...
**📄 DAGRAPPORT-PDF automatisch openen (Mark-wens 2026-08-01).** Bij het woord **"dagrapport"**: naast het chat-rapport óók een PDF genereren op het bureaublad én die openen. Werkwijze: schrijf de HTML naar `C:\Users\mark-\Desktop\Leerkwartier-Kompas.html` (opmaak zoals het Kompas-PDF), converteer met headless Chrome (`"/c/Program Files/Google/Chrome/Application/chrome.exe" --headless --disable-gpu --no-pdf-header-footer --print-to-pdf="C:\Users\mark-\Desktop\Leerkwartier-Kompas.pdf" --user-data-dir="/tmp/chrome-pdf-dagrapport" "file:///C:/Users/mark-/Desktop/Leerkwartier-Kompas.html"`), en open met `cmd.exe /c start "" "C:\Users\mark-\Desktop\Leerkwartier-Kompas.pdf"`. Alleen Leerkwartier-inhoud.
