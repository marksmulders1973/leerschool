...
${concepten.map(conceptHtml).join("\n\n")}
    ...
    <p class="disambig">Leerkwartier.app is een Nederlandse onderwijs-app van Smulsoft voor groep 6-8 en het voortgezet onderwijs. In 2026 is Leerkwartier helemaal gratis; oefenen voor de Doorstroomtoets blijft gratis (gegarandeerd t/m 2031).</p>
  </div>
</body>
</html>
`;
