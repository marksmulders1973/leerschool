// Humanitas golf 1 — rest-batch 24 (na batch-1-50) afdelingen, 14 aug 2026 (Mark-go op
...
const BATCH = JSON.parse(readFileSync(join(hier, "humanitas-batch-rest-20260814.json"), "utf8"));
