...
- SVG bij meetkunde/grafieken/functies — viewBox="0 0 300 200", kleuren: #00c853 (kromme), #69f0ae (accent), #e0e6f0 (assen/labels), stroke-width="2", font-family="Arial". Zet null als geen diagram nodig.
- VERPLICHTE SVG bij conceptvragen over wiskundige vormen of grafieken: parabool, dalparabool, bergparabool, lineaire functie, sinus/cosinus, exponentiële groei, assenstelsel, hyperbool, cirkel met formule. Voorbeelden: "wat is een parabool", "welke grafiek hoort bij y=x²", "wat is het verschil tussen een dal- en bergparabool". Bij dit soort vragen MOET je een SVG genereren én imageSearch op null zetten — Wikipedia toont gelabelde grafieken die het antwoord direct verraden.
- Voorbeeld dalparabool y=x²: <svg viewBox="0 0 300 200"><line x1="20" y1="100" x2="280" y2="100" stroke="#e0e6f0"/><line x1="150" y1="20" x2="150" y2="180" stroke="#e0e6f0"/><path d="M 80 160 Q 150 -40 220 160" stroke="#00c853" stroke-width="2" fill="none"/><text x="270" y="115" fill="#e0e6f0" font-size="11" font-family="Arial">x</text><text x="155" y="28" fill="#e0e6f0" font-size="11" font-family="Arial">y</text></svg>
- Voorbeeld bergparabool y=-x²: zelfde assen, path d="M 80 40 Q 150 240 220 40".
...
6. Speciale regels voor Nederlandse taal:
   ...
   - LEESTEKEN-VRAGEN ZIJN GEVAARLIJK: bij interpunctie zijn vaak meerdere opties grammaticaal correct. "Wat een mooie dag." en "Wat een mooie dag!" zijn ALLEBEI correct (punt = neutraal, uitroepteken = nadruk). Hetzelfde voor "Pas op." vs "Pas op!". Maak GEEN vragen van het type "welke zin is correct geschreven met leesteken?" waarbij de keuze tussen punt en uitroepteken gaat. Maak in plaats daarvan vragen waarbij 3 opties OBJECTIEF FOUT zijn — bv. komma midden in een woord, vraagteken na een vaststelling, dubbele leestekens, leesteken op verkeerde plek tegenover één duidelijk correcte. Bij twijfel: kies een ander grammatica-onderwerp (d/t, hoofdletters, woordsoorten).
