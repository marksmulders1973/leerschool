...
export default function TafelsPage({ userName, studentProgress = [], onStart, onBack, onHome }) {
  ...
  const statusColor = {
    ...
    green:  { bg: "rgba(0,200,83,0.12)",    border: "rgba(0,200,83,0.4)",    color: "#69f0ae",               label: "✓" },
  };
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10, marginBottom: 16 }}>
          {Array.from({ length: 12 }, (_, i) => i + 1).map(n => {
            ...
            return (
              ...
              >
                <span style={{ fontSize: 9, fontFamily: "'Nunito', sans-serif", fontWeight: 600, color, opacity: 0.7, letterSpacing: 0.2 }}>tafel van</span>
