...
const CATEGORIES = [
  ...
  { id: "verhalend",   label: "Verhalend",    icon: "📖", color: "#ab47bc", desc: "Verhalen, dagboek, nieuws" },
  { id: "functioneel", label: "Functioneel",  icon: "✉️",  color: "#26a69a", desc: "Brief, instructie, reclame" },
];
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "0 16px 32px" }}>
        ...
        <button
          ...
          style={{
            ...
            background: "linear-gradient(135deg, rgba(105,240,174,0.15), rgba(0,200,83,0.1))",
            border: "2px solid rgba(105,240,174,0.4)", color: "#69f0ae",
            fontFamily: "'Fredoka', sans-serif", fontSize: 18, fontWeight: 700,
          }}
        >
          🔀 Mix — alle tekstsoorten door elkaar
        </button>
