  ...
  [
    ...
    },
    {
      ...
      vragen: [
        ...
        { q: "Wat is de oplossing voor het voeren in de vakantie?", options: ["Een automatisch voerbakje met een klokje", "De juf neemt de vissen mee naar huis", "De vissen eten in de vakantie niet", "Elke dag komt er een kind naar school"], answer: 0, type: "detail opzoeken", uitleg: "Na 'maar daar is een simpele oplossing voor' komt het antwoord, achter de dubbele punt. Een schrijver die zelf een nadeel noemt, geeft er bijna altijd meteen de oplossing bij." },
