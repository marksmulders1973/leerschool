...
function maakTabs(isTeacher) {
  return [
    ...
    { id: "park",        label: "Park",  emoji: "🐾", target: "parkKeuze", gameRelated: true },
...
function bepaalActieveTab(page) {
  ...
  if (page === "parkKeuze" || page === "zoo" || page === "spellen" || page === "supporterGame" || page === "obliteratorPlay" || page === "obliteratorDirect" || page === "pvp-lobby") return "park";
