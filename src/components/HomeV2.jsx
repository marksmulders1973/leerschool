...
const VAKKEN = [
  ...
  { id: "cito",      label: "Doorstroomtoets", sub: "rekenen · taal · wereld",   icon: (s) => <img src="/logo-doorstroomtoets.png" width={s} height={s} alt="" style={{ objectFit: "contain", verticalAlign: "middle" }} /> },
