...
export default function TextbookQuiz({ onStart, onBack, onHome, userRole, userLevel }) {
  ...
  const BOOK_COVERS = {
    ...
    "Moderne Wiskunde Havo A2":  () => "/covers/moderne-wiskunde-a.jpg",
    "Moderne Wiskunde Havo A3":  () => "/covers/moderne-wiskunde-a.jpg",
    "Moderne Wiskunde VWO B2":   () => "/covers/moderne-wiskunde-b.jpg",
    "Moderne Wiskunde VWO B3":   () => "/covers/moderne-wiskunde-b.jpg",
    ...
    // ── Bedrijfseconomie VO ──────────────────────────────────────
    "Management & Organisatie Havo": () => makeBookCover("M&O", "Havo", ["#1a237e","#283593","#3949ab"], "M&O"),
    "Management & Organisatie VWO":  () => makeBookCover("M&O", "VWO",  ["#0d47a1","#1565c0","#1976d2"], "M&O"),
    "Management & Organisatie":      () => makeBookCover("M&O", "Bedrijfseconomie", ["#1a237e","#283593","#3949ab"], "M&O"),
