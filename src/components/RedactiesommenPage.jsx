          ...
          {CATEGORIES.map(cat => {
            ...
            return (
              ...
              >
                ...
                <span style={{ fontFamily: "var(--font-display)", fontSize: 16, fontWeight: 700, color: "var(--color-text-strong)" }}>
                  {cat.label}
                </span>
                {score !== null && (
                  <span style={{ fontSize: 11, fontFamily: "var(--font-body)", fontWeight: 700, color: st === "green" ? "var(--color-brand-primary-100)" : "#ffb74d" }}>
                    {score}%
                  </span>
                )}
              </button>
