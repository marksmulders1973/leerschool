...
export const SAMPLE_QUESTIONS = {
  ...
  wiskunde: {
    klas1: [
      ...
      { q: "Een rechthoekige driehoek heeft zijden 3 en 4. Hoe lang is de hypotenusa?", options: ["5", "6", "7", "√7"], answer: 0, explanation: "Stelling van Pythagoras: 3² + 4² = 9 + 16 = 25 → √25 = 5.", imageSearch: "Stelling van Pythagoras" },
      { q: "Welke grafiek beschrijft y = 2x + 1?", options: ["Parabool", "Rechte lijn", "Hyperbool", "Cirkel"], answer: 1, explanation: "y = 2x + 1 is een lineaire functie → rechte lijn met rico 2 en snijpunt (0,1).", imageSearch: "Lineaire functie" },
    ...
    klas3: [
      ...
      { q: "Hoe luidt de stelling van Pythagoras?", options: ["a + b = c", "a² + b² = c²", "a × b = c²", "2a + 2b = c"], answer: 1, explanation: "In een rechthoekige driehoek geldt: a² + b² = c² (c = hypotenusa).", imageSearch: "Stelling van Pythagoras" },
      ...
      { q: "Bereken de hoek tegenover de zijde van 5 in een driehoek met zijden 3-4-5.", options: ["30°", "45°", "60°", "90°"], answer: 3, explanation: "3² + 4² = 5² → rechte hoek tegenover de 5 (hypotenusa) = 90°.", imageSearch: "Stelling van Pythagoras" },
