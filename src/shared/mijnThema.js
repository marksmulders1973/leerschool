...
export const THEMAS = [
  ...
  { id: "hartjes", naam: "Hartjes", emoji: "💖", swatch: "#e0568f", pageStyle: { background: `${patroon(HARTJES)} repeat, linear-gradient(180deg, #3a1430 0%, #0b1020 62%)` } },
  { id: "sterren", naam: "Sterren", emoji: "✨", swatch: "#2a2a6a", pageStyle: { background: `${patroon(STERREN)} repeat, linear-gradient(180deg, #161642 0%, #0b1020 62%)` } },
  { id: "eenhoorn", naam: "Eenhoorn", emoji: "🦄", swatch: "#7a3fb0", pageStyle: { background: `${patroon(SPARKLES)} repeat, linear-gradient(180deg, #2e1442 0%, #0b1020 62%)` } },
  { id: "snoep", naam: "Snoep", emoji: "🍬", swatch: "#d94f8a", pageStyle: { background: `${patroon(STIPPEN)} repeat, linear-gradient(180deg, #3a1a2e 0%, #0b1020 62%)` } },
