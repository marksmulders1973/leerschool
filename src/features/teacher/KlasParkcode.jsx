...
export default function KlasParkcode({ authUser }) {
  ...
  return (
    <div style={KAART}>
      ...
      <p style={{ margin: "0 0 10px", color: "#445", background: "#f3efff", borderRadius: 10, padding: "8px 12px" }}>🎮 <b>Klas-game "Wie is de bedrieger?"</b>: open het park met de parkcode, tik op ☰ → 🎮. Jij bent de spelleider en kiest het vak en de groep van de taken (rekenen, taal, lezen, wereld of VMBO-examens) en het aantal imposters. Leerlingen krijgen een uitnodiging in beeld. Elke taak = 3 vragen; het klassement per parkcode blijft 60 dagen staan.</p>
      <p style={{ margin: "0 0 10px", color: "#445", background: "#fff8e1", borderRadius: 10, padding: "8px 12px" }}>✍️ <b>Dictee voor de klas:</b> plak de dicteewoorden van deze week op <a href="/dictee">leerkwartier.app/dictee</a> (Woorden van school) en kies "Zet klaar voor mijn klas". Je krijgt een code voor op het bord; leerlingen typen die op /dictee en Charley leest de woorden voor. Twijfelwoord? Schrijf <b>mail (computer)</b>, dan zegt Charley er een zin bij.</p>
      {!ingelogd ? (
