...
export default function KlasParkcode({ authUser }) {
  ...
  return (
    <div style={KAART}>
      ...
      <p style={{ margin: "0 0 10px", color: "#445", background: "#f3efff", borderRadius: 10, padding: "8px 12px" }}>🎮 <b>Klas-game "Wie doet alsof?"</b>: open het park met de parkcode, tik op ☰ → 🎮. Jij bent de spelleider en kiest het vak en de groep van de taken (rekenen, taal, lezen, wereld of VMBO-examens) en het aantal neppers. Leerlingen krijgen een uitnodiging in beeld. Elke taak = 3 vragen; het klassement per parkcode blijft 60 dagen staan.</p>
