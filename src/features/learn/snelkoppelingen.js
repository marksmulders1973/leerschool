...
export const SNELKOPPELINGEN = [
  ...
  { id: "imposter", emoji: "🎮", label: "Wie doet alsof?", uitleg: "Game in het park: taken zijn sommen, één speler doet alsof. ☰ → 🎮.", pad: "/dierentuin",
    woorden: ["wie doet alsof", "nepper", "imposter", "impostor", "wie is de imposter", "game", "among us", "verrader", "bots", "spelleider"] },
