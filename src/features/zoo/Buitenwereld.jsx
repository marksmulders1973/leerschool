...
export default function Buitenwereld() {
  const { heuvels, bergen, sneeuw, stammen, bladeren } = useMemo(() => {
    ...
    while (stammen.length < 55 && pogingen++ < 400) {
      ...
      if (Math.abs(x) < 11 && z > 36) continue;
      const h = 2.6 + rng() * 1.8;
  ...
  return (
    <group>
      ...
      <group>
        ...
        {[{ x: -1.8, z: 74, k: "#e2574c" }, { x: 1.8, z: 58, k: "#4a90d9", r: Math.PI }, { x: -1.8, z: 88, k: "#f2b134" }].map((a, i) => (
