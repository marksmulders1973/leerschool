...
export const PARK_LEERMOMENTEN = {
  ...
  // 🏔️ Bergen-plan (Mark 6 sep 2026, WhatsApp met Brian): kabelbaan, slee, hangbrug,
  // sneeuwgrens — vaste plekken buiten het raster (zie VASTE_PLEKKEN in ZooScene).
  kabelbaan: {
    id: "kabelbaan", emoji: "🚠", titel: "De kabelbaan",
    praatje: "De gondel hangt aan één dikke staalkabel en wordt van boven omhooggetrokken. Zo kom je zonder te klimmen van het dal naar de top. Hij klimt bijna 75 meter en is daar 40 seconden over bezig.",
    weetje: "Een kabelbaan-kabel is gedraaid uit honderden dunne staaldraadjes samen. Eén zo'n kabel kan het gewicht van wel twintig auto's houden.",
    leerpadId: "tijd-snelheid-afstand-po", leerLabel: "Tijd, snelheid en afstand",
    leerpadId2: "bewegingen-snelheid-natuurkunde", leerLabel2: "Bewegingen en snelheid (brugklas)",
  },
  sneeuwgrens: {
    id: "sneeuwgrens", emoji: "🏔️", titel: "De sneeuwgrens",
    praatje: "Kijk om je heen: hier ligt sneeuw, beneden in het dal groeit gras. Hoe hoger je komt, hoe kouder het wordt — ongeveer één graad kouder per 150 meter. Boven een bepaalde hoogte smelt de sneeuw nooit helemaal: dat is de sneeuwgrens.",
    weetje: "Op de Kilimanjaro in Afrika, vlak bij de evenaar, ligt sneeuw op de top. Niet omdat het daar koud land is, maar omdat de berg bijna 6 kilometer hoog is.",
    leerpadId: "weersvoorspelling-po", leerLabel: "Weer en weersvoorspelling",
    leerpadId2: "klimaten-aardrijkskunde", leerLabel2: "Klimaten en klimaatzones (brugklas)",
  },
  slee: {
    id: "slee", emoji: "🛷", titel: "De sleebaan",
    praatje: "Niemand duwt, en toch gaat de slee steeds sneller: de zwaartekracht trekt hem de helling af. Het ijs is zo glad dat er bijna geen wrijving is. In het dal wordt de baan vlak en remt de slee vanzelf af.",
    weetje: "Bij het rodelen op de Olympische Spelen halen sleeën meer dan 130 kilometer per uur. De sporters sturen alleen met hun schouders en kuiten.",
    leerpadId: "tijd-snelheid-afstand-po", leerLabel: "Tijd, snelheid en afstand",
...
const VRAAG_PER_MOMENT = {
  ...
  kabelbaan: "De gondel klimt 75 meter in 40 seconden. Hoeveel meter is dat ongeveer per seconde?",
