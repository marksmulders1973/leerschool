...
const MaatjePocket = lazy(() => import("./components/MaatjePocket.jsx"));
    ...
    >
      ...
      {page === "teacher-home" && (
        <TeacherHome
          ...
          onMaakWerkblad={() => setPage("werkblad")}
      ...
      {page === "takenlijst-maker" && (
        <Suspense fallback={<PageLoader />}>
          <TakenlijstMaker userId={authUser?.id} onClose={() => setPage("teacher-home")} onWerkblad={() => setPage("werkblad")} />
        </Suspense>
      )}
      {page === "werkblad" && (
        <Suspense fallback={<PageLoader />}>
          <WerkbladPagina onClose={() => setPage("teacher-home")} />
        </Suspense>
      )}
      {page === "self-study" && (
        <SelfStudy
      ...
      {page === "cito" && (
        <CitoPage
          ...
          onStart={(config) => {
            ...
            const label = { gemengd: "Alles gemengd", rekenen: "Rekenen & Wiskunde", taal: "Taal", "begrijpend-lezen": "Begrijpend Lezen", wereldorientatie: "Wereld Oriëntatie", studievaardigheden: "Studievaardigheden" }[config.citoId] || "Doorstroomtoets";
            const quiz = {
              id: "cito-" + Date.now(),
              subject: config.subject,
              level: config.level,
