    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            nogSimpeler: "Niet eerlijk = niet rechtsstaat.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Communisme verdween.",
            simpeler: "1989: alle communistische regeringen Oost-Europa weg → 1991: Warschaupact (= communistisch pact) heeft geen doel meer → landen stappen uit.",
            nogSimpeler: "Communisme weg",
          },
        },
      },
    ],
