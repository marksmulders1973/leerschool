...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Welk woord rijmt op **hond**?", options: ["mond","kat","huis","boom"], answer: 0, wrongHints: [null,"Klopt — eindigt op -ond.","Andere klank.","Niet.","Niet."] },
      { q: "Welk **rijmschema** is **gekruist**?", options: ["ABAB","AABB","ABBA","AAAA"], answer: 0, wrongHints: [null,"Klopt.","Paarrijm.","Omarmend.","Geen wisseling."] },
      { q: "Welk **rijmschema** is **omarmend**?", options: ["ABBA","AABB","ABAB","AAAA"], answer: 0, wrongHints: [null,"Klopt — buiten = A, binnen = B.","Paarrijm.","Gekruist.","Geen wisseling."] },
      { q: "*'De zon lacht naar mij.'* — welke stijlfiguur?", options: ["Personificatie","Vergelijking","Rijm","Hyperbool"], answer: 0, wrongHints: [null,"Klopt — zon = menselijke eigenschap.","Niet — geen 'als'.","Niet rijm.","Niet overdreven."] },
      { q: "*'Duizend keer gezegd.'* — welke stijlfiguur?", options: ["Hyperbool (overdrijving)","Personificatie","Vergelijking","Rijm"], answer: 0, wrongHints: [null,"Klopt.","Niet menselijke eigenschap.","Geen 'als'.","Niet."] },
      { q: "Wat is een **metafoor**?", options: ["Beeldspraak zonder 'als' (X = Y)","Vergelijking met 'als'","Overdrijving","Rijm"], answer: 0, wrongHints: [null,"Klopt — bv. 'Hij is een leeuw'.","Dat is vergelijking.","Hyperbool.","Niet."] },
      { q: "*'Pim heeft een paard in de tuin.'* — welke alliteratie-letters?", options: ["P","T","H","E"], answer: 0, wrongHints: [null,"Klopt — Pim/paard/...","Geen reeks.","Niet beginrijm.","Niet."] },
      { q: "Wat is een **vers**?", options: ["Een regel in een gedicht","Een liedje","Een verhaal","Een tekening"], answer: 0, wrongHints: [null,"Klopt — versregel.","Soms ook, maar primair.","Niet primair.","Niet."] },
      { q: "Welk soort gedicht heeft **14 regels**?", options: ["Sonnet","Haiku","Limerick","Vrij vers"], answer: 0, wrongHints: [null,"Klopt — vast 14.","17 lettergrepen.","Meestal 5 regels.","Geen vorm."] },
      { q: "**Limerick** heeft hoeveel regels?", options: ["5","3","14","8"], answer: 0, wrongHints: [null,"Klopt — humoristisch.","Haiku.","Sonnet.","Niet."] },
      { q: "Wat rijmt op **regen**?", options: ["zegen","zon","wolk","huis"], answer: 0, wrongHints: [null,"Klopt — -egen.","Andere klank.","Niet.","Niet."] },
      { q: "**Refrein** in een gedicht/lied is?", options: ["Herhalend stukje tussen coupletten","Eerste regel","Laatste woord","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Niet specifiek.","Niet.","Wel."] },
      { q: "*'Ik zag, ik zag, wat jij niet zag.'* — welk effect door herhaling?", options: ["Versterkt + ritme","Vermoeit","Onzin","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — repetitie.","Soms — primair effect ritme.","Wel zin.","Wel."] },
      { q: "Wat is een **couplet**?", options: ["Groepje van 2+ versregels samen","Eén woord","Lied","Niet relevant"], answer: 0, wrongHints: [null,"Klopt = strofe.","Te klein.","Te groot.","Wel."] },
      { q: "Welk **rijmpaar** is acceptabel?", options: ["maan/baan","kat/tafel","huis/koud","stoel/groen"], answer: 0, wrongHints: [null,"Klopt — -aan.","Andere klank.","Andere klank.","Andere klank."] },
    ],
  },
];
