...
const steps = [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Te beperkt — geldt voor iedereen.", "Veel ouder.", "Kinderen hebben ook rechten."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-feit: mensenrechten staan in het **UVRM** (Universele Verklaring van de Rechten van de Mens, VN, 1948). Een reactie op de gruwelen van WO2 + Holocaust. Voor iedereen, niet alleen Westerse landen.",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Tegenovergesteld.", "Tegenovergesteld.", "Wel bekend."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Veel eerder.", "Geen direct verband.", "Te vroeg."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Franse Revolutie (Verklaring Mens en Burger).", "Te vroeg.", "Te laat."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-tip jaartallen: UVRM = 1948 (3 jaar na WO2). VN-oprichting = 1945. Kinderrechten-verdrag = 1989. EVRM = 1950 (Europees, voortbouwend op UVRM).",
          voorbeelden: [
          ...
          basiskennis: [{ onderwerp: "Truc", uitleg: "UVRM 1948 = direct na WO2. Belangrijk: Toets-feit." }],
          niveaus: {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Begon later.", "Militair pact.", "Wel meegedaan, niet alleen."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Geen artikel 1.", "Geen artikel 1.", "Artikel ergens anders."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-feit: Artikel 1 = symbool van de mensenrechten-beweging. Geprint op vlaggen, gebouwen, schoolboeken. Inspireerde grondwetten van vele landen, incl. NL.",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet Europees.", "Niet EVRM.", "Niet 2000."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet sociaal.", "Niet collectief.", "Wel een mensenrecht."],
      },
      {
        q: "**Recht op onderwijs** — welke generatie?",
        options: ["2e (sociaal-economisch)", "1e", "3e", "Geen"],
        answer: 0,
        wrongHints: [null, "Klassiek = vrijheid, niet voorzieningen.", "Collectief is anders.", "Wel een recht."],
      },
      {
  ...
  // STAP 4: Schendingen + actualiteit
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Geen partij.", "Non-profit.", "Niet onderdeel VN."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Te laat — val Berlijnse Muur.", "Te vroeg.", "Te laat."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet specifiek.", "Niet specifiek.", "Geen veto."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "NGO, geen overheid.", "Vredelievend.", "Geen bedrijf."],
      },
      {
  ...
  // STAP 6: Eind-toets
  {
    ...
    explanation:
      "Mix-toets in Doorstroomtoets-stijl. Door elkaar: UVRM, generaties, schendingen, organisaties.\n\nVeel succes!",
    checks: [
      {
        q: "Wat is een **mensenrecht**?",
        options: ["Recht dat iedereen heeft als mens", "Recht van rijke mensen", "Een wet uit 2000", "Iets dat niemand heeft"],
        answer: 0,
        wrongHints: [null, "Iedereen, ongeacht inkomen.", "Veel ouder.", "Wel iets — iedereen heeft het."],
      },
      {
        q: "Wat is **UVRM**?",
        options: ["Universele Verklaring Rechten van de Mens (1948)", "Een wet", "Een rechtbank", "Een ster"],
        answer: 0,
        wrongHints: [null, "Verklaring, geen wet.", "Geen rechtbank.", "Geen ster."],
      },
      {
        q: "**Vrijheid van meningsuiting** — welke generatie?",
        options: ["1e (burgerlijk + politiek)", "2e", "3e", "Geen"],
        answer: 0,
        wrongHints: [null, "Sociaal-economisch.", "Collectief.", "Wel mensenrecht."],
      },
      {
        q: "Wat is **ICC**?",
