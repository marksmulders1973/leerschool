    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x² − 2x = 5.", simpeler: "Kwadratisch heeft x². Optie A wel, andere niet.", nogSimpeler: "x² aanwezig" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "−7.", simpeler: "b = getal vóór x (inclusief teken) = −7.", nogSimpeler: "−7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2.", simpeler: "Kwadratisch = meestal 2 oplossingen.", nogSimpeler: "2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "±7.", simpeler: "x² = 49 → x = ±√49 = ±7.", nogSimpeler: "±7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x(x+4).", simpeler: "x² + 4x = x(x+4). Beide hebben x → x buiten.", nogSimpeler: "x(x+4)" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0 of 7.", simpeler: "x·(x−7)=0 → x=0 OF x=7.", nogSimpeler: "0 en 7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0 of −6.", simpeler: "x(x+6)=0 → x=0 OF x=−6.", nogSimpeler: "0, −6" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2 en 3.", simpeler: "2+3=5 én 2·3=6. Beide kloppen.", nogSimpeler: "2,3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0 of 8.", simpeler: "x(x−8)=0 → x=0 of x=8.", nogSimpeler: "0, 8" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0 of −9.", simpeler: "x(x+9)=0 → x=0 of x=−9.", nogSimpeler: "0, −9" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "t=1 en t=3.", simpeler: "h=15: t²−4t+3=0 → (t−1)(t−3)=0 → t=1 of t=3.", nogSimpeler: "1, 3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "20 m.", simpeler: "Top bij t=2. h(2) = 20m maximum.", nogSimpeler: "20m" },
        },
      },
