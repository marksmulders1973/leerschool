    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "PO.", "Te weinig.", "Te veel."],
      },
      {
        q: "**Voldoende cijfer** op middelbare school?",
        options: ["6,0 of hoger", "5,0 of hoger", "4,0 of hoger", "10"],
        answer: 0,
        wrongHints: [null, "5,5 is onvoldoende.", "Te laag.", "Maximum, niet ondergrens."],
      },
      {
        q: "Hoeveel **rapporten** per jaar op middelbare school?",
        options: ["3-4", "1", "10", "0"],
        answer: 0,
        wrongHints: [null, "Te weinig.", "Te veel.", "Wel rapporten."],
      },
      {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Werkt minder goed.", "Vermijd.", "Vermijd."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Te lang aaneengesloten.", "Concentratie zakt.", "Wel techniek."],
      },
      {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Te weinig.", "Werkt slecht.", "Tegenovergesteld."],
      },
      {
        q: "Wat is **Feynman-techniek**?",
        options: ["Uitleggen aan iemand anders", "Hard leren", "Veel slapen", "Gokken"],
        answer: 0,
        wrongHints: [null, "Niet specifiek.", "Slaap wel helpt, maar geen Feynman.", "Niet."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Slecht idee.", "Te weinig.", "Onmogelijk."],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Letterlijk wel, maar techniek bedoeld.", "Tegenovergesteld.", "Niet."],
      },
      { q: "Op de middelbare school heb je meestal hoeveel **docenten** per dag?", options: ["5-7","1","2","20"], answer: 0, wrongHints: [null, "Niet — verschil per vak.", "Te weinig.", "Te veel."] },
      { q: "Wat is **Magister**?", options: ["Online schoolsysteem voor cijfers + rooster","Een vak","Een leraar","Een schoolboek"], answer: 0, wrongHints: [null, "Niet — een tool.", "Niet — een tool.", "Niet — software."] },
      { q: "Cijfers op middelbare school zijn meestal?", options: ["1 tot 10","A tot F","Goed/voldoende/onvoldoende","Sterren"], answer: 0, wrongHints: [null, "Engels systeem.", "Basisschool-stijl.", "Niet relevant."] },
      { q: "Welk cijfer is een **voldoende**?", options: ["5,5 of hoger","4","3","8 of hoger"], answer: 0, wrongHints: [null, "Onvoldoende.", "Onvoldoende.", "Dat is goed."] },
      { q: "Wat is **huiswerk plannen** met een agenda?", options: ["Opschrijven wanneer je wat doet","Opzoeken in boek","Vragen aan docent","Niet doen"], answer: 0, wrongHints: [null, "Niet planning.", "Niet relevant.", "Wel doen."] },
      { q: "Bij **spaced repetition** doe je?", options: ["Korte herhalingen verspreid over meerdere dagen","Alles op 1 avond stampen","Niet leren","Alleen in les"], answer: 0, wrongHints: [null, "Niet — werkt slecht.", "Niet — wel leren.", "Niet alleen les."] },
      { q: "Wat is **interleaving**?", options: ["Verschillende onderwerpen door elkaar leren","Alleen 1 vak per dag","Slapen","Niet leren"], answer: 0, wrongHints: [null, "Tegenovergesteld.", "Niet relevant.", "Wel leren."] },
      { q: "Wat doe je bij de **Feynman-techniek**?", options: ["Uitleggen alsof je het aan een kind vertelt","Lees in boek","Stampen","Vraag aan docent"], answer: 0, wrongHints: [null, "Te passief.", "Werkt slecht.", "Wel handig, maar niet de techniek."] },
      { q: "Wat is een **profielkeuze**?", options: ["Pakket vakken voor bovenbouw kiezen","Kledingstijl","Foto kiezen","Naam veranderen"], answer: 0, wrongHints: [null, "Niet relevant.", "Niet relevant.", "Niet."] },
...
const brugklasOrientatie = {
  ...
  prerequisites: [
    { id: "cito-strategieen-groep8", title: "Toets-strategieen groep 8", niveau: "po-1F" },
  ],
  intro:
