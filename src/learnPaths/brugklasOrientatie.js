...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Op de middelbare school heb je meestal hoeveel **docenten** per dag?", options: ["5-7","1","2","20"], answer: 0, wrongHints: [null,"Klopt — anders dan basisschool.","Niet — verschil per vak.","Te weinig.","Te veel."] },
      { q: "Wat is **Magister**?", options: ["Online schoolsysteem voor cijfers + rooster","Een vak","Een leraar","Een schoolboek"], answer: 0, wrongHints: [null,"Klopt — digital portal.","Niet — een tool.","Niet — een tool.","Niet — software."] },
      { q: "Cijfers op middelbare school zijn meestal?", options: ["1 tot 10","A tot F","Goed/voldoende/onvoldoende","Sterren"], answer: 0, wrongHints: [null,"Klopt — onvoldoende <5,5.","Engels systeem.","Basisschool-stijl.","Niet relevant."] },
      { q: "Welk cijfer is een **voldoende**?", options: ["5,5 of hoger","4","3","8 of hoger"], answer: 0, wrongHints: [null,"Klopt — standaard cesuur.","Onvoldoende.","Onvoldoende.","Dat is goed."] },
      { q: "Wat is **huiswerk plannen** met een agenda?", options: ["Opschrijven wanneer je wat doet","Opzoeken in boek","Vragen aan docent","Niet doen"], answer: 0, wrongHints: [null,"Klopt — week-overzicht.","Niet planning.","Niet relevant.","Wel doen."] },
      { q: "Bij **spaced repetition** doe je?", options: ["Korte herhalingen verspreid over meerdere dagen","Alles op 1 avond stampen","Niet leren","Alleen in les"], answer: 0, wrongHints: [null,"Klopt — bewezen effectief.","Niet — werkt slecht.","Niet — wel leren.","Niet alleen les."] },
      { q: "Wat is **interleaving**?", options: ["Verschillende onderwerpen door elkaar leren","Alleen 1 vak per dag","Slapen","Niet leren"], answer: 0, wrongHints: [null,"Klopt — versterkt onderscheidings-vermogen.","Tegenovergesteld.","Niet relevant.","Wel leren."] },
      { q: "Wat doe je bij de **Feynman-techniek**?", options: ["Uitleggen alsof je het aan een kind vertelt","Lees in boek","Stampen","Vraag aan docent"], answer: 0, wrongHints: [null,"Klopt — laat zien of je het echt snapt.","Te passief.","Werkt slecht.","Wel handig, maar niet de techniek."] },
      { q: "Wat is een **profielkeuze**?", options: ["Pakket vakken voor bovenbouw kiezen","Kledingstijl","Foto kiezen","Naam veranderen"], answer: 0, wrongHints: [null,"Klopt — N&T/N&G/E&M/C&M.","Niet relevant.","Niet relevant.","Niet."] },
      { q: "Het **N&T-profiel** heeft veel?", options: ["Natuurkunde + wiskunde","Talen","Geschiedenis","Tekenen"], answer: 0, wrongHints: [null,"Klopt — Natuur & Techniek.","Dat is C&M.","Dat is E&M.","Niet hoofdvak."] },
      { q: "Welke afkorting staat voor 'middelbare school'?", options: ["VO","PO","HO","MBO"], answer: 0, wrongHints: [null,"Klopt — Voortgezet Onderwijs.","Basisschool.","Universiteit.","Mbo komt erna."] },
      { q: "Wat is een **mentor**?", options: ["Vaste leraar die je begeleidt","Beste vriend","Een vak","Boekenkast"], answer: 0, wrongHints: [null,"Klopt — eerste aanspreekpunt.","Niet schoolse rol.","Niet persoon.","Niet."] },
      { q: "Wat is een **rapportvergadering**?", options: ["Docenten bespreken cijfers van leerling","Klas-feest","Toets","Vakantie"], answer: 0, wrongHints: [null,"Klopt — meerdere keren per jaar.","Niet.","Niet.","Niet."] },
      { q: "Bij **'leren leren'** wat is de belangrijkste tip?", options: ["Begrijp eerst, dan onthouden","Stampen zonder begrip","Alleen samenvattingen","Plaatjes kijken"], answer: 0, wrongHints: [null,"Klopt — beklijft langer.","Werkt slecht.","Te kort.","Niet hoofdmethode."] },
    ],
  },
];
