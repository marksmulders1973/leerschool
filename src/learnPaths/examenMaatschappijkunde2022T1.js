...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "**Ambtenaren** = vaste medewerkers van de overheid die het beleid voorbereiden, uitvoeren en evalueren. Werken op ministeries (Sociale Zaken, Financiën, etc.), gemeentehuizen, etc. Kamerleden zitten in parlement, niet ministerie.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Een **minister** is hoofd van een ministerie. Verantwoordelijk voor beleid op zijn vakgebied + leiding aan ambtenaren. Beslist niet over wet-aanname (dat doet Kamer). Geeft leiding aan eigen ministerie, niet aan partijfractie.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Ministeriële verantwoordelijkheid** = grondwettelijk principe sinds 1848 (Thorbecke): 'De Koning is onschendbaar, de ministers zijn verantwoordelijk.' Inhoud van elke officiële toespraak/handeling van koning wordt door minister opgesteld en die is politiek verantwoordelijk.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Media kunnen direct gedrag uitlokken** — bekend effect van geweld/criminaliteit op tv-series (kopieer-effect). Tieners zagen truc in serie + namen actie. Dit is directe invloed op crimineel gedrag, niet alleen opvattingen of beeldvorming.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Noodweer** = wettelijke strafuitsluitingsgrond: jezelf of een ander verdedigen tegen een wederrechtelijke aanval. De man werd aangevallen → mocht zich verdedigen → niet strafbaar. Andere strafuitsluitingsgronden: overmacht, ontoerekeningsvatbaarheid, wettelijk voorschrift.",
