    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — wapenwedloop + grote legers.", "Wel deels, maar M = militarisme.", "Marokko was 1 incident, niet de hoofdcategorie.", "Marshall plan was na WO2."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is Triple Alliantie.", "VS deed niet mee vanaf begin.", "Spanje was neutraal."],
      },
      {
        q: "Wat is **nationalisme**?",
        options: ["Sterke trots in eigen volk/land", "Vredesbeweging", "Internationaal samenwerken", "Religie"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenovergesteld.", "Tegenovergesteld.", "Geen religie."],
      },
      {
        q: "Welke regio heette **'Balkan-kruidvat'**?",
        options: ["Zuidoost-Europa (Servië, Bulgarije, etc.)", "Noord-Europa", "Spanje", "Engeland"],
        answer: 0,
        wrongHints: [null, "Klopt — explosieve mix volken.", "Geen kruidvat.", "Geen kruidvat.", "Geen kruidvat."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — datum-start.", "Te laat.", "Einde oorlog.", "Niet bij begin."],
      },
      {
        q: "In welke stad gebeurde de **moord**?",
        options: ["Sarajevo (Bosnië)", "Wenen", "Belgrado", "Berlijn"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Hoofdstad Oostenrijk-Hongarije zelf.", "Hoofdstad Servië.", "Hoofdstad Duitsland."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — mislukte bij de Marne.", "Was na WO2.", "Was na WO2.", "Was 1924 — economisch herstel."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — daarom mede oorlog.", "Bleef wel neutraal.", "Bleef neutraal.", "Bleef neutraal."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Geen wapen.", "Geen voertuig.", "Geen vrede — middenin oorlog."],
      },
      {
        q: "Welk **nieuw wapen** werd in WO1 voor het eerst gebruikt?",
        options: ["Tank (1916)", "Pistool", "Kanon", "Zwaard"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Bestond al lang.", "Bestond al lang.", "Bestond al lang."],
      },
      {
        q: "Welk **gif** werd eerst gebruikt **bij Ieper (1915)**?",
        options: ["Chloorgas", "Sarin", "Mosterdgas", "Pepperspray"],
        answer: 0,
        wrongHints: [null, "Klopt — eerste keer door Duitsers.", "Sarin was later (Tweede Wereldoorlog).", "Mosterdgas kwam ook in WO1 maar later.", "Niet WO1."],
      },
      {
        q: "Wanneer deden de **VS mee** aan WO1?",
        options: ["April 1917", "Augustus 1914", "December 1916", "November 1918"],
        answer: 0,
        wrongHints: [null, "Klopt.", "VS deed nog niet mee.", "VS deed nog niet mee.", "Einde oorlog."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet — neutraal.", "Niet — neutraal.", "Wel bekend."],
      },
      {
        q: "Hoeveel **Belgische vluchtelingen** kwamen naar NL?",
        options: ["~1 miljoen", "~10.000", "~100", "~10 miljoen"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Veel meer.", "Veel meer.", "Te veel — meer dan totaal België-bevolking."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — voedseltekort.", "Niet zo bekend.", "Niet zo bekend.", "Niet zo bekend."],
      },
      {
        q: "Wie vluchtte na verlies oorlog naar **Doorn (NL)**?",
        options: ["Duitse keizer Wilhelm II", "Lenin", "Frans Ferdinand", "Hitler"],
        answer: 0,
        wrongHints: [null, "Klopt — woonde daar tot 1941.", "Was in Rusland.", "Was al doodgeschoten.", "Veel later — WO2."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 11 uur 11 nov.", "Begin WO2.", "Einde WO2.", "Verdrag van Versailles — komt later."],
      },
      {
        q: "Hoeveel **doden** ongeveer in WO1?",
        options: ["~17 miljoen", "~1 miljoen", "~50 miljoen", "~100.000"],
        answer: 0,
        wrongHints: [null, "Klopt — 9M soldaten + 7M burgers.", "Te weinig.", "Dat is WO2-totaal.", "Te weinig."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — strenge voorwaarden.", "Wél veel.", "Niet de helft.", "Niet toetreden."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 3 grote rijken vielen uit elkaar.", "Niet alleen Rusland.", "Duitsland bleef bestaan (in andere vorm).", "Wel — meerdere."],
      },
    ],
  },
