    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "Vóór 1848 was de koning bijna alleenheerser. Na 1848 = ceremoniële rol + parlement neemt over.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "ARP.",
            simpeler: "Abraham Kuyper stichtte de Anti-Revolutionaire Partij (ARP, 1879) — protestants-christelijk.",
            nogSimpeler: "ARP",
          },
        },
      },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "1917, Pacificatie.",
            simpeler: "Schoolstrijd opgelost via compromis in 1917 = de Pacificatie.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Reagan.",
            simpeler: "VS-president die USSR 'evil empire' noemde + wapenwedloop opdreef = Reagan (jaren '80).",
            nogSimpeler: "Reagan",
          },
        },
      },
