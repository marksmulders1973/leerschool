...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Vul in: 'Ik ___ je morgen.' (zien)", options: ["zie","ziet","ziende","gezien"], answer: 0, wrongHints: [null,"Klopt — ik-vorm = stam.","Niet — dat is hij-vorm.","Niet.","Voltooid."] },
      { q: "Vul in: 'Hij ___ heel snel.' (lopen)", options: ["loopt","loop","loopd","loopen"], answer: 0, wrongHints: [null,"Klopt — hij = stam + t.","Dat is ik-vorm.","Niet — geen d.","Hele werkwoord."] },
      { q: "Verleden tijd: 'Ik ___ thuis.' (werken, kofschip-regel)", options: ["werkte","werkde","werk","werkten"], answer: 0, wrongHints: [null,"Klopt — k in kofschip → +te.","Niet — k → t.","Geen verleden.","Meervoud."] },
      { q: "Verleden tijd: 'Wij ___ vrolijk.' (spelen)", options: ["speelden","speelde","speelten","spelen"], answer: 0, wrongHints: [null,"Klopt — l niet in kofschip → -den (meervoud).","Enkelvoud.","Niet.","Tegenwoordige tijd."] },
      { q: "Voltooid deelwoord van 'werken'?", options: ["gewerkt","gewerkd","werkte","werkten"], answer: 0, wrongHints: [null,"Klopt — k → t.","Niet — k in kofschip = t.","Verleden tijd.","Niet."] },
      { q: "Voltooid deelwoord van 'leren'?", options: ["geleerd","geleert","leerde","leren"], answer: 0, wrongHints: [null,"Klopt — r niet in kofschip → d.","Niet — r → d.","Verleden tijd.","Hele werkwoord."] },
      { q: "Vul: 'Hij ___ niet wat hij wil.' (weten)", options: ["weet","weett","weeten","wist"], answer: 0, wrongHints: [null,"Klopt — stam 'weet', niet nog een t.","Dubbel — niet.","Hele werkwoord.","Verleden tijd."] },
      { q: "Vul: 'Ik ___ dat ik gelijk heb.' (vinden)", options: ["vind","vindt","vindde","vinden"], answer: 0, wrongHints: [null,"Klopt — ik = stam.","Niet — dat is hij-vorm.","Niet.","Hele."] },
      { q: "Vul: 'Zij ___ snel.' (rennen, hij/zij-vorm)", options: ["rent","rend","rennen","rende"], answer: 0, wrongHints: [null,"Klopt — stam 'ren' + t.","Niet — kofschip-regel niet voor ww-stam.","Hele.","Verleden."] },
      { q: "Voltooid deelwoord van 'spelen'?", options: ["gespeeld","gespelt","speelde","gespeelde"], answer: 0, wrongHints: [null,"Klopt — l → d.","Niet — l geen kofschip.","Verleden tijd.","Niet."] },
      { q: "Vul in: 'Hij ___ niet boos.' (worden)", options: ["wordt","word","wordtt","worden"], answer: 0, wrongHints: [null,"Klopt — stam 'word' + t.","Niet — d-stam + t = dt.","Niet — dubbele t.","Hele."] },
      { q: "Vul in: 'Wij ___ het verhaal.' (horen)", options: ["horen","hoort","horede","horeden"], answer: 0, wrongHints: [null,"Klopt — wij = hele werkwoord.","Dat is hij/zij/het.","Niet bestaand.","Niet."] },
      { q: "Verleden tijd: 'Hij ___ snel.' (rennen)", options: ["rende","rendde","rend","rennen"], answer: 0, wrongHints: [null,"Klopt — n niet in kofschip → de.","Geen dubbele d.","Geen verleden vorm.","Hele."] },
      { q: "Voltooid deelwoord van 'gaan'?", options: ["gegaan","gegaand","gegan","gaan"], answer: 0, wrongHints: [null,"Klopt — onregelmatig.","Geen +d/t bij onregelmatig.","Niet.","Hele."] },
      { q: "Vul in: 'Ik ___ aan een werkstuk.' (werken)", options: ["werk","werkt","gewerkt","werkte"], answer: 0, wrongHints: [null,"Klopt — ik-vorm = stam.","Dat is hij-vorm.","Voltooid.","Verleden."] },
    ],
  },
];
