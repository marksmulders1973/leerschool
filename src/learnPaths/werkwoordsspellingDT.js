    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Werken − en = werk. A.", simpeler: "Haal -en weg van 'werken'. Wat blijft? Werk. Dat is de stam.", nogSimpeler: "Werk" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Maken → maak. A.", simpeler: "Maken klinkt 'maa-ken' (lange a). Stam moet ook lange a hebben: maak.", nogSimpeler: "Maak" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hij = stam + t = speelt. A.", simpeler: "Bij 'hij' altijd een -t achter de stam. Stam van spelen = speel. Hij speel + t = speelt.", nogSimpeler: "Hij + t = speelt" },
        },
      },
      {
        q: "Welke is **goed**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Jij achter = geen t. A.", simpeler: "Bij vragen waar 'jij' achter het werkwoord staat (inversie), valt de t weg. 'Werk jij hard?' niet 'werkt jij hard?'.", nogSimpeler: "Jij achter = geen t" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Meervoud = +en. Lopen. A.", simpeler: "'Zij' kan enkelvoud (1 vrouw) of meervoud (zij allemaal) zijn. Hier meervoud. Bij meervoud: hele werkwoord (lopen).", nogSimpeler: "Meervoud = lopen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hij = stam + t = wordt. A.", simpeler: "Stam van worden = word. Bij hij +t. Word + t = wordt. Niet 'word' (mist t), niet 'wort' (mist d).", nogSimpeler: "Word + t = wordt" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Meervoud = vinden. A.", simpeler: "'Zij' meervoud = meer personen → werkwoord op -en. Vinden.", nogSimpeler: "Meervoud = vinden" },
        },
      },
      {
        q: "Welke is **goed**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hij houdt = houd + t = dt. A.", simpeler: "Houden, stam = houd (op d). Hij krijgt +t. Houd + t = houdt. Beide letters d en t schrijven.", nogSimpeler: "Houdt" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Stam-op-t blijft t. Zit. A.", simpeler: "Zit eindigt al op t. Geen extra t erbij want 'zitt' bestaat niet. Hij zit.", nogSimpeler: "Zit" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Meervoud = eten. A.", simpeler: "Bij meervoud (zij = meer mensen) gebruik je hele werkwoord: eten.", nogSimpeler: "Meervoud = eten" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "'t kofschip = t,k,f,s,ch,h,p. A.", simpeler: "De 7 medeklinkers in 't kofschip zijn: t, k, f, s, ch, h, p. Klinkers (o, i) doen niet mee.", nogSimpeler: "tkfsch(h)p" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "k in kofschip → werkte. A.", simpeler: "Stam werk eindigt op k. K zit in 't kofschip. Dus verleden tijd met -te: werkte.", nogSimpeler: "K = -te = werkte" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "r niet in kofschip → leerde. A.", simpeler: "Stam leer eindigt op r. R zit NIET in 't kofschip. Dus -de: leerde.", nogSimpeler: "Niet-kofschip = -de = leerde" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "ge + werk + t = gewerkt. A.", simpeler: "Voltooid deelwoord: ge-...-t/d. Werk eindigt op k (kofschip) → t. Dus: ge + werk + t = gewerkt.", nogSimpeler: "Gewerkt" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "r niet kofschip → geleerd. A.", simpeler: "Stam leer eindigt op r. R zit NIET in 't kofschip. Dus voltooid: ge + leer + d = geleerd.", nogSimpeler: "Geleerd" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Jij achter = geen t. Word. A.", simpeler: "Vraag begint met werkwoord. Jij komt erachter. Bij deze inversie valt de t weg: 'Word jij' niet 'Wordt jij'.", nogSimpeler: "Jij achter = Word" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "Lopen-test", uitleg: "Hij wordt = hij loopt. Beide eindigen op t. ✓" }],
          niveaus: { basis: "Hij wordt (dt). A.", simpeler: "Bij hij altijd stam + t. Stam = word. Word + t = wordt. Allebei letters apart schrijven.", nogSimpeler: "Wordt" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ik = stam alleen = word. A.", simpeler: "Bij 'ik' krijg je nooit een extra t. Alleen de stam. Stam van worden = word. Dus 'ik word'.", nogSimpeler: "Ik = stam = word" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hij staat. A.", simpeler: "Stam van staan = sta. Bij hij + t = staat (met dubbele aa). Niet 'stat' (te kort) of 'stant' (geen n).", nogSimpeler: "Staat" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "S kofschip → fietste. A.", simpeler: "Stam fiets eindigt op s. S zit in 't kofschip. Verleden tijd met -te: fietste.", nogSimpeler: "S = -te = fietste" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "L niet kofschip → gewandeld. A.", simpeler: "Wandelen, stam = wandel. L zit NIET in kofschip → -d. Voltooid: ge + wandel + d = gewandeld.", nogSimpeler: "Gewandeld" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Werk zonder t → jij. A.", simpeler: "'Werk' (geen t) = vorm bij 'jij' na werkwoord. Bij hij/zij zou er 'werkt' staan.", nogSimpeler: "Werk + ?  = jij" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vindt (dt). A.", simpeler: "Stam van vinden = vind (op d). Bij hij + t. Vind + t = vindt. Beide letters d en t schrijven.", nogSimpeler: "Vindt" },
        },
      },
      {
