    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "World Trade Org.", simpeler: "WTO = handel", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "China 2001.", simpeler: "China-WTO 2001", nogSimpeler: "2001" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Globaal + lokaal.", simpeler: "Glokal = G+L", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Container.", simpeler: "1956 container", nogSimpeler: "A." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "HDI.", simpeler: "HDI = 3-in-1", nogSimpeler: "A." },
        },
      },
      {
        q: "**BRICS**-landen zijn:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "B/R/I/C/ZA.", simpeler: "BRICS = 5 reuzen", nogSimpeler: "A." },
        },
      },
      {
        q: "**Gini = 0** betekent:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gelijk.", simpeler: "Gini 0 = gelijk", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Instellingen.", simpeler: "A+R = instellingen", nogSimpeler: "A." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Snel groei.", simpeler: "SSA = bevolking-explosie", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Grondstoffen-paradox.", simpeler: "Resource curse = paradox", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tussen Sahara + savanne.", simpeler: "Sahel = overgang", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "China.", simpeler: "BRI = China", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Kigali = Singapore Afrika", tekst: "**Rwanda**: na 1994-genocide (~800.000 Tutsi's vermoord in 100 dagen) snelle wederopbouw onder Kagame. Tech-hub Kigali, schoonste stad Afrika, weinig corruptie. Schaduw: autoritair regime + persvrijheid beperkt. Toets-favoriet succes-voorbeeld in 'ontwikkelingslanden'." }],
          theorie: "Andere succes: Botswana (diamant + stabiele democratie), Ghana (democratie), Mauritius (toerisme + diensten).",
          niveaus: { basis: "Rwanda.", simpeler: "Rwanda = succes", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2001.", simpeler: "China-WTO = 2001", nogSimpeler: "2001" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Deng.", simpeler: "1978 = Deng", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "India.", simpeler: "2023 = India boven China", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "toetsvraag-pattern: vergelijk China demografisch met India of NL.",
          niveaus: { basis: "Vergrijzing.", simpeler: "China = oud + daalt", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "One country two systems.", simpeler: "HK = 2 systemen erodeert", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Sneller dan BBP.", simpeler: "Handel > BBP-groei", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "ZA.", simpeler: "Hoogste Gini = ZA", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Resource curse.", simpeler: "Nigeria = olie-paradox", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "China.", simpeler: "Afrika = China-partner", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "17 doelen 2030.", simpeler: "SDG = VN-doelen 2030", nogSimpeler: "A." },
        },
      },
    ],
  },
