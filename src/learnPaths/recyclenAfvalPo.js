...
const steps = [
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit voedselverspilling: NL gooit per jaar **34 kg** voedsel per persoon weg. Veel daarvan door verkeerd lezen van THT-datum. Beter: ruik + proef.",
          voorbeelden: [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Waar gooi je **oud papier** in?", options: ["Papierbak / oud papier","Restafval","GFT","Glasbak"], answer: 0, wrongHints: [null, "Dan kan het niet meer gerecycled.", "Voor groente/fruit/tuin — geen papier.", "Voor glas, niet voor papier."] },
