...
const steps = [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Wel goed maar specifiek dit.", "Niet primair.", "Slechtste."],
        uitlegPad: {
          stappen: [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Op welke bak hoort een **glazen fles**?", options: ["Glasbak","GFT","Plastic","Papier"], answer: 0, wrongHints: [null, "Niet — geen organisch.", "Niet.", "Niet."] },
      ...
      { q: "Waar gooi je **oud papier** in?", options: ["Papierbak / oud papier","Restafval","GFT","Glasbak"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "Waar gooi je **kapotte koffer** in?", options: ["Grofvuil / milieustraat","Restafval","Plastic","Papier"], answer: 0, wrongHints: [null, "Niet — past niet.", "Niet.", "Niet."] },
      { q: "Welke is **NIET** recyclebaar in standaard bak?", options: ["Vies plastic met etensresten","Schone plastic fles","Glazen pot","Karton"], answer: 0, wrongHints: [null, "Wel.", "Wel.", "Wel."] },
      { q: "Wat is **circulaire economie**?", options: ["Producten zo maken dat ze hergebruikt kunnen worden","Lineair","Niet relevant","Reclame"], answer: 0, wrongHints: [null, "Tegengestelde.", "Wel.", "Niet."] },
      { q: "Wat doet een **microplastic** in de zee?", options: ["Vissen eten het, ecosysteem schade","Niets","Verdampt","Voedt vissen"], answer: 0, wrongHints: [null, "Wel.", "Niet.", "Tegengestelde."] },
      { q: "**Boyan Slat** is bekend om?", options: ["Ocean Cleanup — plastic uit zee","F1","Schaatsen","Politiek"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "Wat is **composteren**?", options: ["GFT-afval omzetten tot grond","Plastic recyclen","Verbranden","Niet relevant"], answer: 0, wrongHints: [null, "Niet.", "Tegengestelde.", "Wel."] },
      ...
      { q: "**Geluidsoverlast** is welk type vervuiling?", options: ["Geluidsvervuiling","Lucht","Water","Bodem"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      ...
      { q: "Wat is **duurzaam** kopen?", options: ["Lange levensduur + minder schade aan milieu","Veel kopen","Goedkoop","Mooie kleur"], answer: 0, wrongHints: [null, "Tegengestelde.", "Niet altijd.", "Niet relevant."] },
      { q: "Welke afvalsoort wordt **niet** vaak gerecycled?", options: ["Vies/gemengd afval","Glas","Papier","Plastic flessen"], answer: 0, wrongHints: [null, "Wel.", "Wel.", "Wel."] },
      { q: "Wat is **upcycling**?", options: ["Iets oud iets nieuws/beters maken","Recyclen","Storten","Niet relevant"], answer: 0, wrongHints: [null, "Niet specifiek.", "Tegengestelde.", "Wel."] },
      { q: "Welke soort plastic is **beter** voor milieu?", options: ["Hergebruik (geen wegwerp)","Plastic zakje","Wegwerp","Folie"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
    ],
  },
];
