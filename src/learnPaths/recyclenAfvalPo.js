...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Waar gooi je **oud papier** in?", options: ["Papierbak / oud papier","Restafval","GFT","Glasbak"], answer: 0, wrongHints: [null,"Klopt — apart.","Niet.","Niet.","Niet."] },
      { q: "Waar gooi je **kapotte koffer** in?", options: ["Grofvuil / milieustraat","Restafval","Plastic","Papier"], answer: 0, wrongHints: [null,"Klopt — te groot.","Niet — past niet.","Niet.","Niet."] },
      { q: "Welke is **NIET** recyclebaar in standaard bak?", options: ["Vies plastic met etensresten","Schone plastic fles","Glazen pot","Karton"], answer: 0, wrongHints: [null,"Klopt — moet schoon zijn.","Wel.","Wel.","Wel."] },
      { q: "Wat is **circulaire economie**?", options: ["Producten zo maken dat ze hergebruikt kunnen worden","Lineair","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Wel.","Niet."] },
      { q: "Wat doet een **microplastic** in de zee?", options: ["Vissen eten het, ecosysteem schade","Niets","Verdampt","Voedt vissen"], answer: 0, wrongHints: [null,"Klopt — voedselketen.","Wel.","Niet.","Tegengestelde."] },
      { q: "**Boyan Slat** is bekend om?", options: ["Ocean Cleanup — plastic uit zee","F1","Schaatsen","Politiek"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "Wat is **composteren**?", options: ["GFT-afval omzetten tot grond","Plastic recyclen","Verbranden","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — schimmels + bacteriën.","Niet.","Tegengestelde.","Wel."] },
      { q: "Welk symbool zie je op recyclebare verpakkingen?", options: ["3 pijlen-driehoek","Smiley","Dollar","Niet"], answer: 0, wrongHints: [null,"Klopt — Möbius-strip.","Niet.","Niet.","Wel."] },
      { q: "**Geluidsoverlast** is welk type vervuiling?", options: ["Geluidsvervuiling","Lucht","Water","Bodem"], answer: 0, wrongHints: [null,"Klopt — apart type.","Niet.","Niet.","Niet."] },
      { q: "Wat gebeurt met **restafval** uiteindelijk in NL?", options: ["Verbranden in afvalcentrale","Storten","Recyclen","Lozen in zee"], answer: 0, wrongHints: [null,"Klopt — energie eruit.","Niet meer toegestaan.","Niet — kan niet meer.","Verboden."] },
      { q: "Welk **percentage** van NL-afval wordt gerecycled (ongeveer)?", options: ["~60%+","20%","100%","5%"], answer: 0, wrongHints: [null,"Klopt — top in EU.","Te weinig.","Onmogelijk.","Veel te weinig."] },
      { q: "Wat is **duurzaam** kopen?", options: ["Lange levensduur + minder schade aan milieu","Veel kopen","Goedkoop","Mooie kleur"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Niet altijd.","Niet relevant."] },
      { q: "Welke afvalsoort wordt **niet** vaak gerecycled?", options: ["Vies/gemengd afval","Glas","Papier","Plastic flessen"], answer: 0, wrongHints: [null,"Klopt — moet schoon zijn.","Wel.","Wel.","Wel."] },
      { q: "Wat is **upcycling**?", options: ["Iets oud iets nieuws/beters maken","Recyclen","Storten","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — bv. oude pallet → tafel.","Niet specifiek.","Tegengestelde.","Wel."] },
      { q: "Welke soort plastic is **beter** voor milieu?", options: ["Hergebruik (geen wegwerp)","Plastic zakje","Wegwerp","Folie"], answer: 0, wrongHints: [null,"Klopt — bv. herbruikbare fles.","Niet.","Niet.","Niet."] },
    ],
  },
];
