    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Ethogram.",
            simpeler: "Een ethogram is een tabel waarin een bioloog gedragingen van dieren beschrijft.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Bijnieren.",
            simpeler: "Adrenaline komt uit de bijnieren (boven de nieren). Bij stress: bijnier knijpt → adrenaline in bloed → vechten of vluchten.",
            nogSimpeler: "Bijnier",
          },
        },
      },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Alleen secundaire kenmerken.",
            simpeler: "Hormonen veranderen uiterlijke (secundaire) kenmerken zoals borsten en vetverdeling. Geboren-mee (primaire) organen veranderen niet door hormonen.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Alleen Finn.",
            simpeler: "Finn (straling kan mutatie veroorzaken): KLOPT. Ilse (alleen in geslachtscellen): KLOPT NIET — mutaties zijn er in elke cel.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Kiemlaag.",
            simpeler: "Pigmentcellen (melanocyten) zitten in de kiemlaag — de levende onderlaag van de opperhuid. Daar wordt melanine gemaakt die de huid bruin kleurt.",
