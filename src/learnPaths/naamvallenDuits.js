    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "den Mann.", simpeler: "Mannelijk acc = den.", nogSimpeler: "den." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "der Frau.", simpeler: "Vrouwelijk dat = der.", nogSimpeler: "der." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "mit dem Auto.", simpeler: "Mit = dat.", nogSimpeler: "dem." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "in den Park.", simpeler: "Gaan → acc.", nogSimpeler: "den." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "ohne die Mutter.", simpeler: "ohne + acc.", nogSimpeler: "die." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "den Hund.", simpeler: "Acc + den.", nogSimpeler: "den." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "der Lehrerin.", simpeler: "Mit + der (vrouw dat).", nogSimpeler: "der." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "dem Kind.", simpeler: "Helfen + dat (dem).", nogSimpeler: "dem." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "vrouw acc = die", uitleg: "geen verandering vs nom" }],
          niveaus: { basis: "für die Mutter.", simpeler: "Für + die (vrouw).", nogSimpeler: "die." },
        },
      },
