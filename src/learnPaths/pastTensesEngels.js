    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "klinker + y blijft y, dus +ed.",
          voorbeelden: [{ type: "voorbeeld", tekst: "play→played, stay→stayed" }],
          basiskennis: [{ onderwerp: "regel y", uitleg: "cons + y → -ied (cry→cried)" }],
          niveaus: { basis: "played.", simpeler: "play + ed.", nogSimpeler: "played." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "1 klinker + 1 medeklinker → letter verdubbelen + ed.",
          voorbeelden: [{ type: "voorbeeld", tekst: "stop→stopped, plan→planned, run→running" }],
          basiskennis: [{ onderwerp: "korte klank", uitleg: "stóp niet stoop" }],
          niveaus: { basis: "stopped.", simpeler: "Dubbele p + ed.", nogSimpeler: "stopped." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Did + basisvorm", tekst: "Did you see ...? — niet 'saw'." }],
          woorden: [{ woord: "did", uitleg: "verleden tijd zit hierin" }],
          theorie: "Vraag past simple: did + onderwerp + basisvorm.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Did she eat? · Did they go?" }],
          basiskennis: [{ onderwerp: "geen V2", uitleg: "did absorbeert het verleden" }],
          niveaus: { basis: "Did you see?", simpeler: "Did + onderwerp + see.", nogSimpeler: "Did + basisvorm." },
        },
      },
      {
        q: "Welke is **goed**?",
        ...
        uitlegPad: {
          ...
          theorie: "Ontkenning past simple: didn't + basisvorm.",
          voorbeelden: [{ type: "voorbeeld", tekst: "She didn't go. I didn't see." }],
          basiskennis: [{ onderwerp: "verleden in didn't", uitleg: "alleen V1 erna" }],
          niveaus: { basis: "She didn't go.", simpeler: "Didn't + go.", nogSimpeler: "didn't go." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Have/has + V3. I/you/we/they → have. He/she/it → has.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I have eaten. She has gone." }],
          basiskennis: [{ onderwerp: "eat→ate→eaten", uitleg: "V1, V2, V3" }],
          niveaus: { basis: "I have eaten.", simpeler: "Have + eaten (V3).", nogSimpeler: "I've eaten." },
        },
      },
      {
        q: "Wat is V3 van **see**?",
        ...
        uitlegPad: {
          stappen: [{ titel: "see-saw-seen", tekst: "V1 see, V2 saw, V3 seen." }],
          woorden: [{ woord: "V3", uitleg: "past participle, gebruik na have/has" }],
          theorie: "Onregelmatige werkwoorden: drie vormen leren.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I have seen the film" }],
          basiskennis: [{ onderwerp: "leerlijst", uitleg: "onregelmatige V1-V2-V3 uit hoofd" }],
          niveaus: { basis: "seen.", simpeler: "V3 = seen.", nogSimpeler: "seen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "'Twice', 'three times' zonder vast tijdstip → perfect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I've been there twice" }],
          basiskennis: [{ onderwerp: "context", uitleg: "ervaring beschrijven" }],
          niveaus: { basis: "have seen.", simpeler: "Perfect + V3.", nogSimpeler: "have + seen." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Since/for + duur tot nu → present perfect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "since 2018 · for 5 years" }],
          basiskennis: [{ onderwerp: "since vs for", uitleg: "since=tijdstip, for=duur" }],
          niveaus: { basis: "have lived.", simpeler: "Have + lived.", nogSimpeler: "We've lived." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Just/already/ever/never: tussen have en V3.",
          voorbeelden: [{ type: "voorbeeld", tekst: "She has just left" }],
          basiskennis: [{ onderwerp: "yet", uitleg: "yet aan EIND" }],
          niveaus: { basis: "I have already eaten.", simpeler: "Have + already + V3.", nogSimpeler: "already in midden." },
        },
      },
      {
        q: "Welke is **goed**?",
        ...
        uitlegPad: {
          ...
          theorie: "Yet staat aan einde, in vraag of ontkenning.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I haven't done it yet." }],
          basiskennis: [{ onderwerp: "verschil", uitleg: "yet ≠ already (already al gebeurd)" }],
          niveaus: { basis: "Have you finished yet?", simpeler: "Yet achteraan.", nogSimpeler: "... yet?" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Periode nog open (this week/month/year) → perfect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I've eaten pizza twice this month" }],
          basiskennis: [{ onderwerp: "vs last week", uitleg: "last week (gesloten) → simple" }],
          niveaus: { basis: "have seen.", simpeler: "Have + seen.", nogSimpeler: "have seen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Perfect = gevolg nu (sleutels nog zoek).",
          voorbeelden: [{ type: "voorbeeld", tekst: "She has lost her phone" }],
          basiskennis: [{ onderwerp: "lost", uitleg: "V2 én V3 zijn beide 'lost'" }],
          niveaus: { basis: "I have lost.", simpeler: "Have + lost.", nogSimpeler: "have lost." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Since 2020 (tijdstip) → perfect. For 5 years (duur) → perfect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "since Monday · for 3 hours" }],
          basiskennis: [{ onderwerp: "tot nu nog steeds", uitleg: "doorlopend → perfect" }],
          niveaus: { basis: "have lived.", simpeler: "Have + lived.", nogSimpeler: "I've lived." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "'s + V3 (gone) = has gone. 's + V-ing (going) = is going.",
          voorbeelden: [{ type: "voorbeeld", tekst: "He's left = he has left" }],
          basiskennis: [{ onderwerp: "ambigu", uitleg: "context bepaalt" }],
          niveaus: { basis: "She has gone home.", simpeler: "'s = has voor V3.", nogSimpeler: "She has gone." },
        },
      },
      {
        q: "Wat is **haven't**?",
        ...
        uitlegPad: {
          stappen: [{ titel: "haven't = have not", tekst: "Contractie van have + not." }],
          woorden: [{ woord: "ontkenning", uitleg: "have not = haven't" }],
          theorie: "Have + n't = haven't. Has + n't = hasn't.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I haven't done it · She hasn't seen it" }],
          basiskennis: [{ onderwerp: "spreektaal", uitleg: "korte vorm gebruiken" }],
          niveaus: { basis: "haven't = have not.", simpeler: "Have niet → haven't.", nogSimpeler: "have not." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Vast jaartal → past simple → V2.",
          voorbeelden: [{ type: "voorbeeld", tekst: "in 2018, last year, two days ago" }],
          basiskennis: [{ onderwerp: "went", uitleg: "V2 van go" }],
          niveaus: { basis: "went.", simpeler: "Verleden = went.", nogSimpeler: "went." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Ever/never → perfect (ervaring zonder vast tijdstip).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Have you ever been to Japan?" }],
          basiskennis: [{ onderwerp: "see→seen", uitleg: "V3 = seen" }],
          niveaus: { basis: "Have / seen.", simpeler: "Have + ever + seen.", nogSimpeler: "Have seen." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "For (duur tot nu) → perfect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "for 3 days/years/hours" }],
          basiskennis: [{ onderwerp: "known", uitleg: "V3 van know" }],
          niveaus: { basis: "have known.", simpeler: "Have + known.", nogSimpeler: "have known." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Ervaring zonder vast tijdstip → perfect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I have never tried sushi" }],
          basiskennis: [{ onderwerp: "watch", uitleg: "regelmatig: watched (V2=V3)" }],
          niveaus: { basis: "has / watched.", simpeler: "Has + never + watched.", nogSimpeler: "Has watched." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Klaar zijn met effect nu → perfect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I've finished, so I can play" }],
          basiskennis: [{ onderwerp: "finish", uitleg: "regelmatig: finished" }],
          niveaus: { basis: "have finished.", simpeler: "Klaar nu = have + V3.", nogSimpeler: "I've finished." },
        },
      },
      {
