    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Koolstof.", simpeler: "6 = C.", nogSimpeler: "C." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Atoomnummer.", simpeler: "Aantal protonen.", nogSimpeler: "Z." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8 neutronen.", simpeler: "16 - 8 = 8.", nogSimpeler: "8." },
        },
      },
      {
        q: "Wat zijn isotopen?",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2.", simpeler: "K = 2.", nogSimpeler: "2." },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Groep 18.", simpeler: "Laatste kolom.", nogSimpeler: "18." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Zuurstof.", simpeler: "O = niet-metaal.", nogSimpeler: "O." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3.", simpeler: "1+2 = 3.", nogSimpeler: "3." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2.", simpeler: "H met 2 erachter.", nogSimpeler: "2." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Natrium.", simpeler: "11 = Na.", nogSimpeler: "Na." },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "24.", simpeler: "6+12+6.", nogSimpeler: "24." },
        },
      },
      {
