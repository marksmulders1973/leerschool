...
const chapters = [
  ...
  { letter: "F", title: "Erfenis + Doorstroomtoets-mix", emoji: "🏆", from: 5, to: 5 },
];
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Begin keizerrijk.", "Val West-Rome.", "Te laat — middeleeuwen."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Latere keizers.", "Andere Romeinen.", "Shakespeare-stuk, niet Rome."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Wonen in Griekenland.", "Wonen in Duitsland.", "Wonen in Frankrijk."],
      },
    ],
  },
  ...
  // STAP 4: Romeinen in Nederland
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Vikingen kwamen veel later.", "Niet in Romeinse tijd.", "Verkeerd continent."],
      },
      {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Begin keizerrijk.", "Val Constantinopel.", "Te laat."],
      },
      {
        q: "Wie waren de **Germaanse volken** die binnenvielen?",
        options: ["Goten, Vandalen, Hunnen, Franken", "Egyptenaren", "Grieken", "Maya's"],
        answer: 0,
        wrongHints: [null, "Romeinen veroverden Egypte juist eerder.", "Grieken al deel rijk.", "Andere continent."],
      },
      {
        q: "Wie was de leider van de **Hunnen** (~450 n.Chr.)?",
        options: ["Attila", "Alarik", "Odoaker", "Constantijn"],
        answer: 0,
        wrongHints: [null, "Was Got, niet Hun.", "Was Germaan in Italië.", "Was Romeinse keizer."],
      },
      {
  ...
  // STAP 6: Erfenis + Doorstroomtoets-mix
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Tempel, geen arena.", "Acropolis in Athene.", "Veel later."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Een ander, jongere Caesar.", "Andere keizer.", "Politicus, niet uitspraak."],
      },
      {
        q: "Welk **NL gebouw of stad** is van Romeinse oorsprong?",
        options: ["Nijmegen", "Den Haag", "Almere", "Lelystad"],
        answer: 0,
        wrongHints: [null, "Den Haag van middeleeuwen.", "20e eeuw.", "20e eeuw."],
      },
      {
