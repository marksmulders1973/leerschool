    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "helling", uitleg: "Δy/Δx van rechte lijn" }],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Top = helling 0", tekst: "De top van een parabool is plat → helling 0. Bij y = x² is dat (0, 0)." }],
          woorden: [{ woord: "top", uitleg: "laagste/hoogste punt van parabool" }],
          theorie: "f'(x) = 2x → 2x = 0 → x = 0. Top bij (0, 0).",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² heeft top (0, 0), helling daar = 0" }],
          basiskennis: [{ onderwerp: "raaklijn", uitleg: "horizontaal in top" }],
          niveaus: { basis: "Top (0, 0) → helling = 0.", simpeler: "Onderkant is plat.", nogSimpeler: "Diepste punt." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "afgeleide", uitleg: "formule voor helling per punt" }],
          theorie: "y = x² → helling = 2x. Vul x in.",
          voorbeelden: [{ type: "voorbeeld", tekst: "x=1 → 2, x=2 → 4, x=3 → 6" }],
          basiskennis: [{ onderwerp: "patroon", uitleg: "n·x^(n-1)" }],
          niveaus: { basis: "2·3 = 6.", simpeler: "Vul x=3 in 2x.", nogSimpeler: "Antwoord 6." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "f'(4) = 2·4 = 8", tekst: "f(x) = x² → f'(x) = 2x → f'(4) = 8." }],
          woorden: [{ woord: "f'(a)", uitleg: "helling van f in punt x = a" }],
          theorie: "Eerst afgeleide opschrijven, dan invullen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "f(2) = 4 (y-waarde), f'(2) = 4 (helling)" }],
          basiskennis: [{ onderwerp: "f vs f'", uitleg: "f geeft y, f' geeft helling" }],
          niveaus: { basis: "f'(x) = 2x. f'(4) = 8.", simpeler: "Vul x=4 in 2x.", nogSimpeler: "2 keer 4 = 8." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x⁵ → 5x⁴.", simpeler: "Exponent voor, dan -1.", nogSimpeler: "5 voor x, dan x⁴." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Constante → 0", tekst: "f(x) = 12 is een vlakke lijn → helling = 0." }],
          woorden: [{ woord: "constante", uitleg: "getal zonder x" }],
          theorie: "Vlakke lijn heeft overal helling 0.",
          voorbeelden: [{ type: "voorbeeld", tekst: "f = 5, 7, -3 → f' = 0 altijd" }],
          basiskennis: [{ onderwerp: "som-regel", uitleg: "constante verdwijnt bij differentiëren" }],
          niveaus: { basis: "f' = 0.", simpeler: "Geen x → geen helling.", nogSimpeler: "Vlak → 0." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "coëfficiënt", uitleg: "getal voor de x" }],
          theorie: "Coëfficiënt × exponent → nieuwe coëfficiënt.",
          voorbeelden: [{ type: "voorbeeld", tekst: "5x³ → 15x², 7x² → 14x" }],
          basiskennis: [{ onderwerp: "vermenigvuldig", uitleg: "niet optellen" }],
          niveaus: { basis: "6·4 = 24, x³.", simpeler: "6 keer 4 voor, exponent -1.", nogSimpeler: "24x³." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Som-regel", tekst: "x³ → 3x². 4x² → 8x. Samen: 3x² + 8x." }],
          woorden: [{ woord: "som-regel", uitleg: "elke term apart" }],
          theorie: "(f + g)' = f' + g'. Term voor term differentiëren.",
          voorbeelden: [{ type: "voorbeeld", tekst: "x³ + 4x² → 3x² + 8x" }],
          basiskennis: [{ onderwerp: "twee termen", uitleg: "elk apart, dan optellen" }],
          niveaus: { basis: "3x² + 8x.", simpeler: "Term 1: 3x². Term 2: 8x.", nogSimpeler: "Elke term apart." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "constante", uitleg: "verdwijnt: 7 → 0" }],
          theorie: "Coëfficiënt × exponent. Constante valt weg.",
          voorbeelden: [{ type: "voorbeeld", tekst: "3·3 = 9, -2·2 = -4" }],
          basiskennis: [{ onderwerp: "tekens", uitleg: "min blijft min" }],
          niveaus: { basis: "9x² − 4x (7 verdwijnt).", simpeler: "3·3=9, -2·2=-4, 7→0.", nogSimpeler: "Term voor term." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "invullen", uitleg: "x-waarde in f'(x)" }],
          theorie: "Stap 1: afgeleide. Stap 2: x invullen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "f' = 2x + 3, vul 1 in → 5" }],
          basiskennis: [{ onderwerp: "alles invullen", uitleg: "elke term met x" }],
          niveaus: { basis: "f'(1) = 2 + 3 = 5.", simpeler: "Vul 1 in 2x + 3.", nogSimpeler: "2·1 + 3 = 5." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "y = ax + b", tekst: "Helling a = f'(1) = 2. Door (1,1): 1 = 2 + b → b = -1. y = 2x − 1." }],
          woorden: [{ woord: "raaklijn", uitleg: "rechte lijn die kromme raakt" }],
          theorie: "1) Helling = f'(x₀). 2) Punt invullen voor b.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Door (1,1) met helling 2: y = 2x − 1" }],
          basiskennis: [{ onderwerp: "stappen", uitleg: "altijd a éérst, dan b" }],
          niveaus: { basis: "y = 2x − 1.", simpeler: "Helling 2, door (1,1).", nogSimpeler: "Reken b uit: -1." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "som-regel", uitleg: "elke term apart" }],
          theorie: "Bij elke term: coëfficiënt × exponent.",
          voorbeelden: [{ type: "voorbeeld", tekst: "4·3 = 12, 6·2 = 12" }],
          basiskennis: [{ onderwerp: "2x", uitleg: "afgeleide van 2x is 2" }],
          niveaus: { basis: "12x² − 12x + 2.", simpeler: "Elke term apart.", nogSimpeler: "Coëfficiënt × exponent." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "afgeleide van x", uitleg: "= 1, niet 0" }],
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "f'(x) = 2x − 8 = 0", tekst: "2x = 8 → x = 4." }],
          woorden: [{ woord: "minimum", uitleg: "f'(x) = 0 op het dal" }],
          theorie: "Stel afgeleide = 0, los op.",
          voorbeelden: [{ type: "voorbeeld", tekst: "x² − 8x + 12 → minimum bij x = 4" }],
          basiskennis: [{ onderwerp: "a > 0", uitleg: "dalparabool" }],
          niveaus: { basis: "2x − 8 = 0 → x = 4.", simpeler: "Helling 0 bij x = 4.", nogSimpeler: "x = 4." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Helling = 6, door (3, 9)", tekst: "f'(3) = 6. Door (3, 9): 9 = 18 + b → b = -9. y = 6x − 9." }],
          woorden: [{ woord: "raaklijn-vergelijking", uitleg: "y = ax + b" }],
          theorie: "a = f'(3) = 6. Vul (3, 9) in om b te vinden.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = 6x − 9" }],
          basiskennis: [{ onderwerp: "check", uitleg: "6·3 − 9 = 9 ✓" }],
          niveaus: { basis: "y = 6x − 9.", simpeler: "Helling 6, b = -9.", nogSimpeler: "9 = 6·3 − 9." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "winst-maximum", uitleg: "stel W'(x) = 0" }],
          theorie: "Optimum (max winst) waar W'(x) = 0.",
          voorbeelden: [{ type: "voorbeeld", tekst: "-4·10 + 40 = 0" }],
          basiskennis: [{ onderwerp: "a < 0", uitleg: "bergparabool → max" }],
          niveaus: { basis: "x = 10 stuks.", simpeler: "-4x + 40 = 0 → x = 10.", nogSimpeler: "10 stuks." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "hoogste punt", uitleg: "verticale snelheid 0 (h'=0)" }],
          theorie: "Op maximum hoogte: snelheid 0.",
          voorbeelden: [{ type: "voorbeeld", tekst: "-10·2 + 20 = 0" }],
          basiskennis: [{ onderwerp: "natuurkundig", uitleg: "h' = verticale snelheid" }],
          niveaus: { basis: "t = 2 s.", simpeler: "Op max: h' = 0.", nogSimpeler: "2 seconden." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "f'(x) = 0 oplossen", tekst: "f'(x) = 6x² − 24x + 18 = 0 → x² − 4x + 3 = 0 → (x-1)(x-3) = 0." }],
          woorden: [{ woord: "twee extrema", uitleg: "kubische functie heeft max + min" }],
          theorie: "Bij f'(x) = 0: factoriseren of abc-formule.",
          voorbeelden: [{ type: "voorbeeld", tekst: "(x-1)(x-3) = 0 → x = 1, 3" }],
          basiskennis: [{ onderwerp: "abc", uitleg: "afgeleide is parabool → max 2 nulpunten" }],
          niveaus: { basis: "x = 1 en x = 3.", simpeler: "(x-1)(x-3) = 0.", nogSimpeler: "Twee nulpunten." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "invullen", uitleg: "elke term met x" }],
          theorie: "Afgeleide opstellen, dan x invullen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "-6·1 + 12 = 6" }],
          basiskennis: [{ onderwerp: "tekens", uitleg: "let op −" }],
