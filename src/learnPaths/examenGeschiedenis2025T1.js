    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Passief kiesrecht. D.", simpeler: "Suze werd GEKOZEN (kandidaat) = passief kiesrecht. Actief = zelf STEMMEN.", nogSimpeler: "Passief" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verzetten niet tegen Hitler. C.", simpeler: "Cartoon: leiders dragen Hitler op schouders = leiders doen niets tegen Hitler's machtsuitbreiding (appeasement).", nogSimpeler: "Geen verzet" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oorlog voorkomen. C.", simpeler: "Chamberlain wilde geen nieuwe WO. Daarom akkoord met Hitler om Sudetenland weg te geven = oorlog VOORKOMEN.", nogSimpeler: "Geen oorlog" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Versloeg nazi-Duitsland. D.", simpeler: "Stalin won WO2 tegen Hitler. Veel waardering om 'redder van moederland'-imago.", nogSimpeler: "WO2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "EGKS. B.", simpeler: "Schuman-plan → EGKS (1951, kolen+staal samen). Voorloper EU.", nogSimpeler: "EGKS" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Cubacrisis. B.", simpeler: "1962 + kernoorlog dichtbij = Cubacrisis (Sovjet-raketten op Cuba, 90 km van VS).", nogSimpeler: "Cubacrisis" },
        },
      },
    ],
  },
