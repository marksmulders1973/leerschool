    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Passief kiesrecht.", simpeler: "Suze werd GEKOZEN (kandidaat) = passief kiesrecht. Actief = zelf STEMMEN.", nogSimpeler: "Passief" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verzetten niet tegen Hitler.", simpeler: "Cartoon: leiders dragen Hitler op schouders = leiders doen niets tegen Hitler's machtsuitbreiding (appeasement).", nogSimpeler: "Geen verzet" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oorlog voorkomen.", simpeler: "Chamberlain wilde geen nieuwe WO. Daarom akkoord met Hitler om Sudetenland weg te geven = oorlog VOORKOMEN.", nogSimpeler: "Geen oorlog" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Versloeg nazi-Duitsland.", simpeler: "Stalin won WO2 tegen Hitler. Veel waardering om 'redder van moederland'-imago.", nogSimpeler: "WO2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "EGKS.", simpeler: "Schuman-plan → EGKS (1951, kolen+staal samen). Voorloper EU.", nogSimpeler: "EGKS" },
        },
      },
    ],
  },
