    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Zonder lezen = fouten.", "Eerst snappen wat vraag is.", "Geen strategie."],
      },
      {
        q: "Vraag: *'Wat betaalt hij na **30% korting** op €50?'* Wat reken je?",
        options: ["70% van €50 = €35", "30% van €50 = €15", "€50 + 30%", "€50 + €15"],
        answer: 0,
        wrongHints: [null, "Klopt — je betaalt 100% − 30% = 70%.", "Dat is wat je BESPAART, niet wat je betaalt.", "Verkeerde richting.", "Optellen van fout bedrag."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — controle-stap.", "Niet primair doel.", "Niet.", "Wel nuttig."],
      },
      {
        q: "Vraag vraagt **oppervlak in cm²** — wat schrijf je?",
        options: ["Cijfer + cm²", "Cijfer alleen", "Cijfer + m²", "In mm²"],
        answer: 0,
        wrongHints: [null, "Klopt — eenheid mee.", "Mist eenheid.", "Verkeerde eenheid.", "Verkeerde eenheid."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        options: ["23", "35", "27", "20"],
        answer: 0,
        wrongHints: [null, "Klopt — keer eerst.", "Met haakjes (3+4)×5.", "Niet.", "Alleen 4×5."],
      },
      {
        q: "**(3 + 4) × 5** = ?",
        options: ["35", "23", "27", "20"],
        answer: 0,
        wrongHints: [null, "Klopt — haakjes eerst.", "Zonder haakjes.", "Niet.", "Alleen 4×5."],
      },
      {
        q: "**5 − (−3)** = ?",
        options: ["8", "2", "−8", "−2"],
        answer: 0,
        wrongHints: [null, "Klopt — − van min = +.", "Verkeerde teken.", "Verkeerd.", "Verkeerd."],
      },
      {
        q: "**−2 × −3** = ?",
        options: ["6", "−6", "5", "−5"],
        answer: 0,
        wrongHints: [null, "Klopt — min × min = plus.", "Verkeerd teken.", "Optelling.", "Optelling met -."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — sneller in hoofd.", "Wel nodig.", "Wel nodig.", "Wel nodig."],
      },
      {
        q: "Veiligste manier om **25% van X** te rekenen?",
        options: ["× 0,25", "× 25%", "÷ 4", "Alles werkt"],
        answer: 0,
        wrongHints: [null, "Klopt — werkt op elke rekenmachine.", "%-knop niet uniform.", "Klopt qua antwoord, maar omslachtiger.", "%-knop kan fout gaan."],
      },
      {
        q: "Bij goniometrie op rekenmachine — welke modus?",
        options: ["Degree (graden) — standaard CSE", "Radian", "Float", "Modus maakt niet uit"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor hogere wiskunde.", "Display-mode, niet relevant.", "Wel uit — geeft fouten."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — voor controle.", "Niet zichtbaar later.", "Slecht idee.", "Wel doen."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — a²+b²=c² waar c hypotenusa.", "Voor gelijkzijdige andere regels.", "Niet hier.", "Niet — alleen rechthoekige."],
      },
      {
        q: "Formule oppervlakte **driehoek**?",
        options: ["½ × basis × hoogte", "basis × hoogte", "π × r²", "2(l + b)"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is rechthoek.", "Dat is cirkel.", "Dat is omtrek rechthoek."],
      },
      {
        q: "Formule volume **kubus** met zijde z?",
        options: ["z³ (z × z × z)", "z²", "6 × z²", "z"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is oppervlak 1 vlak.", "Totaal oppervlak alle vlakken.", "Eenheid zijde."],
      },
      {
        q: "Welk **trigger-woord** wijst op procenten-vraag?",
        options: ["korting", "schaal", "volume", "gemiddelde"],
        answer: 0,
        wrongHints: [null, "Klopt — % berekening.", "Verhouding.", "Ruimte.", "Statistiek."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Te kort.", "Te lang.", "Te kort."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — niet vastlopen.", "Verspilt te veel tijd.", "Wel later terugkomen.", "Eerst even nadenken."],
      },
      {
        q: "Bij **meerkeuze** en niet zeker — wat doe je?",
        options: ["Iets invullen (gokken)", "Leeglaten", "Vraag overslaan", "Buurman kopiëren"],
        answer: 0,
        wrongHints: [null, "Klopt — beter gokken dan leeg.", "Levert 0 op.", "Wel terug, maar uiteindelijk vullen.", "Spieken = uitsluiting."],
      },
      {
        q: "Wat doe je in de laatste **5 minuten**?",
        options: ["Antwoorden controleren", "Nieuwe vraag starten", "Stoppen", "Speed-typen"],
        answer: 0,
        wrongHints: [null, "Klopt — kostbare check-tijd.", "Te krap.", "Niet als er tijd is.", "Niet typen — schrijven."],
      },
    ],
  },
