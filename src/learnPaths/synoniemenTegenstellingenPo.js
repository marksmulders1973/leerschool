...
const steps = [
  ...
  // STAP 5: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "Synoniem van **hard**?", options: ["luid","zacht","stil","klein"], answer: 0, wrongHints: [null,"Klopt — bij geluid.","Tegenstelling.","Tegenstelling.","Niet."] },
      { q: "Tegenstelling van **rijk**?", options: ["arm","duur","groot","mooi"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet relevant.","Niet."] },
      { q: "Synoniem van **belangrijk**?", options: ["essentieel","onbelangrijk","klein","saai"], answer: 0, wrongHints: [null,"Klopt — zelfde betekenis.","Tegenstelling.","Niet.","Niet."] },
      { q: "Tegenstelling van **dag**?", options: ["nacht","ochtend","middag","week"], answer: 0, wrongHints: [null,"Klopt.","Onderdeel van dag.","Onderdeel van dag.","Niet tegengesteld."] },
      { q: "Synoniem van **vrolijk**?", options: ["blij","boos","stil","slim"], answer: 0, wrongHints: [null,"Klopt.","Tegenstelling.","Niet emotie.","Niet."] },
      { q: "Tegenstelling van **jong**?", options: ["oud","klein","groot","langzaam"], answer: 0, wrongHints: [null,"Klopt — leeftijd.","Niet over leeftijd.","Niet.","Niet."] },
      { q: "Synoniem van **eenvoudig**?", options: ["makkelijk","moeilijk","lang","snel"], answer: 0, wrongHints: [null,"Klopt.","Tegenstelling.","Niet.","Niet."] },
      { q: "Tegenstelling van **schoon**?", options: ["vies","mooi","groot","stil"], answer: 0, wrongHints: [null,"Klopt.","Niet over reinheid.","Niet.","Niet."] },
      { q: "Synoniem van **bang**?", options: ["angstig","blij","stoer","sterk"], answer: 0, wrongHints: [null,"Klopt.","Tegenstelling.","Tegenstelling.","Niet."] },
      { q: "Tegenstelling van **boven**?", options: ["onder","naast","achter","voor"], answer: 0, wrongHints: [null,"Klopt.","Horizontaal.","Diepte.","Niet."] },
      { q: "Synoniem van **veel**?", options: ["talloos","weinig","klein","traag"], answer: 0, wrongHints: [null,"Klopt — hetzelfde idee.","Tegenstelling.","Niet.","Niet."] },
      { q: "Tegenstelling van **warm**?", options: ["koud","heet","zacht","stil"], answer: 0, wrongHints: [null,"Klopt.","Synoniem.","Andere zin.","Niet."] },
      { q: "Synoniem van **slim**?", options: ["intelligent","dom","klein","langzaam"], answer: 0, wrongHints: [null,"Klopt.","Tegenstelling.","Niet.","Niet."] },
      { q: "Tegenstelling van **leeg**?", options: ["vol","stil","groot","klein"], answer: 0, wrongHints: [null,"Klopt.","Geen relatie.","Niet.","Niet."] },
      { q: "Synoniem van **stil**?", options: ["rustig","luid","druk","fel"], answer: 0, wrongHints: [null,"Klopt.","Tegenstelling.","Niet.","Niet."] },
    ],
  },
];
