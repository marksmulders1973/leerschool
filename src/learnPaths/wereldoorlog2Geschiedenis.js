    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Schuld + betalen + klein leger.", simpeler: "Versailles dwong Duitsland tot: schuld bekennen, betalen, klein leger.", nogSimpeler: "Straf voor Duitsland" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vernedering.", simpeler: "Duitsers voelden Versailles als vernedering — dwang + schuld alleen op hen.", nogSimpeler: "Schaamte" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Beurscrash.", simpeler: "Oktober 1929 = beurs NY crashte, begin wereldcrisis.", nogSimpeler: "Crisis" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Armoede + werkloosheid.", simpeler: "NSDAP groeide door crisis: werkloos + arm volk zocht extreme oplossingen.", nogSimpeler: "Wanhoop" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oostenrijk ingenomen.", simpeler: "Anschluss 1938 = Duitsland lijfde Oostenrijk in zonder oorlog.", nogSimpeler: "Oostenrijk = Duitsland" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Toegeven aan Hitler.", simpeler: "Appeasement = Engeland/Frankrijk gaven Hitler steeds iets om oorlog te voorkomen. Mislukte.", nogSimpeler: "Toegeven" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Versailles + crisis + Hitler.", simpeler: "3 oorzaken: Versailles → boos. Crisis → arm. Hitler → extreem. Samen = WO2.", nogSimpeler: "3 dingen samen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Polen.", simpeler: "1 september 1939 = Duitsland viel Polen binnen. WO2 begon.", nogSimpeler: "Polen" },
        },
      },
      {
        q: "Wat is **Blitzkrieg**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tanks + luchtmacht samen.", simpeler: "Blitzkrieg = razendsnel + tanks + luchtmacht tegelijk. Vijand had geen tijd.", nogSimpeler: "Snel" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "14 mei 1940.", simpeler: "Rotterdam-bombardement = 14 mei 1940, Duitsers braken NL-verzet.", nogSimpeler: "14 mei 1940" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Koningin Wilhelmina.", simpeler: "Radio Oranje = stem koningin Wilhelmina vanuit Londen voor bezet NL.", nogSimpeler: "Koningin" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5 dagen.", simpeler: "Gevecht mei 1940 NL = 5 dagen (10-15 mei). Daarna 5 JAAR bezetting.", nogSimpeler: "5 dagen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Pro-Duitse NL-partij.", simpeler: "NSB = NL-nazi-partij van Mussert, werkte samen met Duitse bezetters.", nogSimpeler: "NL-nazi's" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Enige tegen jodenvervolging in Europa.", simpeler: "Februaristaking 1941 = enige openlijke staking tegen jodenvervolging in heel bezet Europa.", nogSimpeler: "Enige in Europa" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Samenwerken met vijand.", simpeler: "Collaboratie = met bezetter samenwerken, tegen eigen land. NSB deed dit.", nogSimpeler: "Heulen met vijand" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Landing Normandië.", simpeler: "D-Day = 6 juni 1944, geallieerde landing in Frankrijk. Keerpunt.", nogSimpeler: "Landing" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Keerpunt oostfront.", simpeler: "Stalingrad = slag in USSR waar Duitse opmars stopte. Keerpunt oostfront.", nogSimpeler: "Keerpunt" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Voedseltekort west-NL.", simpeler: "Hongerwinter 1944-1945 = honger in bezet west-NL door Duitse blokkade. ~20.000 doden.", nogSimpeler: "Honger NL" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5 mei 1945.", simpeler: "NL bevrijd = 5 mei 1945, capitulatie Wageningen.", nogSimpeler: "5 mei" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Japan capituleert.", simpeler: "15 augustus = einde WO2 Azië, Japan gaf zich over. Belangrijk voor Indië-NL'ers.", nogSimpeler: "Japan klaar" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4=herdenken / 5=vieren.", simpeler: "4 mei = doden herdenken (stil). 5 mei = vrijheid vieren (feest).", nogSimpeler: "4=stil 5=feest" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Moord op 6 miljoen joden.", simpeler: "Holocaust = nazi-moord op ~6 miljoen joden 1941-1945. Industrieel in kampen.", nogSimpeler: "Joden vermoord" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Doorgangskamp NL.", simpeler: "Westerbork = doorgangskamp Drenthe waar NL-joden verzameld werden voor trein naar Auschwitz.", nogSimpeler: "Doorgang" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "27 januari.", simpeler: "Internationale Holocaust-herdenking = 27 januari (Auschwitz bevrijd 1945).", nogSimpeler: "27 jan" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Berechting nazi's.", simpeler: "Neurenberg-processen 1945-46 = rechtszaken tegen top-nazi's. Eerste internationale strafrecht.", nogSimpeler: "Nazi-rechtszaken" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "VS vs USSR.", simpeler: "Koude Oorlog = spanning VS↔Sovjet-Unie zonder echt vechten. 1945-1989.", nogSimpeler: "VS vs Rusland" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Indonesië.", simpeler: "1949 = Indonesië onafhankelijk van NL. Einde Nederlands-Indië.", nogSimpeler: "Indonesië" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1939.", simpeler: "WO2 begon 1 september 1939 (Polen-inval).", nogSimpeler: "1939" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Anne eerst (1942).", simpeler: "Anne dook onder 1942 → D-Day juni 1944. Anne eerst, 2 jaar verschil.", nogSimpeler: "Anne eerst" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Indonesië onafhankelijk.", simpeler: "Direct NL-gevolg WO2 = verlies Nederlands-Indië, Indonesië onafhankelijk 1949.", nogSimpeler: "Indonesië weg" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Versailles + crisis + Hitler.", simpeler: "3 oorzaken WO2: Versailles (boos) + crisis (arm) + Hitler (extreem).", nogSimpeler: "3 dingen samen" },
        },
      },
    ],
  },
