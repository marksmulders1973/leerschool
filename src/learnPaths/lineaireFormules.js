...
<text x="150" y="186" text-anchor="middle" fill="${COLORS.point}" font-size="13" font-family="Arial" font-weight="bold">p = 1,80 · k + 4</text>
    ...
    checks: [
      ...
      { q: "Formule y = 2x + 3. Wat is y als x=4?", options: ["11","8","7","5"], answer: 0, wrongHints: [null,"Klopt — 2·4+3.","Niet — +3 vergeten.","Niet.","Niet."] },
      { q: "Bij y = 3x + 5: wat is **helling**?", options: ["3","5","8","15"], answer: 0, wrongHints: [null,"Klopt — coëfficiënt van x.","Dat is constante (start).","Niet.","Niet."] },
      { q: "Bij y = ax + b: wat is **b**?", options: ["Y-startwaarde (waar lijn x-as snijdt)","Helling","Aantal x-waarden","Onbekende"], answer: 0, wrongHints: [null,"Klopt — y bij x=0.","Dat is a.","Niet.","Niet."] },
      { q: "Los op: 3x + 4 = 19", options: ["x = 5","x = 7","x = 4","x = 15"], answer: 0, wrongHints: [null,"Klopt — −4 dan ÷3.","Niet — vergeet niet −4 eerst.","Niet.","Te hoog."] },
    ],
  },
];
