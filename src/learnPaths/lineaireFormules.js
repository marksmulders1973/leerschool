    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y=2x+3.", simpeler: "Lineair = alleen x. y=2x+3 wel.", nogSimpeler: "y=2x+3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2,5,8,11.", simpeler: "Sprong +3 elke keer = constant = lineair.", nogSimpeler: "+3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7.", simpeler: "y=−2x+7: b=7 (los getal).", nogSimpeler: "7" },
        },
      },
      {
        q: "In y = 4x, wat is b?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0.", simpeler: "y=4x = y=4x+0. b=0.", nogSimpeler: "0" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y=5x.", simpeler: "Grootste a = steilst. 5 wint.", nogSimpeler: "5" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y=−3x+1.", simpeler: "a=−3 negatief → daalt.", nogSimpeler: "Negatief a" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(0,7).", simpeler: "y=2x+7: snijpunt y-as = (0, b) = (0,7).", nogSimpeler: "(0,7)" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2 (6÷3).", simpeler: "a = Δy/Δx = 6/3 = 2.", nogSimpeler: "2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y=3x−5.", simpeler: "a=3, b=−5 → y=3x−5.", nogSimpeler: "3x−5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=4.", simpeler: "2x=8 → x=4.", nogSimpeler: "4" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=3.", simpeler: "4x=12 → x=3.", nogSimpeler: "3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=5.", simpeler: "3x−6=9 → 3x=15 → x=5.", nogSimpeler: "5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "27 cm.", simpeler: "y=3x+12. x=5: y=15+12=27.", nogSimpeler: "27" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=4.", simpeler: "3x=12 → x=4.", nogSimpeler: "4" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y=3x+2.", simpeler: "a=3, b=2 → y=3x+2.", nogSimpeler: "3x+2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "p=1,80k+4.", simpeler: "Vast €4 (=b), per km €1,80 (=a). p=1,80k+4.", nogSimpeler: "1,80k+4" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "€25,60.", simpeler: "1,80·12+4 = 21,60+4 = 25,60.", nogSimpeler: "€25,60" },
        },
      },
      {
