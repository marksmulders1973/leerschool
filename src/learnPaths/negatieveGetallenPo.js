...
const steps = [
...

  {
    ...
    checks: [
      ...
      { q: "**5 − 8** = ?", options: ["−3","3","−13","13"], answer: 0, wrongHints: [null,"Klopt — onder nul.","Verkeerd teken.","Te ver.","Niet."] },
      { q: "Welke is **grootst**?", options: ["3","0","−1","−5"], answer: 0, wrongHints: [null,"Klopt — verst rechts.","Niet.","Negatief is kleiner.","Veel kleiner."] },
      { q: "Van −10 naar −3, hoeveel **opgewarmd**?", options: ["7°","−7°","13°","3°"], answer: 0, wrongHints: [null,"Klopt — verschil 7.","Niet — opwarming positief.","Te veel.","Niet."] },
      { q: "0 − 4 = ?", options: ["−4","4","0","−40"], answer: 0, wrongHints: [null,"Klopt.","Niet — onder nul.","Niet — eraf.","Te ver."] },
      { q: "Wat is **tegengestelde** van −7?", options: ["7","−7","0","14"], answer: 0, wrongHints: [null,"Klopt — zelfde grootte, andere kant.","Niet — zichzelf.","Niet.","Niet."] },
      { q: "Hoogte mens: 1,5 m boven zee. Duiker −3 m. Verschil?", options: ["4,5 m","1,5 m","−4,5 m","−1,5 m"], answer: 0, wrongHints: [null,"Klopt — 1,5 + 3.","Maar 1 zijde.","Verkeerd teken voor verschil.","Niet."] },
      { q: "Welke getallenrij is **kleinst → grootst**?", options: ["−5, −2, 0, 3","3, 0, −2, −5","0, −2, −5, 3","−2, −5, 0, 3"], answer: 0, wrongHints: [null,"Klopt.","Andersom.","Niet sorteer.","Niet."] },
      { q: "Beneden zee-niveau is meestal?", options: ["Negatief","Positief","Nul","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — onder = negatief.","Boven.","Op niveau.","Wel."] },
      { q: "**−7 + 7** = ?", options: ["0","−14","14","7"], answer: 0, wrongHints: [null,"Klopt — heffen op.","Niet — tegengestelde.","Niet — tegengestelde.","Niet."] },
      { q: "**−3 × 2** = ?", options: ["−6","6","−1","−5"], answer: 0, wrongHints: [null,"Klopt — min × plus.","Verkeerd teken.","Niet zo.","Niet."] },
      { q: "**−2 × −3** = ?", options: ["6","−6","−5","5"], answer: 0, wrongHints: [null,"Klopt — min × min = plus.","Verkeerd teken.","Niet.","Verkeerd teken."] },
      { q: "Welk getal ligt **2 onder −5**?", options: ["−7","−3","2","7"], answer: 0, wrongHints: [null,"Klopt — −5−2.","Andersom.","Niet.","Niet."] },
      { q: "**Verschil** tussen −4 en 6?", options: ["10","2","−10","−2"], answer: 0, wrongHints: [null,"Klopt — 4 + 6.","Niet.","Niet — verschil positief.","Niet."] },
      { q: "Op getallenlijn: welke ligt **rechts** van −3?", options: ["0","−5","−10","−4"], answer: 0, wrongHints: [null,"Klopt — verder rechts.","Links.","Verder links.","Verder links."] },
      { q: "**−1 − (−4)** = ?", options: ["3","−5","5","−3"], answer: 0, wrongHints: [null,"Klopt — min een min = plus: −1+4.","Niet — twee min = plus.","Verkeerd teken.","Niet."] },
    ],
  },
];
