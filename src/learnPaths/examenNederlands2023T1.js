...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 1 zegt: 'Ze groeiden op met smartphones, maar ook jongeren begrijpen technologie eigenlijk niet altijd. Hoe school je ze bij?' Dat IS het probleem dat de hele tekst behandelt — jongeren ≠ automatisch digitaal vaardig. De vraag 'hoe school je ze bij' zet dat probleem als rode draad neer.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 15 voegt iets toe: leerlingen ZIJN wel vaardig, MAAR digitale middelen hebben óók nadelen ('je bent minder vrij'). Dat is een nuancering — niet zwart/wit, maar 'ja, maar ook...'.",
