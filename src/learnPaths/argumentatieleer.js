    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Standpunt = mening", tekst: "Met 'zouden moeten' = mening = standpunt." }],
          woorden: [{ woord: "standpunt", uitleg: "subjectieve uitspraak, geen feit" }],
          theorie: "Standpunt = mening waar je over kan discussiëren.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Modale woorden: moet, zou, is nodig" }],
          basiskennis: [{ onderwerp: "vs feit", uitleg: "feit is toetsbaar, mening niet" }],
          niveaus: { basis: "Jongeren zouden... = standpunt.", simpeler: "Mening, geen feit.", nogSimpeler: "Standpunt." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Voorschrijvend = moet doen", tekst: "'Gemeente moet meer geld' = voorschrijvend (zou moeten)." }],
          woorden: [{ woord: "voorschrijvend", uitleg: "schrijft voor wat moet gebeuren" }],
          theorie: "Drie soorten standpunten: beschrijvend (is), waarderend (mooi/goed), voorschrijvend (moet).",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Moet omhoog/omlaag' = voorschrijvend" }],
          basiskennis: [{ onderwerp: "signaal", uitleg: "moet, zou moeten = voorschrijvend" }],
          niveaus: { basis: "Voorschrijvend.", simpeler: "Zegt wat moet gebeuren.", nogSimpeler: "Voorschrijvend." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Argument = waarom", tekst: "Argument is de REDEN: 'planten verbeteren luchtkwaliteit'." }],
          woorden: [{ woord: "argument", uitleg: "antwoord op 'waarom?'" }],
          theorie: "Standpunt = wat. Argument = waarom.",
          voorbeelden: [{ type: "voorbeeld", tekst: "want, omdat = signaalwoord argument" }],
          basiskennis: [{ onderwerp: "vóór/na 'want'", uitleg: "na 'want' staat het argument" }],
          niveaus: { basis: "Planten verbeteren... = argument.", simpeler: "Na 'want' = argument.", nogSimpeler: "Argument." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Voorbeeld ≠ argument", tekst: "Eén concreet geval (buurjongen) = voorbeeld, geen algemene reden." }],
          woorden: [{ woord: "voorbeeld vs argument", uitleg: "voorbeeld illustreert; argument onderbouwt" }],
          theorie: "Argument is algemene uitspraak. Voorbeeld is concreet geval erbij.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Schermgebruik verdringt beweging = argument. Mijn neef speelt 3u = voorbeeld." }],
          basiskennis: [{ onderwerp: "examenvalkuil", uitleg: "voorbeeld bewijst niets" }],
          niveaus: { basis: "Voorbeeld.", simpeler: "Concreet geval, geen reden.", nogSimpeler: "Voorbeeld." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Voor-/nadelen-argument", tekst: "Dat scheelt bomen = VOORDEEL → voor-/nadelen-type." }],
          woorden: [{ woord: "pragmatisch", uitleg: "praktische voor- en nadelen" }],
          theorie: "Type 1: schrijver noemt voor-/nadelen van X.",
          voorbeelden: [{ type: "voorbeeld", tekst: "leidt tot..., het voordeel is..." }],
          basiskennis: [{ onderwerp: "kritisch", uitleg: "weegt + tegen − op?" }],
          niveaus: { basis: "Voor-/nadelen.", simpeler: "Voordeel genoemd = type 1.", nogSimpeler: "Voor-/nadelen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Oorzaak → gevolg", tekst: "'Doordat...' = causaal verband." }],
          woorden: [{ woord: "causaal", uitleg: "oorzakelijk verband" }],
          theorie: "Type 2: doordat X, leidt tot Y.",
          voorbeelden: [{ type: "voorbeeld", tekst: "doordat, leidt tot, daardoor" }],
          basiskennis: [{ onderwerp: "kritisch", uitleg: "écht oorzaak of toeval?" }],
          niveaus: { basis: "Oorzaak-gevolg.", simpeler: "Doordat = causaal.", nogSimpeler: "Oorzaak → gevolg." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Kenmerk-argument", tekst: "Eigenschap van film (geen geweld) → conclusie." }],
          woorden: [{ woord: "kenmerk", uitleg: "eigenschap van iets" }],
          theorie: "Type 3: omdat X eigenschap Y heeft, geldt Z.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Shisha bevat teer → ongezond" }],
          basiskennis: [{ onderwerp: "kritisch", uitleg: "klopt kenmerk + conclusie?" }],
          niveaus: { basis: "Kenmerk-argument.", simpeler: "Eigenschap → conclusie.", nogSimpeler: "Kenmerk." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Vergelijking met ander land", tekst: "Duitsland deed het, dus Nederland kan ook = vergelijking." }],
          woorden: [{ woord: "analogie", uitleg: "parallel met soortgelijke situatie" }],
          theorie: "Type 4: X lijkt op Y, dus Y-gedrag bij X.",
          voorbeelden: [{ type: "voorbeeld", tekst: "net als, vergelijkbaar met, zoals" }],
          basiskennis: [{ onderwerp: "kritisch", uitleg: "écht vergelijkbaar?" }],
          niveaus: { basis: "Vergelijking.", simpeler: "Parallel met ander land.", nogSimpeler: "Vergelijking." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "kritisch", uitleg: "deskundig op dit thema?" }],
          niveaus: { basis: "Autoriteit.", simpeler: "Bron aangehaald.", nogSimpeler: "Autoriteit." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Enkelvoudig = 1 + 1", tekst: "1 standpunt + 1 argument zonder verdere lagen." }],
          woorden: [{ woord: "enkelvoudig", uitleg: "simpelste structuur" }],
          theorie: "Standpunt → 1 argument. Geen subargumenten of extra argumenten.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Jas mee, want regen." }],
          basiskennis: [{ onderwerp: "tegen meervoudig", uitleg: "meervoudig = meer dan 1 argument" }],
          niveaus: { basis: "Enkelvoudig.", simpeler: "1 reden.", nogSimpeler: "Enkelvoudig." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Nevenschikkend = meerdere gelijk", tekst: "3 argumenten naast elkaar — elk apart al overtuigend." }],
          woorden: [{ woord: "nevenschikkend", uitleg: "gelijkwaardig naast elkaar" }],
          theorie: "Meerdere argumenten, geen onderschikking.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Ten eerste/Daarnaast/Bovendien" }],
          basiskennis: [{ onderwerp: "voordeel", uitleg: "1 weerlegging = anderen blijven staan" }],
          niveaus: { basis: "Nevenschikkend.", simpeler: "3 redenen naast elkaar.", nogSimpeler: "Nevenschikkend." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Onderschikkend = keten", tekst: "Argument wordt zélf onderbouwd door subargument." }],
          woorden: [{ woord: "onderschikkend", uitleg: "getrapte argumentatie" }],
          theorie: "Standpunt → argument → subargument (laag dieper).",
          voorbeelden: [{ type: "voorbeeld", tekst: "want X, want zelf Y" }],
          basiskennis: [{ onderwerp: "diepte", uitleg: "argument zelf nog niet geaccepteerd → onderbouw" }],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Drogreden ≠ zwak", tekst: "Zwak = wel argument maar minder overtuigend. Drogreden = redenering deugt niet." }],
          woorden: [{ woord: "drogreden", uitleg: "onjuiste/ongeldige argumentatie" }],
          theorie: "Drogreden = lijkt op argument maar deugt logisch niet.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Persoon aanvallen, vals dilemma, etc." }],
          basiskennis: [{ onderwerp: "4 hoofdtypen", uitleg: "ad hom, autoriteit, generalisatie, dilemma" }],
          niveaus: { basis: "Drogreden = onjuist.", simpeler: "Logica klopt niet.", nogSimpeler: "Drogreden." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Ad hominem = persoon aanvallen", tekst: "Argument over milieuregels wordt niet besproken; de persoon wordt aangevallen." }],
          woorden: [{ woord: "ad hominem", uitleg: "tegen de persoon" }],
          theorie: "Drogreden: aanval op persoon ipv het argument.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Jij vliegt zelf, dus...'" }],
          basiskennis: [{ onderwerp: "irrelevant", uitleg: "wat persoon doet, zegt niets over argument" }],
          niveaus: { basis: "Ad hominem.", simpeler: "Persoon aangevallen.", nogSimpeler: "Persoonlijke aanval." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "verschil", uitleg: "WHO/RIVM = echt; 'mensen' = vaag" }],
          niveaus: { basis: "Vals autoriteit.", simpeler: "Vage bron.", nogSimpeler: "Vals autoriteit." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Vals dilemma = fake-keuze", tekst: "'Of studeren of bijstand' = alleen 2 opties? Er zijn meer." }],
          woorden: [{ woord: "zwart-wit", uitleg: "of...of, geen tussenweg" }],
          theorie: "Vals dilemma: forceert keuze tussen 2 opties terwijl er meer zijn.",
          voorbeelden: [{ type: "voorbeeld", tekst: "of A of B, je bent voor of tegen" }],
          basiskennis: [{ onderwerp: "echte opties", uitleg: "vraag: zijn er meer mogelijkheden?" }],
          niveaus: { basis: "Vals dilemma.", simpeler: "2 opties = fake.", nogSimpeler: "Zwart-wit." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Overhaaste generalisatie", tekst: "1 persoonlijke ervaring → algemene conclusie = drogreden." }],
          woorden: [{ woord: "generalisatie", uitleg: "te brede conclusie uit te weinig gevallen" }],
          theorie: "Eén voorbeeld bewijst geen algemene regel.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Eén buurman ≠ alle jongeren" }],
          basiskennis: [{ onderwerp: "vereist", uitleg: "representatieve steekproef, officiële cijfers" }],
          niveaus: { basis: "Overhaaste generalisatie.", simpeler: "Te weinig bewijs.", nogSimpeler: "Generalisatie." },
        },
      },
    ],
  },
...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">examenstof leesvaardigheid 🏆</text>
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "3 gelijkwaardige redenen", tekst: "Creativiteit + vorming + stress = nevenschikkend." }],
          woorden: [{ woord: "nevenschikkend", uitleg: "gelijkwaardige argumenten naast elkaar" }],
          theorie: "3 onafhankelijke argumenten voor 1 standpunt.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Stimuleert..., bevordert..., biedt..." }],
          basiskennis: [{ onderwerp: "voordeel", uitleg: "elk argument houdt apart stand" }],
          niveaus: { basis: "Nevenschikkend.", simpeler: "3 redenen.", nogSimpeler: "Nevenschikkend." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Ad hominem windmolens", tekst: "Niet het argument wordt besproken, maar de motieven van voorstanders." }],
          woorden: [{ woord: "ad hominem", uitleg: "aanval op persoon, niet inhoud" }],
          theorie: "Schrijver diskwalificeert tegenstanders ipv argument.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Mensen die X zijn, hebben Y niet, dus...'" }],
          basiskennis: [{ onderwerp: "test", uitleg: "wordt het argument zélf weerlegd?" }],
          niveaus: { basis: "Ad hominem.", simpeler: "Persoon aangevallen.", nogSimpeler: "Persoonlijke aanval." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Onderschikkend: keten", tekst: "Standpunt → argument (drempel) → subargument (waarom drempel slecht is)." }],
          woorden: [{ woord: "onderschikkend", uitleg: "argument zelf wordt onderbouwd" }],
          theorie: "Subargument ondersteunt het hoofdargument.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Meer geld → drempel → gelijke kansen" }],
          basiskennis: [{ onderwerp: "diepte", uitleg: "verticale keten, niet horizontale rij" }],
          niveaus: { basis: "Onderschikkend.", simpeler: "Reden onder reden.", nogSimpeler: "Onderschikkend." },
        },
      },
      ...
      { q: "Wat is een **standpunt**?", options: ["Mening die je verdedigt","Een vraag","Een feit","Een citaat"], answer: 0, wrongHints: [null, "Geen mening.", "Niet te verdedigen.", "Niet eigen mening."] },
      ...
      { q: "**Open vraag**: noem 1 typisch signaalwoord voor een argument (reden).", kind: "open", acceptedAnswers: ["want", "omdat", "doordat", "aangezien", "namelijk"], explanation: "Reden-signalen: want, omdat, doordat, aangezien, namelijk." },
      { q: "**Open vraag**: hoe heet een redenering die zichzelf bewijst (A omdat A)?", kind: "open", acceptedAnswers: ["cirkelredenering", "cirkel-redenering", "petitio principii"], explanation: "Cirkelredenering: het bewijs is hetzelfde als de stelling — geen geldig argument." },
    ],
  },
];
