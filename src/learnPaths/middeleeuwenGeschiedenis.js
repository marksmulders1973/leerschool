...
const steps = [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Te vroeg.", "Te laat.", "Te kort en deels Romeinse tijd."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Weinigen waren rijk.", "Velen konden niet lezen.", "Reizen was duur."],
      },
      {
  ...
  // STAP 2: Kerk en macht
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Geen vazal.", "Geeft juist leen uit.", "Niet feodaal."],
      },
      {
        q: "Wat zijn **tienden**?",
        options: ["10% inkomen aan Kerk", "10% korting", "10e zoon", "Tien jaar straf"],
        answer: 0,
        wrongHints: [null, "Geen korting.", "Geen familieding.", "Geen straf."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Reden niet.", "Geen vechten.", "Niet markt."],
      },
    ],
  },
  ...
  // STAP 3: Ridders + kruistochten
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet ontdekt nog.", "Niet kruistochten.", "Niet specifiek."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Eerdere periode.", "Tegenstander, hij verloor.", "Mohammed was 500 jaar eerder."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Iets anders.", "Geen ridder.", "Stadsburgers waren vrij."],
      },
      {
        q: "Wat is een **gilde**?",
        options: ["Beroepsvereniging in stad", "Soort slot", "Soort munt", "Soort eten"],
        answer: 0,
        wrongHints: [null, "Niet slot.", "Niet munt.", "Niet eten."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Eigenlijk vies door drukte.", "Niet allemaal.", "Niet bedoeld."],
      },
    ],
  },
  ...
  // STAP 5: Pest + einde
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Veel meer.", "Niet alles.", "Veel meer."],
      },
      {
  ...
  // STAP 6: Doorstroomtoets-mix
  {
    ...
    explanation:
      "Mix-toets in Doorstroomtoets-stijl. Door elkaar: feodalisme, kerk, ridders, pest, einde.\n\nVeel succes!",
    checks: [
      {
        q: "Wanneer waren de middeleeuwen ongeveer?",
        options: ["500-1500", "0-500", "1500-2000", "100-1000"],
        answer: 0,
        wrongHints: [null, "Te vroeg.", "Te laat.", "Te kort."],
      },
      {
        q: "Wie was **Karel de Grote**?",
        options: ["Keizer rond 800", "Boer", "Pest-slachtoffer", "Ridder Templer"],
        answer: 0,
        wrongHints: [null, "Te specifiek.", "Te laat.", "Niet ridder-Templer."],
      },
      {
        q: "Welke groep had **3-fasen-opleiding** in stad?",
        options: ["Gildenleden", "Boeren", "Adellijke dochters", "Monniken"],
        answer: 0,
        wrongHints: [null, "Boeren hadden geen opleiding.", "Niet vakopleiding.", "Andere route."],
      },
      {
        q: "Wat was de **Zwarte Dood**?",
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Columbus.", "Renaissance.", "Te laat."],
      },
      {
