    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "~3% zoet water.",
            simpeler: "97% van aarde-water = zout. Slechts 3% is zoet (drinkbaar).",
            nogSimpeler: "3%",
          },
        },
      },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Cumulonimbus = onweerswolk.",
            simpeler: "De grote stapel-wolk (tot 15 km hoog) brengt onweer + regen + hagel.",
            nogSimpeler: "Cumulonimbus",
          },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc neerslagsoorten: SNEEUW = al bevroren in wolk + valt als vlok. HAGEL = bevroren door op-en-neer in onweerswolk. IJZEL = vloeibaar gevallen + pas op grond bevroren. Heel verschillende processen!",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "7 kleuren (rood-oranje-geel-groen-blauw-indigo-violet).",
            simpeler: "Regenboog heeft altijd 7 kleuren in vaste volgorde.",
            nogSimpeler: "7",
          },
        },
      },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: NL is bijzonder omdat we leven achter dijken op land dat eigenlijk onder water hoort. Daarom hebben we waterschappen, gemalen en de Deltawerken om veilig te blijven.",
          voorbeelden: [
      ...
      { q: "Hoeveel **kleuren** regenboog?", options: ["7", "3", "10", "1"], answer: 0, wrongHints: [null, "Te weinig.", "Te veel.", "Niet."] },
      {
        ...
        uitlegPad: {
          stappen: [
            ...
            { titel: "Toets-feit: water 'gebruikt' is nooit weg", tekst: "Het water dat jij vandaag drinkt is **HETZELFDE water** dat dinosauriërs dronken — alleen heel veel keer rondgegaan. Aarde maakt geen nieuw water. Alleen de 'plek' verandert: nu in oceaan, dan in wolk, dan in plant, dan in dier.\n\nGevolg: vervuiling is permanent. Plastic in zee blijft eeuwen. Daarom water-zuivering belangrijk." },
            { titel: "Toets-tip: planten + dieren in cyclus", tekst: "Planten doen ook mee — **transpiratie**: planten 'zweten' water uit hun bladeren. Een grote boom kan **honderden liters water per dag** afgeven aan de lucht. Daarom is bos belangrijk voor regen.\n\nDieren + mensen: drinken water, plassen het uit, het verdampt weer, etc. Allemaal onderdeel van de cyclus." },
          ],
          woorden: [
...
const waterkringloopPo = {
  ...
  title: "Waterkringloop (Doorstroomtoets groep 6-8)",
  emoji: "💧",
  level: "groep6-8",
  subject: "natuur",
  referentieNiveau: "1F",
  ...
  intro:
    "Waterkringloop voor Doorstroomtoets groep 6-8 — 4 fasen (verdamping/condensatie/neerslag/afstroming) + soorten wolken (cumulus/cirrus/cumulonimbus) + soorten neerslag (regen/sneeuw/hagel/ijzel/mist/dauw/regenboog) + NL-water (Deltawerken/polders/IJsselmeer) + thuis-gebruik (130 L/dag). ~15 min.",
  triggerKeywords: [
