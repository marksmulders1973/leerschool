    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2⁸ = 256. A.", simpeler: "8 bits → 256 waarden = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8+4+0+1 = 13. A.", simpeler: "1101 = 8+4+1 = 13 = A.", nogSimpeler: "A." },
        },
      },
      {
        q: "Wat is een **bit**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Een 0 of 1. A.", simpeler: "Bit = 0 of 1 = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1, 2, 4, 8. A.", simpeler: "Binair verdubbelt: 1-2-4-8 = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4 bits. A.", simpeler: "1 hex = 4 bits = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "R=255, rest 0 → rood. A.", simpeler: "#FF0000 = rood = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "256³ ≈ 16,7 mln. A.", simpeler: "24-bit = ~16,7 miljoen kleuren = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Getallen via een tekenset. A.", simpeler: "Tekst = getallen (tekenset) = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "'A' = 65. A.", simpeler: "ASCII A = 65 = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Alle talen + emoji. A.", simpeler: "Unicode = alles + emoji = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1 byte. A.", simpeler: "ASCII-teken in UTF-8 = 1 byte = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Pixels met kleur. A.", simpeler: "Foto = pixels = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vaker meten = beter geluid. A.", simpeler: "Meer Hz = beter geluid = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "JPG = lossy. A.", simpeler: "Lossy = JPG = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "PNG = verliesvrij. A.", simpeler: "Tekst scherp houden = PNG = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
