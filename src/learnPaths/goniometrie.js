...
<rect x="225" y="145" width="15" height="15" fill="none" stroke="#00c853" stroke-width="1"/>
    ...
    checks: [
      ...
      { q: "Hoek tussen schuin en grond is 60°. Welke zijde langste?", options: ["Hypotenusa","Aanliggend","Overstaand","Allemaal gelijk"], answer: 0, wrongHints: [null, "Niet — afhankelijk hoek.", "Niet — overstaand kleiner dan hypotenusa.", "Niet — driehoek meestal niet gelijkzijdig."] },
      ...
      { q: "Som van 3 hoeken in elke driehoek = ?", options: ["180°","90°","270°","360°"], answer: 0, wrongHints: [null, "Dat is 1 rechte hoek.", "Niet — alleen 180°.", "Dat is volledige cirkel."] },
