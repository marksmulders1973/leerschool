    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Tegenoverstaand wisselt als je van hoek wisselt.", "Aanliggend wisselt ook.", "Eén zijde is wél altijd dezelfde — denk welke tegenover de rechte hoek ligt."],
        uitlegPad: {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "sin α gebruikt de schuine zijde, niet de aanliggende.", "Niet delen — denk aan TOA: tan α = tegenover / aanliggend.", "Andersom — herschrijf TOA naar tegenover ="],
        uitlegPad: {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Te veel — dat is de hele schuine zijde, niet de tegenover.", "0,71 is sin 45°, niet een zijde — vermenigvuldig nog met de schuine.", "Te weinig — controleer sin 45° (~0,71) × 8."],
        uitlegPad: {
...
<rect x="225" y="145" width="15" height="15" fill="none" stroke="#00c853" stroke-width="1"/>
    ...
    checks: [
      ...
      { q: "Wat is **tan 45°**?", options: ["1","0","√2","0,5"], answer: 0, wrongHints: [null, "Niet — alleen tan 0° = 0.", "Niet — dat is sin 45° of cos 45°.", "Niet — tan 30° = ongeveer 0,58."] },
      ...
      { q: "Welke functie groeit eindeloos bij benadering 90°?", options: ["tan","sin","cos","Allebei"], answer: 0, wrongHints: [null, "Niet — sin 90° = 1.", "Niet — cos 90° = 0.", "Niet — 2 zijn begrensd."] },
      ...
      { q: "**Open vraag**: hoeveel is cos 0°? Typ getal.", kind: "open", acceptedAnswers: ["1"], numericTolerance: 0, explanation: "Bij 0° is de aanliggende zijde gelijk aan de hypotenusa, dus cos 0° = 1." },
      { q: "**Open vraag**: hoeveel graden zijn de andere 2 hoeken samen in een rechthoekige driehoek?", kind: "open", acceptedAnswers: ["90", "90°", "90 graden"], explanation: "Som hoeken driehoek = 180°. Rechte hoek = 90°. Andere 2 samen = 180 − 90 = 90°." },
    ],
  },
];
