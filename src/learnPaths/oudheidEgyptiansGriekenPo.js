...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Welke Egyptische **farao** is bekend van zijn graf-vondst (1922)?", options: ["Toetanchamon","Cleopatra","Ramses","Niet bekend"], answer: 0, wrongHints: [null,"Klopt — Howard Carter.","Andere periode.","Eerder.","Wel."] },
      { q: "Wat is een **piramide**?", options: ["Grafkamer voor farao","Tempel voor goden","Huis","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — Egypte.","Niet primair.","Niet.","Wel."] },
      { q: "**Hiërogliefen** zijn?", options: ["Egyptisch schrift met afbeeldingen","Modern alfabet","Cijfers","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Niet.","Wel."] },
      { q: "Wie ontcijferde de **Rosetta-steen**?", options: ["Champollion","Caesar","Cleopatra","Erasmus"], answer: 0, wrongHints: [null,"Klopt — 1822.","Romeinen.","Wel Egyptisch maar niet ontcijferaar.","Niet."] },
      { q: "Wie was **Julius Caesar**?", options: ["Romeinse veldheer + dictator","Egyptisch","Grieks","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — vermoord 44 v.Chr.","Niet.","Niet.","Wel."] },
      { q: "**Augustus** was eerste?", options: ["Romeinse keizer","Farao","Griek","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — vanaf 27 v.Chr.","Egypte.","Niet.","Wel."] },
      { q: "**Socrates** was een?", options: ["Griekse filosoof","Romeinse keizer","Egyptische farao","Niet bekend"], answer: 0, wrongHints: [null,"Klopt — leraar van Plato.","Niet.","Niet.","Wel."] },
      { q: "Wie was leerling van Plato?", options: ["Aristoteles","Caesar","Cleopatra","Niet bekend"], answer: 0, wrongHints: [null,"Klopt — leraar van Alexander de Grote.","Romein.","Egyptisch.","Wel."] },
      { q: "**Alexander de Grote** kwam uit?", options: ["Macedonië (Grieks gebied)","Egypte","Rome","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — veroverde groot rijk.","Wel veroverde Egypte.","Niet.","Wel."] },
      { q: "Eerste **Olympische Spelen** waren in?", options: ["776 v.Chr. — Olympia, Griekenland","1896 modern","Rome","Egypte"], answer: 0, wrongHints: [null,"Klopt — oudheid.","Modern herstart.","Niet origineel.","Niet."] },
      { q: "Wat liep door NL als **noordelijke Romeinse grens**?", options: ["Limes (Rijn-linie)","Rotterdam","Amsterdam","Niet bekend"], answer: 0, wrongHints: [null,"Klopt — UNESCO erfgoed.","Niet bestaand.","Niet.","Wel."] },
      { q: "Welke **godenwereld** kenden Romeinen?", options: ["12 goden (Jupiter, Mars, Venus...)","1 god","Geen goden","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — vergelijkbaar Grieks.","Later christelijk.","Wel.","Wel."] },
      { q: "Wat is een **gladiator**?", options: ["Romeinse arena-vechter","Egyptisch","Wetenschapper","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — Colosseum.","Niet.","Niet.","Wel."] },
      { q: "Welke taal spreken Romeinen?", options: ["Latijn","Grieks","Egyptisch","Italiaans"], answer: 0, wrongHints: [null,"Klopt — basis voor Romaanse talen.","Grieken wel.","Egyptenaren wel.","Modern, niet oudheid."] },
      { q: "Welke Griekse stad was **bekend voor leger**?", options: ["Sparta","Athene","Korinthe","Niet bekend"], answer: 0, wrongHints: [null,"Klopt — krijgers.","Democratie/cultuur.","Niet primair.","Wel."] },
    ],
  },
];
