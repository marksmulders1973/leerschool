    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Europa.", "NL.", "VS."],
      },
      {
        q: "Wat is een **farao**?",
        options: ["Koning + god van Egypte", "Soldaat", "Boer", "Priester"],
        answer: 0,
        wrongHints: [null, "Niet primair.", "Niet.", "Apart."],
      },
      {
        q: "Wie was **Toetanchamon**?",
        options: ["Jong gestorven farao (graf 1922)", "Romein", "Griek", "Pirate"],
        answer: 0,
        wrongHints: [null, "Romeinen komen veel later — bij welk rijk horen piramides en de Nijl?", "Grieken horen bij Athene en Sparta — waar werd het beroemde gouden dodenmasker gevonden?", "Geen piraat — denk aan een graf in het Dal der Koningen."],
      },
      {
        q: "Wat is **Rosetta-steen**?",
        options: ["Hielp hiëroglyfen ontcijferen", "Goud", "Mummie", "Berg"],
        answer: 0,
        wrongHints: [null, "Het is 'gewoon' steen — de waarde zat in wat eróp stond. Wat dan?", "Geen lichaam — een platte steen met drie soorten schrift erop. Waarom was dat handig?", "Geen berg — een steen met dezelfde tekst in drie schriften. Wat kon je daarmee?"],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Veel later.", "Eerste keizer later.", "Griek."],
      },
      {
        q: "Wie zei **'Veni, vidi, vici'**?",
        options: ["Julius Caesar", "Augustus", "Alexander", "Aristoteles"],
        answer: 0,
        wrongHints: [null, "Augustus was de eerste kéízer — wie schreef trots over zijn bliksemsnelle overwinning?", "Alexander de Grote sprak Grieks — deze uitspraak is Latijn.", "Aristoteles was filosoof, geen veldheer — wie won hier razendsnel een veldslag?"],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Bestond nog.", "Te laat.", "Wel uitgestorven."],
      },
    ],
  },
  {
    ...
    checks: [
      { q: "Welke rivier was levensader **Egypte**?", options: ["Nijl", "Donau", "Rijn", "Tigris"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Andere oude beschaving."] },
      { q: "Waar ontstond **democratie**?", options: ["Athene", "Sparta", "Rome", "Egypte"], answer: 0, wrongHints: [null, "Militair.", "Republiek anders.", "Farao."] },
      { q: "Wie was leraar **Alexander de Grote**?", options: ["Aristoteles", "Socrates", "Caesar", "Plato"], answer: 0, wrongHints: [null, "Eerder.", "Niet — Romein.", "Eerder."] },
      { q: "Wie zei **'Veni, vidi, vici'**?", options: ["Caesar", "Augustus", "Alexander", "Toetanchamon"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Egyptisch."] },
      { q: "Hoogste **piramide** wereld 3800 jr lang?", options: ["Cheops (Gizeh, 146 m)", "Khafre", "Menkaure", "Burj Khalifa"], answer: 0, wrongHints: [null, "Kleinere.", "Kleinere.", "Modern."] },
      { q: "Wanneer **viel West-Romeinse Rijk**?", options: ["476 n.Chr.", "100 v.Chr.", "1000 n.Chr.", "Bestaat nog"], answer: 0, wrongHints: [null, "Bestond nog.", "Te laat.", "Wel."] },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — dat zijn vissen-namen.", "Niet — geen dans.", "Niet — wel sommige tekst stond op stenen."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — moderne OS sinds 1896 in Athene, maar oude OS veel ouder.", "Niet — Chinese sport-cultuur anders.", "Niet — geen Russische oorsprong."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — mythologie = vóór wetenschap, geen feit.", "Niet — wel deel van geschiedenisles maar mythologie zelf is iets anders.", "Niet — wel sport komt VOOR in mythen (Hercules), niet hetzelfde."],
        uitlegPad: {
          stappen: [
      ...
      { q: "Welke **stad** was eerste democratie?", options: ["Athene","Sparta","Rome","Cairo"], answer: 0, wrongHints: [null, "Wel Grieks maar geen democratie.", "Republiek, maar later.", "Egyptisch."] },
      { q: "Welk **Romeins bouwwerk** was het grote arena-gebouw in Rome?", options: ["Colosseum","Acropolis","Parthenon","Piramide"], answer: 0, wrongHints: [null, "Grieks.", "Grieks.", "Egyptisch."] },
      { q: "In welk jaar viel het **West-Romeinse Rijk**?", options: ["476 n.Chr.","100 v.Chr.","1066","1500"], answer: 0, wrongHints: [null, "Te vroeg.", "Slag bij Hastings.", "Renaissance."] },
      { q: "Welke Egyptische **farao** is bekend van zijn graf-vondst (1922)?", options: ["Toetanchamon","Cleopatra","Ramses","Niet bekend"], answer: 0, wrongHints: [null, "Andere periode.", "Eerder.", "Wel."] },
      { q: "Wat is een **piramide**?", options: ["Grafkamer voor farao","Tempel voor goden","Huis","Niet bestaand"], answer: 0, wrongHints: [null, "Niet primair.", "Niet.", "Wel."] },
      { q: "**Hiërogliefen** zijn?", options: ["Egyptisch schrift met afbeeldingen","Modern alfabet","Cijfers","Niet bestaand"], answer: 0, wrongHints: [null, "Tegengestelde.", "Niet.", "Wel."] },
      { q: "Wie ontcijferde de **Rosetta-steen**?", options: ["Champollion","Caesar","Cleopatra","Erasmus"], answer: 0, wrongHints: [null, "Romeinen.", "Wel Egyptisch maar niet ontcijferaar.", "Niet."] },
      { q: "Wie was **Julius Caesar**?", options: ["Romeinse veldheer + dictator","Egyptisch","Grieks","Niet relevant"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Wel."] },
      { q: "**Augustus** was eerste?", options: ["Romeinse keizer","Farao","Griek","Niet relevant"], answer: 0, wrongHints: [null, "Egypte.", "Niet.", "Wel."] },
      { q: "**Socrates** was een?", options: ["Griekse filosoof","Romeinse keizer","Egyptische farao","Niet bekend"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Wel."] },
      { q: "Wie was leerling van Plato?", options: ["Aristoteles","Caesar","Cleopatra","Niet bekend"], answer: 0, wrongHints: [null, "Romein.", "Egyptisch.", "Wel."] },
      { q: "**Alexander de Grote** kwam uit?", options: ["Macedonië (Grieks gebied)","Egypte","Rome","Niet relevant"], answer: 0, wrongHints: [null, "Wel veroverde Egypte.", "Niet.", "Wel."] },
      { q: "Eerste **Olympische Spelen** waren in?", options: ["776 v.Chr. — Olympia, Griekenland","1896 modern","Rome","Egypte"], answer: 0, wrongHints: [null, "Modern herstart.", "Niet origineel.", "Niet."] },
      { q: "Wat liep door NL als **noordelijke Romeinse grens**?", options: ["Limes (Rijn-linie)","Rotterdam","Amsterdam","Niet bekend"], answer: 0, wrongHints: [null, "Niet bestaand.", "Niet.", "Wel."] },
      { q: "Welke **godenwereld** kenden Romeinen?", options: ["12 goden (Jupiter, Mars, Venus...)","1 god","Geen goden","Niet relevant"], answer: 0, wrongHints: [null, "Later christelijk.", "Wel.", "Wel."] },
      { q: "Wat is een **gladiator**?", options: ["Romeinse arena-vechter","Egyptisch","Wetenschapper","Niet relevant"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Wel."] },
      { q: "Welke taal spreken Romeinen?", options: ["Latijn","Grieks","Egyptisch","Italiaans"], answer: 0, wrongHints: [null, "Grieken wel.", "Egyptenaren wel.", "Modern, niet oudheid."] },
      { q: "Welke Griekse stad was **bekend voor leger**?", options: ["Sparta","Athene","Korinthe","Niet bekend"], answer: 0, wrongHints: [null, "Democratie/cultuur.", "Niet primair.", "Wel."] },
    ],
  },
];
...
const oudheidEgyptiansGriekenPo = {
  ...
  title: "Oudheid — Egyptenaren + Grieken + Romeinen (Doorstroomtoets groep 6-8)",
  emoji: "🏺",
  level: "groep6-8",
