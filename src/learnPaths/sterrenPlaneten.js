...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Hoeveel **planeten** in ons zonnestelsel?", options: ["8","9","7","12"], answer: 0, wrongHints: [null,"Klopt — Pluto geen planeet sinds 2006.","Oude telling.","Te weinig.","Te veel."] },
      { q: "Welke planeet is **dichtst bij de zon**?", options: ["Mercurius","Venus","Aarde","Mars"], answer: 0, wrongHints: [null,"Klopt.","Tweede.","Derde.","Vierde."] },
      { q: "Welke planeet noemen we de **rode planeet**?", options: ["Mars","Venus","Jupiter","Saturnus"], answer: 0, wrongHints: [null,"Klopt — ijzeroxide.","Heet, geel.","Reuzenplaneet.","Ringen."] },
      { q: "Welke planeet is **grootst**?", options: ["Jupiter","Saturnus","Neptunus","Aarde"], answer: 0, wrongHints: [null,"Klopt.","Tweede.","Vierde.","Klein."] },
      { q: "**Maan** van de aarde — hoeveel?", options: ["1","2","0","5"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Wel een.","Niet."] },
      { q: "Welke planeet heeft veel **ringen**?", options: ["Saturnus","Mars","Venus","Mercurius"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "Hoeveel dagen duurt een **jaar** op aarde?", options: ["365","100","30","1000"], answer: 0, wrongHints: [null,"Klopt — om zon.","Niet.","Maand.","Te veel."] },
      { q: "Hoe lang duurt 1 **dag** op aarde?", options: ["24 uur","12 uur","365 dagen","1 jaar"], answer: 0, wrongHints: [null,"Klopt — rotatie om as.","Halve dag.","Jaar.","Niet."] },
      { q: "Wat veroorzaakt **dag en nacht**?", options: ["Aarde draait om as","Zon beweegt","Wolken","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — 24 uur rotatie.","Niet.","Niet.","Wel."] },
      { q: "Wat veroorzaakt **seizoenen**?", options: ["Schuine stand aarde + draai om zon","Maan","Zon dichterbij","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — 23,5°.","Niet primair.","Bijna onveranderd.","Wel."] },
      { q: "Wat is een **zonsverduistering**?", options: ["Maan tussen zon en aarde","Aarde tussen zon en maan","Wolk","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Maansverduistering.","Niet astronomie.","Wel."] },
    ],
  },
];
