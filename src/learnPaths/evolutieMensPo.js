    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip: natuurlijke selectie is GEEN toeval. Het selecteert systematisch: betere eigenschappen winnen. Over miljoenen jaren ontstaat zo een nieuwe soort.",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "~300.000 jaar.",
            simpeler: "Moderne mens (Homo sapiens) is een vrij jonge soort, ~300.000 jaar.",
            nogSimpeler: "300.000 jaar",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: kleine dieren overleefden (vogels = afstammelingen van dino's eigenlijk! Plus zoogdieren die later mensen werden). Niet ALLE dino's stierven uit — vogels zijn techn. nog dino's.",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-nuance: 'Mens stamt af van aap' is fout. 'Mens en aap delen een voorouder' is juist. Wij delen 98,8% DNA met chimpansee — heel verwant, maar geen ouder-kind.",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Lucy = Australopithecus-skelet uit Ethiopië (1974).",
            simpeler: "3,2 miljoen jaar oud skelet, 1 meter lang, liep al rechtop. Gevonden in 1974, bijnaam uit Beatles-lied.",
            nogSimpeler: "Lucy = oud skelet Ethiopië",
          },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Versteende resten van oude wezens.",
            simpeler: "Botten + schelpen van lang geleden, nu versteend in gesteente.",
            nogSimpeler: "Versteende botten",
          },
        },
      },
      {
    ...
    checks: [
      ...
      { q: "Hoeveel **mens-chimpansee DNA** overeenkomst?", options: ["~98,8%", "10%", "0%", "50%"], answer: 0, wrongHints: [null, "Te weinig.", "Wel.", "Te weinig."] },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Versteende rest", simpeler: "Fossielen zijn dode dieren/planten die over miljoenen jaren in steen veranderden. Wetenschappers vinden ze in oude aardlagen.", nogSimpeler: "Versteend" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Best aangepast krijgt meer kinderen.", simpeler: "Natuurlijke selectie: dieren die beter passen bij hun omgeving overleven en krijgen meer nakomelingen. Hun voordelen erven over. Soort verandert langzaam.", nogSimpeler: "Beste passende wint" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~300.000 jaar.", simpeler: "Homo sapiens (onze soort) bestaat ongeveer 300.000 jaar. Eerdere Homo-soorten zijn ouder.", nogSimpeler: "300.000" },
        },
      },
...
const evolutieMensPo = {
  id: "evolutie-mens-po",
  title: "Evolutie + mens (Doorstroomtoets groep 6-8)",
  emoji: "🐒",
  level: "groep6-8",
  subject: "natuur",
  referentieNiveau: "1F",
  ...
  intro:
    "Evolutie voor Doorstroomtoets groep 6-8 — Darwin/natuurlijke selectie + voorbeelden (Galapagos-vinken + pepermot) + mens stamboom (Australopithecus/Lucy/Neanderthaler/Homo sapiens) + reis uit Afrika + bewijzen (fossielen/DNA/restorganen/Tiktaalik) + 4,5 mld jr aarde + 5 massa-uitstervingen. Sluit op bekende-wetenschappers. ~15 min.",
  triggerKeywords: [
    "evolutie", "Darwin",
