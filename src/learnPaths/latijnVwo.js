    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-favoriet datum onthouden. Beroemd ook door Shakespeare's *Julius Caesar* (1599).",
