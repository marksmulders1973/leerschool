...
const steps = [
  ...
  },
  {
    ...
    checks: [
      { q: "Wie schilderde **De Nachtwacht**?", options: ["Rembrandt", "Vermeer", "Van Gogh", "Mondriaan"], answer: 0, wrongHints: [null, "Klopt.", "Klein-werk.", "Veel later.", "Veel later."] },
      { q: "Wie schilderde **Zonnebloemen**?", options: ["Van Gogh", "Rembrandt", "Vermeer", "Mondriaan"], answer: 0, wrongHints: [null, "Klopt.", "Realistisch.", "Klein.", "Abstract."] },
      { q: "**Meisje met de Parel** is van?", options: ["Vermeer", "Rembrandt", "Hals", "Steen"], answer: 0, wrongHints: [null, "Klopt.", "Andere.", "Andere.", "Chaos-scènes."] },
      { q: "**Mondriaan** stijl?", options: ["Rechthoeken + primaire kleuren", "Realistisch", "Donker", "Sprookjes"], answer: 0, wrongHints: [null, "Klopt.", "Tegenovergesteld.", "Niet.", "Niet."] },
      { q: "Wie bedacht **Nijntje**?", options: ["Dick Bruna", "Pieck", "Mondriaan", "Hals"], answer: 0, wrongHints: [null, "Klopt.", "Efteling.", "Niet.", "Niet."] },
      { q: "**Grootste museum** NL?", options: ["Rijksmuseum Amsterdam", "Mauritshuis", "Bonnefanten", "Eftelingmuseum"], answer: 0, wrongHints: [null, "Klopt.", "Klein.", "Niet grootst.", "Pretpark."] },
    ],
  },
];
