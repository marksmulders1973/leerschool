  ...
  // STAP 4: Zuurstof + ademen
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — schattingen 50-80% van zuurstof komt uit de zee.", "Bekend bijnaam 'longen van de aarde' maar oceanen leveren meer.", "Bossen leveren veel — maar minder dan de oceanen.", "Mensen ademen zuurstof IN, produceren het niet."],
      },
      {
