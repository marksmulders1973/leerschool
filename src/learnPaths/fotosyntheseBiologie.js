    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — letterlijk 'maken met licht'.", "Planten zijn geen vleeseters meestal.", "Verkeerd om — dat is omgekeerd.", "Wel licht nodig voor fotosynthese."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Plant geeft juist zuurstof AF (niet nodig als input).", "Voedsel maakt plant zelf.", "Plant eet geen vlees."],
      },
      {
        q: "Wat **produceren** planten met fotosynthese?",
        options: ["Suiker + zuurstof", "Vlees + bloed", "Aarde + steen", "CO₂ + water"],
        answer: 0,
        wrongHints: [null, "Klopt — glucose voor henzelf + O₂ voor ons.", "Planten maken geen vlees.", "Geen grondstoffen.", "CO₂ + water gaan IN, niet uit."],
      },
      {
        q: "Waarom zijn **bladeren groen**?",
        options: ["Door chlorofyl (de groene kleurstof)", "Door zonlicht", "Door water", "Toeval"],
        answer: 0,
        wrongHints: [null, "Klopt — chlorofyl vangt zonlicht op.", "Zonlicht is wit/geel.", "Water is doorzichtig.", "Geen toeval — biologische reden."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Bladeren zijn voor CO₂ + zonlicht, niet water.", "Zonlicht is energie, geen water.", "Wind brengt geen water."],
      },
      {
        q: "Wat doet een plant **'s nachts**?",
        options: ["Ademt zuurstof in (weinig)", "Doet fotosynthese", "Groeit niet", "Verandert in dier"],
        answer: 0,
        wrongHints: [null, "Klopt — wel ademen, geen fotosynthese.", "Geen zonlicht = geen fotosynthese.", "Planten groeien soms juist 's nachts.", "Nee."],
      },
      {
        q: "Wat is **NPK**?",
        options: ["Voedingsstoffen in mest", "Plant-soort", "Bladsoort", "Bloem-naam"],
        answer: 0,
        wrongHints: [null, "Klopt — stikstof, fosfor, kalium.", "Niet plant-soort.", "Niet blad.", "Niet bloem."],
      },
      {
        q: "Wat heeft een plant **NIET nodig**?",
        options: ["Eigen voedsel van buitenaf", "Zonlicht", "Water", "CO₂"],
        answer: 0,
        wrongHints: [null, "Klopt — plant maakt zelf voedsel via fotosynthese.", "Wel nodig.", "Wel nodig.", "Wel nodig."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — CO₂ in, O₂ + water uit.", "Geen plant-dier.", "Bladnerf is iets anders.", "Wortel-haar zit onder de grond."],
      },
      {
        q: "Welke kleur **weerkaatst** chlorofyl?",
        options: ["Groen", "Rood", "Blauw", "Geel"],
        answer: 0,
        wrongHints: [null, "Klopt — daarom zien we groene bladeren.", "Wordt opgenomen.", "Wordt opgenomen.", "Wordt deels opgenomen."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet exact 'op'.", "Wind helpt maar is niet de hoofdreden.", "Niet de hoofdreden."],
      },
      {
        q: "Welke boom **verliest GEEN bladeren** in herfst?",
        options: ["Den", "Eik", "Beuk", "Berk"],
        answer: 0,
        wrongHints: [null, "Klopt — naaldbomen houden naalden.", "Loofboom — verliest blad.", "Loofboom.", "Loofboom."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — plant maakt eigen voedsel.", "Mens is consument.", "Geen producent.", "Geen producent."],
      },
      {
        q: "Een **leeuw** eet vooral zebra's. Wat is dat?",
        options: ["Carnivoor", "Herbivoor", "Omnivoor", "Producent"],
        answer: 0,
        wrongHints: [null, "Klopt — vleeseter.", "Eet geen planten.", "Eet vrijwel alleen vlees.", "Geen plant."],
      },
      {
        q: "Mens is een ... ?",
        options: ["Omnivoor", "Carnivoor", "Herbivoor", "Producent"],
        answer: 0,
        wrongHints: [null, "Klopt — eet plant + dier.", "Niet alleen vlees.", "Niet alleen plant.", "Geen plant."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — elke schakel verliest ~90% energie.", "Niet altijd waar.", "Vlees heeft veel energie maar productie kost meer.", "Wel bekend."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Plant eet geen vlees.", "O₂ is product, niet input.", "Mest is voedingsstof, niet de hoofdinput."],
      },
      {
        q: "Wat **produceert** een plant tijdens fotosynthese?",
        options: ["Suiker + zuurstof", "Water + CO₂", "Energie + warmte", "Vlees + bloed"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Die zijn input, niet output.", "Niet directe producten.", "Plant maakt geen vlees."],
      },
      {
        q: "**Chlorofyl** zit in:",
        options: ["Chloroplasten (in bladcellen)", "Wortelhaar", "Boomstam", "Stuifmeel"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Bevat geen chlorofyl.", "Stam vooral hout, weinig chlorofyl.", "Stuifmeel is voor voortplanting."],
      },
      {
        q: "Een **kikker** eet vliegen. Kikker is dan een ...?",
        options: ["Consument (carnivoor)", "Producent", "Herbivoor", "Afbreker"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Geen plant.", "Geen plant-eter.", "Geen afbreker."],
      },
      {
        q: "**Wanneer geven planten zuurstof af**?",
        options: ["Overdag (in zonlicht)", "'s Nachts", "Alleen 's zomers", "Nooit"],
        answer: 0,
        wrongHints: [null, "Klopt — fotosynthese werkt met licht.", "Geen zonlicht 's nachts.", "Ook 's winters wel als zon schijnt.", "Wel — anders geen O₂ op aarde."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet allemaal tegelijk.", "Nee, behouden zomer en winter.", "Verliezen wel beetje per jaar."],
      },
    ],
  },
];
