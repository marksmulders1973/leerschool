    ...
    checks: [
      {
        ...
        options: ["12", "7", "34", "9"],
        answer: 0,
        wrongHints: [null, "Klopt — 3 keer 4 = 4+4+4 = 12.", "Dat is 3+4, niet 3×4.", "Plak-getal.", "Te weinig."],
      },
      {
        q: "Wat is **5 × 2**?",
        options: ["10", "7", "5", "52"],
        answer: 0,
        wrongHints: [null, "Klopt — 5 keer 2 = 2+2+2+2+2.", "Optelling.", "Te weinig.", "Plak-getal."],
      },
      {
        q: "**3 × 4** = **4 × 3** — klopt dat?",
      ...
      },
      {
        ...
        options: ["12", "8", "26", "10"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Optelling 2+6.", "Plak-getal.", "Te weinig."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        options: ["70", "17", "100", "7"],
        answer: 0,
        wrongHints: [null, "Klopt — 0 erbij plakken.", "Optelling 7+10.", "Te veel.", "Geen vermenigvuldiging."],
      },
      {
        q: "**6 × 5** = ?",
        options: ["30", "25", "11", "35"],
        answer: 0,
        wrongHints: [null, "Klopt — 6 × 5 = 30.", "Dat is 5 × 5.", "Optelling.", "Dat is 7 × 5."],
      },
      {
        q: "**9 × 2** = ?",
        options: ["18", "11", "20", "16"],
        answer: 0,
        wrongHints: [null, "Klopt — 9 + 9 = 18.", "Optelling.", "Dat is 10 × 2.", "Dat is 8 × 2."],
      },
      {
        q: "**3 × 5** = ?",
        options: ["15", "8", "35", "13"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Optelling.", "Plak-getal.", "Optelling met 10."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        options: ["12", "7", "43", "9"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Optelling.", "Plak-getal.", "Dat is 3 × 3."],
      },
      {
        q: "**7 × 4** = ?",
        options: ["28", "11", "47", "24"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Optelling.", "Plak-getal.", "Dat is 6 × 4."],
      },
      {
        q: "**9 × 3** = ?",
        options: ["27", "12", "30", "24"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Optelling.", "Dat is 10 × 3.", "Dat is 8 × 3."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        options: ["24", "10", "64", "20"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Optelling.", "Plak-getal.", "Dat is 5 × 4."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        options: ["42", "13", "67", "36"],
        answer: 0,
        wrongHints: [null, "Klopt — het beroemde 'antwoord op alles'.", "Optelling.", "Plak-getal.", "Niet juist."],
      },
      {
        q: "**8 × 7** = ?",
        options: ["56", "15", "87", "48"],
      ...
      },
      {
        ...
        options: ["54", "15", "96", "45"],
        answer: 0,
        wrongHints: [null, "Klopt — cijfers (5+4) = 9. ✓.", "Optelling.", "Plak-getal.", "Dat is 9 × 5."],
      },
      {
        q: "**8 × 8** = ?",
        options: ["64", "16", "88", "48"],
        answer: 0,
        wrongHints: [null, "Klopt — onthoud als 'acht keer acht is vierenzestig'.", "Optelling.", "Plak-getal.", "Dat is 6 × 8."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 7×10 + 7×2 = 70+14 = 84.", "Optelling.", "Plak-getal.", "Niet juist."],
      },
      {
        q: "**9 × 8** = ? *(via 10×8 − 8)*",
        options: ["72", "17", "98", "63"],
        answer: 0,
        wrongHints: [null, "Klopt — 80 - 8 = 72.", "Optelling.", "Plak-getal.", "Dat is 9 × 7."],
      },
      {
        q: "**5 × 18** = ? *(via 10×18 ÷ 2)*",
        options: ["90", "23", "518", "85"],
        answer: 0,
        wrongHints: [null, "Klopt — 180 ÷ 2 = 90.", "Optelling.", "Plak-getal.", "Net niet."],
      },
      {
        q: "**6 × 25** = ? *(via splitsen)*",
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      },
      {
        ...
        options: ["81", "18", "99", "72"],
        answer: 0,
        wrongHints: [null, "Klopt — onthoud als 'negen keer negen is eenentachtig'.", "Optelling.", "Plak-getal.", "Dat is 8 × 9."],
      },
      {
        q: "**8 × 5** = ?",
        options: ["40", "13", "85", "35"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Optelling.", "Plak-getal.", "Dat is 7 × 5."],
      },
      {
        q: "**4 zakjes** met **7 koekjes** per zakje. Totaal?",
        options: ["28 koekjes", "11 koekjes", "47 koekjes", "21 koekjes"],
        answer: 0,
        wrongHints: [null, "Klopt — 4 × 7 = 28.", "Optelling.", "Plak-getal.", "Dat is 3 × 7."],
      },
      {
        q: "**5 boeken** van **€7** elk. **Totaalprijs**?",
        options: ["€35", "€12", "€57", "€28"],
        answer: 0,
        wrongHints: [null, "Klopt — 5 × €7 = €35.", "Optelling.", "Plak-getal.", "Dat is 4 × 7."],
      },
      {
        q: "Welke tafel-uitkomst is **fout**?",
        options: ["7 × 8 = 54", "6 × 6 = 36", "9 × 4 = 36", "8 × 7 = 56"],
        answer: 0,
        wrongHints: [null, "Klopt — 7 × 8 = 56, niet 54.", "Klopt qua som.", "Klopt qua som.", "Klopt qua som."],
      },
      { q: "3 × 4 = ?", options: ["12","7","9","16"], answer: 0, wrongHints: [null,"Klopt.","Som.","Niet.","Niet."] },
      { q: "5 × 6 = ?", options: ["30","11","25","36"], answer: 0, wrongHints: [null,"Klopt.","Som.","5×5.","6×6."] },
      { q: "7 × 7 = ?", options: ["49","14","42","56"], answer: 0, wrongHints: [null,"Klopt.","Niet — × niet +.","Niet.","Niet."] },
      { q: "8 × 9 = ?", options: ["72","17","81","56"], answer: 0, wrongHints: [null,"Klopt.","Som.","9×9.","Niet."] },
      { q: "6 × 7 = ?", options: ["42","13","36","49"], answer: 0, wrongHints: [null,"Klopt.","Som.","Niet.","Niet."] },
      { q: "4 × 8 = ?", options: ["32","12","36","48"], answer: 0, wrongHints: [null,"Klopt.","Som.","Niet.","Te veel."] },
      { q: "Welke is tafel van **9**? 9 × 6 = ?", options: ["54","56","45","63"], answer: 0, wrongHints: [null,"Klopt — 9-truc: 5(tien) + 4(een) = 54.","Niet.","Cijfers gehusseld.","9×7."] },
      { q: "10 × 8 = ?", options: ["80","18","100","800"], answer: 0, wrongHints: [null,"Klopt.","Som.","10×10.","Te veel."] },
      { q: "2 × 12 = ?", options: ["24","14","20","6"], answer: 0, wrongHints: [null,"Klopt — dubbel.","Niet.","Niet.","Helft."] },
      { q: "Tafel-truc: 5 × even getal eindigt op?", options: ["0","5","1","2"], answer: 0, wrongHints: [null,"Klopt — 5×2=10, 5×4=20.","Bij oneven.","Niet.","Niet."] },
      { q: "Welke truc helpt bij **9-tafel**?", options: ["Stappen van −1 in tientallen, +1 in eenheden","Tafel optellen","Niet relevant","Per stuk leren"], answer: 0, wrongHints: [null,"Klopt — 9,18,27,36...","Niet specifiek.","Wel handig.","Werkt traag."] },
      { q: "6 × 8 = ?", options: ["48","14","56","42"], answer: 0, wrongHints: [null,"Klopt.","Som.","7×8.","6×7."] },
      { q: "11 × 11 = ?", options: ["121","111","112","144"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","12×12."] },
      { q: "12 × 4 = ?", options: ["48","16","44","36"], answer: 0, wrongHints: [null,"Klopt.","Som.","Niet.","12×3."] },
    ],
  },
];
