    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Alle vogels hebben veren.",
            simpeler: "Veren komen alleen bij vogels voor — uniek kenmerk.",
            nogSimpeler: "Veren = vogel.",
          },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "8 poten.",
            simpeler: "Spinnen hebben 8 poten (4 links + 4 rechts). Daarom zijn ze geen insect (insecten = 6).",
            nogSimpeler: "8",
          },
        },
      },
