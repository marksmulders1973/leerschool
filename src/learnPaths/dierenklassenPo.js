  ...
  // STAP 3: Vissen + amfibieën
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — kikkervis is een fase van kikker.", "Pad is een ander dier.", "Salamander is ander dier."],
      },
      {
        q: "Welk dier is een **amfibie**?",
        options: ["Salamander", "Hagedis", "Goudvis", "Vlieg"],
        answer: 0,
        wrongHints: [null, "Reptiel.", "Vis.", "Insect."],
      },
      {
        q: "**Vissen** zijn ... ?",
        options: ["Koudbloedig", "Warmbloedig", "Halfwarm", "Geen bloed"],
        answer: 0,
        wrongHints: [null, "Niet — alleen zoogdieren+vogels.", "Bestaat niet.", "Wel bloed."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        options: ["8", "6", "4", "2"],
        answer: 0,
        wrongHints: [null, "Insecten hebben 6.", "Zoogdieren hebben 4.", "Vogels/mensen hebben 2."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Amfibie.", "Spinachtige.", "Zoogdier."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Te weinig.", "Spinnen hebben 2 lichaamsdelen.", "Te veel."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Uilen eten geen gras.", "Niet typisch.", "Uil eet vooral muis."],
      },
      {
        q: "Een **koe** is een ... ?",
        options: ["Herbivoor (plant-eter)", "Carnivoor (vlees-eter)", "Omnivoor", "Producent"],
        answer: 0,
        wrongHints: [null, "Eet geen vlees.", "Eet geen vlees.", "Producent is een plant."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Dat zijn consumenten.", "Dat zijn afbrekers.", "Wel iets — planten produceren."],
      },
      {
        q: "Welk dier leeft op de **Noordpool**?",
        options: ["IJsbeer", "Pinguïn", "Leeuw", "Krokodil"],
        answer: 0,
        wrongHints: [null, "Pinguïns wonen op Zuidpool / Zuidelijk halfrond.", "Afrika.", "Tropen."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — geen schubben/kieuwen.", "Geen veren.", "Geen schubben."],
      },
      {
        q: "Welke heeft **veren**?",
        options: ["Pinguïn", "Hagedis", "Walvis", "Mier"],
        answer: 0,
        wrongHints: [null, "Schubben.", "Geen veren — zoogdier.", "Insect, geen veren."],
      },
      {
        q: "Een **kikker** is een ... ?",
        options: ["Amfibie", "Reptiel", "Vis", "Insect"],
        answer: 0,
        wrongHints: [null, "Geen schubben.", "Leeft niet alleen in water.", "4 poten, niet 6."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Wel zoogdier.", "Wel zoogdier.", "Wel zoogdier."],
      },
      { q: "Hoeveel **diergroepen** zijn er (gewervelden)?", options: ["5 (zoogdier/vogel/reptiel/amfibie/vis)","2","10","3"], answer: 0, wrongHints: [null, "Te weinig.", "Te veel.", "Te weinig."] },
      ...
      { q: "Een **vlinder** is een?", options: ["Insect","Vogel","Reptiel","Zoogdier"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "Een **kip** is een?", options: ["Vogel","Zoogdier","Reptiel","Vis"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      ...
      { q: "Hoe planten zoogdieren zich voort?", options: ["Levende jongen baren","Eieren","Wisselend","Niet"], answer: 0, wrongHints: [null, "Vogel/reptiel/vis.", "Niet.", "Wel."] },
      { q: "Welke diergroep **ademt door longen ÉN huid**?", options: ["Amfibieën","Vogels","Vissen","Insecten"], answer: 0, wrongHints: [null, "Alleen longen.", "Kieuwen.", "Tracheeën."] },
      { q: "Wat is een **roofdier** (predator)?", options: ["Dier dat andere dieren jaagt/eet","Planten-eter","Aaseter","Allesvreter"], answer: 0, wrongHints: [null, "Tegengestelde.", "Andere niche.", "Te breed."] },
    ],
  },
];
