...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Welke Amerikaanse stad heette eerst **Nieuw-Amsterdam**?", options: ["New York","Boston","Chicago","Philadelphia"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      ...
      { q: "**Henry Hudson** was wiens zeevaarder?", options: ["Engels — voor NL/Engeland gewerkt","Frans","Spanje","Portugees"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
