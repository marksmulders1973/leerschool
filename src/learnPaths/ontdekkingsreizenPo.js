...
// toets-relevant Tijdvak 5. 1F. 4 stappen.
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Bestond nog niet.", "Niet.", "Wel reden."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-feit: 1453 viel Constantinopel (huidig Istanbul) in handen van Turken. Daardoor was Zijderoute moeilijk → ZEE-route via Afrika was nieuwe doel. Vasco da Gama lukte het in 1498.",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Een schip is iets om mee te varen, geen instrument.", "Een kaart toont het land, maar meet niet de sterren.", "Voedsel is geen meetinstrument."],
      },
      {
        q: "Wat is **scheurbuik**?",
        options: ["Vitamine C-tekort ziekte", "Maagpijn", "Hoofdpijn", "Niet bestaand"],
        answer: 0,
        wrongHints: [null, "Niet specifiek.", "Niet.", "Wel."],
      },
      {
        q: "Wat verdeelde **Verdrag van Tordesillas**?",
        options: ["Wereld tussen Portugal + Spanje", "Europa", "Azië", "Niet bestaand"],
        answer: 0,
        wrongHints: [null, "Niet primair.", "Niet alleen.", "Wel."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Iets later.", "Te vroeg.", "Te laat."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-feit: 1492 = vaak gezien als overgang van Middeleeuwen naar Nieuwe Tijd. Maar opgepast — 'ontdekken' is Europees perspectief. Indianen waren er al duizenden jaren. Tegenwoordig vinden veel mensen 'ontdekking' geen goed woord — beter: 'contact'.",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Westwaarts.", "Rond aarde.", "Australië."],
      },
      {
        q: "Wie zeilde **eerst rond aarde**?",
        options: ["Magellan-expeditie (1519-1522)", "Columbus", "Cabot", "Dias"],
        answer: 0,
        wrongHints: [null, "Niet rond.", "Niet rond.", "Niet."],
      },
      {
        q: "Wanneer **slavernij in NL afgeschaft**?",
        options: ["1863", "1700", "1492", "2022"],
        answer: 0,
        wrongHints: [null, "Veel later.", "Begon kort daarna.", "Excuses, geen afschaffing."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-feit: NL kwam relatief LAAT met afschaffing. UK: 1833. Frankrijk: 1848. VS: 1865 (na burgeroorlog). NL was 1863. Daarvoor 200+ jaar deelnemer aan trans-Atlantische slavenhandel.",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Columbus.", "Te laat.", "Bijna failliet."],
      },
      {
        q: "Wie ontdekte **Nieuw-Zeeland**?",
        options: ["Abel Tasman (1642)", "Columbus", "Magellan", "Cook"],
        answer: 0,
        wrongHints: [null, "Niet.", "Niet.", "Later — herontdekt."],
      },
      {
        q: "Wat werd **Nieuw-Amsterdam**?",
        options: ["New York (1664)", "Boston", "Washington", "Chicago"],
        answer: 0,
        wrongHints: [null, "Boston is door Engelsen gesticht, geen NL-koloniestad.", "Washington is later gesticht (1791) als hoofdstad.", "Chicago ligt midden in het binnenland."],
      },
      {
        q: "**Paaseiland** ontdekt door?",
        options: ["Jacob Roggeveen (1722)", "Tasman", "Hudson", "Columbus"],
        answer: 0,
        wrongHints: [null, "Tasman ontdekte Tasmanië en Nieuw-Zeeland.", "Hudson voer in Noord-Amerika.", "Columbus was 1492, in het Caribisch gebied."],
      },
    ],
  },
  {
    ...
    checks: [
      { q: "**Columbus** in welk jaar Amerika?", options: ["1492", "1500", "1300", "1700"], answer: 0, wrongHints: [null, "Iets later.", "Te vroeg.", "Te laat."] },
      { q: "Wie zeilde **eerste rond aarde**?", options: ["Magellan-expeditie", "Columbus", "Cook", "Hudson"], answer: 0, wrongHints: [null, "Niet.", "Veel later.", "Niet."] },
      ...
      { q: "**Slavernij in NL** afgeschaft?", options: ["1863", "1492", "2024", "Nooit"], answer: 0, wrongHints: [null, "Te vroeg.", "Te laat — excuses dat jaar.", "Wel afgeschaft."] },
      {
        ...
        answer: 0,
        wrongHints: [null, "Toerisme bestond nog niet — risico te hoog.", "Niet — geen sportwedstrijden.", "Wetenschap deels (kaarten maken), maar geld was hoofdmotief."],
        uitlegPad: {
          stappen: [
          ...
          basiskennis: [{ onderwerp: "Niet alleen heldenverhaal", uitleg: "Vroeger werd het positief verteld. Tegenwoordig erkent de toets ook negatieve kanten — slavernij + onderdrukking." }],
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Geen sport.", "Geen onderwijs.", "Wel — 200 jaar invloed."],
        uitlegPad: {
          stappen: [
          ...
          basiskennis: [{ onderwerp: "Niet alleen positief", uitleg: "Toets-onderwijs nu benadrukt ook negatieve kant: dwangarbeid, slavernij, onderdrukking lokale volken. Andere kijk dan 50 jaar geleden." }],
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — historische feiten zijn duidelijk donkerder.", "Niet — Europeanen vestigden kolonies + tot slaaf gemaakt.", "Niet — meeste werden armer of dood."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-tip: vroeger versus nu in geschiedenisles\n• **Vroeger**: 'Columbus ontdekte Amerika' = held\n• **Nu**: 'Columbus zeilde naar Amerika — er woonden al miljoenen mensen. Wat hij begon werd ramp voor hen.'\n\nGeschiedenis kijkt naar **alle perspectieven** — winnaars + verliezers. Bij de Doorstroomtoets zien we meer historische nuance dan vroeger.",
          voorbeelden: [
      ...
      { q: "Wat is de **VOC**?", options: ["Verenigde Oost-Indische Compagnie","Voetbal-Organisatie-Club","Voor Op Computer","Vinden Onder Cito"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Onzin."] },
      { q: "Welke Nederlander ontdekte **Tasmanië**?", options: ["Abel Tasman","Columbus","Magellan","Barentsz"], answer: 0, wrongHints: [null, "Niet — Amerika.", "Wereldreis maar niet Tasmanië-eerst.", "Nova Zembla."] },
      { q: "Welke Amerikaanse stad heette eerst **Nieuw-Amsterdam**?", options: ["New York","Boston","Chicago","Philadelphia"], answer: 0, wrongHints: [null, "Boston is Engelse stichting.", "Chicago ligt diep in het binnenland.", "Philadelphia is later gesticht door Quakers."] },
      { q: "Wie maakte de **eerste wereldreis** (1519-1522)?", options: ["Magellan's expeditie","Columbus","Vasco da Gama","Tasman"], answer: 0, wrongHints: [null, "Atlantische.", "India.", "Tasmanië."] },
      { q: "**Vasco da Gama** bereikte als eerste?", options: ["India via zee (Kaap de Goede Hoop)","Amerika","Australië","Niet bekend"], answer: 0, wrongHints: [null, "Columbus.", "Veel later.", "Wel."] },
      { q: "Welke Spanjaard veroverde **Aztekenrijk** (Mexico)?", options: ["Cortés","Pizarro","Columbus","Magellan"], answer: 0, wrongHints: [null, "Inca's.", "Bahamas.", "Wereldreis."] },
      { q: "Welke Spanjaard veroverde **Inca-rijk** (Peru)?", options: ["Pizarro","Cortés","Columbus","Magellan"], answer: 0, wrongHints: [null, "Azteken.", "Bahamas.", "Niet."] },
      { q: "Wat is de **WIC**?", options: ["West-Indische Compagnie","Wereldhandel-VK","Niet bestaand","NL koning"], answer: 0, wrongHints: [null, "Wel.", "Niet bestaand bij ons.", "Niet."] },
      { q: "Welk NL-eiland (in Caribisch gebied)?", options: ["Curaçao / Aruba","Hawaii","Sicilië","Niet relevant"], answer: 0, wrongHints: [null, "Niet.", "Italiaans.", "Wel."] },
      { q: "**Henry Hudson** was wiens zeevaarder?", options: ["Engels — voor NL/Engeland gewerkt","Frans","Spanje","Portugees"], answer: 0, wrongHints: [null, "Geen Franse achternaam.", "Niet — Spaanse ontdekkers waren bv. Columbus.", "Niet — Portugezen waren bv. Vasco da Gama."] },
      { q: "**Willem Barentsz** zocht naar?", options: ["Noordelijke route naar Azië","Amerika","Australië","Niet relevant"], answer: 0, wrongHints: [null, "Andere richting.", "Niet.", "Wel."] },
      { q: "**Verdrag van Tordesillas** (1494) verdeelde wat?", options: ["Wereld tussen Spanje en Portugal","NL en België","Engeland en Frankrijk","Niet bestaand"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Wel."] },
      { q: "Wat is **slavernij** in koloniale tijd?", options: ["Mensen gevangen + gedwongen werken zonder vrijheid","Werk met loon","Niet relevant","Reclame"], answer: 0, wrongHints: [null, "Niet.", "Wel.", "Niet."] },
      { q: "**Keti Koti** is wat?", options: ["NL-feestdag herdenking afschaffing slavernij","Voetbal","Eten","Niet relevant"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Wel."] },
      { q: "Welke producten brachten **VOC** terug?", options: ["Specerijen + thee + porselein","Niets","Plastic","Niet relevant"], answer: 0, wrongHints: [null, "Wel.", "Niet bekend toen.", "Wel."] },
      { q: "Wat is de **gouden eeuw** voor NL?", options: ["17e eeuw — handel + kunst-bloei","20e eeuw","Middeleeuwen","Niet bestaand"], answer: 0, wrongHints: [null, "Te recent.", "Te vroeg.", "Wel."] },
      { q: "Welke ziekte verspreidde Europeanen in Amerika?", options: ["Pokken","Verkoudheid","Niet relevant","Reclame"], answer: 0, wrongHints: [null, "Niet dodelijk.", "Wel.", "Niet."] },
      { q: "Wat is een **compagnie** (zoals VOC)?", options: ["Handelsorganisatie","Politiek","Niet relevant","Reclame"], answer: 0, wrongHints: [null, "Wel.", "Niet.", "Niet."] },
    ],
  },
];
...
const ontdekkingsreizenPo = {
  ...
  title: "Ontdekkingsreizen (Doorstroomtoets groep 6-8)",
  emoji: "🧭",
  level: "groep6-8",
  ...
  intro:
    "Ontdekkingsreizen voor Doorstroomtoets groep 6-8 — waarom op reis (specerijen, goud) + Columbus 1492 + Vasco da Gama + Magellan + slavenhandel + NL-ontdekkers (Tasman, Hudson, Barentsz, Roggeveen) + VOC + Nieuw-Amsterdam → New York. Tijdvak 5. ~15 min.",
  triggerKeywords: [
