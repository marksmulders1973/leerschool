...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wie maakte de **eerste wereldreis** (1519-1522)?", options: ["Magellan's expeditie","Columbus","Vasco da Gama","Tasman"], answer: 0, wrongHints: [null,"Klopt — Magellan stierf maar schip kwam terug.","Atlantische.","India.","Tasmanië."] },
      { q: "**Vasco da Gama** bereikte als eerste?", options: ["India via zee (Kaap de Goede Hoop)","Amerika","Australië","Niet bekend"], answer: 0, wrongHints: [null,"Klopt — 1498.","Columbus.","Veel later.","Wel."] },
      { q: "Welke Spanjaard veroverde **Aztekenrijk** (Mexico)?", options: ["Cortés","Pizarro","Columbus","Magellan"], answer: 0, wrongHints: [null,"Klopt — 1521.","Inca's.","Bahamas.","Wereldreis."] },
      { q: "Welke Spanjaard veroverde **Inca-rijk** (Peru)?", options: ["Pizarro","Cortés","Columbus","Magellan"], answer: 0, wrongHints: [null,"Klopt — 1533.","Azteken.","Bahamas.","Niet."] },
      { q: "Wat is de **WIC**?", options: ["West-Indische Compagnie","Wereldhandel-VK","Niet bestaand","NL koning"], answer: 0, wrongHints: [null,"Klopt — Atlantische handel.","Wel.","Niet bestaand bij ons.","Niet."] },
      { q: "Welk NL-eiland (in Caribisch gebied)?", options: ["Curaçao / Aruba","Hawaii","Sicilië","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — NL Antillen.","Niet.","Italiaans.","Wel."] },
      { q: "**Henry Hudson** was wiens zeevaarder?", options: ["Engels — voor NL/Engeland gewerkt","Frans","Spanje","Portugees"], answer: 0, wrongHints: [null,"Klopt — Hudson Bay.","Niet.","Niet.","Niet."] },
      { q: "**Willem Barentsz** zocht naar?", options: ["Noordelijke route naar Azië","Amerika","Australië","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — Nova Zembla.","Andere richting.","Niet.","Wel."] },
      { q: "**Verdrag van Tordesillas** (1494) verdeelde wat?", options: ["Wereld tussen Spanje en Portugal","NL en België","Engeland en Frankrijk","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — paus-gemarkeerde lijn.","Niet.","Niet.","Wel."] },
      { q: "Wat is **slavernij** in koloniale tijd?", options: ["Mensen gevangen + gedwongen werken zonder vrijheid","Werk met loon","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — schande.","Niet.","Wel.","Niet."] },
      { q: "**Keti Koti** is wat?", options: ["NL-feestdag herdenking afschaffing slavernij","Voetbal","Eten","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — 1 juli 1863.","Niet.","Niet.","Wel."] },
      { q: "Welke producten brachten **VOC** terug?", options: ["Specerijen + thee + porselein","Niets","Plastic","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — handel.","Wel.","Niet bekend toen.","Wel."] },
      { q: "Wat is de **gouden eeuw** voor NL?", options: ["17e eeuw — handel + kunst-bloei","20e eeuw","Middeleeuwen","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — Rembrandt etc.","Te recent.","Te vroeg.","Wel."] },
      { q: "Welke ziekte verspreidde Europeanen in Amerika?", options: ["Pokken","Verkoudheid","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — geen immuniteit.","Niet dodelijk.","Wel.","Niet."] },
      { q: "Wat is een **compagnie** (zoals VOC)?", options: ["Handelsorganisatie","Politiek","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt.","Wel.","Niet.","Niet."] },
    ],
  },
];
