    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "regelmatig", uitleg: "+ed achteraan" }],
          theorie: "Basisvorm + -ed = past simple.",
          voorbeelden: [{ type: "voorbeeld", tekst: "walk→walked, talk→talked" }],
          basiskennis: [{ onderwerp: "≠ irregular", uitleg: "regelmatige werkwoorden = standaard" }],
          niveaus: { basis: "walked.", simpeler: "Walk + ed.", nogSimpeler: "walked." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "go-went-gone", tekst: "V2 van go = went." }],
          woorden: [{ woord: "went", uitleg: "V2, gebruikt voor past simple" }],
          theorie: "Go is heel onregelmatig — eigen vormen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Yesterday I went home" }],
          basiskennis: [{ onderwerp: "geen 'goed'", uitleg: "klassieke fout" }],
          niveaus: { basis: "went.", simpeler: "V2 van go.", nogSimpeler: "went." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "V3 na have/has/had", tekst: "Perfect tijden gebruiken V3." }],
          woorden: [{ woord: "perfect", uitleg: "have + V3" }],
          theorie: "Have/has/had eisen V3 (past participle).",
          voorbeelden: [{ type: "voorbeeld", tekst: "I have eaten, she had gone" }],
          basiskennis: [{ onderwerp: "drie vormen", uitleg: "V1=basis, V2=verleden, V3=perfect" }],
          niveaus: { basis: "Na have/has/had.", simpeler: "Bij perfect.", nogSimpeler: "Na have." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Yesterday = V2", tekst: "Yesterday signaleert past simple." }],
          woorden: [{ woord: "tijdwoord", uitleg: "yesterday, last week, ago" }],
          theorie: "Vaste tijdstippen → V2 (past simple).",
          voorbeelden: [{ type: "voorbeeld", tekst: "yesterday, last year, 5 minutes ago" }],
          basiskennis: [{ onderwerp: "perfect-woorden", uitleg: "ever/never/already/since → V3" }],
          niveaus: { basis: "yesterday.", simpeler: "Vast tijdstip = V2.", nogSimpeler: "yesterday." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "AAA = blijft cut", tekst: "Cut-cut-cut. Alle 3 hetzelfde." }],
          woorden: [{ woord: "AAA", uitleg: "geen verandering" }],
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "put = AAA", tekst: "Put-put-put. Alle 3 hetzelfde, geen verandering." }],
          woorden: [{ woord: "AAA-groep", uitleg: "cut, put, hit, let, cost..." }],
  ...
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "come-came-come", tekst: "ABA: V1 = V3 = come." }],
          woorden: [{ woord: "ABA", uitleg: "V1 en V3 hetzelfde, V2 anders" }],
          theorie: "Come/become/run = ABA-groep.",
          voorbeelden: [{ type: "voorbeeld", tekst: "come→came→come, run→ran→run" }],
          basiskennis: [{ onderwerp: "kleine groep", uitleg: "maar 3 belangrijke" }],
          niveaus: { basis: "come.", simpeler: "ABA = come.", nogSimpeler: "come." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "ABC", uitleg: "alle 3 vormen verschillend" }],
          niveaus: { basis: "eaten.", simpeler: "V3 = eaten.", nogSimpeler: "eaten." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "drink-drank-drunk", tekst: "i → a → u patroon." }],
          woorden: [{ woord: "klinkershift", uitleg: "i in V1, a in V2, u in V3" }],
          theorie: "i-a-u groep: sing/ring/swim/drink/sink/begin.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I drink, drank, have drunk" }],
          basiskennis: [{ onderwerp: "ritme", uitleg: "rijtje voelt muzikaal aan" }],
          niveaus: { basis: "drink-drank-drunk.", simpeler: "i → a → u.", nogSimpeler: "drank-drunk." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "stille letters", uitleg: "geen -ed in spelling" }],
          niveaus: { basis: "heard.", simpeler: "V3 = heard.", nogSimpeler: "heard." },
        },
      },
    ],
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Swim ≠ -ought/-aught", tekst: "Swim volgt i-a-u patroon, niet -ought." }],
          woorden: [{ woord: "ander patroon", uitleg: "i-a-u groep" }],
          theorie: "Klinkershift-werkwoorden hebben geen -ought.",
          voorbeelden: [{ type: "voorbeeld", tekst: "swim-swam-swum (niet swought)" }],
          basiskennis: [{ onderwerp: "groep-verschil", uitleg: "patronen helpen onthouden" }],
          niveaus: { basis: "swim.", simpeler: "Ander patroon.", nogSimpeler: "swim/sing." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "swim-swam-swum", tekst: "i → a → u patroon." }],
          woorden: [{ woord: "klinkershift", uitleg: "i-a-u groep" }],
          theorie: "V1 i, V2 a, V3 u. Geen verandering medeklinkers.",
          voorbeelden: [{ type: "voorbeeld", tekst: "swim-swam-swum, ring-rang-rung" }],
          basiskennis: [{ onderwerp: "muzikaal patroon", uitleg: "leuk om hardop te lezen" }],
          niveaus: { basis: "swim-swam-swum.", simpeler: "i-a-u.", nogSimpeler: "swam-swum." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Yesterday → went", tekst: "Past simple bij vast tijdstip." }],
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "read-read-read", tekst: "Spelling gelijk, uitspraak verandert (reed → red)." }],
          woorden: [{ woord: "read (V3)", uitleg: "uitgesproken 'red'" }],
          theorie: "Read is AAA in spelling, maar uitspraak verandert.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I have read that book" }],
          basiskennis: [{ onderwerp: "speciale AAA", uitleg: "alleen uitspraak verschilt" }],
          niveaus: { basis: "read.", simpeler: "Blijft read.", nogSimpeler: "read (uitspraak: red)." },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "have seen", tekst: "see-saw-seen. Na have → V3 = seen." }],
          woorden: [{ woord: "seen", uitleg: "V3 van see" }],
          theorie: "Have/has + V3 = present perfect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Have you seen the new movie?" }],
          basiskennis: [{ onderwerp: "ervaring", uitleg: "perfect bij ervaring" }],
          niveaus: { basis: "seen.", simpeler: "Have + seen.", nogSimpeler: "seen." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "break-broke-broken", tekst: "Last week → V2 = broke." }],
      ...
      { q: "**V2 van 'make'** =?", options: ["made","maked","makes","making"], answer: 0, wrongHints: [null,"Onregelmatig.","Present 3e.","-ing."] },
      { q: "**V2 van 'give'** =?", options: ["gave","given","gived","gives"], answer: 0, wrongHints: [null,"V3.","Onregelmatig.","Present 3e."] },
      { q: "**V2 van 'come'** =?", options: ["came","comed","come","coming"], answer: 0, wrongHints: [null,"Onregelmatig.","V1.","-ing."] },
      { q: "**Open vraag**: V2 van 'have'?", kind: "open", acceptedAnswers: ["had"], explanation: "have → had → had (V1/V2/V3)." },
      { q: "**Open vraag**: V2 van 'write'?", kind: "open", acceptedAnswers: ["wrote"], explanation: "write → wrote → written." },
    ],
  },
];
