...
const steps = [
  // STAP 1: Wat is een gemiddelde?
  {
    ...
    checks: [
      ...
      },
      {
        ...
        options: ["3", "6", "7", "8"],
        answer: 0,
        wrongHints: [null, "Klopt — 3 ligt onder de laagste. Goed antwoord.", "Klopt wel — 6 kan tussen 5 en 9 liggen.", "Klopt wel — 7 is precies tussen 5 en 9.", "Klopt wel — 8 kan tussen 5 en 9 liggen."],
        uitlegPad: {
          stappen: [
  ...
  // STAP 3: Modus
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Rood is 3× — blauw is 8×, dat is meer.", "Groen is maar 2× — minst van allemaal.", "Geel is 3× — blauw is 8×."],
        uitlegPad: {
          stappen: [
  ...
  // STAP 5: Wanneer wat gebruiken?
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "De vraag zegt letterlijk 'gemiddeld'.", "Mediaan is het middelste, niet het gemiddelde.", "Maximum is het hoogste, niet het gemiddelde."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Gemiddelde wordt opgedreven door de rijke. Mediaan negeert die uitschieter.", "Modus zou het meest-verdiende bedrag exact zijn — kan handig zijn maar minder algemeen.", "Som is totaal van alle inkomens, niet 'per persoon'."],
      },
      {
        q: "Wat heeft een **kleur-stemming** wel maar geen gemiddelde?",
        options: ["Modus", "Gemiddelde", "Mediaan", "Geen van deze"],
        answer: 0,
        wrongHints: [null, "Kun je geen 'gemiddelde kleur' berekenen. Modus werkt wel.", "Mediaan werkt ook niet — geen volgorde tussen kleuren.", "Modus werkt wél — vaakst gekozen kleur."],
      },
    ],
  },
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "Gem van 3, 5, 7?", options: ["5","15","3","7"], answer: 0, wrongHints: [null,"Klopt — 15÷3.","Dat is som.","Min.","Max."] },
      { q: "Modus van 4, 7, 4, 9, 4, 7, 2?", options: ["4","7","9","2"], answer: 0, wrongHints: [null,"Klopt — komt 3× voor.","2 keer.","1 keer.","1 keer."] },
      { q: "Mediaan van 5, 2, 8, 1, 4?", options: ["4","2","8","5"], answer: 0, wrongHints: [null,"Klopt — sorteer 1,2,4,5,8 → middelste 4.","Niet zonder sorteren.","Niet.","Niet zonder sorteren."] },
      { q: "Mediaan van 4, 6, 8, 10?", options: ["7","6","8","9"], answer: 0, wrongHints: [null,"Klopt — even aantal: gem 6+8 = 7.","Een midden.","Een midden.","Niet."] },
      { q: "Gem van 10, 20, 30, 40?", options: ["25","30","100","40"], answer: 0, wrongHints: [null,"Klopt — 100÷4.","Niet — middelpunt klopt.","Som.","Max."] },
      { q: "5 toetsen, gemiddelde 7. Som?", options: ["35","12","7","75"], answer: 0, wrongHints: [null,"Klopt — 5×7.","Niet — som = aantal × gem.","Gem.","Te veel."] },
      { q: "Bereik van 12, 5, 18, 9, 3?", options: ["15","18","12","3"], answer: 0, wrongHints: [null,"Klopt — 18−3.","Max alleen.","Niet.","Min alleen."] },
      { q: "Modus van 1,2,3,4,5 (alle 1×)?", options: ["Geen modus","1","5","3"], answer: 0, wrongHints: [null,"Klopt — geen waarde vaker.","Niet — vaakst is niemand.","Niet.","Niet."] },
      { q: "Welk getal in een rij komt **vaakst** voor: 3, 5, 5, 5, 7, 7, 9?", options: ["5","7","3","9"], answer: 0, wrongHints: [null,"Klopt — 3 keer.","2 keer.","1 keer.","1 keer."] },
      { q: "Wanneer is mediaan zinvoller dan gemiddelde?", options: ["Bij uitschieters","Bij weinig getallen","Nooit","Altijd"], answer: 0, wrongHints: [null,"Klopt — minder beïnvloed.","Niet.","Wel soms.","Niet altijd."] },
      { q: "Een **uitschieter** is?", options: ["Extreem hoog/laag getal dat van rest afwijkt","Een wedstrijd","Een spel","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — bv. miljonair in inkomensgegroep.","Niet relevant.","Niet.","Wel."] },
      { q: "Welke maat verandert het meest als je 1 grote uitschieter toevoegt?", options: ["Gemiddelde","Mediaan","Modus","Geen"], answer: 0, wrongHints: [null,"Klopt — extreem gevoelig.","Minder.","Helemaal niet meestal.","Wel — gemiddelde."] },
      { q: "5 keer gegooid: 3, 5, 5, 6, 6. Mediaan?", options: ["5","6","4","3"], answer: 0, wrongHints: [null,"Klopt — middelste van 5 = 3e = 5.","2 middelste.","Te laag.","Te laag."] },
      { q: "Gem van 4 en 8?", options: ["6","12","4","2"], answer: 0, wrongHints: [null,"Klopt — (4+8)/2.","Niet — dat is som.","Klein.","Niet."] },
      { q: "Welke verschilt: gem 5, modus 5, mediaan 5 — kan dat?", options: ["Ja — vooral bij symmetrische data","Nooit","Alleen bij 1 getal","Alleen bij 2 getallen"], answer: 0, wrongHints: [null,"Klopt — 4,5,5,5,6 bijvoorbeeld.","Wel.","Niet.","Niet."] },
    ],
  },
];
