    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "Een nieuw wetsvoorstel indienen kan de Kamer doen via het initiatiefrecht. De andere rechten gaan over vragen, moties of onderzoek.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Europese Commissie.",
            simpeler: "De Commissie is dagelijks bestuur EU + 'hoeder van verdragen' = doet toezicht op lidstaten.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Hoger beroep.",
            simpeler: "Alleen hoger beroep (naar gerechtshof) kan een vonnis veranderen. Andere rechten gaan over andere fasen.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "Tijdens een politieactie zit je in de OPSPORINGS-fase. De officier van justitie geeft leiding aan dat onderzoek (samen met politie).",
