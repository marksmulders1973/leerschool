    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Spierlaag.",
            simpeler: "Peristaltiek is de knijp-beweging van spieren. Minder actief = spierlaag werkt minder = trage maag.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Bewust voelen (zoals een vol gevoel) gebeurt in de grote hersenen.",
            simpeler: "Grote hersenen = bewust (voelen, denken). Kleine hersenen = balans. Hersenstam = ademen/hartslag. Een vol gevoel voel je bewust → grote hersenen.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Hoornlaag → kiemlaag → lederhuid.",
            simpeler: "Buitenste = hoornlaag (dood). Daaronder = kiemlaag (levend). Daaronder = lederhuid (met bloedvaten). Luis prikt door in die volgorde.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Consument.",
            simpeler: "Vingerdier eet larven = eet andere organismen = consument.",
