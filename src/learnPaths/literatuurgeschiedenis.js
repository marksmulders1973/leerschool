...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">examenstof havo 4 🏆</text>
    ...
    checks: [
      ...
      { q: "*Max Havelaar* (Multatuli) protesteerde tegen?", options: ["Koloniale uitbuiting in Indië","Koningshuis","Industrialisatie","Religie"], answer: 0, wrongHints: [null,"Klopt — 1860 aanklacht tegen NL bestuur in Ned.-Indië.","Niet onderwerp.","Niet kernthema boek.","Niet kernthema."] },
      { q: "Tot welke stroming hoort Joost van den Vondel?", options: ["Gouden Eeuw","Romantiek","Modernisme","Postmodernisme"], answer: 0, wrongHints: [null,"Klopt — 17e-eeuwse toneeldichter (Gysbreght).","19e eeuw, te laat.","20e eeuw, te laat.","Heel recent."] },
      { q: "De **Tachtigers** stonden bekend om?", options: ["L'art pour l'art / individualisme","Realisme","Klassieke regels","Religieuze poëzie"], answer: 0, wrongHints: [null,"Klopt — Kloos, Gorter — kunst om de kunst.","Eerdere stroming.","Niet — juist breken met regels.","Niet kernthema."] },
      { q: "Welk verschil is er tussen **'ik-perspectief'** en **'auctorieel'**?", options: ["Ik = 1e persoon binnenuit; auctorieel = alwetende verteller","Geen verschil","Ik is altijd onbetrouwbaar","Auctorieel = 1e persoon"], answer: 0, wrongHints: [null,"Klopt.","Wel verschil — eigen blik vs goden-blik.","Niet altijd.","Andersom."] },
    ],
  },
];
