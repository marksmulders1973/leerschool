    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Geen letterlijke jaartallen", tekst: "Op havo: globale tijdvakken, niet jaartal van geboorte/sterfte." }],
          woorden: [{ woord: "examenstof", uitleg: "wat moet ik wel/niet weten" }],
          theorie: "Wel: stromingen + kenmerken + top-schrijvers. Niet: letterlijke jaren.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Multatuli ~1860 (Romantiek) — exact jaar niet vereist" }],
          basiskennis: [{ onderwerp: "leesdossier", uitleg: "werken in stroming kunnen plaatsen" }],
          niveaus: { basis: "Letterlijke jaartallen niet vereist.", simpeler: "Globale tijdvakken volstaan.", nogSimpeler: "Geen jaartallen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Middeleeuwen eerst", tekst: "Chronologie: Middeleeuwen (500-1500) → Renaissance → Verlichting → Romantiek..." }],
          woorden: [{ woord: "tijdvolgorde", uitleg: "MRVRR MVPE" }],
          theorie: "9 stromingen op tijdlijn. Middeleeuwen = vroegste.",
          voorbeelden: [{ type: "voorbeeld", tekst: "M(eeuwen) → R(enaissance) → V(erlichting) → R(omantiek)..." }],
          basiskennis: [{ onderwerp: "geheugenster", uitleg: "M-R-V-R-R-M-V-P-E" }],
          niveaus: { basis: "Middeleeuwen.", simpeler: "Vroegste tijdvak.", nogSimpeler: "Middeleeuwen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Karel ende Elegast = Middeleeuwen", tekst: "Anoniem ridderverhaal uit ~1300 → Middeleeuwen." }],
          woorden: [{ woord: "ridderepiek", uitleg: "middeleeuws genre" }],
          theorie: "Ridder-verhalen + anoniem + religieus = middeleeuws kenmerk.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Karel ende Elegast, Beatrijs, Reinaert" }],
          basiskennis: [{ onderwerp: "Karel de Grote", uitleg: "ridderkoning, geliefd middeleeuws onderwerp" }],
          niveaus: { basis: "Karel ende Elegast.", simpeler: "Middeleeuws ridderverhaal.", nogSimpeler: "Middeleeuws." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Anoniem + religieus + verzen", tekst: "Drie kerntekenen Middeleeuwen: geen naam-auteur, religie-thema, in verzen voor mondelinge overlevering." }],
          woorden: [{ woord: "kenmerken", uitleg: "wat maakt M-eeuws herkenbaar" }],
          theorie: "Geen drukpers → mondeling → vers + rijm + herhaling.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Beatrijs (anoniem religieus vers)" }],
          basiskennis: [{ onderwerp: "vergelijk met later", uitleg: "Renaissance = met naam + klassieke vorm" }],
          niveaus: { basis: "Anoniem en religieus.", simpeler: "Geen naam-schrijvers.", nogSimpeler: "Middeleeuws." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Vondel = Gouden Eeuw drama", tekst: "Gysbreght van Aemstel = treurspel van Vondel (~1637)." }],
          woorden: [{ woord: "Vondel", uitleg: "grootste toneelschrijver NL" }],
          theorie: "Renaissance/Gouden Eeuw: drama bloeit. Vondel = top.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Vondel: Gysbreght, Lucifer, Jephta" }],
          basiskennis: [{ onderwerp: "Muiderkring", uitleg: "Vondel, Hooft, Bredero" }],
          niveaus: { basis: "Vondel.", simpeler: "Vondel = Gouden Eeuw.", nogSimpeler: "Vondel." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "briefroman", uitleg: "verhaal in vorm van brieven" }],
          theorie: "Verlichting = rede + opvoeding + burgerlijke moraal.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Sara Burgerhart (Wolff & Deken, 1782)" }],
          basiskennis: [{ onderwerp: "verstand boven gevoel", uitleg: "kenmerk Verlichting" }],
          niveaus: { basis: "Sara Burgerhart.", simpeler: "Verlichting-roman.", nogSimpeler: "Sara Burgerhart." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Max Havelaar = koloniale aanklacht", tekst: "Multatuli (1860): kritiek op NL-Indië bestuur." }],
          woorden: [{ woord: "Multatuli", uitleg: "= Eduard Douwes Dekker" }],
          theorie: "Romantiek: aanklacht-literatuur, sociale wantoestanden.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Max Havelaar = aanklacht koloniaal Indië" }],
          basiskennis: [{ onderwerp: "fictie + non-fictie", uitleg: "mengvorm" }],
          niveaus: { basis: "Koloniaal onrecht.", simpeler: "Indië-kritiek.", nogSimpeler: "Aanklacht koloniaal." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Determinisme = product van erfelijkheid + milieu", tekst: "Naturalisme: mens heeft geen vrije wil, alles bepaald door afkomst + omgeving." }],
          woorden: [{ woord: "determinisme", uitleg: "alles voorbepaald" }],
          theorie: "Naturalisme = Zola: schrijver als 'wetenschapper' van samenleving.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Eline Vere = product van gevoelig karakter + Haagse milieu" }],
          basiskennis: [{ onderwerp: "pessimistisch", uitleg: "geen happy end, ondergang" }],
          niveaus: { basis: "Determinisme.", simpeler: "Geen vrije wil.", nogSimpeler: "Bepaald door afkomst." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "Tachtigers", uitleg: "groep dichters rond De Nieuwe Gids" }],
          theorie: "Gorter = Tachtiger. Vorm + inhoud zijn één.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Mei (1889) — lyrisch lentegedicht" }],
          basiskennis: [{ onderwerp: "groep", uitleg: "Kloos, Perk, Gorter, Verwey, Van Eeden" }],
          niveaus: { basis: "Gorter.", simpeler: "Tachtiger.", nogSimpeler: "Gorter." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Modernistische kenmerken", tekst: "Vorm-experiment + fragmentatie + vervreemding = moderne stad-twijfel-poëzie." }],
          woorden: [{ woord: "vervreemding", uitleg: "moderne wereld voelt onbekend" }],
          theorie: "Modernisme reageert op WO1: betekenis-twijfel.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Nijhoff Awater, Vestdijk romans" }],
          basiskennis: [{ onderwerp: "stream of consciousness", uitleg: "innerlijke beleving" }],
          niveaus: { basis: "Vorm-experiment + vervreemding.", simpeler: "Twijfel + experiment.", nogSimpeler: "Modern." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Lucebert = Keizer Vijftigers", tekst: "Bijnaam: 'Keizer der Vijftigers'. Beroemd om experimentele poëzie." }],
          woorden: [{ woord: "Vijftigers", uitleg: "poëzie-stroming ~1945-1965" }],
          theorie: "Vijftigers: vrije vorm + associatief. Lucebert is leider.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Alles van waarde is weerloos'" }],
          basiskennis: [{ onderwerp: "Cobra", uitleg: "verbonden met kunst-beweging" }],
          niveaus: { basis: "Lucebert.", simpeler: "Keizer Vijftigers.", nogSimpeler: "Lucebert." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "De aanslag = Mulisch", tekst: "Harry Mulisch, 1982 — over oorlog en schuld. Postmodernisme." }],
          woorden: [{ woord: "Mulisch", uitleg: "een van Grote Drie (Hermans/Mulisch/Reve)" }],
          theorie: "Postmodernisme. Dood-thema, oorlog-nawerking.",
          voorbeelden: [{ type: "voorbeeld", tekst: "De aanslag, De ontdekking van de hemel" }],
          basiskennis: [{ onderwerp: "Grote Drie", uitleg: "Hermans + Mulisch + Reve" }],
          niveaus: { basis: "De aanslag.", simpeler: "Mulisch.", nogSimpeler: "De aanslag." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Postmodern kenmerk", tekst: "Ironie + intertekstualiteit (verwijzingen naar andere werken) = postmodern." }],
          woorden: [{ woord: "intertekstualiteit", uitleg: "verwijzingen naar andere boeken" }],
          theorie: "Postmodern: spel met genres + ironie + zelfreflectie.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Boek dat naar ander boek verwijst" }],
          basiskennis: [{ onderwerp: "vs religieus", uitleg: "religieus = Middeleeuws, niet postmodern" }],
          niveaus: { basis: "Ironie + intertekstualiteit.", simpeler: "Knipoog naar andere werken.", nogSimpeler: "Postmodern." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Grunberg = eigentijds", tekst: "Arnon Grunberg schrijft nu — eigentijdse literatuur." }],
          woorden: [{ woord: "Grunberg", uitleg: "moderne NL schrijver" }],
          theorie: "Eigentijds = ~2000-nu, na postmodernisme.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Tirza (2006), essays, romans" }],
          basiskennis: [{ onderwerp: "maatschappelijke roman", uitleg: "reflecteert op actuele thema's" }],
          niveaus: { basis: "Grunberg.", simpeler: "Modern.", nogSimpeler: "Grunberg." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Auctorieel = alwetend", tekst: "Verteller weet meer dan personage (vrouw pakt koffers, hij weet 't niet) = alwetende verteller." }],
          woorden: [{ woord: "auctorieel", uitleg: "alwetende verteller" }],
          theorie: "Auctorieel kent gedachten van alle personages + toekomst.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Wat hij niet wist...' = auctorieel signaal" }],
          basiskennis: [{ onderwerp: "vs personaal", uitleg: "personaal blijft bij één hoofd" }],
          niveaus: { basis: "Auctorieel.", simpeler: "Alwetend.", nogSimpeler: "Auctorieel." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Metafoor = zonder 'als'", tekst: "'Hart is een gevangenis' — gelijkstelling zonder 'als' → metafoor." }],
          woorden: [{ woord: "metafoor", uitleg: "directe gelijkstelling" }],
          theorie: "Vergelijking gebruikt 'als/zoals'. Metafoor stelt direct gelijk.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Zijn hart is een steen (metafoor)" }],
          basiskennis: [{ onderwerp: "vs vergelijking", uitleg: "'als steen' = vergelijking, 'is steen' = metafoor" }],
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Personificatie", tekst: "Wind 'fluistert' — wind krijgt menselijke eigenschap → personificatie." }],
          woorden: [{ woord: "personificatie", uitleg: "levenloos ding krijgt mens-eigenschap" }],
          theorie: "Personificatie bezielt levenloze dingen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Wind huilde, zee fluisterde, klok mokte" }],
          basiskennis: [{ onderwerp: "test", uitleg: "kan een mens dit doen?" }],
          niveaus: { basis: "Personificatie.", simpeler: "Wind 'fluistert' = mens-actie.", nogSimpeler: "Personificatie." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Eline Vere = Naturalisme", tekst: "Couperus 1889 — gedetailleerd portret + determinisme = Naturalisme." }],
          woorden: [{ woord: "Naturalisme", uitleg: "subdeel realisme, determinisme" }],
          theorie: "Eline gaat ten onder aan haar gevoeligheid = determinisme.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Eline Vere, De stille kracht" }],
          basiskennis: [{ onderwerp: "Couperus", uitleg: "topwerk Naturalisme NL" }],
          niveaus: { basis: "Realisme/Naturalisme.", simpeler: "1889 = Naturalisme.", nogSimpeler: "Naturalisme." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Lucebert = Vijftiger", tekst: "Vijftigers ~1945-1965: Lucebert is de leider." }],
          woorden: [{ woord: "Vijftigers groep", uitleg: "Lucebert, Kouwenaar, Andreus..." }],
          theorie: "Vijftigers reageren radicaal op vooroorlogse poëzie.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Lucebert, Kouwenaar, Andreus, Vinkenoog" }],
          basiskennis: [{ onderwerp: "Vondel ≠ vijftiger", uitleg: "Vondel = 1600, Vijftigers = 1950" }],
          niveaus: { basis: "Lucebert.", simpeler: "Vijftiger.", nogSimpeler: "Lucebert." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Personaal = één hoofd", tekst: "Verteller kruipt in 1 personage (hij dacht...). Geen alwetendheid." }],
          woorden: [{ woord: "personaal", uitleg: "= beperkt-derde persoon" }],
          theorie: "Personaal: hij + alleen zijn gedachten. Auctorieel: alwetend.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Hij dacht: ...' = personaal" }],
          basiskennis: [{ onderwerp: "geen 'ik'", uitleg: "wel derde persoon, beperkt" }],
          niveaus: { basis: "Personaal.", simpeler: "Eén personage-hoofd.", nogSimpeler: "Personaal." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Litotes = onderdrijving", tekst: "'Niet onaardig' = aardig (zonder enthousiasme) = litotes." }],
          woorden: [{ woord: "litotes", uitleg: "ontkenning van tegendeel" }],
          theorie: "Litotes onderdrukt; hyperbool overdrijft.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Niet onaardig = wel aardig; niet onmogelijk = mogelijk" }],
          basiskennis: [{ onderwerp: "stijlfiguur", uitleg: "12 op havo-lijst" }],
          niveaus: { basis: "Litotes.", simpeler: "Onderdrijving.", nogSimpeler: "Litotes." },
        },
      },
      { q: "*Max Havelaar* (Multatuli) protesteerde tegen?", options: ["Koloniale uitbuiting in Indië","Koningshuis","Industrialisatie","Religie"], answer: 0, wrongHints: [null, "Niet onderwerp.", "Niet kernthema boek.", "Niet kernthema."] },
      { q: "Tot welke stroming hoort Joost van den Vondel?", options: ["Gouden Eeuw","Romantiek","Modernisme","Postmodernisme"], answer: 0, wrongHints: [null, "19e eeuw, te laat.", "20e eeuw, te laat.", "Heel recent."] },
      { q: "De **Tachtigers** stonden bekend om?", options: ["L'art pour l'art / individualisme","Realisme","Klassieke regels","Religieuze poëzie"], answer: 0, wrongHints: [null, "Eerdere stroming.", "Niet — juist breken met regels.", "Niet kernthema."] },
      ...
      { q: "**Metafoor**: 'Hij is een leeuw' — wat doe je?", options: ["Vergelijking ZONDER 'als/zoals'","Met 'als/zoals'","Tegenstelling","Niets"], answer: 0, wrongHints: [null,"Dan is het vergelijking.","Niet.","Wel iets."] },
      { q: "**Personificatie** kent men aan ___?", options: ["Niet-levende ding krijgt menselijke eigenschap","Mens wordt object","Vergelijking","Niet bestaand"], answer: 0, wrongHints: [null,"Tegenovergesteld.","Vergelijking.","Wel bestaat."] },
      { q: "Wie schreef **'Het Achterhuis'** (Anne Frank-dagboek)?", options: ["Anne Frank","Multatuli","Vondel","Annie M.G. Schmidt"], answer: 0, wrongHints: [null,"19e eeuw.","17e eeuw.","Kinder-auteur 20e eeuw."] },
      { q: "Een **roman** is meestal hoeveel pagina's?", options: ["100-500","1-10","1000+","Geen limiet"], answer: 0, wrongHints: [null,"Te kort — verhaal/novelle.","Heel zeldzaam.","Wel typische range."] },
      { q: "Welke is een **literaire stroming** uit de 19e eeuw?", options: ["Romantiek","Modernisme","Postmodernisme","Realisme én Romantiek (beide 19e)"], answer: 3, wrongHints: ["Tegenstelling — realisme ook 19e eeuw.", "20e eeuw.", "Eind 20e/begin 21e.", null] },
...
const literatuurgeschiedenis = {
  ...
  prerequisites: [
    { id: "bekende-boeken-literatuur-po", title: "Bekende boeken + auteurs", niveau: "po-1F" },
    { id: "tijdvakken-geschiedenis", title: "Tijdvakken geschiedenis", niveau: "vmbo" },
  ],
  intro:
