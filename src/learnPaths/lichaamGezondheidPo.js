...
const steps = [
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "Wat doet je **hart**?", options: ["Pompt bloed door je lichaam","Maakt voedsel klein","Filtert lucht","Denkt"], answer: 0, wrongHints: [null,"Klopt.","Dat is maag.","Longen.","Hersenen."] },
      { q: "Wat doen je **longen**?", options: ["Lucht inademen + zuurstof opnemen","Bloed pompen","Voedsel verteren","Denken"], answer: 0, wrongHints: [null,"Klopt.","Hart.","Maag.","Hersenen."] },
      { q: "Welk **lichaamsdeel** is voor zien?", options: ["Ogen","Oren","Neus","Mond"], answer: 0, wrongHints: [null,"Klopt.","Horen.","Ruiken.","Proeven."] },
      { q: "Hoeveel **botten** heeft een volwassen mens ongeveer?", options: ["206","100","500","1.000"], answer: 0, wrongHints: [null,"Klopt.","Te weinig.","Te veel.","Veel te veel."] },
      { q: "Welke voeding is goed voor **botten**?", options: ["Melk + zuivel (calcium)","Snoep","Cola","Chips"], answer: 0, wrongHints: [null,"Klopt — calcium.","Niet voor botten.","Niet.","Niet."] },
      { q: "Hoeveel **uur slaap** heeft een 10-jarige nodig?", options: ["9-11 uur","4-5 uur","12-14 uur","6 uur"], answer: 0, wrongHints: [null,"Klopt — kinderen meer.","Te weinig.","Te veel (baby).","Te weinig."] },
      { q: "Wat heet **diabetes**?", options: ["Suikerziekte","Hartziekte","Botbreuk","Verkoudheid"], answer: 0, wrongHints: [null,"Klopt — type 1 + 2.","Niet.","Niet.","Niet."] },
      { q: "Welke 5 **zintuigen** zijn er?", options: ["Zien/horen/ruiken/proeven/voelen","2","3","10"], answer: 0, wrongHints: [null,"Klopt.","Te weinig.","Te weinig.","Te veel."] },
      { q: "Welke spier in je lichaam **werkt continu**?", options: ["Hartspier","Beenspier","Armspier","Niemand continu"], answer: 0, wrongHints: [null,"Klopt — nooit pauze.","Heeft pauze.","Heeft pauze.","Wel hartspier."] },
      { q: "Wat is **transpireren** voor?", options: ["Lichaam koelen","Warm worden","Niet relevant","Spieren bouwen"], answer: 0, wrongHints: [null,"Klopt — zweet verdampt = koelt.","Tegenovergesteld.","Wel functie.","Niet primair."] },
      { q: "Wat doe je bij een **wond** met bloeding?", options: ["Schoonspoelen + verband","Negeren","Schreeuwen","Likken"], answer: 0, wrongHints: [null,"Klopt — EHBO.","Niet.","Niet primair.","Niet."] },
      { q: "Welk **vitamine** krijg je van de zon?", options: ["D","C","A","B"], answer: 0, wrongHints: [null,"Klopt — UV op huid.","Fruit.","Wortels.","Volkoren."] },
      { q: "Wat doen **witte bloedcellen**?", options: ["Afweer tegen ziekte","Zuurstof transporteren","Stollen","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Dat zijn rode.","Plaatjes.","Wel."] },
      { q: "Hoeveel **liter water** moet een 10-jarige drinken per dag?", options: ["~1,5 liter","5 liter","0,5 liter","10 liter"], answer: 0, wrongHints: [null,"Klopt — incl voeding.","Te veel.","Te weinig.","Veel te veel."] },
    ],
  },
];
