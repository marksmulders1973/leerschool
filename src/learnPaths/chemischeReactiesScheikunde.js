    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "Plasma 4e fase", uitleg: "Geavanceerd: plasma = 4e fase, geïoniseerd gas. De toets vraagt meestal alleen 3 hoofdfasen." }],
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "VMBO-examen basis", uitleg: "Onderscheid atoom/molecuul/verbinding moeten kunnen maken." }],
