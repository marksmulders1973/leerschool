...
const steps = [
...

  {
    ...
    checks: [
      ...
      { q: "Welke 3 **lidwoorden** zijn er in het Nederlands?", options: ["de, het, een","de, een, hij","een, het, jij","de, dit, dat"], answer: 0, wrongHints: [null,"Klopt.","Hij is voornaamwoord.","Jij is voornaamwoord.","Dit/dat zijn aanwijzend vnw."] },
      { q: "*'**De** hond rent.'* — Welk woordsoort is 'de'?", options: ["Lidwoord","Zelfst. naamwoord","Werkwoord","Voornaamwoord"], answer: 0, wrongHints: [null,"Klopt.","Hond is zn.","Rent is ww.","Niet."] },
      { q: "*'Op de **tafel**.'* — Welk woordsoort is 'tafel'?", options: ["Zelfstandig naamwoord","Werkwoord","Bijvoeglijk","Voornaamwoord"], answer: 0, wrongHints: [null,"Klopt — een ding.","Geen actie.","Geen eigenschap.","Niet."] },
      { q: "Welk **voorzetsel** in: 'Ik zit OP de stoel'?", options: ["op","ik","zit","de"], answer: 0, wrongHints: [null,"Klopt — plaats-aanduiding.","Voornaamwoord.","Werkwoord.","Lidwoord."] },
      { q: "*'Hij rent **snel**.'* Wat is 'snel'?", options: ["Bijwoord","Bijvoeglijk","Werkwoord","Zelfst. nw"], answer: 0, wrongHints: [null,"Klopt — hoe rent hij.","Bijvoeglijk staat bij zn.","Geen actie.","Geen ding."] },
      { q: "Wat is een **persoonlijk voornaamwoord**?", options: ["Vervangt een persoon (ik/jij/hij/zij)","Lidwoord","Voorzetsel","Bijwoord"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "*'Wij gaan **morgen** zwemmen.'* Wat is 'morgen'?", options: ["Bijwoord van tijd","Zelfst. nw","Voornaamwoord","Lidwoord"], answer: 0, wrongHints: [null,"Klopt — wanneer.","Geen ding.","Geen vervanging.","Niet."] },
      { q: "**Hoeveel** woordsoorten kent het Nederlands ongeveer?", options: ["~8 hoofdsoorten","2","5","15"], answer: 0, wrongHints: [null,"Klopt — zn/ww/bn/lw/vnw/vz/vw/bw.","Te weinig.","Te weinig.","Te veel."] },
      { q: "**Telwoord** in: 'Ik heb 5 boeken'?", options: ["5 (vijf)","ik","heb","boeken"], answer: 0, wrongHints: [null,"Klopt — getal.","Voornaamwoord.","Werkwoord.","Zelfst. nw."] },
      { q: "Welk **voegwoord** verbindt?", options: ["en/of/maar","de/het/een","ik/jij/hij","op/in/onder"], answer: 0, wrongHints: [null,"Klopt.","Lidwoorden.","Voornaamwoorden.","Voorzetsels."] },
      { q: "*'**Deze** boek is leuk.'* Wat is 'deze'?", options: ["Aanwijzend voornaamwoord","Bezittelijk vnw","Lidwoord","Bijwoord"], answer: 0, wrongHints: [null,"Klopt — wijst aan.","Niet bezit.","Niet de/het/een.","Niet hoe."] },
      { q: "**Tussenwerpsel** in: 'Au, dat doet pijn!'?", options: ["Au","dat","doet","pijn"], answer: 0, wrongHints: [null,"Klopt — uitroep.","Voornaamwoord.","Werkwoord.","Zelfst. nw."] },
      { q: "Wat is een **werkwoord**?", options: ["Woord dat een actie/toestand uitdrukt","Naam","Eigenschap","Vragen"], answer: 0, wrongHints: [null,"Klopt — doen-woord.","Zelfst. nw.","Bijv. nw.","Niet woordsoort."] },
      { q: "*'In de **grote** stad.'* Wat is 'grote'?", options: ["Bijvoeglijk naamwoord","Werkwoord","Lidwoord","Bijwoord"], answer: 0, wrongHints: [null,"Klopt — beschrijft stad.","Geen actie.","Niet.","Niet bij ww."] },
      { q: "Wat is een **zelfstandig naamwoord**?", options: ["Naam van een ding/persoon/dier","Eigenschap","Actie","Vragen"], answer: 0, wrongHints: [null,"Klopt — bv. tafel, kat, jongen.","Bijv. nw.","Werkwoord.","Niet."] },
    ],
  },
];
