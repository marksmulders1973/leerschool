...
const steps = [
  ...
  {
    title: "Toets-eindopdracht — woordsoorten mix",
    ...
    checks: [
      ...
      { q: "Wat is een **zelfstandig naamwoord**?", options: ["Naam van een ding/persoon/dier","Eigenschap","Actie","Vragen"], answer: 0, wrongHints: [null, "Bijv. nw.", "Werkwoord.", "Niet."] },
    ],
  },
];
