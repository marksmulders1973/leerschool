...
const steps = [
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "20 ÷ 4 = ?", options: ["5","4","6","20"], answer: 0, wrongHints: [null,"Klopt.","Deler.","Niet.","Niet."] },
      { q: "36 ÷ 9 = ?", options: ["4","5","6","9"], answer: 0, wrongHints: [null,"Klopt — 9×4=36.","Niet.","Niet — 9×6=54.","Deler."] },
      { q: "72 ÷ 8 = ?", options: ["9","8","7","6"], answer: 0, wrongHints: [null,"Klopt — 8×9=72.","Niet.","Niet — 8×7=56.","Niet."] },
      { q: "100 ÷ 10 = ?", options: ["10","100","1","11"], answer: 0, wrongHints: [null,"Klopt.","Geen verandering.","Niet.","Niet."] },
      { q: "**56 ÷ 7** = ?", options: ["8","7","6","9"], answer: 0, wrongHints: [null,"Klopt — 7×8.","Deler.","Niet.","Te hoog."] },
      { q: "**Rest** bij 23 ÷ 5 = ?", options: ["3","2","4","0"], answer: 0, wrongHints: [null,"Klopt — 5×4=20, 23−20=3.","Niet.","Niet.","Niet — wel rest."] },
      { q: "**Rest** bij 30 ÷ 4 = ?", options: ["2","1","4","0"], answer: 0, wrongHints: [null,"Klopt — 4×7=28, 30−28=2.","Niet.","Te veel.","Niet — wel rest."] },
      { q: "Welke is **deeltafel** van 10: 10/10 = ?", options: ["1","10","100","0"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "**24 ÷ 6** = ?", options: ["4","6","8","3"], answer: 0, wrongHints: [null,"Klopt — 6×4.","Deler.","Niet.","Niet."] },
      { q: "Welk getal **deelt** 48 in 8 gelijk?", options: ["6","8","4","12"], answer: 0, wrongHints: [null,"Klopt — 48/8=6 per stuk.","Aantal groepen.","Niet.","Niet."] },
      { q: "100 ÷ 25 = ?", options: ["4","25","5","10"], answer: 0, wrongHints: [null,"Klopt — kwarten in heel.","Deler.","Niet.","Niet."] },
      { q: "Wat is **omgekeerde** van delen?", options: ["Vermenigvuldigen","Aftrekken","Optellen","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — tafel-truc.","Niet.","Niet.","Wel."] },
      { q: "**Halveren** is delen door?", options: ["2","½","4","10"], answer: 0, wrongHints: [null,"Klopt — helft.","Vermenigvuldigen met.","Kwarten.","Niet."] },
      { q: "**Eerlijk verdelen** 18 koeken over 6 kinderen?", options: ["3 per kind","12","6","18"], answer: 0, wrongHints: [null,"Klopt — 18÷6.","Niet — som onderdelen.","Aantal kinderen.","Hele."] },
    ],
  },
];
