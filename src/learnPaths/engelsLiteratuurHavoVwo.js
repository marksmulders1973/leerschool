    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Austen.", simpeler: "Pride+Prejudice = Austen.", nogSimpeler: "Austen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Old English.", simpeler: "Heel oud (~700).", nogSimpeler: "OE" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hamlet.", simpeler: "Hamlet's monoloog.", nogSimpeler: "Hamlet" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Orwell.", simpeler: "Orwell 1984.", nogSimpeler: "Orwell" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Fitzgerald.", simpeler: "Fitzgerald = Gatsby.", nogSimpeler: "Fitzgerald" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Melville.", simpeler: "Melville = Moby Dick.", nogSimpeler: "Melville" },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Groter idee via object.", simpeler: "Iets staat voor iets anders.", nogSimpeler: "Symbool" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hints geven.", simpeler: "Vooruit-signaal.", nogSimpeler: "Voorspel" },
        },
      },
      {
