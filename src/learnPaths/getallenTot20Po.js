    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8 komt na 7.", simpeler: "Tel op: 7 → 8.", nogSimpeler: "8" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8 < 12.", simpeler: "8 komt eerst, dus 8 is kleiner.", nogSimpeler: "8" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "15 tussen 14 en 16.", simpeler: "14 → 15 → 16.", nogSimpeler: "15" },
        },
      },
      {
        q: "Wat is **20** = 10 + ?",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5 + 3 = 8.", simpeler: "Tel vanaf 5: 6, 7, 8.", nogSimpeler: "8" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4 + 4 = 8.", simpeler: "Dubbele 4 = 8.", nogSimpeler: "8" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7.", simpeler: "Plus 0 = niets erbij.", nogSimpeler: "7" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6 - 2 = 4.", simpeler: "Tel terug vanaf 6: 5, 4.", nogSimpeler: "4" },
        },
      },
      {
        q: "**10 - 7** = ?",
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verschil 8-3 = 5.", simpeler: "Verschil = groot - klein = 5.", nogSimpeler: "5" },
        },
      },
      {
        q: "**9 - 9** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9 - 9 = 0.", simpeler: "Alles weg = 0.", nogSimpeler: "0" },
        },
      },
      {
        q: "Vul in: **7 - ?** = 3",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8+5 = 13.", simpeler: "8+2=10, 10+3=13.", nogSimpeler: "13" },
        },
      },
      {
        q: "**15 - 7** = ?",
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "14+5 = 19.", simpeler: "14+5 = 10+4+5 = 19.", nogSimpeler: "19" },
        },
      },
      {
