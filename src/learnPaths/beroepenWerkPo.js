    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip economie: ZZP'er heeft VRIJHEID (eigen tijd kiezen, eigen klanten) maar ook RISICO (geen werk = geen loon, geen vakantiegeld). Daarom rekenen ZZP'ers hoger uurtarief.",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip afkortingen: AOW = Algemene Ouderdoms Wet. Andere belangrijke: WW = Werkloosheidswet. WIA = arbeidsongeschiktheid. Bijstand = laagste uitkering.",
          voorbeelden: [
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip sectoren: PRIMAIR = direct uit natuur. SECUNDAIR = iets maken. TERTIAIR = iemand helpen (dienst). QUARTAIR = publieke sector (zorg/onderwijs/overheid).",
          voorbeelden: [
      ...
      { q: "Wat is **bruto**?", options: ["Salaris voor belasting", "Salaris na belasting", "Cadeau", "Niet bestaand"], answer: 0, wrongHints: [null, "Netto.", "Niet.", "Wel."] },
      {
        ...
        uitlegPad: {
          stappen: [
            ...
            { titel: "Toets-feit: Doorstroomtoets-link", tekst: "**De Doorstroomtoets** (groep 8) helpt bepalen welk middelbare-school-niveau bij je past — VMBO, HAVO of VWO. Dit beïnvloedt welk vervolgonderwijs makkelijk bereikbaar is. Maar het is **geen einde van keuzes** — stapelen kan altijd later.\n\nNederland heeft ~3 miljoen studenten in MBO/HBO/WO samen (2024)." },
          ],
          woorden: [
...
const beroepenWerkPo = {
  id: "beroepen-werk-po",
  title: "Beroepen + werk (Doorstroomtoets groep 6-8)",
  emoji: "👷",
  level: "groep6-8",
  ...
  intro:
    "Beroepen + werk voor Doorstroomtoets groep 6-8 — wat is beroep (werknemer/ZZP/vrijwilliger) + 4 sectoren (primair/secundair/tertiair/quartair) + MBO/HBO/WO + voorbeelden beroepen + salaris (bruto/netto/minimum/CAO) + werkrechten + werken vanaf 13. Sluit op financiele-vorming. ~15 min.",
  triggerKeywords: [
