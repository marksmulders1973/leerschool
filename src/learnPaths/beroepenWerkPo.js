...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wat is een **CV** (curriculum vitae)?", options: ["Overzicht van opleiding/werk-ervaring","Auto","Reclame","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — voor sollicitatie.","Niet.","Niet.","Wel."] },
      { q: "Wat is **MBO**?", options: ["Middelbaar Beroepsonderwijs","Hoger Onderwijs","Universiteit","Basisschool"], answer: 0, wrongHints: [null,"Klopt — na VMBO.","Dat is HBO/WO.","Hoger.","Niet."] },
      { q: "Wat is **HBO**?", options: ["Hoger Beroepsonderwijs","Universiteit","MBO","VMBO"], answer: 0, wrongHints: [null,"Klopt.","Dat is WO.","Lager.","Lager."] },
      { q: "Welk **beroep** werkt in een ziekenhuis?", options: ["Verpleegkundige","Bakker","Politieagent","Boer"], answer: 0, wrongHints: [null,"Klopt.","Bakkerij.","Politiebureau.","Boerderij."] },
      { q: "Welk **beroep** werkt met dieren?", options: ["Dierenarts","Bakker","Architect","Boekhouder"], answer: 0, wrongHints: [null,"Klopt.","Brood.","Gebouwen.","Cijfers."] },
      { q: "Wat doet een **architect**?", options: ["Gebouwen ontwerpen","Bouwen alleen","Schoonmaken","Lesgeven"], answer: 0, wrongHints: [null,"Klopt.","Aannemer.","Schoonmaker.","Leraar."] },
      { q: "Wat is **vakantiegeld**?", options: ["8% extra salaris in mei","Niet bestaand","Buitenland-geld","Bonus"], answer: 0, wrongHints: [null,"Klopt — wettelijk in NL.","Wel.","Niet.","Soort bonus maar wel wettelijk."] },
      { q: "Wat is een **vrijwilliger**?", options: ["Iemand die onbetaald werkt voor goede doel","Politicus","Niet werkend","Manager"], answer: 0, wrongHints: [null,"Klopt.","Niet primair.","Wel werkend.","Niet specifiek."] },
      { q: "Welk **beroep** lost branden op?", options: ["Brandweer","Politie","Ambulance","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Andere taak.","Andere taak.","Wel."] },
      { q: "Welk **beroep** plant en oogst?", options: ["Boer","Bakker","Slager","Visser"], answer: 0, wrongHints: [null,"Klopt — landbouw.","Verwerkt graan.","Verwerkt vlees.","Vis."] },
      { q: "Wat is een **werkgever**?", options: ["Persoon/bedrijf dat iemand laat werken","Werknemer","Klant","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Andere kant.","Niet.","Wel."] },
      { q: "Wat is een **werknemer**?", options: ["Persoon die werkt voor werkgever","Werkgever","Klant","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Andere kant.","Niet.","Wel."] },
      { q: "Wat is **loon**?", options: ["Salaris (betaling voor werk)","Bonus","Vakantie","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Extra.","Niet betaling.","Wel."] },
      { q: "Welk beroep helpt mensen leren?", options: ["Leraar/docent","Politicus","Bakker","Boer"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "Wat is een **stage**?", options: ["Werkervaring opdoen tijdens opleiding","Vakantie","Loonstop","Reclame"], answer: 0, wrongHints: [null,"Klopt — vaak onbetaald.","Niet werk.","Niet.","Niet."] },
    ],
  },
];
