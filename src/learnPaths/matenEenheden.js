    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "cm. A.", simpeler: "Een vinger meet je in cm (~8 cm). Km voor steden, kg voor gewicht.", nogSimpeler: "cm" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "g. A.", simpeler: "Appel ~200 g. Gewicht-eenheid g past het best. (mm=lengte, mL=inhoud, ton=te groot).", nogSimpeler: "g" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1000. A.", simpeler: "Kilo = 1000. Dus 1 km = 1000 m. (1 m = 100 cm — andere eenheid).", nogSimpeler: "1000" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "300. A.", simpeler: "1 m = 100 cm. 3 m = 3 × 100 = 300 cm.", nogSimpeler: "300" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2500. A.", simpeler: "1 km = 1000 m. 2,5 × 1000 = 2500 m.", nogSimpeler: "2500" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "180. A.", simpeler: "1 cm = 10 mm. 18 cm × 10 = 180 mm.", nogSimpeler: "180" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5000. A.", simpeler: "1 kg = 1000 g. 5 × 1000 = 5000 g.", nogSimpeler: "5000" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3000 kg. A.", simpeler: "1 ton = 1000 kg. 3 ton = 3000 kg.", nogSimpeler: "3000" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0,5 g. A.", simpeler: "1000 mg = 1 g. 500 mg = halve g = 0,5 g.", nogSimpeler: "0,5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1500 mL. A.", simpeler: "1 L = 1000 mL. 1,5 × 1000 = 1500 mL.", nogSimpeler: "1500" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "200 mL. A.", simpeler: "1 dL = 100 mL. 2 dL = 2 × 100 = 200 mL.", nogSimpeler: "200" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0,5 cL. A.", simpeler: "1 cL = 10 mL. 5 mL = halve cL = 0,5 cL.", nogSimpeler: "0,5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "150 min. A.", simpeler: "2,5 uur = 2 uur + halfuur = 120 min + 30 min = 150 min.", nogSimpeler: "150" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "21:15. A.", simpeler: "19:45 + 1u30m = 21:15. (45+30=75 → 1u15m → eindtijd 21:15).", nogSimpeler: "21:15" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1 uur 45 min. A.", simpeler: "16:45→17:00=15m, →18:00=1u, →18:30=30m. Som = 1u 45m.", nogSimpeler: "1u45m" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1,75 kg. A.", simpeler: "1750 g = ÷ 1000 = 1,75 kg (komma 3 plekken naar links).", nogSimpeler: "1,75" },
        },
      },
      {
        q: "**0,8 L** in **mL**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "800 mL. A.", simpeler: "0,8 L × 1000 = 800 mL (komma 3 plekken naar rechts).", nogSimpeler: "800" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4,5 m. A.", simpeler: "4500 mm ÷ 1000 = 4,5 m (komma 3 plekken naar links).", nogSimpeler: "4,5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3 kg. A.", simpeler: "2 × 750 g = 1500 g = 1,5 kg. + 1,5 kg = 3 kg totaal.", nogSimpeler: "3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "10 bekers. A.", simpeler: "2 L = 2000 mL. ÷ 200 = 10 bekers van 200 mL.", nogSimpeler: "10" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "66,7 m/min. A.", simpeler: "3 km = 3000 m. ÷ 45 min = 66,7 m per minuut.", nogSimpeler: "66,7" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "375.000 L. A.", simpeler: "Zwembad-volume = 25×10×1,5 = 375 m³. × 1000 L/m³ = 375.000 L.", nogSimpeler: "375.000" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "42.195 m. A.", simpeler: "42 km = 42.000 m + 195 m = 42.195 m.", nogSimpeler: "42.195" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "810 g. A.", simpeler: "3 appels × 150 = 450 g. 2 peren × 180 = 360 g. Totaal = 810 g.", nogSimpeler: "810" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "€0,0012. A.", simpeler: "1,5 L = 1500 mL. €1,80 ÷ 1500 = €0,0012 per mL.", nogSimpeler: "0,0012" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "11:05. A.", simpeler: "08:47 + 2u18m = 11:05 (47+18=65 = 1u 5m, dus extra uur).", nogSimpeler: "11:05" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Voordeur. A.", simpeler: "2,5 m = ongeveer hoogte van voordeur. Potlood is 15 cm.", nogSimpeler: "Deur" },
        },
      },
      ...
      { q: "1 kg = hoeveel g?", options: ["1000","100","10","10.000"], answer: 0, wrongHints: [null, "Te weinig — 100 g = 1 ons.", "Veel te weinig — 10 g is een paperclip.", "Te veel — dat zou 10 kg zijn."] },
      { q: "1 L = hoeveel mL?", options: ["1000","100","10","10.000"], answer: 0, wrongHints: [null, "Te weinig — 100 mL = 1 dl (klein glaasje).", "Heel weinig — 10 mL is een lepel.", "Te veel — dat is 10 L (een emmer)."] },
      { q: "Zet om: **2,5 m** in cm", options: ["250","25","2500","0,025"], answer: 0, wrongHints: [null, "×10.", "×1000.", "Verkeerde kant."] },
      { q: "Zet om: **500 g** in kg", options: ["0,5","5","50","0,05"], answer: 0, wrongHints: [null, "Te veel — 5 kg is een kleine peuter.", "Veel te veel.", "Te weinig — 0,05 kg = 50 g."] },
      ...
      { q: "Welke is langste: 1 m, 100 cm, 1.000 mm?", options: ["Allemaal gelijk","1 m","100 cm","1000 mm"], answer: 0, wrongHints: [null, "Reken om: 1 m = 100 cm = 1000 mm — vergelijk dan.", "100 cm = precies 1 meter — kijk goed naar de andere twee.", "1000 mm = 100 cm = 1 m — overweeg de keuze."] },
      ...
      { q: "1 **ton** = hoeveel kg?", options: ["1000","100","10","10.000"], answer: 0, wrongHints: [null, "Te weinig — 100 kg ≈ groot persoon.", "Heel weinig — 10 kg = een baby.", "Te veel — 10.000 kg = 10 ton (grote vrachtwagen)."] },
