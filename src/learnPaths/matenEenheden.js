...
<defs><marker id="arrow" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto"><polygon points="0 0, 8 5, 0 10" fill="${COLORS.good}"/></marker></defs>
  ...
  // STAP 8: Eindopdracht
  {
    ...
    checks: [
      ...
      { q: "1 km = hoeveel m?", options: ["1000","100","10","10.000"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "1 m = hoeveel cm?", options: ["100","10","1000","60"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "1 cm = hoeveel mm?", options: ["10","100","1","1000"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "1 kg = hoeveel g?", options: ["1000","100","10","10.000"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "1 L = hoeveel mL?", options: ["1000","100","10","10.000"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "Zet om: **2,5 m** in cm", options: ["250","25","2500","0,025"], answer: 0, wrongHints: [null,"Klopt — ×100.","×10.","×1000.","Verkeerde kant."] },
      { q: "Zet om: **500 g** in kg", options: ["0,5","5","50","0,05"], answer: 0, wrongHints: [null,"Klopt — helft kilo.","Niet.","Niet.","Niet."] },
      { q: "Zet om: **3.500 m** in km", options: ["3,5","350","35","0,35"], answer: 0, wrongHints: [null,"Klopt — ÷1000.","Niet — komma verkeerd.","Niet.","Niet."] },
      { q: "Welke is meer: **0,5 kg** of **600 g**?", options: ["600 g (600g vs 500g)","0,5 kg","Gelijk","Niet te zeggen"], answer: 0, wrongHints: [null,"Klopt — 0,5 kg = 500 g.","Niet — minder.","Niet — verschil 100g.","Wel — vergelijken."] },
      { q: "Welke is langste: 1 m, 100 cm, 1.000 mm?", options: ["Allemaal gelijk","1 m","100 cm","1000 mm"], answer: 0, wrongHints: [null,"Klopt — zelfde lengte.","Eén van drie.","Eén van drie.","Eén van drie."] },
      { q: "Een fles **1,5 L** = hoeveel mL?", options: ["1500","150","15","15.000"], answer: 0, wrongHints: [null,"Klopt.","Niet — ×1000.","Niet.","Te veel."] },
      { q: "Een sinaasappel weegt **ongeveer**?", options: ["150 g","150 kg","15 g","1,5 kg"], answer: 0, wrongHints: [null,"Klopt.","Veel te zwaar.","Te licht.","Te zwaar."] },
      { q: "Lengte van een **gymzaal** ongeveer?", options: ["20 m","2 m","200 m","2 cm"], answer: 0, wrongHints: [null,"Klopt.","Te klein.","Te groot.","Heel klein."] },
      { q: "1 **ton** = hoeveel kg?", options: ["1000","100","10","10.000"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "1 **dl** = hoeveel mL?", options: ["100","10","1000","1"], answer: 0, wrongHints: [null,"Klopt — deci.","Niet — dat is cl.","Niet — ×10.","Niet."] },
    ],
  },
];
