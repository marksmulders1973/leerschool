    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Rechte lijn = kortste", tekst: "Tussen twee punten is een rechte lijn altijd korter dan elke andere weg." }],
          woorden: [{ woord: "lijnstuk", uitleg: "stuk van een rechte lijn tussen 2 punten" }],
          theorie: "|AB| = lengte van het lijnstuk = afstand tussen A en B.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Recht > krom: A naar B via boog is altijd langer dan AB" }],
          basiskennis: [{ onderwerp: "afstand", uitleg: "= kortste verbinding" }],
          niveaus: {
            basis: "Rechte lijn is altijd de kortste tussen 2 punten.",
            simpeler: "Niet kromgaan, niet via omweg. Recht.",
            nogSimpeler: "Recht is kortst.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "voet", uitleg: "snijpunt van loodlijn met de lijn" }],
          theorie: "Schuin is altijd langer dan loodrecht.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Persoon voor muur: 5 m loodrecht, niet 7 m schuin" }],
          basiskennis: [{ onderwerp: "90°", uitleg: "loodrecht = haakse hoek" }],
          niveaus: {
            basis: "Loodrechte afstand is de afstand van punt tot lijn.",
            simpeler: "Recht erop = kortst. Niet schuin.",
            nogSimpeler: "Haaks staan, dan meten.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Midden + lood", tekst: "Middelloodlijn = door midden van AB én loodrecht op AB." }],
          woorden: [{ woord: "middelloodlijn", uitleg: "midden + lood (90°)" }],
          theorie: "Twee eigenschappen samen: door midden M, én haaks op AB.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Bij AB horizontaal, middelloodlijn = verticale lijn door midden" }],
          basiskennis: [{ onderwerp: "naam", uitleg: "letterlijk: middel + lood" }],
          niveaus: {
            basis: "Door midden van AB én haaks op AB.",
            simpeler: "Door midden + 90° op AB.",
            nogSimpeler: "Naam zegt: middel én lood.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "eigenschap", uitleg: "altijd gelijke afstanden" }],
          theorie: "Middelloodlijn van AB ⇔ alle punten op gelijke afstand van A en B.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Postbode tussen 2 dorpen — punt op middelloodlijn ligt even ver van beide" }],
          basiskennis: [{ onderwerp: "symmetrie", uitleg: "middelloodlijn = spiegel-as" }],
          niveaus: {
            basis: "P op middelloodlijn → even ver van A en B.",
            simpeler: "|PA| = |PB|.",
            nogSimpeler: "Even ver van allebei.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Snijpunt 3 middelloodlijnen = M (omgeschreven cirkel).",
            simpeler: "Middelloodlijnen kruisen in M.",
            nogSimpeler: "M = waar de 3 middelloodlijnen samenkomen.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Hoek/2", tekst: "Bissectrice deelt 80° in twee hoeken van elk 40°." }],
          woorden: [{ woord: "bissectrice", uitleg: "Latijn: 'in tweeën snijden'" }],
          theorie: "Bissectrice = hoekdeler. 2 gelijke hoeken.",
          voorbeelden: [{ type: "voorbeeld", tekst: "60° → 30° + 30°. 90° → 45° + 45°." }],
          basiskennis: [{ onderwerp: "delen door 2", uitleg: "80 ÷ 2 = 40" }],
          niveaus: {
            basis: "80 ÷ 2 = 40 elk.",
            simpeler: "De helft van 80 is 40.",
            nogSimpeler: "Hoek halveren: 40 + 40 = 80.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "loodrechte afstand", uitleg: "haakse afstand tot zijde" }],
          theorie: "Op bissectrice ⇔ gelijke afstanden tot beide zijden.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Paadje tussen 2 muren: bissectrice geeft het midden" }],
          basiskennis: [{ onderwerp: "spiegelas", uitleg: "bissectrice = symmetrieas van de hoek" }],
          niveaus: {
            basis: "P op bissectrice → afstanden tot beide zijden gelijk.",
            simpeler: "Bissectrice ligt in het midden tussen zijden.",
            nogSimpeler: "Midden tussen 2 zijden = bissectrice.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "3 bissectrices → I", tekst: "Drie bissectrices kruisen in I, het middelpunt van de ingeschreven cirkel." }],
          woorden: [{ woord: "ingeschreven", uitleg: "cirkel binnen driehoek, raakt 3 zijden" }],
          theorie: "I ligt even ver van alle 3 zijden → cirkel past binnen driehoek.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Ingeschreven cirkel = grootste cirkel die past in driehoek" }],
          basiskennis: [{ onderwerp: "verschil met M", uitleg: "M (omgeschreven) = middelloodlijnen, I (ingeschreven) = bissectrices" }],
          niveaus: {
            basis: "3 bissectrices kruisen in I.",
            simpeler: "Ingeschreven → bissectrices (binnen).",
            nogSimpeler: "I = waar bissectrices samenkomen.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Naar midden overkant", tekst: "Vanuit hoek A naar midden van BC (de zijde tegenover A)." }],
          woorden: [{ woord: "overstaande zijde", uitleg: "zijde tegenover de hoek" }],
          theorie: "Zwaartelijn: van hoek naar midden van overkant.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Vanuit C naar midden van AB" }],
          basiskennis: [{ onderwerp: "verschil", uitleg: "≠ bissectrice (hoek delen) ≠ hoogtelijn (loodrecht)" }],
          niveaus: {
            basis: "Van A naar midden van BC.",
            simpeler: "Hoek → midden andere zijde.",
            nogSimpeler: "Recht naar het midden aan de overkant.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "2:1 verhouding", tekst: "Vanaf hoek tot Z = 2 delen. Vanaf Z tot midden overkant = 1 deel." }],
          woorden: [{ woord: "zwaartepunt", uitleg: "balanspunt van driehoek" }],
          theorie: "Z deelt elke zwaartelijn in 2:1 (vanaf hoek geteld).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Driehoek van papier balanseert op Z" }],
          basiskennis: [{ onderwerp: "kruispunt", uitleg: "3 zwaartelijnen ontmoeten in Z" }],
          niveaus: {
            basis: "Z deelt zwaartelijn in 2:1.",
            simpeler: "Vanaf hoek 2 delen, dan Z, dan 1 deel.",
            nogSimpeler: "2 stappen, dan Z, dan 1 stap.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Twee verschillende lijnen", tekst: "Zwaartelijn → naar midden. Hoogtelijn → loodrecht op overkant." }],
          woorden: [{ woord: "hoogtelijn", uitleg: "loodrecht vanuit hoek op overkant" }],
          theorie: "Zwaartelijn ≠ hoogtelijn. Snijdt vaak een ander punt op de zijde.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Zwaartelijn → midden. Hoogtelijn → voet (90°)." }],
          basiskennis: [{ onderwerp: "oppervlakte", uitleg: "hoogtelijn-lengte = h in opp = ½·b·h" }],
          niveaus: {
            basis: "Zwaartelijn naar midden, hoogtelijn loodrecht.",
            simpeler: "Z = midden. H = haaks.",
            nogSimpeler: "Z gaat naar midden, H staat haaks.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "b × h", tekst: "Opp parallellogram = basis × hoogte = 12 × 7 = 84 m²." }],
          woorden: [{ woord: "hoogte", uitleg: "loodrechte afstand tussen evenwijdige zijden" }],
          theorie: "Opp = b · h. Niet de schuine zijde gebruiken!",
          voorbeelden: [{ type: "voorbeeld", tekst: "8 × 5 = 40 cm²" }],
          basiskennis: [{ onderwerp: "eenheid", uitleg: "m × m = m²" }],
          niveaus: {
            basis: "12 × 7 = 84 m².",
            simpeler: "Vermenigvuldig basis met hoogte.",
            nogSimpeler: "12 keer 7 = 84.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "½ × d₁ × d₂", tekst: "½ × 10 × 6 = ½ × 60 = 30 cm²." }],
          woorden: [{ woord: "diagonalen", uitleg: "lijnen tussen overstaande hoeken" }],
          theorie: "Ruit: opp = ½ · d₁ · d₂. Diagonalen staan loodrecht.",
          voorbeelden: [{ type: "voorbeeld", tekst: "d₁=8, d₂=6 → ½·48 = 24 cm²" }],
          basiskennis: [{ onderwerp: "eenheid", uitleg: "cm × cm = cm² (vierkant)" }],
          niveaus: {
            basis: "½ × 10 × 6 = 30 cm².",
            simpeler: "Diagonalen vermenigvuldigen, dan ÷ 2.",
            nogSimpeler: "10 × 6 = 60. 60 ÷ 2 = 30.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "½ × (a+b) × h", tekst: "½ × (6+10) × 4 = ½ × 16 × 4 = 32." }],
          woorden: [{ woord: "trapezium", uitleg: "1 paar evenwijdige zijden" }],
          theorie: "Opp = ½ · (a + b) · h, waar a en b de evenwijdige zijden zijn.",
          voorbeelden: [{ type: "voorbeeld", tekst: "a=4, b=8, h=5 → ½·12·5 = 30" }],
          basiskennis: [{ onderwerp: "gemiddelde", uitleg: "(a+b)/2 = gemiddelde van evenwijdige zijden" }],
          niveaus: {
            basis: "½ × (6+10) × 4 = 32.",
            simpeler: "Tel beide evenwijdige zijden op, keer hoogte, ÷ 2.",
            nogSimpeler: "6 + 10 = 16. 16 × 4 = 64. 64 ÷ 2 = 32.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "Zwaartepunt = van zwaartelijnen.",
            nogSimpeler: "Naam zegt het: zwaarte → zwaartelijnen.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "stappen", uitleg: "eerst optellen, dan × h, dan × ½" }],
          theorie: "Opp trapezium = ½ · (a + b) · h.",
          voorbeelden: [{ type: "voorbeeld", tekst: "a=8, b=12, h=5 → ½·20·5 = 50" }],
          basiskennis: [{ onderwerp: "volgorde", uitleg: "haakjes eerst" }],
          niveaus: {
            basis: "½ × (8+12) × 5 = 50 cm².",
            simpeler: "Eerst 8+12=20, dan ×5=100, dan ÷2=50.",
            nogSimpeler: "20, dan 100, dan 50.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "oppervlakte", uitleg: "binnenkant van figuur in vierkante meters" }],
          theorie: "Rechthoek: lengte × breedte.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Kamer 4m × 5m = 20 m²" }],
          basiskennis: [{ onderwerp: "eenheid", uitleg: "m × m = m²" }],
          niveaus: {
            basis: "12 × 8 = 96 m².",
            simpeler: "Lengte keer breedte.",
            nogSimpeler: "12 × 8 = 96.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "halfrond", uitleg: "halve cirkel = halve oppervlakte" }],
          theorie: "Cirkel: π·r². Halfrond: ½·π·r².",
          voorbeelden: [{ type: "voorbeeld", tekst: "r=3 → ½·π·9 ≈ 14,1" }],
          basiskennis: [{ onderwerp: "diameter→straal", uitleg: "r = d/2" }],
          niveaus: {
            basis: "½ × π × 3² ≈ 14,1 m².",
            simpeler: "Eerst r=3. Dan π×9÷2 ≈ 14.",
            nogSimpeler: "3,14 × 9 ÷ 2 ≈ 14.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Tuin − zandbak", tekst: "96 − 14,1 ≈ 81,9 m²." }],
          woorden: [{ woord: "samenstelling", uitleg: "hele tuin minus uitgesneden deel" }],
          theorie: "Bij combinatie-figuren: grootste opp minus uitgesneden vorm.",
          voorbeelden: [{ type: "voorbeeld", tekst: "96 − 14,1 = 81,9" }],
          basiskennis: [{ onderwerp: "rest", uitleg: "grasveld = tuin − zandbak" }],
          niveaus: {
            basis: "96 − 14,1 = 81,9 m².",
            simpeler: "Hele tuin min de zandbak.",
            nogSimpeler: "96 − 14 ≈ 82.",
          },
        },
      },
      { q: "Oppervlakte parallellogram met basis 6 en hoogte 4 = ?", options: ["24","10","12","20"], answer: 0, wrongHints: [null,"Klopt — basis × hoogte.","Niet — niet optellen.","Geen verklaring.","Niet."] },
      { q: "Een **ruit** heeft hoeveel gelijke zijden?", options: ["4","2","3","Geen"], answer: 0, wrongHints: [null,"Klopt — alle 4 gelijk.","Niet — alle 4.","Niet.","Niet."] },
      { q: "Omtrek cirkel met straal 5 = ?", options: ["10π","5π","25π","π/5"], answer: 0, wrongHints: [null,"Klopt — 2πr = 2·π·5.","Niet — diameter.","Dat is oppervlakte.","Niet."] },
      { q: "Oppervlakte cirkel met straal 3 = ?", options: ["9π","6π","3π","12π"], answer: 0, wrongHints: [null,"Klopt — πr² = π·9.","Dat is omtrek.","Niet.","Niet."] },
      { q: "Een **trapezium** heeft minimaal hoeveel parallelle zijden?", options: ["2","4","0","1"], answer: 0, wrongHints: [null,"Klopt — boven en onder parallel.","Dat is parallellogram.","Niet — wel parallel.","Te weinig."] },
      { q: "Oppervlakte driehoek basis 10, hoogte 6 = ?", options: ["30","60","16","20"], answer: 0, wrongHints: [null,"Klopt — (b·h)/2.","Vergeet ÷2.","Niet — geen optellen.","Niet."] },
    ],
  },
];
