    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Europese Raad.",
            simpeler: "Brede politieke crises worden besproken door de regeringsleiders = Europese Raad.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Verzorgingsstaat.",
            simpeler: "Overheid die actief jongeren ondersteunt met centra = uiting van een verzorgingsstaat.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Beleidsvoorbereiding.",
            simpeler: "Beleidsambtenaren op ministeries werken wetsvoorstellen uit = fase 2 = beleidsvoorbereiding.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Sociaaldemocratische stroming.",
            simpeler: "Sociale oorzaken van criminaliteit aanpakken = sociaaldemocratisch denken (PvdA-stijl).",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Bindingstheorie.",
            simpeler: "Sterke banden (familie/school/werk) remmen criminaliteit = bindingstheorie van Hirschi.",
