    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2 : 3. A.", simpeler: "12 en 18 beide ÷6: 12÷6=2, 18÷6=3 → 2:3 (jongens : meisjes).", nogSimpeler: "2:3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2 : 3. A.", simpeler: "6 en 9 beide ÷3: 6÷3=2, 9÷3=3 → 2:3.", nogSimpeler: "2:3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4 : 1. A.", simpeler: "Fietsen:brommers = 20:5. Beide ÷5 → 4:1. (4 fietsen op elke 1 brommer).", nogSimpeler: "4:1" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "100 mL. A.", simpeler: "1:3 = 4 delen. 400÷4=100 per deel. Siroop=1 deel=100 mL.", nogSimpeler: "100" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8. A.", simpeler: "2+5=7 delen. 28÷7=4 per deel. Eerste groep = 2 × 4 = 8 leerlingen.", nogSimpeler: "8" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5 kg. A.", simpeler: "3+1=4 delen. 20÷4=5 per deel. Cement = 1 deel = 5 kg.", nogSimpeler: "5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "€10. A.", simpeler: "Per brood: €6÷3 = €2. 5 broden = 5×€2 = €10.", nogSimpeler: "€10" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "100. A.", simpeler: "2 → 40 = ×20 (40÷2). Andere kant ook ×20: 5×20=100.", nogSimpeler: "100" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "150 g. A.", simpeler: "1 deel meel = 200÷4 = 50g. Suiker = 3 delen × 50 = 150g.", nogSimpeler: "150" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "450 g. A.", simpeler: "Per persoon: 300÷4 = 75g. 6 mensen: 6×75 = 450g.", nogSimpeler: "450" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "375 mL. A.", simpeler: "1L = 1000mL. Per persoon: 1000÷8 = 125mL. 3 personen: 3×125 = 375mL.", nogSimpeler: "375" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5 cm. A.", simpeler: "Op kaart wordt werkelijke afstand veel kleiner. 5 km in werkelijkheid → 5 cm op kaart.", nogSimpeler: "5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3 km. A.", simpeler: "Bij 1:100.000 is 1 cm op kaart = 1 km werkelijk. 3 cm op kaart = 3 km.", nogSimpeler: "3 km" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "15 cm. A.", simpeler: "Bij 1:100 schaal: 1 m werkelijk = 1 cm op kaart. 15 m = 15 cm.", nogSimpeler: "15" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4 m. A.", simpeler: "8 cm × 50 (schaal) = 400 cm = 4 m werkelijk.", nogSimpeler: "4 m" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "€0,50. A.", simpeler: "750 mL = 7,5 × 100 mL. Prijs per 100 mL = €3,75 ÷ 7,5 = €0,50.", nogSimpeler: "€0,50" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "40. A.", simpeler: "Rood: 3 → 24 = ×8 (24÷3). Blauw: 5×8=40.", nogSimpeler: "40" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "750 g. A.", simpeler: "Per persoon: 300÷4 = 75g. 10 mensen: 10×75 = 750g.", nogSimpeler: "750" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "18 m. A.", simpeler: "9 cm × 200 (schaal) = 1800 cm = 18 m werkelijk.", nogSimpeler: "18 m" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Beide 3:4. A.", simpeler: "Klas A: 12:16 = 3:4 (÷4). Klas B: 9:12 = 3:4 (÷3). Verhouding identiek.", nogSimpeler: "3:4 beide" },
        },
      },
      {
      ...
      { q: "Verhouding 1:5 op een tekening. 2 cm = ?", options: ["10 cm","5 cm","½ cm","20 cm"], answer: 0, wrongHints: [null, "Niet vermenigvuldigd.", "Andersom.", "Niet."] },
      ...
      { q: "Wat is een **verhouding**?", options: ["Vergelijking tussen 2+ getallen (a:b)","Som","Verschil","Product"], answer: 0, wrongHints: [null, "Optellen.", "Aftrekken.", "Vermenigvuldigen."] },
      { q: "5 leerlingen in 3 banken — gemiddeld?", options: ["~1,7 per bank","3","5","2"], answer: 0, wrongHints: [null, "Aantal banken.", "Aantal leerlingen.", "Niet."] },
      { q: "Recept 2 eieren voor 4 personen. Voor 6 personen?", options: ["3 eieren","2","4","6"], answer: 0, wrongHints: [null, "Niet meer.", "Te veel.", "Niet zo."] },
