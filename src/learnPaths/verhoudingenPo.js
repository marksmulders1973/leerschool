...
const steps = [
...

  {
    ...
    checks: [
      ...
      { q: "Recept voor 4 personen wil je voor 8 — vermenigvuldig met?", options: ["2","4","½","8"], answer: 0, wrongHints: [null,"Klopt — dubbel.","Niet — alles ×4 = te veel.","Halveren = minder.","Niet zo."] },
      { q: "1 fles cola = €1,50. 6 flessen = ?", options: ["€9","€6","€1,50","€15"], answer: 0, wrongHints: [null,"Klopt — 6 × €1,50.","Geen multipliceren.","1 fles.","Te veel."] },
      { q: "Verhouding 2:3. Bij 2 = 10, bij 3 = ?", options: ["15","13","20","30"], answer: 0, wrongHints: [null,"Klopt — vermenigvuldigingsfactor 5.","Niet — verhouding behouden.","Niet.","Niet."] },
      { q: "Schaal 1:100 — 3 cm op tekening = echt?", options: ["3 m","30 cm","30 m","3 km"], answer: 0, wrongHints: [null,"Klopt — 3×100 = 300 cm = 3 m.","Te klein.","Te groot.","Veel te groot."] },
      { q: "Sap : water = 1 : 3. 200 mL sap → hoeveel water?", options: ["600 mL","200 mL","100 mL","300 mL"], answer: 0, wrongHints: [null,"Klopt — 3× sap.","Gelijk = 1:1.","Te weinig.","1,5×."] },
      { q: "120 km in 2 uur = welke snelheid?", options: ["60 km/u","120 km/u","240 km/u","30 km/u"], answer: 0, wrongHints: [null,"Klopt — 120÷2.","Dat is afstand.","Te hoog.","Niet."] },
      { q: "Verhouding 1:5 op een tekening. 2 cm = ?", options: ["10 cm","5 cm","½ cm","20 cm"], answer: 0, wrongHints: [null,"Klopt — 2×5.","Niet vermenigvuldigd.","Andersom.","Niet."] },
      { q: "8 m² muur kost 12 euro verf. 24 m²?", options: ["€36","€18","€48","€12"], answer: 0, wrongHints: [null,"Klopt — 24÷8=3, 3×12.","Te weinig.","Te veel.","Geen vermenigvuldiging."] },
      { q: "Op kaart 1:50.000 is 4 cm = welke afstand?", options: ["2 km","20 m","200 m","20 km"], answer: 0, wrongHints: [null,"Klopt — 4×50.000=200.000 cm=2 km.","Te weinig.","Niet.","Te veel."] },
      { q: "Wat is een **verhouding**?", options: ["Vergelijking tussen 2+ getallen (a:b)","Som","Verschil","Product"], answer: 0, wrongHints: [null,"Klopt — relatie.","Optellen.","Aftrekken.","Vermenigvuldigen."] },
      { q: "5 leerlingen in 3 banken — gemiddeld?", options: ["~1,7 per bank","3","5","2"], answer: 0, wrongHints: [null,"Klopt — 5÷3 ≈ 1,67.","Aantal banken.","Aantal leerlingen.","Niet."] },
      { q: "Recept 2 eieren voor 4 personen. Voor 6 personen?", options: ["3 eieren","2","4","6"], answer: 0, wrongHints: [null,"Klopt — verhouding 2:4 = 3:6.","Niet meer.","Te veel.","Niet zo."] },
      { q: "Plant groeit 5 cm in 2 weken. Per week?", options: ["2,5 cm","5 cm","7 cm","10 cm"], answer: 0, wrongHints: [null,"Klopt — 5÷2.","Dat is 2 weken.","Niet — niet plus.","Te veel."] },
      { q: "Schaal 1:25 — model van 8 cm = echt?", options: ["2 m","25 m","2 cm","20 cm"], answer: 0, wrongHints: [null,"Klopt — 8×25=200 cm = 2 m.","Te veel.","Te weinig.","Niet."] },
      { q: "Mix: 3 deel zout + 1 deel peper. 12 g totaal. Hoeveel zout?", options: ["9 g","3 g","6 g","12 g"], answer: 0, wrongHints: [null,"Klopt — 3/4 × 12.","Dat is peper.","Helft.","Hele."] },
    ],
  },
];
