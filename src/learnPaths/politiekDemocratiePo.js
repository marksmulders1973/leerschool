...
const steps = [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit Trias: 3 machten = balans en controle. Rechters mogen niet door politici worden ontslagen (onafhankelijk). Anders zou regering rechters kunnen omkopen.",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-formule: meerderheid = (totaal ÷ 2) + 1. Bij 150 = 75 + 1 = 76. Bij Eerste Kamer (75): 37 + 1 = 38.",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        options: ["12", "10", "11", "13"],
        answer: 0,
        wrongHints: [null, "Iets minder.", "Iets minder.", "Iets meer."],
        uitlegPad: {
          stappen: [
          ...
          basiskennis: [{ onderwerp: "Truc", uitleg: "12 provincies = vast onder toetsvraag. Niet 11 (vóór 1986), niet 13. Sinds 1986 = 12." }],
          niveaus: {
            basis: "12 provincies.",
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Eerder.", "Eerder.", "Veel later."],
      },
      {
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Hoeveel **provincies**?", options: ["12", "11", "13", "16"], answer: 0, wrongHints: [null, "Iets minder.", "Iets meer.", "Te veel."] },
      ...
      { q: "Wanneer **euro** in NL?", options: ["2002", "1957", "1980", "1990"], answer: 0, wrongHints: [null, "EEG.", "Eerder.", "Eerder."] },
      ...
      { q: "Wat is **Binnenhof**?", options: ["Plek waar Tweede Kamer zit (Den Haag)","Koningsverblijf","Niet relevant","Reclame"], answer: 0, wrongHints: [null, "Paleis Noordeinde.", "Wel.", "Niet."] },
      { q: "Wat zijn **referendum**?", options: ["Volk stemt direct over één onderwerp","Verkiezing kandidaten","Niet bestaand","Reclame"], answer: 0, wrongHints: [null, "Niet — kandidaten.", "Wel.", "Niet."] },
      { q: "Welke is **EU-instituut**?", options: ["Europees Parlement","NL Tweede Kamer","Niet bestaand","Reclame"], answer: 0, wrongHints: [null, "NL nationaal.", "Wel.", "Niet."] },
