...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wat is **Trias Politica**?", options: ["3 machten gescheiden (wetgevend/uitvoerend/rechterlijk)","2 partijen","1 koning","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — Montesquieu.","Niet.","Niet.","Wel."] },
      { q: "Welke macht maakt **wetten**?", options: ["Wetgevende (parlement)","Uitvoerende (regering)","Rechterlijke (rechters)","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Voert uit.","Beoordeelt.","Wel."] },
      { q: "Welke macht **voert wetten uit**?", options: ["Uitvoerende (regering/kabinet)","Wetgevende","Rechterlijke","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Maakt wetten.","Beoordeelt.","Wel."] },
      { q: "Wat doet de **Eerste Kamer**?", options: ["Wetten goedkeuren / verwerpen","Wetten maken","Voert uit","Beoordeelt"], answer: 0, wrongHints: [null,"Klopt — controleert Tweede Kamer.","Tweede Kamer.","Regering.","Rechters."] },
      { q: "Vanaf welke leeftijd mag je **stemmen** in NL?", options: ["18","16","21","12"], answer: 0, wrongHints: [null,"Klopt.","Niet algemeen.","Eerder verlaagd.","Te jong."] },
      { q: "Wat is een **coalitie**?", options: ["Samenwerking partijen voor meerderheid","Eén partij","Oppositie","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt.","Niet — geen meerderheid alleen.","Tegengestelde.","Wel."] },
      { q: "Wat is **oppositie**?", options: ["Partijen NIET in regering","Regering","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Wel.","Niet."] },
      { q: "Wat is een **grondrecht**?", options: ["Recht in grondwet beschermd","Een belasting","Niet bestaand","Reclame"], answer: 0, wrongHints: [null,"Klopt — bv. vrijheid van meningsuiting.","Niet.","Wel.","Niet."] },
      { q: "Wat doet de **Koning** politiek (NL)?", options: ["Ceremonieel + ondertekent wetten","Beslist alles","Maakt wetten","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — constitutionele monarchie.","Niet — kabinet.","Parlement.","Wel."] },
      { q: "Wat is **Binnenhof**?", options: ["Plek waar Tweede Kamer zit (Den Haag)","Koningsverblijf","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — historisch.","Paleis Noordeinde.","Wel.","Niet."] },
      { q: "Wat zijn **referendum**?", options: ["Volk stemt direct over één onderwerp","Verkiezing kandidaten","Niet bestaand","Reclame"], answer: 0, wrongHints: [null,"Klopt.","Niet — kandidaten.","Wel.","Niet."] },
      { q: "Welke is **EU-instituut**?", options: ["Europees Parlement","NL Tweede Kamer","Niet bestaand","Reclame"], answer: 0, wrongHints: [null,"Klopt — Brussel/Straatsburg.","NL nationaal.","Wel.","Niet."] },
      { q: "Wat is een **minister**?", options: ["Hoofd van een ministerie","Burgemeester","Koning","Rechter"], answer: 0, wrongHints: [null,"Klopt.","Lokaal.","Niet.","Niet."] },
      { q: "Wat is een **burgemeester**?", options: ["Hoofd van een gemeente","Minister","Koning","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Wel."] },
    ],
  },
];
