    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klimaat.", "Wel.", "Wel verschil."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: {
            basis: "Weer = wat NU in atmosfeer gebeurt.",
            simpeler: "Weer = vandaag. Klimaat = gemiddelde over decennia.",
            nogSimpeler: "NU = weer",
          },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Te warm.", "Te koud.", "Te warm."],
      },
      {
        q: "**Eenheid neerslag**?",
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip neerslag: ALTIJD in mm. Liter zegt niets zonder oppervlak — daarom mm (universeel). Regen in mm wordt gemeten per dag of per jaar.",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Te weinig — woestijn.", "Te veel — tropisch regenwoud.", "Niet."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: zon = motor van wind. Warmt aarde ongelijk op → drukverschillen → wind. Op evenaar warm = laagedruk. Bij polen koud = hogedruk.",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet.", "Vooral droog.", "Niet primair."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: {
            basis: "Zuidwesten.",
            simpeler: "60% van NL-wind komt uit het zuidwesten (Atlantische Oceaan + UK).",
            nogSimpeler: "Zuidwesten",
          },
        },
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Lage druk.", "Niet primair.", "Lage druk."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: KNMI gebruikt supercomputers + satellieten + weerballonnen + radar. Modellen rekenen 4x per dag wat lucht gaat doen. Voorspellingen 1-3 dagen = ~90% betrouwbaar.",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Iso-thermen.", "Niet primair.", "Niet specifiek."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: {
            basis: "Isobaren = lijnen van gelijke luchtdruk op weerkaart.",
            simpeler: "Lijnen die luchtdruk-waarden verbinden. Dicht bij elkaar = wind.",
            nogSimpeler: "Druk-lijnen",
          },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Te weinig.", "Wel mogelijk.", "Nooit 100%."],
      },
      {
        q: "Wat is **tropische cyclon** in Caraiben?",
        options: ["Orkaan", "Typhoon", "Storm", "Tornado"],
        answer: 0,
        wrongHints: [null, "Pacific.", "Algemeen.", "Anders."],
      },
    ],
  },
  {
    ...
    checks: [
      ...
      { q: "Hoe lang **vooruit voorspellen**?", options: ["~7 dagen redelijk", "1 maand exact", "1 jaar", "Niet mogelijk"], answer: 0, wrongHints: [null, "Onmogelijk.", "Onmogelijk.", "Wel."] },
      {
        ...
        answer: 0,
        wrongHints: [null, "Dat is gewoon WEER, niet klimaat (= langere termijn).", "Seizoenen = normale cyclus, geen verandering.", "Niet — klimaat is wetenschappelijk fenomeen."],
        uitlegPad: {
          stappen: [
            ...
            { titel: "Toets-feit: Parijsakkoord", tekst: "In **2015** sloten 196 landen het **Parijsakkoord**:\n• Opwarming **onder 2 °C** houden (liefst 1,5 °C)\n• Drastisch minder CO₂ uitstoten\n• Tegen ~2050 'klimaatneutraal' zijn\n\nNL doel: **49% minder CO₂ in 2030** + **95% minder in 2050** (Klimaatwet 2019). Voor toetsstof: weet dat MENS de oorzaak is + Parijs 2015 belangrijk." },
          ],
          woorden: [
          ...
          basiskennis: [{ onderwerp: "Niet 1 dag warm = klimaat", uitleg: "Hete zomer ≠ klimaatverandering. TREND over 30 jaar wel. Toets-feit: weer ≠ klimaat." }],
          niveaus: { basis: "Opwarming door CO₂.", simpeler: "Klimaatverandering = aarde wordt langzaam warmer door mensen die fossiele brandstoffen verbranden + veel CO₂ uitstoten. Al ~1,5 °C warmer sinds 1850.", nogSimpeler: "Opwarming" },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Dat zijn schermrichtingen, geen windrichtingen.", "Wiskunde-symbolen, niet windrichtingen.", "Wel — basis weer + navigatie."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: { basis: "NOZW.", simpeler: "Vier windrichtingen: Noord (boven), Oost (rechts), Zuid (onder), West (links). Ezelsbrug: Nooit Op Zaterdag Werken.", nogSimpeler: "NOZW" },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Veel regen = bui, geen storm-definitie.", "Sneeuw + storm = sneeuwstorm, maar storm zelf = wind.", "Onweer = bliksem/donder, andere fenomeen."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: { basis: "Beaufort 9+ (75 km/u).", simpeler: "Storm in NL = windkracht 9 op Beaufort-schaal = 75 km/u of harder. Beaufort 12 = orkaan (>117 km/u).", nogSimpeler: "Beaufort 9+" },
        },
      },
      ...
      { q: "Welk **alfabet** voor wind-richting?", options: ["NWZOO (Noord-West-Zuid-Oost)","ABCD","Random","Niet bestaand"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Wel."] },
...
const weersvoorspellingPo = {
  ...
  title: "Weer + weersvoorspelling (Doorstroomtoets groep 6-8)",
  emoji: "🌤️",
  level: "groep6-8",
  subject: "natuur",
  referentieNiveau: "1F",
  ...
  intro:
    "Weer voor Doorstroomtoets groep 6-8 — wat is weer (temperatuur/neerslag/wind/druk) + wind + luchtdruk + onweer/bliksem + KNMI in De Bilt + voorspellen via radar/satelliet/computermodellen + weerkaart-symbolen + extreem weer (orkaan/tornado/hittegolf). Sluit op water-kringloop. ~15 min.",
  triggerKeywords: [
