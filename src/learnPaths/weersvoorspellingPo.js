...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wat is **luchtdruk**?", options: ["Kracht waarmee lucht drukt","Wind","Temperatuur","Vochtigheid"], answer: 0, wrongHints: [null,"Klopt — gemeten in hPa.","Beweging lucht.","Warmte.","Vocht."] },
      { q: "Hoge luchtdruk = welk weer?", options: ["Mooi/droog","Storm","Onweer","Regen"], answer: 0, wrongHints: [null,"Klopt — anticycloon.","Lage druk.","Lage druk.","Lage druk."] },
      { q: "Welke windrichting waait meestal in NL?", options: ["Zuidwest","Noord","Oost","Zuid"], answer: 0, wrongHints: [null,"Klopt — overheersend.","Soms.","Soms (oosterwind koud).","Niet primair."] },
      { q: "Welke wolk lijkt op **bloemkool**?", options: ["Cumulus","Cirrus","Stratus","Cumulonimbus"], answer: 0, wrongHints: [null,"Klopt — schoonweer-wolk.","IJskristal.","Vlakke laag.","Onweerswolk."] },
      { q: "Welke schaal meet **temperatuur** in NL?", options: ["Celsius","Fahrenheit","Kelvin","Beaufort"], answer: 0, wrongHints: [null,"Klopt.","VS-stelsel.","Wetenschap.","Wind."] },
      { q: "Welk **instrument** meet luchtdruk?", options: ["Barometer","Thermometer","Anemometer","Hygrometer"], answer: 0, wrongHints: [null,"Klopt.","Temperatuur.","Wind.","Vocht."] },
      { q: "Wat doet een **anemometer**?", options: ["Wind meten","Temperatuur","Luchtdruk","Vochtigheid"], answer: 0, wrongHints: [null,"Klopt.","Thermometer.","Barometer.","Hygrometer."] },
      { q: "Een **hittegolf** in NL = ?", options: ["≥5 dagen ≥25°C met 3 ≥30°C","1 dag warm","1 week zon","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — KNMI-definitie.","Te kort.","Niet specifiek.","Wel."] },
      { q: "Wat doet een **front** in weer?", options: ["Grens tussen luchtmassa's","Niets","Wolk","Zon"], answer: 0, wrongHints: [null,"Klopt — koud/warm front.","Wel.","Onderdeel.","Niet."] },
      { q: "**Code rood** bij KNMI betekent?", options: ["Extreem gevaarlijk weer","Mooi weer","Een dag wachten","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — waarschuwingsniveau.","Tegengestelde.","Niet.","Wel."] },
      { q: "Wat is **smog**?", options: ["Mengsel mist + luchtvervuiling","Sneeuw","Mooi weer","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Tegengestelde.","Wel."] },
      { q: "Welk weer geeft een **lage druk** vaak?", options: ["Bewolkt/regen","Mooi weer","Sneeuw","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — depressie.","Hoge druk.","Niet primair.","Wel."] },
      { q: "Wat doet een **buienradar**?", options: ["Toont waar regen valt + bewegingsrichting","Voorspelt temperatuur","Toont wind","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — radar-techniek.","Niet primair.","Niet primair.","Wel."] },
      { q: "Welk **alfabet** voor wind-richting?", options: ["NWZOO (Noord-West-Zuid-Oost)","ABCD","Random","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — kompasrichtingen.","Niet.","Niet.","Wel."] },
      { q: "Welke maanden zijn meestal **warmst** in NL?", options: ["Juni-augustus","December-februari","Maart-mei","September-november"], answer: 0, wrongHints: [null,"Klopt — zomer.","Winter.","Lente.","Herfst."] },
    ],
  },
];
