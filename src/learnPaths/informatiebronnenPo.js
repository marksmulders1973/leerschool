...
// vragen, 25%). Tweede grootste Toets-gat dat 4-agent-audit B 2026-05-18 vond.
//
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-regel: voor woord-betekenis altijd woordenboek (Van Dale). Voor concept-uitleg encyclopedie (Wikipedia).",
          ...
          niveaus: { basis: "Betekenis = woordenboek.", simpeler: "Voor wat een woord betekent → woordenboek.", nogSimpeler: "Woordenboek" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Waar ligt = atlas.", simpeler: "Voor kaarten en ligging → atlas.", nogSimpeler: "Atlas" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Nieuws = krant.", simpeler: "Actueel → krant of nieuws-site.", nogSimpeler: "Krant" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Encyclopedie + schoolboek.", simpeler: "Werkstuk → brede info → encyclopedie.", nogSimpeler: "Encyclopedie" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "aap eerst (aa<ap<au<az).", simpeler: "Alle a-, dan 2e letter: a<p<u<z. → aap.", nogSimpeler: "Aap." },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Liep → lopen.", simpeler: "Vervoegd werkwoord → opzoeken onder hele werkwoord.", nogSimpeler: "Lopen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "a-b-c → appel-banaan-citroen.", simpeler: "Volgorde a-b-c: appel, banaan, citroen.", nogSimpeler: "ABC" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Inhoudsopgave.", simpeler: "Lijst hoofdstukken vooraf = inhoudsopgave.", nogSimpeler: "Inhoudsopgave" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Index.", simpeler: "Specifieke naam → index achteraan.", nogSimpeler: "Index" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Inhoudsopgave.", simpeler: "'Hoofdstuk N ... blz N' = inhoudsopgave.", nogSimpeler: "Hoofdstuk" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Fictie, alfabetisch schrijver.", simpeler: "Verzonnen verhaal = fictie.", nogSimpeler: "Fictie" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "NIOD.", simpeler: "Wetenschappelijk instituut = meest betrouwbaar.", nogSimpeler: "NIOD" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip: primaire bron = origineel. Secundair = afgeleid. Onderzoek waardeert primair hoger.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Primair: brief van Rembrandt aan Saskia. Secundair: schoolboek-uitleg over hun relatie." }],
          niveaus: { basis: "Dagboek zelf = primair.", simpeler: "Anne schreef het zelf = direct van bron.", nogSimpeler: "Dagboek" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Sensationeel + geen bron = fake.", simpeler: "Schreeuwerig + anoniem = waarschuwing.", nogSimpeler: "Geen bron" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3 bronnen combineren.", simpeler: "Wetenschap + actueel + mens = sterk.", nogSimpeler: "Combineren" },
        },
      },
      {
...
const informatiebronnenPo = {
  ...
  title: "Informatiebronnen (Doorstroomtoets groep 6-8)",
  emoji: "🔍",
  level: "groep6-8",
  subject: "taal",
  referentieNiveau: "1F",
  ...
  intro:
    "Bronnen voor de Doorstroomtoets — woordenboek, atlas, encyclopedie, inhoudsopgave + index, betrouwbaarheid + fake news. 5 stappen × ~5 vragen. ~15 min.",
  triggerKeywords: [
