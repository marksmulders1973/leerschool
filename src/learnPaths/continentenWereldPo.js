    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Nederland ligt in Europa.",
            simpeler: "Europa = ons continent. Buren: Duitsland, België.",
            nogSimpeler: "Europa",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Azië = grootst.",
            simpeler: "Top 3: Azië > Afrika > Noord-Amerika. Grootst = Azië.",
            nogSimpeler: "Azië",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Pinguïns + onderzoekers.",
            simpeler: "Antarctica = ijs + pinguïns. Wel onderzoekers, geen steden.",
            nogSimpeler: "Pinguïns",
          },
        },
      },
    ],
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Stille Oceaan = grootst.",
            simpeler: "Volgorde: Stille > Atlantische > Indische. Grootst = Stille.",
            nogSimpeler: "Stille",
          },
        },
      },
  ...
  // STAP 3: Landen op continent
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Te ver naar het oosten.", "Te ver naar het noorden.", "Heel ver weg — Egypte ligt aan de Middellandse Zee."],
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "12 − 6 = 06:00.",
            simpeler: "New York is 6 uur eerder, dus je trekt 6 uur af. 12 − 6 = 6. = 06:00",
            nogSimpeler: "12 − 6 = 6 uur 's ochtends",
          },
        },
      },
      {
