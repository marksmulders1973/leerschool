...
const steps = [
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "Hoeveel **continenten** zijn er?", options: ["7","5","8","6"], answer: 0, wrongHints: [null,"Klopt — Europa, Azië, Afrika, NAm, ZAm, Oceanië, Antarctica.","Te weinig.","Te veel.","Bijna."] },
      { q: "Op welk continent ligt **Egypte**?", options: ["Afrika","Azië","Europa","Oceanië"], answer: 0, wrongHints: [null,"Klopt — Noord-Afrika.","Niet — grootste deel Afrika.","Niet.","Niet."] },
      { q: "Op welk continent ligt **China**?", options: ["Azië","Afrika","Europa","Noord-Amerika"], answer: 0, wrongHints: [null,"Klopt — oost-Azië.","Niet.","Niet.","Niet."] },
      { q: "Welk continent is het **kleinst** (in oppervlakte)?", options: ["Oceanië/Australië","Antarctica","Europa","Zuid-Amerika"], answer: 0, wrongHints: [null,"Klopt.","Groter.","Groter.","Veel groter."] },
      { q: "Welk continent heeft de **Sahara**?", options: ["Afrika","Azië","Australië","Antarctica"], answer: 0, wrongHints: [null,"Klopt — grootste warme woestijn.","Niet.","Niet.","Wel woestijn, niet Sahara."] },
      { q: "Welk continent heeft de **Amazone-rivier**?", options: ["Zuid-Amerika","Afrika","Azië","Oceanië"], answer: 0, wrongHints: [null,"Klopt — Brazilië.","Wel grote rivieren, niet Amazone.","Niet.","Niet."] },
      { q: "Tussen welke 2 continenten ligt de **Atlantische Oceaan**?", options: ["Amerika ↔ Europa/Afrika","Azië ↔ Australië","NAm ↔ ZAm","Niet."], answer: 0, wrongHints: [null,"Klopt.","Stille Oceaan.","Geen oceaan tussen.","Wel."] },
      { q: "Welk continent ligt rond de **noordpool**?", options: ["Niet één continent — vooral water","Antarctica","Europa","Azië"], answer: 0, wrongHints: [null,"Klopt — ijsvlakte op water.","Dat is zuidpool.","Wel deels, geen continent op pool.","Wel deels."] },
      { q: "Op welk werelddeel ligt **Nederland**?", options: ["Europa","Azië","Afrika","Amerika"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "Welke continent heeft de **Mount Everest**?", options: ["Azië","Afrika","Zuid-Amerika","Noord-Amerika"], answer: 0, wrongHints: [null,"Klopt — Himalaya, Nepal/Tibet.","Wel bergen, niet Everest.","Andean.","Wel bergen, niet hoogste."] },
      { q: "Welke landen-groep ligt in **Oceanië**?", options: ["Australië + Nieuw-Zeeland + eilanden","NL + BE + DE","China + Japan","Brazilië + Argentinië"], answer: 0, wrongHints: [null,"Klopt.","Europa.","Azië.","Zuid-Amerika."] },
      { q: "Welk continent is dichtstbevolkt?", options: ["Azië","Afrika","Europa","Antarctica"], answer: 0, wrongHints: [null,"Klopt — China + India.","Tweede.","Niet groot genoeg.","Geen bewoning."] },
      { q: "Tijdzones-feit: hoeveel uur verschil **NL ↔ Sydney**?", options: ["+9 of +10 uur","+5","Geen verschil","−8"], answer: 0, wrongHints: [null,"Klopt — Australië voor.","Te weinig.","Wel verschil.","Verkeerde richting."] },
      { q: "Welke continent ligt deels op **noordelijk** + deels **zuidelijk** halfrond?", options: ["Afrika (en ZAm)","Antarctica","Europa","Azië"], answer: 0, wrongHints: [null,"Klopt — evenaar gaat erdoor.","Volledig zuid.","Volledig noord.","Voor 95% noord."] },
    ],
  },
];
