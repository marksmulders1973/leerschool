  ...
  // STAP 2: Oceanen
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Andere kant van de wereld.", "Onder Azië.", "Bij Antarctica."],
      },
      {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Onder Mexico.", "Andere kant van de wereld.", "Andere kant van de wereld."],
      },
      {
        q: "In welk continent ligt **Egypte**?",
        options: ["Afrika", "Azië", "Europa", "Oceanië"],
        answer: 0,
        wrongHints: [null, "Ten oosten van Afrika.", "Ten noorden.", "Veel verder."],
      },
      {
        q: "In welk continent ligt **Australië**?",
        options: ["Oceanië", "Azië", "Afrika", "Amerika"],
        answer: 0,
        wrongHints: [null, "Ligt onder Azië maar is eigen continent.", "Andere kant.", "Andere kant."],
      },
      {
  ...
  // STAP 4: Tijdzones (basic intro)
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Te vroeg — verkeerde richting.", "24:00 ≠ 20:00.", "Te ver."],
      },
      {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Big Ben staat daar.", "Colosseum staat daar.", "Geen Eiffeltoren."],
      },
      {
        q: "In welk land staan de **piramiden van Gizeh**?",
        options: ["Egypte", "Marokko", "Mexico", "Italië"],
        answer: 0,
        wrongHints: [null, "Niet Marokko.", "Daar zijn Maya-piramiden, maar niet die van Gizeh.", "Niet Italië."],
      },
      {
        q: "Wat is de **hoofdstad van Duitsland**?",
        options: ["Berlijn", "München", "Hamburg", "Wenen"],
        answer: 0,
        wrongHints: [null, "Grote stad maar geen hoofdstad.", "Grote stad maar geen hoofdstad.", "Wenen is hoofdstad van Oostenrijk."],
      },
      {
        q: "Bij welke stad staat het **Christusbeeld**?",
        options: ["Rio de Janeiro", "São Paulo", "Buenos Aires", "Lima"],
        answer: 0,
        wrongHints: [null, "Andere Braziliaanse stad.", "Hoofdstad Argentinië.", "Hoofdstad Peru."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        options: ["Europa", "Azië", "Afrika", "Noord-Amerika"],
        answer: 0,
        wrongHints: [null, "Te oostelijk.", "Italië ligt boven Afrika.", "Andere kant van de wereld."],
      },
      {
        q: "Welk continent heeft de **meeste mensen**?",
        options: ["Azië", "Afrika", "Europa", "Noord-Amerika"],
        answer: 0,
        wrongHints: [null, "Tweede, niet eerste.", "Veel minder mensen.", "Veel minder."],
      },
      {
        q: "Welke oceaan is **kleiner**: Atlantisch of Stille?",
        options: ["Atlantisch", "Stille", "Even groot", "Niet uit te leggen"],
        answer: 0,
        wrongHints: [null, "Stille is groter.", "Niet hetzelfde.", "Wel uit te leggen — vergelijk grootte."],
      },
      {
        q: "Het is **15:00** in Nederland. Beijing is **7 uur later**. Hoe laat?",
        options: ["22:00", "08:00", "10:00", "07:00"],
        answer: 0,
        wrongHints: [null, "Verkeerde richting.", "Verkeerd.", "Verkeerd."],
      },
      {
        q: "**Australië** is een continent én een ... ?",
        options: ["Land", "Stad", "Eiland", "Berg"],
        answer: 0,
        wrongHints: [null, "Niet alleen stad.", "Wel een groot eiland, maar 'land' is preciezer.", "Geen berg."],
      },
      {
      ...
      { q: "Op welk continent ligt **Egypte**?", options: ["Afrika","Azië","Europa","Oceanië"], answer: 0, wrongHints: [null, "Niet — grootste deel Afrika.", "Niet.", "Niet."] },
      { q: "Op welk continent ligt **China**?", options: ["Azië","Afrika","Europa","Noord-Amerika"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      ...
      { q: "Op welk werelddeel ligt **Nederland**?", options: ["Europa","Azië","Afrika","Amerika"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
