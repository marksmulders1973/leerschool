...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Welke is **hernieuwbaar**?", options: ["Zon","Aardolie","Aardgas","Steenkool"], answer: 0, wrongHints: [null,"Klopt.","Fossiel.","Fossiel.","Fossiel."] },
      { q: "Welke energie levert een **windturbine**?", options: ["Elektriciteit","Olie","Aardgas","Kolen"], answer: 0, wrongHints: [null,"Klopt — generator.","Niet.","Niet.","Niet."] },
      { q: "Wat zit er in **zonnepanelen**?", options: ["Cellen die licht → stroom omzetten","Olie","Kolen","Water"], answer: 0, wrongHints: [null,"Klopt — fotovoltaïsch.","Niet.","Niet.","Niet."] },
      { q: "Welk type elektriciteit uit een **stopcontact** in NL?", options: ["230 V wisselstroom","12 V","gelijkstroom","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Auto-accu.","DC = batterij.","Wel."] },
      { q: "Wat is een **kerncentrale**?", options: ["Maakt stroom met kernsplijting","Wind","Zon","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — uranium.","Niet.","Niet.","Wel."] },
      { q: "Wat doet een **batterij**?", options: ["Slaat energie op","Maakt elektriciteit uit niets","Verwarmt","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — chemische → elektrisch.","Niet — opslag.","Niet primair.","Wel."] },
      { q: "Welke energie uit **gas-fornuis**?", options: ["Warmte (uit chemische energie)","Elektrisch","Mechanisch","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — verbranding.","Niet.","Niet.","Wel."] },
      { q: "Wat is **isolatie** thuis?", options: ["Materiaal dat warmte vasthoudt","Verwarming","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — bespaart energie.","Andere functie.","Wel.","Niet."] },
      { q: "Welke energie heeft **stromend water** (rivier)?", options: ["Bewegingsenergie","Warmte","Licht","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — kinetisch.","Niet primair.","Niet.","Wel."] },
      { q: "Wat is een **kWh**?", options: ["Eenheid voor elektrisch verbruik","Eenheid gewicht","Eenheid tijd","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — kilowattuur.","Niet.","Niet.","Wel."] },
      { q: "Welke energiebron is **gratis** maar afhankelijk van weer?", options: ["Zon + wind","Olie","Kolen","Gas"], answer: 0, wrongHints: [null,"Klopt — weersafhankelijk.","Wel kosten.","Wel kosten.","Wel kosten."] },
      { q: "Welk percentage NL-stroom uit duurzaam (2024+)?", options: ["~50%+","5%","100%","20%"], answer: 0, wrongHints: [null,"Klopt — groeit snel.","Te weinig.","Niet helemaal.","Te weinig."] },
      { q: "Wat doet **CO₂-uitstoot** lagere energiebron?", options: ["Duurzame energie","Kolen","Olie","Gas"], answer: 0, wrongHints: [null,"Klopt — zon/wind.","Hoogste.","Hoog.","Lager dan kolen, niet duurzaam."] },
      { q: "Welke energievorm **zit in voedsel**?", options: ["Chemische energie","Elektrisch","Magnetisch","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — calorieën.","Niet.","Niet.","Wel."] },
    ],
  },
];
