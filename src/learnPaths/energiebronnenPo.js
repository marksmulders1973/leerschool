...
const steps = [
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Duurzaam.", "Duurzaam.", "Duurzaam."],
        uitlegPad: {
          stappen: [
  ...
  },
  {
    ...
    checks: [
      { q: "Welke is **fossiel**?", options: ["Aardgas", "Zon", "Wind", "Water"], answer: 0, wrongHints: [null, "Duurzaam.", "Duurzaam.", "Duurzaam."] },
      { q: "Welke is **duurzaam**?", options: ["Zonnepaneel", "Steenkool", "Aardolie", "Aardgas"], answer: 0, wrongHints: [null, "Fossiel.", "Fossiel.", "Fossiel."] },
      ...
      { q: "**Borssele** is wat?", options: ["NL kerncentrale", "Provincie", "Bedrijf", "Politicus"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "**Energie maken** = ?", options: ["Bestaat niet — alleen omzetten", "Uit niets", "Door wetenschap", "Door pc"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "Welke is **hernieuwbaar**?", options: ["Zon","Aardolie","Aardgas","Steenkool"], answer: 0, wrongHints: [null, "Fossiel.", "Fossiel.", "Fossiel."] },
      { q: "Welke energie levert een **windturbine**?", options: ["Elektriciteit","Olie","Aardgas","Kolen"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "Wat zit er in **zonnepanelen**?", options: ["Cellen die licht → stroom omzetten","Olie","Kolen","Water"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      ...
      { q: "Welke energiebron is **gratis** maar afhankelijk van weer?", options: ["Zon + wind","Olie","Kolen","Gas"], answer: 0, wrongHints: [null, "Wel kosten.", "Wel kosten.", "Wel kosten."] },
