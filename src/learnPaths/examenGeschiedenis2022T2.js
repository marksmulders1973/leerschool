...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "**Liberalisme** = ideologie van Thorbecke: vrijheid + parlementair stelsel + rijke burgers (census) macht geven. **Industrialisatie** = fabrieken + stoommachines (start NL rond 1850-1870 echt vol). Beide passen bij Thorbecke. Pacificatie = 1917 schoolstrijd-akkoord (veel later). Socialisme = arbeidersbeweging (veel later).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**4 Kamer-rechten**: AMENDEMENT (wet-tekst van regering wijzigen), BUDGET (begroting goedkeuren), INITIATIEF (zelf wet voorstellen), INTERPELLATIE (minister ondervragen). Wettekst aanpassen = amendement.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Geheime politie** = staatsorganisatie die zonder proces oppakt + afvoert (Gestapo in Nazi-Duitsland, NKVD/KGB in Sovjet-Unie, Stasi in DDR). Methode = stilletjes ophalen, geen verklaring, familie weet niets.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**18 maart 1990**: eerste **vrije verkiezingen** in DDR. CDU-Oost won (Lothar de Maizière). Dit baande de weg naar Duitse hereniging (3 oktober 1990, Tag der Deutschen Einheit).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Populisme** (Latijn populus = volk): sterke leider + 'gewone volk' tegenover 'elite' + vaak nationalistisch. Voorbeelden: Trump (VS), Wilders/Baudet (NL), Orbán (HU), Le Pen (FR). Volkstribuun-stijl, eenvoudige taal, anti-establishment.",
