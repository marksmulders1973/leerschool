    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Stelling = mening.", "Geen vraag.", "Geen voorbeeld."],
      },
      {
        q: "*'Volgens onderzoek van TU Delft ...'* — welk argument?",
        options: ["Autoriteit", "Emotioneel", "Praktisch", "Moreel"],
        answer: 0,
        wrongHints: [null, "Klopt — bron met gezag.", "Geen emotie.", "Niet praktisch.", "Niet over goed/fout."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Wel verschil.", "Niet primair.", "Niet primair."],
      },
      {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Wel verschil.", "Niet primair.", "Niet — betoog is feitelijk."],
      },
      {
        q: "*'Ik liep door de straat'* = welk perspectief?",
        options: ["Ik-perspectief", "Hij/zij-perspectief", "Alwetend", "Geen"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet — gebruikt ik.", "Niet — alleen 1 persoon.", "Wel iets — ik-vorm."],
      },
      {
        q: "Welke tijd vooral bij **verslagen**?",
        options: ["Verleden tijd", "Tegenwoordige", "Toekomst", "Voorwaardelijk"],
        answer: 0,
        wrongHints: [null, "Klopt — wat is gebeurd.", "Soms, voor levendigheid.", "Bijna nooit.", "Geen tijd-categorie."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — letterlijke vertaling.", "Andere betekenis.", "Niet alleen plaatjes.", "Niet bedoeld."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — derde persoon.", "Mist t.", "Wel verschil.", "Plural fout."],
      },
      {
        q: "**Groter dan ik** of **groter als ik**?",
        options: ["Groter dan ik (vergelijken)", "Groter als ik", "Beide goed", "Geen van beide"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Informeel/fout.", "Standaard taal: 'dan'.", "Wel — 'dan'."],
      },
      {
        q: "Verschil **liggen** en **leggen**?",
        options: ["Liggen = positie, leggen = actie", "Geen verschil", "Beide goed", "Liggen voor mensen"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Wel verschil.", "Niet uitwisselbaar.", "Niet."],
      },
      {
        q: "**Sinds** of **vanaf** 2020?",
        options: ["Sinds (begin tot nu)", "Vanaf", "Beide", "Geen verschil"],
        answer: 0,
        wrongHints: [null, "Klopt — vanaf 2020 tot nu.", "Vanaf is voor losse start-moment.", "Klein verschil.", "Wel verschil."],
      },
    ],
  },
  ...
  // STAP 6: Eind-toets
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Eerste argument.", "Tegenstelling.", "Voorbeeld."],
      },
      {
        q: "**Plagiat** in samenvatting = wat?",
        options: ["Letterlijk overnemen", "Eigen woorden", "Korter maken", "Synoniemen"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenovergesteld.", "Wel doel.", "Goed — synonyms."],
      },
      {
        q: "**Ik fietste** of **ik fietsde**?",
        options: ["Ik fietste ('t kofschip)", "Ik fietsde", "Beide", "Ik fiets"],
        answer: 0,
        wrongHints: [null, "Klopt — stam op 's' → -te.", "Verkeerde uitgang.", "1 is fout.", "Tegenwoordige tijd."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 1 personage centraal.", "Niet 'ik'.", "Geen meerdere personages-inzicht.", "Wel iets."],
      },
    ],
  },
];
