  ...
  // STAP 1: Nederland en water
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Geen plaatsnaam.", "Geen rivier.", "Geen dijk-soort."],
      },
      {
        q: "Welke **rivier** loopt door Nederland?",
        options: ["Rijn", "Theems", "Donau", "Nijl"],
        answer: 0,
        wrongHints: [null, "Klopt — komt uit Duitsland, gaat naar Noordzee.", "Theems is in Engeland.", "Donau in Midden-Europa.", "Nijl in Egypte."],
      },
      {
        q: "Wat is het **IJsselmeer** vroeger geweest?",
        options: ["Een zee (de Zuiderzee)", "Een berg", "Een woestijn", "Een rivier"],
        answer: 0,
        wrongHints: [null, "Klopt — afgesloten in 1932.", "Nederland heeft geen bergen.", "Geen woestijnen.", "Geen rivier."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet altijd — variabel.", "Andersom.", "Wel verschil."],
      },
      {
        q: "Hoe lang is de **Afsluitdijk**?",
        options: ["~32 km", "~5 km", "~100 km", "~10 km"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Veel langer.", "Te lang.", "Te kort."],
      },
      {
        q: "Wat is een **waterschap**?",
        options: ["Overheid speciaal voor water", "Een rivier", "Een soort dijk", "Een waterpark"],
        answer: 0,
        wrongHints: [null, "Klopt — onderhoudt dijken + waterstand.", "Geen rivier.", "Geen dijk.", "Geen pretpark."],
      },
      {
        q: "Welke is een beroemde **stormvloedkering**?",
        options: ["Maeslantkering", "Oosterdijk", "Rijnsluis", "Veluwedijk"],
        answer: 0,
        wrongHints: [null, "Klopt — bij Rotterdam.", "Geen specifieke kering.", "Geen stormvloedkering.", "Geen kering."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Andersom — polder is geen meer.", "Geen bos.", "Geen berg."],
      },
      {
        q: "Welke is een **drooggemaakte polder**?",
        options: ["Flevoland", "Drenthe", "Noord-Brabant", "Limburg"],
        answer: 0,
        wrongHints: [null, "Klopt — drooggelegd in 1957-1968.", "Niet drooggemaakt — oude grond.", "Niet drooggemaakt.", "Niet drooggemaakt."],
      },
      {
        q: "Welke vroegere zee is **drooggemalen tot Flevoland**?",
        options: ["Zuiderzee", "Noordzee", "Waddenzee", "Oosterschelde"],
        answer: 0,
        wrongHints: [null, "Klopt — afgesloten 1932, deels drooggemalen tot Flevoland.", "Noordzee is nog steeds zee.", "Wadden is nog zee.", "Oosterschelde nog water."],
      },
      {
        q: "Wat doet een **poldermolen**?",
        options: ["Pompt water uit polder", "Maalt graan", "Maakt elektriciteit", "Pompt drinkwater"],
        answer: 0,
        wrongHints: [null, "Klopt — vroeger op windkracht, nu met elektriciteit.", "Dat is korenmolen.", "Moderne windturbines doen dat, niet poldermolens.", "Niet drinkwater."],
      },
    ],
  },
  ...
  // STAP 4: Watersnoodramp 1953
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — zuidwesten van Nederland.", "Boven Nederland — niet getroffen.", "Oosten — niet de hardste klap.", "Niet hardst."],
      },
      {
        q: "Hoeveel **doden** waren er ongeveer?",
        options: ["~1.836", "~100", "~10.000", "~500"],
        answer: 0,
        wrongHints: [null, "Klopt — tussen 1800 en 1900 doden.", "Veel te weinig.", "Te veel.", "Te weinig."],
      },
      {
        q: "Wat was de **reactie** op de ramp?",
        options: ["Deltawerken bouwen", "Niets doen", "Mensen verhuizen", "Land opgeven"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Wél iets gedaan — heel veel zelfs.", "Niet de hoofdreactie.", "Land werd juist beschermd."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is Afsluitdijk-klaar.", "Te laat.", "Te laat."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet helemaal dicht — dan zou het milieu sterven.", "Niet onder water.", "Geen 100 deuren."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Veel te kort.", "Te lang.", "Te kort."],
      },
    ],
  },
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — provincie sinds 1986.", "Oude provincie.", "Oude provincie.", "Oude provincie."],
      },
      {
        q: "In welk jaar was de **Watersnoodramp**?",
        options: ["1953", "1832", "1953 én 1932", "1900"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Te lang geleden.", "Twee jaren — alleen 1953 = ramp.", "Niet."],
      },
      {
        q: "Welke kering is **bij Rotterdam**?",
        options: ["Maeslantkering", "Oosterscheldekering", "Brouwersdam", "Veerse Gatdam"],
        answer: 0,
        wrongHints: [null, "Klopt — Hoek van Holland.", "Zeeland.", "Brouwershavense Gat.", "Veerse Gat."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — beide soorten bestonden.", "Moderne windturbines wel, niet vroeger.", "Schepen hebben zeilen, geen molens.", "Wel gebruikt."],
      },
      {
        q: "Welke is een **gemaal**?",
        options: ["Pomp die water uit polder weghaalt", "Een korenmolen", "Een stormvloedkering", "Een brug"],
        answer: 0,
        wrongHints: [null, "Klopt — elektrisch tegenwoordig.", "Geen korenmolen.", "Geen kering — een pomp.", "Geen brug."],
      },
      { q: "**Deltawerken** beschermen NL tegen?", options: ["Overstroming (stormvloed)","Aardbeving","Tornado","Lawine"], answer: 0, wrongHints: [null,"Klopt — Zeeland.","Niet relevant.","Niet relevant.","Niet relevant."] },
      { q: "Een **polder** is?", options: ["Drooggelegd land beneden zeeniveau","Een rivier","Een stad","Een dijk"], answer: 0, wrongHints: [null,"Klopt — water weggepompt.","Niet.","Niet — landgebied.","Beschermt polder."] },
      { q: "Wat is de **Afsluitdijk**?", options: ["Dijk Friesland↔Noord-Holland (sloot Zuiderzee af)","Een molen","Een gemaal","Een spoorbrug"], answer: 0, wrongHints: [null,"Klopt — 1932.","Niet.","Niet primair.","Niet."] },
      { q: "Welk **percentage** van NL ligt onder zee-niveau?", options: ["Ongeveer 25%","60%","5%","90%"], answer: 0, wrongHints: [null,"Klopt — vooral west.","Te veel.","Te weinig.","Veel te veel."] },
      { q: "Wat is een **terp**?", options: ["Kunstmatige verhoging — woonplek bij hoog water","Een molen","Een dijk","Een sloot"], answer: 0, wrongHints: [null,"Klopt — Friesland/Groningen.","Niet.","Niet — bescherming buiten.","Niet."] },
      { q: "Welk **werelderfgoed** in NL beschermt water-cultuur?", options: ["Kinderdijk-molens","Pyramide","Acropolis","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — Zuid-Holland.","Egypte.","Griekenland.","Wel."] },
      { q: "Wie was **Jan Leeghwater**?", options: ["Beroemde polder-maker (~1600)","Een koning","Een dijkbreker","Een sportman"], answer: 0, wrongHints: [null,"Klopt — Schermer, Beemster.","Niet.","Tegenovergesteld.","Niet."] },
      { q: "Wat is **windmolen** versus **windturbine**?", options: ["Molen = oud (graan/pompen); turbine = elektriciteit","Hetzelfde","Andere taal","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Wel verschil.","Niet.","Wel."] },
      { q: "**Beemster** ligt in welke provincie?", options: ["Noord-Holland","Zeeland","Friesland","Limburg"], answer: 0, wrongHints: [null,"Klopt — drooggemaakt 1612.","Andere drooglegging.","Niet droog gemaakt.","Niet."] },
      { q: "Wat doet een **stuw** in een rivier?", options: ["Waterhoogte regelen","Water weghalen","Niet gebruikt","Verkeer doorlaten"], answer: 0, wrongHints: [null,"Klopt — peil reguleren.","Dat is gemaal.","Wel.","Niet primair."] },
      { q: "Welke beroemde **molen-stad** ligt in NL?", options: ["Zaanse Schans (Zaandam)","Eiffel","Pisa","Geen"], answer: 0, wrongHints: [null,"Klopt — historische molens.","Frankrijk.","Italië.","Wel."] },
      { q: "Wat doet de **Maeslantkering** in Hoek van Holland?", options: ["Sluit bij stormvloed automatisch","Spoorbrug","Gemaal","Niets"], answer: 0, wrongHints: [null,"Klopt — beschermt Rotterdam.","Niet.","Andere functie.","Wel iets."] },
      { q: "Beroemd **deltagebied** in NL?", options: ["Zeeland (Schelde, Maas, Rijn)","Friesland","Drenthe","Limburg"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Geen delta."] },
      { q: "Wat zou er gebeuren ZONDER dijken in NL?", options: ["Groot deel ondergelopen","Niets","Droogte","Hetzelfde"], answer: 0, wrongHints: [null,"Klopt — onder zeeniveau.","Wel.","Tegengestelde.","Wel verschil."] },
    ],
  },
];
