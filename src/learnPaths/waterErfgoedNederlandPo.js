    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "~25% (kwart).",
            simpeler: "Ongeveer 1 op de 4 m² van NL ligt onder zeeniveau = 25%.",
            nogSimpeler: "25%",
          },
        },
      },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Afsluitdijk (= 1932, niet Deltawerk).",
            simpeler: "Afsluitdijk = 1932 = noord. Deltawerken = 1958-1997 = zuid. Anders.",
