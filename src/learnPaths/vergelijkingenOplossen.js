    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Twee uitdrukkingen + =. A.", simpeler: "Vergelijking heeft =-teken.", nogSimpeler: "=" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "13. A.", simpeler: "x−5=8 → x=8+5=13.", nogSimpeler: "13" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "÷8. A.", simpeler: "8x → ÷8 → x alleen.", nogSimpeler: "÷8" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7. A.", simpeler: "x+8=15 → x=15−8=7.", nogSimpeler: "7" },
        },
      },
      {
        q: "*Los op: x + 12 = 5.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "−7. A.", simpeler: "x+12=5 → x=5−12=−7.", nogSimpeler: "−7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6. A.", simpeler: "7x=42 → x=42÷7=6.", nogSimpeler: "6" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "54. A.", simpeler: "x/6=9 → x=9·6=54.", nogSimpeler: "54" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4. A.", simpeler: "4x=16 → x=4.", nogSimpeler: "4" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Haakjes openen. A.", simpeler: "Stap 1 bij haakjes-vergelijking = haakjes openen.", nogSimpeler: "Haakjes" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3. A.", simpeler: "3x+12=21 → 3x=9 → x=3.", nogSimpeler: "3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "40. A.", simpeler: "x/5=8 → x=8·5=40.", nogSimpeler: "40" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x−7=12. A.", simpeler: "Trek 7 vanaf x → x−7. Resultaat 12 → =12.", nogSimpeler: "x−7=12" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5. A.", simpeler: "3x−4=11 → 3x=15 → x=5.", nogSimpeler: "5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7. A.", simpeler: "3x=21 → x=7.", nogSimpeler: "7" },
        },
      },
      {
        q: "*Los op: 4x + 7 = 2x + 13.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3. A.", simpeler: "2x=6 → x=3.", nogSimpeler: "3" },
        },
      },
      {
        q: "*Los op: 2(x − 3) = 8.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7. A.", simpeler: "2x−6=8 → 2x=14 → x=7.", nogSimpeler: "7" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7. A.", simpeler: "2x+6=20 → 2x=14 → x=7.", nogSimpeler: "7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4. A.", simpeler: "3x=12 → x=4.", nogSimpeler: "4" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "24. A.", simpeler: "×6: 2x+30=3x+6 → x=24.", nogSimpeler: "24" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5 uur. A.", simpeler: "65=25+8u → 8u=40 → u=5.", nogSimpeler: "5" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4. A.", simpeler: "2x=8 → x=4.", nogSimpeler: "4" },
        },
      },
