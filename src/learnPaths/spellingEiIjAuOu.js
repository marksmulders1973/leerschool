    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hetzelfde klinken, anders schrijven. A.", simpeler: "Homofoon = twee woorden die identiek klinken maar verschillend geschreven worden.", nogSimpeler: "Klinkt zelfde" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ja, identiek. A.", simpeler: "Spreek hardop: r-ei-s en r-ij-st. Geen verschil in klank.", nogSimpeler: "Identiek" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "trein = ei. A.", simpeler: "Trein hoort bij klein/plein/rein — allemaal met ei (korte ei).", nogSimpeler: "Ei" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "klein = ei. A.", simpeler: "Klein = ei (korte ei). Net als plein, trein, rein. 'Klijn' is geen woord.", nogSimpeler: "Ei" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "plein = ei. A.", simpeler: "Plein staat in ei-groep met klein/trein/rein. Allemaal ei.", nogSimpeler: "Ei" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "wij = ij. A.", simpeler: "Voornaamwoorden zoals wij/jij/hij/mij hebben altijd ij. Wei en wijn zijn andere woorden.", nogSimpeler: "Voornaamwoord = ij" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "rijst (eten) = ij. A.", simpeler: "Witte korreltjes = rijst met ij. Reist met ei = werkwoord (op reis gaan).", nogSimpeler: "Ij" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "tijd = ij. A.", simpeler: "Tijd hoort in -tijd-groep: altijd, vrijetijd, werktijd. Allemaal met ij.", nogSimpeler: "Ij" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "altijd = ij. A.", simpeler: "Altijd = al + tijd. Tijd heeft ij, dus altijd ook.", nogSimpeler: "Ij" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "prijs = ij. A.", simpeler: "Prijs (kosten) heeft ij. Komt vaak met -ij in handelswoorden voor.", nogSimpeler: "Ij" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "klein = ei. A.", simpeler: "Klein heeft ei. Andere opties zijn geen Nederlandse woorden.", nogSimpeler: "Ei" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "auto = au. A.", simpeler: "Auto begint met au (zoals augustus, augurk). Niet ou.", nogSimpeler: "Au" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "augustus = au. A.", simpeler: "Augustus (keizer) heeft au-begin. Niet 'ougustus'.", nogSimpeler: "Au" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "flauw = au. A.", simpeler: "Flauw hoort bij blauw/gauw/rauw — allemaal -auw met au.", nogSimpeler: "Au" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "goud = ou. A.", simpeler: "Goud hoort bij oud/koud/zout — allemaal -oud met ou.", nogSimpeler: "Ou" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "jouw boek (bezittelijk). A.", simpeler: "'Jouw boek' = boek van jou = bezittelijk = jouw met w. Niet 'jou'.", nogSimpeler: "Jouw + w" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "mouw = ou. A.", simpeler: "Mouw (van trui/jas) heeft ou. Hoort bij vrouw/jouw/bouwen — allemaal -ouw.", nogSimpeler: "Ou" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "koud = ou. A.", simpeler: "Koud = ou. Hoort bij oud/goud/zout. Geen extra t (geen werkwoord).", nogSimpeler: "Ou" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hij rijdt. A.", simpeler: "Werkwoord rijden → stam rijd → hij rijdt (stam + t). Klinkt hetzelfde maar schrijven met t.", nogSimpeler: "Rijdt" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Nou = ou. A.", simpeler: "Informele 'nu' = nou (met ou). Niet nau, niet now.", nogSimpeler: "Nou" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "trein = ei. A.", simpeler: "Trein = ei (zoals klein, plein, rein). Geen extra t.", nogSimpeler: "Ei" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "vrouw = ou. A.", simpeler: "Vrouw = ou. Hoort bij mouw/jouw/bouwen — allemaal -ouw. V aan begin.", nogSimpeler: "Ou" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "gouden = ou. A.", simpeler: "Goud (zelfst nw) → gouden (bijv nw) = ou-stam. Niet 'gauden', niet 'golden'.", nogSimpeler: "Ou" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "rijst (eten) = ij. A.", simpeler: "Witte korreltjes = rijst met ij. Niet reist (= van reizen).", nogSimpeler: "Ij" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "koud = ou. A.", simpeler: "Koud = ou (oud-rijtje). Geen 'kaud', geen extra t.", nogSimpeler: "Ou" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Jij = ij. A.", simpeler: "Voornaamwoord 2e persoon = jij met ij. Allerlei voornaamwoorden hebben ij.", nogSimpeler: "Jij" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "augustus = au. A.", simpeler: "Maand 8 = augustus (au-begin, -us einde). Niet ougustus, niet august.", nogSimpeler: "Au" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "auto = au. A.", simpeler: "Auto met au (zoals augustus). 4 letters. Geen extra t.", nogSimpeler: "Au" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "vrouw = ou. A.", simpeler: "Vrouw = ou (zoals mouw/jouw). V niet F. Geen extra t.", nogSimpeler: "Ou" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "met jou. A.", simpeler: "'Hoe gaat het met jou' = lijdend voorwerp na 'met' = jou (zonder w). Jij is onderwerp, jouw bezittelijk.", nogSimpeler: "Jou" },
        },
      },
      { q: "Schrijf juist: 'De k___ wint.'", options: ["kei","kij","kij(?)","key"], answer: 0, wrongHints: [null, "Niet — geen voornaamwoord.", "Niet.", "Engels."] },
      { q: "Schrijf juist: 'Ik woon b___ jou.'", options: ["bij","bei","bij(?)","by"], answer: 0, wrongHints: [null, "Niet — geen 'ei'-woord.", "Niet.", "Engels."] },
      { q: "Schrijf juist: 'Een d___ in de pan.'", options: ["ei","ij","ey","ai"], answer: 0, wrongHints: [null, "Niet — geen voornaamwoord.", "Engels.", "Niet."] },
      { q: "Schrijf juist: 'Het brood is g___d.'", options: ["ou","au","aw","ow"], answer: 0, wrongHints: [null, "Niet — geen 'au'-woord.", "Engels.", "Engels."] },
