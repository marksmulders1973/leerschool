    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hetzelfde klinken, anders schrijven.", simpeler: "Homofoon = twee woorden die identiek klinken maar verschillend geschreven worden.", nogSimpeler: "Klinkt zelfde" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ja, identiek.", simpeler: "Spreek hardop: r-ei-s en r-ij-st. Geen verschil in klank.", nogSimpeler: "Identiek" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "tijd = ij.", simpeler: "Tijd hoort in -tijd-groep: altijd, vrijetijd, werktijd. Allemaal met ij.", nogSimpeler: "Ij" },
        },
      },
    ],
  },
