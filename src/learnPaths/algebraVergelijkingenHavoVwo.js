    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6x−15.", simpeler: "3 maal elk: 6x en −15.", nogSimpeler: "6x−15" },
        },
      },
      {
        q: "**(x + 4)²** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x²+8x+16.", simpeler: "Drie termen: x², 8x, 16.", nogSimpeler: "x²+8x+16" },
        },
      },
      {
        q: "Factoriseer: **x² − 36** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(x−6)(x+6).", simpeler: "a²−b² = (a−b)(a+b).", nogSimpeler: "(x±6)" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x+3.", simpeler: "Boven factor weg.", nogSimpeler: "x+3" },
        },
      },
      {
        q: "**√50** vereenvoudig:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5√2.", simpeler: "√25·√2 = 5√2.", nogSimpeler: "5√2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=6.", simpeler: "12/2=6.", nogSimpeler: "6" },
        },
      },
      {
        q: "Los op: **3(x − 4) = 2x + 5**.",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=17.", simpeler: "Verplaats x naar links: x=17.", nogSimpeler: "17" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "b=5.", simpeler: "4b+10=30 → b=5.", nogSimpeler: "5" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen oplossing.", simpeler: "0=3 = vals.", nogSimpeler: "Geen" },
        },
      },
      {
        q: "Los op: **(x + 3)/2 = 5**.",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=7.", simpeler: "10−3=7.", nogSimpeler: "7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=3 of x=4.", simpeler: "(x−3)(x−4)=0.", nogSimpeler: "3,4" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "D=12.", simpeler: "16−4=12.", nogSimpeler: "12" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "D=−16.", simpeler: "Negatief D = geen oplossing.", nogSimpeler: "−16" },
        },
      },
      {
        q: "Los op: **x² = 49**.",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "±7.", simpeler: "x=7 of x=−7.", nogSimpeler: "±7" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=2,5 of −1.", simpeler: "Twee oplossingen via ABC.", nogSimpeler: "2,5/−1" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x=7.", simpeler: "Optel beide: 2x=14, x=7.", nogSimpeler: "7" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "a=€2.", simpeler: "Eliminatie geeft a=2.", nogSimpeler: "€2" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oneindig.", simpeler: "Beide zelfde lijn = ∞.", nogSimpeler: "∞" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x>4.", simpeler: "Verplaats + delen.", nogSimpeler: "x>4" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x≤−3.", simpeler: "Negatief delen = teken omkeren.", nogSimpeler: "x≤−3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "g ≤ 200.", simpeler: "30÷0,15=200.", nogSimpeler: "200" },
        },
      },
      {
        q: "**x² − 4 > 0**. Oplossing?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x<−2 of x>2.", simpeler: "Buiten −2 en 2.", nogSimpeler: "|x|>2" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "a>1.", simpeler: "D<0 vereist a>1.", nogSimpeler: "a>1" },
        },
      },
    ],
  },
