    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc: voor kans-statistiek-vragen — onthoud Nederlandse gemiddelden. Meerling 1%. Tweeling alleen 1,2%. IVF verhoogt naar ~10%.",
          ...
          niveaus: { basis: "1%.", simpeler: "Meerling-kans in NL = ~1%.", nogSimpeler: "1%" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc volgorde: I-O-U-N = Indaling-Ontsluiting-Uitdrijving-Nageboorte. Placenta hoort altijd bij de laatste fase.",
          ...
          niveaus: { basis: "Nageboorte.", simpeler: "I-O-U-N: indaling → ontsluiting → uitdrijving (baby) → nageboorte (placenta).", nogSimpeler: "Nageboorte" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc hersendelen: B-B-H = **Bewust** (grote hersenen), **Balans** (kleine hersenen), **Hartslag** (hersenstam). Match het werkwoord aan het hersendeel.",
          ...
          niveaus: { basis: "Grote hersenen.", simpeler: "Bewust waarnemen = grote hersenen (cerebrum).", nogSimpeler: "Grote hersenen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc gal-vraag: 3 feiten onthouden — gal maakt = LEVER. Gal opslag = GALBLAAS. Gal werkt = EMULGEREN vetten (geen enzym).",
          voorbeelden: [
          ...
          niveaus: { basis: "Emulgeert vetten.", simpeler: "Gal splitst grote vetdruppels in kleintjes (zoals afwasmiddel).", nogSimpeler: "Emulgeert" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc anatomie-naam: Latijn = duidelijk. Vas deferens = 'transporterend vat'. Ureter = 'uretha' verschil = 1 letter, totaal andere organen.",
          voorbeelden: [
          ...
          niveaus: { basis: "Zaadleider → urinebuis.", simpeler: "Volgorde: zaadbal → bijbal → ZAADLEIDER → prostaat → URINEBUIS → uit penis.", nogSimpeler: "Z-U" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc: dier = consument (altijd). Plant/alg = producent. Kiezen volgen dieet: planten → plooi, vlees → knobbel.",
          voorbeelden: [
          ...
          niveaus: { basis: "Consument + plooikiezen.", simpeler: "Giraffe eet bladeren (= herbivoor) = consument + plooikiezen.", nogSimpeler: "B = consument plooikiezen." },
        },
      },
    ],
  },
