...
// Sluit op digitale-geletterdheid + media-wijsheid. Toets-burgerschap. 1F. 4 stappen.
...
const steps = [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet hetzelfde.", "Niet.", "Tegenovergesteld."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-feit: kritisch denken hoort bij **mediawijsheid** + **digitale geletterdheid**. Belangrijk voor school + later leven. Niet alles op TikTok klopt!",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet.", "Niet.", "Wel lezen + checken."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: {
            basis: "Checken bron + andere bronnen + waarom.",
            simpeler: "Bij info: vraag WIE, WAT, WANNEER, WAAROM, WAAR. Dan pas geloven.",
            nogSimpeler: "Checken!",
          },
        },
      },
      ...
      },
      {
        ...
        options: ["~67%", "10%", "100%", "0%"],
        answer: 0,
        wrongHints: [null, "Te weinig.", "Niet allemaal.", "Wel."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip kritisch denken: weet dat je BIAS hebt. Vraag bewust: 'wat is de andere kant? Wie spreekt mij tegen?' Lees ook bronnen die NIET met je eens zijn — dan denk je breder.",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip: sunk cost fallacy = niet alleen geld, ook TIJD + EMOTIE. Een relatie waar je 5 jaar in stak voelt 'te zonde om weg te gooien'. Maar dat is een denkfout — beoordeel op TOEKOMST, niet op verleden.",
          voorbeelden: [
          ...
          niveaus: {
            basis: "Sunk cost fallacy = doorgaan omdat je al investeerde (denkfout).",
            simpeler: "Saai boek uitlezen alleen omdat je al 100 bladzijden las = sunk cost fallacy.",
            nogSimpeler: "Doorgaan om verleden",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip: stereotypering is altijd PROBLEMATISCH. Behandel mensen individueel, niet als lid van groep. De toets en grondwet beschermen tegen discriminatie.",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit ad hominem: vaak gezien in politieke debatten + sociale media-ruzies. Mensen vallen elkaar persoonlijk aan ipv inhoudelijk te discussiëren. Aristoteles beschreef dit al in 4e eeuw v.Chr. als drogreden.",
          voorbeelden: [
          ...
          niveaus: {
            basis: "Ad hominem = aanval op persoon ipv argument.",
            simpeler: "In plaats van te reageren op WAT iemand zegt, ga je tegen WIE hij is. Drogreden.",
            nogSimpeler: "Persoon aanvallen",
          },
        },
      },
      {
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wat is **stereotypering** fout?", options: ["Oordeel over groep ipv individu", "Slim", "Mag wel", "Niet"], answer: 0, wrongHints: [null, "Niet.", "Geen excuus.", "Wel fout."] },
      { q: "Wie won **Nobelprijs voor denkfouten**?", options: ["Daniel Kahneman (2002)", "Einstein", "Darwin", "Aristoteles"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Vroeger maar geen Nobel."] },
      { q: "Wat is **cherry picking**?", options: ["Kies gunstige feiten, negeer res", "Fruit plukken", "Goed", "Niet bestaand"], answer: 0, wrongHints: [null, "Letterlijk niet.", "Tegenovergesteld.", "Wel."] },
      {
        q: "Wat is **fake news**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Nepnieuws.", simpeler: "Fake news = nieuws/info dat NIET klopt maar wel gedeeld wordt alsof het waar is. Komt vooral van social media. Check altijd 2 bronnen.", nogSimpeler: "Nepnieuws" },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Anekdote-fout — 1 voorbeeld bewijst niets over miljoenen mensen.", "Niet — gebruik kritisch denken, niet impuls.", "Niet nodig — leg uit wat anekdote-bewijs is."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: { basis: "1 verhaal is geen bewijs.", simpeler: "1 persoon (zoals opa) is een anekdote, geen wetenschappelijk bewijs. Echte conclusies komen uit onderzoek met veel mensen + statistiek.", nogSimpeler: "Anekdote ≠ bewijs" },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — pinguïns kunnen ECHT niet vliegen. Logica klopt, premisse niet.", "Pinguïns zijn WEL vogels (warmbloedig, eieren, veren).", "Vogels bestaan zeker wel."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: { basis: "Premisse 1 klopt niet.", simpeler: "De eerste zin ('alle vogels vliegen') is FOUT — pinguïns/struisvogels vliegen niet. Daarom klopt de conclusie ook niet, ondanks goede logica.", nogSimpeler: "Premisse fout" },
        },
      },
      { q: "Wat is **bevestigingsbias**?", options: ["Alleen info zoeken die jouw mening bevestigt","Alle info opnemen","Je mening direct veranderen","Twijfelen over alles"], answer: 0, wrongHints: [null, "Tegenovergesteld.", "Niet — vasthouden, niet veranderen.", "Niet relevant."] },
      ...
      { q: "Wat is **correlatie ≠ causatie**?", options: ["Twee dingen samen ≠ een veroorzaakt ander","Hetzelfde","Niet relevant","Reclame"], answer: 0, wrongHints: [null, "Wel verschil.", "Wel.", "Niet."] },
      ...
      { q: "**Cirkelredenering**: 'A omdat A, en A omdat A.' Drogreden?", options: ["Ja — bewijs zichzelf","Geen drogreden","Logisch","Niet relevant"], answer: 0, wrongHints: [null, "Wel.", "Niet.", "Wel."] },
      ...
      { q: "Hoe leer je **kritisch denken**?", options: ["Vragen stellen + bronnen checken","Stoppen met denken","Wel reclame","Niet relevant"], answer: 0, wrongHints: [null, "Tegengestelde.", "Niet.", "Wel."] },
    ],
  },
];
...
const kritischDenkenPo = {
  ...
  title: "Kritisch denken + denkfouten (Doorstroomtoets groep 6-8)",
  emoji: "🤔",
  level: "groep6-8",
  ...
  intro:
    "Kritisch denken voor Doorstroomtoets groep 6-8 — wat is kritisch denken (5 W's + niet alles geloven) + 10 denkfouten (bevestigingsbias/anker/groepsdruk/halo/sunk cost - Daniel Kahneman) + 10 drogredenen (ad hominem/stroman/vals dilemma/cherry picking - Aristoteles). Sluit op digitale-geletterdheid. ~15 min.",
  triggerKeywords: [
    "kritisch denken",
    "denkfout", "bias",
