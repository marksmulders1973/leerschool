...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wat is **groepsdruk**?", options: ["Druk vanuit groep om mee te doen","Persoonlijke keuze","Eenzaamheid","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — sociale invloed.","Tegengestelde.","Tegengestelde.","Wel."] },
      { q: "Wat is **logisch redeneren**?", options: ["Stap voor stap denken zonder fouten","Aannemen zonder check","Random","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Tegengestelde.","Wel."] },
      { q: "*'Iedereen vindt dit, dus het klopt.'* — denkfout?", options: ["Argument van populariteit","Logica","Geen denkfout","Bevestigingsbias"], answer: 0, wrongHints: [null,"Klopt — meerderheid ≠ waarheid.","Niet logisch.","Wel.","Andere denkfout."] },
      { q: "*'Vroeger was alles beter.'* — denkfout?", options: ["Nostalgie-bias","Logica","Wetenschap","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — onderzoek toont vaak tegendeel.","Niet logisch.","Niet bewezen.","Wel."] },
      { q: "*'Hij maakte een fout, dus alles wat hij zegt klopt niet.'* — denkfout?", options: ["Ad hominem / generalisatie","Wel logica","Niet bestaand","Bevestigingsbias"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Wel.","Andere denkfout."] },
      { q: "Wat is **correlatie ≠ causatie**?", options: ["Twee dingen samen ≠ een veroorzaakt ander","Hetzelfde","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — vaak fout interpreteren.","Wel verschil.","Wel.","Niet."] },
      { q: "Wat is **objectief** versus **subjectief**?", options: ["Objectief = feiten; subjectief = mening","Hetzelfde","Andersom","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Wel verschil.","Niet andersom.","Wel."] },
      { q: "Wat doe je bij een **claim** zonder bewijs?", options: ["Bronnen vragen","Geloven","Volg de meerderheid","Negeren"], answer: 0, wrongHints: [null,"Klopt — kritisch denken.","Niet.","Niet logisch.","Niet primair."] },
      { q: "Wat is een **drogreden**?", options: ["Argument dat lijkt te kloppen maar logisch fout is","Bewezen feit","Vraag","Reclame"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Niet.","Wel."] },
      { q: "**Vals dilemma**: 'Je bent voor of tegen ons.' Drogreden?", options: ["Ja — er zijn meer opties","Geen drogreden","Logisch","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — beperkt opties.","Wel.","Niet.","Wel."] },
      { q: "**Cirkelredenering**: 'A omdat A, en A omdat A.' Drogreden?", options: ["Ja — bewijs zichzelf","Geen drogreden","Logisch","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Wel.","Niet.","Wel."] },
      { q: "Wat is een **goed argument**?", options: ["Standpunt + bewijs/redenering","Alleen mening","Aanval op persoon","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Te dun.","Drogreden.","Wel."] },
      { q: "**Wat zou je doen** bij twijfelachtig nieuws?", options: ["Verifiëren met andere bron","Direct delen","Negeren","Geloven"], answer: 0, wrongHints: [null,"Klopt — fact-check.","Verspreidt nep.","Niet.","Niet."] },
      { q: "Wat is een **autoriteits-drogreden**?", options: ["Beroep op gezag zonder bewijs","Wetenschap citeren","Logica","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — 'experts zeggen' zonder check.","Wel goed.","Niet.","Wel."] },
      { q: "Hoe leer je **kritisch denken**?", options: ["Vragen stellen + bronnen checken","Stoppen met denken","Wel reclame","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — oefenen.","Tegengestelde.","Niet.","Wel."] },
    ],
  },
];
