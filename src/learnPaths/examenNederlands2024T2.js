...
const compact = (kern, niveaus, woorden = []) => ({
  ...
  woorden,
  theorie:
    "De toets leesvaardigheid: 4 doel-typen (informeren/overtuigen/amuseren/activeren). Onderwerp-introductie ≠ centraal probleem ≠ aanleiding. Advertentie = bijna altijd activeren. Interview = bijna altijd informeren. Doelgroep = de IDENTITEIT die wordt aangesproken.",
  voorbeelden: [],
  basiskennis: [],
  niveaus,
});
...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 1-2 schetsen het Flitsmeister-kantoor + het bedrijf — letterlijk het onderwerp 'wat IS Flitsmeister' wordt geïntroduceerd. Geen probleem, geen aanleiding, geen voorbeelden — gewoon onderwerps-introductie.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "'Beugel/bitje voor kind' + 'wat jouw kind nodig heeft' = de advertentie spreekt OUDERS/VERZORGERS aan die voor hun KIND een zorgverzekering kiezen. Niet de kinderen zelf (kunnen niet kopen), niet algemene zorgverzekerings-zoekers (te breed).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Advertentie = activeren. Specifiek: 'Sluit eenvoudig en snel af via Independer.nl' — de oproep is om VIA INDEPENDER te kiezen, niet om een specifieke verzekering.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Tekst legt 3 generaties vegan leer uit (plastic → biobased), met voor- en nadelen. Geen mening 'koop dit'. = informeren. Specifiek: ONTWIKKELING door de tijd.",
