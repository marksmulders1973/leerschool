...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "**Industriële Revolutie** begon in welk land?", options: ["Engeland","NL","Frankrijk","Duitsland"], answer: 0, wrongHints: [null,"Klopt — ~1750.","Veel later.","Later.","Later."] },
      { q: "Wat is **urbanisatie**?", options: ["Mensen verhuizen platteland → stad","Andersom","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — fabrieken trokken volk.","Tegengestelde.","Wel.","Niet."] },
      { q: "Wat doet een **spoorweg**?", options: ["Treinen + goederen verplaatsen","Wegen onderhouden","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — kern industrieel.","Niet primair.","Wel.","Niet."] },
      { q: "Eerste NL-spoorlijn was?", options: ["Amsterdam-Haarlem (1839)","Den Haag-Rotterdam","Niet bekend","2000"], answer: 0, wrongHints: [null,"Klopt — eerste.","Andere route.","Wel bekend.","Veel later."] },
      { q: "Wat zijn **vakbonden**?", options: ["Organisaties voor werknemers-rechten","Werkgevers","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — onstaan door industrie.","Andere kant.","Wel.","Niet."] },
      { q: "**Twentse textiel** was vroeg NL-industrie in?", options: ["Enschede / Almelo","Amsterdam","Rotterdam","Niet bekend"], answer: 0, wrongHints: [null,"Klopt — bekend cluster.","Niet primair.","Niet.","Wel."] },
      { q: "Welke energiebron werd dominant in Industriële Revolutie?", options: ["Steenkool","Wind","Zon","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — stoommachine.","Eerder.","Later.","Wel."] },
      { q: "Wat is **kolonisatie** in deze tijd?", options: ["Andere landen onder controle nemen voor grondstoffen","Vrede","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Wel.","Niet."] },
      { q: "**Karl Marx** schreef over?", options: ["Arbeidersbeweging / kapitalisme","Astronomie","Sport","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — Manifest 1848.","Niet.","Niet.","Wel."] },
      { q: "Welk transport-uitvinding kwam in Industriële Revolutie?", options: ["Stoomtrein + stoomschip","Auto met benzine","Vliegtuig","Internet"], answer: 0, wrongHints: [null,"Klopt.","Later.","Veel later.","Veel later."] },
      { q: "Wat zijn **slechte gevolgen** Industriële Revolutie?", options: ["Vervuiling + lange werkdagen","Niet bestaand","Te veel vrije tijd","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Wel.","Tegengestelde.","Niet."] },
      { q: "Wat zijn **goede gevolgen**?", options: ["Betere voeding, kleding goedkoper, vooruitgang","Niets","Te veel oorlog","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Wel goede.","Niet hoofdgevolg.","Wel."] },
      { q: "Wanneer kwam **NL-industrialisering**?", options: ["~1850-1900","1500","2000","Voor jaar 1"], answer: 0, wrongHints: [null,"Klopt — laat.","Te vroeg.","Te laat.","Onmogelijk."] },
      { q: "Wat is **massa-productie**?", options: ["Veel producten snel maken met machines","1 product","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt — fabrieken.","Tegengestelde.","Wel.","Niet."] },
    ],
  },
];
