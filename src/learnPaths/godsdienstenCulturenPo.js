...
const steps = [
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "2e plek.", "4e plek.", "3e plek."],
      },
      {
        q: "Wat is **atheïst**?",
        options: ["Gelooft niet in God", "Christen", "Boeddhist", "Niet bekend"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet.", "Wel religie.", "Wel."],
      },
      {
        q: "Percentage NL **zonder religie**?",
        options: ["~55%", "1%", "100%", "20%"],
        answer: 0,
        wrongHints: [null, "Klopt — meeste niet-religieus.", "Veel meer.", "Niet.", "Veel meer."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        options: ["5", "10", "3", "1"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Te veel.", "Te weinig.", "Te weinig."],
      },
      {
        q: "Welke is de **oudste** Abrahamitische godsdienst?",
        options: ["Jodendom", "Christendom", "Islam", "Hindoeisme"],
        answer: 0,
        wrongHints: [null, "Klopt — >3000 jr.", "2000 jr.", "1400 jr.", "Niet Abrahamitisch."],
      },
      {
        q: "**Vasten-maand** in islam?",
        options: ["Ramadan", "Pesach", "Pinksteren", "Kerst"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Joods.", "Christelijk.", "Christelijk."],
      },
      {
        q: "Wat is **kosjer**?",
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 'de verlichte'.", "Niet — geen God.", "Niet.", "Niet."],
      },
      {
        q: "Wat is **karma**?",
        options: ["Wat je doet komt terug", "Toeval", "Lijden", "Geld"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet.", "Wel related maar specifiek dit.", "Niet."],
      },
      {
        q: "**Diwali** is welk feest?",
        options: ["Hindoe lichtfeest", "Boeddhistisch", "Islam", "Joods"],
        answer: 0,
        wrongHints: [null, "Klopt — okt/nov.", "Niet.", "Niet.", "Niet."],
      },
      {
        q: "Wat is **nirvana** in boeddhisme?",
        options: ["Bevrijding uit lijden + reincarnatie", "Hemel", "Hel", "Niet bekend"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Geen hemel-concept.", "Geen hel.", "Wel."],
      },
    ],
  },
  {
    ...
    checks: [
      { q: "**Grootste** godsdienst wereldwijd?", options: ["Christendom (~2,4 mld)", "Islam", "Boeddhisme", "Hindoeisme"], answer: 0, wrongHints: [null, "Klopt.", "2e.", "4e.", "3e."] },
      { q: "Heilig boek **islam**?", options: ["Koran", "Bijbel", "Torah", "Vedas"], answer: 0, wrongHints: [null, "Klopt.", "Christen.", "Joods.", "Hindoe."] },
      { q: "Profeet **islam**?", options: ["Mohammed", "Jezus", "Boeddha", "Mozes"], answer: 0, wrongHints: [null, "Klopt.", "Christen.", "Boeddhist.", "Jood."] },
      { q: "**Heilige rivier** hindoes?", options: ["Ganges (India)", "Nijl", "Donau", "Jordaan"], answer: 0, wrongHints: [null, "Klopt.", "Egyptisch.", "Europees.", "Christen."] },
      { q: "**Vasten** in islam = ?", options: ["Ramadan", "Pesach", "Pasen", "Sabbat"], answer: 0, wrongHints: [null, "Klopt.", "Joods.", "Christen.", "Joods."] },
      { q: "Wat is **atheïst**?", options: ["Gelooft niet in God", "Christen", "Hindoe", "Niet bekend"], answer: 0, wrongHints: [null, "Klopt.", "Niet.", "Niet.", "Wel."] },
    ],
  },
];
