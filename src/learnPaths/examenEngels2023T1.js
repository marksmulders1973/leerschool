...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "Sleutel-zin: 'Planned signalling work will be postponed and start the following day.' Onderhoud is **uitgesteld** zodat rugby-fans kunnen reizen.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Sleutel-zin: 'create a national register of the UK's most outstanding trees — to celebrate them, monitor their health, and protect them from being cut down'. Doel: **lijst aanleggen + behouden**.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Sleutel-zin alinea 3: 'The Mini, weighing about 1,400 pounds, is comparable in weight to a real two-man bobsled — making it an ideal substitute training tool.' Mini = vergelijkbaar met echte bobslee = **comparable to the real thing**.",
      ...
      uitlegPad: compactUitleg(
        ...
        { basis: "Trainings-tool vergelijkbaar met echte ding.", simpeler: "Mini Cooper heeft zelfde gewicht als bobslee — perfect substituut.", nogSimpeler: "Comparable" },
      ),
    }],
  },
  {
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 1: 'They parachute out of planes to quickly reach fire sites that do not have roads — the only way in is from the air.' Smokejumpers gaan naar plaatsen die alleen vanuit de lucht bereikbaar zijn.",
      ...
      uitlegPad: compactUitleg(
        ...
        { basis: "Onbereikbare gebieden per lucht.", simpeler: "Smokejumpers springen waar geen wegen heen lopen — alleen vanuit de lucht.", nogSimpeler: "Only by air" },
      ),
    }],
  },
  {
