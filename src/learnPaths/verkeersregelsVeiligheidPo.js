    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: ook **handsfree** bellen op fiets via oortjes mag, maar oppassen — het mag NIET als je een telefoon vasthoudt. Smartwatch checken op pols = ook verboden.",
          voorbeelden: [
