...
const steps = [
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Rond.", "Punt onder.", "Wel."],
      },
      {
        q: "**Geel verkeerslicht** = ?",
        options: ["Voorzichtig — stoppen als kan", "Hard rijden", "Niets", "Hetzelfde als rood"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenovergesteld.", "Wel actie.", "Bijna maar specifiek dit."],
      },
      {
        q: "**Stop-bord** vorm?",
        options: ["8-hoekig (rood)", "Driehoek", "Rond", "Vierkant"],
        answer: 0,
        wrongHints: [null, "Klopt — uniek.", "Niet.", "Niet.", "Niet."],
      },
    ],
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet.", "Wel.", "Speed-pedelec wel."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Te hoog.", "Wel grens.", "Voor jongeren onder 18 wel."],
      },
    ],
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Gevaarlijk.", "Niet.", "Niet."],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    checks: [
      { q: "**Rood rond met witte streep** = ?", options: ["Verbod", "Gebod", "Waarschuwing", "Info"], answer: 0, wrongHints: [null, "Klopt.", "Blauw.", "Driehoek.", "Vierkant."] },
      { q: "**Rotonde** voorrang?", options: ["Verkeer op rotonde", "Invoegers", "Geen", "Rechtdoor"], answer: 0, wrongHints: [null, "Klopt.", "Niet.", "Wel.", "Niet."] },
      { q: "**Mobiel op fiets** boete?", options: ["€160 (sinds 2019)", "Geen", "€10", "€1000"], answer: 0, wrongHints: [null, "Klopt.", "Wel.", "Te weinig.", "Te veel."] },
      ...
      { q: "**Maximum snelheid** binnen bebouwde kom (NL)?", options: ["50 km/u","30 km/u","80 km/u","100 km/u"], answer: 0, wrongHints: [null,"Klopt — standaard.","Soms — zone 30.","Buiten.","Snelweg."] },
      { q: "Maximum snelheid **autosnelweg** overdag?", options: ["100 km/u","130 km/u","80 km/u","50 km/u"], answer: 0, wrongHints: [null,"Klopt — sinds 2020.","Tot 2020.","Buiten bebouwd.","Bebouwd."] },
      { q: "**Veiligheidsgordel** auto — verplicht?", options: ["Ja, voor alle inzittenden","Alleen voorin","Alleen achterin","Niet wettelijk"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Wel."] },
      { q: "Welke bord-vorm is een **gebod**?", options: ["Blauwe rond","Rode rond","Driehoek","Vierkant"], answer: 0, wrongHints: [null,"Klopt — moet.","Verbod.","Waarschuwing.","Info."] },
      { q: "Welke bord-vorm is een **waarschuwing**?", options: ["Driehoek (rood randje)","Blauw rond","Rood rond","Vierkant"], answer: 0, wrongHints: [null,"Klopt — let op.","Gebod.","Verbod.","Info."] },
      { q: "Wat doe je bij **brand** thuis?", options: ["Verlaat huis + bel 112","Blijven","Niets","Vrienden bellen"], answer: 0, wrongHints: [null,"Klopt.","Gevaarlijk.","Niet.","Eerst 112."] },
      { q: "**Mobiel op fiets** is sinds welk jaar verboden?", options: ["2019","2010","2025","Niet verboden"], answer: 0, wrongHints: [null,"Klopt.","Eerder niet.","Niet.","Wel."] },
      { q: "Welke kant rijdt verkeer in NL?", options: ["Rechts","Links","Beide","Random"], answer: 0, wrongHints: [null,"Klopt.","VK.","Niet.","Niet."] },
      { q: "Wat is **EHBO**?", options: ["Eerste Hulp Bij Ongelukken","Een ziekenhuis","Politie","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Andere zorg.","Niet.","Wel."] },
      { q: "Wat doe je bij een **bewusteloos** persoon?", options: ["Bel 112 + check ademhaling","Wakker schudden hard","Negeren","Eten geven"], answer: 0, wrongHints: [null,"Klopt — EHBO.","Niet.","Niet.","Gevaarlijk."] },
      { q: "Welke leeftijd is **fietsexamen** in NL?", options: ["Groep 7 (~10-11 jaar)","Groep 1","Klas 1","Volwassen"], answer: 0, wrongHints: [null,"Klopt — VVN.","Te jong.","Niet basisschool.","Niet."] },
      { q: "Welke kant heeft de **rechterbinnenkant** bij een rotonde?", options: ["Verkeer op rotonde heeft voorrang","Invoegers","Geen voorrang","Random"], answer: 0, wrongHints: [null,"Klopt — sinds 2002.","Andersom.","Wel voorrang.","Niet."] },
      { q: "Welke **lampen** moet je aan op fiets in donker?", options: ["Voor wit + achter rood","Geen","Blauw + groen","Random"], answer: 0, wrongHints: [null,"Klopt.","Wel verplicht.","Niet wettelijk.","Niet."] },
      { q: "Wat is **defensief rijden**?", options: ["Voorzichtig + anticiperen op anderen","Aanvallend","Niet relevant","Reclame"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Wel.","Niet."] },
      { q: "Welke **wegmarkering** mag je niet overschrijden?", options: ["Doorgetrokken witte streep","Onderbroken streep","Geen markering","Random"], answer: 0, wrongHints: [null,"Klopt.","Mag wel.","Wel.","Niet."] },
    ],
  },
];
