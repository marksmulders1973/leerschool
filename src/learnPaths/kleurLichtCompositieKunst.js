    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rood, geel, blauw.", simpeler: "Primair = rood/geel/blauw", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tegenover elkaar.", simpeler: "Complementair = tegenover", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Warme kleuren.", simpeler: "Warm = naar voren", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Cultuur + tijd.", simpeler: "Betekenis verschilt per cultuur", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Licht/donker.", simpeler: "Toonwaarde = licht-donker", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Licht-donkercontrast.", simpeler: "Clair-obscur = licht/donker", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Op vs geworpen.", simpeler: "Eigen = op voorwerp", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rust/evenwicht.", simpeler: "Symmetrie = rust", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Op ⅓.", simpeler: "Belangrijke ding op ⅓", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Leidende lijnen + blik.", simpeler: "Lijnen sturen je oog", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Overlapping.", simpeler: "Diepte = overlapping", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hoekig + diagonaal.", simpeler: "Diagonaal = beweging", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Zien → effect benoemen.", simpeler: "Analyse = wat + effect", nogSimpeler: "A." },
        },
      },
    ],
  },
