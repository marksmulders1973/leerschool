...
<text x="150" y="180" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">statistiek onder de knie 🏆</text>
    ...
    checks: [
      ...
      { q: "Bereik van 12, 5, 18, 9, 3?", options: ["15","18","12","3"], answer: 0, wrongHints: [null,"Klopt — max 18 min 3 = 15.","Max alleen.","Niet.","Min alleen."] },
      { q: "Gemiddelde van 10, 20, 30?", options: ["20","60","10","30"], answer: 0, wrongHints: [null,"Klopt — 60/3=20.","Dat is som.","Min.","Max."] },
      { q: "Wanneer is mediaan zinvoller dan gemiddelde?", options: ["Bij grote uitschieters","Bij weinig getallen","Bij even aantal","Bij oneven aantal"], answer: 0, wrongHints: [null,"Klopt — uitschieters trekken gemiddelde scheef.","Niet — beide werken bij elk aantal.","Niet — speelt geen rol.","Niet — speelt geen rol."] },
      { q: "5 toetsen gemiddeld 7. Som = ?", options: ["35","12","7","75"], answer: 0, wrongHints: [null,"Klopt — som = aantal × gemiddelde = 5×7=35.","Niet — optellen ipv vermenigvuldigen.","Gem zelf.","Verkeerde berekening."] },
      { q: "Frequentie van 4 in [4,5,4,6,4,7,5]?", options: ["3","2","1","4"], answer: 0, wrongHints: [null,"Klopt — 4 staat 3× in de lijst.","Niet — tel zorgvuldig.","Niet — tel nog eens.","Niet."] },
      { q: "Staafdiagram-hoogte staat voor?", options: ["Frequentie","Waarde","Som","Modus"], answer: 0, wrongHints: [null,"Klopt — hoogte = aantal keer voorkomen.","Niet — waarde op x-as.","Niet.","Modus = HOOGSTE staaf, niet hoogte zelf."] },
      { q: "5, 5, 5, 5, 5 — bereik?", options: ["0","5","25","1"], answer: 0, wrongHints: [null,"Klopt — alle gelijk, geen spreiding.","Dat is de waarde, niet bereik.","Dat is de som.","Niet."] },
      { q: "Modus van 3, 4, 5, 7, 8 (allen verschillend)?", options: ["Geen modus","3","8","5"], answer: 0, wrongHints: [null,"Klopt — geen waarde komt vaker voor.","Niet — 3 komt 1× voor (zoals alle).","Niet — zelfde frequentie.","Niet."] },
      { q: "6 cijfers gem 7. Eén cijfer is 4. Som overige 5?", options: ["38","42","32","7"], answer: 0, wrongHints: [null,"Klopt — totale som 6×7=42. Min 4 = 38.","Dat is totaal-som, niet 'overige 5'.","Te laag.","Niet."] },
    ],
  },
