    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Data bestuderen. A.", simpeler: "Statistiek = wiskunde van gegevens verzamelen + analyseren.", nogSimpeler: "Data" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6 (4+2). A.", simpeler: "Maat 38 (=4) + maat 39 (=2) = 6 leerlingen.", nogSimpeler: "6" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Frequentie. A.", simpeler: "Y-as staafdiagram = frequentie (hoe vaak iets voorkomt).", nogSimpeler: "Frequentie" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7 (28÷4). A.", simpeler: "Som 28 ÷ 4 getallen = 7 gemiddeld.", nogSimpeler: "7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7. A.", simpeler: "7 komt 3× voor (vaakst) = modus.", nogSimpeler: "7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6 (na sorteren). A.", simpeler: "Sorteer 1,2,3,6,7,8,9. Middelste (4e) = 6.", nogSimpeler: "6" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Bij uitschieters. A.", simpeler: "Mediaan beter bij uitschieters (extreem hoge/lage getallen). Anders gemiddelde.", nogSimpeler: "Uitschieters" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "22 (30-8). A.", simpeler: "Bereik = 30 - 8 = 22.", nogSimpeler: "22" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verschillende verdeling. A.", simpeler: "Zelfde gem + ander bereik = even goed, anders gespreid.", nogSimpeler: "Anders verdeeld" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "30 (5×6). A.", simpeler: "Som = aantal × gemiddelde = 5 × 6 = 30.", nogSimpeler: "30" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7,2 (36÷5). A.", simpeler: "Som 36 ÷ 5 = 7,2.", nogSimpeler: "7,2" },
        },
      },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6,6 (132÷20). A.", simpeler: "Som=132, ÷20 leerlingen = 6,6 gemiddeld.", nogSimpeler: "6,6" },
        },
      },
      {
        q: "Wat is de **modus**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7 (6 leerlingen). A.", simpeler: "7 had 6 leerlingen = meest = modus 7.", nogSimpeler: "7" },
        },
      },
      {
        q: "Wat is de **mediaan**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7 (10e+11e in 7). A.", simpeler: "Mediaan 20 lln = 10e+11e cijfer. Beide in 7. Mediaan=7.", nogSimpeler: "7" },
        },
      },
    ],
  },
