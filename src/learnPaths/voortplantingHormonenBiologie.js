    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Hormoon = boodschapper", tekst: "Hormonen zijn chemische signaalstoffen die door klieren in het bloed worden afgegeven en op afstand werken. Zenuwen sturen elektrische signalen — hormonen sturen chemische." }],
          woorden: [{ woord: "klier", uitleg: "orgaan dat hormonen maakt" }],
          theorie: "Hormoonstelsel = traag maar lang werkend. Zenuwstelsel = snel maar kort.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Insuline, testosteron, adrenaline: allemaal hormonen" }],
          basiskennis: [{ onderwerp: "endocriene systeem", uitleg: "klieren + hormonen samen" }],
          niveaus: { basis: "Chemische boodschappers.", simpeler: "Signaalstoffen in bloed.", nogSimpeler: "Berichten in bloed." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Bloed = transportsysteem", tekst: "Hormonen worden door klieren direct aan het bloed afgegeven. Bloed brengt ze naar alle delen van het lichaam. Alleen doelcellen reageren." }],
          woorden: [{ woord: "doelcel", uitleg: "cel met receptor voor specifiek hormoon" }],
          theorie: "Algemeen via bloed, specifiek via receptor — pas waar het hormoon past, gebeurt iets.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Adrenaline reist door bloed, werkt op hart + spieren" }],
          basiskennis: [{ onderwerp: "circulatie", uitleg: "bloed gaat overal" }],
          niveaus: { basis: "Via bloed.", simpeler: "Bloed vervoert alles.", nogSimpeler: "Door je aderen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Hypofyse = baas-klier", tekst: "De hypofyse zit onderin de hersenen. Hij stuurt andere klieren aan via stuurhormonen (TSH → schildklier, LH/FSH → eierstokken)." }],
          woorden: [{ woord: "stuurhormoon", uitleg: "hormoon dat andere klieren activeert" }],
          theorie: "Hiërarchie: hypofyse → andere klieren → effect.",
          voorbeelden: [{ type: "voorbeeld", tekst: "TSH (uit hypofyse) zet schildklier aan om T3/T4 te maken" }],
          basiskennis: [{ onderwerp: "negatieve feedback", uitleg: "klieren remmen elkaar" }],
          niveaus: { basis: "Hypofyse.", simpeler: "Baas-klier.", nogSimpeler: "Hersenklier." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Schildklier = stofwisseling", tekst: "Schildklier (in je hals onder de adamsappel) maakt T3 + T4. Die hormonen bepalen hoe snel je lichaam energie verbrandt." }],
          woorden: [{ woord: "stofwisseling", uitleg: "alle chemische processen in cellen" }],
          theorie: "Te weinig: traag, moe, koud. Te veel: onrustig, transpireren, snel.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Bij hypothyreoïdie: voortdurend moe en koud" }],
          basiskennis: [{ onderwerp: "jodium nodig", uitleg: "schildklier gebruikt jodium" }],
          niveaus: { basis: "Stofwisseling.", simpeler: "Hoe snel je energie verbrandt.", nogSimpeler: "Versneller." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Bevruchting in eileider", tekst: "Eicel komt uit eierstok → wordt opgevangen door eileider. Zaadcellen zwemmen vanaf vagina door baarmoeder de eileider in. Daar ontmoeten ze elkaar." }],
          woorden: [{ woord: "eileider", uitleg: "buisje tussen eierstok en baarmoeder" }],
          theorie: "Innesteling pas later — in baarmoeder, ~6-10 dagen na bevruchting.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Buitenbaarmoederlijke zwangerschap: bevruchte eicel blijft in eileider" }],
          basiskennis: [{ onderwerp: "twee eileiders", uitleg: "links + rechts" }],
          niveaus: { basis: "Eileider.", simpeler: "Buisje boven baarmoeder.", nogSimpeler: "Net na de eierstok." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "voorraad", uitleg: "kan niet aangevuld worden bij vrouwen" }],
          theorie: "Verschil met mannen: zaadcellen worden continu nieuw gemaakt vanaf puberteit.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Daarom: vruchtbaarheid vrouw daalt met leeftijd, kwaliteit eicellen ook" }],
          basiskennis: [{ onderwerp: "geboorte = max", uitleg: "vanaf dan alleen afname" }],
          niveaus: { basis: "1-2 miljoen.", simpeler: "Veel — al bij geboorte.", nogSimpeler: "Heel veel." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Menopauze = eierstokken stoppen", tekst: "Rond 45-55 jaar stoppen de eierstokken geleidelijk: geen rijpe eicellen meer, geen menstruatie. Hormonen oestrogeen + progesteron dalen sterk." }],
          woorden: [{ woord: "menopauze", uitleg: "einde van vruchtbare periode" }],
          theorie: "Eicellen-voorraad raakt op. Daling hormonen → soms opvliegers, stemmingswisseling.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Gemiddelde leeftijd in NL: ~51 jaar" }],
          basiskennis: [{ onderwerp: "geen kinderen meer", uitleg: "natuurlijke vruchtbaarheid eindigt" }],
          niveaus: { basis: "Eierstokken stoppen.", simpeler: "Geen menstruatie meer.", nogSimpeler: "Vruchtbaarheid eindigt." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Zaadcellen willen koeler", tekst: "Zaadcellen ontwikkelen zich het best bij ~35°C (2°C lager dan lichaamstemperatuur). Daarom hangen de teelballen buiten het lichaam in de balzak." }],
          woorden: [{ woord: "balzak (scrotum)", uitleg: "huidzak buiten het lichaam" }],
          theorie: "Bij kou trekken teelballen omhoog (warmer), bij warmte zakken ze (koeler).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Strakke kleding of laptop op schoot kan zaadkwaliteit verminderen" }],
          basiskennis: [{ onderwerp: "temperatuurregeling", uitleg: "lichaam regelt actief" }],
          niveaus: { basis: "Lagere temperatuur.", simpeler: "Koeler buiten lichaam.", nogSimpeler: "Te warm = slecht." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "200-400 miljoen", tekst: "Eén uitstoot sperma (2-5 ml) bevat ~200-400 miljoen zaadcellen. Maar slechts één kan een eicel bevruchten — concurrentie is enorm." }],
          woorden: [{ woord: "ejaculaat", uitleg: "uitgestoten sperma" }],
          theorie: "Veel zaadcellen → hogere kans dat er één de eicel bereikt. De meeste sterven onderweg.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Van 300 miljoen blijven er ~200 over in de eileider" }],
          basiskennis: [{ onderwerp: "selectie", uitleg: "sterkste zaadcellen winnen" }],
          niveaus: { basis: "200-400 miljoen.", simpeler: "Honderden miljoenen.", nogSimpeler: "Heel veel." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Eisprong dag 14", tekst: "Bij een 28-daagse cyclus is de eisprong rond dag 14 (midden). Bij kortere/langere cyclus schuift de datum mee — meestal 14 dagen vóór volgende menstruatie." }],
          woorden: [{ woord: "ovulatie", uitleg: "wetenschappelijke term voor eisprong" }],
          theorie: "Cyclus start bij dag 1 (eerste dag menstruatie). Eisprong = midden.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Bij cyclus van 32 dagen: eisprong rond dag 18" }],
          basiskennis: [{ onderwerp: "individueel verschillend", uitleg: "niet iedereen 28 dagen" }],
          niveaus: { basis: "Dag 14.", simpeler: "Midden in cyclus.", nogSimpeler: "Halverwege." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "~24 uur na eisprong", tekst: "De eicel blijft maar ~24 uur leefbaar in de eileider. Daarna sterft ze af. Sperma kan ~3-5 dagen overleven — daarom vruchtbare periode ~5-6 dagen rond eisprong." }],
          woorden: [{ woord: "vruchtbare periode", uitleg: "tijd waarin bevruchting mogelijk is" }],
          theorie: "Sperma wacht langer dan eicel. Beste kans: zaadcellen aanwezig zijn op moment van eisprong.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Seks 1 dag vóór eisprong → zaadcel wacht eicel op" }],
          basiskennis: [{ onderwerp: "korte termijn eicel", uitleg: "24 uur, niet meer" }],
          niveaus: { basis: "24 uur.", simpeler: "Eén dag.", nogSimpeler: "Kort." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Geen bevruchting → menstruatie", tekst: "Zonder bevruchting daalt het progesteron-niveau. Slijmvlies in baarmoeder houdt zich niet meer in stand → komt los → bloedt af via vagina = menstruatie." }],
          woorden: [{ woord: "menstruatie", uitleg: "afstoten van baarmoederslijmvlies" }],
          theorie: "Progesteron hoog = slijmvlies blijft. Progesteron laag = slijmvlies komt los.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Volgende cyclus begint op dag 1 = eerste dag menstruatie" }],
          basiskennis: [{ onderwerp: "cyclisch", uitleg: "herhaalt elke 28 dagen" }],
          niveaus: { basis: "Menstruatie.", simpeler: "Bloeden begint.", nogSimpeler: "Nieuwe cyclus." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Slechts 1 zaadcel", tekst: "Honderden zaadcellen duwen tegen de eicel, maar zodra één doorbreekt, sluit de eicel zich chemisch af. De rest kan er niet meer in. Eén-op-één DNA-versmelting." }],
          woorden: [{ woord: "zygote", uitleg: "bevruchte eicel" }],
          theorie: "Cortical reaction: na binnenkomst eerste zaadcel verhardt de eicel-buitenkant.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Soms toch 2 zaadcellen → onbruikbaar embryo (sterft af)" }],
          basiskennis: [{ onderwerp: "23 + 23 = 46", uitleg: "zaadcel 23 + eicel 23 chromosomen" }],
          niveaus: { basis: "Eén.", simpeler: "Alleen de eerste.", nogSimpeler: "Eentje wint." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "trimester", uitleg: "periode van ~3 maanden" }],
          theorie: "Eerste trimester: aanleg organen. Tweede: groei + bewegen. Derde: rijping + groei.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Een baby van 37+ weken is voldragen, vóór 37 = prematuur" }],
          basiskennis: [{ onderwerp: "+/- 2 weken normaal", uitleg: "exacte datum zelden klopt" }],
          niveaus: { basis: "9 maanden.", simpeler: "Ongeveer 40 weken.", nogSimpeler: "9 maanden." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Eeneiig = 1, twee-eiig = 2", tekst: "Eeneiig: één bevruchte eicel splitst → identieke tweeling, zelfde DNA + altijd zelfde geslacht. Twee-eiig: twee eicellen + twee zaadcellen → verschillend DNA, kunnen ander geslacht hebben." }],
          woorden: [{ woord: "identiek", uitleg: "exact zelfde DNA" }],
          theorie: "Eeneiig is zeldzaam (1 op 250). Twee-eiig komt vaker voor.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Eeneiige tweeling: 100% gelijk. Twee-eiig: net als gewone broers/zussen" }],
          basiskennis: [{ onderwerp: "1 eicel vs 2", uitleg: "telt hoeveel eicellen bevrucht" }],
          niveaus: { basis: "Aantal eicellen.", simpeler: "1 of 2 bevruchte eicellen.", nogSimpeler: "Verschillend begin." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Testosteron = jongens", tekst: "Testosteron uit de teelballen stuurt mannelijke puberteit: baardgroei, lage stem, spiergroei, productie zaadcellen, schouders breder." }],
          woorden: [{ woord: "androgeen", uitleg: "verzamelnaam mannelijke hormonen" }],
          theorie: "Vrouwen hebben ook beetje testosteron, mannen ook beetje oestrogeen — verschil zit in HOEVEEL.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Zang van Justin Bieber → lage stem (testosteron-effect)" }],
          basiskennis: [{ onderwerp: "uit teelballen", uitleg: "vanaf puberteit verhoogd" }],
          niveaus: { basis: "Testosteron.", simpeler: "Mannelijk hormoon.", nogSimpeler: "Maakt jongens man." },
        },
      },
      {
        q: "Wat is **menarche**?",
        ...
        uitlegPad: {
          stappen: [{ titel: "Menarche = eerste menstruatie", tekst: "De eerste keer dat een meisje menstrueert. Gemiddeld rond 12-13 jaar in Nederland, maar 10-15 jaar is allemaal normaal." }],
          woorden: [{ woord: "menarche", uitleg: "Grieks: men = maand, arche = begin" }],
          theorie: "Markeert begin van vruchtbare levensfase.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Cyclus daarna eerst onregelmatig — gewoon" }],
          basiskennis: [{ onderwerp: "verschil per meisje", uitleg: "normaal: 10-15 jaar" }],
          niveaus: { basis: "Eerste menstruatie.", simpeler: "Eerste keer ongesteld.", nogSimpeler: "Start cyclus." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "~25 jaar", tekst: "Het frontale deel van de hersenen (verantwoordelijk voor afwegingen + remming impulsen) is pas rond 25 jaar volledig ontwikkeld. Verklaart waarom tieners soms impulsief zijn." }],
          woorden: [{ woord: "prefrontale cortex", uitleg: "controleer-deel hersenen" }],
          theorie: "Hersenen blijven plastisch — vanaf 25 wel veel minder grote veranderingen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Daarom mag je in NL pas op 18 stemmen, op 21 cannabis-shop, etc." }],
          basiskennis: [{ onderwerp: "ontwikkeling van achter naar voren", uitleg: "frontaal is laatst" }],
          niveaus: { basis: "25 jaar.", simpeler: "Tot midden 20.", nogSimpeler: "Lang." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Insuline verlaagt bloedsuiker", tekst: "Na het eten stijgt bloedsuiker. Alvleesklier maakt insuline → cellen openen 'glucose-poortjes' → glucose verlaat bloed, gaat cellen in. Bloedsuiker daalt." }],
          woorden: [{ woord: "glycogeen", uitleg: "opgeslagen vorm van glucose in lever" }],
          theorie: "Insuline gaat in (bloedsuiker omlaag). Glucagon gaat uit (bloedsuiker omhoog).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Na lunch: insuline-piek. Tussen maaltijden: glucagon" }],
          basiskennis: [{ onderwerp: "alvleesklier", uitleg: "klier achter de maag" }],
          niveaus: { basis: "Verlaagt bloedsuiker.", simpeler: "Suiker uit bloed naar cellen.", nogSimpeler: "Insuline = suiker omlaag." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Type 1 vs Type 2", tekst: "Type 1: immuunsysteem heeft insuline-cellen vernietigd → geen insuline (vaak op jonge leeftijd). Type 2: insuline wel, maar cellen reageren slecht (vaak bij ouderdom + leefstijl)." }],
          woorden: [{ woord: "insuline-resistentie", uitleg: "cellen luisteren niet meer naar insuline" }],
          theorie: "Type 1 = absoluut tekort. Type 2 = relatief tekort/resistentie.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Type 1: insuline-injecties levenslang. Type 2: vaak eerst dieet + beweging" }],
          basiskennis: [{ onderwerp: "niet besmettelijk", uitleg: "geen ziektekiem" }],
          niveaus: { basis: "Wel/geen insuline.", simpeler: "Type 1 = niets, type 2 = doof.", nogSimpeler: "Andere oorzaak." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Vechten of vluchten", tekst: "Bij gevaar maakt bijnier in seconden adrenaline → hart sneller, bloeddruk omhoog, pupillen wijd, spieren krijgen meer bloed → lichaam klaar om te vechten of vluchten." }],
          woorden: [{ woord: "stress-response", uitleg: "noodreactie van het lichaam" }],
          theorie: "Adrenaline = acuut (seconden). Cortisol = chronisch (uren-dagen).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Hond rent op je af → adrenaline-stoot → je springt opzij" }],
          basiskennis: [{ onderwerp: "bijnier", uitleg: "klier bovenop nier" }],
          niveaus: { basis: "Lichaam klaar voor actie.", simpeler: "Sneller, sterker, alert.", nogSimpeler: "Klaarstoot." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Schildklier = stofwisselingssnelheid", tekst: "Schildklierhormoon (T3, T4) bepaalt hoe snel je cellen energie verbranden. Hoger = sneller (warmte, energie). Lager = trager (moe, koud)." }],
          woorden: [{ woord: "T3/T4", uitleg: "schildklierhormonen (T staat voor tyrosine)" }],
          theorie: "Te veel = hyper, te weinig = hypo. Beide via bloedonderzoek vast te stellen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Hyper: gewichtsverlies, onrust. Hypo: gewichtstoename, traagheid" }],
          basiskennis: [{ onderwerp: "jodium nodig", uitleg: "zonder jodium kan schildklier geen hormoon maken" }],
          niveaus: { basis: "Stofwisselingssnelheid.", simpeler: "Energie verbranden.", nogSimpeler: "Snelheid lichaam." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Insuline-injecties", tekst: "Bij type 1 maakt het lichaam GEEN insuline meer. Patiënt moet dagelijks insuline toedienen via pen-injecties of een insuline-pomp. Levenslang." }],
          woorden: [{ woord: "insuline-pomp", uitleg: "klein apparaat dat automatisch insuline geeft" }],
          theorie: "Dieet alleen werkt niet: er is geen insuline meer in lichaam.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Voor maaltijd: bolus. 's Nachts: basaal-tempo continu" }],
          basiskennis: [{ onderwerp: "bloedsuiker meten", uitleg: "voor elke maaltijd prikken/scannen" }],
          niveaus: { basis: "Insuline spuiten.", simpeler: "Dagelijks toedienen.", nogSimpeler: "Pen of pomp." },
        },
      },
      {
        q: "Wat is **PCOS**?",
        ...
        uitlegPad: {
          stappen: [{ titel: "PCOS — hormonaal syndroom", tekst: "Polycysteus Ovarium Syndroom: vrouwen met hormonaal onbalans (te veel mannelijke hormonen). Onregelmatige cyclus, soms vruchtbaarheidsproblemen, vaak meerdere kleine cysten op eierstokken." }],
          woorden: [{ woord: "polycysteus", uitleg: "veel cysten" }],
          theorie: "Komt voor bij ~5-10% van vrouwen. Niet besmettelijk. Behandeling: leefstijl + soms anticonceptiepil.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Symptomen: cyclus van 40+ dagen, acne, overbeharing" }],
          basiskennis: [{ onderwerp: "diagnose via echo + bloed", uitleg: "huisarts → gynaecoloog" }],
          niveaus: { basis: "Hormonaal onbalans bij vrouwen.", simpeler: "Cyclus klopt niet.", nogSimpeler: "Vrouw-syndroom." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Eierstokken = oestrogeen", tekst: "Eierstokken produceren oestrogeen + progesteron. Oestrogeen = vrouwelijke kenmerken + slijmvlies-opbouw eerste cyclushelft." }],
          woorden: [{ woord: "oestrogeen", uitleg: "hoofd-vrouwelijk-hormoon" }],
          theorie: "Eierstokken (2 stuks) maken hormonen + leveren eicellen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Oestrogeen-piek rond eisprong → LH-piek → eisprong" }],
          basiskennis: [{ onderwerp: "klier ≠ orgaan", uitleg: "klier maakt hormoon" }],
          niveaus: { basis: "Oestrogeen.", simpeler: "Vrouwelijk hormoon.", nogSimpeler: "Hormoon van vrouw." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Adrenaline = stress-respons", tekst: "Adrenaline (uit bijnieren) zet je lichaam binnen seconden in 'fight-or-flight'-modus. Hart, ademhaling, spieren — alles versnelt voor acute actie." }],
          woorden: [{ woord: "bijnier", uitleg: "klier bovenop nier" }],
          theorie: "Acute reactie (adrenaline) vs chronische (cortisol).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Schrik → adrenaline-stoot → hart bonkt, je springt op" }],
          basiskennis: [{ onderwerp: "evolutionair", uitleg: "overlevings-mechanisme uit oertijd" }],
          niveaus: { basis: "Adrenaline.", simpeler: "Stress-hormoon.", nogSimpeler: "Schrik-stof." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Progesteron = slijmvlies-bescherming", tekst: "Progesteron (uit lege follikel na eisprong) houdt het baarmoederslijmvlies dik en klaar voor innesteling. Daalt het → slijmvlies komt los → menstruatie." }],
          woorden: [{ woord: "luteale fase", uitleg: "tweede cyclushelft, hoog progesteron" }],
          theorie: "Progesteron beschermt zwangerschap. Bij zwangerschap blijft het hoog (geen menstruatie).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Zwangerschapstest meet hCG, maar progesteron is wat slijmvlies behoudt" }],
          basiskennis: [{ onderwerp: "uit lege follikel", uitleg: "het gele lichaam" }],
          niveaus: { basis: "Slijmvlies in stand houden.", simpeler: "Baarmoeder klaar voor baby.", nogSimpeler: "Vrouwen-hormoon." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Dag 14 midden", tekst: "Bij 28-daagse cyclus: eisprong rond dag 14 (midden). Eisprong is altijd 14 dagen vóór volgende menstruatie." }],
          woorden: [{ woord: "midcyclus", uitleg: "midden van cyclus" }],
          theorie: "Cyclus: dag 1-5 menstruatie, 6-13 opbouw, 14 eisprong, 15-28 wachtfase.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Bij cyclus van 32 dagen: eisprong rond dag 18 (32 - 14)" }],
          basiskennis: [{ onderwerp: "luteale fase = vast", uitleg: "14 dagen na eisprong" }],
          niveaus: { basis: "Dag 14.", simpeler: "Halverwege.", nogSimpeler: "Midden." },
        },
      },
    ],
  },
