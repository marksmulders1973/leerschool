...
const steps = [
...

  {
    ...
    checks: [
      ...
      { q: "Wat is een **stroomdiagram**?", options: ["Schema met stappen en beslissingen","Tabel","Tijdslijn","Tekening"], answer: 0, wrongHints: [null,"Klopt — zoals voor proces.","Geen schema.","Geen beslissingen.","Niet schematisch."] },
      { q: "Welk symbool gebruik je voor een **ja/nee-vraag** in beslisboom?", options: ["Ruit","Rechthoek","Cirkel","Driehoek"], answer: 0, wrongHints: [null,"Klopt — afspraak.","Dat is actie/stap.","Dat is begin/eind.","Niet standaard."] },
      { q: "Welk symbool voor **begin/eind** in stroomdiagram?", options: ["Cirkel of ovaal","Ruit","Rechthoek","Pijl"], answer: 0, wrongHints: [null,"Klopt.","Beslissing.","Actie.","Verbinding."] },
      { q: "In een **tabel** staan?", options: ["Rijen + kolommen met data","Verhalen","Pijlen","Recepten"], answer: 0, wrongHints: [null,"Klopt.","Geen verhaal.","Niet alleen pijlen.","Soms maar niet altijd."] },
      { q: "Wat is de **eerste kolom** in een tabel vaak?", options: ["Categorieën/labels","Random data","De totalen","Reclame"], answer: 0, wrongHints: [null,"Klopt — y-as-labels.","Niet random.","Vaak rechts.","Niet."] },
      { q: "Welk schema toont **hiërarchie** (boven-onder)?", options: ["Boomdiagram","Tijdslijn","Tabel","Beslisboom"], answer: 0, wrongHints: [null,"Klopt — bv. familieboom.","Tijd-volgorde.","Data-overzicht.","Wel boom, maar voor keuzes."] },
      { q: "Welke volgorde hoort in **stappenplan 'klaarmaken brood'**?", options: ["Brood pakken → besmeren → eten","Eten → brood pakken → besmeren","Besmeren → brood pakken → eten","Eten → besmeren → brood pakken"], answer: 0, wrongHints: [null,"Klopt — logische volgorde.","Niet — eerst pakken.","Niet — eerst brood.","Niet — laatste = eten."] },
      { q: "Wat zoek je in een **legenda** bij een schema?", options: ["Wat de symbolen betekenen","De auteur","De datum","De prijs"], answer: 0, wrongHints: [null,"Klopt — uitleg-symbolen.","Niet relevant.","Niet relevant.","Niet relevant."] },
      { q: "Bij een **flowchart**: wat doe je bij een ruit?", options: ["Antwoord op ja/nee-vraag kiezen","Stap uitvoeren","Stoppen","Nieuw begin"], answer: 0, wrongHints: [null,"Klopt — beslismoment.","Dat is rechthoek.","Dat is ovaal-eind.","Dat is ovaal-begin."] },
      { q: "Wat is een **Venn-diagram**?", options: ["Cirkels die overlappen om gemeenschappelijk te tonen","Tijdslijn","Boom","Tabel"], answer: 0, wrongHints: [null,"Klopt — overlap = gedeelde eigenschap.","Niet.","Niet.","Niet."] },
      { q: "Welke verwijzing in tekst vertelt: 'kijk in tabel 2'?", options: ["Een verwijzing/referentie","Een mening","Een conclusie","Onzin"], answer: 0, wrongHints: [null,"Klopt — info-pijler.","Niet — feitelijk.","Niet conclusie.","Wel zinvol."] },
      { q: "Een **organogram** toont?", options: ["Wie boven/onder wie staat in organisatie","Tijd","Recept","Verhaal"], answer: 0, wrongHints: [null,"Klopt — hiërarchie.","Niet.","Niet.","Niet."] },
      { q: "Wat doet een **pijl** in een stappenplan?", options: ["Wijst naar volgende stap","Verbiedt","Toont fouten","Markeert begin"], answer: 0, wrongHints: [null,"Klopt — volgorde.","Niet.","Niet relevant.","Niet specifiek."] },
      { q: "Bij **chronologisch** schema staan dingen op?", options: ["Volgorde van tijd","Alfabet","Grootte","Willekeurig"], answer: 0, wrongHints: [null,"Klopt — vroeg naar laat.","Niet.","Niet.","Niet."] },
      { q: "Wat helpt het meest om **stappenplan** te onthouden?", options: ["Stappen genummerd zien (1, 2, 3)","Random kleuren","Lange zin per stap","Tekening zonder tekst"], answer: 0, wrongHints: [null,"Klopt — nummers helpen volgorde.","Niet.","Te lang om snel te zien.","Tekst helpt ook."] },
    ],
  },
];
