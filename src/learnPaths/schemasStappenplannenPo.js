...

  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Dat is uitrekenen, niet begrijpen.", "Controle is na rekenen, niet begrijpen vooraf.", "Wel — stap 1 + 2 zijn lezen + markeren."],
        uitlegPad: {
          stappen: [
      ...
      { q: "Wat is de **eerste kolom** in een tabel vaak?", options: ["Categorieën/labels","Random data","De totalen","Reclame"], answer: 0, wrongHints: [null, "Niet random.", "Vaak rechts.", "Niet."] },
      ...
      { q: "Wat zoek je in een **legenda** bij een schema?", options: ["Wat de symbolen betekenen","De auteur","De datum","De prijs"], answer: 0, wrongHints: [null, "Niet relevant.", "Niet relevant.", "Niet relevant."] },
      ...
      { q: "Wat is een **Venn-diagram**?", options: ["Cirkels die overlappen om gemeenschappelijk te tonen","Tijdslijn","Boom","Tabel"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      ...
      { q: "Een **organogram** toont?", options: ["Wie boven/onder wie staat in organisatie","Tijd","Recept","Verhaal"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      ...
      { q: "Bij **chronologisch** schema staan dingen op?", options: ["Volgorde van tijd","Alfabet","Grootte","Willekeurig"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "Wat helpt het meest om **stappenplan** te onthouden?", options: ["Stappen genummerd zien (1, 2, 3)","Random kleuren","Lange zin per stap","Tekening zonder tekst"], answer: 0, wrongHints: [null, "Niet.", "Te lang om snel te zien.", "Tekst helpt ook."] },
    ],
  },
];
