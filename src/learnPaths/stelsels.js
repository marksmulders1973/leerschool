    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ja, beide.", simpeler: "5+2=7 ✓ en 2·5−2=8 ✓ → ja oplossing.", nogSimpeler: "Ja" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen.", simpeler: "x+y kan niet 5 én 7 zijn → geen oplossing.", nogSimpeler: "0" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen.", simpeler: "Parallel = nooit kruisen = geen oplossing.", nogSimpeler: "0" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(3x−1) invullen.", simpeler: "y=3x−1 → vul in 2e vgl.", nogSimpeler: "Invullen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x in vgl 1.", simpeler: "Coëff 1 = makkelijkst isoleren.", nogSimpeler: "Coëff 1" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Optellen.", simpeler: "y tegengesteld → optellen, y weg.", nogSimpeler: "Optellen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "·3 en ·2.", simpeler: "KGV(2,3)=6. Vgl 1 ·3, vgl 2 ·2.", nogSimpeler: "·3,·2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Substitutie.", simpeler: "y al alleen → substitueer.", nogSimpeler: "Subst." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen oplossing.", simpeler: "0=5 onmogelijk → geen oplossing.", nogSimpeler: "Geen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x+y=20, x−y=6.", simpeler: "Samen=+, verschil=−.", nogSimpeler: "+,−" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2.", simpeler: "5x=10 → x=2.", nogSimpeler: "2" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(4,3).", simpeler: "8x=32 → x=4. Dan y=3.", nogSimpeler: "(4,3)" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oneindig veel.", simpeler: "Vgl 2 = 2× vgl 1 → identiek → ∞ oplossingen.", nogSimpeler: "∞" },
        },
      },
    ],
  },
