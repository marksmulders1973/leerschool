    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ja, beide. A.", simpeler: "5+2=7 ✓ en 2·5−2=8 ✓ → ja oplossing.", nogSimpeler: "Ja" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen. A.", simpeler: "x+y kan niet 5 én 7 zijn → geen oplossing.", nogSimpeler: "0" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen. A.", simpeler: "Parallel = nooit kruisen = geen oplossing.", nogSimpeler: "0" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(3x−1) invullen. A.", simpeler: "y=3x−1 → vul in 2e vgl.", nogSimpeler: "Invullen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3. A.", simpeler: "x+2x=9 → 3x=9 → x=3.", nogSimpeler: "3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x in vgl 1. A.", simpeler: "Coëff 1 = makkelijkst isoleren.", nogSimpeler: "Coëff 1" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Optellen. A.", simpeler: "y tegengesteld → optellen, y weg.", nogSimpeler: "Optellen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "·3 en ·2. A.", simpeler: "KGV(2,3)=6. Vgl 1 ·3, vgl 2 ·2.", nogSimpeler: "·3,·2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Substitutie. A.", simpeler: "y al alleen → substitueer.", nogSimpeler: "Subst." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen oplossing. A.", simpeler: "0=5 onmogelijk → geen oplossing.", nogSimpeler: "Geen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x+y=20, x−y=6. A.", simpeler: "Samen=+, verschil=−.", nogSimpeler: "+,−" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5. A.", simpeler: "3x=15 → x=5.", nogSimpeler: "5" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2. A.", simpeler: "5x=10 → x=2.", nogSimpeler: "2" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y=3. A.", simpeler: "Volg eliminatie of substitutie.", nogSimpeler: "3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4.67 kg. A.", simpeler: "3h=14 → h=14/3≈4.67.", nogSimpeler: "4.67" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(4,3). A.", simpeler: "8x=32 → x=4. Dan y=3.", nogSimpeler: "(4,3)" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2 uur. A.", simpeler: "Eerste deel duurt 2 uur (15·2=30km).", nogSimpeler: "2u" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oneindig veel. A.", simpeler: "Vgl 2 = 2× vgl 1 → identiek → ∞ oplossingen.", nogSimpeler: "∞" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3. A.", simpeler: "x=3 volgens antwoord. Verifieer met substitutie.", nogSimpeler: "3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "€2.50. A.", simpeler: "k=2, b=2.50. Broodje €2,50.", nogSimpeler: "€2.50" },
        },
      },
