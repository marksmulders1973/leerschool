...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">je beheerst het 🎓</text>
    ...
    checks: [
      ...
      { q: "Een **stelsel** heeft hoeveel onbekenden?", options: ["Meestal 2 (of meer)","1","0","Oneindig"], answer: 0, wrongHints: [null,"Klopt — twee onbekenden, twee vergelijkingen.","Dat is gewone vergelijking.","Niet.","Niet algemeen."] },
      { q: "Welke methode lost stelsel op door optellen/aftrekken?", options: ["Eliminatie","Substitutie","Factorisatie","Grafiek"], answer: 0, wrongHints: [null,"Klopt — variabele 'elimineren'.","Andere methode (één vervangen).","Niet relevant.","Niet specifiek."] },
      { q: "Stelsel x+y=5 en x−y=1. Wat is x?", options: ["3","2","4","1"], answer: 0, wrongHints: [null,"Klopt — optellen: 2x=6, x=3.","y=2, niet x.","Niet.","Niet."] },
      { q: "Grafisch: snijpunt twee lijnen = ?", options: ["Oplossing van stelsel","Niets","Y-as","X-as"], answer: 0, wrongHints: [null,"Klopt — waar beide vergelijkingen kloppen.","Wel iets.","Niet relevant.","Niet relevant."] },
      { q: "Stelsel y=2x en y=x+1. Snijpunt y= ?", options: ["2","1","0","3"], answer: 0, wrongHints: [null,"Klopt — x=1 → y=2.","Niet — dat is y bij x=0.","Niet.","Niet."] },
    ],
  },
];
