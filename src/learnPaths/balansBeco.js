...
<text x="150" y="160" text-anchor="middle" fill="${COLORS.winst}" font-size="12" font-family="Arial" font-weight="bold">je kunt het — succes!</text>
    ...
    checks: [
      ...
      { q: "Een **balans** bestaat uit welke 2 kanten?", options: ["Activa (links) + Passiva (rechts)","Inkomsten + Uitgaven","Winst + Verlies","Eigen + vermogen"], answer: 0, wrongHints: [null, "Inkomsten en uitgaven horen bij de resultatenrekening — de balans is een fóto van bezit en financiering.", "Winst en verlies staan op de W&V-rekening, niet op de balans.", "Dat is maar één post — welke twéé volledige kanten heeft de balans?"] },
      ...
      { q: "**Crediteur** = ?", options: ["Iemand aan wie het bedrijf geld moet","Iemand die geld krijgt van bedrijf","Bank","Klant"], answer: 0, wrongHints: [null, "Dat is de omgekeerde geldstroom — wie moet wíé nog betalen bij een crediteur?", null, "Een klant die nog moet betalen heeft een andere naam — welke ook alweer?"] },
      { q: "**Debiteur** = ?", options: ["Klant die nog moet betalen","Leverancier","Eigenaar","Bank"], answer: 0, wrongHints: [null, "Een leverancier waar jíj nog moet betalen heet juist anders — hoe ook alweer?", null, null] },
