    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Wel verschil.", "Niet primair.", "Beide wetenschap."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-tip: kledij is voor weer (regenjas vandaag), klimaat is voor architectuur (huizen-isolatie in NL voor koude winters).",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: IPCC won in 2007 de Nobelprijs voor de Vrede (samen met Al Gore). Hun rapporten worden door politici gebruikt om klimaatbeleid te maken (Parijs-akkoord 2015).",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip: broeikaseffect ZELF is goed! Zonder dit geen leven. Het PROBLEEM is dat mens MEER broeikasgassen maakt door fossiele brandstoffen, en daardoor extra warmte vasthoudt.",
          voorbeelden: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "78% lucht maar geen broeikas.", "21% lucht.", "Edelgas."],
      },
      {
  ...
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Wel doel.", "Onmogelijk in 2030.", "Te weinig."],
      },
      {
        q: "Wanneer **stopt NL gas** uit Groningen?",
        options: ["2024", "2050", "Nooit", "1980"],
        answer: 0,
        wrongHints: [null, "Te laat.", "Wel stop.", "Begon toen juist."],
      },
      {
        q: "Wat is **klimaatadaptatie**?",
        options: ["Aanpassen aan verandering", "Veroorzaken", "Negeren", "Voorspellen"],
        answer: 0,
        wrongHints: [null, "Tegenovergesteld.", "Niet.", "Voorspellen apart."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Adaptatie.", "Niet.", "Tegenovergesteld."],
      },
      {
        q: "Wanneer **Parijs-akkoord**?",
        options: ["2015", "1997", "2024", "1990"],
        answer: 0,
        wrongHints: [null, "Kyoto.", "Te recent.", "Te vroeg."],
      },
      {
        q: "Wat is een **NDC**?",
