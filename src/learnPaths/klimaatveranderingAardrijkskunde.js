...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wat is **kantelpunt** in klimaat?", options: ["Onomkeerbare verandering", "Tijdmeter", "Berg", "Klok"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "Welke is **hernieuwbare energie**?", options: ["Zonnepaneel + windmolen", "Kolen", "Olie", "Gas"], answer: 0, wrongHints: [null, "Fossiel.", "Fossiel.", "Fossiel."] },
