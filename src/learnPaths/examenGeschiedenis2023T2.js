...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "Thorbecke (1798-1872) was de auteur van de Grondwet van 1848 (na revolutiegolf Europa). Daarin kwam **censuskiesrecht** = stemmen op basis van vermogen (alleen rijke mannen). Algemeen kiesrecht volgt veel later (mannen 1917, vrouwen 1919). Beide kanten kloppen: 'ja' + 'censuskiesrecht'.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Socialisten** (SDAP, opgericht 1894) streden voor: hoger loon, arbeiderrechten, kortere werkdag, sociale wetten (ziektewet, AOW, etc.), staking-recht. Belangrijke namen: Troelstra, Domela Nieuwenhuis.",
