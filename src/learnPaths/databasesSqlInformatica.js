    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geordende gegevens. A.", simpeler: "Database = geordende gegevens = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Een rij. A.", simpeler: "Record = rij = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Snel zoeken bij veel data. A.", simpeler: "Database = snel zoeken = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Uniek kenmerk per record. A.", simpeler: "Primaire sleutel = uniek id = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tabellen koppelen. A.", simpeler: "Foreign key = koppeling = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen dubbele data. A.", simpeler: "Opsplitsen = geen dubbel = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "SELECT. A.", simpeler: "Kolommen kiezen = SELECT = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Filtert op ≥6. A.", simpeler: "WHERE = filter = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "SELECT * ... WHERE groep=7. A.", simpeler: "Alles ophalen = SELECT * = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "DELETE. A.", simpeler: "Verwijderen = DELETE = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Anders raak je alles. A.", simpeler: "Zonder WHERE = alles = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "COUNT(*). A.", simpeler: "Aantal tellen = COUNT = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
