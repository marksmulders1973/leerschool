    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Gesloten kring nodig", tekst: "Stroom kan alleen lopen als er een COMPLETE rondgaande baan is: bron → draad → verbruiker → draad → bron. Open ergens = geen stroom." }],
          woorden: [{ woord: "stroomkring", uitleg: "rondgaande baan voor elektronen" }],
          theorie: "Schakelaar dicht = kring rond. Schakelaar open = kring onderbroken.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Lamp uit = schakelaar open = geen stroom door lamp" }],
          basiskennis: [{ onderwerp: "begin = eind", uitleg: "moet rond zijn" }],
          niveaus: { basis: "Gesloten kring.", simpeler: "Rondje moet rond zijn.", nogSimpeler: "Geen breuk." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Kortsluiting = pad zonder verbruiker", tekst: "Bij kortsluiting kan stroom direct terug naar bron zonder eerst door een verbruiker. Weinig weerstand → enorme stroom → draden heet → brandgevaar." }],
          woorden: [{ woord: "kortsluiting", uitleg: "korte weg zonder weerstand" }],
          theorie: "Zekering/stop knapt door om de kortsluiting te onderbreken vóór brand.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Plus en min direct verbinden zonder lamp = kortsluiting" }],
          basiskennis: [{ onderwerp: "Wet van Ohm", uitleg: "I = U/R, kleine R = grote I" }],
          niveaus: { basis: "Hele grote stroom.", simpeler: "Stroom zonder verbruiker.", nogSimpeler: "Te veel stroom." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Spanning meet je in volt", tekst: "Volt (V) is de eenheid van spanning. Symbool U. Net zoals snelheid in km/u, spanning in volt." }],
          woorden: [{ woord: "Volt (V)", uitleg: "eenheid van spanning, vernoemd naar Alessandro Volta" }],
          theorie: "Onthoud: U-Volt, I-Ampère, R-Ohm, P-Watt.",
          voorbeelden: [{ type: "voorbeeld", tekst: "AA-batterij 1,5 V. Stopcontact 230 V" }],
          basiskennis: [{ onderwerp: "eenheden-tabel", uitleg: "weet voor elk symbool de eenheid" }],
          niveaus: { basis: "Volt (V).", simpeler: "V.", nogSimpeler: "V van Volt." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "veiligheid", uitleg: "nooit direct aanraken!" }],
          niveaus: { basis: "230 V.", simpeler: "Stopcontact-spanning.", nogSimpeler: "Hoog!" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "In serie.", simpeler: "In de kring.", nogSimpeler: "Er doorheen." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Ampère (A) = stroomsterkte", tekst: "Symbool I, eenheid A (ampère). Geeft aan hoeveel stroom (lading per seconde) er door een draad gaat." }],
          woorden: [{ woord: "Ampère", uitleg: "vernoemd naar André-Marie Ampère, Frans wetenschapper" }],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Ohm (Ω) = weerstand", tekst: "Eenheid van weerstand is ohm, symbool Ω (Griekse letter omega). Vernoemd naar Georg Ohm." }],
          woorden: [{ woord: "Ω", uitleg: "Griekse omega, ziet eruit als hoefijzer" }],
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "doorsnede", uitleg: "oppervlakte van dwarsdoorsnede draad" }],
          theorie: "Weerstand R = ρ × L/A. R hoger bij langere L, lager bij grotere A.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Hoogspanningskabels zijn dik — om verlies te beperken" }],
          basiskennis: [{ onderwerp: "factoren weerstand", uitleg: "materiaal, lengte, dikte, temperatuur" }],
          niveaus: { basis: "Dikker.", simpeler: "Grotere doorsnede.", nogSimpeler: "Brede draad." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "I = U / R = 12/100 = 0,12 A", tekst: "Wet van Ohm omgeschreven: I = U/R. Met U=12 V en R=100 Ω → I = 12/100 = 0,12 A (= 120 mA)." }],
          woorden: [{ woord: "milliampère (mA)", uitleg: "1 mA = 0,001 A" }],
          theorie: "Driehoek-truc: bedek I, je leest U/R.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Knoopcel 3 V door 30 Ω lampje: I = 0,1 A" }],
          basiskennis: [{ onderwerp: "eenheden checken", uitleg: "V/Ω geeft A" }],
          niveaus: { basis: "0,12 A.", simpeler: "12 / 100.", nogSimpeler: "Delen." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "U = I × R", tekst: "De Wet van Ohm in zijn basis-vorm. U (spanning) = I (stroom) maal R (weerstand). Een vermenigvuldiging." }],
          woorden: [{ woord: "Wet van Ohm", uitleg: "Georg Ohm, 1827" }],
          theorie: "Drie vormen: U = I·R, I = U/R, R = U/I. Allemaal afgeleid van dezelfde wet.",
          voorbeelden: [{ type: "voorbeeld", tekst: "I=2A, R=50Ω → U = 2×50 = 100 V" }],
          basiskennis: [{ onderwerp: "maal, niet plus", uitleg: "×, niet +" }],
          niveaus: { basis: "U = I × R.", simpeler: "Spanning = stroom × weerstand.", nogSimpeler: "Maal." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "R = U / I = 230/2 = 115 Ω", tekst: "Wet van Ohm omgeschreven: R = U / I. Met U=230 en I=2 → R = 115 Ω." }],
          woorden: [{ woord: "R", uitleg: "weerstand in ohm" }],
          theorie: "Driehoek-truc: bedek R, je leest U/I.",
          voorbeelden: [{ type: "voorbeeld", tekst: "U=12 V, I=0,5 A → R = 24 Ω" }],
          basiskennis: [{ onderwerp: "delen", uitleg: "U gedeeld door I" }],
          niveaus: { basis: "115 Ω.", simpeler: "230/2.", nogSimpeler: "Half van 230." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "serie", uitleg: "achter elkaar in één pad" }],
          theorie: "Serie: I gelijk, U som. Parallel: U gelijk, I som.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Oude kerstboomlampjes: serie, 1 stuk = alles uit" }],
          basiskennis: [{ onderwerp: "1 pad", uitleg: "geen splitsing" }],
          niveaus: { basis: "Stroomsterkte I.", simpeler: "Stroom overal hetzelfde.", nogSimpeler: "I gelijk." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "parallel", uitleg: "naast elkaar, eigen takken" }],
          theorie: "Onthoud: parallel = paar = U-paar (spanning gelijk).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Stopcontacten thuis: parallel — alle 230 V, 1 lamp stuk = rest werkt" }],
          basiskennis: [{ onderwerp: "eigen tak", uitleg: "elke verbruiker eigen pad" }],
          niveaus: { basis: "Spanning U.", simpeler: "U overal hetzelfde.", nogSimpeler: "Volt gelijk." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Serie: 1 stuk = alles uit", tekst: "Stroom moet door ALLE verbruikers in serie. Eén kapot = kring onderbroken = geen stroom = alles uit." }],
          woorden: [{ woord: "open kring", uitleg: "onderbroken pad" }],
          theorie: "Daarom worden kerstboomlampjes nu parallel gemaakt — bij stukke lamp blijven andere branden.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Oude kerstverlichting: 1 lampje stuk = hele kerstboom donker" }],
          basiskennis: [{ onderwerp: "geen alternatief pad", uitleg: "1 pad voor stroom" }],
          niveaus: { basis: "Alle lampen gaan uit.", simpeler: "Alles uit.", nogSimpeler: "Donker." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "P = U × I", tekst: "Vermogen P = spanning U × stroomsterkte I. Eenheid: watt (W) = V × A." }],
          woorden: [{ woord: "Watt (W)", uitleg: "eenheid vermogen, vernoemd naar James Watt" }],
          theorie: "Onthoud: P = U·I voor vermogen. Combineer met Wet van Ohm voor P = I²R of P = U²/R.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Stopcontact 230 V × 0,5 A = 115 W lamp" }],
          basiskennis: [{ onderwerp: "vermenigvuldigen", uitleg: "V × A = W" }],
          niveaus: { basis: "P = U × I.", simpeler: "Vermogen = spanning × stroom.", nogSimpeler: "Maal." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "delen omkeren", uitleg: "P = U × I → I = P / U" }],
          theorie: "Gloeilamp 100 W trekt minder dan 0,5 A. Krachtigere apparaten trekken meer A.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Waterkoker 2000 W: I = 2000/230 ≈ 8,7 A" }],
          basiskennis: [{ onderwerp: "P en U gegeven", uitleg: "delen om I te vinden" }],
          niveaus: { basis: "0,43 A.", simpeler: "100/230.", nogSimpeler: "Bijna half A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "1 kWh = 1 kW × 1 uur", tekst: "kWh is energie: vermogen (kW) maal tijd (uren). 1 kWh = apparaat van 1000 W dat 1 uur aan staat." }],
          woorden: [{ woord: "kWh", uitleg: "kilowattuur, eenheid van energie op stroomrekening" }],
          theorie: "Energie = vermogen × tijd. P in kW, t in u → E in kWh.",
          voorbeelden: [{ type: "voorbeeld", tekst: "10 W lamp × 100 uur = 1 kWh" }],
          basiskennis: [{ onderwerp: "verschil kW vs kWh", uitleg: "kW = vermogen NU, kWh = totaal verbruik" }],
          niveaus: { basis: "1 kW × 1 uur.", simpeler: "Vermogen × tijd.", nogSimpeler: "1000 W een uur." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "Wh", uitleg: "wattuur, 1/1000 kWh" }],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "I = U/R = 230/200 = 1,15 A", tekst: "Wet van Ohm: I = U/R. 230 ÷ 200 = 1,15 A." }],
          woorden: [{ woord: "delen", uitleg: "230 gedeeld door 200" }],
          theorie: "Even checken: 200 × 1,15 = 230 ✓",
          voorbeelden: [{ type: "voorbeeld", tekst: "100 V op 50 Ω: I = 2 A" }],
          basiskennis: [{ onderwerp: "Wet van Ohm-driehoek", uitleg: "bedek I" }],
          niveaus: { basis: "1,15 A.", simpeler: "230/200.", nogSimpeler: "Iets meer dan 1 A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "1500 W × 4 u = 6000 Wh = 6 kWh", tekst: "1500 W = 1,5 kW. 1,5 × 4 = 6 kWh. Of: 1500 × 4 = 6000 Wh = 6 kWh." }],
          woorden: [{ woord: "1500 W = 1,5 kW", uitleg: "delen door 1000" }],
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "in serie", uitleg: "achter elkaar" }],
          theorie: "Parallel: 1/R-tot = 1/R₁ + 1/R₂ (R-tot lager).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Drie 100 Ω in serie: R-tot = 300 Ω" }],
          basiskennis: [{ onderwerp: "optellen, niet maal", uitleg: "+, niet ×" }],
          niveaus: { basis: "200 Ω.", simpeler: "100 + 100.", nogSimpeler: "Dubbel." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "P = U + I is fout", tekst: "Vermogen is een vermenigvuldiging, geen optelling. P = U × I. Niet P = U + I." }],
          woorden: [{ woord: "×, niet +", uitleg: "vermenigvuldigen" }],
