...
const steps = [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Bij 3+ dingen.", "Bij 1 ding.", "Tijden, niet trap."],
      },
      {
        q: "Welke trap voor **'allerhoogste'**?",
        options: ["Superlative met 'the'", "Comparative", "Stellend", "Wisselt"],
        answer: 0,
        wrongHints: [null, "Vergrotend bij 2.", "Geen vergelijking.", "Wel vaste regel."],
      },
      {
        q: "**'My bag is ___ than yours.'** Welk woord?",
        options: ["bigger", "biggest", "big", "more big"],
        answer: 0,
        wrongHints: [null, "Niet voor 2 dingen.", "Geen 'than'.", "Niet voor 'big' (kort woord)."],
      },
      {
        q: "**'This is ___ car in the world.'** Welk woord (snelst)?",
        options: ["the fastest", "faster", "fast", "more fast"],
        answer: 0,
        wrongHints: [null, "Niet alle auto's.", "Geen vergelijking.", "Niet voor 'fast'."],
      },
    ],
  },
  ...
  // STAP 2: -er / -est voor korte woorden
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Vergrotend.", "Klopt qua 'the' maar woord verkeerd.", "Niet voor kort woord."],
      },
      {
        q: "**'I am ___ than my brother.'** (young)",
        options: ["younger", "youngest", "the youngest", "more young"],
        answer: 0,
        wrongHints: [null, "Niet vergelijking.", "Niet vergelijking.", "Niet voor 'young'."],
      },
      {
        q: "**'My car is the ___ in the street.'** (fast)",
        options: ["fastest", "faster", "fast", "more fast"],
        answer: 0,
        wrongHints: [null, "Vergrotend.", "Stellend.", "Niet voor 'fast'."],
      },
    ],
  },
  ...
  // STAP 6: Eind-toets
  {
    ...
    explanation:
      "Mix-toets in Doorstroomtoets-stijl. Door elkaar: kort/lang, regelmatig/onregelmatig, spelling.\n\nVeel succes!",
    checks: [
      {
        q: "**'tall'** in vergrotende trap?",
        options: ["taller", "tallest", "more tall", "the taller"],
        answer: 0,
        wrongHints: [null, "Overtreffend.", "Niet voor 'tall'.", "Geen 'the' bij vergrotend."],
      },
      {
        q: "**'good'** in overtreffende trap?",
        options: ["the best", "the goodest", "the better", "more good"],
        answer: 0,
        wrongHints: [null, "Bestaat niet.", "Vergrotend.", "Geen 'more' bij onregelmatig."],
      },
      {
        q: "**'expensive'** in vergrotende trap?",
        options: ["more expensive", "expensiver", "the most expensive", "expensivest"],
        answer: 0,
        wrongHints: [null, "Bestaat niet.", "Overtreffend.", "Bestaat niet."],
      },
      {
        q: "**'easy'** in overtreffende trap?",
        options: ["the easiest", "the easyest", "the most easy", "easier"],
        answer: 0,
        wrongHints: [null, "Spelling fout.", "Niet voor 'easy'.", "Vergrotend."],
      },
      {
        q: "**'I have ___ books than you.'** (many)",
        options: ["more", "manyer", "the most", "much more"],
        answer: 0,
        wrongHints: [null, "Bestaat niet.", "Overtreffend.", "Te veel."],
      },
      {
        q: "**'My grade is ___ than last year.'** (bad)",
        options: ["worse", "badder", "more bad", "worser"],
        answer: 0,
        wrongHints: [null, "Bestaat niet.", "Onregelmatig krijgt niet 'more'.", "Bestaat niet."],
      },
      { q: "**'This book is ___ than that one.'** (interesting)", options: ["more interesting","interestinger","more interestinger","interestingest"], answer: 0, wrongHints: [null,"Lang woord = 'more'.", "Dubbel.", "Overtreffend."] },
      { q: "**'She is ___ than her sister.'** (tall)", options: ["taller","more tall","tallest","more taller"], answer: 0, wrongHints: [null,"Kort woord = -er.", "Overtreffend.", "Dubbel."] },
      { q: "**'This is the ___ day of my life.'** (good — overtreffend)", options: ["best","goodest","most good","more best"], answer: 0, wrongHints: [null,"Bestaat niet.", "Onregelmatig.", "Dubbel."] },
      { q: "**'It's getting ___ and ___.'** (warm)", options: ["warmer / warmer","more warm / more warm","warm / warmest","warmest / warmest"], answer: 0, wrongHints: [null,"Korte woorden -er.", "Verkeerde vorm.", "Vervolg, niet super."] },
      { q: "**'Nothing is ___ than freedom.'** (precious)", options: ["more precious","preciouser","most precious","more preciouser"], answer: 0, wrongHints: [null,"Lang woord = more.", "Overtreffend.", "Dubbel."] },
      { q: "Een **comparative** (vergrotende trap) gebruik je als je ___ vergelijkt?", options: ["2 dingen","3 of meer dingen","Geen dingen","Niet relevant"], answer: 0, wrongHints: [null,"Dat is superlative.", "Wel relevant.", "Wel."] },
      { q: "Een **superlative** (overtreffende trap) gebruik je bij ___?", options: ["3 of meer dingen, of 'meeste/best'","2 dingen","1 ding","Geen"], answer: 0, wrongHints: [null,"Dat is comparative.", "Geen vergelijking nodig.", "Wel."] },
      { q: "**Open vraag**: maak de comparative van 'happy'.", kind: "open", acceptedAnswers: ["happier"], explanation: "Korte woorden eindigend op -y: vervang y door i + er → happier." },
      { q: "**Open vraag**: maak de superlative van 'fast'.", kind: "open", acceptedAnswers: ["fastest", "the fastest"], explanation: "Kort woord: +est → fastest." },
    ],
  },
];
