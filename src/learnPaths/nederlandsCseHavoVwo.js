    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-favoriet: 'wat is de functie van alinea X?' → vaak concessio + weerlegging-paar.",
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "P-O-patroon", tekst: "**Probleem-oplossing-structuur**: inleiding (probleem schetsen) → middendeel (mogelijke oplossingen analyseren) → slot (beste oplossing aanbevelen of vooruitblik). Veel gebruikt in beleids-artikelen, opinies. **toetsvraag-pattern**: 'Welk structuur-type heeft deze tekst?'" }],
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Anaphora", tekst: "**Dit / dat / deze / die / hij / zij / het** = anaforische verwijzing: terug naar iets eerder genoemd in tekst. toetsvraag: 'Waar verwijst *dit* in regel 23 naar?' → kijk eerdere zin/concept. Zelden cataforisch (vooruit): *Dit kun je niet ontkennen: feit X.*" }],
  ...
  // ─── E. Eindopdracht ──────────────────────────────────────
  {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Begin of eind", tekst: "**Hoofdgedachte** staat meestal in **inleiding** (thesis-zin, vaak alinea 1-2) of in **slot** (conclusie-alinea als bevestiging). Soms beide (introductie + bevestiging). Middendeel werkt argumenten uit. Toets-patroon: 'Wat is de hoofdgedachte?' — kijk eerst eerste + laatste alinea." }],
