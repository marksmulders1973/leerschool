    ...
    checks: [
      {
        ...
        answer: 1,
        wrongHints: [null,"Hardop lezen = technisch lezen.","Snelheid is iets anders.","Spelling is een andere skill."],
      },
      {
        ...
        answer: 1,
        wrongHints: [null,"Niet kort.","Veel meer dan 1 woord.","Niet zingen."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 1,
        wrongHints: [null,"Informatief geeft alleen feiten.","Verhalend vertelt een verhaal.","Beschrijven geeft details, niet overtuigen."],
      },
      {
        ...
        answer: 1,
        wrongHints: [null,"Sprookje is verhalend.","Opiniestuk is betogend.","Liedjes zijn vaak verhalend/poëtisch."],
      },
      {
        ...
        answer: 1,
        wrongHints: [null,"Voorbeelden komen overal voor.","Tijd-woord, niet specifiek voor betogend.","Gewoon zelfstandig naamwoord."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 1,
        wrongHints: [null,"'Maar' is tegenstelling.","'Bijvoorbeeld' is voorbeeld.","'Ten slotte' is opsomming/conclusie."],
      },
      {
        q: "Welk signaalwoord introduceert een **tegenstelling**?",
        options: ["dus","echter","ook","bijvoorbeeld"],
        answer: 1,
        wrongHints: [null,"'Dus' = conclusie.","'Ook' = opsomming.","'Bijvoorbeeld' = voorbeeld."],
      },
      {
        q: "Welk woord vat samen / sluit af?",
        options: ["kortom","ten eerste","echter","gisteren"],
        answer: 0,
        wrongHints: [null,"Begint juist een opsomming.","Tegenstelling.","Tijd-woord."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null,"Hoofdgedachte staat vaak in 1e zin maar IS niet de zin zelf.","Detail is geen hoofdgedachte.","Titel is een hint, maar niet altijd hoofdgedachte."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null,"Soms wel maar minder vaak.","Niet typisch.","Geen verband."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null,"Te selectief.","Sla niets over.","Titel is hint maar niet alleen."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null,"Te langzaam — dat is normaal lezen.","Skimmen is wel kort lezen, niet overslaan.","Gokken is niet skimmen."],
      },
      {
        q: "Wat is **scannen**?",
        options: ["Gericht zoeken naar een specifiek antwoord","Langzaam herlezen","De tekst kopiëren","Iemand anders laten lezen"],
        answer: 0,
        wrongHints: [null,"Niet hetzelfde.","Niet kopieren — alleen lezen.","Niet bij toets."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null,"Te tijdrovend.","Niet zonder lezen.","Tekst lezen is essentieel."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null,"Andersom — let op de NIET!","Doe wel een gok als je niet zeker bent.","Niets leeg laten."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null,"Inferentie staat niet letterlijk.","Wel iets invullen.","Wel iets invullen."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null,"Niet grappig — bewust verwarrend.","Soms juist lang.","Niet specifiek."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null,"'Echter' is tegenstelling.","'Bijvoorbeeld' = voorbeeld.","'Kortom' = conclusie."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null,"Letterlijke vraag.","Woordbetekenis-vraag.","Letterlijke vraag."],
      },
      {
