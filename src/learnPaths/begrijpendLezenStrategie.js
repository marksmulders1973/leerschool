...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Welk signaalwoord wijst op een **tegenstelling**?", options: ["maar","want","ook","bovendien"], answer: 0, wrongHints: [null,"Klopt — 'maar/echter/toch'.","Reden-woord.","Opsomming.","Opsomming."] },
      { q: "Welk signaalwoord wijst op **oorzaak-gevolg**?", options: ["daarom","ook","maar","echter"], answer: 0, wrongHints: [null,"Klopt — 'daarom/dus/zodat'.","Opsomming.","Tegenstelling.","Tegenstelling."] },
      { q: "Wat doe je bij **scannen**?", options: ["Snel zoeken naar 1 specifiek woord/feit","Letter voor letter lezen","Hele tekst hardop voorlezen","Tekenen erbij"], answer: 0, wrongHints: [null,"Klopt — bv. een telefoonnummer vinden.","Te traag — dat is gewoon lezen.","Niet relevant.","Niet."] },
      { q: "Wat doe je bij **skimmen**?", options: ["Tekst snel doorbladeren voor hoofdlijn","Heel langzaam lezen","Tekst overschrijven","Plaatjes bekijken"], answer: 0, wrongHints: [null,"Klopt — eerste/laatste zin per alinea pakken.","Tegenovergesteld.","Niet relevant.","Niet alleen plaatjes."] },
      { q: "Een **informatieve tekst** geeft vooral?", options: ["Feiten + uitleg","Mening","Spanning","Humor"], answer: 0, wrongHints: [null,"Klopt — bv. encyclopedie.","Dat is betoog.","Dat is verhaal.","Niet hoofddoel."] },
      { q: "Een **betogende tekst** wil de lezer?", options: ["Overtuigen","Informeren","Vermaken","Boos maken"], answer: 0, wrongHints: [null,"Klopt — mening + argumenten.","Informatieve tekst.","Verhalende/amuserende.","Niet de bedoeling."] },
      { q: "Een **letterlijke vraag** zoek je antwoord?", options: ["Direct in de tekst","Door erover na te denken","Door te raden","Buiten de tekst"], answer: 0, wrongHints: [null,"Klopt — vraag = exact te vinden.","Dat is inferentie.","Niet — wel zoeken.","Tekst is bron."] },
      { q: "Een **inferentie-vraag** vraagt om?", options: ["Conclusie trekken uit gegevens","Letterlijk citeren","Tellen","Geen antwoord"], answer: 0, wrongHints: [null,"Klopt — 'tussen de regels lezen'.","Dat is letterlijke vraag.","Niet relevant.","Wel antwoord — bedenken."] },
      { q: "Bij welk **woord** weet je 'het komt eraan': de schrijver gaat **iets opsommen**?", options: ["ten eerste","echter","daarom","kortom"], answer: 0, wrongHints: [null,"Klopt — opening van opsomming.","Tegenstelling.","Reden.","Conclusie."] },
      { q: "*'Kortom: lezen is belangrijk.'* — welk soort zin?", options: ["Conclusie","Vraag","Opsomming","Tegenstelling"], answer: 0, wrongHints: [null,"Klopt — samenvattend.","Geen vraagteken.","Geen lijst.","Geen 'maar'."] },
      { q: "Welke **alinea** bevat meestal de hoofdgedachte van de hele tekst?", options: ["Inleiding of slot","De middelste alinea","Een random alinea","Geen"], answer: 0, wrongHints: [null,"Klopt — kern wordt vaak voor- of nabesproken.","Niet altijd.","Niet random — er is patroon.","Wel — vaak duidelijk."] },
      { q: "Welke **tekstsoort** is een dagboek?", options: ["Verhalend (persoonlijk)","Informatief","Betogend","Schoolboek"], answer: 0, wrongHints: [null,"Klopt — verhaal vanuit ik-perspectief.","Geen feiten-uitleg.","Geen overtuiging.","Niet schoolboek."] },
      { q: "Wat is een **kernzin**?", options: ["Zin met hoofdpunt van alinea","Eerste zin altijd","Laatste zin altijd","Langste zin"], answer: 0, wrongHints: [null,"Klopt — meestal eerst, soms anders.","Vaak wel, niet altijd.","Soms wel, niet altijd.","Niet relevant."] },
      { q: "Welk woord in zin betekent **bovendien**?", options: ["daarnaast","echter","want","kortom"], answer: 0, wrongHints: [null,"Klopt — opsomming/toevoeging.","Tegenstelling.","Reden.","Conclusie."] },
      { q: "Wat is een **alinea**?", options: ["Stukje tekst met 1 onderwerp/idee","Hele bladzijde","1 zin","Titel"], answer: 0, wrongHints: [null,"Klopt — meestal nieuwe regel/witregel.","Te groot.","Te klein — meerdere zinnen.","Niet hetzelfde."] },
    ],
  },
];
