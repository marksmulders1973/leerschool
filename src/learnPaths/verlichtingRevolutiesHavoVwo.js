    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kant.", simpeler: "Sapere aude = Kant", nogSimpeler: "Kant" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Trias politica.", simpeler: "Montesquieu = scheiding", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Diderot.", simpeler: "Encyc. = Diderot", nogSimpeler: "Diderot" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Pruisen Frederik.", simpeler: "Verlicht desp. = Frederik", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vrouwen.", simpeler: "Wollst. = vrouwen-rechten", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4 juli 1776.", simpeler: "4-7-1776", nogSimpeler: "1776" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Jefferson.", simpeler: "Jefferson = onafh.verkl.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen belasting zonder vert.", simpeler: "No tax w/o rep", nogSimpeler: "A." },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Robespierre.", simpeler: "Terreur = Robespierre", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verlichting + VS.", simpeler: "Verlichting+VS", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "L/É/F.", simpeler: "Frans motto = vrijheid-gelijk", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "18 Brumaire 1799.", simpeler: "1799 staatsgreep", nogSimpeler: "1799" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "18 juni 1815.", simpeler: "1815 Waterloo", nogSimpeler: "1815" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Winter + tactiek.", simpeler: "1812 = winter+Rus", nogSimpeler: "A." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Locke.", simpeler: "VS = Locke", nogSimpeler: "Locke" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rousseau.", simpeler: "Contrat social = Rousseau", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1776 = VS.", simpeler: "1776 = VS-onafh.", nogSimpeler: "1776" },
        },
      },
      {
