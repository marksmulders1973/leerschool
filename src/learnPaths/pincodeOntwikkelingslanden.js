    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Inkomen+levensverwachting+onderwijs.", simpeler: "HDI = 3 dingen samen: geld + leeftijd + scholing.", nogSimpeler: "3 dingen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "50-65 jaar.", simpeler: "Arm land levensverwachting = 50-65 jaar. Rijk ~80.", nogSimpeler: "50-65" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Nederland.", simpeler: "NL = West-Europa, hoge HDI ~0,94. Andere opties = arme landen.", nogSimpeler: "NL" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~700 miljoen.", simpeler: "Extreme armoede 2020 = ~700 miljoen. Daalde van 1,9 mrd (1990).", nogSimpeler: "700 mln" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Reflecteert zorg+voeding+hygiëne.", simpeler: "Kindersterfte raakt 4 dingen tegelijk: zorg + voeding + hygiëne + woon. Goede maat.", nogSimpeler: "Alles tegelijk" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "<$1.135/jaar BBP/hoofd.", simpeler: "Lage-inkomen-land = gemiddelde inkomen <$1.135/jaar/persoon.", nogSimpeler: "$1.135" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Alleen materieel.", simpeler: "Welvaart enge zin = alleen geld + spullen. Ruime zin = ook welzijn erbij.", nogSimpeler: "Materieel" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Noord-Europa.", simpeler: "Hoogste geluk = Finland, Denemarken, NL. Noord-Europese mix.", nogSimpeler: "Scandinavië+NL" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Boven drempel geen extra geluk.", simpeler: "Easterlin = boven ~$20-30k levert extra geld nauwelijks meer geluk. Drempelwaarde.", nogSimpeler: "Genoeg=genoeg" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "11 dimensies.", simpeler: "Better Life Index meet 11 aspecten kwaliteit leven (OESO).", nogSimpeler: "11 dimensies" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "BBP.", simpeler: "Bhutan vervangt BBP door GNH = geluksmeting.", nogSimpeler: "BBP" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4 pijlers.", simpeler: "Gelukkig maakt: sociale relaties + gezondheid + doel + autonomie.", nogSimpeler: "4 dingen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Armoede voedt zichzelf.", simpeler: "Vicieuze cirkel = arm → geen scholen → ongeschoolde werkers → blijft arm.", nogSimpeler: "Voedt zichzelf" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verwerking elders.", simpeler: "Ruwe export = land mist verwerking-winst (90%+ waarde).", nogSimpeler: "Verwerking elders" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Zuid-Korea.", simpeler: "ZK was 1960 armer dan Ghana, nu top-rijk. Door onderwijs + export.", nogSimpeler: "ZK" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Slechte grenzen + mono-cultuur.", simpeler: "Kolonisatie-erfenis = grenzen + economie door Westen gemaakt voor zichzelf.", nogSimpeler: "Slechte grenzen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rente eet budget op.", simpeler: "Schulden = rente eet jaarlijks geld op, niet meer voor onderwijs/zorg.", nogSimpeler: "Rente eet" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hervormingen + export.", simpeler: "China success = Deng hervormingen 1978, opening + export, 800 mln uit armoede.", nogSimpeler: "Hervormingen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Meerdere landen samen.", simpeler: "Multilateraal = via VN/EU/Wereldbank, meerdere landen samen.", nogSimpeler: "Samen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Artsen zonder Grenzen.", simpeler: "Noodhulp-NGO = Artsen zonder Grenzen (AzG). Medische rampenhulp.", nogSimpeler: "AzG" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Lokale producenten verliezen.", simpeler: "Gratis hulp = lokale producent kan niet concurreren, gaat failliet.", nogSimpeler: "Lokaal verliest" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~0,5%.", simpeler: "NL ontwikkelingsbudget = ~0,5% BBP, onder UN-norm 0,7%.", nogSimpeler: "0,5%" },
        },
      },
      {
        q: "Wat is **Fair Trade**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Eerlijke boerenprijs.", simpeler: "Fair Trade = boer arme land krijgt eerlijke + minimum-prijs. Keurmerk.", nogSimpeler: "Eerlijke prijs" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Migranten-geld.", simpeler: "Remittances = geld dat migranten naar familie thuis sturen. $700 mrd/jaar wereld.", nogSimpeler: "Geld naar familie" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "17 VN-doelen 2030.", simpeler: "SDG = Sustainable Development Goals = 17 VN-doelen voor 2030.", nogSimpeler: "17 doelen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "People+Planet+Profit.", simpeler: "3 P's duurzaamheid = People (mensen) + Planet (milieu) + Profit (winst).", nogSimpeler: "3 P's" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kleine ondernemers arme landen.", simpeler: "Microkrediet = mini-lening (€50-500) voor beginnende ondernemer arm land.", nogSimpeler: "Kleine lening" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Muhammad Yunus.", simpeler: "Microkrediet Nobelprijs 2006 = Muhammad Yunus (Grameen Bank Bangladesh).", nogSimpeler: "Yunus" },
        },
      },
      {
        q: "**Leapfrogging** is:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Stappen overslaan.", simpeler: "Leapfrogging = arme landen slaan tech-stappen over (vaste tel → direct mobiel).", nogSimpeler: "Overslaan" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Weinig CO2, veel schade.", simpeler: "Arme landen veroorzaken weinig CO2 maar lijden meeste klimaatschade. Onrechtvaardig.", nogSimpeler: "Slachtoffer" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Eerlijke prijs + premie.", simpeler: "Fair Trade = eerlijke (hogere) prijs voor boer + extra geld voor dorp-projecten.", nogSimpeler: "Eerlijke prijs" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Max Havelaar/Fairtrade/UTZ.", simpeler: "Koffie/cacao-keurmerk = Max Havelaar + Fairtrade + UTZ. EU-bio = ander (alle bio-eten).", nogSimpeler: "Max Havelaar" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vals duurzaam imago.", simpeler: "Greenwashing = bedrijven doen groener dan ze zijn, voor marketing.", nogSimpeler: "Nep-groen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Minder vlees, niet geen.", simpeler: "Flexitariër = eet minder vlees (2-3×/week) maar niet helemaal geen.", nogSimpeler: "Beetje vlees" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~15.000 L.", simpeler: "1 kg rundvlees ≈ 15.000 liter water (drinkbaar+veevoer+stal).", nogSimpeler: "15.000" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kopen = invloed.", simpeler: "'Stem met je portemonnee' = wat je koopt beïnvloedt wat bedrijven maken. Macht consument.", nogSimpeler: "Kopen = stemmen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Onderwijs meisjes.", simpeler: "Meest effectief = onderwijs, vooral voor meisjes. Levenslang multiplicator.", nogSimpeler: "Scholing meisjes" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~73 jaar.", simpeler: "Wereldwijd levensverwachting nu ~73 jaar (was 32 in 1900).", nogSimpeler: "73" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Afrika.", simpeler: "Afrika groeit het snelst: 1,4 → 2,5 miljard tegen 2050.", nogSimpeler: "Afrika" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1,9 mrd → 700 mln.", simpeler: "Extreme armoede daalde 1990 (1,9 mrd) naar 2020 (700 mln). Sterke daling.", nogSimpeler: "Sterke daling" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Klimaatverandering.", simpeler: "#1 uitdaging = klimaat. Arme landen geraakt door droogte/zeespiegel/storm.", nogSimpeler: "Klimaat" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Leren+internationaal+bewust.", simpeler: "Toekomst-burger: levenslang leren + globaal denken + bewuste keuzes maken.", nogSimpeler: "Doorgaan leren" },
        },
      },
    ],
  },
