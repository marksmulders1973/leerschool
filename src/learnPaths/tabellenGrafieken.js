    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Staafdiagram. A.", simpeler: "Vergelijken groepen → staafdiagram (balken naast elkaar).", nogSimpeler: "Staaf" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Lijngrafiek. A.", simpeler: "Tijd-verloop = lijngrafiek. Per maand een jaar lang = tijd = lijn.", nogSimpeler: "Lijn" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Titel + assen eerst. A.", simpeler: "Stap 1 grafiek-vraag = titel + assen lezen voor context.", nogSimpeler: "Eerst lezen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6 (vanille×do). A.", simpeler: "Rij vanille + kolom do = 6 ijsjes.", nogSimpeler: "6" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vrijdag (29 stuks). A.", simpeler: "Som per dag. Vr=29 hoogst.", nogSimpeler: "Vr" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "44 (rij choco). A.", simpeler: "7+10+5+9+13 = 44.", nogSimpeler: "44" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Voetbal (hoogst). A.", simpeler: "Hoogste balk = voetbal (28).", nogSimpeler: "Voetbal" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "20 (28-8). A.", simpeler: "Voetbal 28, judo 8. Verschil = 28-8 = 20.", nogSimpeler: "20" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "35 (andere balken). A.", simpeler: "NIET voet/zwem = tennis+hockey+judo = 15+12+8 = 35.", nogSimpeler: "35" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Zaterdag (27). A.", simpeler: "Hoogste punt = zaterdag (27°C).", nogSimpeler: "Za" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "11 (27-16). A.", simpeler: "Ma 16, za 27. Verschil 27-16 = 11°C.", nogSimpeler: "11" },
        },
      },
      {
        disabled: true, // leunt op step.svg (lijngrafiek temperaturen ma-zo).
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Do + zo (lijn omlaag). A.", simpeler: "Daling = lijn omlaag. Donderdag (22→18) + zondag (27→23).", nogSimpeler: "Do+zo" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "10 (40÷4). A.", simpeler: "25% van 40 = 1/4 × 40 = 10 leerlingen.", nogSimpeler: "10" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "50% (20+30). A.", simpeler: "Groen 20% + Blauw 30% = 50%.", nogSimpeler: "50%" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8 (40% × 20). A.", simpeler: "10% van 20 = 2. 40% = 4 × 2 = 8.", nogSimpeler: "8" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "26 (130÷5). A.", simpeler: "Som 130 ÷ 5 dagen = 26 gemiddeld.", nogSimpeler: "26" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "45% (18÷40×100). A.", simpeler: "Hond: 18 ÷ 40 = 0,45 = 45%.", nogSimpeler: "45%" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Dag 3→4 (19→17). A.", simpeler: "Enige daling: dag 3 (19°) → dag 4 (17°).", nogSimpeler: "3→4" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Eva (32). A.", simpeler: "Hoogste balk = Eva (32 rondjes).", nogSimpeler: "Eva" },
        },
      },
      {
        disabled: true, // leunt op step.svg (staafdiagram Tom/Eva/Ali/Lisa).
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "52 (24+28). A.", simpeler: "Tom 24 + Lisa 28 = 52 rondjes samen.", nogSimpeler: "52" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "14 (32-18). A.", simpeler: "Eva 32, Ali 18. Verschil = 32-18 = 14.", nogSimpeler: "14" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "25,5 (102÷4). A.", simpeler: "Som 102 ÷ 4 kinderen = 25,5 gemiddeld.", nogSimpeler: "25,5" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geel (15%). A.", simpeler: "Kwart = 25%. Geel 15% < 25%. Enige stuk MINDER dan kwart.", nogSimpeler: "Geel" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7 (25-18). A.", simpeler: "Warmste 25, koudste 18. Verschil 25-18 = 7.", nogSimpeler: "7" },
        },
      },
