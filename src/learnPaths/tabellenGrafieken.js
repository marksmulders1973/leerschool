...
const steps = [
...

  {
    ...
    checks: [
      ...
      { q: "Welk soort grafiek voor **30% jongens / 70% meisjes**?", options: ["Cirkel/taartdiagram","Lijngrafiek","Staafdiagram","Verspreidingsdiagram"], answer: 0, wrongHints: [null,"Klopt — verdeling.","Niet verloop.","Soms maar niet ideaal.","Niet."] },
      { q: "Tabel: rijen = leerlingen, kolommen = vakken. Welke cel = Anna's wiskunde-cijfer?", options: ["Rij Anna × kolom Wiskunde","Anna × klas","Top-rij","Onderste rij"], answer: 0, wrongHints: [null,"Klopt — kruispunt.","Niet.","Header.","Niet."] },
      { q: "Welke tabel-cel staat **gemiddeld**?", options: ["Vaak onderaan (kolom-totaal)","Linksboven","Verspreid","Niet in tabel"], answer: 0, wrongHints: [null,"Klopt — vaak laatste rij.","Niet — daar staat label.","Niet — apart vermeld.","Wel."] },
      { q: "Bij **categorie-data** (kleuren, vakken) is beste grafiek?", options: ["Staafdiagram","Lijngrafiek","Verspreidingsdiagram","Heatmap"], answer: 0, wrongHints: [null,"Klopt — vergelijken.","Niet — geen tijdvolgorde.","Niet inhoudelijk.","Niet voor kinderen."] },
      { q: "Bij **percentages die samen 100% zijn**: kies?", options: ["Cirkeldiagram","Staafdiagram","Lijngrafiek","Tabel"], answer: 0, wrongHints: [null,"Klopt — verdeling.","Soms.","Niet voor verdeling.","Wel mogelijk maar niet visueel."] },
      { q: "In een **kolom** van een tabel staan typisch?", options: ["Verticale waarden (onder elkaar)","Horizontale data","Plaatjes","Tekst"], answer: 0, wrongHints: [null,"Klopt.","Dat is rij.","Niet inhoud.","Soms."] },
      { q: "Bij **lijngrafiek 'temperatuur per dag'**: hoogste piek = ?", options: ["Warmste dag","Koudste dag","Begin","Eind"], answer: 0, wrongHints: [null,"Klopt — top.","Dal.","Niet inhoud — links.","Niet."] },
      { q: "**Kolom-totaal** in tabel = ?", options: ["Som van alle cellen in die kolom","Som van 1 rij","Gemiddelde","Modus"], answer: 0, wrongHints: [null,"Klopt — verticale optelling.","Dat is rij-totaal.","Niet som.","Niet som."] },
      { q: "Welk **schaal-probleem** kan grafiek misleidend maken?", options: ["Y-as begint niet bij 0","Lijngrafiek","Veel data","Mooi getekend"], answer: 0, wrongHints: [null,"Klopt — vergroot verschillen.","Niet inhoud zelf.","Niet probleem.","Niet relevant."] },
      { q: "Welke gegevens zet je **niet** in een cirkeldiagram?", options: ["Verloop in tijd","Verdeling","Procenten","Verhouding"], answer: 0, wrongHints: [null,"Klopt — daarvoor lijn.","Wel — kern.","Wel.","Wel."] },
      { q: "Bij **'meeste/minste'-vraag in staaf**: kijk naar?", options: ["Hoogste/laagste staaf","Eerste staaf","Laatste","Random"], answer: 0, wrongHints: [null,"Klopt.","Niet zonder kijken.","Niet zonder kijken.","Niet."] },
      { q: "Een **frequentietabel** toont?", options: ["Hoe vaak elke waarde voorkomt","Tijd-verloop","Verhouding","Som"], answer: 0, wrongHints: [null,"Klopt — telling per waarde.","Lijngrafiek.","Niet.","Niet enkel."] },
      { q: "Bij grafiek-vraag: **eerst** doen?", options: ["Titel + assen lezen","Direct antwoord raden","Telling totaal","Naam tellen"], answer: 0, wrongHints: [null,"Klopt — context.","Niet — fout.","Soms maar niet eerst.","Niet."] },
      { q: "Welke vraag bij **tabel** is moeilijkst?", options: ["Optellen meerdere cellen + interpreteren","Naam zoeken","Datum lezen","Titel lezen"], answer: 0, wrongHints: [null,"Klopt — combineren.","Te makkelijk.","Niet.","Niet."] },
      { q: "Een **histogram** lijkt op?", options: ["Staafdiagram (voor frequentie)","Lijn","Taart","Tijdslijn"], answer: 0, wrongHints: [null,"Klopt — staven samen.","Niet.","Niet.","Niet."] },
    ],
  },
];
