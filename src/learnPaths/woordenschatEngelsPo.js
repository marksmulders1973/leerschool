...
const steps = [
  ...
  },
  {
    ...
    checks: [
      { q: "Wat is **5** in Engels?", options: ["five", "four", "six", "fifteen"], answer: 0, wrongHints: [null, "4 = four.", "6 = six.", "15 = fifteen."] },
      { q: "Wat is **12** in Engels?", options: ["twelve", "ten", "two", "twenty"], answer: 0, wrongHints: [null, "10 = ten.", "2 = two.", "20 = twenty."] },
      { q: "Wat is **17** in Engels?", options: ["seventeen", "seven", "seventy", "sixteen"], answer: 0, wrongHints: [null, "7 = seven.", "70 = seventy.", "16 = sixteen."] },
      { q: "Wat is **40** in Engels?", options: ["forty", "fourteen", "four", "fourty"], answer: 0, wrongHints: [null, "14 = fourteen.", "4 = four.", "Niet — 'forty' zonder u (uitzondering)."] },
      { q: "Welk getal is **eighty**?", options: ["80", "8", "18", "800"], answer: 0, wrongHints: [null, "8 = eight.", "18 = eighteen.", "Te veel — 800 = eight hundred."] },
    ],
  },
  {
