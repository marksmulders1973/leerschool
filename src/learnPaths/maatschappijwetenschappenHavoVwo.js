    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Koning gebonden aan grondwet.", simpeler: "Const. = grondwet boven koning", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "PvdA-GL.", simpeler: "Soc-dem = PvdA-GL", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "40k → parlement.", simpeler: "Burgerinit. = 40k handt.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "PVV/VVD/NSC/BBB.", simpeler: "Schoof = 4 partijen", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Cognitief.", simpeler: "Cult/taal = cognitief", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Familie.", simpeler: "Primair = gezin", nogSimpeler: "Gezin" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-actueel: COVID-maatregelen, klimaat, migratie, Israël-Palestina-debat hebben affectieve polarisatie versterkt.",
          niveaus: { basis: "Emotionele afkeer.", simpeler: "Affectief pol = emotie", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Mech → org.", simpeler: "Durkheim 2 soorten", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tussen groepen.", simpeler: "Bridging = brug tussen", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Religie kwijnt.", simpeler: "Secul = religie minder", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Calvinistisch.", simpeler: "Weber = calvinisme + kap", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-patroon: 'leg uit waarom onderwijssucces deels afhangt van gezinscultuur' → Bourdieu's habitus + cultureel kapitaal.",
          niveaus: { basis: "Aangeleerd.", simpeler: "Habitus = aangeleerde stijl", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Eigen risico's.", simpeler: "Beck = nieuwe risico's", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "toetsvraag-pattern: 'koppel maatschappelijke verandering aan generatie'. Bv: klimaatbeleid groot voor Gen Z, pensioen voor boomers.",
          niveaus: { basis: "Smartphone + klimaat.", simpeler: "Gen Z = smartphone + klimaat", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Mening.", simpeler: "Klassiek = vrijheid", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-actueel: NL veroordeeld 2023 om Klimaatzaak Urgenda + Toeslagenaffaire-elementen.",
          niveaus: { basis: "EVRM bindend.", simpeler: "EVRM = bindend", nogSimpeler: "A." },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-patroon: 'leg uit waarom Toeslagenaffaire schadelijk voor rechtsstaat'. Antwoord: schending grondrechten + onafhankelijke rechter omzeild.",
          niveaus: { basis: "Rechtsstaat.", simpeler: "Toeslagen = rechtsstaat", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Resocialisatie.", simpeler: "Doel = resocial.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Cognitief.", simpeler: "Waarden = cognitief", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "VVD.", simpeler: "Liberaal-rechts = VVD", nogSimpeler: "A." },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tirannie.", simpeler: "Trias = anti-tirannie", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-trend: opkomst populisme in westen sinds 2008-crisis + 2016 (Brexit, Trump).",
          niveaus: { basis: "Volk vs elite.", simpeler: "Populisme = volk vs elite", nogSimpeler: "A." },
        },
      },
    ],
  },
