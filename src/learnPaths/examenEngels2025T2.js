    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc 'doel van tekst': geen oproep + geen verhaal + alleen feiten = informatief. Werkwoord-cue 'informatie geven' = match.",
          ...
          niveaus: { basis: "Informatie over koemest-energie.", simpeler: "Pure feiten over biogas uit koeien = informatieve tekst.", nogSimpeler: "B = informatie." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        explanation: "Sleutel-zin alinea 2: *'Joan ... admits she was a little tired of hearing her aunt boast about her unbeaten record.'* En: *'So I said: prove it.'* Joan was de eeuwige opscheppen-verhalen zat → uitdaagde Adell om het te bewijzen. 'Fed up with boasting' = klaar met opschepperij =",
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc 'why' Engels: 'tired of' / 'fed up' / 'so I/she/he decided' zijn vaak motief-aanwijzingen. Match Nederlandse parafrase.",
          ...
          niveaus: { basis: "Klaar met Adell's opschepperij.", simpeler: "Joan was 'tired of hearing her aunt boast' → uitdagen om te bewijzen.", nogSimpeler: "C = fed up boasting." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc 'how does writer introduce' Engels: kijk welke werkwoord-soort het opening-alinea gebruikt. 'I use', 'I am writing', 'I know' = persoonlijke ervaring = tell about experiences.",
          ...
          niveaus: { basis: "Persoonlijke ervaringen vertellen.", simpeler: "Schrijver deelt eigen telefoon-gebruik = 'tell about her experiences'.", nogSimpeler: "D = experiences." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc 'main point' Engels: zoek de zin met de meest-algemene uitspraak in de alinea. Specifieke cijfers (size 10/14/16) zijn voorbeelden van die algemene uitspraak.",
          ...
          niveaus: { basis: "Maten-schaal is veranderd door de jaren.", simpeler: "Wat nu 10 heet, was 60 jaar geleden 14-16. De schaal verschoof geleidelijk.", nogSimpeler: "C = scale changed." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [
            ...
            { titel: "Mocking match", tekst: "**Mocking** = spottend / ironisch / belachelijk-makend (zonder direct te beledigen). Verteller maakt grap over Ami's blinde zelfbeeld — niet onbeleefd hardop, maar via subtle ironie." },
          ],
          ...
          theorie: "Toets-truc toon-vraag in verhaal: kijk naar de DISSONANTIE — verteller zegt iets dat tegenstrijdig is met wat het personage van zichzelf denkt. Dat is bijna altijd mocking/ironisch.",
          ...
          niveaus: { basis: "Mockend / spottend.", simpeler: "Verteller ziet dat zus zich bridezilla-achtig gedraagt en ironiseert dat met 'define bridezilla' = spottend.", nogSimpeler: "Mocking" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        explanation: "Alinea 1: *'discovered she was 100 per cent Māori after taking a DNA test in 2017. The newsreader then decided to adopt the Māori tattoo in 2019 in a process known as Tā moko, which represents family heritage and social status.'* Reden: DNA-test bevestigde dat ze 100% Māori is → ze koos toen om de **tradities van haar etnische achtergrond** te omhelzen via tā moko.",
        ...
        uitlegPad: {
          ...
          theorie: "Toets-truc Engels 'why'-vraag: vind in de tekst het tijd-pad (X gebeurde, daarom Y). Hier: 2017 DNA → 2019 tattoo = directe causale lijn naar identiteit-embrace.",
          ...
          niveaus: { basis: "Omarmen van etnische traditie.", simpeler: "DNA-test = 100% Māori → koos tā moko om Māori-erfgoed te omarmen.", nogSimpeler: "Embrace traditions" },
        },
      },
    ],
  },
