    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Okt 1929.", simpeler: "1929 krach", nogSimpeler: "1929" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Lenin.", simpeler: "Vóór Stalin = Lenin", nogSimpeler: "Lenin" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "30 jan 1933.", simpeler: "1933 Hitler", nogSimpeler: "1933" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Niet-aanval + verdeel.", simpeler: "M-R = niet-aanval+verdelen", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "14 mei 1940.", simpeler: "Bombardement = 14-5-40", nogSimpeler: "1940" },
        },
      },
      {
        q: "Wanneer **D-Day**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6 juni 1944.", simpeler: "D-Day = 6-6-44", nogSimpeler: "1944" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Pearl Harbor.", simpeler: "1941 Pearl Harbor", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Endlösung.", simpeler: "Wannsee = uitroeiing", nogSimpeler: "A." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Symbolische scheiding.", simpeler: "IJG = Oost-West scheiding", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "13-8-1961.", simpeler: "Muur 1961", nogSimpeler: "1961" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1962.", simpeler: "Cuba = 1962", nogSimpeler: "1962" },
        },
      },
      {
        q: "**Marshall-Plan** was:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "VS hulp WEU.", simpeler: "Marshall = VS-hulp", nogSimpeler: "A." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gorbatsjov.", simpeler: "Laatste = Gorbatsjov", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9 nov 1989.", simpeler: "1989 Muur valt", nogSimpeler: "1989" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Openheid.", simpeler: "Glasnost = openheid", nogSimpeler: "A." },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "War on Terror.", simpeler: "9/11 → War on Terror", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Polen-inval.", simpeler: "1939 Polen", nogSimpeler: "1939" },
        },
      },
      {
        q: "Wat is **NATO**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Militaire alliantie.", simpeler: "NAVO = West-alliantie", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Noord vs Zuid Korea.", simpeler: "Korea = N-Z", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "27-12-1949.", simpeler: "1949 = NL erkent", nogSimpeler: "1949" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1945-1991.", simpeler: "KO = 1945-91", nogSimpeler: "A." },
        },
      },
    ],
  },
