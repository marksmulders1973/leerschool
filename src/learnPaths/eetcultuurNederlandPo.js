...
const steps = [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — sinds Leiden 1574.", "Japans.", "Italiaans.", "Italiaans."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — roze of blauw.", "Niet.", "Niet.", "Niet."],
      },
      {
        q: "Hoeveel **kaas per persoon NL** per jaar?",
        options: ["~14 kg", "1 kg", "100 kg", "Geen"],
        answer: 0,
        wrongHints: [null, "Klopt — wereldtop.", "Te weinig.", "Te veel.", "Wel."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Japans.", "Russisch.", "Wel."],
      },
      {
        q: "Welke kaas heeft **rood waxlaagje**?",
        options: ["Edammer", "Goudse", "Leerdammer", "Brie"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Andere.", "Andere.", "Frans."],
      },
      {
        q: "Wat is **vla**?",
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — niet in Indonesië zelf.", "Niet.", "Niet.", "Wel."],
      },
      {
        q: "Welke is **Surinaams**?",
        options: ["Roti", "Sushi", "Pizza", "Stamppot"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Japans.", "Italiaans.", "Hollands."],
      },
      {
        q: "Welke is **Indonesisch**?",
        options: ["Nasi goreng", "Roti", "Lahmacun", "Pizza"],
        answer: 0,
        wrongHints: [null, "Klopt — gebakken rijst.", "Surinaams.", "Turks.", "Italiaans."],
      },
      {
  ...
  },
  {
    ...
    checks: [
      { q: "Welke is **typisch Hollands**?", options: ["Stamppot + haring", "Sushi", "Pizza", "Tajine"], answer: 0, wrongHints: [null, "Klopt.", "Japans.", "Italiaans.", "Marokkaans."] },
      { q: "Wat is **hagelslag**?", options: ["Chocolade-hagel op brood (NL)", "Vis", "Vlees", "Kaas"], answer: 0, wrongHints: [null, "Klopt.", "Niet.", "Niet.", "Niet."] },
      { q: "Welke is **Indonesisch**?", options: ["Saté", "Roti", "Tajine", "Pizza"], answer: 0, wrongHints: [null, "Klopt.", "Surinaams.", "Marokkaans.", "Italiaans."] },
      { q: "**Goudse kaas** komt uit?", options: ["Gouda (NL)", "Italië", "Frankrijk", "Niet bestaand"], answer: 0, wrongHints: [null, "Klopt — markt sinds 1395.", "Niet.", "Brie wel.", "Wel."] },
      { q: "**Vis** aanbevolen aantal per week?", options: ["1 keer (omega-3)", "Dagelijks", "Nooit", "Maandelijks"], answer: 0, wrongHints: [null, "Klopt.", "Te veel.", "Wel.", "Te weinig."] },
      { q: "**Stroopwafel** uit?", options: ["Gouda (1810)", "Amsterdam", "Frankrijk", "Indonesië"], answer: 0, wrongHints: [null, "Klopt.", "Niet.", "Niet.", "Niet."] },
    ],
  },
];
