    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is mengsel.", "Pure stof kan ook vast of gas zijn.", "Wel bekend."],
      },
      {
        q: "Welke is een **pure stof**?",
        options: ["Water (H₂O)", "Soep", "Lucht", "Brons"],
        answer: 0,
        wrongHints: [null, "Klopt — verbinding van 2 elementen.", "Mengsel veel dingen.", "Mengsel gassen.", "Mengsel metalen."],
      },
      {
        q: "Welke is een **mengsel**?",
        options: ["Zoutwater", "Goud", "Zuurstof", "Koper"],
        answer: 0,
        wrongHints: [null, "Klopt — water + zout.", "Element = pure stof.", "Element.", "Element."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Wel verschil.", "Andersom soms.", "Niet over grootte."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is suspensie.", "Dat is emulsie.", "Dat is schuim."],
      },
      {
        q: "Melk is een ... ?",
        options: ["Emulsie (vet in water)", "Oplossing", "Suspensie", "Pure stof"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet — melk niet helder.", "Wel troebel, maar specifiek emulsie.", "Mengsel, geen pure stof."],
      },
      {
        q: "Wat is **brons**?",
        options: ["Legering (mengsel metalen)", "Pure stof", "Emulsie", "Schuim"],
        answer: 0,
        wrongHints: [null, "Klopt — koper + tin.", "Mengsel.", "Niet vloeibaar normaal.", "Niet schuim."],
      },
      {
        q: "Wat is **mist**?",
        options: ["Aerosol (water-druppels in lucht)", "Oplossing", "Emulsie", "Schuim"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet vloeibaar primair.", "Niet 2 vloeistoffen.", "Niet gas in vloeistof."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — zand blijft in filter.", "Dan blijft zand én iets uit water; veel verlies.", "Voor 2 vloeistoffen.", "Voor kleurstoffen."],
      },
      {
        q: "Hoe haal je **zout uit zeewater**?",
        options: ["Indampen (verdampen)", "Filtreren", "Bezinken", "Chromatografie"],
        answer: 0,
        wrongHints: [null, "Klopt — water verdampt, zout blijft.", "Zout zit opgelost.", "Zout niet zwaarder dan water.", "Geen kleuren."],
      },
      {
        q: "Hoe haal je **alcohol uit wijn**?",
        options: ["Destilleren", "Indampen", "Filtreren", "Bezinken"],
        answer: 0,
        wrongHints: [null, "Klopt — verschillende kookpunten.", "Verkeerde manier voor 2 vloeistoffen.", "Geen vaste stof.", "Geen vaste stof."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — zwarte inkt → meerdere kleuren.", "Indampen.", "Destilleren.", "Filtreren."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet dichtheid.", "Niet dichtheid.", "Niet dichtheid."],
      },
      {
        q: "Dichtheid water = ?",
        options: ["1 g/cm³", "7,9 g/cm³", "0,5 g/cm³", "10 g/cm³"],
        answer: 0,
        wrongHints: [null, "Klopt.", "IJzer.", "Olie ongeveer.", "Te veel."],
      },
      {
        q: "Olie drijft op water omdat ... ?",
        options: ["Olie lagere dichtheid heeft", "Olie warmer is", "Olie heller is", "Toeval"],
        answer: 0,
        wrongHints: [null, "Klopt — ~0,9 g/cm³ vs water 1.", "Niet primair.", "Niet primair.", "Geen toeval — natuurwet."],
      },
      {
        q: "Welke is een **chemische** eigenschap?",
        options: ["Brandbaarheid", "Dichtheid", "Smeltpunt", "Kleur"],
        answer: 0,
        wrongHints: [null, "Klopt — stof wordt anders bij brand.", "Fysisch.", "Fysisch.", "Fysisch."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Andere symbool (schedel).", "Andere symbool.", "Andere symbool."],
      },
      {
        q: "Symbool voor **zoutzuur**?",
        options: ["Corrosief (vreet weg)", "Ontvlambaar", "Explosief", "Milieu"],
        answer: 0,
        wrongHints: [null, "Klopt — vreet huid + metaal.", "Brandt niet.", "Explodeert niet.", "Niet primair milieu."],
      },
      {
        q: "Wat doe je bij **chemicalie in oog**?",
        options: ["15 minuten spoelen met water", "Drogen", "Afvegen", "Wachten"],
        answer: 0,
        wrongHints: [null, "Klopt — niet droogwrijven.", "Maakt erger.", "Maakt erger.", "Wachten gevaarlijk."],
      },
      {
        q: "Mag je **bleekmiddel + ammoniak** mengen?",
        options: ["Nee — vormt giftig gas", "Ja, geen probleem", "Soms", "Maakt sterker"],
        answer: 0,
        wrongHints: [null, "Klopt — chloorgas/chloramine.", "Heel gevaarlijk.", "Altijd nee.", "Tegenovergesteld — gevaarlijk."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Mengsel.", "Mengsel gassen.", "Mengsel metalen."],
      },
      {
        q: "Hoe haal je **alcohol uit wijn**?",
        options: ["Destilleren", "Filtreren", "Bezinken", "Chromatografie"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor vaste stof.", "Geen vaste deeltjes.", "Voor kleuren."],
      },
      {
        q: "Mayonaise is een ... ?",
        options: ["Emulsie (olie in eigeel)", "Oplossing", "Pure stof", "Schuim"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet helder.", "Mengsel.", "Geen gas."],
      },
      {
        q: "Dichtheid water?",
        options: ["1 g/cm³", "7,9 g/cm³", "0,1 g/cm³", "10 g/cm³"],
        answer: 0,
        wrongHints: [null, "Klopt.", "IJzer.", "Te weinig.", "Te veel."],
      },
      {
        q: "Welk gevaarssymbool voor **benzine**?",
        options: ["Vlam (ontvlambaar)", "Schedel", "Corrosief", "Milieu"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet acuut giftig.", "Niet corrosief.", "Niet primair milieu."],
      },
      {
        q: "Hoeveel **elementen** in periodiek systeem?",
        options: ["~118", "~50", "~10", "~1000"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Te weinig.", "Te weinig.", "Te veel."],
      },
    ],
  },
];
