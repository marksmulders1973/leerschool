...
const steps = [
  ...
  // STAP 6: Eind-toets
  {
    ...
    explanation:
      "Mix-toets in Doorstroomtoets-stijl. Door elkaar: pure stof/mengsel, soorten mengsels, scheidingsmethoden, eigenschappen, pictogrammen.\n\nVeel succes!",
    checks: [
      {
