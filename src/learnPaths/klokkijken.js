    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kleine = uurwijzer. A.", simpeler: "Kleine wijzer = de korte. Wijst naar uur. Grote wijzer = lang, wijst naar minuten.", nogSimpeler: "Klein=uur" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "60 minuten. A.", simpeler: "1 uur = 60 minuten (vaste regel). Niet 30 (=halfuur), niet 100, niet 24 (=uren per dag).", nogSimpeler: "60" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Groot op 12, klein op 3. A.", simpeler: "Bij heel uur (3 uur): minutenwijzer staat op 12 (=0 min), uurwijzer op 3.", nogSimpeler: "12+3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "21:00. A.", simpeler: "9 uur 's avonds = 9 + 12 = 21 uur → 21:00.", nogSimpeler: "21:00" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "16:30. A.", simpeler: "Half 5 = 30 min vóór 5 = uur 4 + 30 min = 04:30. 's Middags +12 = 16:30.", nogSimpeler: "16:30" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tussen 7 en 8. A.", simpeler: "Half 8 = 7:30. Klein wijzer staat halverwege tussen 7 en 8 (niet meer op 7, nog niet op 8).", nogSimpeler: "7-8" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "02:30 of 14:30. A.", simpeler: "Half 3 = 30 min VÓÓR 3 = uur 2 + 30 min = 02:30 of 14:30.", nogSimpeler: "2:30/14:30" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "15 min. A.", simpeler: "Kwart = 1/4 van 60 = 15 minuten. Vier kwartieren passen in 1 uur.", nogSimpeler: "15" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Op 3. A.", simpeler: "Kwart over = 15 min over uur. Minutenwijzer wijst naar 3 (rechts op klok).", nogSimpeler: "3" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "20:45. A.", simpeler: "Kwart voor 9 = uur 8 + 45 min. 's Avonds: 8+12=20 → 20:45.", nogSimpeler: "20:45" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5 min. A.", simpeler: "60 minuten ÷ 12 cijfers = 5 minuten per cijfer.", nogSimpeler: "5" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "10 minuten. A.", simpeler: "Grote wijzer op 2: 2 × 5 minuten = 10 minuten over heel uur.", nogSimpeler: "10" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "19:10. A.", simpeler: "10 over 7 = 7:10. 's Avonds: 7+12=19 → 19:10.", nogSimpeler: "19:10" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9:00 PM. A.", simpeler: "21:00 = 21-12 = 9 's avonds = 9:00 PM.", nogSimpeler: "9 PM" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "45 min over 8. A.", simpeler: "08:45 = 8 uur + 45 min = kwart voor 9 (45 min over 8).", nogSimpeler: "Kwart voor 9" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "00:00. A.", simpeler: "Middernacht = nieuwe dag begint = 00:00. (12:00 = middag, niet middernacht.)", nogSimpeler: "00:00" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6 uur. A.", simpeler: "14 - 8 = 6 uur. Minuten zijn beide 00.", nogSimpeler: "6" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2 uur 15 min. A.", simpeler: "Uren: 17-15=2. Minuten: 45-30=15. Samen: 2 uur 15 minuten.", nogSimpeler: "2u15m" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9 uur. A.", simpeler: "22→24=2u (tot middernacht). 0→7=7u (na). Samen: 2+7=9 uur.", nogSimpeler: "9" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Half 8. A.", simpeler: "Grote op 6 = halve uur. Klein tussen 7 en 8 → half 8 (= 7:30).", nogSimpeler: "Half 8" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "18:45. A.", simpeler: "Kwart voor 7 = 6:45. 's Avonds: 6+12=18 → 18:45.", nogSimpeler: "18:45" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1 uur 45 min. A.", simpeler: "13:15 → 15:00 = 13:15 → 14:00 (45m) + 14:00 → 15:00 (1u) = 1 uur 45 min.", nogSimpeler: "1u45m" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "45 min. A.", simpeler: "1 kwartier = 15 min. 3 × 15 = 45 minuten.", nogSimpeler: "45" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Half 9. A.", simpeler: "08:30 = halve uur, vooruit kijken naar 9 = 'half 9'. (Half 8 zou 7:30 zijn).", nogSimpeler: "Half 9" },
        },
      },
