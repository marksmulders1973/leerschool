...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "**Kwart over 3** = welke tijd?", options: ["3:15","3:45","2:45","3:30"], answer: 0, wrongHints: [null,"Klopt.","Kwart voor 4.","Kwart voor 3.","Half 4."] },
      { q: "**Kwart voor 8** = welke tijd?", options: ["7:45","8:15","8:45","7:15"], answer: 0, wrongHints: [null,"Klopt — 15 min vóór 8.","Kwart over.","Te laat.","Niet."] },
      { q: "**Half 5** = welke tijd?", options: ["4:30","5:30","4:45","5:00"], answer: 0, wrongHints: [null,"Klopt — vooruit naar 5.","Niet — vooruit kijken.","Niet.","Niet half."] },
      { q: "**21:00** in 12-uurs?", options: ["9:00 's avonds","9:00 's morgens","11:00 's avonds","1:00 's nachts"], answer: 0, wrongHints: [null,"Klopt — 21−12.","Dat is 09:00.","23:00.","01:00."] },
      { q: "Hoeveel **minuten** in 1 uur?", options: ["60","100","30","24"], answer: 0, wrongHints: [null,"Klopt.","Niet — geen decimaal.","Halve.","Uren in dag."] },
      { q: "Hoeveel **seconden** in 1 minuut?", options: ["60","30","100","24"], answer: 0, wrongHints: [null,"Klopt.","Halve.","Niet.","Niet."] },
      { q: "School begint 8:30, eindigt 14:45. Duur?", options: ["6 uur 15 min","6 uur","5 uur 45 min","7 uur"], answer: 0, wrongHints: [null,"Klopt.","Vergeet niet 15 min.","Niet.","Te veel."] },
      { q: "Trein vertrekt 10:50, rijdt 1 uur 25 min. Aankomst?", options: ["12:15","11:50","12:25","11:25"], answer: 0, wrongHints: [null,"Klopt — 10:50 + 1u25.","Alleen 1 uur.","Niet — 25 min na 12.","Te kort."] },
      { q: "**12:00** noemen we?", options: ["Middag","Middernacht","Half 1","Avond"], answer: 0, wrongHints: [null,"Klopt.","Dat is 0:00 / 24:00.","Half 1 = 12:30.","Niet relevant."] },
      { q: "Verschil tussen 9:15 en 9:45?", options: ["30 min","15 min","45 min","1 uur"], answer: 0, wrongHints: [null,"Klopt — 45−15.","Niet zonder kijken.","Niet.","Niet."] },
      { q: "Een **dag** heeft hoeveel uur?", options: ["24","12","60","48"], answer: 0, wrongHints: [null,"Klopt.","Halve dag.","Minuten in uur.","Twee dagen."] },
      { q: "Hoe laat is 'half 11'?", options: ["10:30","11:30","10:45","11:00"], answer: 0, wrongHints: [null,"Klopt — vooruit naar 11.","Niet — vooruit kijken.","Niet half.","Niet half."] },
      { q: "**15:30** = welke spreektaal?", options: ["Half 4 's middags","Half 5","Kwart over 3","Kwart voor 4"], answer: 0, wrongHints: [null,"Klopt — 15:30 = vooruit naar 16=4.","Dat is 16:30.","Dat is 15:15.","Dat is 15:45."] },
      { q: "Hoeveel uur tussen 22:00 en 06:00 's morgens?", options: ["8 uur","4 uur","12 uur","6 uur"], answer: 0, wrongHints: [null,"Klopt — 2 uur tot middernacht + 6 = 8.","Niet — over middernacht.","Niet — niet 12.","Niet — vergeet middernacht."] },
      { q: "**5 voor half 3** = welke tijd?", options: ["14:25","14:35","2:35","2:25"], answer: 0, wrongHints: [null,"Klopt — 5 min vóór 14:30.","5 over half 3.","12-uur (overdag bedoeld).","Niet."] },
    ],
  },
];
