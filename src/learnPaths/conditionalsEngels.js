  ...
  // STAP 1: Wat is een conditional?
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Type 1 zou 'If I have a car, I will drive' zijn.", "Type 3 = verleden.", "Type 0 = altijd waar."],
      },
      {
        q: "Welk type voor **toekomst (kan gebeuren)**?",
        options: ["Type 1", "Type 0", "Type 2", "Type 3"],
        answer: 0,
        wrongHints: [null, "Algemene waarheid.", "Onreëel nu.", "Verleden."],
      },
    ],
  },
  ...
  // STAP 2: Type 1
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Geen toekomst.", "3e persoon -s, maar geen toekomst.", "Type 2."],
      },
      {
        q: "**'If she ___ (call), I will answer.'**",
        options: ["calls", "call", "will call", "called"],
        answer: 0,
        wrongHints: [null, "Mist -s.", "Niet 'will' in if-clause.", "Verleden — type 2."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Geen 'will' in if.", "Type 2.", "Mist -s (3e persoon)."],
      },
      {
        q: "**'If I had a million euros, I ___ travel the world.'**",
        options: ["would", "will", "have", "had"],
        answer: 0,
        wrongHints: [null, "Type 1.", "Niet conditional.", "Past simple is in if-clause, niet hoofdzin."],
      },
      {
        q: "**'If she had known, she ___ have helped.'**",
        options: ["would", "will", "had", "would be"],
        answer: 0,
        wrongHints: [null, "Type 1.", "Mist 'would'.", "Mixed met 'be'."],
      },
      {
        q: "**'___ you study harder, you will pass.'**",
        options: ["If", "Unless", "Were", "Should"],
        answer: 0,
        wrongHints: [null, "Tegenovergesteld.", "Inversion — formeel, ongewoon hier.", "Kan formeel, maar 'If' gangbaarder."],
      },
      {
        q: "**'If I ___ you, I would tell the truth.'**",
        options: ["were", "am", "was", "had been"],
        answer: 0,
        wrongHints: [null, "Type 1.", "Informeel kan, formeel were.", "Type 3."],
      },
      {
      ...
      { q: "**'If I ___ rich, I would travel.'** Type 2?", options: ["were","was","am","had been"], answer: 0, wrongHints: [null,"Spreektaal, niet examen.","Type 1.","Type 3."] },
