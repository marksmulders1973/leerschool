...
const steps = [
  ...
  },
  {
    ...
    checks: [
      { q: "**Koude Oorlog** = ?", options: ["VS-USSR spanning 1945-1991", "Echte oorlog", "Winter", "Geen"], answer: 0, wrongHints: [null, "Klopt.", "Geen direct.", "Niet.", "Wel."] },
      { q: "Wanneer **Berlijnse Muur viel**?", options: ["1989", "1961", "1945", "2001"], answer: 0, wrongHints: [null, "Klopt.", "Gebouwd.", "WO2-einde.", "9/11."] },
      { q: "Wie verhinderde **bijna kernoorlog Cuba 1962**?", options: ["Kennedy + Chroesjtsjov + Arkhipov", "Stalin", "Gorbatsjov", "Hitler"], answer: 0, wrongHints: [null, "Klopt — onderhandeling.", "Eerder.", "Later.", "WO2."] },
      { q: "Wat is **NAVO**?", options: ["Westerse militaire alliantie sinds 1949", "Sovjet-pact", "VN", "EU"], answer: 0, wrongHints: [null, "Klopt.", "Warschau.", "Andere.", "Andere."] },
      { q: "Wie won **Vietnam-oorlog**?", options: ["Noord-Vietnam", "VS", "Frankrijk", "Niemand"], answer: 0, wrongHints: [null, "Klopt.", "Verloor.", "Eerder weg.", "Wel."] },
      { q: "Wanneer **9/11**?", options: ["11 september 2001", "1989", "1945", "2022"], answer: 0, wrongHints: [null, "Klopt.", "Muur viel.", "WO2.", "Oekraine."] },
    ],
  },
];
