    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Containers.", simpeler: "Standaard containers.", nogSimpeler: "Container" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Halvering.", simpeler: "Veel minder armoede.", nogSimpeler: "↓" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Politiek = organisaties.", simpeler: "VN, EU, NAVO.", nogSimpeler: "VN" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "De-globalisering.", simpeler: "Terug naar nationaal.", nogSimpeler: "Anti-glob" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Specialisatie.", simpeler: "Maak waar je goed in bent + ruil.", nogSimpeler: "Specialiseren" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Handel + geschillen.", simpeler: "Vrije handel regelen.", nogSimpeler: "WTO = handel." },
        },
      },
      {
        q: "**Off-shoring** is:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Naar laag-loon land.", simpeler: "Productie verhuizen.", nogSimpeler: "Off-shore" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "15% minimum.", simpeler: "Belasting-minimum globaal.", nogSimpeler: "15%" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wereldketen.", simpeler: "Veel landen samen.", nogSimpeler: "Globaal" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "BBP+onderwijs+leven.", simpeler: "Drie indicatoren samen.", nogSimpeler: "HDI" },
        },
      },
      {
        q: "**Resource curse** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Grondstoffen → vaak slecht.", simpeler: "Rijk aan iets = ramp soms.", nogSimpeler: "Vloek" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Van arm tot top.", simpeler: "Heel snel ontwikkeld.", nogSimpeler: "Stijger" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kleine leningen armen.", simpeler: "Mini-leningen voor ondernemerschap.", nogSimpeler: "Micro" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Instituties.", simpeler: "Goede regels = groei.", nogSimpeler: "Insts" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geld naar huis.", simpeler: "Migrant stuurt geld familie.", nogSimpeler: "Remit" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vlucht gedwongen.", simpeler: "Vluchteling = gevaar.", nogSimpeler: "Gevaar" },
        },
      },
      {
        q: "**Brain drain** is:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hoog-opgeleiden weg.", simpeler: "Slimme mensen vertrekken.", nogSimpeler: "Brain drain" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oekraïne.", simpeler: "Oekraïens vluchtelingen.", nogSimpeler: "Oekr" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Push = wegduwen.", simpeler: "Push = nadeel thuis.", nogSimpeler: "Push" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "#13 = klimaat.", simpeler: "Klimaatactie.", nogSimpeler: "Klimaat" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "MDGs.", simpeler: "Millenium-doelen.", nogSimpeler: "MDG" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "CO₂-importbelasting.", simpeler: "Vervuilende import betalt extra.", nogSimpeler: "CBAM" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Veel achter.", simpeler: "Niet halen 2030.", nogSimpeler: "Achter" },
        },
      },
      {
        q: "**Re-shoring** is:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Terug naar huis.", simpeler: "Productie terughalen.", nogSimpeler: "Re-shore" },
        },
      },
    ],
  },
