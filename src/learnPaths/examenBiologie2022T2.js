...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "**Adrenaline** = stress/vecht-of-vlucht-hormoon. Versnelt hart, verhoogt bloeddruk, vergroot pupillen. Bètablokkers blokkeren adrenaline-receptoren in hartspier → hartslag daalt. Glucagon en insuline werken op bloedsuiker, niet op hart.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Grote hersenen** = bewuste waarneming + denken + bewegen. Verdeeld in 4 kwabben (achterhoofd zien, slaap horen, voorhoofd plannen, kruin voelen). Pijn-waarneming = bewust → grote hersenen. Kleine hersenen = motoriek. Hersenstam = autonoom (ademen, hartritme).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Reflexboog 3 zenuwcellen**: GEVOELSZENUW (zintuig → ruggenmerg) → SCHAKELCEL (binnen ruggenmerg) → BEWEGINGSZENUW (ruggenmerg → spier). Vanuit huid (= zintuig) = gevoelszenuwcel.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**3 vormen leergedrag**: GEWENNING (stopt reageren op onschuldig signaal), INPRENTING (eenmalig in kritieke periode jong), CONDITIONERING (leert SIGNAAL koppelen aan BELONING — Pavlov-hond, kleur-nectar-koppeling). Vlinder leert kleur → nectar = conditionering.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Bijnieren** = klieren op nieren (BIJ-NIER = naast nier). Maken adrenaline + cortisol = stress-hormonen. Alvleesklier = insuline/glucagon. Hypofyse = chef. Schildklier = thyroxine.",
