...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "**Nationale ombudsman** = onafhankelijk orgaan dat klachten van burgers tegen Rijksoverheid (ministeries, Belastingdienst, UWV, politie etc.) onderzoekt. Geen rechter — wel publiek rapport + adviezen. Sinds 1982 in NL.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Ecologische stroming** (GroenLinks, Partij voor de Dieren, D66 deels) heeft milieu + duurzaamheid + klimaat als KERN-thema. Herbruikbaar plastic = duurzaamheid = ecologische doelstelling. Andere stromingen zijn niet primair milieu-georiënteerd.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Opsporingsmiddel** = na een misdrijf het bewijs verzamelen + verdachten identificeren (gezichten, fietsen, kleding op de beelden). Camera's = na-onderzoek-tool. PREVENTIE = misdaad voorkomen (zichtbaarheid kan helpen). SANCTIE = straf opleggen (rechter, niet politie).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Rationele keuze-theorie** (Becker): criminelen maken een AFWEGING van kosten/baten — pakking-kans + opbrengst + risico vs verwachte straf. Corona = mensen thuis = pakking-kans hoog = te risicovol = inbreker kiest tegen. Inbreker berekent dus rationeel.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Slachtoffer-spreekrecht** (sinds 2005 verbreed): slachtoffer mag op de zitting voor de strafmaat-uitspraak emotioneel verklaren wat het delict betekend heeft. Geen invloed op straf zelf — wel zichtbaarheid. Andere opties = niet wettelijk recht.",
