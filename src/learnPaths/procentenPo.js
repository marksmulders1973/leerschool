...
const steps = [
  ...
  // STAP 7: Eindopdracht — Cito-mix
  {
    ...
    checks: [
      ...
      { q: "10% van 50 = ?", options: ["5","10","50","0,5"], answer: 0, wrongHints: [null,"Klopt — tiende.","Niet — % zelf.","Niet.","Niet."] },
      { q: "25% van 80 = ?", options: ["20","25","40","2"], answer: 0, wrongHints: [null,"Klopt — kwart.","Dat is %.","Helft.","Niet."] },
      { q: "Trui van €40 met 20% korting = ?", options: ["€32","€20","€8","€40"], answer: 0, wrongHints: [null,"Klopt — €40−€8.","Niet — korting niet 50%.","Dat is de korting.","Geen korting?"] },
      { q: "Welk decimaal getal is **0,5**?", options: ["50%","5%","½%","500%"], answer: 0, wrongHints: [null,"Klopt — helft.","Niet.","Niet.","Veel meer."] },
      { q: "5% van 200 = ?", options: ["10","5","20","100"], answer: 0, wrongHints: [null,"Klopt — 5/100 × 200.","Niet — % zelf.","Niet.","Helft."] },
      { q: "**Stijging** 50 → 75 is welk percentage?", options: ["50%","25%","20%","75%"], answer: 0, wrongHints: [null,"Klopt — +25 op 50.","Stijging absoluut, niet %.","Niet.","Niet relevant."] },
      { q: "Welk percentage is **¼**?", options: ["25%","20%","½%","75%"], answer: 0, wrongHints: [null,"Klopt — kwart.","Vijfde.","Niet.","Drie kwart."] },
      { q: "100% van 60 = ?", options: ["60","100","0","6"], answer: 0, wrongHints: [null,"Klopt — alles.","Niet getal zelf.","Niet — alles.","Tiende."] },
      { q: "30% van 200 = ?", options: ["60","30","20","6"], answer: 0, wrongHints: [null,"Klopt — 3×10% = 3×20.","Dat is %.","Niet.","10% van 60."] },
      { q: "Welk percentage past bij **½**?", options: ["50%","25%","75%","100%"], answer: 0, wrongHints: [null,"Klopt — helft.","Niet — kwart.","Niet — driekwart.","Heel."] },
      { q: "Een fles van €5 wordt 10% goedkoper. Nieuwe prijs?", options: ["€4,50","€4,00","€5,50","€10"], answer: 0, wrongHints: [null,"Klopt — €0,50 eraf.","Te veel korting.","Niet — eraf, niet erbij.","Niet."] },
      { q: "Hoeveel % is 1 op 10?", options: ["10%","1%","100%","0,1%"], answer: 0, wrongHints: [null,"Klopt — 1/10.","Niet.","Geheel.","Te klein."] },
      { q: "Hoeveel % is 50 op 200?", options: ["25%","50%","100%","75%"], answer: 0, wrongHints: [null,"Klopt — 50/200 = ¼.","Niet — helft van 200 is 100.","Niet.","Niet."] },
      { q: "**150%** van 20 = ?", options: ["30","20","15","150"], answer: 0, wrongHints: [null,"Klopt — 1× plus helft = 20+10.","Origineel.","Niet — minder.","Veel te veel."] },
    ],
  },
];
