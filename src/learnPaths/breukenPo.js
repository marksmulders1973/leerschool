...
const steps = [
...

  {
    ...
    checks: [
      ...
      { q: "½ + ¼ = ?", options: ["¾","⅙","⅔","¼"], answer: 0, wrongHints: [null,"Klopt — gelijknamig: ²⁄₄+¼=¾.","Niet.","Niet.","Niet."] },
      { q: "1 − ⅓ = ?", options: ["⅔","¼","½","⅓"], answer: 0, wrongHints: [null,"Klopt — 1 = ³⁄₃; ³⁄₃ − ⅓ = ⅔.","Niet.","Niet.","Dat is wat je weghaalt."] },
      { q: "Welke breuk is groter: ½ of ⅓?", options: ["½","⅓","Gelijk","Niet te zeggen"], answer: 0, wrongHints: [null,"Klopt — bij gelijke teller kleiner getal onder = grotere taart.","Niet.","Niet.","Wel — te bepalen."] },
      { q: "Vereenvoudig: ⁴⁄₈ = ?", options: ["½","⅓","¼","⅔"], answer: 0, wrongHints: [null,"Klopt — beide ÷4.","Niet.","Niet.","Niet."] },
      { q: "½ van 20 = ?", options: ["10","5","15","2"], answer: 0, wrongHints: [null,"Klopt — helft.","Dat is ¼.","Niet.","Niet."] },
      { q: "¾ van 12 = ?", options: ["9","3","6","8"], answer: 0, wrongHints: [null,"Klopt — 12÷4×3.","Dat is ¼.","Dat is ½.","Niet."] },
      { q: "⅓ + ⅓ = ?", options: ["⅔","⅙","⅓","1"], answer: 0, wrongHints: [null,"Klopt — gelijknamig.","Niet — niet kruisen.","Geen optellen?","Niet — niet 3 derden."] },
      { q: "Vereenvoudig: ⁶⁄₉ = ?", options: ["⅔","½","¾","⅓"], answer: 0, wrongHints: [null,"Klopt — beide ÷3.","Niet — geen gemeen.","Niet.","Niet."] },
      { q: "Welke is **kleinst**: ¼, ½, of ¾?", options: ["¼","½","¾","Gelijk"], answer: 0, wrongHints: [null,"Klopt — kleinste stuk.","Helft.","Grootste.","Niet."] },
      { q: "Hoeveel **kwarten** zijn in 1 geheel?", options: ["4","2","8","3"], answer: 0, wrongHints: [null,"Klopt — vier kwarten.","Twee halven.","Achtsten misschien?","Derden."] },
      { q: "1/10 als decimaal?", options: ["0,1","0,01","1,0","0,10 (?)"], answer: 0, wrongHints: [null,"Klopt — 1 gedeeld door 10.","Dat is ¹⁄₁₀₀.","Dat is heel.","Niet zinvol vraagteken."] },
      { q: "¾ als decimaal?", options: ["0,75","0,34","0,43","0,8"], answer: 0, wrongHints: [null,"Klopt — 3÷4.","Cijfers gehusseld.","Cijfers gehusseld.","Niet."] },
      { q: "Welke breuk is **gelijk** aan 0,5?", options: ["½","⅕","¼","⅓"], answer: 0, wrongHints: [null,"Klopt — helft.","Vijfde.","Kwart = 0,25.","Derde ≈ 0,33."] },
      { q: "2/5 + 1/5 = ?", options: ["3/5","3/10","2/25","⅕"], answer: 0, wrongHints: [null,"Klopt — tellers optellen, noemer blijft.","Niet — noemer blijft.","Niet — noemer blijft.","Niet."] },
      { q: "½ × 4 = ?", options: ["2","½","¼","4"], answer: 0, wrongHints: [null,"Klopt — helft van 4.","Niet — vermenigvuldigd.","Niet.","Niet veranderd."] },
    ],
  },
];
