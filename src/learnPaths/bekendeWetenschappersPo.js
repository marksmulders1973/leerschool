...
// toetsvraag: wie deed welke uitvinding/ontdekking. 1F.
// 5 stappen.
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tijdlijn astronomie: Aristoteles/Ptolemaeus = aarde-centrisch. Copernicus 1543 = zon-centrisch (idee). Galileo ~1610 = bewijs. Newton 1687 = zwaartekracht-verklaring. Steeds beter inzicht.",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-onderscheid wetenschappers: NEWTON = zwaartekracht + beweging-wetten. EINSTEIN = relativiteit (verklaring zwaartekracht). GALILEO = telescoop-waarnemingen. DARWIN = evolutie (biologie, niet natuurkunde).",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-onderscheid biologen: DARWIN = evolutie. MENDEL = genetica (erwten). PASTEUR = bacteriën + vaccin. FLEMING = penicilline. Verschillende ontdekkingen, niet verwarren.",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-onderscheid wetenschappers: EINSTEIN = relativiteit + E=mc². NEWTON = zwaartekracht + 3 wetten. DARWIN = evolutie (biologie). CURIE = radium + radioactiviteit. Elk had eigen revolutionair idee.",
          voorbeelden: [
          ...
          niveaus: {
            basis: "Einstein.",
            simpeler: "Einstein bedacht de formule E=mc² in 1905. Energie = massa × lichtsnelheid².",
            nogSimpeler: "Einstein",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Radium + radioactiviteit.",
            simpeler: "Marie Curie ontdekte radium + bedacht woord 'radioactiviteit'. Kreeg 2 Nobelprijzen.",
            nogSimpeler: "Radium",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Alan Turing.",
            simpeler: "Britse wiskundige Alan Turing brak de Duitse Enigma-code in WO2.",
            nogSimpeler: "Turing",
          },
        },
      },
    ...
    checks: [
      ...
      { q: "Wie kreeg **2 Nobelprijzen**?", options: ["Marie Curie", "Einstein", "Newton", "Darwin"], answer: 0, wrongHints: [null, "Slechts 1.", "Geen Nobel (vóór bestaat).", "Geen."] },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Einstein.", simpeler: "Albert Einstein ontwikkelde relativiteitstheorie + formule E=mc². Belangrijkste natuurkundige 20e eeuw.", nogSimpeler: "Einstein" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Newton.", simpeler: "Isaac Newton (Engels, 17e eeuw) beschreef zwaartekracht — verhaal met vallende appel. Schreef ook 3 bewegingswetten.", nogSimpeler: "Newton" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Marie Curie.", simpeler: "Marie Curie (1867-1934) was eerste vrouw met Nobelprijs (1903) + enige met 2 Nobelprijzen in verschillende vakken. Ontdekte radioactiviteit.", nogSimpeler: "Marie Curie" },
        },
      },
      ...
      { q: "Wie ontwikkelde de **fiets** (early form)?", options: ["Karl Drais (Duits)","Edison","Tesla","Newton"], answer: 0, wrongHints: [null, "Edison = gloeilamp + telefoon.", "Tesla = wisselstroom + elektriciteit.", "Newton = zwaartekracht, geen voertuig."] },
      ...
      { q: "Wie was Marie **Curie's** focus-vakgebied?", options: ["Radioactiviteit","Astronomie","Biologie","Wiskunde"], answer: 0, wrongHints: [null, "Astronomie = sterren, ander vakgebied.", "Biologie = leven (Darwin).", "Wiskunde = getallen, geen lab-werk."] },
    ],
  },
];
...
const bekendeWetenschappersPo = {
  ...
  title: "Bekende wetenschappers (Doorstroomtoets groep 6-8)",
  emoji: "🔭",
  level: "groep6-8",
  subject: "natuur",
  referentieNiveau: "1F",
  ...
  intro:
    "Bekende wetenschappers voor Doorstroomtoets groep 6-8 — Copernicus/Galileo (zon-middelpunt) + Newton (zwaartekracht, 3 wetten) + Darwin (evolutie) + Mendel/Pasteur/Fleming + Einstein (E=mc²) + Curie (radium) + Turing (computer). toets-relevant. ~15 min.",
  triggerKeywords: [
