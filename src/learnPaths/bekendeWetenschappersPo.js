...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wie ontdekte de **zwaartekracht**?", options: ["Isaac Newton","Albert Einstein","Galileo","Curie"], answer: 0, wrongHints: [null,"Klopt — appel-anekdote.","Relativiteit.","Astronomie.","Radioactiviteit."] },
      { q: "Wie bedacht de **relativiteitstheorie**?", options: ["Albert Einstein","Newton","Curie","Darwin"], answer: 0, wrongHints: [null,"Klopt — E=mc².","Zwaartekracht.","Radioactiviteit.","Evolutie."] },
      { q: "Wie was **eerste programmeur**?", options: ["Ada Lovelace","Charles Babbage","Newton","Einstein"], answer: 0, wrongHints: [null,"Klopt — 19e eeuw.","Maakte machine.","Niet.","Niet."] },
      { q: "Wie ontwierp de **gloeilamp**?", options: ["Thomas Edison","Tesla","Newton","Einstein"], answer: 0, wrongHints: [null,"Klopt — 1879.","Wisselstroom.","Niet.","Niet."] },
      { q: "Wie ontwikkelde **wisselstroom (AC)**?", options: ["Nikola Tesla","Edison","Curie","Bell"], answer: 0, wrongHints: [null,"Klopt.","DC.","Niet.","Telefoon."] },
      { q: "Wie ontdekte het **DNA-structuur** (samen)?", options: ["Watson + Crick (met Rosalind Franklin)","Einstein","Newton","Galileo"], answer: 0, wrongHints: [null,"Klopt — 1953.","Niet biologie.","Niet.","Niet."] },
      { q: "Wie was bekend van **chimpansee-onderzoek**?", options: ["Jane Goodall","Curie","Newton","Einstein"], answer: 0, wrongHints: [null,"Klopt — Tanzania.","Niet biologie.","Niet.","Niet."] },
      { q: "Wie bedacht de **telefoon**?", options: ["Alexander Graham Bell","Edison","Tesla","Newton"], answer: 0, wrongHints: [null,"Klopt — 1876.","Andere uitvindingen.","Wisselstroom.","Niet."] },
      { q: "Wie kraakte de **enigma-code** in WO2?", options: ["Alan Turing","Einstein","Curie","Newton"], answer: 0, wrongHints: [null,"Klopt — computer-pionier.","Niet.","Niet.","Niet."] },
      { q: "Wie was de **eerste mens op de maan**?", options: ["Neil Armstrong","Yuri Gagarin","Buzz Aldrin","Curie"], answer: 0, wrongHints: [null,"Klopt — 1969.","Eerste in ruimte.","Met Armstrong, niet eerste.","Niet."] },
      { q: "Wie schreef *Origin of Species*?", options: ["Charles Darwin","Newton","Einstein","Curie"], answer: 0, wrongHints: [null,"Klopt — 1859.","Niet.","Niet.","Niet."] },
      { q: "Wie ontwikkelde de **fiets** (early form)?", options: ["Karl Drais (Duits)","Edison","Tesla","Newton"], answer: 0, wrongHints: [null,"Klopt — 1817.","Niet.","Niet.","Niet."] },
      { q: "Welke NL-er ontdekte **micro-organismen** met microscoop?", options: ["Anton van Leeuwenhoek","Huygens","Erasmus","Boyan Slat"], answer: 0, wrongHints: [null,"Klopt — Delft 1670s.","Astronoom.","Filosoof.","Plastic uit zee."] },
      { q: "Wie ontwierp de **slingerklok**?", options: ["Christiaan Huygens","Newton","Leeuwenhoek","Erasmus"], answer: 0, wrongHints: [null,"Klopt — 1656.","Niet uurwerk.","Microscoop.","Filosofie."] },
      { q: "Wie was Marie **Curie's** focus-vakgebied?", options: ["Radioactiviteit","Astronomie","Biologie","Wiskunde"], answer: 0, wrongHints: [null,"Klopt — polonium/radium.","Niet.","Niet.","Niet."] },
    ],
  },
];
