...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "*'De **kogel** is door de kerk.'* Wat betekent dit?", options: ["Definitief besluit genomen","Geweld","Religieuze actie","Sport"], answer: 0, wrongHints: [null,"Klopt — beslissing is genomen.","Letterlijk lezen.","Niet hoofdbetekenis.","Niet."] },
      { q: "*'Vele handen maken licht werk.'* — betekenis?", options: ["Samen gaat het makkelijker","Veel handen wegen niets","Licht zien","Niets"], answer: 0, wrongHints: [null,"Klopt — samenwerken is sterker.","Letterlijk gelezen.","Niet bedoeld.","Wel."] },
      { q: "*'Aan zijn lot overlaten.'* — betekenis?", options: ["Iemand niet helpen","Lot kopen","Loten trekken","Spelen"], answer: 0, wrongHints: [null,"Klopt — alleen laten.","Letterlijk.","Niet.","Niet."] },
      { q: "Wat is een **figuurlijke uitdrukking**?", options: ["Niet letterlijk, beeldspraak","Letterlijk","Wiskundige formule","Tekening"], answer: 0, wrongHints: [null,"Klopt.","Tegenstelling.","Niet.","Niet."] },
      { q: "*'Iemand iets onder de neus wrijven.'* — betekenis?", options: ["Iemand er steeds aan herinneren","Iemand schoonmaken","Iemand kietelen","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Letterlijk.","Niet.","Wel."] },
      { q: "*'Op één lijn zitten.'* — betekenis?", options: ["Eens zijn","Wachten in een rij","Sport","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — eensgezind.","Letterlijk.","Niet.","Wel."] },
      { q: "*'De druppel die de emmer doet overlopen.'* — betekenis?", options: ["Laatste reden waardoor je boos wordt","Letterlijk water","Klein probleem","Goed nieuws"], answer: 0, wrongHints: [null,"Klopt.","Letterlijk.","Tegenovergesteld.","Niet."] },
      { q: "*'Een kat in de zak kopen.'* — betekenis?", options: ["Iets kopen dat tegenvalt","Echte kat kopen","Niet relevant","Goedkoop"], answer: 0, wrongHints: [null,"Klopt — bedrogen.","Letterlijk.","Wel uitdrukking.","Niet primair."] },
      { q: "*'Een appeltje voor de dorst.'* — betekenis?", options: ["Geld bewaren voor later","Letterlijk fruit","Recept","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — spaargeld.","Letterlijk.","Niet.","Wel."] },
      { q: "*'Met de neus in de boter vallen.'* — betekenis?", options: ["Net op tijd komen voor iets goeds","Niet relevant","Verlies","Vies worden"], answer: 0, wrongHints: [null,"Klopt — geluk.","Wel.","Tegengestelde.","Letterlijk."] },
      { q: "*'Boontje komt om zijn loontje.'* — betekenis?", options: ["Wie kwaad doet, krijgt straf","Boontjes kopen","Niet relevant","Eten geven"], answer: 0, wrongHints: [null,"Klopt — karma.","Letterlijk.","Wel.","Niet."] },
      { q: "*'Een open deur intrappen.'* — betekenis?", options: ["Iets zeggen dat iedereen al weet","Inbraak","Voetbal","Letterlijk"], answer: 0, wrongHints: [null,"Klopt — overbodig.","Letterlijk.","Niet.","Niet bedoeld."] },
      { q: "*'Met twee maten meten.'* — betekenis?", options: ["Iets oneerlijk beoordelen","Wiskunde doen","Meten","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Letterlijk.","Letterlijk.","Wel."] },
      { q: "*'Knollen voor citroenen verkopen.'* — betekenis?", options: ["Mensen bedriegen","Markt","Niet relevant","Recept"], answer: 0, wrongHints: [null,"Klopt — onwaar.","Letterlijk.","Wel.","Niet."] },
    ],
  },
];
