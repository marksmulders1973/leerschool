...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "*'De druppel die de emmer doet overlopen.'* — betekenis?", options: ["Laatste reden waardoor je boos wordt","Letterlijk water","Klein probleem","Goed nieuws"], answer: 0, wrongHints: [null, "Letterlijk.", "Tegenovergesteld.", null] },
