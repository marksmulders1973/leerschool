    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — standaard formeel.", "Informeel.", "Informeel + naam bekend.", "Slang."],
      },
      {
        q: "Welke **sign-off** bij 'Dear Mr Smith'?",
        options: ["Yours sincerely,", "Yours faithfully,", "Cheers,", "Bye!"],
        answer: 0,
        wrongHints: [null, "Klopt — naam bekend.", "Bij naam onbekend.", "Informeel.", "Informeel."],
      },
      {
        q: "**Formeel** woord voor 'I'm':",
        options: ["I am", "I'm (geen verschil)", "Im", "Me"],
        answer: 0,
        wrongHints: [null, "Klopt — geen samentrekking.", "Wel verschil — formeel niet.", "Spelling fout.", "Verkeerde vorm."],
      },
      {
        q: "*'I would like to **___** about your job advert.'* Welk woord?",
        options: ["enquire", "ask", "look", "say"],
        answer: 0,
        wrongHints: [null, "Klopt — formeel.", "Te informeel.", "Niet juist.", "Niet juist."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is introduction.", "Geen alinea-type.", "Niet de structuur."],
      },
      {
        q: "Welk woord = **mijn mening geven**?",
        options: ["In my opinion", "Generally speaking", "Indeed", "Furthermore"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Algemeen, niet persoonlijke mening.", "Toevoeging, geen mening.", "Toevoeging."],
      },
      {
        q: "Welk signaalwoord = **conclusie**?",
        options: ["In conclusion", "Firstly", "For example", "However"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Eerste argument.", "Voorbeeld.", "Tegenstelling."],
      },
      {
        q: "Wat doe je met een **tegenwerping** in essay?",
        options: ["Noem en weerleg", "Negeer", "Eens mee zijn", "Ontwijken"],
        answer: 0,
        wrongHints: [null, "Klopt — sterker essay.", "Niet — toont gebrek aan diepte.", "Tegenstrijdig met je standpunt.", "Niet — sterk essay heeft het."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — false friend.", "Dat is 'possible'.", "Niet.", "Niet."],
      },
      {
        q: "**It's** vs **Its** — verschil?",
        options: ["It's = it is, Its = van het", "Geen verschil", "Beide samentrekking", "Beide bezittelijk"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Wel verschil.", "Niet beide.", "Niet beide."],
      },
      {
        q: "Welk voorzetsel? *'I am good ___ swimming.'*",
        options: ["at", "in", "on", "with"],
        answer: 0,
        wrongHints: [null, "Klopt — good at.", "Niet correct.", "Niet correct.", "Niet correct."],
      },
      {
        q: "*'Yesterday I ___ to the cinema.'* Welke tijd?",
        options: ["went (past simple)", "have gone (present perfect)", "go (present)", "going"],
        answer: 0,
        wrongHints: [null, "Klopt — bepaalde tijd in verleden.", "Voor onbepaalde tijd.", "Niet verleden.", "Geen volledige zin."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Informeel.", "Informeel.", "Informeel."],
      },
      {
        q: "Sign-off bij **'Dear Mrs Brown'**?",
        options: ["Yours sincerely,", "Yours faithfully,", "Bye,", "Cheers,"],
        answer: 0,
        wrongHints: [null, "Klopt — naam bekend.", "Naam onbekend.", "Informeel.", "Informeel."],
      },
      {
        q: "Welke is **samentrekking**?",
        options: ["I'm", "I am", "Im", "Iam"],
        answer: 0,
        wrongHints: [null, "Klopt — formeel = I am.", "Geen samentrekking.", "Spelling fout.", "Spelling fout."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — bezittelijk.", "Plek (daar).", "Verschillende functies.", "Wel — their."],
      },
      {
        q: "Een **samenvatting** is ... ?",
        options: ["Korte versie in eigen woorden", "Letterlijke kopie", "Mening over de tekst", "Lijst voorbeelden"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Plagiat.", "Niet samenvatting.", "Niet samenvatting."],
      },
    ],
  },
];
