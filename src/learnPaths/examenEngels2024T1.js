    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Werkers vonden iets onverwacht. A.", simpeler: "Crews (werkers) unearthed (vonden) something surprising (onverwachts) → A (group of workers, unforeseen). = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Positieve framing. C.", simpeler: "Tekst is positief over besluit. Optie C ('journey towards equal') past bij positieve toon. = C.", nogSimpeler: "C." },
        },
      },
    ],
  },
