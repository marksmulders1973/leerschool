    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Feiten in detail.", simpeler: "Alinea 2 geeft citaat + concrete details over de gevonden tunnel = feiten uitwerken.", nogSimpeler: "Details" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wanneer/waarom onbekend.", simpeler: "Tekst zegt 'age and purpose remain mysterious' = wanneer + waarom = nog niet duidelijk.", nogSimpeler: "Onbekend" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Reacties op besluit.", simpeler: "Marta + fans-citaten = reactie op besluit = HOW it was received.", nogSimpeler: "Reacties" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Positieve framing.", simpeler: "Tekst is positief over besluit. Optie C ('journey towards equal') past bij positieve toon.", nogSimpeler: "Tekst is positief over besluit. Optie C ('journey towards equal') past… → C." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "However.", simpeler: "Alinea 4 = positief. Alinea 5 = 'maar nog niet alles gelijk'. Tegenstelling = However.", nogSimpeler: "However" },
        },
      },
    ],
  },
