    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Brug-geluid + gitaar", simpeler: "Tekst zegt 'gitaar over hum (brom) van de brug' = brug-geluid wordt gebruikt op album.", nogSimpeler: "Geluid" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Relaxed + dreamlike", simpeler: "Tekst noemt 'otherworldly, relaxed, dreamlike, meditative'. Optie B gebruikt zelfde woorden.", nogSimpeler: "Dreamlike" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Werkers vonden iets onverwacht. A.", simpeler: "Crews (werkers) unearthed (vonden) something surprising (onverwachts) → A (group of workers, unforeseen).", nogSimpeler: "Crews (werkers) unearthed (vonden) something surprising (onverwachts) … → A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Feiten in detail. D.", simpeler: "Alinea 2 geeft citaat + concrete details over de gevonden tunnel = feiten uitwerken.", nogSimpeler: "Details" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wanneer/waarom onbekend. B.", simpeler: "Tekst zegt 'age and purpose remain mysterious' = wanneer + waarom = nog niet duidelijk.", nogSimpeler: "Onbekend" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Reacties op besluit. B.", simpeler: "Marta + fans-citaten = reactie op besluit = HOW it was received.", nogSimpeler: "Reacties" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Positieve framing. C.", simpeler: "Tekst is positief over besluit. Optie C ('journey towards equal') past bij positieve toon.", nogSimpeler: "Tekst is positief over besluit. Optie C ('journey towards equal') past… → C." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "However. B.", simpeler: "Alinea 4 = positief. Alinea 5 = 'maar nog niet alles gelijk'. Tegenstelling = However.", nogSimpeler: "However" },
        },
      },
    ],
  },
