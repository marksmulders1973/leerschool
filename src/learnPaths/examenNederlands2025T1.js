...
const steps = [
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "De tekst zegt expliciet dat matig/slecht gehoor → slechter presteren al bekend wás. Nieuw is dat zélfs heel lichte gehoorschade al lagere scores geeft.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "De rode draad door alle onderzoeken: 'in feite onthouden we alleen de kern' en 'mensen herinneren zich van nature de kern van wat is gezegd'.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "De tekst beschrijft neutraal verschillende onderzoeken naar wat we van gesprekken onthouden. Dat is informeren — niet adviseren.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Een flyer wil activeren. De tekst spoort de lezer rechtstreeks aan: 'Zorg ervoor dat jij en je buren klaarstaan' en 'Meld je gewipte tegels aan'.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "De titel eindigt al met een vraag ('slaat dat aan?') en de tekst weegt steeds af: echte duurzaamheid of greenwashing? Dat is de centrale vraag.",
