    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "3 gegeten van 8 totaal = ⅜.",
            simpeler: "Boven schrijven hoeveel je hebt (3). Onder schrijven hoeveel er in totaal zijn (8).",
            nogSimpeler: "3 boven, 8 onder.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Noemer = onderaan", tekst: "Bij ⁵⁄₉: 5 is teller (boven), 9 is noemer (onder)." }],
          woorden: [{ woord: "noemer", uitleg: "het getal onder de streep" }],
          theorie: "Teller boven, noemer onder. T = Top.",
          voorbeelden: [{ type: "voorbeeld", tekst: "¾: teller=3, noemer=4" }],
          basiskennis: [{ onderwerp: "onthouden", uitleg: "noemer 'noemt' het aantal delen waarin geheel verdeeld is" }],
          niveaus: {
            basis: "Bij ⁵⁄₉ is 9 de noemer.",
            simpeler: "Noemer = onder de streep = 9.",
            nogSimpeler: "Onderste getal = 9.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Teller ÷ noemer", tekst: "¾ = 3 ÷ 4 = 0,75." }],
          woorden: [{ woord: "kommagetal", uitleg: "decimaal getal" }],
          theorie: "Breuk = deling. Teller bovenaan ÷ noemer onderaan.",
          voorbeelden: [{ type: "voorbeeld", tekst: "½=0,5  ¼=0,25  ¾=0,75  ⅕=0,2" }],
          basiskennis: [{ onderwerp: "rekenmachine", uitleg: "typ 3 ÷ 4 =" }],
          niveaus: {
            basis: "¾ = 3 ÷ 4 = 0,75.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "÷ 3", tekst: "9÷3=3, 12÷3=4 → ¾." }],
          woorden: [{ woord: "vereenvoudigen", uitleg: "kleinste getallen schrijven" }],
          theorie: "Deel teller en noemer door dezelfde deler.",
          voorbeelden: [{ type: "voorbeeld", tekst: "⁹⁄₁₂ = ¾ (÷3)" }],
          basiskennis: [{ onderwerp: "deler", uitleg: "zoek getal dat in beide past — hier 3" }],
          niveaus: {
            basis: "9 en 12 beide door 3 → ¾.",
            simpeler: "9÷3=3 en 12÷3=4. Antwoord: ¾.",
            nogSimpeler: "Deel boven en onder door 3.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "KGV = 12", tekst: "3 en 4 — kleinste getal dat door beide deelbaar is = 12." }],
          woorden: [{ woord: "gemeenschappelijke noemer", uitleg: "getal waar alle noemers in passen" }],
          theorie: "Vermenigvuldig de noemers (3·4=12) of zoek kleinste getal dat in beide past.",
          voorbeelden: [{ type: "voorbeeld", tekst: "noemers 2 en 3 → 6. Noemers 4 en 6 → 12." }],
          basiskennis: [{ onderwerp: "tafels", uitleg: "3·1=3,6,9,12; 4·1=4,8,12 → 12" }],
          niveaus: {
            basis: "Gemeenschappelijke noemer 3 en 4 = 12.",
            simpeler: "3×4 = 12. Werkt altijd.",
            nogSimpeler: "Zoek getal waar 3 én 4 in passen: 12.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Tellers optellen", tekst: "²⁄₇ + ³⁄₇: noemer blijft 7, tellers samen: 2+3=5 → ⁵⁄₇." }],
          woorden: [{ woord: "gelijknamig", uitleg: "zelfde noemer" }],
          theorie: "Zelfde noemer? Tel alleen tellers op, noemer blijft.",
          voorbeelden: [{ type: "voorbeeld", tekst: "¹⁄₅ + ²⁄₅ = ³⁄₅" }],
          basiskennis: [{ onderwerp: "logisch", uitleg: "2 stukken + 3 stukken (van 7) = 5 stukken (van 7)" }],
          niveaus: {
            basis: "²⁄₇ + ³⁄₇ = ⁵⁄₇ (noemer blijft).",
            simpeler: "2+3 = 5 boven. 7 blijft onder.",
            nogSimpeler: "2 stukjes + 3 stukjes = 5 stukjes.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Gelijknamig + optellen", tekst: "½ = ²⁄₄. Dan ¼ + ²⁄₄ = ³⁄₄." }],
          woorden: [{ woord: "gemeenschappelijke noemer", uitleg: "hier 4 (waar 2 én 4 in passen)" }],
          theorie: "Ongelijke noemers? Eerst gelijknamig (zelfde noemer), dan tellers optellen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "¼ + ²⁄₄ = ³⁄₄" }],
          basiskennis: [{ onderwerp: "½ = ²⁄₄", uitleg: "boven én onder × 2" }],
          niveaus: {
            basis: "½ wordt ²⁄₄. Dan ¼ + ²⁄₄ = ¾.",
            simpeler: "Eerst zelfde noemer. ½ = ²⁄₄. Dan 1+2 = 3 boven.",
            nogSimpeler: "Maak van ½ eerst ²⁄₄. Dan 1+2 = 3 → ¾.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "vereenvoudigen", uitleg: "³⁄₆ = ½ (÷3)" }],
          theorie: "Gelijknamig maken, tellers aftrekken, dan vereenvoudigen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "⅚ − ²⁄₆ = ³⁄₆ = ½" }],
          basiskennis: [{ onderwerp: "check", uitleg: "³⁄₆: beide door 3 = ½" }],
          niveaus: {
            basis: "⅓ = ²⁄₆. ⅚ − ²⁄₆ = ³⁄₆ = ½.",
            simpeler: "Maak van ⅓ eerst ²⁄₆. Dan 5−2 = 3 boven.",
            nogSimpeler: "5 stukjes − 2 stukjes = 3 stukjes van 6 = ½.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "vermenigvuldigen", uitleg: "geen gelijknamig nodig" }],
          theorie: "Bij × geen gelijknamig maken. Gewoon boven·boven, onder·onder.",
          voorbeelden: [{ type: "voorbeeld", tekst: "½ × ⅓ = ¹⁄₆. ⅔ × ¾ = ⁶⁄₁₂ = ½." }],
          basiskennis: [{ onderwerp: "vereenvoudigen", uitleg: "³⁄₁₂ = ¼ (÷3)" }],
          niveaus: {
            basis: "¾ × ⅓ = ³⁄₁₂ = ¼.",
            simpeler: "Boven × boven: 3×1=3. Onder × onder: 4×3=12.",
            nogSimpeler: "3 keer 1 = 3 boven. 4 keer 3 = 12 onder. = ³⁄₁₂ = ¼.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "omgekeerde", uitleg: "teller en noemer wisselen" }],
          theorie: "Delen door breuk = vermenigvuldigen met omgekeerde breuk.",
          voorbeelden: [{ type: "voorbeeld", tekst: "½ ÷ ⅓ = ½ × ³⁄₁ = 1½" }],
          basiskennis: [{ onderwerp: "logisch", uitleg: "hoe vaak past ¼ in ½? 2 keer." }],
          niveaus: {
            basis: "½ ÷ ¼ = ½ × 4 = 2.",
            simpeler: "Tweede breuk omkeren: ¼ wordt ⁴⁄₁. Dan ½ × 4 = 2.",
            nogSimpeler: "¼ past 2 keer in ½.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Vermenigvuldigen gaat altijd voor optellen, ook met breuken.",
          voorbeelden: [{ type: "voorbeeld", tekst: "½×⅖ = ²⁄₁₀ = ⅕" }],
          basiskennis: [{ onderwerp: "HMVO-regel", uitleg: "Haakjes Machten Vermenigvuldigen Optellen" }],
          niveaus: {
            basis: "Eerst ⅕. Dan ⅓ + ⅕ = ⁸⁄₁₅.",
            simpeler: "Eerst keer-som: ½×⅖ = ⅕. Daarna ⅓ + ⅕.",
            nogSimpeler: "Doe eerst keer-som, daarna plus-som.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "van", uitleg: "betekent vermenigvuldigen" }],
          theorie: "Breuk van getal: deel door noemer, keer teller.",
          voorbeelden: [{ type: "voorbeeld", tekst: "⅖ van 30: 30÷5=6, 2×6=12" }],
          basiskennis: [{ onderwerp: "check", uitleg: "¼ van 60 = 15. Drie kwart = 3×15 = 45." }],
          niveaus: {
            basis: "60÷4 = 15. 3×15 = 45.",
            simpeler: "Eén kwart van 60 = 15. Drie kwart = 45.",
            nogSimpeler: "60 delen door 4 = 15. Drie keer 15 = 45.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Gelijknamig + vergelijken", tekst: "⅗ = ⁹⁄₁₅. ⅔ = ¹⁰⁄₁₅. 10 > 9 → ⅔ groter." }],
          woorden: [{ woord: "vergelijken", uitleg: "welke heeft grotere waarde" }],
          theorie: "Maak gelijknamig (zelfde noemer), dan grootste teller wint.",
          voorbeelden: [{ type: "voorbeeld", tekst: "¾=0,75 vs ⅖=0,4 → ¾ groter" }],
          basiskennis: [{ onderwerp: "kommagetal", uitleg: "⅗≈0,6 en ⅔≈0,67" }],
          niveaus: {
            basis: "⅗ = ⁹⁄₁₅. ⅔ = ¹⁰⁄₁₅. ⅔ wint.",
            simpeler: "Maak beide naar 15-en. 9 < 10 → ⅔ groter.",
            nogSimpeler: "⅗ = 0,6. ⅔ = 0,67. 0,67 > 0,6.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "× voor +", tekst: "Eerst ⅓×⅙ = ¹⁄₁₈. Dan ½ + ¹⁄₁₈ = ⁹⁄₁₈ + ¹⁄₁₈ = ¹⁰⁄₁₈." }],
          woorden: [{ woord: "volgorde", uitleg: "haakjes → × ÷ → + −" }],
          theorie: "Vermenigvuldigen voor optellen.",
      ...
      { q: "½ + ¼ = ?", options: ["¾","⅙","⅔","¼"], answer: 0, wrongHints: [null,"Klopt — gelijknamig: ²⁄₄ + ¼ = ¾.","Niet — gelijknamig maken.","Niet.","Niet."] },
      { q: "⅔ × ¾ = ?", options: ["½","¹⁄₂₄","¹²⁄₁₂","⅚"], answer: 0, wrongHints: [null,"Klopt — teller×teller, noemer×noemer = ⁶⁄₁₂ = ½.","Niet — niet plus.","Niet zo gerekend.","Niet."] },
      { q: "⅓ + ⅙ = ?", options: ["½","⅔","⅙","⅕"], answer: 0, wrongHints: [null,"Klopt — gelijknamig ²⁄₆+⅙ = ³⁄₆ = ½.","Te hoog.","Niet.","Niet."] },
      { q: "Vereenvoudig: ⁶⁄₈ = ?", options: ["¾","⅓","⅛","½"], answer: 0, wrongHints: [null,"Klopt — beide ÷2.","Niet.","Niet.","Niet."] },
      { q: "¾ ÷ ½ = ?", options: ["1½","⅜","¼","2"], answer: 0, wrongHints: [null,"Klopt — delen door breuk = vermenigvuldigen met omgekeerde: ¾×2 = 1½.","Niet — andersom.","Niet.","Niet."] },
      { q: "3/4 als decimaal?", options: ["0,75","0,34","0,43","0,8"], answer: 0, wrongHints: [null,"Klopt — 3÷4.","Niet — alleen cijfers gehusseld.","Niet.","Niet."] },
      { q: "¼ + ⅛ = ?", options: ["⅜","½","⅙","⅔"], answer: 0, wrongHints: [null,"Klopt — gelijknamig ²⁄₈+⅛=⅜.","Te hoog.","Niet.","Niet."] },
      { q: "2½ + 1¼ = ?", options: ["3¾","3¼","4","4½"], answer: 0, wrongHints: [null,"Klopt — gehele apart, breuken apart.","Niet.","Niet — niet rond.","Te veel."] },
      { q: "Welke breuk is groter: ⅓ of ¼?", options: ["⅓","¼","Gelijk","Niet te zeggen"], answer: 0, wrongHints: [null,"Klopt — bij gelijke teller, kleinere noemer = groter.","Niet — andersom.","Niet — verschillend.","Wel — andersom dan PO."] },
      { q: "1 − ⅖ = ?", options: ["⅗","⅖","⅘","½"], answer: 0, wrongHints: [null,"Klopt — 1 = ⁵⁄₅, dus ⁵⁄₅ − ⅖ = ⅗.","Andersom.","Niet.","Niet."] },
    ],
  },
];
