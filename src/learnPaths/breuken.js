...
<text x="150" y="175" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">je hebt breuken onder de knie 🏆</text>
    ...
    checks: [
      ...
      { q: "**Open vraag**: hoeveel is **½ + ¼** (typ als breuk)?", kind: "open", acceptedAnswers: ["3/4", "0,75", "0.75"], explanation: "½ = 2/4. 2/4 + 1/4 = 3/4." },
      { q: "**Open vraag**: schrijf **0,5** als breuk (typ a/b).", kind: "open", acceptedAnswers: ["1/2", "2/4"], explanation: "0,5 = ½ = 1/2." },
      { q: "**Open vraag**: hoeveel is **2/3 van 60**? (typ alleen getal)", kind: "open", acceptedAnswers: ["40"], numericTolerance: 0, explanation: "60/3 = 20, ×2 = 40." },
    ],
  },
];
