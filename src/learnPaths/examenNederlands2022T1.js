...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "Het signaalwoord 'daarmee' wijst op een gevolg: afleiden (oorzaak) → kennis opdoen wordt gefrustreerd (gevolg). Dus oorzaak-gevolg. Antwoord B.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 9-12: scholen praten erover, zoeken balans tussen voor- en nadelen, en proberen kinderen te leren focussen. De rode draad door dit blok = zoeken naar evenwichtig gebruik. Antwoord D.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "'De toename zwakt af' = het IQ stijgt nog steeds, maar minder snel dan vroeger. Het daalt dus niet — de groei wordt alleen kleiner. Antwoord D.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Een advertentie wil bijna altijd activeren (tot actie aanzetten). De kern hier: meld je aan als taalvrijwilliger. De website is daarbij het middel. Antwoord C.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 1-2: 'we willen wel, maar we doen het niet' — een discrepantie tussen wens en gedrag. Niet onwil, maar het lukt nog niet. Antwoord D.",
