    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — hertz.", "Dat is amplitude.", "Anders ding.", "Niet relevant."],
      },
      {
        q: "Welke **frequentie-range** kan een mens horen?",
        options: ["20-20.000 Hz", "0-10 Hz", "100-200 Hz", "0-100.000 Hz"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Te smal.", "Te smal.", "Te ruim — boven 20K = ultrasoon."],
      },
      {
        q: "Hoe snel reist geluid in **lucht**?",
        options: ["~343 m/s", "~1.500 m/s", "~300.000 km/s", "~10 m/s"],
        answer: 0,
        wrongHints: [null, "Klopt — bij 20°C.", "In water.", "Dat is licht!", "Te langzaam."],
      },
      {
        q: "Wat hoor je in **vacuüm**?",
        options: ["Niets", "Hetzelfde", "Sneller geluid", "Meer geluid"],
        answer: 0,
        wrongHints: [null, "Klopt — geluid heeft medium nodig.", "Geen medium = geen geluid.", "Geen geluid mogelijk.", "Geen geluid mogelijk."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — c.", "Dat is geluid in lucht.", "Te langzaam.", "Niet oneindig — wel super snel."],
      },
      {
        q: "Hoe gaat licht **door lucht**?",
        options: ["In een rechte lijn", "In een cirkel", "In zigzag", "Krom"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet.", "Niet.", "Wel — door breking gedeeltelijk."],
      },
      {
        q: "Wat is een **echte lichtbron**?",
        options: ["Iets dat zelf licht maakt (zon, lamp)", "Iets dat licht weerkaatst", "Beide", "Donker"],
        answer: 0,
        wrongHints: [null, "Klopt — zon, kaars, lamp.", "Dat is verlicht voorwerp.", "Specifieker: alleen die zelf produceren.", "Geen licht."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — eenheid van afstand.", "Geen astronomische eenheid.", "Geen tijdseenheid (al klinkt het zo).", "Niet."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is holle lens.", "Niet lens.", "Geen lens."],
      },
      {
        q: "**Wet van reflectie**?",
        options: ["Hoek van inval = hoek van weerkaatsing", "Licht weg, geluid terug", "Spiegel maakt 2× licht", "Alleen voor sterren"],
        answer: 0,
        wrongHints: [null, "Klopt — t.o.v. normaal.", "Niet.", "Niet.", "Geldt overal."],
      },
      {
        q: "Welk lens voor **bijziend** (ver wazig)?",
        options: ["Holle lens (negatief)", "Bolle lens", "Vlakke lens", "Cilindrisch"],
        answer: 0,
        wrongHints: [null, "Klopt — verkleint, duwt licht naar netvlies achter.", "Voor verziend.", "Geen lens.", "Voor astigmatisme."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — beeld ontstaat hier.", "Regelt hoeveelheid licht.", "Helpt focussen.", "Geeft kleur aan oog."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        options: ["7", "3", "10", "5"],
        answer: 0,
        wrongHints: [null, "Klopt — ROGGBIV.", "Dat zijn primaire kleuren.", "Te veel.", "Te weinig."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Geen lichtbron.", "Niet geluid.", "Wel bekend."],
      },
      {
        q: "Primaire kleuren bij **licht (RGB)**?",
        options: ["Rood + Groen + Blauw", "Rood + Geel + Blauw", "Cyaan + Magenta + Geel", "Wit + Zwart"],
        answer: 0,
        wrongHints: [null, "Klopt — additief.", "Oude verf-theorie.", "Voor inkt (subtractief).", "Geen primaire."],
      },
      {
        q: "Wat is **UV-straling**?",
        options: ["Onzichtbaar boven violet (zonnebrand)", "Soort radio", "Geluid", "Pijn"],
        answer: 0,
        wrongHints: [null, "Klopt — ultraviolet.", "Lagere frequentie.", "Geen licht.", "Niet."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 3 dingen werken.", "Lager.", "Materiaal heeft effect maar niet primair.", "Wel iets."],
      },
      {
        q: "Hoe ontstaat een **regenboog**?",
        options: ["Zonlicht door regendruppels breekt in kleuren", "Magie", "Toeval", "Wolken kleuren"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Geen magie.", "Wetenschappelijk verklaarbaar.", "Wolken hebben geen eigen kleur normaal."],
      },
      {
        q: "Wat maakt **laserstraal** speciaal?",
        options: ["1 golflengte + in fase, heel sterk", "Onzichtbaar", "Geluid", "Hard"],
        answer: 0,
        wrongHints: [null, "Klopt — monochromatisch + coherent.", "Wel zichtbaar (de straal).", "Geen geluid.", "Wel sterk, maar specifiek mono+coherent."],
      },
      {
        q: "**3 sec tussen bliksem en donder** = afstand?",
        options: ["~1 km", "~100 m", "~10 km", "~100 km"],
        answer: 0,
        wrongHints: [null, "Klopt — 3 × 343m = ~1 km.", "Te dichtbij.", "Te ver.", "Veel te ver."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — lucht/water/vast.", "Dat is licht.", "Geen verband.", "Geen verband."],
      },
      {
        q: "Lichtsnelheid?",
        options: ["~300.000 km/s", "~343 m/s", "~1.500 m/s", "Oneindig"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Geluid in lucht.", "Geluid in water.", "Niet oneindig — wel snelste."],
      },
      {
        q: "**Reflectie-wet**: hoek van inval = ... ?",
        options: ["Hoek van weerkaatsing", "0°", "90°", "Onbekend"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet.", "Niet.", "Wel bekend."],
      },
      {
        q: "Welke kleur weerkaatst een **gele citroen**?",
        options: ["Geel", "Wit", "Zwart", "Alle behalve geel"],
        answer: 0,
        wrongHints: [null, "Klopt — andere kleuren absorbeert.", "Niet wit.", "Zwart absorbeert alles.", "Tegenovergesteld."],
      },
      {
        q: "Wat is **UV-licht**?",
        options: ["Onzichtbaar boven violet (zonnebrand)", "Soort kleur", "Geluid", "Verboden"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet zichtbaar.", "Geen geluid.", "Niet verboden, wel schadelijk."],
      },
      {
        q: "Mens hoort **frequenties** tot ... ?",
        options: ["20.000 Hz", "100 Hz", "1 miljoen Hz", "1.000.000.000 Hz"],
        answer: 0,
        wrongHints: [null, "Klopt — boven is ultrasoon.", "Te weinig.", "Onmogelijk.", "Belachelijk veel."],
      },
    ],
  },
];
