...
const steps = [
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "Hoeveel **dagen** heeft februari in een **schrikkeljaar**?", options: ["29","28","30","31"], answer: 0, wrongHints: [null,"Klopt — schrikkel = 1 extra.","Niet — gewoon jaar.","Niet — geen 30.","Niet — geen 31."] },
      { q: "Hoeveel **maanden** in 1 jaar?", options: ["12","10","11","13"], answer: 0, wrongHints: [null,"Klopt.","Te weinig.","Te weinig.","Te veel."] },
      { q: "Welke maand heeft **31 dagen**?", options: ["Januari","Februari","April","September"], answer: 0, wrongHints: [null,"Klopt — bovenkant vuist-truc.","Niet — 28/29.","Niet — 30.","Niet — 30."] },
      { q: "**Schrikkeljaar** komt elke?", options: ["4 jaar","2 jaar","10 jaar","100 jaar"], answer: 0, wrongHints: [null,"Klopt — bijna altijd elke 4.","Te vaak.","Te zelden.","Niet primair."] },
      { q: "Hoeveel **weken** in 1 jaar (ongeveer)?", options: ["52","12","100","30"], answer: 0, wrongHints: [null,"Klopt — 365÷7.","Dat is maanden.","Niet.","Niet."] },
      { q: "Welke dag komt **na vrijdag**?", options: ["Zaterdag","Donderdag","Zondag","Maandag"], answer: 0, wrongHints: [null,"Klopt.","Niet — daarvóór.","Niet — dag erna 2.","Niet."] },
      { q: "Geboren 2014, hoe oud in 2026?", options: ["12","11","13","10"], answer: 0, wrongHints: [null,"Klopt — 2026−2014.","Niet — verjaardag al gehad.","Te oud.","Te jong."] },
      { q: "**Koningsdag** is op?", options: ["27 april","30 april","5 mei","30 maart"], answer: 0, wrongHints: [null,"Klopt — verjaardag W-A.","Vroegere Koninginnedag.","Bevrijdingsdag.","Niet."] },
      { q: "**Bevrijdingsdag** is op?", options: ["5 mei","4 mei","27 april","31 december"], answer: 0, wrongHints: [null,"Klopt — 1945.","Dodenherdenking.","Koningsdag.","Oudjaar."] },
      { q: "**Dodenherdenking** is op?", options: ["4 mei","5 mei","11 nov","2 nov"], answer: 0, wrongHints: [null,"Klopt — avond herdenking.","Bevrijding.","Wapenstilstand WO1.","Niet."] },
      { q: "Hoeveel **dagen** in een week?", options: ["7","5","10","6"], answer: 0, wrongHints: [null,"Klopt.","Werkweek.","Niet.","Niet."] },
      { q: "Een **kwartaal** heeft hoeveel maanden?", options: ["3","4","6","12"], answer: 0, wrongHints: [null,"Klopt — kwart jaar.","Niet.","Half jaar.","Heel jaar."] },
      { q: "Eeuw heeft hoeveel **jaar**?", options: ["100","10","1000","50"], answer: 0, wrongHints: [null,"Klopt.","Decennium.","Millennium.","Halve eeuw."] },
      { q: "Hoeveel dagen in **3 weken**?", options: ["21","20","14","30"], answer: 0, wrongHints: [null,"Klopt — 3×7.","Niet.","Dat is 2 weken.","Niet."] },
    ],
  },
];
