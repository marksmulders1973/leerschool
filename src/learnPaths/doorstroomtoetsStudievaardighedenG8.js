    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "4 km. A.",
            simpeler: "2 × 200.000 = 400.000 cm = 4 km. = A.",
            nogSimpeler: "4 km = A.",
          },
        },
      },
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "O (oost). A.",
            simpeler: "Klok: N→O→Z→W. = A.",
            nogSimpeler: "Rechts van N = O = A.",
          },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "1:1 miljoen = veel land op 1 kaart. = A.",
            nogSimpeler: "Groot gebied = A.",
          },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "Lijn die op- en neergaat = tijd-verloop. = A.",
            nogSimpeler: "Tijd = A.",
          },
        },
      },
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "20%. A.",
            simpeler: "100 − 50 − 30 = 20. = A.",
            nogSimpeler: "Rest = 100 − 80 = 20% = A.",
          },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "C4 = vak in kaart-raster. = A.",
            nogSimpeler: "Vak = A.",
          },
        },
      },
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Index. A.",
            simpeler: "Index achterin geeft direct de pagina. = A.",
            nogSimpeler: "Index = A.",
          },
        },
      },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "Pijl wijst van vorig naar volgend = volgorde. = A.",
            nogSimpeler: "Volgorde = A.",
          },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "1975 ligt tussen 1950 en 2000. = A.",
            nogSimpeler: "1950 < 1975 < 2000 = A.",
          },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Konijn. A.",
            simpeler: "Pijl konijn → vos betekent: vos eet konijn. = A.",
            nogSimpeler: "Konijn = A.",
          },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "taart eerst. A.",
            simpeler: "ta-a- vóór ta-b- vóór ta-f-. = A.",
            nogSimpeler: "a vóór b vóór f. taart = A.",
          },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Goed. A.",
            simpeler: "Legenda = uitleg van kleuren/symbolen. = A.",
            nogSimpeler: "Goed = A.",
          },
        },
      },
