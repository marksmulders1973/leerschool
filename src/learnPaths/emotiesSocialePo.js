...
const steps = [
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Maakt erger.", "Niet OK.", "Wel iets."],
      },
      {
        q: "Wat is een **ik-boodschap**?",
        options: ["Eigen gevoel uiten ('Ik voel...')", "Verwijt aan ander", "Geen mening", "Schreeuwen"],
        answer: 0,
        wrongHints: [null, "Klopt — minder ruzie.", "Jij-boodschap.", "Wel mening.", "Niet."],
      },
      {
  ...
  },
  {
    ...
    checks: [
      { q: "Hoeveel **basis-emoties** (Ekman)?", options: ["6", "1", "100", "0"], answer: 0, wrongHints: [null, "Klopt.", "Te weinig.", "Te veel.", "Wel."] },
      { q: "Wat is **ik-boodschap**?", options: ["Eigen gevoel uiten", "Verwijt aan ander", "Geen mening", "Schreeuwen"], answer: 0, wrongHints: [null, "Klopt.", "Jij-boodschap.", "Wel mening.", "Niet."] },
      { q: "Wat is **pesten** vs plagen?", options: ["Pesten = herhaald + gericht", "Geen verschil", "Plagen erger", "Niet bekend"], answer: 0, wrongHints: [null, "Klopt.", "Wel verschil.", "Tegenovergesteld.", "Wel."] },
      { q: "Welk nummer **Kindertelefoon**?", options: ["0800-0432", "112", "0900", "0800-2000"], answer: 0, wrongHints: [null, "Klopt.", "Spoed.", "Niet.", "Veilig Thuis."] },
      { q: "Wat doe je bij **boosheid**?", options: ["Tel 10 + diep ademen", "Direct schreeuwen", "Slaan", "Niets"], answer: 0, wrongHints: [null, "Klopt.", "Maakt erger.", "Niet OK.", "Wel reageren."] },
      { q: "Wat doe je als **getuige van pesten**?", options: ["Spreek uit + help + vertel volwassene", "Negeer", "Lach mee", "Pest mee"], answer: 0, wrongHints: [null, "Klopt — moed.", "Wegkijken werkt niet.", "Slecht.", "Slecht."] },
    ],
  },
];
