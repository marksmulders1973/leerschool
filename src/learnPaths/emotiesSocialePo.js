...
// Sluit op puberteit-groei. Toets-burgerschap. 1F. 4 stappen.
...
const emotiesSocialePo = {
  ...
  title: "Emoties + sociaal omgaan (Doorstroomtoets groep 6-8)",
  emoji: "😊",
  level: "groep6-8",
  ...
  intro:
    "Emoties + sociaal omgaan voor Doorstroomtoets groep 6-8 — 6 basis-emoties (Ekman) + omgaan met boosheid/verdriet/angst + vrienden maken + conflict oplossen (ik-boodschap) + pesten (4 soorten + KiVa + Kindertelefoon 0800-0432) + grenzen + getuige-rol. Sluit op puberteit. ~15 min.",
  triggerKeywords: [
    "emoties", "gevoelens",
