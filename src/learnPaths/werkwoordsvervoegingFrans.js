    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Groep 2.", "Groep 3.", "Onregelmatig."],
      },
      {
        q: "Wat betekent **'tu'**?",
        options: ["jij", "ik", "hij", "wij"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is 'je'.", "Dat is 'il'.", "Dat is 'nous'."],
      },
      {
        q: "Wat is de stam van **'aimer'**?",
        options: ["aim-", "aimer-", "am-", "aime-"],
        answer: 0,
        wrongHints: [null, "Klopt — verwijder -er.", "Met -er.", "Spelling fout.", "Met -e."],
      },
      {
        q: "Waarom **'j'aime'** en niet **'je aime'**?",
        options: ["Voor klinker wordt je → j'", "Spelling fout", "Beide goed", "Alleen poëzie"],
        answer: 0,
        wrongHints: [null, "Klopt — elisie.", "Wel correct.", "Niet allebei.", "Algemene regel."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor 'tu'.", "Voor 'ils'.", "Infinitief."],
      },
      {
        q: "**parler + nous** → ?",
        options: ["nous parlons", "nous parle", "nous parlez", "nous parlent"],
        answer: 0,
        wrongHints: [null, "Klopt — -ons.", "Niet meervoud.", "Voor vous.", "Voor ils."],
      },
      {
        q: "**finir + il** → ?",
        options: ["il finit", "il finis", "il finissent", "il finissons"],
        answer: 0,
        wrongHints: [null, "Klopt — derde persoon ev.", "Voor je/tu.", "Voor ils.", "Voor nous."],
      },
      {
        q: "**vendre + tu** → ?",
        options: ["tu vends", "tu vend", "tu vendes", "tu vendons"],
        answer: 0,
        wrongHints: [null, "Klopt — -s.", "Voor il.", "Niet correct.", "Voor nous."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor tu.", "Voor il.", "Voor ils."],
      },
      {
        q: "**avoir + nous** → ?",
        options: ["nous avons", "nous a", "nous as", "nous ont"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor il.", "Voor tu.", "Voor ils."],
      },
      {
        q: "**aller + tu** → ?",
        options: ["tu vas", "tu allez", "tu va", "tu vais"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor vous.", "Voor il.", "Voor je."],
      },
      {
        q: "**'Je ___ aller au cinéma.'** Welk werkwoord?",
        options: ["vais (van aller — futur proche)", "suis", "ai", "vais aller"],
        answer: 0,
        wrongHints: [null, "Klopt — futur proche.", "être past niet.", "avoir past niet.", "Niet dubbel."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Présent.", "Identiek aan A.", "Passé composé."],
      },
      {
        q: "Imparfait van **'être' (j')** = ?",
        options: ["j'étais", "je suis", "j'ai été", "j'étions"],
        answer: 0,
        wrongHints: [null, "Klopt — speciale stam ét-.", "Présent.", "Passé composé.", "Voor nous."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is Passé composé.", "Niet verleden.", "Présent."],
      },
      {
        q: "Imparfait van **'avoir' (nous)** = ?",
        options: ["nous avions", "nous avons", "nous avaient", "nous avait"],
        answer: 0,
        wrongHints: [null, "Klopt — av- + -ions.", "Présent.", "Voor ils.", "Voor il."],
      },
    ],
  },
  ...
  // STAP 5: Passé composé
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — -é voor groep 1.", "Niet correct.", "Voor -ir.", "Bestaat niet."],
      },
      {
        q: "Participe passé van **'avoir'** = ?",
        options: ["eu", "avu", "ai", "été"],
        answer: 0,
        wrongHints: [null, "Klopt — onregelmatig.", "Niet correct.", "Présent.", "Van être."],
      },
      {
        q: "**'Elle ___ allée au cinéma.'** Welk werkwoord?",
        options: ["est (être)", "a (avoir)", "va (aller)", "fait (faire)"],
        answer: 0,
        wrongHints: [null, "Klopt — aller = être + participe.", "Niet voor aller.", "Présent, geen voltooid.", "Verkeerd."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor je/il.", "Voor nous.", "Voor vous."],
      },
      {
        q: "**être + il** in Présent → ?",
        options: ["il est", "il a", "il sont", "il était"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Avoir.", "Voor ils.", "Imparfait."],
      },
      {
        q: "Imparfait van **'avoir' (j')** = ?",
        options: ["j'avais", "j'ai", "j'avait", "j'eu"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Présent.", "Voor il.", "Participe passé."],
      },
      {
        q: "Participe passé van **'finir'** = ?",
        options: ["fini", "finu", "finit", "finissé"],
        answer: 0,
        wrongHints: [null, "Klopt — -ir → -i.", "Niet correct.", "Présent (il).", "Bestaat niet."],
      },
      {
        q: "**'Nous ___ allés à Paris.'** Passé composé.",
        options: ["sommes", "avons", "étions", "irons"],
        answer: 0,
        wrongHints: [null, "Klopt — aller = être.", "Niet voor aller.", "Imparfait.", "Futur."],
      },
      {
        q: "**aller + nous** in Présent → ?",
        options: ["nous allons", "nous va", "nous allez", "nous vais"],
        answer: 0,
        wrongHints: [null, "Klopt — onregelmatig.", "Voor il.", "Voor vous.", "Voor je."],
      },
    ],
  },
];
