...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "De hele tekst draait om bomenmakelaar.nl: een manier om bomen te verplaatsen in plaats van te kappen. Dat is dé oplossing om onnodige bomenkap tegen te gaan. Antwoord B.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 12: Heindijk wil een bomendatabank/platform (het middel). Alinea 13: 'Zo kun je burgers beter informeren...' = waarvóór dat platform dient (het doel). Dus middel-doel. Antwoord A.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "De hoofdgedachte vat de hele tekst samen: bomen worden in kaart gebracht en verplaatst om onnodige kap te voorkomen en volwassen bomen te redden. Antwoord D.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 3-5 zetten verschillende theorieën/verklaringen voor gapen op een rij (sociale spanning, zuurstof, overgangsfases). De rode draad door dit blok = verklaringen voor gapen. Antwoord D.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "De tekst legt neutraal uit wat de functie van gapen is en hoe het werkt — dat is informeren. Ze probeert je niet van één standpunt te overtuigen. Antwoord B.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "'Opvallen in de kudde' = je onderscheiden van de rest (onderscheidend). 'Met beide laarzen in de Hollandse klei' = met beide benen op de grond, nuchter. Samen: onderscheidend én nuchter. Antwoord B.",
