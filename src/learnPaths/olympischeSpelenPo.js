    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 5 goud + 5 zilver + 3 brons.", "10 medailles.", "Geen NL.", "Nog meer komen mogelijk."],
      },
      {
        q: "NL is **top** in welke wintersport?",
        options: ["Schaatsen", "IJshockey", "Skeleton", "Curling"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet sterk.", "Niet.", "Niet."],
      },
      {
        q: "**Femke Bol** is sterk in?",
        options: ["400m horden / 4x400m", "Zwemmen", "Schaatsen", "Tennis"],
        answer: 0,
        wrongHints: [null, "Klopt — atletiek.", "Niet.", "Niet.", "Niet."],
      },
      {
        q: "**Oranje** komt van?",
        options: ["Oranje-Nassau koninklijke familie", "Sinaasappel", "Vlag", "Olympisch"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Letterlijk niet.", "Niet primair.", "Niet."],
      },
    ],
  },
  {
    ...
    checks: [
      { q: "**Eerste moderne OS** in?", options: ["Athene 1896", "Olympia oud", "Parijs 1900", "Rome"], answer: 0, wrongHints: [null, "Klopt.", "Oude tijden.", "2e moderne.", "Later."] },
      { q: "Hoeveel **olympische ringen**?", options: ["5", "4", "6", "7"], answer: 0, wrongHints: [null, "Klopt.", "Te weinig.", "Te veel.", "Te veel."] },
      { q: "**Marathon** lengte?", options: ["42 km", "10 km", "100 km", "5 km"], answer: 0, wrongHints: [null, "Klopt — 42,195 km.", "Te kort.", "Te lang.", "Te kort."] },
      { q: "**Meest medailles** NL ooit?", options: ["Ireen Wüst", "Sven Kramer", "Phelps", "Femke Bol"], answer: 0, wrongHints: [null, "Klopt.", "Iets minder.", "Geen NL.", "Nog actief."] },
      { q: "**Goud** medaille voor?", options: ["1e plaats", "2e", "3e", "Doping"], answer: 0, wrongHints: [null, "Klopt.", "Zilver.", "Brons.", "Niet."] },
      { q: "Wat is **WADA**?", options: ["Anti-Doping-Agency", "Sportbond", "NL-team", "Stadion"], answer: 0, wrongHints: [null, "Klopt.", "Niet primair.", "Niet.", "Niet."] },
    ],
  },
];
