    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Doosje met een waarde. A.", simpeler: "Variabele = doosje = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Boolean. A.", simpeler: "True/False = boolean = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "\"34\". A.", simpeler: "Tekst + tekst = plakken = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "= toekennen, == vergelijken. A.", simpeler: "== is vergelijken = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Als de voorwaarde True is. A.", simpeler: "if = alleen bij waar = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Beide waar. A.", simpeler: "and = beide = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0 t/m 4. A.", simpeler: "range(5) = 0-4 = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Onbekend aantal. A.", simpeler: "while = zolang voorwaarde = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oneindige lus. A.", simpeler: "Geen ophoging = eeuwig = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Code benoemen + hergebruiken. A.", simpeler: "Functie = herbruikbaar blok = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geeft een waarde terug. A.", simpeler: "return = waarde terug = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Syntaxfout. A.", simpeler: "Start niet = syntaxfout = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
