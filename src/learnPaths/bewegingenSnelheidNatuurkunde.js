    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Vermenigvuldigen geeft geen snelheid.", "Optellen geeft geen snelheid.", "Aftrekken geeft geen snelheid."],
      },
      {
        q: "Auto rijdt **100 km in 2 uur**. Snelheid?",
        options: ["50 km/u", "200 km/u", "100 km/u", "2 km/u"],
        answer: 0,
        wrongHints: [null, "Klopt — 100÷2.", "Vermenigvuldigen.", "Niet 100 — controleer.", "Te langzaam."],
      },
      {
        q: "**s = v × t** — voor wat?",
        options: ["Afstand uitrekenen", "Snelheid", "Tijd", "Gewicht"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Andere formule.", "Andere formule.", "Geen formule."],
      },
      {
        q: "Fietser rijdt **30 min** met **20 km/u**. **Afstand**?",
        options: ["10 km", "20 km", "600 km", "5 km"],
        answer: 0,
        wrongHints: [null, "Klopt — 20 × 0,5 uur.", "Vergeet de halve uur.", "Veel te veel.", "Te weinig."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Andersom.", "Wel verband maar specifiek 3,6.", "Andersom."],
      },
      {
        q: "**20 m/s** = ... km/u?",
        options: ["72", "20", "36", "180"],
        answer: 0,
        wrongHints: [null, "Klopt — 20 × 3,6.", "Geen omrekening.", "Helft.", "Verkeerd."],
      },
      {
        q: "**100 km/u** ≈ ... m/s?",
        options: ["~28", "~10", "~360", "~1000"],
        answer: 0,
        wrongHints: [null, "Klopt — 100 ÷ 3,6.", "Te weinig.", "Vermenigvuldigd.", "Veel te veel."],
      },
      {
        q: "Bij **wetenschap** gebruik je meestal welke eenheid?",
        options: ["m/s", "km/u", "mph", "knopen"],
        answer: 0,
        wrongHints: [null, "Klopt — SI-eenheid.", "Voor verkeer.", "Engels-systeem.", "Voor scheepvaart."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is snelheid zelf.", "Geen verandering.", "Geen verandering."],
      },
      {
        q: "Auto: 0 → 30 m/s in **10 sec**. Versnelling?",
        options: ["3 m/s²", "30 m/s²", "10 m/s²", "0,3 m/s²"],
        answer: 0,
        wrongHints: [null, "Klopt — 30 ÷ 10.", "Vermenigvuldigen.", "Tijd, niet versnelling.", "Komma verkeerd."],
      },
      {
        q: "**Zwaartekracht** op aarde ongeveer?",
        options: ["~10 m/s²", "~1 m/s²", "~100 m/s²", "0 m/s²"],
        answer: 0,
        wrongHints: [null, "Klopt — precies 9,8.", "Te weinig.", "Te veel.", "Wel zwaartekracht."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 2× snelheid = ~4× remweg.", "Niet primair.", "Speelt mee maar niet kwadratisch.", "Niet hoofdfactor."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — afstand verandert niet.", "Dat is curve.", "Dat is steile lijn.", "Dat is dalend."],
      },
      {
        q: "Wat geeft een **steile rechte lijn** aan?",
        options: ["Hoge constante snelheid", "Stilstaan", "Versnellen", "Pauze"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Vlakke lijn.", "Curve, niet recht.", "Vlakke lijn."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet relevant.", "Dat is afstand.", "Dat is tijd."],
      },
      {
        q: "In een **snelheid-tijd-grafiek**: oppervlakte onder lijn = ?",
        options: ["Totale afstand", "Snelheid", "Versnelling", "Tijd"],
        answer: 0,
        wrongHints: [null, "Klopt — handige eigenschap.", "Dat is y-waarde.", "Dat is helling.", "Dat is x-as."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — sinds 2020.", "Nachts mag 130.", "Wel toegestaan.", "Niet altijd — nachts 130."],
      },
      {
        q: "Snelheid **geluid in lucht**?",
        options: ["~343 m/s", "~100 m/s", "~1.000 m/s", "~10.000 m/s"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Te weinig.", "Te veel.", "Veel te veel."],
      },
      {
        q: "**Lichtsnelheid**?",
        options: ["300.000 km/s", "300 km/s", "30.000 km/s", "Oneindig"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Te weinig.", "Te weinig.", "Niet oneindig."],
      },
      {
        q: "ISS *(ruimtestation)* draait in **~90 min** rond aarde — snelheid?",
        options: ["~28.000 km/u", "~1.000 km/u", "~100.000 km/u", "~280 km/u"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Te langzaam.", "Te snel.", "Veel te langzaam."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Geeft afstand.", "Geen formule.", "Geen formule."],
      },
      {
        q: "**60 km in 30 min**. Snelheid?",
        options: ["120 km/u", "30 km/u", "60 km/u", "2 km/u"],
        answer: 0,
        wrongHints: [null, "Klopt — 60 km in 0,5 uur = 120.", "Helft.", "Niet verhouding.", "Te weinig."],
      },
      {
        q: "**5 m/s** in km/u?",
        options: ["18 km/u", "5 km/u", "50 km/u", "1,4 km/u"],
        answer: 0,
        wrongHints: [null, "Klopt — × 3,6.", "Geen omrekening.", "Te veel.", "Andersom."],
      },
      {
        q: "**Versnelling-eenheid**?",
        options: ["m/s²", "km/u", "m", "sec"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Snelheid.", "Afstand.", "Tijd."],
      },
      {
        q: "**Vlakke lijn** afstand-tijd-grafiek = ?",
        options: ["Stilstaan", "Hoge snelheid", "Versnellen", "Terug bewegen"],
        answer: 0,
        wrongHints: [null, "Klopt — geen afstand erbij.", "Steile lijn.", "Curve.", "Dalende lijn."],
      },
      {
        q: "**Zwaartekracht** versnelling aarde?",
        options: ["~10 m/s²", "~5 m/s²", "~100 m/s²", "0 m/s²"],
        answer: 0,
        wrongHints: [null, "Klopt — 9,8 precies.", "Te weinig.", "Te veel.", "Wel zwaartekracht."],
      },
    ],
  },
];
