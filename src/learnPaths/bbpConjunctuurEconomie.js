  ...
  // STAP 1: BBP
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — onbetaald.", "Wel — betaald.", "Wel — betaald.", "Wel — betaald."],
      },
      {
        q: "Wat is **reëel** BBP?",
        options: ["BBP gecorrigeerd voor inflatie", "BBP zonder belasting", "BBP per huishouden", "BBP van vorig jaar"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet de definitie.", "Niet correct.", "Niet hetzelfde."],
      },
      {
        q: "**5% nominale BBP-groei**, **3% inflatie** → reële groei?",
        options: ["~2%", "8%", "5%", "3%"],
        answer: 0,
        wrongHints: [null, "Klopt — 5−3.", "Onlogisch.", "Nominaal.", "Inflatie alleen."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Iets anders.", "Niet relevant.", "Iets anders."],
      },
      {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet de classificatie.", "Niet werkloosheid.", "Wel 4 hoofdsoorten."],
      },
      {
        q: "Werkloosheid van **mijnwerkers nadat mijnen sluiten** — welke?",
        options: ["Structureel", "Frictie", "Conjunctureel", "Seizoen"],
        answer: 0,
        wrongHints: [null, "Klopt — banen blijvend weg.", "Frictie = tijdelijk tussen banen.", "Niet door recessie.", "Niet seizoens."],
      },
      {
        q: "Werkloosheid door **recessie** — welke?",
        options: ["Conjunctureel", "Frictie", "Structureel", "Seizoen"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet tussen banen.", "Niet blijvend.", "Niet seizoens."],
      },
      {
        q: "**WW-uitkering** is voor wie?",
        options: ["Onvrijwillig werklozen met arbeidsverleden", "Iedereen", "Studenten", "Pensionado's"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet iedereen.", "Studenten apart.", "Pensioen apart."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — ECB doet dit.", "Dat is begrotingsbeleid.", "Niet beleid-makers.", "Niet beleid."],
      },
      {
        q: "Wat doet overheid bij **recessie**?",
        options: ["Belasting omlaag + uitgaven omhoog", "Belasting omhoog", "Beide omlaag", "Niets"],
        answer: 0,
        wrongHints: [null, "Klopt — anti-cyclisch.", "Verkeerde richting.", "Helpt niet.", "Wel iets — anti-cyclisch."],
      },
      {
        q: "Welke is **Keynesiaans**?",
        options: ["Anti-cyclisch (regering springt in bij recessie)", "Geen overheid", "Pro-cyclisch", "Alleen rente"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenovergesteld.", "Anti-Keynesiaans.", "Niet alleen rente."],
      },
      {
        q: "Wat is **EU-norm** voor staatsschuld?",
        options: ["Max 60% BBP", "Max 30%", "Max 100%", "Geen norm"],
        answer: 0,
        wrongHints: [null, "Klopt — Maastricht-criteria.", "Te streng.", "Te ruim.", "Wel norm."],
      },
    ],
  },
  ...
  // STAP 6: Eind-toets
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — onderdeel van golfbeweging.", "Andersoortig fenomeen.", "Andersoortig.", "Andersoortig."],
      },
      {
        q: "**ECB-doel** voor inflatie?",
        options: ["~2%", "0%", "5%", "10%"],
        answer: 0,
        wrongHints: [null, "Klopt — stabiel + lichte groei.", "Deflatie risico.", "Te hoog.", "Veel te hoog."],
      },
      {
        q: "Werkloosheid van **ijsverkoper in januari** — welk soort?",
        options: ["Seizoens", "Frictie", "Conjunctureel", "Structureel"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet tussen banen.", "Niet door recessie.", "Niet blijvend weg."],
      },
      {
        q: "Bij **hoge inflatie** wat doet ECB?",
        options: ["Rente omhoog", "Rente omlaag", "Geld bijdrukken", "Niets"],
        answer: 0,
        wrongHints: [null, "Klopt — lenen duurder = vraag remmen.", "Andersom.", "Verergert inflatie.", "Wel iets."],
      },
      {
