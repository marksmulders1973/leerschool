    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Amsterdam. A.", simpeler: "Hoofdstad NL = Amsterdam (regering wel in Den Haag).", nogSimpeler: "Amsterdam" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "12. A.", simpeler: "NL heeft 12 provincies (Flevoland sinds 1986 erbij).", nogSimpeler: "12" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Flevoland (1986). A.", simpeler: "Flevoland = jongste, op nieuw land uit zee gewonnen, sinds 1986.", nogSimpeler: "Flevoland" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Limburg. A.", simpeler: "Vaalserberg (323 m, hoogste NL) ligt in Limburg, zuid-oost.", nogSimpeler: "Limburg" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Friesland (Fries). A.", simpeler: "Friesland heeft Fries als 2e officiële taal van NL.", nogSimpeler: "Friesland" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Leeuwarden. A.", simpeler: "Friesland → Leeuwarden (LEEUW-warden).", nogSimpeler: "Leeuwarden" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Flevoland. A.", simpeler: "Lelystad = Flevoland, jongste hoofdstad NL, vernoemd naar Lely.", nogSimpeler: "Flevoland" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Arnhem. A.", simpeler: "Gelderland → Arnhem (niet Nijmegen!).", nogSimpeler: "Arnhem" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Haarlem. A.", simpeler: "Noord-Holland → HAARLEM (Amsterdam = NL-hoofdstad).", nogSimpeler: "Haarlem" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Middelburg. A.", simpeler: "Zeeland → Middelburg (historische stad op Walcheren).", nogSimpeler: "Middelburg" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Maastricht. A.", simpeler: "Limburg → Maastricht (zuidelijke grensstad, Verdrag van Maastricht).", nogSimpeler: "Maastricht" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rijn, Maas, Schelde. A.", simpeler: "3 NL-rivieren: Rijn + Maas + Schelde.", nogSimpeler: "RMS" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Zuiderzee. A.", simpeler: "Vroeger Zuiderzee, sinds 1932 (Afsluitdijk) IJsselmeer.", nogSimpeler: "Zuiderzee" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Bescherming overstroming. A.", simpeler: "Deltawerken = beschermen Zeeland tegen overstromingen, na 1953-ramp.", nogSimpeler: "Bescherming" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Texel (westelijkst). A.", simpeler: "Wadden­eilanden west→oost: T-V-T-A-S = Texel-Vlieland-Terschelling-Ameland-Schiermonnikoog. Texel = west.", nogSimpeler: "Texel" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~26%. A.", simpeler: "~26% (een kwart) van NL ligt onder zeeniveau, beschermd door dijken.", nogSimpeler: "26%" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vaalserberg 323m. A.", simpeler: "Hoogste NL = Vaalserberg (323 m, Limburg).", nogSimpeler: "Vaalserberg" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rotterdam. A.", simpeler: "Top-5: Amsterdam-Rotterdam-Den Haag-Utrecht-Eindhoven. R = 2e.", nogSimpeler: "Rotterdam" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Randstad. A.", simpeler: "Vier grote steden samen = Randstad. Dichtstbevolkt gebied NL.", nogSimpeler: "Randstad" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Duitsland + België. A.", simpeler: "NL grenst aan Duitsland (oost) en België (zuid).", nogSimpeler: "DE+BE" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kinderdijk. A.", simpeler: "19 oude molens UNESCO = Kinderdijk, Zuid-Holland.", nogSimpeler: "Kinderdijk" },
        },
      },
      {
        q: "Wat is **Schiphol**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vliegveld. A.", simpeler: "Schiphol = grootste luchthaven NL, in Noord-Holland.", nogSimpeler: "Vliegveld" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Giethoorn. A.", simpeler: "'Venetië van NL' = Giethoorn (Overijssel, dorp met grachten).", nogSimpeler: "Giethoorn" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Zwolle. A.", simpeler: "Overijssel → Zwolle.", nogSimpeler: "Zwolle" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rijn, Maas, Schelde. A.", simpeler: "Drie NL-rivieren: R(ijn) M(aas) S(chelde).", nogSimpeler: "RMS" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Noord-Holland. A.", simpeler: "Texel = enige Waddeneiland bij Noord-Holland (rest = Friesland).", nogSimpeler: "N-Holland" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Jongste, uit zee. A.", simpeler: "Flevoland = jongste provincie (1986), gewonnen uit Zuiderzee.", nogSimpeler: "Jongste" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~17,9 miljoen. A.", simpeler: "NL inwoners 2026 ≈ 17,9 miljoen (bijna 18 mln).", nogSimpeler: "17,9 mln" },
        },
      },
