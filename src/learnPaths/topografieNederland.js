    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Texel (westelijkst).", simpeler: "Wadden­eilanden west→oost: T-V-T-A-S = Texel-Vlieland-Terschelling-Ameland-Schiermonnikoog. Texel = west.", nogSimpeler: "Texel" },
        },
      },
      {
