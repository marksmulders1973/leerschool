...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wat is de **hoofdstad** van Nederland?", options: ["Amsterdam","Den Haag","Rotterdam","Utrecht"], answer: 0, wrongHints: [null,"Klopt — wettelijk.","Regeringsstad, geen hoofdstad.","Grootste haven.","Niet."] },
      { q: "Welke stad is de **regeringsstad** van NL?", options: ["Den Haag","Amsterdam","Rotterdam","Utrecht"], answer: 0, wrongHints: [null,"Klopt — Tweede Kamer + ministeries.","Hoofdstad.","Niet.","Niet."] },
      { q: "Hoeveel **provincies** heeft NL?", options: ["12","11","13","10"], answer: 0, wrongHints: [null,"Klopt.","Bijna.","Te veel.","Te weinig."] },
      { q: "Welke is een NL-provincie?", options: ["Friesland","Beieren","Vlaanderen","Bayern"], answer: 0, wrongHints: [null,"Klopt — noorden.","Duits.","Belgisch.","Duits."] },
      { q: "Welke **rivier** stroomt door Rotterdam?", options: ["Nieuwe Maas / Maas","Rijn","IJssel","Amstel"], answer: 0, wrongHints: [null,"Klopt — split van Rijn.","Splitsing nog niet op die punt.","Andere richting.","Door Amsterdam."] },
      { q: "Welke twee **landen** grenzen aan NL?", options: ["Duitsland + België","Frankrijk + DE","VK + BE","Italië + FR"], answer: 0, wrongHints: [null,"Klopt.","Niet — geen FR-grens.","Niet — geen VK-grens.","Niet."] },
      { q: "Welke **provincie** is hoofdstad-provincie (Amsterdam)?", options: ["Noord-Holland","Zuid-Holland","Utrecht","Flevoland"], answer: 0, wrongHints: [null,"Klopt.","Rotterdam/Den Haag daar.","Anders.","Anders."] },
      { q: "**Wadden** liggen?", options: ["Noorden — boven Friesland/Groningen","Zuiden","Westen","Oosten"], answer: 0, wrongHints: [null,"Klopt — Waddenzee.","Niet.","Niet exact.","Niet."] },
      { q: "**IJsselmeer** ontstond door?", options: ["Afsluitdijk (1932)","Mensen-graven","Natuurlijk","Industrie"], answer: 0, wrongHints: [null,"Klopt — was Zuiderzee.","Niet primair.","Wel maar afgesloten 1932.","Niet."] },
      { q: "Welke **provincie** is nieuwste (jongste)?", options: ["Flevoland (1986)","Limburg","Zeeland","Groningen"], answer: 0, wrongHints: [null,"Klopt — drooggemaakt.","Veel ouder.","Veel ouder.","Veel ouder."] },
      { q: "Hoogste **berg** in NL ligt in?", options: ["Limburg (Vaalserberg 322m)","Friesland","Zeeland","Noord-Holland"], answer: 0, wrongHints: [null,"Klopt — drielandenpunt.","Geen bergen.","Niet hoog.","Niet."] },
      { q: "Welke provincie ligt het **meest noordelijk**?", options: ["Groningen","Limburg","Zeeland","Drenthe"], answer: 0, wrongHints: [null,"Klopt — bovenkant kaart.","Zuid.","Zuidwest.","Bijna — Groningen iets noordelijker."] },
    ],
  },
];
