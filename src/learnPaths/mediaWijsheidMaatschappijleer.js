...
const steps = [
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — De Speld is satire.", "Niet.", "Niet.", "Niet."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — geen info-overdracht.", "Wel media.", "Wel media.", "Wel media."],
      },
    ],
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — cross-check.", "Eerst checken.", "Niet zomaar geloven.", "Vaak misleidend."],
      },
      {
        q: "Welke is **betrouwbaar** in NL?",
        options: ["NOS", "Anoniem Twitter-account", "Random TikTok-video", "Reclame-mail"],
        answer: 0,
        wrongHints: [null, "Klopt — publieke omroep.", "Verdacht.", "Verdacht.", "Verdacht."],
      },
      {
        q: "Wat is **clickbait**?",
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — GDPR in Engels.", "Niet.", "Niet.", "Niet."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — voor advertenties.", "Soms gevolg, niet doel.", "Tegenovergesteld.", "Niet hun doel."],
      },
      {
        q: "Wat is **2FA**?",
        options: ["Twee-staps-verificatie", "Tweede factor accent", "2x foto", "Twee accounts"],
        answer: 0,
        wrongHints: [null, "Klopt — wachtwoord + code.", "Niet.", "Niet.", "Niet."],
      },
      {
        q: "Welke deel je **NIET** online?",
        options: ["Wachtwoord + paspoort", "Vakantie-foto van zee", "Verjaardagswens", "Boekrecensie"],
        answer: 0,
        wrongHints: [null, "Klopt — gevaarlijk.", "Lokatie eventueel — anders OK.", "OK.", "OK."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Werkt averechts.", "Praat met iemand.", "Gevaarlijk."],
      },
      {
        q: "**Kindertelefoon**-nummer?",
        options: ["0800-0432", "112", "0900-9292", "Onbekend"],
        answer: 0,
        wrongHints: [null, "Klopt — gratis + anoniem.", "Spoed.", "Niet relevant.", "Wel bekend."],
      },
      {
        q: "Wat is **grooming**?",
        options: ["Volwassene bouwt online vertrouwen met kind voor misbruik", "Haartrim", "Sport", "Game"],
        answer: 0,
        wrongHints: [null, "Klopt — pas op.", "Andere betekenis.", "Niet.", "Niet."],
      },
      {
        q: "Bij **sextortion** — wat doen?",
        options: ["Niet betalen, melden bij politie", "Betalen", "Negeren", "Foto sturen"],
        answer: 0,
        wrongHints: [null, "Klopt — vraagt steeds meer.", "Niet doen.", "Wel actie.", "Maakt erger."],
      },
    ],
  },
  {
    ...
    checks: [
      { q: "**Mediawijsheid** is?", options: ["Kritisch met media omgaan", "Tegen media", "Geen media", "Veel media"], answer: 0, wrongHints: [null, "Klopt.", "Te negatief.", "Niet doel.", "Niet doel."] },
      { q: "**Desinformatie** = ?", options: ["Opzettelijk onjuist", "Per ongeluk", "Mening", "Reclame"], answer: 0, wrongHints: [null, "Klopt.", "Misinformatie.", "Niet specifiek.", "Aparte categorie."] },
      { q: "Wat doen **algoritmes**?", options: ["Kiezen wat jij ziet", "Verbergen reclame", "Beveiligen", "Doen niets"], answer: 0, wrongHints: [null, "Klopt.", "Niet doel.", "Niet primair.", "Doen veel."] },
      { q: "**AVG** = ?", options: ["EU-privacy-wet", "Auto-club", "App", "Belasting"], answer: 0, wrongHints: [null, "Klopt.", "Niet.", "Niet.", "Niet."] },
      { q: "**2FA** = ?", options: ["Twee-staps-verificatie", "Twee accounts", "2x foto", "Andere"], answer: 0, wrongHints: [null, "Klopt — extra veilig.", "Niet.", "Niet.", "Wel iets."] },
      { q: "Wat NOOIT delen online?", options: ["Wachtwoord", "Boekrecensie", "Vakantie-foto", "Vriendelijk bericht"], answer: 0, wrongHints: [null, "Klopt.", "OK.", "OK (eventueel zonder locatie).", "OK."] },
    ],
  },
];
