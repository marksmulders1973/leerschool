    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Zn: de/het ervoor mogelijk.",
          voorbeelden: [{ type: "voorbeeld", tekst: "fiets, tafel, jongen, Amsterdam" }],
          basiskennis: [{ onderwerp: "test", uitleg: "de/het + meervoud mogelijk?" }],
          niveaus: { basis: "fiets.", simpeler: "Ding = zn.", nogSimpeler: "fiets." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Zwemt = doen = ww", tekst: "Zwemt zegt wat iemand doet → werkwoord." }],
          woorden: [{ woord: "werkwoord", uitleg: "wat iemand doet/is/wordt" }],
          theorie: "Test: vervoegbaar? eindigt op -en in infinitief?",
          voorbeelden: [{ type: "voorbeeld", tekst: "zwemmen, lopen, eten, zijn" }],
          basiskennis: [{ onderwerp: "vervoeging", uitleg: "ik zwem, jij zwemt, wij zwemmen" }],
          niveaus: { basis: "zwemt.", simpeler: "Actie = ww.", nogSimpeler: "zwemt." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Plaatsen zijn ook zn (de bibliotheek, het station).",
          voorbeelden: [{ type: "voorbeeld", tekst: "school, park, bibliotheek, Amsterdam" }],
          basiskennis: [{ onderwerp: "de/het", uitleg: "lidwoord ervoor mogelijk" }],
          niveaus: { basis: "bibliotheek.", simpeler: "Plaats = zn.", nogSimpeler: "bibliotheek." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Beschrijvend (mooi/groot/snel) = bn, geen zn.",
          voorbeelden: [{ type: "voorbeeld", tekst: "mooi, leuk, klein = bn" }],
          basiskennis: [{ onderwerp: "test", uitleg: "geen 'de mooi' mogelijk → niet zn" }],
          niveaus: { basis: "mooi = bn.", simpeler: "Beschrijft = bn.", nogSimpeler: "mooi." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Bn staat voor zn, krijgt vaak -e.",
          voorbeelden: [{ type: "voorbeeld", tekst: "de snelle auto, een mooi huis" }],
          basiskennis: [{ onderwerp: "test", uitleg: "hoe is de ___? → bn-antwoord" }],
          niveaus: { basis: "snelle.", simpeler: "Beschrijft auto.", nogSimpeler: "snelle." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "De/het + bn: +e. Een + de-woord: +e. Een + het-woord: GEEN -e.",
          voorbeelden: [{ type: "voorbeeld", tekst: "het kleine kind, een klein kind" }],
          basiskennis: [{ onderwerp: "test", uitleg: "kind = het-woord (het kind)" }],
          niveaus: { basis: "klein.", simpeler: "Geen -e bij 'een + het-woord'.", nogSimpeler: "klein." },
        },
      },
    ],
  },
...
<text x="150" y="155" text-anchor="middle" fill="${COLORS.warm}" font-size="11" font-family="Arial" font-weight="bold">verkleinwoord = altijd 'het'</text>
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "3 lidwoorden", tekst: "Nederlands heeft maar 3 lidwoorden: de, het, een." }],
          woorden: [{ woord: "lidwoord", uitleg: "klein woord voor zn" }],
          theorie: "Bepaald: de/het. Onbepaald: een.",
          voorbeelden: [{ type: "voorbeeld", tekst: "de tafel, het boek, een huis" }],
          basiskennis: [{ onderwerp: "verschil vnw", uitleg: "die/dat = aanwijzend vnw, geen lw" }],
          niveaus: { basis: "de, het, een.", simpeler: "3 lidwoorden.", nogSimpeler: "de/het/een." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Drinkt = doen", tekst: "Drinkt is wat de kat doet → werkwoord." }],
          woorden: [{ woord: "werkwoord", uitleg: "actie of toestand" }],
          theorie: "Vervoegbaar → ww.",
          voorbeelden: [{ type: "voorbeeld", tekst: "drinkt, eet, slaapt = ww" }],
          basiskennis: [{ onderwerp: "test", uitleg: "ik drink / hij drinkt = vervoegd" }],
          niveaus: { basis: "drinkt.", simpeler: "Actie = ww.", nogSimpeler: "drinkt." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Vervangt iemand. Onderwerp (ik/hij) of voorwerp (mij/hem).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Hij = onderwerp. Mij = voorwerp." }],
          basiskennis: [{ onderwerp: "twee in 1 zin", uitleg: "kan onderwerp + voorwerp samen" }],
          niveaus: { basis: "Hij én mij.", simpeler: "Vervangt persoon.", nogSimpeler: "Pers. vnw." },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Bez. vnw staat voor zn en zegt 'van wie?'.",
          voorbeelden: [{ type: "voorbeeld", tekst: "mijn boek, jouw fiets, zijn jas" }],
          basiskennis: [{ onderwerp: "vs ik/mij", uitleg: "ik = onderwerp, mijn = bezit" }],
          niveaus: { basis: "mijn.", simpeler: "Van wie? mijn.", nogSimpeler: "mijn." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Op = voorzetsel", tekst: "Op vertelt waar het boek ligt → voorzetsel." }],
          woorden: [{ woord: "voorzetsel", uitleg: "in, op, onder, naast, voor, achter" }],
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Zonder = vz", tekst: "Zonder vertelt relatie → voorzetsel." }],
          woorden: [{ woord: "zonder", uitleg: "ontbreken-relatie (zonder X)" }],
          theorie: "Vz kan ook abstracte relatie aangeven.",
          voorbeelden: [{ type: "voorbeeld", tekst: "zonder jas, zonder geld, met mij, voor jou" }],
          basiskennis: [{ onderwerp: "vs zo", uitleg: "zo = bijwoord, zonder = vz" }],
          niveaus: { basis: "zonder.", simpeler: "Vz: zonder, met, voor.", nogSimpeler: "zonder." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "geen verbuiging", uitleg: "bw blijft altijd hetzelfde" }],
          niveaus: { basis: "vandaag.", simpeler: "Wanneer? vandaag.", nogSimpeler: "vandaag." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Hen = pers. vnw lijdend of na voorzetsel.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Ik zie hen / met hen praten" }],
          basiskennis: [{ onderwerp: "vs hun", uitleg: "hun = meewerkend, hen = lijdend" }],
          niveaus: { basis: "persoonlijk vnw.", simpeler: "Hen = pers. vnw.", nogSimpeler: "pers. vnw." },
        },
      },
      {
