...
<text x="160" y="48" text-anchor="middle" fill="#ffd54f" font-size="10" font-family="Arial">index: 100 → 150</text>
    ...
    checks: [
      ...
      { q: "Een trui van €40 met 30% korting kost?", options: ["€28","€12","€30","€10"], answer: 0, wrongHints: [null, "Dat is de korting zelf, niet de prijs.", "Niet — 70% van 40.", "Niet."] },
      { q: "Stijging van 50 naar 75 = welk percentage?", options: ["50%","25%","20%","75%"], answer: 0, wrongHints: [null, "Dat is de stijging absoluut.", "Niet.", "Niet relevant."] },
      { q: "**BTW** in NL standaard?", options: ["21%","9%","19%","25%"], answer: 0, wrongHints: [null, "Dat is laag tarief (eten).", "Geen NL-tarief.", "Geen NL-tarief."] },
