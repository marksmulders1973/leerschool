...
<text x="160" y="48" text-anchor="middle" fill="#ffd54f" font-size="10" font-family="Arial">index: 100 → 150</text>
    ...
    checks: [
      ...
      { q: "Wat is 25% van 80?", options: ["20","25","40","2"], answer: 0, wrongHints: [null,"Klopt — kwart van 80.","Dat is het percentage zelf.","Te veel.","Te weinig."] },
      { q: "Een trui van €40 met 30% korting kost?", options: ["€28","€12","€30","€10"], answer: 0, wrongHints: [null,"Klopt — €40 − €12 = €28.","Dat is de korting zelf, niet de prijs.","Niet — 70% van 40.","Niet."] },
      { q: "Stijging van 50 naar 75 = welk percentage?", options: ["50%","25%","20%","75%"], answer: 0, wrongHints: [null,"Klopt — stijging 25, /50 × 100 = 50%.","Dat is de stijging absoluut.","Niet.","Niet relevant."] },
      { q: "**BTW** in NL standaard?", options: ["21%","9%","19%","25%"], answer: 0, wrongHints: [null,"Klopt — hoog tarief.","Dat is laag tarief (eten).","Geen NL-tarief.","Geen NL-tarief."] },
      { q: "0,75 is welk percentage?", options: ["75%","7,5%","0,75%","750%"], answer: 0, wrongHints: [null,"Klopt — × 100.","Te laag.","Te laag.","Te hoog."] },
      { q: "Welk percentage is **½**?", options: ["50%","25%","20%","100%"], answer: 0, wrongHints: [null,"Klopt — helft.","Dat is ¼.","Dat is ⅕.","Dat is hele."] },
      { q: "Inflatie 5% per jaar. €100 wordt na 1 jaar?", options: ["€105","€95","€150","€100"], answer: 0, wrongHints: [null,"Klopt — 5% erbij.","Niet — inflatie = stijging.","Te veel — alleen 5%.","Niet — er is iets veranderd."] },
      { q: "20% van een getal is 60. Wat is het hele getal?", options: ["300","12","80","30"], answer: 0, wrongHints: [null,"Klopt — 60 ÷ 0,20 = 300.","Niet — vermenigvuldigen ipv delen.","Niet.","Niet."] },
      { q: "Auto kost €20.000 + 10% btw. Totaal?", options: ["€22.000","€20.100","€20.000","€18.000"], answer: 0, wrongHints: [null,"Klopt — 10% van 20.000 = 2.000.","Niet — 10% niet 0,1%.","Niet — btw moet erbij.","Niet — btw komt erbij, niet eraf."] },
    ],
  },
];
