    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Je hebt × 3 gedaan. Maar 30% = 0,30, dus 80 × 0,30 = 24.",
          "300 = 30 × 10. Maar 30% van 80 is veel kleiner: 80 × 0,30 = 24.",
          "Komma één plek te ver. 80 × 0,3 = 24, niet 2,4.",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "15% van 80 zou 12 zijn. Maar dit is 60 — reken: 10% van 60 = 6, plus 5% = 3, totaal 9.",
          "10 = 16,67% van 60 — net iets te hoog. Reken: 6 + 3 = 9.",
          "Je hebt het percentage zelf overgenomen. Voor 15% van 60: 6 + 3 = 9.",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Je hebt 22 + 700 of zoiets. Reken: 22% × 350 = 0,22 × 350 = 77.",
          "Komma één plek te ver. 0,22 × 350 = 77, niet 7,7.",
          "Klopt niet. Reken: 22% = 0,22, dus 0,22 × 350 = 77.",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "12 is niet automatisch 12%. Reken: 12 / 50 × 100 = 24%.",
          "50% is de helft. 12 is geen helft van 50 — bereken (12/50) × 100.",
          "Je hebt 12 + 50 gedaan. Maar de formule is **delen** dan × 100.",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "20% = 1 / 5 × 100. Maar 1 / **4** × 100 = 25. Vergelijk altijd met de **oorspronkelijke** prijs (€4).",
          "1 is de stijging in euro, niet het percentage. Reken: 1 / 4 × 100 = 25%.",
          "100% zou betekenen verdubbeling — van €4 naar €8. Maar dit ging maar van €4 naar €5.",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "€20 zou kloppen als de korting 60% was. Bij 30% korting betaal je 70% = 0,70 × 50 = €35.",
          "€15 is de **korting** zelf (30% van 50). Maar de vraag is wat je **betaalt** — dat is €50 − €15 = €35.",
          "€65 = €50 + 30%. Maar het is korting (verlaging), dus je betaalt minder, niet meer.",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "€60 is 25% korting. Hier is + 25% btw = 1,25 × 80 = €100.",
          "€20 is alleen de btw zelf. Het totaal is product + btw = 80 + 20 = €100.",
          "€105 = €80 + 30%. Maar het is + 25%: 1,25 × 80 = €100.",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "50% korting zou €100 zijn (helft). Hier is de korting €50 — dat is 50/200 × 100 = 25%.",
          "33% klopt niet. Korting €50 ÷ origineel €200 × 100 = 25%.",
          "75% korting zou €150 korting zijn (€50 over). Maar €50 is de korting, niet €150.",
        ],
      },
      {
        q: "Wat is 35% van 80?",
        ...
        wrongHints: [
          null,
          "35 is het percentage zelf, niet de uitkomst. Reken: 0,35 × 80 = 28.",
          "115 = 80 + 35. Maar 'van' betekent vermenigvuldigen, niet optellen.",
          "Komma één plek te ver. 0,35 × 80 = 28, niet 2,28.",
        ],
      },
    ],
  },
