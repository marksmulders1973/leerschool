...
<text x="150" y="155" text-anchor="middle" fill="${COLORS.good}" font-size="12" font-family="Arial" font-weight="bold">je kunt het — succes!</text>
    ...
    checks: [
      ...
      { q: "Welk seizoen begint **rond 21 maart**?", options: ["Lente","Zomer","Herfst","Winter"], answer: 0, wrongHints: [null,"Klopt — equinox.","21 juni.","21 sept.","21 dec."] },
      { q: "Welk seizoen heeft **bladval**?", options: ["Herfst","Lente","Zomer","Winter"], answer: 0, wrongHints: [null,"Klopt.","Bloesem.","Volle bladeren.","Geen bladeren meer."] },
      { q: "Wat doet een **trekvogel** in de winter?", options: ["Vliegt naar warmer land","Slaapt","Verandert kleur","Niets"], answer: 0, wrongHints: [null,"Klopt — bv. ooievaar.","Niet vogel.","Niet trekvogel.","Wel migratie."] },
      { q: "Wat is **winterslaap**?", options: ["Langdurige rust met lage activiteit","Korte slaap","Wakker blijven","Vlucht"], answer: 0, wrongHints: [null,"Klopt — bv. egel, beer.","Niet — lang.","Tegengestelde.","Trekvogels."] },
      { q: "Welk dier houdt **winterslaap** in NL?", options: ["Egel","Vos","Konijn","Eekhoorn"], answer: 0, wrongHints: [null,"Klopt — november-april.","Blijft actief.","Blijft actief.","Half — torpor."] },
      { q: "Welk seizoen is meestal **droogst**?", options: ["Zomer","Winter","Lente","Herfst"], answer: 0, wrongHints: [null,"Klopt — minste regen.","Vaak nat.","Variabel.","Vaak nat."] },
      { q: "Wat doet een **kikkervisje** in de lente?", options: ["Groeit uit tot kikker","Slaapt","Verstopt","Vliegt"], answer: 0, wrongHints: [null,"Klopt — metamorfose.","Niet.","Niet.","Niet."] },
      { q: "Welke vogel **trekt** in de herfst weg uit NL?", options: ["Ooievaar","Mus","Merel","Spreeuw"], answer: 0, wrongHints: [null,"Klopt — naar Afrika.","Standvogel.","Standvogel.","Standvogel."] },
      { q: "Een **knop** aan een tak verschijnt in welk seizoen?", options: ["Lente","Zomer","Herfst","Winter"], answer: 0, wrongHints: [null,"Klopt — voorjaar.","Volgroeide bladeren.","Bladeren weg.","Geen bladeren."] },
      { q: "Welk seizoen heeft **kortste dagen** in NL?", options: ["Winter","Zomer","Lente","Herfst"], answer: 0, wrongHints: [null,"Klopt — rond 21 dec.","Langste dagen.","Half.","Korter dan zomer."] },
      { q: "Wat is een **standvogel**?", options: ["Vogel die hele jaar in NL blijft","Trekvogel","Insecten-eter","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — bv. mus, merel.","Tegengestelde.","Wel onderdeel.","Wel."] },
      { q: "Wat doet een **rups** uiteindelijk?", options: ["Wordt vlinder","Sterft direct","Wordt bij","Niets"], answer: 0, wrongHints: [null,"Klopt — metamorfose.","Niet.","Niet.","Wel iets."] },
    ],
  },
];
