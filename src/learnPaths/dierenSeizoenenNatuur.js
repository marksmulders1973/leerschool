    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Steen. A.", simpeler: "Steen leeft niet (geen ademen/groeien). Mier/boom/paddenstoel zijn wel levend.", nogSimpeler: "Steen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ademen. A.", simpeler: "ALLE levende wezens ademen (zuurstof). Praten/lopen/zingen niet voor planten/vissen.", nogSimpeler: "Ademen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "walvis. A.", simpeler: "Walvis lijkt vis maar zoogt + ademt met longen → zoogdier. Haai=vis, krokodil=reptiel, kikker=amfibie.", nogSimpeler: "Walvis" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Melk geven. A.", simpeler: "Zoogdieren = enige groep die melk geeft aan baby. Daarom ZOOG-dier.", nogSimpeler: "Melk" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Veren. A.", simpeler: "Alleen vogels hebben veren (uniek!). Vleugels/eieren/snavel komen ook bij andere dieren voor.", nogSimpeler: "Veren" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "pinguïn. A.", simpeler: "Pinguïn is vogel maar kan niet vliegen — gebruikt vleugels om te zwemmen.", nogSimpeler: "Pinguïn" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6. A.", simpeler: "Insecten hebben ALTIJD 6 poten (mier, vlinder, bij). Spin=8 (geen insect).", nogSimpeler: "6" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "amfibieën. A.", simpeler: "Kikker leeft in water (jong) + op land (volwassen). Glibberige huid = amfibie.", nogSimpeler: "Amfibie" },
        },
      },
      {
        q: "Wat is een **spin**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Geen insect (8 poten). A.", simpeler: "Spin heeft 8 poten = NIET insect (=6 poten). Spin = aparte groep (spinachtigen).", nogSimpeler: "8 poten" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Weekdier. A.", simpeler: "Slak = zacht lichaam + schelp = weekdier. (Krab=pantser=schaaldier.)", nogSimpeler: "Weekdier" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Schaaldier. A.", simpeler: "Krab heeft pantser + veel poten = schaaldier. (Slak=schelp=weekdier.)", nogSimpeler: "Schaaldier" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "pop. A.", simpeler: "Volgorde: ei → rups → POP → vlinder. Pop is tussenfase in cocon.", nogSimpeler: "Pop" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Van vorm veranderen. A.", simpeler: "Gedaanteverwisseling = dier verandert tijdens leven van vorm (rups→vlinder, kikkervisje→kikker).", nogSimpeler: "Vorm" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Jonge dieren. A.", simpeler: "Lente = jonge dieren geboren (lammetjes, kuikens) + bloemen bloeien.", nogSimpeler: "Jong" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Onze kant naar zon. A.", simpeler: "Zomer = onze kant van aarde naar zon gedraaid → meer zonkracht → warmer.", nogSimpeler: "Naar zon" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "egel. A.", simpeler: "Egel = klassiek winterslaap-dier. Slaapt hele winter in nest.", nogSimpeler: "Egel" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Energie sparen. A.", simpeler: "Winter = weinig licht. Bladeren werken niet → kosten energie. Boom werpt ze af om te overleven.", nogSimpeler: "Sparen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Suiker uit zonlicht. A.", simpeler: "Foto (licht) + synthese (maken) = plant maakt suiker uit zonlicht. Geeft zuurstof af.", nogSimpeler: "Suiker" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "bloem. A.", simpeler: "Bloem maakt zaden voor nieuwe planten = voortplantingsorgaan.", nogSimpeler: "Bloem" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "spar. A.", simpeler: "Spar heeft naalden + blijft 's winters groen = naaldboom. (Eik/beuk/esdoorn = loofboom).", nogSimpeler: "Spar" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "herbivoor. A.", simpeler: "Planteneter = herbivoor. Carnivoor=vlees, omnivoor=alles.", nogSimpeler: "Herbivoor" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "vos. A.", simpeler: "Vos eet konijn, niemand eet vos → vos bovenaan keten.", nogSimpeler: "Vos" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Eet dode resten. A.", simpeler: "Afbreker (regenworm/schimmel) eet dood materiaal en maakt er grond van. Natuur recyclet.", nogSimpeler: "Recyclen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "zoogdier. A.", simpeler: "Vleermuis vliegt maar heeft vacht + zoogt → zoogdier (enige vliegende).", nogSimpeler: "Zoogdier" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Bestuiven. A.", simpeler: "Bijen brengen stuifmeel van bloem naar bloem → bevruchting → vrucht/zaad → nieuwe planten.", nogSimpeler: "Bestuiven" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "kikkervisje. A.", simpeler: "Kikker-baby = kikkervisje (met staart, in water). Verandert later in kikker.", nogSimpeler: "Kikkervisje" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "lente. A.", simpeler: "Lente = bomen krijgen nieuwe blaadjes uit knoppen (na kale winter).", nogSimpeler: "Lente" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Fotosynthese. A.", simpeler: "Plant gebruikt zonlicht om voedsel (suiker) te maken = fotosynthese.", nogSimpeler: "Voedsel" },
        },
      },
