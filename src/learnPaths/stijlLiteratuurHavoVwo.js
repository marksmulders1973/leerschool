    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oxymoron.", simpeler: "Tegenovergestelde woorden samen.", nogSimpeler: "Oxymoron" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Metonymia.", simpeler: "Verwant ding gebruikt.", nogSimpeler: "Metonymia" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ironie.", simpeler: "Bedoeld tegengesteld.", nogSimpeler: "Ironie" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Middeleeuwen.", simpeler: "13e eeuw = ME.", nogSimpeler: "ME" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Multatuli.", simpeler: "Douwes Dekker = Multatuli.", nogSimpeler: "Multatuli" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kunst om kunst.", simpeler: "Vorm = inhoud.", nogSimpeler: "Esthetiek" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hermans, Reve, Mulisch.", simpeler: "HRM = Grote Drie.", nogSimpeler: "HRM" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vondel.", simpeler: "Vondel-treurspel.", nogSimpeler: "Vondel" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "14.", simpeler: "Sonnet = 14 regels.", nogSimpeler: "14" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3e persoon, één hoofd.", simpeler: "Hij/zij + één gezichtspunt.", nogSimpeler: "Personaal" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tragedie.", simpeler: "Tragedie = toneel.", nogSimpeler: "Tragedie" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kort-Lang.", simpeler: "ta-DAH.", nogSimpeler: "Jambe" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Universele gedachte.", simpeler: "Hoofdidee.", nogSimpeler: "Hoofdidee" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tijd in verhaal.", simpeler: "Hoeveel tijd er gebeurt.", nogSimpeler: "In-verhaal" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Complex + ontwikkelend.", simpeler: "Meerlagig + verandert.", nogSimpeler: "Complex" },
        },
      },
      {
        q: "**Raamvertelling** is:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verhaal-in-verhaal.", simpeler: "Verteller vertelt verhaal in verhaal.", nogSimpeler: "Raam" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Booker International.", simpeler: "Booker 2020.", nogSimpeler: "Booker" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Reve, niet Mulisch.", simpeler: "De avonden = Reve.", nogSimpeler: "Reve" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Eén hoofd.", simpeler: "Beperkt tot één personage.", nogSimpeler: "Eén" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Niet opgelost.", simpeler: "Lezer mag invullen.", nogSimpeler: "Open" },
        },
      },
    ],
  },
