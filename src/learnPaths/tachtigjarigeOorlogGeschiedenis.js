    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Filips II. A.", simpeler: "Spaanse koning bij begin oorlog 1568 = Filips II.", nogSimpeler: "Filips II" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Calvinisme. A.", simpeler: "Vervolgd: calvinisten (protestanten).", nogSimpeler: "Calvinisme" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Calvinisten vernielden beelden. A.", simpeler: "Beeldenstorm 1566 = calvinisten vernielden heiligenbeelden in kerken.", nogSimpeler: "Vernieling" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Bedelaars (spotnaam). A.", simpeler: "Geuzen = oorspronkelijk 'bedelaars' (spotnaam Spaanse adviseur). Werd eretitel.", nogSimpeler: "Bedelaars" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Alva's strafrechtbank. A.", simpeler: "Bloedraad = Alva's rechtbank die opstandelingen ter dood veroordeelde.", nogSimpeler: "Rechtbank Alva" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1568. A.", simpeler: "Tachtigjarige Oorlog begon 1568 (Slag bij Heiligerlee), eindigde 1648.", nogSimpeler: "1568" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Den Briel. A.", simpeler: "1 april 1572 = Den Briel veroverd door Watergeuzen. Keerpunt.", nogSimpeler: "Den Briel" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Willem van Oranje. A.", simpeler: "1572 stadhouder Holland = Willem van Oranje (gekozen in Dordrecht).", nogSimpeler: "Willem" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Dijken door, water + schepen. A.", simpeler: "Leiden ontzet 1574 = dijken doorsteken, water hoog, geuzen kwamen per schip.", nogSimpeler: "Dijken door" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Haring + wittebrood. A.", simpeler: "3 oktober Leiden: haring + wittebrood (zoals geuzen bracht 1574).", nogSimpeler: "Haring" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7 provincies tegen Spanje. A.", simpeler: "Unie van Utrecht 1579 = 7 noordelijke protestantse provincies samen tegen Spanje.", nogSimpeler: "7 provincies" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Onafhankelijkheidsverklaring. A.", simpeler: "Plakkaat van Verlatinghe 1581 = NL-onafhankelijkheidsverklaring tegen Filips II.", nogSimpeler: "Onafhank.verklaring" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Willem van Oranje. A.", simpeler: "1584 Delft = Willem van Oranje vermoord door Gerards.", nogSimpeler: "Willem" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7. A.", simpeler: "Republiek = 7 Verenigde Nederlanden (sinds 1579).", nogSimpeler: "7" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Staten-Generaal + stadhouder. A.", simpeler: "Republiek geregeerd door Staten-Generaal + stadhouder, geen koning.", nogSimpeler: "Geen koning" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Volk mag tiran afzweren. A.", simpeler: "Plakkaat-principe: bij tirannie mag volk koning afzweren.", nogSimpeler: "Volk > tiran" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "VS-onafh.verklaring 1776. A.", simpeler: "Plakkaat 1581 inspireerde Amerikaanse Onafhankelijkheidsverklaring 1776.", nogSimpeler: "VS 1776" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wapenstilstand Republiek-Spanje. A.", simpeler: "Twaalfjarig Bestand 1609-1621 = 12 jaar pauze in oorlog tussen Republiek + Spanje.", nogSimpeler: "12j pauze" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Frederik Hendrik. A.", simpeler: "Stedendwinger = Frederik Hendrik (stadhouder 1625-47).", nogSimpeler: "Fred. Hendrik" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1648. A.", simpeler: "Einde Tachtigjarige Oorlog = 1648 Vrede van Münster.", nogSimpeler: "1648" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Schelde gesloten. A.", simpeler: "Vrede van Münster sloot Schelde → Antwerpen verarmt, Amsterdam wint.", nogSimpeler: "Schelde dicht" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ter Borch. A.", simpeler: "Eed Vrede van Münster geschilderd door Gerard ter Borch (1648).", nogSimpeler: "Ter Borch" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1568. A.", simpeler: "Tachtigjarige Oorlog begon 1568.", nogSimpeler: "1568" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Leiden ontzet. A.", simpeler: "3 oktober 1574 = Leiden ontzet door Watergeuzen.", nogSimpeler: "Leiden" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Filips II (wel afgezworen). A.", simpeler: "Strikvraag: Filips II IS afgezworen. Anderen geen koning.", nogSimpeler: "Filips II" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vrede van Westfalen. A.", simpeler: "Vrede van Münster 1648 was onderdeel Vrede van Westfalen.", nogSimpeler: "Westfalen" },
        },
      },
    ],
  },
