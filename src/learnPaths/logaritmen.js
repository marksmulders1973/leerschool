    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Tot welke macht?", tekst: "2⁴ = 16, dus log₂(16) = 4." }],
          woorden: [{ woord: "log_a(b)", uitleg: "tot welke macht moet a om b te worden" }],
          theorie: "log_a(b) = c ↔ a^c = b.",
          voorbeelden: [{ type: "voorbeeld", tekst: "2² = 4, 2³ = 8, 2⁴ = 16" }],
          basiskennis: [{ onderwerp: "machten van 2", uitleg: "2, 4, 8, 16, 32, 64..." }],
          niveaus: { basis: "2⁴ = 16 → log₂(16) = 4.", simpeler: "4 keer 2 vermenigvuldigen = 16.", nogSimpeler: "2·2·2·2 = 16." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Macht-relatie", tekst: "log₅(125) = 3 → 5³ = 125. Grondtal^log = argument." }],
          woorden: [{ woord: "grondtal", uitleg: "het kleine getal bij log" }],
          theorie: "log_a(b) = c ↔ a^c = b. Drie posities: a = grondtal, b = argument, c = log.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log₂(8) = 3 ↔ 2³ = 8" }],
          basiskennis: [{ onderwerp: "omkering", uitleg: "log keert macht om" }],
          niveaus: { basis: "5³ = 125.", simpeler: "Grondtal^antwoord = argument.", nogSimpeler: "5 tot de macht 3." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "log(10) = 1", tekst: "10¹ = 10, dus log(10) = 1." }],
          woorden: [{ woord: "log", uitleg: "= log₁₀ (basis 10)" }],
          theorie: "log_a(a) = 1 voor elk grondtal.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(10)=1, log(100)=2, log(1000)=3" }],
          basiskennis: [{ onderwerp: "machten van 10", uitleg: "10, 100, 1000..." }],
          niveaus: { basis: "log(10) = 1 want 10¹ = 10.", simpeler: "Grondtal zelf → log = 1.", nogSimpeler: "Antwoord is 1." },
        },
      },
      {
        q: "*Wat is ln(1)?*",
        ...
        uitlegPad: {
          stappen: [{ titel: "ln(1) = 0", tekst: "e⁰ = 1 (alles tot de 0 is 1)." }],
          woorden: [{ woord: "ln", uitleg: "natuurlijke log, basis e ≈ 2,718" }],
          theorie: "log_a(1) = 0 voor elk grondtal (a⁰ = 1).",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(1) = 0, ln(1) = 0, log₂(1) = 0" }],
          basiskennis: [{ onderwerp: "a^0 = 1", uitleg: "elk getal tot de 0 is 1" }],
          niveaus: { basis: "ln(1) = 0.", simpeler: "Argument 1 → log = 0 altijd.", nogSimpeler: "Log van 1 is altijd 0." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "machten van 3", uitleg: "3, 9, 27, 81" }],
          theorie: "Schrijf 9 als macht van 3 → exponent = log.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log₃(27) = 3, log₃(81) = 4" }],
          basiskennis: [{ onderwerp: "uit hoofd", uitleg: "3² = 9 onthouden" }],
          niveaus: { basis: "9 = 3² → log₃(9) = 2.", simpeler: "3 keer 3 = 9, dus 2.", nogSimpeler: "2 keer 3." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "speciaal", uitleg: "log_a(1) = 0 voor elke a" }],
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "eet exponent", uitleg: "log haalt exponent eruit" }],
          theorie: "log_a(a^n) = n. Argument = macht van grondtal → log = exponent.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(10⁵) = 5, ln(e³) = 3" }],
          basiskennis: [{ onderwerp: "speciale regel", uitleg: "3e regel" }],
          niveaus: { basis: "log₂(2⁹) = 9.", simpeler: "Exponent valt eruit.", nogSimpeler: "Antwoord is 9." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Som van logs = log van product", tekst: "log(3) + log(7) = log(3·7) = log(21)." }],
          woorden: [{ woord: "regel 1", uitleg: "log(ab) = log(a) + log(b)" }],
          theorie: "Eerste log-eigenschap: + buiten ↔ · binnen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(2)+log(5) = log(10) = 1" }],
          basiskennis: [{ onderwerp: "let op", uitleg: "log(a+b) ≠ log(a)+log(b)" }],
          niveaus: { basis: "log(3) + log(7) = log(21).", simpeler: "+ wordt · binnen.", nogSimpeler: "3 keer 7 = 21." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "regel 2", uitleg: "log(a/b) = log(a) − log(b)" }],
          theorie: "Tweede log-eigenschap: − buiten ↔ / binnen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(100/10) = log(100)−log(10) = 1" }],
          basiskennis: [{ onderwerp: "let op", uitleg: "log(a−b) ≠ log(a)−log(b)" }],
          niveaus: { basis: "log₂(64/8) = log₂(8) = 3.", simpeler: "− wordt / binnen.", nogSimpeler: "64÷8 = 8 → log₂(8)." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "regel 3", uitleg: "log(a^n) = n · log(a)" }],
          theorie: "Derde log-eigenschap: exponent komt naar buiten als factor.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(36) = log(6²) = 2·log(6)" }],
          basiskennis: [{ onderwerp: "voor oplossen", uitleg: "cruciaal voor 2^x = 50" }],
          niveaus: { basis: "4 · log(2).", simpeler: "Exponent naar voren als factor.", nogSimpeler: "4 keer log(2)." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "vuistregel", uitleg: "snelle schatting verdubbelingstijd" }],
          theorie: "Voor kleine % per jaar: T ≈ 70/r.",
          voorbeelden: [{ type: "voorbeeld", tekst: "5% → 14j, 7% → 10j, 10% → 7j" }],
          basiskennis: [{ onderwerp: "exact", uitleg: "T = log(2)/log(1+r/100)" }],
          niveaus: { basis: "70/7 = 10 jaar.", simpeler: "70 gedeeld door 7 = 10.", nogSimpeler: "≈ 10." },
        },
      },
    ],
  },
...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">3 eigenschappen 🏆</text>
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Verschil = log van deling", tekst: "log(50) − log(5) = log(50/5) = log(10) = 1." }],
          woorden: [{ woord: "regel 2", uitleg: "log(a/b) = log(a) − log(b)" }],
          theorie: "Aftrekken van logs ↔ delen in argument.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(100/10) = 1" }],
          basiskennis: [{ onderwerp: "deling", uitleg: "50/5 = 10" }],
          niveaus: { basis: "log(50/5) = log(10) = 1.", simpeler: "50 gedeeld door 5 = 10.", nogSimpeler: "Antwoord 1." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "uit hoofd", uitleg: "machten van 2: 2,4,8,16,32" }],
          theorie: "Argument als macht van grondtal → exponent = x.",
          voorbeelden: [{ type: "voorbeeld", tekst: "2¹=2, 2²=4, 2³=8, 2⁴=16, 2⁵=32" }],
          basiskennis: [{ onderwerp: "exact", uitleg: "geen log nodig — herken macht" }],
          niveaus: { basis: "32 = 2⁵, dus x = 5.", simpeler: "Vijf keer 2 = 32.", nogSimpeler: "Antwoord 5." },
        },
      },
      {
        q: "*Versimpel: log(x³).*",
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "regel 3", uitleg: "log(a^n) = n · log(a)" }],
          theorie: "Macht in argument → factor buiten log.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(2⁴) = 4·log(2)" }],
          basiskennis: [{ onderwerp: "let op", uitleg: "log(x)³ = (log x)³ — héél anders" }],
          niveaus: { basis: "3 · log(x).", simpeler: "Exponent 3 naar voren.", nogSimpeler: "3 keer log(x)." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "combineren", uitleg: "eerst regel 3, dan regel 1" }],
          theorie: "n·log(a) → log(a^n). Dan optellen → product.",
          voorbeelden: [{ type: "voorbeeld", tekst: "log(9) + log(5) = log(45)" }],
          basiskennis: [{ onderwerp: "3² = 9", uitleg: "voor de macht-stap" }],
          niveaus: { basis: "2·log(3) = log(9). 9·5 = 45.", simpeler: "Eerst 3² = 9. Dan 9·5 = 45.", nogSimpeler: "Twee stappen." },
        },
      },
      {
...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">je beheerst het 🎓</text>
    ...
    checks: [
      ...
      { q: "**Open vraag**: bereken log(100) met basis 10. Typ getal.", kind: "open", acceptedAnswers: ["2"], numericTolerance: 0, explanation: "10² = 100 → log(100) = 2." },
      { q: "**Open vraag**: los op: 2^x = 8. Typ x.", kind: "open", acceptedAnswers: ["3"], numericTolerance: 0, explanation: "2³ = 8 → x = 3." },
    ],
  },
];
...
const logaritmen = {
  ...
  prerequisites: [
    ...
    { id: "exponentieel", title: "Exponentiële groei", niveau: "vmbo-3F" },
  ],
  intro:
