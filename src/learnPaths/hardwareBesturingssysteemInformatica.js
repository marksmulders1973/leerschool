    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "De CPU. A.", simpeler: "Brein = CPU = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Snel + tijdelijk. A.", simpeler: "RAM = tijdelijk geheugen = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "SSD sneller, geen bewegende delen. A.", simpeler: "SSD = sneller = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Fetch-decode-execute. A.", simpeler: "Ophalen-ontcijferen-uitvoeren = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Niet-opgeslagen werk in RAM. A.", simpeler: "RAM weg = niet-opgeslagen werk = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Dichterbij = sneller, kleiner. A.", simpeler: "Bij CPU = sneller+kleiner = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hardware + programma's beheren. A.", simpeler: "OS = beheert alles = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Multitasking. A.", simpeler: "Tegelijk = multitasking = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Linux. A.", simpeler: "Open source = Linux = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Het type. A.", simpeler: "Extensie = bestandstype = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Overal + back-up. A.", simpeler: "Cloud = overal bereikbaar = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Een pad. A.", simpeler: "Locatie = pad = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
