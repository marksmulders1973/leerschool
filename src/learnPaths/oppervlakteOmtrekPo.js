...
const steps = [
    ...
    checks: [
      {
        ...
        explanation: "**Omtrek = 2× lengte + 2× breedte** = 2×8 + 2×5 = 16 + 10 = **26 m**. Een tuin heeft 4 zijden — niet 2.",
        uitlegPad: compact(
      ...
      },
      {
        ...
        explanation: "**Vierkante meter (m²)** = oppervlakte. Het kleine ²-tje betekent 'maal zichzelf' = vlak. Eenheden: cm² (klein), m² (kamer/tuin), km² (provincie).",
        uitlegPad: compact(
      ...
      },
      {
        ...
        uitlegPad: compact(
          ...
          [{ woord: "omtrek", uitleg: "De totale rand rondom een figuur." }],
        ),
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: compact(
          ...
          { basis: "40÷2=20. 20−12=8 cm.", simpeler: "Halve omtrek = L+B = 20. B = 20−12 = 8.", nogSimpeler: "8" },
          [{ woord: "terugrekenen omtrek", uitleg: "Deel omtrek door 2, trek lengte eraf → breedte." }],
        ),
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: compact(
          ...
          { basis: "8 cm (√64 = 8).", simpeler: "Welk getal × zichzelf = 64? Probeer 8: 8×8=64.", nogSimpeler: "8" },
          [{ woord: "vierkantswortel", uitleg: "√64 = 8 want 8×8 = 64." }],
        ),
      },
      {
        ...
        uitlegPad: compact(
          "L = Opp ÷ B = 48 ÷ 6 = 8 m.",
          { basis: "48 ÷ 6 = 8 m.", simpeler: "Opp = L×B → L = 48÷6 = 8.", nogSimpeler: "8" },
  ...
  },
  {
    ...
    checks: [
      ...
      {
        q: "Een driehoek heeft basis **6 cm** en hoogte **4 cm**. Wat is de **oppervlakte**?",
        options: ["12 cm²", "24 cm²", "10 cm²", "12 cm"],
        answer: 0,
        wrongHints: [null, "Je vergeet te delen door 2 — een driehoek is de helft van een rechthoek.", "Dat is een optelling, niet de oppervlakte-formule.", "Eenheid is cm²."],
      ...
      {
        q: "Een driehoek heeft basis **14 m** en hoogte **5 m**. Wat is de **oppervlakte**?",
        options: ["35 m²", "70 m²", "19 m²", "35 m"],
        answer: 0,
        wrongHints: [null, "Je vergeet door 2 te delen — driehoek is halve rechthoek.", "Dat is een optelling van basis en hoogte, geen formule voor oppervlakte.", "Eenheid is m²."],
        explanation: "A = ½ × 14 × 5 = 7 × 5 = **35 m²**.",
        uitlegPad: compact(
          "A = (14×5)/2 = 70/2 = 35 m².",
          { basis: "14×5=70, /2 = 35 m².", simpeler: "Helft van 14×5 = halve 70 = 35.", nogSimpeler: "35" },
          [{ woord: "oppervlakte driehoek", uitleg: "½ × basis × hoogte." }],
        ),
      },
    ],
