    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Sancties + schuld.", simpeler: "Streng straf voor DE.", nogSimpeler: "Streng" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Leefruimte oosten.", simpeler: "Ruimte voor DE-volk.", nogSimpeler: "Lebens" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Sudetenland weggeven.", simpeler: "DE krijgt deel Tsjechië.", nogSimpeler: "München" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Polen.", simpeler: "Polen 1939.", nogSimpeler: "Polen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Mei 1940.", simpeler: "10-14 mei 1940.", nogSimpeler: "1940" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Keerpunt + DE verliezen.", simpeler: "DE verliest grote slag.", nogSimpeler: "DE verlies" },
        },
      },
      {
        q: "**D-Day** (6 juni 1944):",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Landing Normandië.", simpeler: "Frankrijk-invasie.", nogSimpeler: "Normandië" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "20 000 doden NL.", simpeler: "Hongersnood West-NL.", nogSimpeler: "Honger" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8 mei 1945.", simpeler: "DE-capitulatie.", nogSimpeler: "8-5-45" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "NL ~75%.", simpeler: "NL hoogste verlies.", nogSimpeler: "NL 75%" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Endlösung-plan.", simpeler: "Uitroeiing alle joden.", nogSimpeler: "Endlösung" },
        },
      },
      {
        q: "**Anne Frank** stierf:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Bergen-Belsen tyfus.", simpeler: "Bergen-Belsen feb '45.", nogSimpeler: "Belsen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Anti-joden-vervolging staking.", simpeler: "Amsterdammers tegen razzia.", nogSimpeler: "Staking" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1100 joden.", simpeler: "Fabriek redde joden.", nogSimpeler: "Schindler" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Japan→VS-Hawaii.", simpeler: "Japan valt VS aan.", nogSimpeler: "PH" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6 aug 1945.", simpeler: "Augustus 1945.", nogSimpeler: "6-8-45" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Atoombom.", simpeler: "VS-atoombom-project.", nogSimpeler: "Atoom" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "17 aug 1945.", simpeler: "Augustus 1945.", nogSimpeler: "17-8-45" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "300k Chinezen vermoord.", simpeler: "Japans massamoord China.", nogSimpeler: "Nanjing" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "VS-hulp wederopbouw.", simpeler: "$13 mld voor Europa.", nogSimpeler: "Marshall" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Orders ≠ vrijbrief.", simpeler: "Persoonlijk verantwoordelijk.", nogSimpeler: "Persoon" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1948.", simpeler: "Mei 1948.", nogSimpeler: "1948" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vrede via integratie.", simpeler: "Geen oorlog meer EU.", nogSimpeler: "Vrede" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rwanda 1994.", simpeler: "Rwanda 800k doden.", nogSimpeler: "Rwanda" },
        },
      },
    ],
  },
