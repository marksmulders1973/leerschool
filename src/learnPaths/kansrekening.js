    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "gunstig ÷ totaal", tekst: "1 vlak met 4, dobbelsteen heeft 6 vlakken → P = 1/6." }],
          woorden: [{ woord: "kans P", uitleg: "= gunstig / totaal" }],
          theorie: "P = aantal gunstige uitkomsten ÷ aantal mogelijke uitkomsten.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1/6 voor elk dobbelsteen-vlak" }],
          basiskennis: [{ onderwerp: "dobbelsteen", uitleg: "6 vlakken: 1, 2, 3, 4, 5, 6" }],
          niveaus: { basis: "1/6 (1 gunstig, 6 totaal).", simpeler: "1 op de 6 kans op een 4.", nogSimpeler: "1 uit 6." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "3 ÷ 10", tekst: "3 rode op totaal 10 knikkers → P(rood) = 3/10." }],
          woorden: [{ woord: "totaal", uitleg: "alle knikkers samen, niet alleen één kleur" }],
          theorie: "Totaal = 3 + 7 = 10. Gunstig = 3 rode.",
          voorbeelden: [{ type: "voorbeeld", tekst: "P(blauw) = 7/10" }],
          basiskennis: [{ onderwerp: "alles bij elkaar", uitleg: "rode + blauwe = 10" }],
          niveaus: { basis: "3/10.", simpeler: "3 rode op 10 knikkers.", nogSimpeler: "3 uit 10." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "even", uitleg: "deelbaar door 2" }],
          theorie: "Tel gunstige uitkomsten op (2, 4, 6 = 3 stuks), deel door totaal (6).",
          voorbeelden: [{ type: "voorbeeld", tekst: "P(oneven) = 3/6 = 1/2 ook" }],
          basiskennis: [{ onderwerp: "vereenvoudigen", uitleg: "3/6 = 1/2 (÷3)" }],
          niveaus: { basis: "3/6 = 1/2.", simpeler: "Drie even, drie oneven. Helft.", nogSimpeler: "Helft van 6 is 3. 50%." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          basiskennis: [{ onderwerp: "schaal", uitleg: "0 ≤ P ≤ 1" }],
          niveaus: { basis: "P = 1 → altijd.", simpeler: "1 betekent 100%, dus zeker.", nogSimpeler: "100% kans = zeker." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "1/5 = 20%", tekst: "100 ÷ 5 = 20 → 1/5 = 20%." }],
          woorden: [{ woord: "percentage", uitleg: "breuk × 100" }],
          theorie: "1/N als percentage = 100/N.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1/4=25%, 1/5=20%, 1/10=10%" }],
          basiskennis: [{ onderwerp: "vuistregels", uitleg: "1/2=50%, 1/4=25%, 1/5=20%" }],
          niveaus: { basis: "100 ÷ 5 = 20%.", simpeler: "5 past 20× in 100.", nogSimpeler: "1/5 = 20%." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Tel <5", tekst: "{1, 2, 3, 4} = 4 gunstig. 4/6 = 2/3." }],
          woorden: [{ woord: "kleiner dan", uitleg: "strikt < 5, dus 5 telt NIET mee" }],
          theorie: "Gunstige uitkomsten: 1, 2, 3, 4. Niet 5 of 6.",
          voorbeelden: [{ type: "voorbeeld", tekst: "4/6 = 2/3" }],
          basiskennis: [{ onderwerp: "< vs ≤", uitleg: "kleiner DAN ≠ kleiner of gelijk aan" }],
          niveaus: { basis: "4/6 = 2/3.", simpeler: "4 op 6 vlakken zijn <5.", nogSimpeler: "1,2,3,4 = 4 vlakken." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "uitkomsten", uitleg: "2³ = 8 mogelijke combinaties" }],
          theorie: "Aantal paden met 2 K uit 3 worpen = 3 (combinatorisch).",
          voorbeelden: [{ type: "voorbeeld", tekst: "3 paden × (1/2)³ = 3/8" }],
          basiskennis: [{ onderwerp: "2^n", uitleg: "n worpen → 2^n totaal" }],
          niveaus: { basis: "3 paden / 8 totaal = 3/8.", simpeler: "KKM, KMK, MKK = 3 stuks.", nogSimpeler: "Tel KKM, KMK, MKK: 3 stuks." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "12 ÷ 30", tekst: "12 jongens / 30 totaal = 12/30 = 2/5." }],
          woorden: [{ woord: "totaal", uitleg: "12 + 18 = 30 leerlingen" }],
          theorie: "Kans = gunstig ÷ totaal. Niet ratio jongens:meisjes.",
          voorbeelden: [{ type: "voorbeeld", tekst: "P(meisje) = 18/30 = 3/5" }],
          basiskennis: [{ onderwerp: "vereenvoudigen", uitleg: "12/30 = 2/5 (÷6)" }],
          niveaus: { basis: "12/30 = 2/5.", simpeler: "12 op 30 leerlingen.", nogSimpeler: "12 uit 30." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "pad", uitleg: "route door de kansboom van begin tot eind" }],
          theorie: "Bij onafhankelijke stappen: vermenigvuldig kansen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "KK: 1/2 × 1/2 = 1/4" }],
          basiskennis: [{ onderwerp: "som = 1", uitleg: "alle paden samen tellen op tot 1" }],
          niveaus: { basis: "Kansen langs pad vermenigvuldigen.", simpeler: "Keer-som van takken.", nogSimpeler: "× langs pad." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "onafhankelijk", uitleg: "uitkomst niet beïnvloed door vorige" }],
          theorie: "Onafhankelijke gebeurtenissen: P(A en B) = P(A) × P(B).",
          voorbeelden: [{ type: "voorbeeld", tekst: "KK = 1/4 (1 op 4 uitkomsten)" }],
          basiskennis: [{ onderwerp: "4 totaal", uitleg: "KK, KM, MK, MM" }],
          niveaus: { basis: "1/2 × 1/2 = 1/4.", simpeler: "Helft × helft = kwart.", nogSimpeler: "1 op 4 kans." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "1/6 × 1/6", tekst: "Twee dobbelstenen: 1/6 × 1/6 = 1/36." }],
          woorden: [{ woord: "combinatie (3,5)", uitleg: "eerst 3 op A, daarna 5 op B" }],
          theorie: "Onafhankelijk: vermenigvuldigen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "36 totaal mogelijke combinaties bij 2 dobbelstenen" }],
          basiskennis: [{ onderwerp: "6×6", uitleg: "elke combinatie even waarschijnlijk" }],
          niveaus: { basis: "1/6 × 1/6 = 1/36.", simpeler: "1 op 36 mogelijkheden.", nogSimpeler: "6 keer 6 is 36." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "totaal 16", uitleg: "2⁴ = 16 mogelijke combinaties" }],
          theorie: "4 paden × (1/2)⁴ = 4/16 = 1/4.",
          voorbeelden: [{ type: "voorbeeld", tekst: "K kan op 4 posities zitten" }],
          basiskennis: [{ onderwerp: "vereenvoudigen", uitleg: "4/16 = 1/4 (÷4)" }],
          niveaus: { basis: "4/16 = 1/4.", simpeler: "4 paden waar 1 K kan staan.", nogSimpeler: "1 op 4 kans." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "uitsluitend", uitleg: "kan niet tegelijk gebeuren" }],
          theorie: "Bij uitsluitende uitkomsten: optellen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "P(2) + P(4) + P(6) = 3/6" }],
          basiskennis: [{ onderwerp: "= even", uitleg: "{2, 4, 6} = even getallen" }],
          niveaus: { basis: "3/6 = 1/2.", simpeler: "1/6 + 1/6 + 1/6.", nogSimpeler: "3 even op 6 totaal = helft." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "1 − P(geen K)", tekst: "P(0 K) = (1/2)⁵ = 1/32. Antwoord = 1 − 1/32 = 31/32." }],
          woorden: [{ woord: "complement", uitleg: "tegenovergestelde gebeurtenis" }],
          theorie: "P(minstens 1) = 1 − P(geen).",
          voorbeelden: [{ type: "voorbeeld", tekst: "1 − 1/32 = 31/32 ≈ 97%" }],
          basiskennis: [{ onderwerp: "truc", uitleg: "minstens-vragen via complement" }],
          niveaus: { basis: "1 − 1/32 = 31/32.", simpeler: "Bijna zeker. Alleen geen K = 1/32.", nogSimpeler: "31 op 32 kans." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "1/6 × 1/6", tekst: "Beide moeten 6 zijn: 1/6 × 1/6 = 1/36." }],
          woorden: [{ woord: "twee dobbelstenen", uitleg: "onafhankelijke worpen" }],
          theorie: "Onafhankelijk: vermenigvuldigen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "36 combinaties totaal, 1 is (6,6)" }],
          basiskennis: [{ onderwerp: "klein", uitleg: "1/36 ≈ 2,8%" }],
          niveaus: { basis: "1/6 × 1/6 = 1/36.", simpeler: "Kans op 6 keer kans op 6.", nogSimpeler: "1 op 36." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "met terugleggen", uitleg: "totaal blijft 10" }],
          theorie: "Met terugleggen → onafhankelijk → kansen blijven gelijk.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Tweede keer ook 4 op 10 rode" }],
          basiskennis: [{ onderwerp: "vereenvoudigen", uitleg: "16/100 = 4/25" }],
          niveaus: { basis: "4/10 × 4/10 = 16/100 = 4/25.", simpeler: "Twee keer dezelfde kans van 4/10.", nogSimpeler: "(2/5)² = 4/25." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "totaal 8", uitleg: "2³ = 8 mogelijke combinaties" }],
          theorie: "Tel posities waarop K kan staan: 3.",
          voorbeelden: [{ type: "voorbeeld", tekst: "3 paden × (1/2)³ = 3/8" }],
          basiskennis: [{ onderwerp: "symmetrie", uitleg: "1×K = 3 paden, 2×K = 3 paden ook" }],
          niveaus: { basis: "3/8.", simpeler: "3 plekken voor K, 8 totaal.", nogSimpeler: "3 op 8 kans." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "complement", uitleg: "P(niet A) = 1 − P(A)" }],
          theorie: "Tegen-kans. Alles behalve 1: 2, 3, 4, 5, 6.",
          voorbeelden: [{ type: "voorbeeld", tekst: "5 op 6 vlakken is geen 1" }],
          basiskennis: [{ onderwerp: "som = 1", uitleg: "1/6 + 5/6 = 1" }],
          niveaus: { basis: "5/6.", simpeler: "5 vlakken zijn niet de 1.", nogSimpeler: "1 minus 1/6 = 5/6." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "zonder terugleggen", uitleg: "minder bonbons + minder totaal na 1ste" }],
          theorie: "Na 1ste: 4 choc op 7 totaal (1 weg, 1 minder totaal).",
          voorbeelden: [{ type: "voorbeeld", tekst: "5/8 × 4/7 = 20/56" }],
          basiskennis: [{ onderwerp: "afhankelijk", uitleg: "kans verandert na 1ste trekking" }],
          niveaus: { basis: "5/8 × 4/7 = 20/56 = 5/14.", simpeler: "Eerst 5 op 8, daarna 4 op 7.", nogSimpeler: "Twee stappen achter elkaar." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "(99/100)³", tekst: "Kans niet winnen per lootje: 99/100. 3× niet winnen: (99/100)³ ≈ 0,97." }],
          woorden: [{ woord: "geen prijs", uitleg: "alle 3 verliezen" }],
          theorie: "P(geen) = product van P(niet winnen) per lootje.",
          voorbeelden: [{ type: "voorbeeld", tekst: "(99/100)³ ≈ 97,03%" }],
          basiskennis: [{ onderwerp: "complement", uitleg: "1 − P(geen) = P(minstens 1 prijs)" }],
          niveaus: { basis: "(99/100)³ ≈ 0,97.", simpeler: "Drie keer niet winnen op rij.", nogSimpeler: "99/100 keer 99/100 keer 99/100." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "minstens 2", uitleg: "2, 3 of 4 K" }],
          theorie: "Complement: 1 − P(geen) − P(precies 1).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Of: P(2)+P(3)+P(4) = 6/16+4/16+1/16 = 11/16" }],
          basiskennis: [{ onderwerp: "totaal 16", uitleg: "2⁴ = 16 paden" }],
          niveaus: { basis: "1 − 1/16 − 4/16 = 11/16.", simpeler: "Trek 'geen' en '1' af van geheel.", nogSimpeler: "11 op 16." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "1 − (5/6)³", tekst: "P(geen 6 in 3 worpen) = (5/6)³. P(min. 1 zes) = 1 − (5/6)³ ≈ 0,42." }],
          woorden: [{ woord: "complement", uitleg: "minstens 1 = 1 minus geen" }],
          theorie: "P(min. 1) = 1 − P(geen).",
          voorbeelden: [{ type: "voorbeeld", tekst: "(5/6)³ = 125/216 → 1 − 125/216 = 91/216" }],
          basiskennis: [{ onderwerp: "5/6", uitleg: "kans GEEN 6 per worp" }],
          niveaus: { basis: "1 − (5/6)³ = 91/216.", simpeler: "Truc: 1 min P(geen 6) drie keer.", nogSimpeler: "Bijna helft van kans." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "1 − P(jongen)", tekst: "P(meisje) = 1 − 12/30 = 18/30 = 3/5." }],
          woorden: [{ woord: "complement", uitleg: "som tot 1" }],
          theorie: "Jongen + meisje = 1 (iedereen is een van beide).",
          voorbeelden: [{ type: "voorbeeld", tekst: "12/30 + 18/30 = 30/30 = 1" }],
          basiskennis: [{ onderwerp: "vereenvoudigen", uitleg: "18/30 = 3/5 (÷6)" }],
          niveaus: { basis: "P(meisje) = 18/30 = 3/5.", simpeler: "1 − 12/30 = 18/30.", nogSimpeler: "Wat overblijft is meisje." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "afhankelijk", uitleg: "tweede kans hangt af van eerste" }],
          theorie: "Bij zonder terugleggen: aantal verandert na elke trekking.",
          voorbeelden: [{ type: "voorbeeld", tekst: "3/8 × 2/7 = 6/56 = 3/28" }],
          basiskennis: [{ onderwerp: "rood eraf", uitleg: "1 rood weg → 2 rood + 5 blauw = 7 totaal" }],
          niveaus: { basis: "3/8 × 2/7 = 6/56.", simpeler: "Eerst 3 op 8, daarna 2 op 7.", nogSimpeler: "Twee trekkingen op rij." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "5/8 × 4/7", tekst: "Eerst 5/8 (5 blauw op 8). Daarna 4/7 (1 blauw weg)." }],
          woorden: [{ woord: "blauw eraf", uitleg: "4 blauw + 3 rood = 7 totaal" }],
          theorie: "Bij zonder terugleggen: zowel teller als noemer verandert.",
          voorbeelden: [{ type: "voorbeeld", tekst: "5/8 × 4/7 = 20/56 = 5/14" }],
          basiskennis: [{ onderwerp: "afhankelijk", uitleg: "kans tweede hangt af van eerste" }],
          niveaus: { basis: "5/8 × 4/7 = 20/56.", simpeler: "Eerst 5/8, daarna 4/7.", nogSimpeler: "Twee blauwe op rij." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "precies één", uitleg: "RB of BR, beide kunnen" }],
          theorie: "Twee verschillende paden — beide tellen mee.",
          voorbeelden: [{ type: "voorbeeld", tekst: "30/56 vereenvoudigd = 15/28" }],
          basiskennis: [{ onderwerp: "vereenvoudigen", uitleg: "30/56 = 15/28 (÷2)" }],
          niveaus: { basis: "15/56 + 15/56 = 30/56 = 15/28.", simpeler: "RB of BR — beide optellen.", nogSimpeler: "Twee paden samen." },
        },
      },
    ],
  },
