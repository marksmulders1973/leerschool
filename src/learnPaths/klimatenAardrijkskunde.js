...
<text x="20" y="150" fill="${COLORS.hoog}" font-size="11" font-family="Arial">H = hoogte (bergen)</text>
    ...
    checks: [
      ...
      { q: "Welk klimaat heeft NL?", options: ["Gematigd zeeklimaat","Tropisch","Woestijn","Toendra"], answer: 0, wrongHints: [null,"Klopt — Köppen Cfb.","Te warm.","Te droog.","Te koud."] },
      { q: "**Tropisch klimaat** is rond?", options: ["De evenaar","Polen","Gematigde zone","Woestijn"], answer: 0, wrongHints: [null,"Klopt — heet + nat.","Te koud.","Niet tropisch.","Wel warm maar droog."] },
      { q: "**Woestijnklimaat** is vooral?", options: ["Droog","Nat","Koud","Tropisch"], answer: 0, wrongHints: [null,"Klopt — <250 mm/jaar.","Niet.","Soms wel koud.","Niet."] },
      { q: "Wat is **temperatuur** gemeten met?", options: ["Thermometer","Barometer","Anemometer","Hygrometer"], answer: 0, wrongHints: [null,"Klopt.","Luchtdruk.","Wind.","Vochtigheid."] },
      { q: "Welk klimaat heeft de **Sahara**?", options: ["Woestijn (heet + droog)","Tropisch","Toendra","Bergklimaat"], answer: 0, wrongHints: [null,"Klopt.","Niet droog.","Te koud.","Niet."] },
      { q: "Wat is **klimaat** versus **weer**?", options: ["Klimaat = lange termijn (30+ jaar); weer = nu","Hetzelfde","Klimaat = dag; weer = maand","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Wel verschil.","Andersom.","Wel."] },
      { q: "Welk **gas** is hoofd-broeikasgas?", options: ["CO₂","O₂","N₂","H₂"], answer: 0, wrongHints: [null,"Klopt — 76%.","Zuurstof.","Stikstof.","Waterstof."] },
      { q: "Wat is **smelten van poolijs** gevolg van?", options: ["Klimaatopwarming","Maan","Industrie alleen","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — algemene temperatuur stijgt.","Niet.","Onderdeel daarvan, niet alleen.","Wel."] },
      { q: "Welke klimaat-zone heeft **toendra**?", options: ["Subpolair / koud","Tropisch","Woestijn","Gematigd"], answer: 0, wrongHints: [null,"Klopt — Siberië/Alaska.","Tegengestelde.","Niet.","Niet."] },
      { q: "Wat is een **moesson**?", options: ["Seizoenswind met regen (vooral Azië)","Storm","Aardbeving","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — India.","Niet specifiek.","Niet relevant.","Wel."] },
      { q: "Welk continent heeft veel **Amazone-regenwoud**?", options: ["Zuid-Amerika","Afrika","Azië","Australië"], answer: 0, wrongHints: [null,"Klopt.","Heeft Congo-regenwoud.","Heeft Borneo-regenwoud.","Niet primair."] },
      { q: "Wat is een **gevolg** van klimaatopwarming?", options: ["Zeespiegel-stijging","Lagere temperatuur","Meer ijs","Minder droogte"], answer: 0, wrongHints: [null,"Klopt — door smelten + uitzetting.","Tegengestelde.","Tegengestelde.","Tegengestelde."] },
      { q: "Welk type **regen** komt door bergen?", options: ["Stuwingsregen","Convectieregen","Frontale regen","Geen regen"], answer: 0, wrongHints: [null,"Klopt — lucht moet omhoog.","Door warmte.","Door front.","Wel regen."] },
      { q: "Wat doet het **golfstroom**?", options: ["Warm water transporteert van tropen naar Europa","Koud water","Niet relevant","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt — daarom NL milder dan verwachte breedtegraad.","Niet primair.","Wel.","Wel."] },
      { q: "Welk verschil tussen **Köppen** zones?", options: ["Internationale klimaat-classificatie","Niet bestaand","Mode-stijlen","Politiek"], answer: 0, wrongHints: [null,"Klopt.","Wel.","Niet.","Niet."] },
    ],
  },
];
