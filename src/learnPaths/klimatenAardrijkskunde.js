    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gemiddeld weer 30 jaar. A.", simpeler: "Klimaat = lang-gemiddeld weer (≥30 jaar).", nogSimpeler: "Lang weer" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Italië-uitspraak. A.", simpeler: "'Italië heeft warme zomers' = patroon = klimaat. Andere = momenten = weer.", nogSimpeler: "Patroon" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Evenaar. A.", simpeler: "Evenaar = recht onder zon, sterkste zonkracht.", nogSimpeler: "Evenaar" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Schuine zoninval. A.", simpeler: "Polen koud omdat zon schuin valt, weinig kracht per m².", nogSimpeler: "Schuine zon" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Amazonegebied. A.", simpeler: "Tropisch regenwoud = Amazone, Congo, Indonesië.", nogSimpeler: "Amazone" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Droog/nat tijd verschil. A.", simpeler: "Savanne = droge + natte tijd. Regenwoud = altijd nat. Beide tropisch.", nogSimpeler: "Droog seizoen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Mediterraan. A.", simpeler: "Spanje = mediterraan (subtropisch): droge zomer, natte winter.", nogSimpeler: "Mediterraan" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Woestijnklimaat. A.", simpeler: "Sahara = woestijn (BW), heet en heel droog (<250 mm regen).", nogSimpeler: "Woestijn" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gematigd zeeklimaat. A.", simpeler: "NL = gematigd zeeklimaat (Cfb), zacht door zee.", nogSimpeler: "Zeeklimaat" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Zee + westenwind. A.", simpeler: "NL zacht 's winters door warme zee + westenwind uit Atlantische Oceaan.", nogSimpeler: "Zee warm" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Groot zomer-winter verschil. A.", simpeler: "Landklimaat = extreme zomers + winters door afstand tot zee.", nogSimpeler: "Extreem" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Centraal Rusland. A.", simpeler: "Landklimaat = midden continent. Centraal Rusland = voorbeeld.", nogSimpeler: "Rusland" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Bevroren bodem. A.", simpeler: "Permafrost = altijd bevroren grond (>2 jaar).", nogSimpeler: "Bevroren" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Antarctica. A.", simpeler: "IJsklimaat = altijd onder 0°C. Antarctica = voorbeeld.", nogSimpeler: "Antarctica" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0,6°C/100m. A.", simpeler: "Hoogte = kouder, ~0,6°C per 100m omhoog.", nogSimpeler: "0,6" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hoogte koelt. A.", simpeler: "Kilimanjaro 5895m hoog → ~-10°C top → sneeuw mogelijk ondanks evenaar.", nogSimpeler: "Hoogte" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Broeikasgassen door mensen. A.", simpeler: "Klimaatverandering door mensen die broeikasgassen uitstoten (CO2).", nogSimpeler: "Mensen+CO2" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Zeespiegel stijgt. A.", simpeler: "Gevolg klimaatverandering = zeespiegel stijgt door smeltend ijs.", nogSimpeler: "Zee stijgt" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tropisch (A). A.", simpeler: "Warm hele jaar + veel regen + evenaar = tropisch regenwoud.", nogSimpeler: "A" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gematigd zeeklimaat. A.", simpeler: "4 seizoenen + zacht + regen = gematigd zeeklimaat (NL).", nogSimpeler: "Cfb" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Woestijnklimaat. A.", simpeler: "Droog + heet overdag + koud nacht = woestijnklimaat (BW).", nogSimpeler: "Woestijn" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Landklimaat. A.", simpeler: "Centraal Rusland ver van zee = landklimaat (D), extreme zomer/winter.", nogSimpeler: "Land" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5 hoofdgroepen A-B-C-D-E.", simpeler: "Köppen verdeelt wereld-klimaten in 5 groepen: A tropisch, B droog, C gematigd (NL), D land, E polair.", nogSimpeler: "5 klimaten" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gassen houden warmte vast.", simpeler: "Broeikaseffect = CO₂ + andere gassen in lucht houden zonnewarmte vast. Beetje is goed (leven mogelijk). Te veel = klimaatverandering.", nogSimpeler: "Warmte vasthouden" },
        },
      },
