    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Uitleg + neutraal = uitleggen", tekst: "Wetenschap stap-voor-stap zonder mening = uiteenzetting (uitleggen)." }],
          woorden: [{ woord: "uiteenzetting", uitleg: "tekst die iets uitlegt" }],
          theorie: "Vier hoofddoelen: overtuigen, informeren, uitleggen, beschouwen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Hoe werkt fotosynthese? = uitleggen" }],
          basiskennis: [{ onderwerp: "signalen", uitleg: "neutrale toon, hoe-werkt-vraag" }],
          niveaus: { basis: "Uitleggen.", simpeler: "Uiteenzetting.", nogSimpeler: "Uitleg." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Oproep = overtuigen", tekst: "'Hoog tijd dat regering ingrijpt' = oproep tot actie = overtuigen." }],
          woorden: [{ woord: "betoog", uitleg: "overtuigende tekst" }],
          theorie: "Slotzin met actie-oproep wijst op overtuigen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Moet', 'hoog tijd', 'we moeten' = overtuigen" }],
          basiskennis: [{ onderwerp: "subjectief", uitleg: "geëngageerde toon = overtuigen" }],
          niveaus: { basis: "Overtuigen.", simpeler: "Wil dat lezer iets doet.", nogSimpeler: "Overtuigen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Jargon zonder uitleg = experts", tekst: "Medisch jargon zonder toelichting = artsen / verpleegkundigen." }],
          woorden: [{ woord: "doelgroep", uitleg: "wie de tekst leest" }],
          theorie: "Toon + jargon-niveau = signaal voor doelgroep.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Contra-indicatie, comorbiditeit = medische vakwoorden" }],
          basiskennis: [{ onderwerp: "test", uitleg: "wordt jargon uitgelegd? leek vs expert" }],
          niveaus: { basis: "Medisch geschoold.", simpeler: "Artsen/verpleegkundigen.", nogSimpeler: "Experts." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Hoofdgedachte = volzin", tekst: "Niet alleen onderwerp (1 woord), maar volzin met claim." }],
          woorden: [{ woord: "hoofdgedachte", uitleg: "wat schrijver stelt over onderwerp" }],
          theorie: "Onderwerp = waar over. Hoofdgedachte = wat schrijver stelt.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Te veel schermtijd schaadt... = volzin met claim" }],
          basiskennis: [{ onderwerp: "1 tweet", uitleg: "max 280 tekens samenvatting" }],
          niveaus: { basis: "Volzin met claim.", simpeler: "Wat zegt schrijver?", nogSimpeler: "Boodschap." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Hoofdvraag past bij hoofdgedachte", tekst: "Hoofdgedachte = sociale media schadelijk → hoofdvraag = Zijn ze schadelijk?" }],
          woorden: [{ woord: "hoofdvraag", uitleg: "centrale vraag die de tekst beantwoordt" }],
          theorie: "Vorm hoofdvraag uit hoofdgedachte (claim → vraag).",
          voorbeelden: [{ type: "voorbeeld", tekst: "'X moet omlaag' → 'Moet X omlaag?'" }],
          basiskennis: [{ onderwerp: "scope", uitleg: "past bij hele tekst, niet 1 alinea" }],
          niveaus: { basis: "Schadelijk?", simpeler: "Maak claim → vraag.", nogSimpeler: "Hoofdvraag." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Deelvraag = onderdeel hoofd", tekst: "Hoofdvraag = oorzaak crisis. Deelvraag = welke rol speelt rente?" }],
          woorden: [{ woord: "deelvraag", uitleg: "vraag per alinea, bouwt totaalantwoord" }],
          theorie: "Deelvragen bouwen samen het antwoord op de hoofdvraag.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Per alinea: 1 deelvraag" }],
          basiskennis: [{ onderwerp: "topic sentence", uitleg: "eerste zin → deel-onderwerp" }],
          niveaus: { basis: "Rol van rente.", simpeler: "Onderdeel van oorzaak.", nogSimpeler: "Deelvraag." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "'Echter' = tegenstellend", tekst: "Echter + tegenstanders = tegen-perspectief introduceren." }],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Tegenstellend verband", tekst: "Alinea 4 weerspreekt alinea 3 = tegenstellend." }],
          woorden: [{ woord: "verband", uitleg: "relatie tussen alinea's" }],
          theorie: "7 verbanden: toevoegend, tegenstellend, oorzaak-gevolg, voorbeeld, uitwerking, vergelijking, conclusie.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Echter, uit cijfers blijkt...' = tegen" }],
          basiskennis: [{ onderwerp: "1e woord 2e alinea", uitleg: "verklapt het verband" }],
          niveaus: { basis: "Tegenstellend.", simpeler: "Spreekt vorige tegen.", nogSimpeler: "Tegen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "'Met als gevolg' = gevolg", tekst: "Voor 'gevolg'-vraag: scan op 'met als gevolg', 'daardoor'." }],
          woorden: [{ woord: "signaalwoorden", uitleg: "tonen relatie tussen zinnen" }],
          theorie: "Vraag → bijbehorend signaalwoord. Antwoord zit vaak in die zin.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Gevolg = met als gevolg / daardoor" }],
          basiskennis: [{ onderwerp: "examen-truc", uitleg: "scan eerst vraag, dan signaal" }],
          niveaus: { basis: "Met als gevolg...", simpeler: "Gevolg-zin.", nogSimpeler: "Gevolg." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Mening = waardeoordeel", tekst: "'Sociale media schadelijk' = niet objectief toetsbaar = mening." }],
          woorden: [{ woord: "mening", uitleg: "oordeel/voorkeur, niet toetsbaar" }],
          theorie: "Feit = toetsbaar. Mening = waardeoordeel.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Schadelijk' is subjectief oordeel" }],
          basiskennis: [{ onderwerp: "test", uitleg: "kun je tegendeel beweren zonder dom te lijken?" }],
          niveaus: { basis: "Mening.", simpeler: "Niet objectief toetsbaar.", nogSimpeler: "Mening." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "'Iedereen weet' = mening vermomd", tekst: "Klinkt zeker, maar is een mening — niet objectief toetsbaar." }],
          woorden: [{ woord: "vermomde mening", uitleg: "lijkt feit, is opinie" }],
          theorie: "Pas op met 'iedereen weet', 'duidelijk', 'natuurlijk'.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Iedereen weet dat X' = mening, geen feit" }],
          basiskennis: [{ onderwerp: "test", uitleg: "is X echt door alle bronnen bevestigd?" }],
          niveaus: { basis: "Mening.", simpeler: "Vermomde mening.", nogSimpeler: "Mening." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Selectief = één perspectief", tekst: "Alleen artsen aangehaald = andere kanten weggelaten." }],
          woorden: [{ woord: "selectieve bron", uitleg: "alleen één kant uitlichten" }],
          theorie: "Goede tekst toont meerdere perspectieven.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Zorg-tekst: artsen + patiënten + verzekeraars" }],
          basiskennis: [{ onderwerp: "kritisch", uitleg: "welke kant ontbreekt?" }],
          niveaus: { basis: "Selectief.", simpeler: "Eén kant.", nogSimpeler: "Selectief." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Waardeoordeel + versterker", tekst: "'Werkelijk schandalig' = waardeoordeel + versterker = subjectief." }],
          woorden: [{ woord: "subjectief", uitleg: "persoonlijke positie zichtbaar" }],
          theorie: "Subjectiviteit zit in woordkeus (schandalig, werkelijk, natuurlijk).",
          voorbeelden: [{ type: "voorbeeld", tekst: "Schandalig, prachtig, absurd = oordelend" }],
          basiskennis: [{ onderwerp: "vs objectief", uitleg: "objectief = neutraal" }],
          niveaus: { basis: "Subjectief.", simpeler: "Waardeoordeel + versterker.", nogSimpeler: "Mening." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Slot met 'moet' = overtuigen", tekst: "'Regering moet beleid herzien' = oproep = overtuigen." }],
          woorden: [{ woord: "overtuigen", uitleg: "wil dat lezer actie onderneemt" }],
          theorie: "Slotzin met 'moet/dient/zo snel mogelijk' = overtuigen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Hoog tijd dat...' = oproep" }],
          basiskennis: [{ onderwerp: "andere doelen", uitleg: "informeren/uitleggen eindigen neutraal" }],
          niveaus: { basis: "Overtuigen.", simpeler: "Oproep tot actie.", nogSimpeler: "Overtuigen." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "'Concluderend' = slot/concluderend", tekst: "'Concluderend' = afsluiting + samenvatting." }],
          woorden: [{ woord: "concluderend", uitleg: "alinea trekt eindconclusie" }],
          theorie: "Concluderend / kortom / al met al = concluderende functie.",
          voorbeelden: [{ type: "voorbeeld", tekst: "'Concluderend kan gesteld worden...'" }],
          basiskennis: [{ onderwerp: "vs inleidend", uitleg: "inleidend opent, concluderend sluit" }],
          niveaus: { basis: "Concluderend.", simpeler: "Eindconclusie.", nogSimpeler: "Slot." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Volzin met claim", tekst: "'Suikerbelasting zou volksgezondheid verbeteren' = volzin met claim = hoofdgedachte." }],
          woorden: [{ woord: "claim", uitleg: "wat schrijver stelt" }],
          theorie: "Hoofdgedachte = uitspraak met standpunt/conclusie.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Niet 'suiker' (thema) — wel 'suiker is schadelijk' (claim)" }],
          basiskennis: [{ onderwerp: "test", uitleg: "kun je tegendeel beweren?" }],
          niveaus: { basis: "Volzin met claim.", simpeler: "Stelling.", nogSimpeler: "Hoofdgedachte." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "beter", uitleg: "waardeoordeel = mening" }],
          theorie: "Comparatieven ('beter') zonder objectieve criteria = mening.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Klassiek beter dan pop = onmogelijk objectief" }],
          basiskennis: [{ onderwerp: "vermomming", uitleg: "'iedereen weet' = trucje" }],
          niveaus: { basis: "Mening.", simpeler: "Vermomd als feit.", nogSimpeler: "Mening." },
        },
      },
      { q: "*'De zonneschijn voelt heerlijk warm.'* — Welke uitspraak?", options: ["Mening","Feit","Hypothese","Wet"], answer: 0, wrongHints: [null,"Klopt — 'heerlijk' = waardering.","Geen meetbaar feit.","Niet specifiek getoetst.","Niet."] },
      { q: "*'Nederland heeft 17 miljoen inwoners.'* — Welke uitspraak?", options: ["Feit","Mening","Hypothese","Suggestie"], answer: 0, wrongHints: [null,"Klopt — controleerbaar getal.","Geen waardering.","Geen veronderstelling.","Geen advies."] },
      { q: "Een **uiteenzettende tekst** heeft welk doel?", options: ["Informeren","Overtuigen","Vermaken","Aansporen tot actie"], answer: 0, wrongHints: [null,"Klopt — neutrale uitleg.","Dat is betogend.","Dat is amuserend.","Dat is appellerend."] },
      { q: "Wat is een **tekstdoel**?", options: ["Waarom de schrijver de tekst schreef","De titel","Het aantal woorden","De zinslengte"], answer: 0, wrongHints: [null,"Klopt.","Titel ≠ doel.","Telling.","Stijl."] },
      { q: "Welk signaalwoord geeft een **conclusie** aan?", options: ["dus","want","bijvoorbeeld","echter"], answer: 0, wrongHints: [null,"Klopt.","Reden.","Voorbeeld.","Tegenstelling."] },
      { q: "Wat zegt het **doelgroep** van een tekst?", options: ["Voor wie de tekst is bedoeld","Hoe lang de tekst is","Wat het tekstdoel is","Wie de tekst schreef"], answer: 0, wrongHints: [null,"Klopt.","Lengte.","Dat is tekstdoel.","Auteur."] },
      { q: "Welke vraag stel je om de **hoofdvraag** te vinden?", options: ["Wat is de centrale vraag die de tekst beantwoordt?","Hoeveel alinea's heeft de tekst?","Wat staat in de eerste zin?","Welke kleuren komen voor?"], answer: 0, wrongHints: [null,"Klopt.","Telling.","Te oppervlakkig.","Onzinnig."] },
    ],
  },
];
