    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Zonder context = fouten.", "Te traag.", "Niet als eerste."],
      },
      {
        q: "Welk signaalwoord = **tegenstelling**?",
        options: ["echter", "omdat", "zoals", "bovendien"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Reden.", "Voorbeeld.", "Toevoeging."],
      },
      {
        q: "*'Veel jongeren willen vegetariër worden. ___, ze weten vaak niet hoe.'* Welk woord past?",
        options: ["Echter", "Daarom", "Bijvoorbeeld", "En"],
        answer: 0,
        wrongHints: [null, "Klopt — tegenstelling met 'willen' vs 'kunnen niet'.", "Geen gevolg.", "Geen voorbeeld.", "Geen toevoeging."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — tijd-management.", "Verspilt tijd.", "Niet zonder lezen.", "Wel later proberen."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet typisch.", "Soms maar niet primair.", "Geen typische plek."],
      },
      {
        q: "*'Volgens de tekst, ___'* Wat doe je?",
        options: ["Zoek letterlijk in tekst", "Geef eigen mening", "Gok beste antwoord", "Sla over"],
        answer: 0,
        wrongHints: [null, "Klopt — alleen wat in tekst staat.", "Niet — alleen tekst.", "Niet zonder lezen.", "Wel beantwoorden."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — algemeen genoeg.", "Detail.", "Niet expliciet in deze samenvatting.", "Niet de hoofdgedachte."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — detail.", "Goed voor hoofdgedachte.", "Vaak goed.", "Vaak goed."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — enige persoon.", "Niet — Tom expliciet.", "Geen persoon.", "Wel bekend."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 'dit' vat samen.", "Te beperkt.", "Te beperkt.", "Dat is gevolg, niet 'dit'."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Wel verschil.", "Niet over geslacht.", "Beide kunnen ev + mv."],
      },
      {
        q: "*'Anna en Lisa kochten boeken. **Zij** las graag.'* Wie is **zij**?",
        options: ["Niet duidelijk — kan beide", "Anna sowieso", "Lisa sowieso", "Niemand"],
        answer: 0,
        wrongHints: [null, "Klopt — moet context geven.", "Mogelijk maar niet eenduidig.", "Mogelijk maar niet eenduidig.", "Wel iemand."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is argument.", "Stelling kan ook geen feit zijn.", "Niet stelling."],
      },
      {
        q: "*'Volgens het CBS rookt 20% van Nederlanders.'* Welk soort argument?",
        options: ["Feitelijk", "Emotioneel", "Moreel", "Voorbeeld"],
        answer: 0,
        wrongHints: [null, "Klopt — statistiek.", "Geen emotie.", "Niet over goed/fout.", "Wel illustratie, maar primair feit."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — appelleert aan gevoel.", "Geen bewijs.", "Geen werkings-argument.", "Geen autoriteit."],
      },
      {
        q: "Wat is een **tegenwerping**?",
        options: ["Argument tegen de stelling (van tegenstander)", "Argument voor", "Een feit", "Een vraag"],
        answer: 0,
        wrongHints: [null, "Klopt — counter-argument.", "Tegenovergesteld.", "Niet specifiek argument-type.", "Geen tegenwerping."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenstelling.", "Reden.", "Voorbeeld."],
      },
      {
        q: "*'Het regende. **Daarom** bleef ik thuis.'* Welk soort signaalwoord?",
        options: ["Gevolg", "Reden", "Tegenstelling", "Voorbeeld"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Reden is 'omdat'.", "Tegenstelling 'maar'.", "Voorbeeld 'zoals'."],
      },
      {
