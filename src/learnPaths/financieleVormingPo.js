...
const steps = [
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "**50/30/20** — wat is **50%** voor?", options: ["Nodig (huur, eten)","Leuk","Sparen","Belasting"], answer: 0, wrongHints: [null,"Klopt — basisbehoeften.","Dat is 30%.","Dat is 20%.","Niet in regel."] },
      { q: "**50/30/20** — wat is **20%** voor?", options: ["Sparen","Leuk","Nodig","Belasting"], answer: 0, wrongHints: [null,"Klopt — buffer/doelen.","Dat is 30%.","Dat is 50%.","Niet in regel."] },
      { q: "€10 zakgeld × 4 weken = totaal in 1 maand?", options: ["€40","€14","€10","€100"], answer: 0, wrongHints: [null,"Klopt.","Som.","Per week.","Te veel."] },
      { q: "Spaar €5/week. Hoeveel na 10 weken?", options: ["€50","€5","€15","€100"], answer: 0, wrongHints: [null,"Klopt — 5×10.","Per week.","Niet.","Te veel."] },
      { q: "**Reclame** wil je vooral?", options: ["Iets kopen","Niets","Spelen","Spreken"], answer: 0, wrongHints: [null,"Klopt — beïnvloeden.","Wel — doel.","Soms ook, niet hoofd.","Niet primair."] },
      { q: "Wat doe je als je iets duurs wilt kopen?", options: ["Sparen tot je het zelf kan betalen","Direct lenen","Vrienden vragen","Vergeten"], answer: 0, wrongHints: [null,"Klopt — geen schulden.","Riskant.","Niet primair.","Niet relevant."] },
      { q: "**BNPL** (Buy Now Pay Later) is?", options: ["Vorm van lenen","Spaarrekening","Reclame-truc","Statiegeld"], answer: 0, wrongHints: [null,"Klopt — riskant.","Niet sparen.","Wel reclame, maar concreet lenen.","Niet."] },
      { q: "Welke 3 **functies** heeft geld?", options: ["Ruil + reken + spaar","Ruil + reken","Ruil + reclame","Spaar + lenen + reclame"], answer: 0, wrongHints: [null,"Klopt.","Mist sparen.","Niet — reclame is geen functie.","Niet 3 functies."] },
      { q: "**Schulden** ontstaan als je?", options: ["Niet terugbetaalt wat je leende","Veel spaart","Niet uitgeeft","Statiegeld inlevert"], answer: 0, wrongHints: [null,"Klopt.","Tegenovergesteld.","Niet.","Niet."] },
      { q: "Influencer reclame heet?", options: ["Sponsored content / partnership","Eerlijke mening","Niet reclame","Belasting"], answer: 0, wrongHints: [null,"Klopt — betaald reclame.","Niet altijd.","Wel.","Niet."] },
      ...
      { q: "**Begroting** is?", options: ["Plan voor inkomsten + uitgaven","Boodschappenlijst","Reclame","Bankrekening"], answer: 0, wrongHints: [null,"Klopt — financieel plan.","Soms onderdeel.","Niet.","Niet."] },
      { q: "Welke geldzaak is voor **kinderen** verstandig?", options: ["Klein deel zakgeld sparen","Alles op één hoop","Niets sparen","Lenen"], answer: 0, wrongHints: [null,"Klopt — discipline leren.","Niet — overzicht weg.","Niet.","Risico."] },
      { q: "Welk product heeft **statiegeld** in NL?", options: ["Plastic flessen","Boeken","Stickers","Bananen"], answer: 0, wrongHints: [null,"Klopt — terug bij inlevering.","Geen statiegeld.","Geen.","Geen."] },
    ],
  },
];
