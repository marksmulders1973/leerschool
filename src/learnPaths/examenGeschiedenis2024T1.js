    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Aan het parlement.",
            simpeler: "Sinds 1848 leggen ministers verantwoording af aan het parlement (Tweede + Eerste Kamer), niet aan de koning.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Gelijkschakeling.",
            simpeler: "Alle vakbonden vervangen door 1 verplichte nazi-organisatie = gelijkschakeling.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "VN + VS.",
            simpeler: "In 1947 bestonden NAVO + EGKS nog niet. Alleen de VN en VS waren grote critici van NL-militair ingrijpen in Indonesië.",
            nogSimpeler: "VN + VS",
          },
        },
      },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Soevereiniteitsoverdracht.",
            simpeler: "De officiële overdracht van bestuur = soevereiniteitsoverdracht (1949).",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Cubacrisis.",
            simpeler: "Na de Cubacrisis (1962, bijna-kernoorlog) wilden VS + USSR directe communicatie. Hotline 1963.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Poldermodel.",
            simpeler: "Overheid + vakbonden + werkgevers regelmatig samen aan tafel = poldermodel (NL-overlegcultuur).",
