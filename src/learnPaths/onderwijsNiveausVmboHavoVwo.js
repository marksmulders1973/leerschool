...
const steps = [
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet 'beter', wel anders.", "Niet 'beter', wel anders.", "Niet 'beter', wel anders."],
      },
      {
        q: "Wat helpt naast het schooladvies bij je indeling?",
        options: ["De Doorstroomtoets", "Je schoenmaat", "Je lievelingskleur", "Het weer"],
        answer: 0,
        wrongHints: [null, "Heeft niks met school te maken.", "Heeft niks met school te maken.", "Heeft niks met school te maken."],
      },
    ],
  },
  {
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet waar het voor staat.", "Niet waar het voor staat.", "Niet waar het voor staat."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet waar.", "Niet waar.", "Niet waar."],
      },
    ],
  },
  {
