...
const steps = [
...

  {
    ...
    checks: [
      ...
      { q: "**456 + 287** = ?", options: ["743","743 (?)","633","843"], answer: 0, wrongHints: [null,"Klopt.","Niet — geen vraag.","Niet — vergeet onthouden niet.","Niet."] },
      { q: "**905 − 327** = ?", options: ["578","678","622","622 (?)"], answer: 0, wrongHints: [null,"Klopt — lenen bij honderdtal.","Niet — lenen vergeten.","Niet.","Niet."] },
      { q: "**24 × 15** = ?", options: ["360","240","36","350"], answer: 0, wrongHints: [null,"Klopt — 24×10 + 24×5 = 240 + 120.","Dat is 24×10.","Niet — vergeet 10-vouden.","Niet — bijna."] },
      { q: "**156 ÷ 4** = ?", options: ["39","36","42","51"], answer: 0, wrongHints: [null,"Klopt — 4×39=156.","Niet — controleer 4×36=144.","Niet — te hoog.","Niet."] },
      { q: "**3,5 + 2,7** = ?", options: ["6,2","5,2","6,12","5,12"], answer: 0, wrongHints: [null,"Klopt — 0,5+0,7=1,2 → 1,2 + 5 = 6,2.","Niet — 0,5+0,7 = 1,2.","Niet — 12 hoort niet samen.","Niet."] },
      { q: "**8 − 3,4** = ?", options: ["4,6","5,6","3,6","4,4"], answer: 0, wrongHints: [null,"Klopt — 8=8,0; 8,0−3,4=4,6.","Niet.","Niet.","Niet."] },
      { q: "**0,3 × 7** = ?", options: ["2,1","21","0,21","3,7"], answer: 0, wrongHints: [null,"Klopt — 3×7=21, komma één plaats links.","Niet — komma vergeten.","Komma te ver.","Niet."] },
      { q: "**240 ÷ 12** = ?", options: ["20","12","24","30"], answer: 0, wrongHints: [null,"Klopt — 12×20=240.","Dat is de deler.","Te laag.","Te hoog."] },
      { q: "Rond af: **23,7** op heel getal", options: ["24","23","23,7","20"], answer: 0, wrongHints: [null,"Klopt — 7 ≥ 5 → omhoog.","Niet — 7 ≥ 5.","Dat is niet afgerond.","Te ver."] },
      { q: "Wat is **17 × 6**?", options: ["102","112","104","92"], answer: 0, wrongHints: [null,"Klopt — 10×6 + 7×6 = 60+42.","Niet — controleer.","Niet.","Te laag."] },
      { q: "**1.234 + 567** = ?", options: ["1.801","1.701","1.811","1.901"], answer: 0, wrongHints: [null,"Klopt.","Niet — onthouden vergeten.","Niet.","Niet."] },
      { q: "**1.000 − 245** = ?", options: ["755","855","655","745"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet — bijna."] },
      { q: "**45 × 11** = ?", options: ["495","450","405","550"], answer: 0, wrongHints: [null,"Klopt — truc: tussen 4+5=9 zetten.","Dat is ×10.","Niet.","Niet."] },
      { q: "**100 ÷ 25** = ?", options: ["4","5","2","10"], answer: 0, wrongHints: [null,"Klopt — kwartjes in €1.","Niet.","Niet.","Niet."] },
      { q: "Hoeveel **honderdtallen** in 4.567?", options: ["5","4","6","7"], answer: 0, wrongHints: [null,"Klopt — kijk naar 100-plek.","Dat is duizendtal.","Dat is tiental.","Dat is eenheid."] },
    ],
  },
];
