...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "**2 typen zintuigcellen in netvlies**: KEGELTJES (kleur + scherp, alleen bij genoeg licht) + STAAFJES (geen kleur, wel licht-gevoelig, werken óók in schemer/donker). Donkere achtbaan-hal = weinig licht = STAAFJES nemen het over.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Eiwit** = bouwstof bij uitstek (spieren, organen, veren bouwen). Rups = veel eiwit = perfect voor jonge koolmees. Koolhydraten en vetten = brandstof. Mineralen = klein aandeel.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Genotype** = je DNA-code = onveranderlijk (zelfde van bevruchting tot dood). **Fenotype** = hoe je eruit ziet/functioneert = WEL veranderlijk (groei, ziekte, metamorfose). Metamorfose verandert FENOTYPE drastisch (rups → vlinder), maar GENOTYPE blijft identiek.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Beenmerg** = zacht weefsel BINNENIN BOTTEN (rug, borstbeen, ribben, heup). Stamcellen daar produceren alle bloeddeeltjes: rode + witte cellen + bloedplaatjes. Daarom doen artsen 'beenmergpunctie' uit het bekken om dit te testen.",
