    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Net iets te vroeg.", "Te laat.", "Veel te laat."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — combinatie van factoren.", "Geen olie in 17e eeuw.", "Geen goudmijnen in NL.", "Nederland heerste niet over Europa."],
      },
      {
        q: "Welke vorm van regering had Nederland in de Gouden Eeuw?",
        options: ["Republiek (geen koning)", "Koninkrijk", "Keizerrijk", "Stadstaat"],
        answer: 0,
        wrongHints: [null, "Klopt — Republiek der Verenigde Nederlanden.", "Pas vanaf 1815 koninkrijk.", "Geen keizer.", "Geen losse stadstaat."],
      },
      {
        q: "Welke stad was het **financiële centrum**?",
        options: ["Amsterdam", "Rotterdam", "Utrecht", "Den Haag"],
        answer: 0,
        wrongHints: [null, "Klopt — eerste beurs ter wereld in 1602.", "Belangrijke haven maar Amsterdam was financieel hart.", "Utrecht was groot maar geen handelscentrum.", "Den Haag was bestuurlijk."],
      },
    ],
  },
  ...
  // STAP 2: Handel + VOC
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Te vroeg.", "Te laat.", "Koninkrijk Nederland."],
      },
      {
        q: "Wat handelde VOC vooral?",
        options: ["Specerijen uit Indonesië", "Auto's uit Duitsland", "IJzer uit Amerika", "Boeken uit Engeland"],
        answer: 0,
        wrongHints: [null, "Klopt — peper, nootmuskaat, kruidnagel, kaneel.", "Geen auto's in 17e eeuw.", "Niet kerntaak.", "Niet kerntaak."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — door Engelsen veroverd in 1664.", "Bestond niet.", "Bestond niet.", "Echte plaats in Zeeland."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 1642.", "Vermeer maakte Meisje met de Parel.", "19e eeuw, niet 17e.", "20e eeuw."],
      },
      {
        q: "Wie schilderde **het Meisje met de Parel**?",
        options: ["Vermeer", "Rembrandt", "Jan Steen", "Frans Hals"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Nachtwacht.", "Andere stijl.", "Portretten."],
      },
      {
        q: "Wie ontdekte **micro-organismen** met microscoop?",
        options: ["Antoni van Leeuwenhoek", "Christiaan Huygens", "Newton", "Galilei"],
        answer: 0,
        wrongHints: [null, "Klopt — uit Delft.", "Astronomie + slingerklok.", "Engelsman, niet Nederlands.", "Italiaan, andere periode."],
      },
      {
        q: "**Waarom** waren Amsterdamse huizen **smal en hoog**?",
        options: ["Belasting was op breedte", "Geen ruimte", "Modetrend", "Beter tegen wind"],
        answer: 0,
        wrongHints: [null, "Klopt — meer breedte = meer belasting.", "Ruimte was er wel.", "Geen mode-reden.", "Geen wind-reden."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Geen ramp, juist begin Gouden Eeuw.", "Vrede, niet ramp.", "Te laat."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Duitsland bestond als land nog niet.", "Wel ooit (80-jarige oorlog) maar niet in 1672.", "Bestond niet."],
      },
      {
        q: "Hoe **redde** Nederland zich in 1672?",
        options: ["Waterlinie + de Ruyter + diplomatie", "Vluchten naar Engeland", "Geld geven", "Verloren"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Geen vlucht.", "Niet de hoofdoplossing.", "Niet helemaal verloren — kwam er bovenop."],
      },
      {
        q: "Wanneer werd Indonesië **onafhankelijk**?",
        options: ["1945", "1815", "1672", "1700"],
        answer: 0,
        wrongHints: [null, "Klopt — na WO2.", "Toen werd Nederland koninkrijk.", "Andere eeuw.", "Andere eeuw."],
      },
    ],
  },
  ...
  // STAP 6: Eind-mix
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Andere schilder.", "20e eeuw.", "15e eeuw."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 1664 veroverd door Engelsen.", "Bestaat niet.", "Bestaat niet.", "Bestaat niet."],
      },
      {
        q: "Wanneer werd **slavernij afgeschaft** in NL-koloniën?",
        options: ["1863", "1648", "1672", "1945"],
        answer: 0,
        wrongHints: [null, "Klopt — Keti Koti.", "Vrede 80-jarige oorlog.", "Rampjaar.", "Na WO2."],
      },
      {
        q: "Welk **bedrijf** was vooral betrokken bij slavernij?",
        options: ["WIC", "VOC", "ING", "Microsoft"],
        answer: 0,
        wrongHints: [null, "Klopt — West-Indische Compagnie.", "Oost-Indië, niet primair slavernij.", "Modern.", "Modern."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet bank.", "Niet museum.", "Niet universiteit."],
      },
    ],
  },
];
