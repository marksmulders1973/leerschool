    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Te beperkt.", "Een park kan ecosysteem zijn, maar definitie is breder.", "Te beperkt — populatie is 1 soort."],
      },
      {
        q: "Wat is een **abiotische factor**?",
        options: ["Niet-levend (water, lucht, grond)", "Een dier", "Een plant", "Een bacterie"],
        answer: 0,
        wrongHints: [null, "Klopt — niet-levend.", "Dat is biotisch.", "Dat is biotisch.", "Dat is biotisch."],
      },
      {
        q: "Wat is een **populatie**?",
        options: ["Alle individuen van 1 soort in een gebied", "Alle dieren", "Hele bos", "1 plant"],
        answer: 0,
        wrongHints: [null, "Klopt — bv. alle eekhoorns in dit bos.", "Te ruim.", "Dat is levensgemeenschap+.", "Dat is individu."],
      },
      {
        q: "Welke is een **biotische** factor?",
        options: ["Een schimmel", "Regen", "Temperatuur", "Bodem"],
        answer: 0,
        wrongHints: [null, "Klopt — levend.", "Abiotisch.", "Abiotisch.", "Abiotisch."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — maakt zelf voedsel.", "Consument (herbivoor).", "Afbreker.", "Consument (carnivoor)."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is herbivoor.", "Dat is carnivoor.", "Dat is producent."],
      },
      {
        q: "Een **leeuw** eet zebra's. Wat is een leeuw?",
        options: ["Carnivoor (vleeseter)", "Herbivoor", "Producent", "Afbreker"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Eet vlees, geen planten.", "Geen plant.", "Geen afbreker."],
      },
      {
        q: "Wat is een **autotroof**?",
        options: ["Wezen dat zelf voedsel maakt (producent)", "Vleeseter", "Plant-eter", "Afbreker"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Heterotroof.", "Heterotroof.", "Heterotroof."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        options: ["~10%", "~50%", "~100%", "~1%"],
        answer: 0,
        wrongHints: [null, "Klopt — rest gaat verloren.", "Te veel.", "Onmogelijk.", "Te weinig — dat is 2 niveaus."],
      },
      {
        q: "Welk dier is **meest zeldzaam** in ecosysteem?",
        options: ["Toproofdier", "Plant", "Herbivoor", "Insect"],
        answer: 0,
        wrongHints: [null, "Klopt — minste energie beschikbaar.", "Vaak juist meest aanwezig.", "Talrijker dan toproofdier.", "Talrijker dan toproofdier."],
      },
      {
        q: "In voedselketen 'gras → muis → uil' — wat **eet de muis**?",
        options: ["Gras", "Uil", "Beide", "Niets"],
        answer: 0,
        wrongHints: [null, "Klopt — muis is herbivoor hier.", "Andersom — uil eet muis.", "Niet uil.", "Wel iets."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — beroemd voorbeeld trophic cascade.", "Wel veel impact.", "Tegenovergesteld.", "Niet hoofdgevolg."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is waterkringloop.", "Dat is N-kringloop.", "Dat is energiestroom (geen kringloop)."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — kolen, olie, gas verbranding.", "Tegenovergesteld effect.", "Geen significante invloed.", "Wel bekend."],
      },
      {
        q: "Wat is de **stikstofkringloop**?",
        options: ["N₂ uit lucht → bacterie → nitraten → plant → terug", "Water-cyclus", "CO₂-cyclus", "Energie-stroom"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is water.", "Dat is C.", "Geen kringloop."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — belangrijke regel.", "Energie kringloopt niet.", "Materie blijft circuleren.", "Wel verschil."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — diversiteit = verscheidenheid.", "Niet biologie.", "Niet biologie.", "Dat is populatie."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — leefgebied weg = soort weg.", "Belangrijk maar niet grootste.", "Belangrijk maar niet grootste.", "Belangrijk maar niet grootste."],
      },
      {
        q: "Wat is een **invasieve soort**?",
        options: ["Nieuwe soort die andere verdringt", "Bedreigde soort", "Grote soort", "Soort met veel pups"],
        answer: 0,
        wrongHints: [null, "Klopt — bv. Amerikaanse rivierkreeft in NL.", "Andersom — invasief is sterk.", "Niet noodzakelijk groot.", "Geen voortplanting-iets."],
      },
      {
        q: "Wat is **endemisch**?",
        options: ["Uniek voor 1 gebied (bv. panda voor China)", "Veel voorkomend", "Ziek", "Uitgestorven"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenovergesteld.", "Endemisch ≠ ziekte (al heet pandemic ook 'over de hele wereld').", "Endemisch betekent juist nog wél bestaan."],
      },
    ],
  },
