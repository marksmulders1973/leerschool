...
const steps = [
  ...
  // STAP 3: Vermenigvuldigen
  {
    ...
    checks: [
      ...
      },
      {
        ...
        options: ["2 (= 1 + 1)", "1", "0", "3"],
        answer: 0,
        wrongHints: [null, "Klopt — beide getallen hebben 1 cijfer ná de komma, samen 2.", "Te weinig — 0,5 én 0,2 hebben elk 1 decimaal.", "Allebei wél een komma — niet 0.", "Te veel — er zijn maar 2 decimalen in totaal."],
      },
    ],
  },
  ...
  // STAP 5: Praktijk
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Te veel — je moet 2,8 kg verdelen onder 4 kinderen. Krijgt iedereen dan meer of minder dan 2,8 kg?", "Te veel — controleer of je hebt gedeeld of vermenigvuldigd.", "Komma 1 plaats te ver — controleer.", "Komma 1 plaats verkeerd."],
      },
    ],
  },
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "0,3 + 0,4 = ?", options: ["0,7","0,07","7","0,1"], answer: 0, wrongHints: [null,"Klopt.","Komma fout.","Niet — komma vergeten.","Niet."] },
      { q: "1,5 + 2,7 = ?", options: ["4,2","3,2","4,12","42"], answer: 0, wrongHints: [null,"Klopt — 0,5+0,7=1,2; 1+2+1=4 → 4,2.","Niet.","Niet zo schrijven.","Komma weg."] },
      { q: "5 − 0,3 = ?", options: ["4,7","4,3","5,3","53"], answer: 0, wrongHints: [null,"Klopt — 5,0−0,3.","Niet.","Niet — eraf, niet erbij.","Niet."] },
      { q: "0,2 × 5 = ?", options: ["1","10","0,1","0,7"], answer: 0, wrongHints: [null,"Klopt — 2×5=10, komma één links.","Komma vergeten.","Niet.","Niet."] },
      { q: "Welke is groter: 0,5 of 0,15?", options: ["0,5","0,15","Gelijk","Niet te zeggen"], answer: 0, wrongHints: [null,"Klopt — 0,5 = 0,50 > 0,15.","Niet — 'meer cijfers' ≠ groter.","Niet.","Wel — vergelijken."] },
      { q: "Schrijf ½ als kommagetal", options: ["0,5","0,2","0,1","0,05"], answer: 0, wrongHints: [null,"Klopt — helft.","Dat is ⅕.","Dat is ¹⁄₁₀.","Dat is ¹⁄₂₀."] },
      { q: "1,25 € + 0,75 € = ?", options: ["2,00 €","1,50","2,25","20,00"], answer: 0, wrongHints: [null,"Klopt — netjes €2.","Niet.","Niet.","Komma weg."] },
      { q: "Rond 7,38 af op één decimaal", options: ["7,4","7,3","7,0","8,0"], answer: 0, wrongHints: [null,"Klopt — 8 ≥ 5.","Niet — 8 ≥ 5.","Te ver.","Te ver."] },
      { q: "0,8 × 10 = ?", options: ["8","80","0,08","0,8"], answer: 0, wrongHints: [null,"Klopt — komma rechts.","Te veel.","Andersom.","Niet veranderd."] },
      { q: "Welke is kleinst: 0,4 / 0,04 / 0,44 / 0,4?", options: ["0,04","0,4","0,44","Gelijk"], answer: 0, wrongHints: [null,"Klopt — hundste.","Tiende.","Groter.","Niet — andere getallen."] },
      { q: "1,75 = welke breuk?", options: ["1¾","1¼","1⅓","1⅖"], answer: 0, wrongHints: [null,"Klopt — 0,75 = ¾.","Dat is 1,25.","≈ 1,33.","≈ 1,4."] },
      { q: "10,5 ÷ 5 = ?", options: ["2,1","2,5","21","5,5"], answer: 0, wrongHints: [null,"Klopt — 10÷5 = 2; 0,5÷5 = 0,1 → 2,1.","Niet.","Komma weg.","Niet."] },
      { q: "Welke is **gelijk** aan 0,25?", options: ["¼","½","⅛","⅓"], answer: 0, wrongHints: [null,"Klopt — kwart.","Dat is 0,5.","Dat is 0,125.","≈ 0,33."] },
    ],
  },
];
