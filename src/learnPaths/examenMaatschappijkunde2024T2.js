    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "Parlement heeft gestemd = beslissing genomen = beleidsbepaling = fase 3.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "Een eigen NIEUWE wet voorstellen = recht van initiatief.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Partijen in college B en W.",
            simpeler: "Coalitiepartijen in gemeente = partijen die samen wethouders leveren in college van B en W.",
            nogSimpeler: "B en W",
          },
        },
      },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            ...
            simpeler: "'Terug in samenleving brengen' = resocialisatie.",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Strafeis.",
            simpeler: "Requisitoir = redevoering officier met de strafeis erin.",
