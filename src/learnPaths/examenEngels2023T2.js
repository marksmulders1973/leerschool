...
const steps = [
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 4: **'statute of limitations on the burglary has expired'** + 'suspect is unlikely to be extradited to Germany' = geen proces (trial) voor de inbraak. Verjaring = no trial.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Tekst-als-geheel: alle 24 rooms zijn 'designed for the perfect selfie' + 'creative selfies' (alinea 2). Selfies = kernconcept van het museum.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 1 schetst het hele begin-verhaal: kart op 8e verjaardag → Lucas Oil Pro series → kampioen → eerste vrouw met titel. Dit is de **opstart van haar carrière**.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 1: **'pupils regularly exceeded a 70-decibel limit'** + 'official readings reached 88 decibels'. Speelplaats dicht wegens te veel geluid (88 dB > 70 dB norm).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 2: **'It is still unclear whether this extraordinary communication ... is intended to repel rivals, attract a mate or achieve something else.'** = reden onduidelijk = mysterie. Andere opties: louder = niet in tekst; inaudible = onjuist (wel hoorbaar, op grens); chase away animals = niet in tekst.",
