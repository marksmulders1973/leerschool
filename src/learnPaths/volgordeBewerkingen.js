    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "14. A.", simpeler: "× eerst: 3×4=12. Dan +: 2+12=14.", nogSimpeler: "14" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vermenigvuldigen. A.", simpeler: "× is sterker dan +. Doe altijd eerst de × in een som met beide.", nogSimpeler: "×" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "23. A.", simpeler: "5×4=20, +3=23. (Niet 5+3 of 4+3 ipv ×).", nogSimpeler: "23" },
        },
      },
      {
        q: "**12 − 6 ÷ 3** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "10. A.", simpeler: "÷ eerst: 6÷3=2. Dan -: 12-2=10.", nogSimpeler: "10" },
        },
      },
      {
        q: "**6 × 2 + 4 × 3** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "24. A.", simpeler: "Twee maal-stukken eerst: 6×2=12, 4×3=12. Som: 24.", nogSimpeler: "24" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "30. A.", simpeler: "Haakjes eerst: 4+6=10. Dan ×3=30.", nogSimpeler: "30" },
        },
      },
      {
        q: "**3 × (4 + 2) − 1** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "17. A.", simpeler: "(4+2)=6. 3×6=18. 18-1=17.", nogSimpeler: "17" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Binnenste eerst. A.", simpeler: "Bij haakjes-in-haakjes: doe altijd eerst de binnenste, daarna buitenste.", nogSimpeler: "Binnen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9. A.", simpeler: "3² = 3×3 = 9 (NIET 3+3 of 3×2).", nogSimpeler: "9" },
        },
      },
      {
        q: "**2³** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8. A.", simpeler: "2³ = 2×2×2 = 4×2 = 8.", nogSimpeler: "8" },
        },
      },
      {
        q: "**4 + 5²** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "29. A.", simpeler: "5² = 25 (eerst). Dan 4+25 = 29.", nogSimpeler: "29" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7. A.", simpeler: "÷ eerst: 4÷2=2. Som = 8-2+1 = 7.", nogSimpeler: "7" },
        },
      },
      {
        q: "**(2 + 3)² − 5** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "20. A.", simpeler: "Haakjes 2+3=5. Macht 5²=25. -5 = 20.", nogSimpeler: "20" },
        },
      },
      {
        q: "**3 × 2² + 4** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "16. A.", simpeler: "2² eerst = 4. 3×4 = 12. +4 = 16.", nogSimpeler: "16" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "24. A.", simpeler: "Haakjes:1+2=3. Dan 18÷3=6. Dan 6×4=24.", nogSimpeler: "24" },
        },
      },
      {
        q: "**2 × (4 + 3²)** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "26. A.", simpeler: "Binnen haakjes: 3²=9, 4+9=13. Dan 2×13=26.", nogSimpeler: "26" },
        },
      },
      {
        q: "**(5 + 1)² − 4 × 3** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "24. A.", simpeler: "(5+1)²=36. 4×3=12. 36-12=24.", nogSimpeler: "24" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "11. A.", simpeler: "× eerst: 4×2=8. Dan 3+8=11.", nogSimpeler: "11" },
        },
      },
      {
        q: "**(6 − 2) × 5** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "20. A.", simpeler: "(6-2)=4. 4×5=20.", nogSimpeler: "20" },
        },
      },
      {
        q: "**5²** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "25. A.", simpeler: "5² = 5×5 = 25. (Niet 5+5=10, niet 5×2=10).", nogSimpeler: "25" },
        },
      },
      {
        q: "**12 ÷ 4 + 3 × 2** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9. A.", simpeler: "12÷4=3. 3×2=6. 3+6=9.", nogSimpeler: "9" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "× (vermenigvuldigen). A.", simpeler: "× en ÷ zijn sterker dan + en −. Optie A correct.", nogSimpeler: "×" },
        },
      },
