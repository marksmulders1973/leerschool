...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Bereken: 12 − 6 ÷ 2 = ?", options: ["9","3","6","2"], answer: 0, wrongHints: [null, "Niet — −6 dan ÷2 = 3, klopt niet.", null, null] },
      ...
      { q: "Bereken: 3² × 2 = ?", options: ["18","12","9","6"], answer: 0, wrongHints: [null, "Niet — 3²=9, niet 6.", "Macht.", null] },
