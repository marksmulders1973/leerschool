    ...
    checks: [
      {
        ...
        options: ["9","6","5","12"],
        answer: 0,
        wrongHints: [null,"Niet 3×2 — een macht is herhaald vermenigvuldigen.","Niet 3+3 — dat is optellen, geen macht.","Het kleine getal zegt hoe vaak je het grote getal met zichzelf vermenigvuldigt."],
        uitlegPad: {
    ...
    checks: [
      {
        ...
        options: ["7","3","5","9"],
        answer: 0,
        wrongHints: [null,"Rekende je van links naar rechts? De ÷ is sterker dan − en gaat éérst.","Hoort de +1 bij de deling? Alleen 4÷2 is één stukje — de rest gaat gewoon van links naar rechts.","Kijk nog eens goed naar de tekens: waar staat de − en waar de +?"],
        uitlegPad: {
