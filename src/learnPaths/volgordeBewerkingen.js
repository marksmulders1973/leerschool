...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Bereken: 5 × (3 + 4) = ?", options: ["35","19","27","9"], answer: 0, wrongHints: [null,"Klopt — haakjes eerst.","Niet — haakjes prioriteit.","Niet.","Niet."] },
      { q: "Bereken: 100 − 30 × 2 = ?", options: ["40","140","70","60"], answer: 0, wrongHints: [null,"Klopt — × eerst, dan −.","Niet — × eerst.","Niet.","Niet."] },
      { q: "Bereken: (10 + 5) × 2 = ?", options: ["30","25","15","20"], answer: 0, wrongHints: [null,"Klopt — haakjes 15, ×2.","Niet — haakjes eerst.","Niet.","Niet."] },
      { q: "Bereken: 18 ÷ (6 − 3) = ?", options: ["6","3","18","2"], answer: 0, wrongHints: [null,"Klopt — haakjes 3, dan 18÷3.","Niet — niet zonder haakjes.","Niet.","Niet."] },
      { q: "Bereken: 4 × 3 − 5 = ?", options: ["7","2","17","12"], answer: 0, wrongHints: [null,"Klopt — × eerst.","Niet.","Niet — geen +.","Vergeet −5."] },
      { q: "Bereken: 8 + 4 ÷ 2 = ?", options: ["10","6","12","16"], answer: 0, wrongHints: [null,"Klopt — ÷ eerst.","Niet — ÷ eerst.","Te veel.","Niet."] },
      { q: "Welke bewerking is **sterkste** (eerst doen)?", options: ["Haakjes","Optellen","Aftrekken","Vermenigvuldigen"], answer: 0, wrongHints: [null,"Klopt — H in HMVDOA.","Zwakst.","Zwakst.","Sterker dan +/−, niet sterkst."] },
      { q: "Bereken: 6² + 3 = ?", options: ["39","15","36","9"], answer: 0, wrongHints: [null,"Klopt — macht eerst, dan +.","Niet — 6² niet 6×3.","Niet — vergeet +3.","Niet."] },
      { q: "Bereken: 2 + 3 × 4 − 1 = ?", options: ["13","19","5","11"], answer: 0, wrongHints: [null,"Klopt — × eerst (12), dan +/−.","Niet — niet eerst optellen.","Niet.","Niet — vergeet niet 3."] },
      { q: "Wat staat de **H** in HMVDOA voor?", options: ["Haakjes","Hard","Half","Honderdtal"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet."] },
      { q: "Bereken: 5 + (8 − 3) × 2 = ?", options: ["15","16","26","13"], answer: 0, wrongHints: [null,"Klopt — haakjes 5, ×2=10, +5.","Niet.","Te veel.","Niet."] },
      { q: "Bereken: 20 ÷ 4 × 2 = ?", options: ["10","2,5","160","5"], answer: 0, wrongHints: [null,"Klopt — links naar rechts: 5×2.","Niet — niet ÷ laatste.","Te veel.","20÷8."] },
      { q: "Bereken: 3² × 2 = ?", options: ["18","12","9","6"], answer: 0, wrongHints: [null,"Klopt — macht 9, ×2.","Niet — 3²=9, niet 6.","Macht.","Niet."] },
      { q: "Welke is **gelijkwaardig**: × en ÷ of + en −?", options: ["Beide paren onderling gelijk","Niet relevant","× sterker dan ÷","+ sterker dan −"], answer: 0, wrongHints: [null,"Klopt — links→rechts binnen niveau.","Wel.","Niet.","Niet."] },
      { q: "Bereken: (4 + 2) × (3 − 1) = ?", options: ["12","7","10","20"], answer: 0, wrongHints: [null,"Klopt — beide haakjes eerst: 6×2.","Niet.","Niet.","Niet."] },
    ],
  },
];
