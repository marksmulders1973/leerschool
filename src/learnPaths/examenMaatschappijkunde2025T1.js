...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "**Recht van initiatief** = Kamerleden mogen ZELF nieuwe wetsvoorstellen indienen (i.p.v. dat dit alleen via de regering loopt). D66+GroenLinks dienden zelf een Thuiswerkwet in via initiatiefrecht.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Requisitoir** = het deel van de rechtszitting waarin de officier van justitie zijn EIS uitspreekt (vaak: feitelijke uiteenzetting + strafmaat-eis). Volgorde: 1) tenlastelegging 2) onderzoek/verhoor 3) requisitoir (OvJ) 4) pleidooi (advocaat) 5) vonnis (rechter).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Bindingstheorie** (Hirschi): wie sterke BANDEN heeft met familie/werk/school/maatschappij komt minder snel in de criminaliteit. Vadervleugel versterkt vader-kind-band → minder recidive.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Legaliteitsbeginsel** = NULLA POENA SINE LEGE = geen straf zonder wet. Als ontsnappen niet expliciet als strafbaar feit in de wet staat, kan iemand er niet voor gestraft worden. Een fundamenteel rechtsstaat-principe.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Framingtheorie**: media kiezen een INVALSHOEK (frame) waardoor publiek het onderwerp op die manier ziet. Vapen als 'cool' framen = positief frame. AGENDA-theorie = media bepalen WAAR over wordt gesproken (niet HOE). INJECTIENAALD = ouder model, direct effect (achterhaald).",
