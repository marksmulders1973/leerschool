...
<text x="200" y="168" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">elke stap netjes</text>
    ...
    checks: [
      ...
      },
      {
        ...
        wrongHints: [
          null,
          "Je hebt gedeeld door 2, maar je zoekt de vierkantswortel — niet hetzelfde.",
          "Je hebt gekwadrateerd, maar je zoekt juist de omgekeerde bewerking.",
          "Probeer: welk getal maal zichzelf geeft 289?",
        ],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Je hebt de zijden rechtstreeks afgetrokken — maar Pythagoras werkt met kwadraten.",
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Alleen het grondvlak meegerekend — voeg ook de derde afmeting toe.",
          "Slechts één afmeting gekwadrateerd — alle drie de afmetingen tellen mee.",
          "Vermenigvuldigd in plaats van opgeteld — gebruik het +-teken tussen de kwadraten.",
        ],
      },
    ],
  },
