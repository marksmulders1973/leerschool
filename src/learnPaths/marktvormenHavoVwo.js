    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Qd ↓, Qs ↑.", simpeler: "Duur = minder kopers, meer verkopers.", nogSimpeler: "Qd↓Qs↑" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Inelastisch.", simpeler: "Moet kopen, dus prijs maakt weinig uit voor vraag.", nogSimpeler: "Inelastisch" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Margarine-vraag stijgt.", simpeler: "Boter duurder = mensen kopen margarine.", nogSimpeler: "Margarine↑" },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Veel kleinen, identiek.", simpeler: "Veel aanbieders met zelfde product.", nogSimpeler: "Volkomen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hoge barrières.", simpeler: "Anderen kunnen niet erbij komen.", nogSimpeler: "Barrières" },
        },
      },
      {
        q: "Een **kartel** is:",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Negatieve externaliteit.", simpeler: "Schade aan anderen niet ingeprijsd.", nogSimpeler: "Externaliteit" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Leger = collectief.", simpeler: "Iedereen profiteert ongeacht betaling.", nogSimpeler: "Leger" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Asymmetrische info.", simpeler: "Verkoper weet meer dan koper.", nogSimpeler: "Lemons" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Baten voor derden.", simpeler: "Anderen profiteren ongevraagd.", nogSimpeler: "Positief" },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Inflatie ↓, werkloosheid ↑ mogelijk.", simpeler: "Duurder lenen remt economie.", nogSimpeler: "Remt" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3%.", simpeler: "Tekort max 3% BBP.", nogSimpeler: "3" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0 = gelijkheid.", simpeler: "Hoe lager Gini, hoe gelijker.", nogSimpeler: "0" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~0,30.", simpeler: "NL relatief gelijk na herverdeling.", nogSimpeler: "0,30" },
        },
      },
      {
