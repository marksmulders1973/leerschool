    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(0,0).", simpeler: "Oorsprong = (0,0).", nogSimpeler: "(0,0)" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "-3.", simpeler: "3 stappen links = -3 op x-as.", nogSimpeler: "-3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(5,2).", simpeler: "5 rechts en 2 omhoog = (5,2). x eerst!", nogSimpeler: "(5,2)" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Linksonder.", simpeler: "Beide min = links + omlaag = linksonder.", nogSimpeler: "Linksonder" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "II (-,+).", simpeler: "(-3,4) heeft (-,+) = kwadrant II (linksboven).", nogSimpeler: "II" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "IV (+,-).", simpeler: "(6,-2) heeft (+,-) = kwadrant IV.", nogSimpeler: "IV" },
        },
      },
      {
        q: "*Het punt (0, 5) ligt:*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Op y-as.", simpeler: "(0,5): x=0 → op y-as, geen kwadrant.", nogSimpeler: "Y-as" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Dalend.", simpeler: "Linksboven → rechtsonder = lijn daalt.", nogSimpeler: "Dalend" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ja, constant +3.", simpeler: "0,3,6,9 stijgt elke stap +3 → rechte lijn.", nogSimpeler: "Ja" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "III (-,-).", simpeler: "(-2,-7) heeft (-,-) → kwadrant III.", nogSimpeler: "III" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Op x-as.", simpeler: "(4,0): y=0 → op x-as, 4 rechts.", nogSimpeler: "X-as" },
        },
      },
      {
