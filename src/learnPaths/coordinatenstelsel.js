...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">basis voor alle grafieken 🏆</text>
    ...
    checks: [
      ...
      { q: "Punt (3, 5) ligt in welk **kwadrant**?", options: ["I (rechtsboven)","II (linksboven)","III (linksonder)","IV (rechtsonder)"], answer: 0, wrongHints: [null,"Klopt — beide positief.","Niet — x is +.","Niet — beide +.","Niet — y is +."] },
      { q: "Welk punt ligt op de **x-as**?", options: ["(4, 0)","(0, 4)","(4, 4)","(−1, 2)"], answer: 0, wrongHints: [null,"Klopt — y=0 = op x-as.","Dat is y-as.","Niet — beide niet 0.","Niet — geen 0."] },
      { q: "Welk punt is de **oorsprong**?", options: ["(0, 0)","(1, 1)","(0, 1)","(−1, 0)"], answer: 0, wrongHints: [null,"Klopt — kruispunt assen.","Niet.","Niet.","Niet."] },
      { q: "Punt (−2, −3) ligt in welk kwadrant?", options: ["III (linksonder)","I","II","IV"], answer: 0, wrongHints: [null,"Klopt — beide negatief.","Niet — beide +.","Niet — y negatief.","Niet — x negatief."] },
      { q: "Welk punt ligt op de **y-as**?", options: ["(0, 7)","(7, 0)","(7, 7)","(1, 2)"], answer: 0, wrongHints: [null,"Klopt — x=0.","X-as.","Niet.","Niet."] },
      { q: "Welk punt ligt op lijn y = 2x?", options: ["(3, 6)","(2, 3)","(6, 3)","(1, 3)"], answer: 0, wrongHints: [null,"Klopt — 2×3=6.","Niet — invullen y=2×2=4.","Niet — andersom.","Niet — y moet 2."] },
      { q: "**Helling** = verandering in y per verandering in x. Van (0,1) naar (3,7) is helling?", options: ["2","1/2","3","6"], answer: 0, wrongHints: [null,"Klopt — Δy/Δx = 6/3 = 2.","Andersom.","Verschil x.","Verschil y."] },
    ],
  },
];
