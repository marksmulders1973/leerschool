    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x-as. A.", simpeler: "Horizontaal = x-as.", nogSimpeler: "x" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(0,0). A.", simpeler: "Oorsprong = (0,0).", nogSimpeler: "(0,0)" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "-3. A.", simpeler: "3 stappen links = -3 op x-as.", nogSimpeler: "-3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(5,2). A.", simpeler: "5 rechts en 2 omhoog = (5,2). x eerst!", nogSimpeler: "(5,2)" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3 rechts + 2 omlaag. A.", simpeler: "(3,-2): x=+3 rechts, y=-2 omlaag.", nogSimpeler: "3r 2o" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Linksonder. A.", simpeler: "Beide min = links + omlaag = linksonder.", nogSimpeler: "Linksonder" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tegen klok. A.", simpeler: "I→II→III→IV tegen de klok in (rechtsboven start).", nogSimpeler: "Tegen klok" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "II (-,+). A.", simpeler: "(-3,4) heeft (-,+) = kwadrant II (linksboven).", nogSimpeler: "II" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "IV (+,-). A.", simpeler: "(6,-2) heeft (+,-) = kwadrant IV.", nogSimpeler: "IV" },
        },
      },
      {
        q: "*Het punt (0, 5) ligt:*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Op y-as. A.", simpeler: "(0,5): x=0 → op y-as, geen kwadrant.", nogSimpeler: "Y-as" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Dalend. A.", simpeler: "Linksboven → rechtsonder = lijn daalt.", nogSimpeler: "Dalend" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Collineair. A.", simpeler: "3 punten op één lijn = collineair.", nogSimpeler: "Collineair" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ja, constant +3. A.", simpeler: "0,3,6,9 stijgt elke stap +3 → rechte lijn.", nogSimpeler: "Ja" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "X-as. A.", simpeler: "Letter B in Battleship = kolom = x-as.", nogSimpeler: "X" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "III (-,-). A.", simpeler: "(-2,-7) heeft (-,-) → kwadrant III.", nogSimpeler: "III" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Op x-as. A.", simpeler: "(4,0): y=0 → op x-as, 4 rechts.", nogSimpeler: "X-as" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ja, constant. A.", simpeler: "Y-verschillen constant (+4) → rechte lijn.", nogSimpeler: "Ja" },
        },
      },
