...
const chapters = [
  ...
  // FIX 2026-06-12: stond op to:13 maar er zijn 13 stappen (index 0-12) —
  // path.steps[13] was undefined en crashte de overview ("reading 'title'").
  { letter: "E", title: "Eindopdracht", emoji: "🏆", from: 11, to: 12 },
];
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "64. A.", simpeler: "4·4·4 = 64.", nogSimpeler: "64" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vijf kwadraat. A.", simpeler: "5² = vijf in het kwadraat.", nogSimpeler: "Kwadraat" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1. A.", simpeler: "Elk getal⁰ = 1.", nogSimpeler: "1" },
        },
      },
      {
        q: "*Wat is (-3)²?*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9. A.", simpeler: "(-3)² = (-3)·(-3) = 9.", nogSimpeler: "9" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "11. A.", simpeler: "3²=9, 2+9=11.", nogSimpeler: "11" },
        },
      },
      {
        q: "*Wat is (3 + 1)² · 2?*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "32. A.", simpeler: "4² · 2 = 16·2 = 32.", nogSimpeler: "32" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x¹⁰. A.", simpeler: "x⁴·x⁶ = x^(4+6) = x¹⁰.", nogSimpeler: "x¹⁰" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y⁵. A.", simpeler: "y⁸/y³ = y^(8-3) = y⁵.", nogSimpeler: "y⁵" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x¹⁰. A.", simpeler: "(x²)⁵ = x^(2·5) = x¹⁰.", nogSimpeler: "x¹⁰" },
        },
      },
      {
        q: "*Versimpel: 2³ · 2⁴.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2⁷. A.", simpeler: "Exponenten optellen: 3+4=7.", nogSimpeler: "2⁷" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9x². A.", simpeler: "(3x)² = 9·x² = 9x².", nogSimpeler: "9x²" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9/16. A.", simpeler: "(3/4)² = 9/16.", nogSimpeler: "9/16" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1/4. A.", simpeler: "4⁻¹ = 1/4.", nogSimpeler: "1/4" },
        },
      },
      {
        q: "*Versimpel: x³ · x⁻⁵.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x⁻². A.", simpeler: "x^(3−5) = x⁻².", nogSimpeler: "x⁻²" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "100.000. A.", simpeler: "10⁵ = 1 met 5 nullen = 100.000.", nogSimpeler: "100k" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4,5·10⁴. A.", simpeler: "45.000 → 4,5·10⁴ (komma 4 plekken).", nogSimpeler: "4,5·10⁴" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "a⁴. A.", simpeler: "5+2−3 = 4. a⁴.", nogSimpeler: "a⁴" },
        },
      },
      {
        q: "*Versimpel: (2x²)³.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8x⁶. A.", simpeler: "2³·x⁶ = 8x⁶.", nogSimpeler: "8x⁶" },
        },
      },
      {
        q: "*Wat is 3⁻²?*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1/9. A.", simpeler: "3⁻² = 1/3² = 1/9.", nogSimpeler: "1/9" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6,7·10⁻⁴. A.", simpeler: "0,00067 → 6,7 · 10⁻⁴.", nogSimpeler: "6,7·10⁻⁴" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x²/3. A.", simpeler: "(9x⁸)/(27x⁶) = x²/3.", nogSimpeler: "x²/3" },
        },
      },
      {
        q: "*Wat is (2 · 10³) · (4 · 10⁵)?*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8·10⁸. A.", simpeler: "2·4=8. 10³·10⁵=10⁸. Antwoord 8·10⁸.", nogSimpeler: "8·10⁸" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2⁻⁴. A.", simpeler: "1/16 = 1/2⁴ = 2⁻⁴.", nogSimpeler: "2⁻⁴" },
        },
      },
      {
        q: "*Versimpel: (a²b³)⁴.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "a⁸b¹². A.", simpeler: "(a²)⁴ = a⁸, (b³)⁴ = b¹². Antwoord a⁸b¹²", nogSimpeler: "a⁸b¹²" },
        },
      },
      ...
      { q: "10³ = ?", options: ["1000","30","100","10000"], answer: 0, wrongHints: [null,"Niet — 10×10×10.","Te laag.","Te hoog."] },
      { q: "**Open vraag**: bereken 4². Typ getal.", kind: "open", acceptedAnswers: ["16"], numericTolerance: 0, explanation: "4 × 4 = 16." },
      { q: "**Open vraag**: bereken 2⁵. Typ getal.", kind: "open", acceptedAnswers: ["32"], numericTolerance: 0, explanation: "2 × 2 × 2 × 2 × 2 = 32." },
    ],
  },
];
