    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "64.", simpeler: "4·4·4 = 64.", nogSimpeler: "64" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vijf kwadraat.", simpeler: "5² = vijf in het kwadraat.", nogSimpeler: "Kwadraat" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1.", simpeler: "Elk getal⁰ = 1.", nogSimpeler: "1" },
        },
      },
      {
        q: "*Wat is (-3)²?*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9.", simpeler: "(-3)² = (-3)·(-3) = 9.", nogSimpeler: "9" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "11.", simpeler: "3²=9, 2+9=11.", nogSimpeler: "11" },
        },
      },
      {
        q: "*Wat is (3 + 1)² · 2?*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "32.", simpeler: "4² · 2 = 16·2 = 32.", nogSimpeler: "32" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x¹⁰.", simpeler: "x⁴·x⁶ = x^(4+6) = x¹⁰.", nogSimpeler: "x¹⁰" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y⁵.", simpeler: "y⁸/y³ = y^(8-3) = y⁵.", nogSimpeler: "y⁵" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x¹⁰.", simpeler: "(x²)⁵ = x^(2·5) = x¹⁰.", nogSimpeler: "x¹⁰" },
        },
      },
      {
        q: "*Versimpel: 2³ · 2⁴.*",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9x².", simpeler: "(3x)² = 9·x² = 9x².", nogSimpeler: "9x²" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "9/16.", simpeler: "(3/4)² = 9/16.", nogSimpeler: "9/16" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1/4.", simpeler: "4⁻¹ = 1/4.", nogSimpeler: "1/4" },
        },
      },
      {
        q: "*Versimpel: x³ · x⁻⁵.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x⁻².", simpeler: "x^(3−5) = x⁻².", nogSimpeler: "x⁻²" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4,5·10⁴.", simpeler: "45.000 → 4,5·10⁴ (komma 4 plekken).", nogSimpeler: "4,5·10⁴" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "a⁴.", simpeler: "5+2−3 = 4. a⁴.", nogSimpeler: "a⁴" },
        },
      },
      {
        q: "*Versimpel: (2x²)³.*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8x⁶.", simpeler: "2³·x⁶ = 8x⁶.", nogSimpeler: "8x⁶" },
        },
      },
      {
        q: "*Wat is 3⁻²?*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1/9.", simpeler: "3⁻² = 1/3² = 1/9.", nogSimpeler: "1/9" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6,7·10⁻⁴.", simpeler: "0,00067 → 6,7 · 10⁻⁴.", nogSimpeler: "6,7·10⁻⁴" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x²/3.", simpeler: "(9x⁸)/(27x⁶) = x²/3.", nogSimpeler: "x²/3" },
        },
      },
      {
        q: "*Wat is (2 · 10³) · (4 · 10⁵)?*",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "8·10⁸.", simpeler: "2·4=8. 10³·10⁵=10⁸. Antwoord 8·10⁸.", nogSimpeler: "8·10⁸" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2⁻⁴.", simpeler: "1/16 = 1/2⁴ = 2⁻⁴.", nogSimpeler: "2⁻⁴" },
        },
      },
      {
        q: "*Versimpel: (a²b³)⁴.*",
