...
const steps = [
...

  {
    ...
    checks: [
      ...
      { q: "Wat is een **synoniem**?", options: ["Woord met dezelfde betekenis","Tegengestelde","Lang woord","Klein woord"], answer: 0, wrongHints: [null,"Klopt.","Dat is antoniem.","Niet relevant.","Niet relevant."] },
      { q: "Wat is een **antoniem**?", options: ["Tegengestelde betekenis","Zelfde betekenis","Lang woord","Spreekwoord"], answer: 0, wrongHints: [null,"Klopt.","Synoniem.","Niet.","Niet."] },
      { q: "Synoniem van **snel**?", options: ["vlug","traag","stil","langzaam"], answer: 0, wrongHints: [null,"Klopt.","Antoniem.","Niets met snelheid.","Antoniem."] },
      { q: "Antoniem van **licht** (gewicht)?", options: ["zwaar","donker","helder","klein"], answer: 0, wrongHints: [null,"Klopt — gewicht.","Andere betekenis (licht = donker).","Synoniem helderheid.","Niet."] },
      { q: "Antoniem van **vol**?", options: ["leeg","gevuld","groot","klein"], answer: 0, wrongHints: [null,"Klopt.","Synoniem.","Niet.","Niet."] },
      { q: "Wat betekent **enthousiast**?", options: ["Vol energie en blij","Boos","Verdrietig","Verveeld"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Tegengestelde."] },
      { q: "*Context*: 'De vissers haalden de buit binnen.' Wat betekent 'buit'?", options: ["Vangst / gevonden spullen","Boot","Net","Water"], answer: 0, wrongHints: [null,"Klopt — wat gevangen is.","Niet.","Niet.","Niet."] },
      { q: "Synoniem van **mooi**?", options: ["prachtig","lelijk","slim","groot"], answer: 0, wrongHints: [null,"Klopt.","Antoniem.","Andere betekenis.","Niet."] },
      { q: "*Context*: 'Hij is een fanatiek voetballer.' Fanatiek =?", options: ["Heel toegewijd","Lui","Onverschillig","Bang"], answer: 0, wrongHints: [null,"Klopt — gepassioneerd.","Tegengestelde.","Tegengestelde.","Niet."] },
      { q: "Wat betekent **discreet**?", options: ["Stil + voorzichtig","Luid","Boos","Onzeker"], answer: 0, wrongHints: [null,"Klopt — niet opvallend.","Tegengestelde.","Niet.","Niet."] },
      { q: "Antoniem van **vroeg**?", options: ["laat","snel","wakker","nu"], answer: 0, wrongHints: [null,"Klopt.","Andere as.","Niet over tijd-startmoment.","Niet."] },
      { q: "**Verbazing** lijkt op?", options: ["verrassing","boosheid","verveling","angst"], answer: 0, wrongHints: [null,"Klopt — zelfde emotie.","Andere emotie.","Niet.","Niet."] },
      { q: "*Context*: 'Het was een schitterend feest.' Schitterend = ?", options: ["geweldig","saai","kort","duur"], answer: 0, wrongHints: [null,"Klopt — synoniem prachtig.","Tegengestelde.","Niet.","Niet."] },
      { q: "Wat betekent **respect** voor iemand hebben?", options: ["Waardering / achting","Boosheid","Onverschilligheid","Angst"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Tegengestelde.","Niet."] },
      { q: "Wat betekent **nieuwsgierig**?", options: ["Veel willen weten","Verveeld","Bang","Boos"], answer: 0, wrongHints: [null,"Klopt — wil meer weten.","Tegengestelde.","Niet.","Niet."] },
    ],
  },
];
