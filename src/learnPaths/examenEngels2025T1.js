    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Study impact. D.", simpeler: "Doel = onderzoeken hoe schadelijk microplastics zijn = study impact on people. = D.", nogSimpeler: "Doel = onderzoeken hoe schadelijk microplastics zijn = study impact on… → D." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Citaat A. A.", simpeler: "Citaat A noemt many types + weathering = uitlegt waarom onderzoek moeilijk is. B/C gaan over importance/scale. = A.", nogSimpeler: "Citaat A noemt many types + weathering = uitlegt waarom onderzoek moei… → A." },
        },
      },
    ],
  },
