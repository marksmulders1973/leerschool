    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Weinig kunstlicht.", simpeler: "UFO's mijden steden (veel licht) en gaan naar dunbevolkte gebieden (donker) → weinig kunstlicht.", nogSimpeler: "Donker" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Populair product.", simpeler: "Alinea 1 = e-scooters hebben grootste verkoop = populair. Andere opties (afford/bicycles/cheap) niet genoemd.", nogSimpeler: "Populair" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Buiten veiliger.", simpeler: "Binnen opladen = brand spreidt. Buiten opladen = veiliger (geen huis in brand).", nogSimpeler: "Buiten" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Technische uitleg.", simpeler: "Alinea 4 legt mechanisme thermal runaway uit (cel→cel ketting) = technische uitleg.", nogSimpeler: "Mechanisme" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Meanwhile.", simpeler: "Brandweer adviseert + waakhond onderzoekt = parallel/tegelijk = Meanwhile.", nogSimpeler: "Meanwhile" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Study impact.", simpeler: "Doel = onderzoeken hoe schadelijk microplastics zijn = study impact on people.", nogSimpeler: "Doel = onderzoeken hoe schadelijk microplastics zijn = study impact on… → D." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wat wordt onderzocht.", simpeler: "Alinea 3 = 2 projecten beschrijven die starten = uitleg wat onderzocht wordt.", nogSimpeler: "Wat onderzocht" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Citaat A.", simpeler: "Citaat A noemt many types + weathering = uitlegt waarom onderzoek moeilijk is. B/C gaan over importance/scale.", nogSimpeler: "Citaat A noemt many types + weathering = uitlegt waarom onderzoek moei… → A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Update over onderzoek.", simpeler: "Tekst = nieuws over nieuw onderzoekslab + projecten = informatief = update people.", nogSimpeler: "Update" },
        },
      },
    ],
  },
