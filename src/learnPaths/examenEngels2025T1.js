    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Weinig kunstlicht. B.", simpeler: "UFO's mijden steden (veel licht) en gaan naar dunbevolkte gebieden (donker) → weinig kunstlicht.", nogSimpeler: "Donker" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Populair product. B.", simpeler: "Alinea 1 = e-scooters hebben grootste verkoop = populair. Andere opties (afford/bicycles/cheap) niet genoemd.", nogSimpeler: "Populair" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Buiten veiliger. A.", simpeler: "Binnen opladen = brand spreidt. Buiten opladen = veiliger (geen huis in brand).", nogSimpeler: "Buiten" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Technische uitleg. A.", simpeler: "Alinea 4 legt mechanisme thermal runaway uit (cel→cel ketting) = technische uitleg.", nogSimpeler: "Mechanisme" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Meanwhile. B.", simpeler: "Brandweer adviseert + waakhond onderzoekt = parallel/tegelijk = Meanwhile.", nogSimpeler: "Meanwhile" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Study impact. D.", simpeler: "Doel = onderzoeken hoe schadelijk microplastics zijn = study impact on people.", nogSimpeler: "Doel = onderzoeken hoe schadelijk microplastics zijn = study impact on… → D." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wat wordt onderzocht. B.", simpeler: "Alinea 3 = 2 projecten beschrijven die starten = uitleg wat onderzocht wordt.", nogSimpeler: "Wat onderzocht" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Citaat A. A.", simpeler: "Citaat A noemt many types + weathering = uitlegt waarom onderzoek moeilijk is. B/C gaan over importance/scale.", nogSimpeler: "Citaat A noemt many types + weathering = uitlegt waarom onderzoek moei… → A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Update over onderzoek. C.", simpeler: "Tekst = nieuws over nieuw onderzoekslab + projecten = informatief = update people.", nogSimpeler: "Update" },
        },
      },
    ],
  },
