...
const steps = [
  // ─── A. Machten + wortels ─────────────────────────────────
  {
    ...
    explanation:
      "**Machtnotatie**: $a^n = a \\cdot a \\cdot \\ldots \\cdot a$ (n maal).\n• a = grondtal. n = exponent.\n• $2^3 = 8$. $5^2 = 25$. $10^4 = 10\\,000$.\n\n**Rekenregels** (PAD-formule):\n• $a^m \\cdot a^n = a^{m+n}$\n• $\\dfrac{a^m}{a^n} = a^{m-n}$\n• $(a^m)^n = a^{m \\cdot n}$\n• $(a \\cdot b)^n = a^n \\cdot b^n$\n• $\\left(\\dfrac{a}{b}\\right)^n = \\dfrac{a^n}{b^n}$\n\n**Speciale waarden**:\n• $a^0 = 1$ (voor $a \\neq 0$).\n• $a^1 = a$.\n• $a^{-n} = \\dfrac{1}{a^n}$\n• $a^{1/2} = \\sqrt{a}$\n• $a^{1/n} = \\sqrt[n]{a}$\n• $a^{m/n} = \\sqrt[n]{a^m}$\n\n**Negatieve grondtallen**: voorzichtig.\n• $(-2)^2 = 4$ (even macht: positief).\n• $(-2)^3 = -8$ (oneven macht: negatief).\n• $(-2)^{1/2} = \\sqrt{-2}$ = niet reëel (problematisch).\n\n**Wetenschappelijke notatie**:\n• $1{,}5 \\cdot 10^8 = 150\\,000\\,000$ (handig bij grote getallen).\n• $6{,}022 \\cdot 10^{23}$ (Avogadro).\n• $3{,}0 \\cdot 10^8$ m/s (lichtsnelheid).\n• $1{,}6 \\cdot 10^{-19}$ C (elektron-lading).\n\n**Vereenvoudig**:\n• $x^3 \\cdot x^5 = x^8$\n• $(x^2)^3 = x^6$\n• $\\dfrac{x^3}{x^5} = x^{-2} = \\dfrac{1}{x^2}$\n• $4^{1/2} = 2$\n• $8^{2/3} = \\sqrt[3]{8^2} = \\sqrt[3]{64} = 4$\n\n**Cito/CSE-tips**:\n• Alle wortels schrijven als gebroken macht voor uniformere rekenregels.\n• Negatieve exponent = omgekeerde.\n• Vereenvoudig altijd EERST voor je in formule stopt.",
    checks: [
      {
        q: "**2³ · 2⁴** = ?",
        options: ["2⁷", "2¹²", "4⁷", "16"],
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2.", simpeler: "³√8 = 2.", nogSimpeler: "2" },
        },
      },
      {
        q: "**a⁻² · a⁵** = ?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "a³.", simpeler: "-2 + 5 = 3, dus a³.", nogSimpeler: "a³" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(a^m)^n correct.", simpeler: "Macht-van-macht = m·n.", nogSimpeler: "(a^m)^n" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1,03.", simpeler: "100% + 3% = 1,03.", nogSimpeler: "1,03" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(½)⁴=6,25%.", simpeler: "4 halveringen = 6,25%.", nogSimpeler: "6,25" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Nadert 0.", simpeler: "Daalt naar nul.", nogSimpeler: "0" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2.", simpeler: "ln en e zijn omgekeerd.", nogSimpeler: "2" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "3.", simpeler: "Som log = log product.", nogSimpeler: "3" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5.", simpeler: "2^5=32.", nogSimpeler: "5" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "64×.", simpeler: "2 tot de 6e = 64.", nogSimpeler: "64" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Lage N.", simpeler: "Vroege fase exp, late vlak.", nogSimpeler: "Laag N" },
        },
      },
      {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "10.", simpeler: "7+3=10, ln(e^10)=10.", nogSimpeler: "10" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "16×.", simpeler: "2^4 = 16.", nogSimpeler: "16" },
        },
      },
    ],
  },
