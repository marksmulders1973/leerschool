...
const steps = [
  ...
  // ── Stap 5 — Cito-eindopdracht ──────────────────────────────────
  {
    ...
    checks: [
      ...
      { q: "Welke vraag stel je het eerst bij een tekst om de **structuur** te zien?", options: ["Hoeveel alinea's heeft de tekst?","Hoe lang is de tekst?","Wat is de kleur van het papier?","Wie heeft de tekst gedrukt?"], answer: 0, wrongHints: [null,"Klopt — alinea's = bouwstenen.","Lengte zegt niets over structuur.","Niet inhoudelijk.","Niet relevant."] },
      { q: "*'Veel kinderen kijken te veel TV.'* — welke tekstsoort past hierbij?", options: ["Betogend","Verhalend","Instructief","Recept"], answer: 0, wrongHints: [null,"Klopt — bevat mening 'te veel'.","Geen verhaal.","Geen stappen.","Geen recept."] },
      { q: "*'Eerst de pan opzetten, dan de boter erin.'* — welke tekstsoort?", options: ["Instructief","Betogend","Verhalend","Zakelijk"], answer: 0, wrongHints: [null,"Klopt — stappenplan.","Geen mening.","Geen verhaal.","Niet alleen feiten."] },
      { q: "Welke **alinea** geeft meestal de conclusie?", options: ["De laatste","De eerste","De middelste","Geen"], answer: 0, wrongHints: [null,"Klopt — kortom/concluderend.","Inleiding.","Kern, geen conclusie.","Wel — vaak in slot."] },
      { q: "Welke vraag is een **inferentievraag**?", options: ["Waarom zou de schrijver dit voorbeeld kiezen?","Hoeveel alinea's heeft de tekst?","Welk woord betekent X?","Hoe heet de schrijver?"], answer: 0, wrongHints: [null,"Klopt — vraagt om nadenken.","Telling.","Letterlijk.","Letterlijk."] },
      { q: "*'Dieren zijn slim, want ze leren snel.'* Welk woord signaleert de reden?", options: ["want","ze","leren","snel"], answer: 0, wrongHints: [null,"Klopt — reden-signaal.","Niet — verwijswoord.","Werkwoord.","Bijvoeglijk."] },
      { q: "Een **tekstdoel** wijst aan?", options: ["Waarom de tekst geschreven is","Hoe oud de tekst is","Het aantal woorden","De schrijver"], answer: 0, wrongHints: [null,"Klopt.","Niet relevant.","Niet doel.","Niet hetzelfde."] },
      { q: "Bij **woordbetekenis-vragen** kijk je naar?", options: ["De context (omringende zinnen)","De letters van het woord","Hoe het klinkt","De lengte"], answer: 0, wrongHints: [null,"Klopt — context geeft betekenis.","Soms helpt, maar context is sterker.","Niet relevant.","Niet relevant."] },
      { q: "Welk **soort vraag** is dit: 'Wat staat in regel 3?'", options: ["Letterlijk","Inferentie","Mening","Voorspelling"], answer: 0, wrongHints: [null,"Klopt — direct te vinden.","Inferentie vraagt nadenken.","Geen mening.","Niet voorspellen."] },
      { q: "*'Hoewel het regende, gingen ze door.'* Welk soort signaalwoord?", options: ["Tegenstelling","Reden","Opsomming","Conclusie"], answer: 0, wrongHints: [null,"Klopt — 'hoewel/ondanks'.","Niet — geen want.","Geen lijst.","Geen samenvatting."] },
      { q: "Wat is een **citaat** in een tekst?", options: ["Letterlijk overgenomen stukje (vaak met aanhalingstekens)","Eigen mening","Lange zin","De titel"], answer: 0, wrongHints: [null,"Klopt — door 'haakjes' herkend.","Niet — citaat = van iemand anders.","Niet relevant.","Niet."] },
      { q: "*'Volgens experts is de aarde steeds warmer.'* Welk woord toont een **bron**?", options: ["volgens","is","de","steeds"], answer: 0, wrongHints: [null,"Klopt — verwijst naar deskundigen.","Werkwoord.","Lidwoord.","Bijwoord."] },
      { q: "Welke alinea-functie heeft een **voorbeeld-alinea**?", options: ["Hoofdgedachte concreet maken","Mening geven","Nieuwe regel beginnen","Tellen"], answer: 0, wrongHints: [null,"Klopt — uitleg via case.","Mening = aparte rol.","Niet inhoudelijk.","Niet relevant."] },
      { q: "Welke tekst is meest **objectief**?", options: ["Encyclopedie","Reclame","Mening-column","Persoonlijke brief"], answer: 0, wrongHints: [null,"Klopt — feiten zonder kleuring.","Veel mening.","Mening = subjectief.","Persoonlijk = subjectief."] },
      { q: "*'Verbazingwekkend!'* — wat zegt het woord over de **toon**?", options: ["Verrassing/emotie","Neutraal","Verveling","Boosheid"], answer: 0, wrongHints: [null,"Klopt — uitroep + positief.","Niet — duidelijk emotie.","Tegenovergesteld.","Niet specifiek."] },
    ],
  },
];
