...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">je beheerst het 🎓</text>
    ...
    checks: [
      ...
      { q: "Wat is de **periode** van y = sin(x)?", options: ["2π (360°)","π","π/2","1"], answer: 0, wrongHints: [null,"Klopt — één volledige cyclus.","Halve cyclus.","Kwart cyclus.","Niet."] },
      { q: "Bij y = 3sin(x) — wat is **amplitude**?", options: ["3","1","6","0"], answer: 0, wrongHints: [null,"Klopt — uitwijking ten opzichte van evenwicht.","Dat is bij sin(x) zonder factor.","Niet — geen × 2.","Niet."] },
      { q: "Sin(0°) = ?", options: ["0","1","−1","½"], answer: 0, wrongHints: [null,"Klopt — start in oorsprong.","Dat is sin(90°).","Niet.","Niet."] },
      { q: "Cos(0°) = ?", options: ["1","0","−1","√2"], answer: 0, wrongHints: [null,"Klopt — start op maximum.","Dat is cos(90°).","Niet.","Niet."] },
      { q: "Bij y = sin(x) + 5 — wat is **evenwichtslijn**?", options: ["y = 5","y = 0","y = 1","x = 5"], answer: 0, wrongHints: [null,"Klopt — verschuift omhoog.","Dat is bij gewone sin(x).","Niet.","Niet — y-waarde."] },
    ],
  },
];
