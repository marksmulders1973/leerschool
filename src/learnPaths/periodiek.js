...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">je beheerst het 🎓</text>
    ...
    checks: [
      ...
      { q: "Wat is de **periode** van y = sin(x)?", options: ["2π (360°)","π","π/2","1"], answer: 0, wrongHints: [null, "Halve cyclus.", "Kwart cyclus.", "Niet."] },
      { q: "Bij y = 3sin(x) — wat is **amplitude**?", options: ["3","1","6","0"], answer: 0, wrongHints: [null, "Dat is bij sin(x) zonder factor.", "Niet — geen × 2.", "Niet."] },
      { q: "Sin(0°) = ?", options: ["0","1","−1","½"], answer: 0, wrongHints: [null, "Dat is sin(90°).", "Niet.", "Niet."] },
      { q: "Cos(0°) = ?", options: ["1","0","−1","√2"], answer: 0, wrongHints: [null, "Dat is cos(90°).", "Niet.", "Niet."] },
      ...
      { q: "Bij y = sin(x), welke is **maximum**?", options: ["+1","+2","0","∞"], answer: 0, wrongHints: [null,"Sin is begrensd op [−1,+1].","Minimum.","Niet."] },
      { q: "Bij y = sin(x), welke is **minimum**?", options: ["−1","0","−2","−∞"], answer: 0, wrongHints: [null,"Evenwicht.","Niet — begrensd.","Niet — begrensd."] },
      { q: "**Open vraag**: wat is de periode van y = sin(x) in graden?", kind: "open", acceptedAnswers: ["360", "360°", "360 graden", "2π"], explanation: "Sin(x) herhaalt elke 360° (= 2π radialen)." },
      { q: "**Open vraag**: amplitude van y = 5cos(x)?", kind: "open", acceptedAnswers: ["5"], numericTolerance: 0, explanation: "Coëfficiënt voor sin/cos = amplitude. Hier 5." },
    ],
  },
];
