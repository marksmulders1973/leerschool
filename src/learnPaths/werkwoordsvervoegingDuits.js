    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Dat is 'geben'.", "Dat is 'bleiben'.", "Dat is 'stoppen'."],
      },
      {
        q: "Welke Duitse woord betekent **'jij'**?",
        options: ["du", "ich", "er", "Sie"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Ik.", "Hij.", "Formeel u."],
      },
      {
        q: "Welk verschil tussen **'sie'** en **'Sie'**?",
        options: ["sie = zij, Sie = u (formeel)", "Geen verschil", "Verkeerd gespeld", "sie = man, Sie = vrouw"],
        answer: 0,
        wrongHints: [null, "Klopt — hoofdletter telt.", "Wel verschil.", "Beide correct.", "Niet."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — der Hund, das Buch.", "Niet automatisch.", "Niet automatisch.", "Soms (Sie = u)."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — ich + -e.", "Voor 'du'.", "Voor 'er/sie/es'.", "Voor 'wir/sie/Sie'."],
      },
      {
        q: "**er + lernen** → ?",
        options: ["er lernt", "er lerne", "er lernst", "er lernen"],
        answer: 0,
        wrongHints: [null, "Klopt — er + -t.", "Voor 'ich'.", "Voor 'du'.", "Voor 'wir'."],
      },
      {
        q: "**wir + gehen** → ?",
        options: ["wir gehen", "wir gehe", "wir geht", "wir gehst"],
        answer: 0,
        wrongHints: [null, "Klopt — wir + -en = infinitief.", "Voor ich.", "Voor er/ihr.", "Voor du."],
      },
      {
        q: "**du + arbeiten** → ?",
        options: ["du arbeitest", "du arbeitst", "du arbeite", "du arbeitt"],
        answer: 0,
        wrongHints: [null, "Klopt — tussen-e omdat stam op -t eindigt.", "Niet uit te spreken.", "Voor ich.", "Niet correct."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor er/sie/es.", "Niet vervoegd.", "Voor du."],
      },
      {
        q: "**du + haben** → ?",
        options: ["du hast", "du hat", "du habst", "du habt"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor er.", "Niet correct.", "Voor ihr."],
      },
      {
        q: "**er + fahren** → ?",
        options: ["er fährt", "er fahrt", "er fährst", "er fahren"],
        answer: 0,
        wrongHints: [null, "Klopt — a→ä bij er.", "Mist umlaut.", "Voor du.", "Voor wir."],
      },
      {
        q: "**du + sehen** → ?",
        options: ["du siehst", "du sehst", "du sieht", "du seht"],
        answer: 0,
        wrongHints: [null, "Klopt — e→ie.", "Mist verandering.", "Voor er.", "Voor ihr."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenwoordige tijd.", "Van haben.", "Van gehen."],
      },
      {
        q: "Präteritum van **'haben' (er)** = ?",
        options: ["hatte", "hat", "habe", "hattet"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenwoordig.", "Voor ich.", "Voor ihr."],
      },
      {
        q: "Präteritum van **'gehen' (wir)** = ?",
        options: ["gingen", "ging", "gehen", "gingt"],
        answer: 0,
        wrongHints: [null, "Klopt — meervoud + -en.", "Voor ich/er.", "Tegenwoordig.", "Voor ihr."],
      },
      {
        q: "Präteritum van **'spielen' (ich)** = ?",
        options: ["spielte", "spiele", "gespielt", "spielen"],
        answer: 0,
        wrongHints: [null, "Klopt — regelmatig.", "Tegenwoordig.", "Voltooid deelwoord.", "Infinitief."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — beweging.", "Niet voor beweging.", "Geen hulpwerkwoord hier.", "Geen hulpwerkwoord."],
      },
      {
        q: "Partizip II van **'spielen'** = ?",
        options: ["gespielt", "gespielen", "spielen", "spielte"],
        answer: 0,
        wrongHints: [null, "Klopt — regelmatig.", "Niet -en.", "Infinitief.", "Präteritum."],
      },
      {
        q: "**'Ich ___ gestern Fußball ___ .'** (Perfekt 'spielen')",
        options: ["habe ... gespielt", "bin ... gespielt", "habe ... spielen", "bin ... gegangen"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Spielen is haben, niet sein.", "Niet Partizip II.", "Verkeerd werkwoord."],
      },
      {
        q: "Partizip II van **'gehen'** = ?",
        options: ["gegangen", "gegehen", "gehen", "ging"],
        answer: 0,
        wrongHints: [null, "Klopt — onregelmatig.", "Spelling fout.", "Infinitief.", "Präteritum."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor ich.", "Voor er.", "Voor wir."],
      },
      {
        q: "**er + sein** → ?",
        options: ["er ist", "er bist", "er bin", "er sind"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Voor du.", "Voor ich.", "Voor wir/sie."],
      },
      {
        q: "Präteritum van **'gehen' (ich)** = ?",
        options: ["ich ging", "ich gehe", "ich gegangen", "ich gehst"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Tegenwoordig.", "Partizip II.", "Voor du."],
      },
      {
        q: "Partizip II van **'haben'** = ?",
        options: ["gehabt", "gehaben", "haben", "hatte"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet -en.", "Infinitief.", "Präteritum."],
      },
      {
        q: "**'Wir ___ ins Kino ___ .'** Perfekt 'gehen'.",
        options: ["sind ... gegangen", "haben ... gegangen", "sind ... gehen", "war ... gegangen"],
        answer: 0,
        wrongHints: [null, "Klopt — gehen = sein.", "Niet haben.", "Niet infinitief.", "Niet Präteritum + Partizip mix."],
      },
      {
        q: "**er + lesen** in Präsens → ?",
        options: ["er liest", "er lest", "er liesst", "er lesen"],
        answer: 0,
        wrongHints: [null, "Klopt — e→ie sterk werkwoord.", "Mist klinker-verandering.", "Spelling fout.", "Infinitief."],
      },
    ],
  },
];
