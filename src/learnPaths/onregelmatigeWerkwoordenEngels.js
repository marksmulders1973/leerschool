    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "go.", simpeler: "Go verandert vreemd.", nogSimpeler: "go." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "V3.", simpeler: "Na have = V3.", nogSimpeler: "V3." },
        },
      },
      {
        q: "Wat is V2 van **see**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "saw.", simpeler: "V2 = saw.", nogSimpeler: "saw." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "put.", simpeler: "Blijft put.", nogSimpeler: "put." },
        },
      },
      {
        q: "Welke zin is **goed**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "cut.", simpeler: "Yesterday + cut.", nogSimpeler: "cut." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "ran.", simpeler: "V2 = ran.", nogSimpeler: "ran." },
        },
      },
    ],
  },
