...
const steps = [
  ...
  // STAP 6: Cito-mix
  {
    ...
    checks: [
      ...
      { q: "Welke zin is **fout**?", options: ["mijn naam is anna.","Mijn naam is Anna.","Wat heet jij?","Hallo!"], answer: 0, wrongHints: [null, "Goed.", "Goed.", "Goed."] },
      ...
      { q: "Welke zin heeft een **fout vraagteken**?", options: ["Ik ga slapen?","Ga je mee?","Hoe heet je?","Waar is mijn boek?"], answer: 0, wrongHints: [null, "Echte vraag.", "Echte vraag.", "Echte vraag."] },
      { q: "Welke **hoofdletter** is fout?", options: ["Ik Eet brood","Ik eet brood","Ik eet brood.","Eet jij brood?"], answer: 0, wrongHints: [null, "Goed.", "Goed.", "Goed."] },
