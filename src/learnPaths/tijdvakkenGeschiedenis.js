    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Jagers en boeren.", simpeler: "Eerste tijdvak = jagers + boeren, prehistorie tot 3000 v.Chr.", nogSimpeler: "Jagers" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vast wonen + akkers.", simpeler: "Landbouwrevolutie = mensen stoppen met rondtrekken en gaan een vast huis bouwen + akkers bewerken.", nogSimpeler: "Vast wonen" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Athene.", simpeler: "Eerste democratie = Athene ~500 v.Chr. Mannen stemden zelf over wetten.", nogSimpeler: "Athene" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "476 Val Rome.", simpeler: "Tijdvak 2 (Grieken+Romeinen) eindigt in 476 met val West-Romeinse Rijk.", nogSimpeler: "476" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Land tegen bescherming.", simpeler: "Koning geeft land aan ridders, ridders beschermen koning. Hiërarchie.", nogSimpeler: "Land=bescherming" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ambacht-organisaties.", simpeler: "Gilde = club van vakgenoten (bakkers, smeden) die samen prijzen + kwaliteit regelden.", nogSimpeler: "Vakgenoten" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "95 stellingen 1517.", simpeler: "Luther plakte in 1517 95 protestbrieven op de kerkdeur. Begin Reformatie.", nogSimpeler: "Luther" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1568.", simpeler: "Tachtigjarige Oorlog: 1568-1648, NL tegen Spanje.", nogSimpeler: "1568" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1789.", simpeler: "Franse Revolutie = 1789, bestorming Bastille, volk tegen koning.", nogSimpeler: "1789" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tijdvak 5+6.", simpeler: "Tachtigjarige Oorlog 1568-1648 valt in tijdvak 5 (begin) + 6 (einde).", nogSimpeler: "5+6" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tijdvak 9.", simpeler: "Anne Frank leefde 1929-1945, midden in WO2. Dat is tijdvak 9.", nogSimpeler: "9" },
        },
      },
      {
