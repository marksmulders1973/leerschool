    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "10. A.", simpeler: "Nederlandse geschiedenis-canon = 10 tijdvakken.", nogSimpeler: "10" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Jagers en boeren. A.", simpeler: "Eerste tijdvak = jagers + boeren, prehistorie tot 3000 v.Chr.", nogSimpeler: "Jagers" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vast wonen + akkers. A.", simpeler: "Landbouwrevolutie = mensen stoppen met rondtrekken en gaan een vast huis bouwen + akkers bewerken.", nogSimpeler: "Vast wonen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Stenen graven tijdvak 1. A.", simpeler: "Hunebedden = stenen graven van ~5000 jaar geleden in Drenthe.", nogSimpeler: "Oude graven" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Athene. A.", simpeler: "Eerste democratie = Athene ~500 v.Chr. Mannen stemden zelf over wetten.", nogSimpeler: "Athene" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "476 Val Rome. A.", simpeler: "Tijdvak 2 (Grieken+Romeinen) eindigt in 476 met val West-Romeinse Rijk.", nogSimpeler: "476" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Land tegen bescherming. A.", simpeler: "Koning geeft land aan ridders, ridders beschermen koning. Hiërarchie.", nogSimpeler: "Land=bescherming" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Karel de Grote. A.", simpeler: "Karel de Grote werd in 800 tot keizer gekroond door de paus in Rome.", nogSimpeler: "Karel" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ambacht-organisaties. A.", simpeler: "Gilde = club van vakgenoten (bakkers, smeden) die samen prijzen + kwaliteit regelden.", nogSimpeler: "Vakgenoten" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Goedkoper + verspreid. A.", simpeler: "Boekdrukkunst (~1450) = boeken werden 100× goedkoper, iedereen kon leren lezen.", nogSimpeler: "Goedkoper" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "95 stellingen 1517. A.", simpeler: "Luther plakte in 1517 95 protestbrieven op de kerkdeur. Begin Reformatie.", nogSimpeler: "Luther" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1568. A.", simpeler: "Tachtigjarige Oorlog: 1568-1648, NL tegen Spanje.", nogSimpeler: "1568" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Handelscompagnie Azië. A.", simpeler: "VOC = NL-handelsbedrijf in specerijen uit Indonesië, 17e eeuw. Eerste multinational.", nogSimpeler: "Handel" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Franse zonnekoning. A.", simpeler: "Lodewijk XIV = absolute koning Frankrijk, 'Zonnekoning', paleis Versailles.", nogSimpeler: "Frans" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wetgevend+uitvoerend+rechter. A.", simpeler: "Trias politica = macht in 3 delen: wetten maken / uitvoeren / oordelen. Door Montesquieu.", nogSimpeler: "3 machten" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1789. A.", simpeler: "Franse Revolutie = 1789, bestorming Bastille, volk tegen koning.", nogSimpeler: "1789" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Fabrieken + treinen. A.", simpeler: "Stoommachine → eerste fabrieken + treinen + massaproductie.", nogSimpeler: "Fabrieken" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1848. A.", simpeler: "NL-grondwet kwam in 1848 — Thorbecke maakte 'm. Koning kreeg minder macht.", nogSimpeler: "1848" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Muur viel. A.", simpeler: "1989 = Berlijnse Muur viel, einde Koude Oorlog.", nogSimpeler: "Muur weg" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "VS vs USSR. A.", simpeler: "Koude Oorlog = spanning VS↔Sovjet-Unie zonder echt vechten. 1945-1989.", nogSimpeler: "VS en Rusland tegen elkaar" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tijdvak 5+6. A.", simpeler: "Tachtigjarige Oorlog 1568-1648 valt in tijdvak 5 (begin) + 6 (einde).", nogSimpeler: "5+6" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tijdvak 5. A.", simpeler: "Columbus 1492 valt in tijdvak 5 (Ontdekkers) omdat ontdekkingsreizen = kenmerk daar.", nogSimpeler: "5" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tijdvak 9. A.", simpeler: "Anne Frank leefde 1929-1945, midden in WO2. Dat is tijdvak 9.", nogSimpeler: "9" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tijdvak 10. A.", simpeler: "1989 = Muur valt = tijdvak 10 (Televisie+computer, 1950-nu).", nogSimpeler: "10" },
        },
      },
    ],
  },
