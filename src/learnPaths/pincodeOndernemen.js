    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Volkomen = open markt", tekst: "Volkomen concurrentie = VEEL aanbieders + VEEL vragers + identiek product. Niemand heeft macht over prijs — markt bepaalt." }],
          woorden: [{ woord: "volkomen concurrentie", uitleg: "Marktvorm met veel kleine spelers + identiek product. Prijs door markt bepaald." }],
          ...
          niveaus: { basis: "Veel aanbieders. A.", simpeler: "Volkomen concurrentie heeft veel verkopers van hetzelfde product. = A.", nogSimpeler: "Veel = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4 spelers = oligopolie. A.", simpeler: "Telecom heeft 4 grote spelers. Niet 1 (mono), niet 50 (veel) — dus oligopolie. = A.", nogSimpeler: "4 = oligo = A." },
        },
      },
      {
        q: "**Monopolie** kenmerk:",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1 aanbieder. A.", simpeler: "Monopolie = ÉÉN verkoper. Hij bepaalt prijs want klanten kunnen nergens anders heen. = A.", nogSimpeler: "1 = monopolie = A." },
        },
      },
      {
        q: "Wat doet de **ACM**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Bewaakt eerlijke markt. A.", simpeler: "ACM is de marktpolitie — voorkomt dat bedrijven samen prijzen te hoog maken. = A.", nogSimpeler: "Marktwaakhond = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Veel + verschillend", tekst: "Monopolistische concurrentie = veel aanbieders, maar elk met EIGEN merk/design. Nike-schoen ≠ Adidas-schoen al maken ze beide sportschoenen." }],
          woorden: [{ woord: "monopolistische concurrentie", uitleg: "Marktvorm: veel aanbieders + gedifferentieerd product (eigen merk/kwaliteit)." }, { woord: "differentiatie", uitleg: "Je product anders maken dan dat van concurrenten (merk, design, kwaliteit)." }],
          ...
          niveaus: { basis: "Veel + verschillend = mono. conc. A.", simpeler: "Veel kledingmerken die allemaal anders zijn = monopolistische concurrentie. = A.", nogSimpeler: "Veel + uniek = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Oligopolie. A.", simpeler: "Bij oligopolie (weinig grote spelers zoals telecom) verschillen prijzen genoeg om vergelijken €100+/jaar op te leveren. = A.", nogSimpeler: "Oligopolie = A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "BV = niet privé. A.", simpeler: "Alleen BV beschermt je privé-vermogen bij faillissement. Eenmanszaak + VOF niet. = A.", nogSimpeler: "BV = veilig = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Hoofdelijk aansprakelijk = voor de hele schuld", tekst: "Bij VOF zijn alle vennoten HOOFDELIJK aansprakelijk. Als jouw vennoot een grote schuld maakt, kunnen schuldeisers het GEHELE bedrag bij JOU komen halen — niet alleen jouw deel." }],
          woorden: [{ woord: "VOF", uitleg: "Vennootschap onder firma. 2+ vennoten, allen privé én hoofdelijk aansprakelijk." }, { woord: "hoofdelijk aansprakelijk", uitleg: "Schuldeiser kan voor de HELE schuld bij één persoon aankloppen, niet alleen voor zijn deel." }],
          ...
          niveaus: { basis: "Hoofdelijk privé aansprakelijk. A.", simpeler: "Bij VOF kan de schuld van JE PARTNER ook bij JOU terechtkomen. Dat is het grootste risico. = A.", nogSimpeler: "Schuld partner = jouw schuld = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "BV = VPB. A.", simpeler: "BV is een aparte 'persoon' en betaalt zijn eigen belasting: vennootschapsbelasting (VPB). = A.", nogSimpeler: "BV = VPB = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Eenmanszaak. A.", simpeler: "Alleen, lage kosten, snel beginnen = eenmanszaak. = A.", nogSimpeler: "Alleen + goedkoop = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "~€100k winst. A.", simpeler: "Onder €100k winst per jaar is eenmanszaak goedkoper. Erboven wordt BV beter. = A.", nogSimpeler: "€100k = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Juridisch een 'persoon'", tekst: "Rechtspersoon = juridisch een eigen entiteit. Heeft eigen bezit, eigen schulden, kan contracten sluiten in eigen naam — los van de eigenaars." }],
          woorden: [{ woord: "rechtspersoon", uitleg: "Juridische entiteit (BV, NV, stichting, vereniging) met eigen rechten en plichten." }, { woord: "natuurlijke persoon", uitleg: "Een mens van vlees en bloed. Heeft eigen rechten en plichten." }],
          ...
          niveaus: { basis: "Bedrijf als juridische persoon. A.", simpeler: "Een rechtspersoon is een BEDRIJF dat juridisch een eigen 'persoon' is — zoals een BV. = A.", nogSimpeler: "Bedrijf-als-persoon = A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Boodschappen = 9%. A.", simpeler: "Eten valt onder LAGE BTW = 9%. Niet 21% (algemeen). = A.", nogSimpeler: "Eten = 9% = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Tel 21% er bij op", tekst: "Inclusief BTW = excl + (excl × 21%). €100 + €100 × 0,21 = €100 + €21 = €121." }],
          woorden: [{ woord: "exclusief BTW", uitleg: "Prijs zonder BTW. Wat de verkoper zelf overhoudt vóór belasting." }, { woord: "inclusief BTW", uitleg: "Prijs MET BTW erbij. Wat klant uiteindelijk betaalt." }],
          ...
          niveaus: { basis: "€100 × 1,21 = €121. A.", simpeler: "€100 + 21% (= €21 BTW) = €121 totaal. = A.", nogSimpeler: "121 = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "121/1,21 = 100, BTW = 21. A.", simpeler: "Deel €121 door 1,21 = €100 excl. Verschil €21 = BTW. = A.", nogSimpeler: "€21 = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Wettelijke factuur-eisen", tekst: "Een factuur moet bevatten: jouw naam+adres+KvK+BTW, klant naam+adres, datum, uniek nummer, omschrijving, prijs (excl BTW + BTW-bedrag + totaal)." }],
          woorden: [{ woord: "factuur", uitleg: "Officieel document voor zakelijke transactie. Bewijs voor administratie + BTW." }, { woord: "factuurnummer", uitleg: "Uniek volgnummer per factuur. Onmisbaar voor administratie." }],
          ...
          niveaus: { basis: "Alle 5 items verplicht. A.", simpeler: "Factuur moet jouw + klant gegevens, datum, factuurnummer en prijs met BTW vermelden. = A.", nogSimpeler: "Veel verplicht = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "7 jaar = wet", tekst: "Belastingdienst kan tot 7 jaar terug onderzoeken. Bewaarplicht = 7 jaar voor alle bedrijfsadministratie." }],
          ...
          niveaus: { basis: "7 jaar. A.", simpeler: "Wettelijke bewaarplicht = 7 jaar. Niet weggooien. = A.", nogSimpeler: "7 jaar = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1000/1,09 = ~917, BTW ~83. A.", simpeler: "€1.000 / 1,09 = ~€917 excl. BTW = €1.000 − €917 = ~€83 voor de Belastingdienst. = A.", nogSimpeler: "~€83 = A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Klant betaalt niet. A.", simpeler: "Debiteurenrisico = kans dat klanten je niet betalen wat ze schuldig zijn. = A.", nogSimpeler: "Niet betalen = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Eenmanszaak = privé bedreigd", tekst: "Eenmanszaak en eigenaar zijn juridisch 1 persoon. Schuldeisers kunnen privé-bezittingen (huis, auto, spaargeld) opeisen om schuld te dekken." }],
          woorden: [{ woord: "faillissement eenmanszaak", uitleg: "Curator mag privé-vermogen pakken want eenmanszaak ≠ aparte juridische entiteit." }, { woord: "faillissement BV", uitleg: "Curator pakt alleen BV-vermogen. Eigenaars privé veilig (mits niet onbehoorlijk bestuurd)." }],
          ...
          niveaus: { basis: "Privé in gevaar bij eenmanszaak. A.", simpeler: "Eenmanszaak: ook je privé-bezittingen kunnen verkocht worden. BV beschermt je daartegen. = A.", nogSimpeler: "Privé verkoop = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Rechter benoemt curator", tekst: "Bij faillissement-uitspraak benoemt de rechtbank een CURATOR (vaak een advocaat). Hij/zij beheert het faillissement: bezittingen verkopen + geld onder schuldeisers verdelen." }],
          woorden: [{ woord: "curator", uitleg: "Door rechter benoemde persoon (vaak advocaat) die failliete onderneming afwikkelt." }, { woord: "faillissement", uitleg: "Juridische staat waarin schulden niet meer betaald kunnen worden. Rechter verklaart bedrijf failliet." }],
          ...
          niveaus: { basis: "Curator door rechter. A.", simpeler: "De rechter wijst een curator aan — die regelt het failliete bedrijf. = A.", nogSimpeler: "Curator = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Buffer van 3-6 mnd. A.", simpeler: "Een spaarpotje van 3-6 maanden kosten = veiligheid bij tegenvallers. = A.", nogSimpeler: "Buffer = A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Veel verschillende klanten. A.", simpeler: "Spreiding = veel verschillende klanten zodat je niet van 1 afhankelijk bent. = A.", nogSimpeler: "Spreiden = A." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Jij = het bedrijf", tekst: "Bij eenmanszaak BEN JIJ het bedrijf. Word je ziek → geen omzet. Burn-out → geen omzet. Geen werknemers om over te nemen. Daarom AOV-verzekering belangrijk." }],
          woorden: [{ woord: "persoonlijk risico", uitleg: "Risico dat in jouzelf zit (gezondheid, energie) — bij eenmanszaak direct verbonden aan bedrijf." }, { woord: "AOV", uitleg: "Arbeidsongeschiktheidsverzekering. Vervangt deel inkomen als je niet kunt werken." }],
          ...
          niveaus: { basis: "Ziekte = persoonlijk risico. A.", simpeler: "Jij bent het bedrijf. Word je ziek → geen omzet. Dat is het grote persoonlijke risico. = A.", nogSimpeler: "Ziek = geen omzet = A." },
        },
      },
    ],
  },
