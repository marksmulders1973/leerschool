...
<text x="160" y="180" text-anchor="middle" fill="${COLORS.muted}" font-size="10" font-family="Arial" font-style="italic">USP = wat maakt JOU anders?</text>
    ...
    checks: [
      ...
      {
        q: "🎓 Examen 2023-T1 V36: Volgers van influencers hebben het gevoel dat zij een intieme band hebben met de influencers die zij volgen, een soortgelijke band als met een vriend of familielid. De be'nvloeding van influencers noemen we sociale be'nvloeding. Is er ook sprake van commerci'le be'nvloeding?",
...
<text x="118" y="218" text-anchor="middle" fill="${COLORS.warm}" font-size="9" font-family="Arial">36 stuks</text>
    ...
    checks: [
      ...
      {
        q: "🎓 Examen 2023-T1 V42: Kaj vervolgt: \"Bovendien blijft de vraag naar onze producten stijgen, dus het is wijs om de verkoopprijs na productie-uitbreiding gelijk te houden.\" Welk gevolg voor de winstmarge van K2 bv heeft het gelijk houden van de verkoopprijs na de productie-uitbreiding?",
...
<text x="160" y="200" text-anchor="middle" fill="${COLORS.muted}" font-size="10" font-family="Arial" font-style="italic">ACM bewaakt eerlijke markt</text>
    ...
    checks: [
      ...
      {
        q: "🎓 Examen 2023-T1 V38: K2 bv biedt heterogene producten aan en er zijn veel concurrenten op de markt. Van welke marktvorm is hier sprake?",
        ...
        answer: 1,
        wrongHints: [null, null, null, null],
        examenBron: "🎓 Examen 2023-T1 V38:",
      },
    
      {
        q: "🎓 Examen 2024-T1 V7: Van welke marktvorm is er sprake bij de publieke omroepen?",
        options: ["van monopolie", "van monopolistische concurrentie", "van oligopolie", "van volkomen concurrentie"],
        answer: 2,
        wrongHints: [null, null, null, null],
        examenBron: "🎓 Examen 2024-T1 V7:",
      },
    ],
  },
  // ─── Stap 7: Rechtsvormen ─────────────────────────────────
...
<text x="160" y="200" text-anchor="middle" fill="${COLORS.muted}" font-size="10" font-family="Arial" font-style="italic">~€100k winst: eenmanszaak fiscaal voordeliger</text>
    ...
    checks: [
      ...
      {
        q: "🎓 Examen 2024-T2 V17: Een eigenaar van een bedrijf moet een ondernemingsvorm kiezen. Welke ondernemingsvorm moet Arjun kiezen, zodat hij niet hoofdelijk aansprakelijk is voor de schulden van het bedrijf?",
        options: ["bv (besloten vennootschap)", "eenmanszaak", "vof (vennootschap onder firma)"],
        answer: 0,
        wrongHints: [null, null, null, null],
        examenBron: "🎓 Examen 2024-T2 V17:",
      },
    
      {
        q: "🎓 Examen 2025-T1 V17: De leerlingen van de klas doen allemaal mee. Ze zijn allen priv' aansprakelijk voor de eventuele schulden van Dog4fun. Welke ondernemingsvorm heeft Dog4fun?",
