    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gijzelt bestanden voor losgeld. A.", simpeler: "Ransomware = losgeld-malware = A.", nogSimpeler: "A." },
        },
      },
      {
        q: "Wat is **phishing**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Nep-bericht voor je gegevens. A.", simpeler: "Phishing = nep-bericht = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "De mens. A.", simpeler: "Social engineering = mens misleiden = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Lang + uniek. A.", simpeler: "Sterk = lang + uniek = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tweede bewijs. A.", simpeler: "2FA = extra code = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Als hash. A.", simpeler: "Wachtwoord = als hash bewaren = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Onleesbaar zonder sleutel. A.", simpeler: "Encryptie = versleutelen = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Publieke + privé. A.", simpeler: "Asymmetrisch = 2 sleutels = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verkeer afschermen. A.", simpeler: "🔒 = verkeer versleuteld = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Back-ups. A.", simpeler: "Dataverlies voorkomen = back-up = A.", nogSimpeler: "A." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Dichten gaten. A.", simpeler: "Updates = gaten dichten = A.", nogSimpeler: "A." },
        },
      },
      {
        q: "De **AVG** gaat over…",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Omgaan met persoonsgegevens. A.", simpeler: "AVG = privacywet = A.", nogSimpeler: "A." },
        },
      },
    ],
  },
