...
const steps = [
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Tekst weegt voordelen (sneller info opnemen) tegen risico's (minder begrip, vooral bij fictie). Beide kanten = informeren. Specifiek: VOORDELEN ÉN RISICO'S.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Tekst: 'UW krant' + 'UW krantenbezorger' = lezers die ZELF een krant ontvangen worden direct aangesproken. Zij kunnen hun eigen bezorger bedanken.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 7 (Bos): 'overheid moet gedragssturing doen'. Alinea 8: 'MAAR het is ÓÓK niet alleen overheidsverantwoordelijkheid — bedrijven moeten ook'. Klassiek 'aan de ene kant — aan de andere kant' = tegenstelling.",
