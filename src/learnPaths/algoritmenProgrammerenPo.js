    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip: een algoritme staat los van wat het GEBRUIKT (computer of mens). Recept = algoritme. Route op kaart = algoritme. Stenen tegen stenen-spel-strategie = algoritme.",
          voorbeelden: [
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Ada Lovelace = eerste programmeur (1840s, Engelse wiskundige).",
