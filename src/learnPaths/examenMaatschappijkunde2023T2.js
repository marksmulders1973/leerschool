...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "**Referendum** = volksraadpleging waarbij burgers direct over een vraag mogen stemmen. Helsinki organiseerde dit voor de havermelk-keuze. Andere invloed-vormen: politieke partij (kies/lid), lobby (druk achter de schermen), actie (demonstreren).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Volgorde gemeente na verkiezingen: 1) verkiezingen → 2) **coalitie vormen** + akkoord schrijven → 3) **wethouders kiezen** (gemeenteraad benoemt ze, 1 per coalitiepartij meestal) → 4) college van B&W is compleet (burgemeester + wethouders).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Europese Raad** = bijeenkomst van de **regeringsleiders** (president/premier) van alle EU-lidstaten. Voorzitter = Charles Michel (toen). Niet te verwarren met: COMMISSIE (ambtenaren, Von der Leyen), RAAD VAN DE EU (ministers per vakgebied), EUROPEES PARLEMENT (gekozen MEPs).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**EU-richtlijn** = lidstaat MOET een doel bereiken, maar mag zelf bepalen HOE dat in eigen wetgeving wordt vastgelegd. Verschil met **EU-verordening** = die geldt direct, woordelijk in alle lidstaten (geen vertaling nodig).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Trias Politica** (Montesquieu): WETGEVENDE macht (parlement maakt wetten), UITVOERENDE macht (regering + OM voeren uit), RECHTERLIJKE macht (rechters spreken recht). OM = onderdeel uitvoerende macht (eist straf). Rechter = rechterlijke macht (beslist).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Klassenjustitie** = ongelijke behandeling in het recht op basis van iemand's positie/klasse/achtergrond. Gaat in tegen rechtsstaat-principe 'iedereen gelijk voor de wet'. Arbeidsmigrant zwaarder straffen wegens taal = klassenjustitie.",
