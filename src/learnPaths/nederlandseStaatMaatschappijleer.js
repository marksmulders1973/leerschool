    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Macht volk.", simpeler: "Democratie = Grieks 'macht van volk'.", nogSimpeler: "Volk" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "18.", simpeler: "Stemmen in NL = 18+.", nogSimpeler: "18" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1919.", simpeler: "Vrouwen stemmen NL sinds 1919 (mannen sinds 1917).", nogSimpeler: "1919" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wetgevend.", simpeler: "Wetten maken = wetgevende macht (Kamer + regering).", nogSimpeler: "Wetgevend" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "150.", simpeler: "Tweede Kamer = 150 zetels. Eerste = 75.", nogSimpeler: "150" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Via Provinciale Staten.", simpeler: "Eerste Kamer = indirect via Provinciale Staten (volk kiest provincie → provincie kiest senaat).", nogSimpeler: "Provincie kiest" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Thorbecke 1848.", simpeler: "Moderne NL-grondwet = Thorbecke 1848.", nogSimpeler: "Thorbecke" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gelijke behandeling.", simpeler: "Artikel 1 = iedereen wordt gelijk behandeld + geen discriminatie.", nogSimpeler: "Gelijkheid" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Iedereen gelijk onder wet.", simpeler: "Rechtsstaat = land waar iedereen zich aan zelfde wetten moet houden.", nogSimpeler: "Wet voor allen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hoge Raad.", simpeler: "Hoogste NL-rechter = Hoge Raad (cassatie).", nogSimpeler: "Hoge Raad" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Stemmen is recht.", simpeler: "Stemmen = recht (mag), geen plicht (niet moet).", nogSimpeler: "Stemmen = mag" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "14 jaar.", simpeler: "ID-plicht NL = vanaf 14 jaar.", nogSimpeler: "14" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1945.", simpeler: "VN opgericht 1945, vlak na WO2.", nogSimpeler: "1945" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Aanval op 1 = op allen.", simpeler: "NAVO art. 5 = aanval op één lid is aanval op allen, samen verdedigen.", nogSimpeler: "1 voor allen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rechtsprekend.", simpeler: "Rechter doet rechtsprekende macht (3e van Trias Politica).", nogSimpeler: "Rechtsprekend" },
        },
      },
      {
