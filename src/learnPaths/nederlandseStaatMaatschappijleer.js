    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Macht volk. A.", simpeler: "Democratie = Grieks 'macht van volk'.", nogSimpeler: "Volk" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Koning beperkt door wet. A.", simpeler: "Constitutionele monarchie = koning bestaat, maar grondwet beperkt zijn macht. NL is dit.", nogSimpeler: "Koning + wet" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "18. A.", simpeler: "Stemmen in NL = 18+.", nogSimpeler: "18" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1919. A.", simpeler: "Vrouwen stemmen NL sinds 1919 (mannen sinds 1917).", nogSimpeler: "1919" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Montesquieu. A.", simpeler: "Trias Politica = Montesquieu (1748, Frans denker).", nogSimpeler: "Montesquieu" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Wetgevend. A.", simpeler: "Wetten maken = wetgevende macht (Kamer + regering).", nogSimpeler: "Wetgevend" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "150. A.", simpeler: "Tweede Kamer = 150 zetels. Eerste = 75.", nogSimpeler: "150" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Samen-regerende partijen. A.", simpeler: "Coalitie = meerdere partijen die samen regeren (= meerderheid).", nogSimpeler: "Samen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Via Provinciale Staten. A.", simpeler: "Eerste Kamer = indirect via Provinciale Staten (volk kiest provincie → provincie kiest senaat).", nogSimpeler: "Provincie kiest" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Minister-president. A.", simpeler: "Regeringshoofd NL = minister-president (premier).", nogSimpeler: "Premier" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Willem-Alexander. A.", simpeler: "Koning sinds 2013 = Willem-Alexander.", nogSimpeler: "Willem-Alexander" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ondertekent formeel. A.", simpeler: "Koning tekent wetten formeel — geen veto, kan niet weigeren.", nogSimpeler: "Formaliteit" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Thorbecke 1848. A.", simpeler: "Moderne NL-grondwet = Thorbecke 1848.", nogSimpeler: "Thorbecke" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gelijke behandeling. A.", simpeler: "Artikel 1 = iedereen wordt gelijk behandeld + geen discriminatie.", nogSimpeler: "Gelijkheid" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Iedereen gelijk onder wet. A.", simpeler: "Rechtsstaat = land waar iedereen zich aan zelfde wetten moet houden.", nogSimpeler: "Wet voor allen" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hoge Raad. A.", simpeler: "Hoogste NL-rechter = Hoge Raad (cassatie).", nogSimpeler: "Hoge Raad" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Stemmen is recht. A.", simpeler: "Stemmen = recht (mag), geen plicht (niet moet).", nogSimpeler: "Stemmen = mag" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "14 jaar. A.", simpeler: "ID-plicht NL = vanaf 14 jaar.", nogSimpeler: "14" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1945. A.", simpeler: "VN opgericht 1945, vlak na WO2.", nogSimpeler: "1945" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Aanval op 1 = op allen. A.", simpeler: "NAVO art. 5 = aanval op één lid is aanval op allen, samen verdedigen.", nogSimpeler: "1 voor allen" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Rechtsprekend. A.", simpeler: "Rechter doet rechtsprekende macht (3e van Trias Politica).", nogSimpeler: "Rechtsprekend" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ondertekent formeel. A.", simpeler: "Koning doet alleen formaliteiten: wetten ondertekenen, ceremonieel.", nogSimpeler: "Formaliteit" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Binnenhof Den Haag. A.", simpeler: "Tweede Kamer = Binnenhof, Den Haag.", nogSimpeler: "Binnenhof" },
        },
      },
      {
        q: "Wat is de **euro**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Munt 20 EU-landen. A.", simpeler: "Euro = munt van 20 EU-landen, incl. NL sinds 2002.", nogSimpeler: "EU-munt" },
        },
      },
