    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4x|−3y|+7 = 3 termen. A.", simpeler: "Termen scheiden door + of −. Tel de stukken: 4x, −3y, +7 = 3.", nogSimpeler: "3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4a en 9a (zelfde a). A.", simpeler: "Soortgelijk = zelfde letter, zelfde macht. 4a en 9a hebben allebei letter a.", nogSimpeler: "4a+9a = soortgelijk" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5x−2x=3x, 3+4=7 → 3x+7. A.", simpeler: "Trek soortgelijke termen samen: x'en bij x'en (5x−2x=3x), getallen bij getallen (3+4=7). Antwoord 3x+7.", nogSimpeler: "3x+7" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "4(x+7)=4x+28. A.", simpeler: "4 keer x = 4x. 4 keer 7 = 28. Samen: 4x + 28.", nogSimpeler: "4x+28" },
        },
      },
      {
        q: "Werk weg: 5(2x − 3).",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5(2x−3)=10x−15. A.", simpeler: "5 × 2x = 10x. 5 × 3 = 15. Min teken blijft: 10x − 15.", nogSimpeler: "10x−15" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "−(x−3)=−x+3. A.", simpeler: "Min vóór haakjes draait ALLE tekens om: x wordt −x, −3 wordt +3. Antwoord: −x+3.", nogSimpeler: "−x+3" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2x+8+3x−6=5x+2. A.", simpeler: "Stap 1: haakjes weg → 2x+8 + 3x−6. Stap 2: x'en samen (5x), getallen samen (8−6=2). Antwoord 5x+2.", nogSimpeler: "5x+2" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(x+4)²=x²+8x+16. A.", simpeler: "Formule (a+b)²=a²+2ab+b². Met a=x, b=4: x²+(2·x·4)+4² = x²+8x+16.", nogSimpeler: "x²+8x+16" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(x−5)²=x²−10x+25. A.", simpeler: "(a−b)² = a²−2ab+b². a=x, b=5: x² − 10x + 25. b² blijft positief.", nogSimpeler: "x²−10x+25" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(y+6)(y−6)=y²−36. A.", simpeler: "Formule (a+b)(a−b)=a²−b². a=y, b=6: y² − 36.", nogSimpeler: "y²−36" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x⁴·x³=x⁷ (4+3). A.", simpeler: "Bij vermenigvuldigen van machten: exponenten OPTELLEN. 4+3=7. Dus x⁷.", nogSimpeler: "x⁷" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "x⁸/x³=x^(8−3)=x⁵. A.", simpeler: "Bij delen van machten: exponenten AFTREKKEN. 8−3=5. Dus x⁵.", nogSimpeler: "x⁵" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "(x³)⁴=x^(3·4)=x¹². A.", simpeler: "(x³)⁴ = (x³)·(x³)·(x³)·(x³). Vier keer x³. Exponent 3·4=12. Dus x¹².", nogSimpeler: "x¹²" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Eerst ×, dan +. 10x². A.", simpeler: "Stap 1: 3x·2x = 6x² (coëfficiënten ×, exponenten +). Stap 2: 4x²+6x²=10x².", nogSimpeler: "10x²" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "= x+8. A.", simpeler: "Stap 1 haakjes: 3(x+2)=3x+6, −2(x−1)=−2x+2. Stap 2 herleid: 3x−2x=x, 6+2=8. = x+8.", nogSimpeler: "x+8" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "= 2x²+4x. A.", simpeler: "(x+2)² = x²+4x+4. (x+2)(x−2) = x²−4. Samen: 2x² + 4x + (4−4) = 2x²+4x.", nogSimpeler: "2x²+4x" },
        },
      },
      { q: "Vereenvoudig: 3x + 4x = ?", options: ["7x","12x","x⁷","7"], answer: 0, wrongHints: [null, "Niet — niet vermenigvuldigen.", "Niet — geen macht.", "Letter weglaten kan niet."] },
      { q: "Vereenvoudig: 5a − 2a = ?", options: ["3a","7a","10a","a"], answer: 0, wrongHints: [null, "Niet — aftrekken.", "Niet vermenigvuldigen.", "Niet."] },
      { q: "Werk uit: 2(x + 3) = ?", options: ["2x + 6","2x + 3","x + 6","2x · 3"], answer: 0, wrongHints: [null, "Vergeet niet 2 keer 3.", "Vergeet 2 voor x.", "Niet — plus binnen haakjes."] },
