...
<text x="150" y="188" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">algebra-basis: gehaald 🏆</text>
    ...
    checks: [
      ...
      { q: "Vereenvoudig: 3x + 4x = ?", options: ["7x","12x","x⁷","7"], answer: 0, wrongHints: [null,"Klopt — soortgelijke termen optellen.","Niet — niet vermenigvuldigen.","Niet — geen macht.","Letter weglaten kan niet."] },
      { q: "Vereenvoudig: 5a − 2a = ?", options: ["3a","7a","10a","a"], answer: 0, wrongHints: [null,"Klopt.","Niet — aftrekken.","Niet vermenigvuldigen.","Niet."] },
      { q: "Werk uit: 2(x + 3) = ?", options: ["2x + 6","2x + 3","x + 6","2x · 3"], answer: 0, wrongHints: [null,"Klopt — distributie.","Vergeet niet 2 keer 3.","Vergeet 2 voor x.","Niet — plus binnen haakjes."] },
      { q: "Vereenvoudig: 4x + 2x − 3x = ?", options: ["3x","9x","3","x³"], answer: 0, wrongHints: [null,"Klopt — 4+2−3 = 3.","Niet — niet plus.","Letter blijft.","Niet."] },
      { q: "Wat is 3x · 2x = ?", options: ["6x²","6x","5x","9x"], answer: 0, wrongHints: [null,"Klopt — getal × getal, letter × letter (x²).","Vergeet niet kwadraat.","Niet — vermenigvuldigen, niet optellen.","Niet."] },
      { q: "Vereenvoudig: (2x)² = ?", options: ["4x²","2x²","4x","2x⁴"], answer: 0, wrongHints: [null,"Klopt — 2²·x² = 4x².","Vergeet 2 ook kwadrateren.","Vergeet x²","Niet."] },
      { q: "Vereenvoudig: x² · x³ = ?", options: ["x⁵","x⁶","x²ˣ³","x²·³"], answer: 0, wrongHints: [null,"Klopt — exponenten optellen.","Niet — niet vermenigvuldigen.","Niet — vorm.","Niet."] },
      { q: "Werk haakjes weg: −(x − 5) = ?", options: ["−x + 5","−x − 5","x − 5","−x · 5"], answer: 0, wrongHints: [null,"Klopt — alle tekens omdraaien.","Niet — −x klopt maar +5.","Niet — min eraf.","Niet."] },
      { q: "Bereken voor x=2: 3x + 1", options: ["7","6","4","2"], answer: 0, wrongHints: [null,"Klopt — 3·2+1.","Vergeet +1.","Niet.","Niet."] },
    ],
  },
];
