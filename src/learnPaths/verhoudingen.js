...
<text x="150" y="180" text-anchor="middle" fill="#42a5f5" font-size="11" font-family="Arial" font-weight="bold">In werkelijkheid: ?</text>
    ...
    checks: [
      ...
      { q: "Verhouding meisjes:jongens = 3:2 in klas van 25. Hoeveel meisjes?", options: ["15","10","12","13"], answer: 0, wrongHints: [null, "Dat is jongens-aantal.", "Niet — verdeling klopt niet.", "Idem."] },
      { q: "Werkverhouding 2:1 (Anna : Bob werken). Anna 12 uur. Bob?", options: ["6 uur","24 uur","18 uur","8 uur"], answer: 0, wrongHints: [null, "Anna doet meer, Bob doet juist minder.", "Niet — verkeerde verhouding.", "Niet."] },
      { q: "Mix sap 1:4 (siroop : water). 1 dl siroop nodig — water?", options: ["4 dl","0,25 dl","5 dl","2 dl"], answer: 0, wrongHints: [null, "Tegenovergesteld — water meer dan siroop.", "Dat is totaal-volume.", "Niet."] },
      { q: "Schaduw vlaggenstok 4 m, persoon 1,60 m schaduw 0,8 m. Hoogte stok?", options: ["8 m","16 m","20 m","6 m"], answer: 0, wrongHints: [null, "Te hoog — controleer verhouding.", "Veel te hoog.", "Te laag — schaduw 4m × 2 = 8."] },
      { q: "Vereenvoudig 36 : 24", options: ["3 : 2","6 : 4","36 : 24","2 : 1"], answer: 0, wrongHints: [null, "Niet maximaal vereenvoudigd (kan ÷2 nog).", "Niet vereenvoudigd.", "Niet — 36÷24 ≠ 2."] },
      { q: "Verhouding 2:3:5 in klas van 50. Aantal in middelste groep?", options: ["15","10","25","20"], answer: 0, wrongHints: [null, "Eerste groep.", "Laatste groep.", "Niet."] },
      { q: "1 km = ? cm?", options: ["100.000 cm","1.000 cm","10.000 cm","1.000.000 cm"], answer: 0, wrongHints: [null, "Niet — dat is 10 m.", "Niet — dat is 100 m.", "Te veel."] },
      { q: "1 L = ? mL?", options: ["1.000 mL","100 mL","10 mL","10.000 mL"], answer: 0, wrongHints: [null, "Niet — dat is dl.", "Te weinig — cl.", "Te veel."] },
      { q: "Auto 60 km/u — afstand in 2 uur?", options: ["120 km","30 km","60 km","240 km"], answer: 0, wrongHints: [null, "Te weinig — heb je gedeeld?", "Niet — controleer factor.", "Te veel."] },
    ],
  },
];
