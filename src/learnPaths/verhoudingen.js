    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Vereenvoudigen", tekst: "12 en 18 zijn beide deelbaar door 6: 12÷6=2, 18÷6=3." }],
          woorden: [{ woord: "GGD", uitleg: "grootste gemeenschappelijke deler" }],
          theorie: "Deel beide getallen door hetzelfde getal.",
          voorbeelden: [{ type: "voorbeeld", tekst: "12÷6=2 en 18÷6=3 → 2:3" }],
          basiskennis: [{ onderwerp: "deler vinden", uitleg: "zoek grootste getal dat in beide past" }],
          niveaus: {
            basis: "12:18 = (÷6) 2:3.",
            simpeler: "Deel 12 en 18 allebei door 6.",
            nogSimpeler: "Door 6 delen: 2:3.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "8 : 12 is een tussenstap. Door welk getal kun je nog verder delen?",
          "4 : 6 is een tussenstap. Kun je nog kleiner — door welk getal?",
          "Dat is de oorspronkelijke. Wat is het grootste getal waar 16 én 24 door deelbaar zijn?",
        ],
        uitlegPad: {
          stappen: [{ titel: "GGD = 8", tekst: "16÷8=2, 24÷8=3 → 2:3." }],
          woorden: [{ woord: "vereenvoudigd", uitleg: "kleinste getallen mogelijk" }],
          theorie: "Deel door grootste gemeenschappelijke deler.",
          voorbeelden: [{ type: "voorbeeld", tekst: "16:24 = 8:12 = 4:6 = 2:3" }],
          basiskennis: [{ onderwerp: "stap-voor-stap", uitleg: "kan ook in stappen: ÷2, ÷2, ÷2" }],
          niveaus: {
            basis: "16:24 = (÷8) 2:3.",
            simpeler: "Beide door 8: 2:3.",
            nogSimpeler: "16:24 → 8:12 → 4:6 → 2:3.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "25% = ¼ — dat zou bij verhouding 1 : 3 passen. Tel eerst de delen op bij 1 : 4.",
          "Tel eerst alle delen op (1 + 4). Hoeveel deel is 1 dan van het totaal?",
          "Dat is 2 delen op 5. Maar de vraag gaat over 1 deel — hoeveel procent is dat van het totaal?",
        ],
        uitlegPad: {
          stappen: [{ titel: "Totaal delen", tekst: "1+4 = 5 delen. 1 deel is 1/5 = 20%." }],
          woorden: [{ woord: "totaal", uitleg: "som van alle delen" }],
          theorie: "Bij a:b is a-deel = a/(a+b) van totaal.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1:4 → 1/5 = 20%, 4/5 = 80%" }],
          basiskennis: [{ onderwerp: "procent", uitleg: "deel ÷ totaal × 100" }],
          niveaus: {
            basis: "1 op totaal 5 = 1/5 = 20%.",
            simpeler: "Tel: 1+4=5. Dan 1÷5 = 0.2 = 20%.",
            nogSimpeler: "5 delen totaal. 1 deel = 20%.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Te veel. Reken eerst de prijs van 1 boterham uit (deel 2,50 door 5). Wat krijg je dan voor 8?",
          "Te weinig. Bereken eerst de prijs voor 1 boterham, daarna × 8.",
          "Te veel. Bereken eerst per boterham (2,50 ÷ 5), dan × 8.",
        ],
        uitlegPad: {
          stappen: [{ titel: "Naar 1 stuk", tekst: "€2.50 ÷ 5 = €0.50 per boterham. 8 × €0.50 = €4." }],
          woorden: [{ woord: "stuksprijs", uitleg: "prijs per 1 stuk" }],
          theorie: "Eerst delen om bij 1 te komen, dan vermenigvuldigen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "5 → 1: ÷5. Daarna 1 → 8: ×8." }],
          basiskennis: [{ onderwerp: "tabel", uitleg: "5/2.50, 1/0.50, 8/4.00" }],
          niveaus: {
            basis: "Per boterham €0.50. 8 × €0.50 = €4.00.",
            simpeler: "€2.50 ÷ 5 = €0.50. Dan × 8.",
            nogSimpeler: "1 boterham = €0.50. 8 stuks = €4.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Pas het kruisproduct toe: 5 · x = 15 · 8. Hoeveel is 15 × 8? En deel dat door 5.",
          "Te klein. Schrijf het kruisproduct uit: 5x = 15 · 8. Reken stap voor stap.",
          "Te groot. Reken eerst 15 × 8 uit, en deel dat dan door 5.",
        ],
        uitlegPad: {
          ...
          niveaus: {
            basis: "15·8 = 120. 120÷5 = 24.",
            simpeler: "Verhouding gelijk: 15 = 3×5, dus x = 3×8 = 24.",
            nogSimpeler: "5→15 is keer 3. 8→? ook keer 3 = 24.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Bereken eerst hoeveel rijst er per persoon nodig is (150 ÷ 3). Daarna × 8.",
          "Dat is voor minder dan 8 personen. Reken eerst per persoon, dan × 8.",
          "Te veel. Reken eerst per persoon, daarna keer het aantal personen.",
        ],
        uitlegPad: {
          stappen: [{ titel: "Per persoon", tekst: "150÷3 = 50g pp. 8 × 50 = 400g." }],
          woorden: [{ woord: "factor", uitleg: "8/3 ≈ 2.67" }],
          theorie: "Recept × (nieuw aantal / oud aantal).",
          voorbeelden: [{ type: "voorbeeld", tekst: "3p → 1p: 50g. 1p → 8p: 400g." }],
          basiskennis: [{ onderwerp: "tabel", uitleg: "3/150, 1/50, 8/400" }],
          niveaus: {
            basis: "Per persoon 50g. 8 personen = 400g.",
            simpeler: "150÷3 = 50. Dan ×8 = 400.",
            nogSimpeler: "1 persoon = 50g. 8 keer = 400g.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Te groot. Reken eerst 6 × 50 uit (in cm), en zet dan om naar meter.",
          "Je hebt × 5 gedaan, niet × 50. Probeer opnieuw.",
          "Te veel. Reken 6 × 50 uit in cm, en zet dat om naar meter.",
        ],
        uitlegPad: {
          stappen: [{ titel: "× schaalfactor", tekst: "6 × 50 = 300 cm = 3 m." }],
          woorden: [{ woord: "schaal", uitleg: "kaart : werkelijk" }],
          theorie: "Werkelijk = kaart × schaalfactor. Dan omzetten naar m.",
          voorbeelden: [{ type: "voorbeeld", tekst: "100 cm = 1 m" }],
          basiskennis: [{ onderwerp: "cm→m", uitleg: "÷100" }],
          niveaus: {
            basis: "6 × 50 = 300 cm = 3 m.",
            simpeler: "Eerst keer 50 (cm). Dan ÷100 voor m.",
            nogSimpeler: "6 cm × 50 = 300 cm. 300 cm = 3 m.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Te kort. Reken 7 × 100.000 uit in cm, en zet dat om naar km.",
          "Te ver. Reken eerst in cm en zet dat om naar km — 1 km = 100.000 cm.",
          "Te kort. Bedenk: bij schaal 1 : 100.000 is 1 cm = hoeveel km? Vermenigvuldig dan met 7.",
        ],
        uitlegPad: {
          stappen: [{ titel: "1 cm = 1 km", tekst: "1:100.000 → 1 cm op kaart = 100.000 cm = 1 km. 7 cm = 7 km." }],
          woorden: [{ woord: "wegenkaart", uitleg: "schaal 1:100.000 = veelgebruikt" }],
          theorie: "100.000 cm = 1 km.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1 km = 1000 m = 100.000 cm" }],
          basiskennis: [{ onderwerp: "omrekenen", uitleg: "cm ÷ 100.000 = km" }],
          niveaus: {
            basis: "1 cm = 1 km bij schaal 1:100.000. 7 cm = 7 km.",
            simpeler: "Onthoud: bij 1:100.000 is 1 cm = 1 km.",
            nogSimpeler: "7 cm op deze kaart = 7 km in echt.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        wrongHints: [
          null,
          "Tel eerst de delen op (2 + 5). Hoeveel personen vormen samen 1 deel? Vermenigvuldig daarna met 2.",
          "Dat is de waarde van 1 deel. Maar het kleine deel van de verhouding 2 : 5 is hoeveel delen?",
          "Reken eerst het totaal aantal delen uit (2 + 5). Hoeveel personen per deel?",
        ],
        uitlegPad: {
          stappen: [{ titel: "Totaal delen", tekst: "2+5 = 7 delen. 35÷7 = 5 per deel. Klein = 2 delen = 10." }],
          woorden: [{ woord: "deel-waarde", uitleg: "totaal ÷ aantal delen" }],
          theorie: "Verdeel volgens delen: per-deel × aantal-delen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1 deel = 5 personen, 2 delen = 10, 5 delen = 25" }],
          basiskennis: [{ onderwerp: "check", uitleg: "10 + 25 = 35 ✓" }],
          niveaus: {
            basis: "1 deel = 5 personen. Klein deel = 2 delen = 10.",
            simpeler: "35÷7 = 5 per deel. Klein = 2×5 = 10.",
            nogSimpeler: "7 delen totaal. 5 per deel. Klein = 2×5 = 10.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Lees notatie", tekst: "1 : N → 1 cm op kaart = N cm in echt." }],
          woorden: [{ woord: "schaalnotatie", uitleg: "kaart : werkelijk" }],
          theorie: "Eenheid is hetzelfde aan beide kanten.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1:25000 = 1 cm wordt 25000 cm" }],
          basiskennis: [{ onderwerp: "cm aan beide kanten", uitleg: "niet cm:m mixen" }],
          niveaus: {
            basis: "1 cm op kaart = 25.000 cm in echt.",
            simpeler: "Schaal 1:N = 1 op kaart, N in echt.",
            nogSimpeler: "1 keer N = werkelijke afstand.",
          },
        },
      },
      {
        ...
        wrongHints: [
          null,
          "Je hebt gedeeld in plaats van vermenigvuldigd. Welke bewerking past bij 'kaart × schaalgetal = werkelijk'?",
          "Je hebt na vermenigvuldigen door 100 gedeeld. Dat geeft meters, maar de vraag is in cm.",
          "Vermenigvuldig 8,4 met de schaalfactor (25.000). Wat krijg je dan in cm?",
        ],
        uitlegPad: {
          stappen: [{ titel: "Vermenigvuldigen", tekst: "8.4 × 25.000 = 210.000 cm." }],
          woorden: [{ woord: "vermenigvuldigen", uitleg: "kaart-afstand × schaal = werkelijk" }],
          theorie: "Werkelijk = kaart × N.",
          voorbeelden: [{ type: "voorbeeld", tekst: "8.4 × 25000 = 210000" }],
          basiskennis: [{ onderwerp: "rekenmachine", uitleg: "8.4 × 25000 =" }],
          niveaus: {
            basis: "8.4 × 25.000 = 210.000 cm.",
            simpeler: "Kaart × schaal = werkelijk. 8.4 × 25000.",
            nogSimpeler: "8.4 × 25000 = 210.000.",
          },
        },
      },
      {
        ...
        wrongHints: [
          null,
          "Te groot. Door welk getal moet je delen om van cm naar km te gaan?",
          "Te klein. Je hebt te diep gedeeld. Hoeveel cm zit er in 1 km?",
          "Te groot. Bedenk: 1 km = 100.000 cm. Deel het cm-bedrag door dat getal.",
        ],
        uitlegPad: {
          stappen: [{ titel: "cm → km", tekst: "210.000 ÷ 100.000 = 2.1 km." }],
          woorden: [{ woord: "km", uitleg: "1 km = 100.000 cm" }],
          theorie: "Delen door 100.000 om van cm naar km te gaan.",
          voorbeelden: [{ type: "voorbeeld", tekst: "100.000 cm = 1 km" }],
          basiskennis: [{ onderwerp: "omrekenen", uitleg: "cm → m: ÷100. m → km: ÷1000." }],
          niveaus: {
            basis: "210.000 cm = 2.1 km (÷100.000).",
            simpeler: "Streep 5 nullen weg. 210.000 → 2.1.",
            nogSimpeler: "210.000 cm = 2.100 m = 2.1 km.",
          },
        },
      },
      { q: "Verhouding 3 : 5 — vereenvoudig 12 : 20", options: ["3 : 5","12 : 20","4 : 5","2 : 3"], answer: 0, wrongHints: [null,"Klopt — deel beide door 4.","Niet vereenvoudigd.","Niet — beide niet door 4.","Niet — controle 2:3 = 4:6, niet 12:20."] },
      { q: "Recept 4 personen: 200 g pasta. Voor 6 personen?", options: ["300 g","250 g","400 g","350 g"], answer: 0, wrongHints: [null,"Klopt — 200÷4 = 50/persoon. 6×50 = 300.","Te weinig — verhoudings­factor 1,5.","Te veel — voor 8 personen.","Te veel."] },
      { q: "Schaal 1:100.000 — 5 cm op kaart = ? in werkelijkheid", options: ["5 km","500 m","50 m","50 km"], answer: 0, wrongHints: [null,"Klopt — 5×100.000 = 500.000 cm = 5 km.","Te weinig — heb je 1:10.000 gerekend?","Veel te weinig.","Te veel."] },
      { q: "Schaal 1:50 — 6 cm tekening = ? in werkelijkheid", options: ["3 m","300 m","30 cm","3 km"], answer: 0, wrongHints: [null,"Klopt — 6×50 = 300 cm = 3 m.","Verkeerde eenheid (te groot).","Te weinig — heb je vergeten te vermenigvuldigen?","Veel te groot."] },
      { q: "Verhouding meisjes:jongens = 3:2 in klas van 25. Hoeveel meisjes?", options: ["15","10","12","13"], answer: 0, wrongHints: [null,"Klopt — totaal 5 delen, 1 deel = 5. Meisjes 3 × 5 = 15.","Dat is jongens-aantal.","Niet — verdeling klopt niet.","Idem."] },
      { q: "Werkverhouding 2:1 (Anna : Bob werken). Anna 12 uur. Bob?", options: ["6 uur","24 uur","18 uur","8 uur"], answer: 0, wrongHints: [null,"Klopt — Anna doet dubbel zoveel: Bob = helft.","Anna doet meer, Bob doet juist minder.","Niet — verkeerde verhouding.","Niet."] },
      { q: "Mix sap 1:4 (siroop : water). 1 dl siroop nodig — water?", options: ["4 dl","0,25 dl","5 dl","2 dl"], answer: 0, wrongHints: [null,"Klopt — verhouding 1:4 = 1 siroop op 4 water.","Tegenovergesteld — water meer dan siroop.","Dat is totaal-volume.","Niet."] },
      { q: "Schaduw vlaggenstok 4 m, persoon 1,60 m schaduw 0,8 m. Hoogte stok?", options: ["8 m","16 m","20 m","6 m"], answer: 0, wrongHints: [null,"Klopt — verhouding 1,60:0,8 = 2:1. Stok: 4×2 = 8 m.","Te hoog — controleer verhouding.","Veel te hoog.","Te laag — schaduw 4m × 2 = 8."] },
      { q: "Vereenvoudig 36 : 24", options: ["3 : 2","6 : 4","36 : 24","2 : 1"], answer: 0, wrongHints: [null,"Klopt — beide ÷12.","Niet maximaal vereenvoudigd (kan ÷2 nog).","Niet vereenvoudigd.","Niet — 36÷24 ≠ 2."] },
      { q: "Verhouding 2:3:5 in klas van 50. Aantal in middelste groep?", options: ["15","10","25","20"], answer: 0, wrongHints: [null,"Klopt — totaal 10 delen, 1 deel = 5. Middelste 3 × 5 = 15.","Eerste groep.","Laatste groep.","Niet."] },
      { q: "1 km = ? cm?", options: ["100.000 cm","1.000 cm","10.000 cm","1.000.000 cm"], answer: 0, wrongHints: [null,"Klopt — 1 km = 1.000 m = 100.000 cm.","Niet — dat is 10 m.","Niet — dat is 100 m.","Te veel."] },
      { q: "1 L = ? mL?", options: ["1.000 mL","100 mL","10 mL","10.000 mL"], answer: 0, wrongHints: [null,"Klopt — vaste omrekening.","Niet — dat is dl.","Te weinig — cl.","Te veel."] },
      { q: "Auto 60 km/u — afstand in 2 uur?", options: ["120 km","30 km","60 km","240 km"], answer: 0, wrongHints: [null,"Klopt — snelheid × tijd.","Te weinig — heb je gedeeld?","Niet — controleer factor.","Te veel."] },
    ],
  },
];
