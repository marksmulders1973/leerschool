    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Avondeten = dinner.", simpeler: "Dag-volgorde: ontbijt (breakfast) → middag (lunch) → avond (dinner).", nogSimpeler: "Dinner" },
        },
      },
      {
        q: "Wat is **fish**?",
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Trui = sweater.", simpeler: "Trui = sweater (US) of jumper (UK). Shirt=hemd, skirt=rok, scarf=sjaal — andere kleding.", nogSimpeler: "Sweater" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Foot → feet.", simpeler: "Foot is onregelmatig — meervoud is feet (klanksprong oo→ee). Niet 'foots'.", nogSimpeler: "Feet" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Broer = brother.", simpeler: "Bro-ther lijkt op bro-er. Sister=zus, uncle=oom, cousin=neef/nicht.", nogSimpeler: "Brother" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Mouth = mond.", simpeler: "Mouth begint met M, mond ook. Neus=nose, oor=ear, kin=chin.", nogSimpeler: "Mond" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kitchen = keuken.", simpeler: "Kitchen begint met K, keuken ook. Plek om te koken. (Bathroom=badkamer).", nogSimpeler: "Keuken" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vogel = bird.", simpeler: "B-I-R-D = vogel. Vis=fish, kat=cat, paard=horse — andere dieren.", nogSimpeler: "Bird" },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Know = weten.", simpeler: "K-N-O-W (uitspraak: 'no') = weten. K is stom. Denken=think, zien=see.", nogSimpeler: "Weten" },
        },
      },
      {
        q: "Hoe zeg je **werken**?",
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Fifteen = 15.", simpeler: "Fif (van five=5) + -teen achtervoegsel = 15. Fifty (-ty) = 50.", nogSimpeler: "15" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Monday (hoofdletter).", simpeler: "Engels heeft hoofdletter bij dagen. M-O-N-D-A-Y begint met grote M.", nogSimpeler: "Monday" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Quarter past 3 = 3:15.", simpeler: "Quarter (kwart=15min) + past (na) + 3 = 15 min NA 3 uur = 3:15.", nogSimpeler: "3:15" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "I'm fine, thank you.", simpeler: "How are you? = hoe gaat het? Standaardantwoord = I'm fine, thank you.", nogSimpeler: "I'm fine" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "You're welcome = graag gedaan.", simpeler: "Als iemand 'thank you' zegt, antwoord je 'you're welcome' = graag gedaan.", nogSimpeler: "Graag gedaan" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Window = niet familie.", simpeler: "Mother (moeder), uncle (oom), cousin (neef/nicht) = familie. Window (raam) = huis.", nogSimpeler: "Window" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ik draag een rode jurk.", simpeler: "I'm wearing = ik draag (nu). A red dress = een rode jurk. = Ik draag een rode jurk", nogSimpeler: "Draag rode jurk" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Scarf = niet eten.", simpeler: "Bread=brood, milk=melk, egg=ei = eten/drinken. Scarf=sjaal = kleding. Afwijker = scarf.", nogSimpeler: "Scarf" },
        },
      },
      {
        q: "Wat is **Tuesday**?",
