    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Per thema + herhalen. A.", simpeler: "Beste manier = woorden per thema leren + ~3× herhalen verspreid over een week. Eén keer hardop is te weinig.", nogSimpeler: "Thema + herhaal" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Bread = brood. A.", simpeler: "B-r-e-a-d = brood. Onthoud: 'breakfast' = ontbijt, dat is vaak met bread.", nogSimpeler: "Brood" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Avondeten = dinner. A.", simpeler: "Dag-volgorde: ontbijt (breakfast) → middag (lunch) → avond (dinner).", nogSimpeler: "Dinner" },
        },
      },
      {
        q: "Wat is **fish**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Fish = vis. A.", simpeler: "F-I-S-H = vis. Klinkt op vis. (Vlees=meat, fruit=fruit, ei=egg).", nogSimpeler: "Vis" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Shoes = schoenen. A.", simpeler: "Shoes (sjoes) = schoenen. Sokken = socks (klinkt anders).", nogSimpeler: "Schoenen" },
        },
      },
      {
        q: "Hoe zeg je **trui**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Trui = sweater. A.", simpeler: "Trui = sweater (US) of jumper (UK). Shirt=hemd, skirt=rok, scarf=sjaal — andere kleding.", nogSimpeler: "Sweater" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Foot → feet. A.", simpeler: "Foot is onregelmatig — meervoud is feet (klanksprong oo→ee). Niet 'foots'.", nogSimpeler: "Feet" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Broer = brother. A.", simpeler: "Bro-ther lijkt op bro-er. Sister=zus, uncle=oom, cousin=neef/nicht.", nogSimpeler: "Brother" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Mouth = mond. A.", simpeler: "Mouth begint met M, mond ook. Neus=nose, oor=ear, kin=chin.", nogSimpeler: "Mond" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Homework = huiswerk. A.", simpeler: "Home (thuis) + work (werk) = werk dat je thuis doet = huiswerk.", nogSimpeler: "Huiswerk" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Gum = eraser. A.", simpeler: "Engels 'gum' is kauwgom! Schoolgum = eraser (uitwisser).", nogSimpeler: "Eraser" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kitchen = keuken. A.", simpeler: "Kitchen begint met K, keuken ook. Plek om te koken. (Bathroom=badkamer).", nogSimpeler: "Keuken" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vogel = bird. A.", simpeler: "B-I-R-D = vogel. Vis=fish, kat=cat, paard=horse — andere dieren.", nogSimpeler: "Bird" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Mouse → mice. A.", simpeler: "Mouse is onregelmatig — meervoud is mice (klanksprong ou→i). Niet 'mouses'.", nogSimpeler: "Mice" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Know = weten. A.", simpeler: "K-N-O-W (uitspraak: 'no') = weten. K is stom. Denken=think, zien=see.", nogSimpeler: "Weten" },
        },
      },
      {
        q: "Hoe zeg je **werken**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Werken = work. A.", simpeler: "Vier W-werkwoorden: work (werken), play (spelen), walk (lopen), watch (kijken). Werken = work.", nogSimpeler: "Work" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Fifteen = 15. A.", simpeler: "Fif (van five=5) + -teen achtervoegsel = 15. Fifty (-ty) = 50.", nogSimpeler: "15" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Monday (hoofdletter). A.", simpeler: "Engels heeft hoofdletter bij dagen. M-O-N-D-A-Y begint met grote M.", nogSimpeler: "Monday" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Quarter past 3 = 3:15. A.", simpeler: "Quarter (kwart=15min) + past (na) + 3 = 15 min NA 3 uur = 3:15.", nogSimpeler: "3:15" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "I'm fine, thank you. A.", simpeler: "How are you? = hoe gaat het? Standaardantwoord = I'm fine, thank you.", nogSimpeler: "I'm fine" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "You're welcome = graag gedaan. A.", simpeler: "Als iemand 'thank you' zegt, antwoord je 'you're welcome' = graag gedaan.", nogSimpeler: "Graag gedaan" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Window = niet familie. A.", simpeler: "Mother (moeder), uncle (oom), cousin (neef/nicht) = familie. Window (raam) = huis.", nogSimpeler: "Window" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ik draag een rode jurk. A.", simpeler: "I'm wearing = ik draag (nu). A red dress = een rode jurk. = Ik draag een rode jurk", nogSimpeler: "Draag rode jurk" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Mijn oma woont in een klein huis. A.", simpeler: "Grandmother=oma, lives=woont, small=klein, house=huis → 'Mijn oma woont in een klein huis'.", nogSimpeler: "Oma + klein huis" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Scarf = niet eten. A.", simpeler: "Bread=brood, milk=melk, egg=ei = eten/drinken. Scarf=sjaal = kleding. Afwijker = scarf.", nogSimpeler: "Scarf" },
        },
      },
      {
        q: "Wat is **Tuesday**?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tuesday = dinsdag. A.", simpeler: "Volgorde: Monday (ma), Tuesday (di). Tuesday is de 2e dag = dinsdag.", nogSimpeler: "Dinsdag" },
        },
      },
    ],
  },
