    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "+3 elke stap", tekst: "Vaste toename per week — geen factor." }],
          woorden: [{ woord: "lineair", uitleg: "constant verschil per stap" }],
          theorie: "Lineair = +constant. Exponentieel = ×constant.",
          voorbeelden: [{ type: "voorbeeld", tekst: "10 → 13 → 16 → 19 (steeds +3)" }],
          basiskennis: [{ onderwerp: "verschil", uitleg: "nieuw − oud is constant bij lineair" }],
          niveaus: {
            basis: "Plant +3 cm per week — verschil constant → lineair.",
            simpeler: "Telkens +3. Plus, niet keer.",
            nogSimpeler: "Elke week 3 cm erbij. 10, 13, 16…",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "×2 elke stap", tekst: "Verdubbelen = vermenigvuldigen, niet optellen." }],
          woorden: [{ woord: "exponentieel", uitleg: "elke stap dezelfde factor" }],
          theorie: "N = b·g^t — bij verdubbelen g = 2.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1 → 2 → 4 → 8 → 16" }],
          basiskennis: [{ onderwerp: "factor", uitleg: "nieuw ÷ oud is constant" }],
          niveaus: {
            basis: "Verdubbelen → ×2 elke uur → exponentieel.",
            simpeler: "Keer 2 elke stap. Niet +.",
            nogSimpeler: "1, 2, 4, 8 — keer 2.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Reken factor", tekst: "75/50 = 1.5, 112.5/75 = 1.5, 168.75/112.5 = 1.5 — constant!" }],
          woorden: [{ woord: "factor", uitleg: "verhouding tussen opeenvolgende waarden" }],
          theorie: "Constante factor → exponentieel. Constant verschil → lineair.",
          voorbeelden: [{ type: "voorbeeld", tekst: "50 → 75 → 112.5 → 168.75 (×1.5)" }],
          basiskennis: [{ onderwerp: "checken", uitleg: "deel waarde door vorige; herhaal" }],
          niveaus: {
            basis: "Deel: 75/50=1.5, 112.5/75=1.5. Constant → exponentieel.",
            simpeler: "Eerst verschil: niet constant. Dan factor: wel constant.",
            nogSimpeler: "Probeer delen. 75÷50=1.5. 112.5÷75=1.5. Klopt = exponentieel.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Deel nieuw ÷ oud", tekst: "80/100 = 0.8, 64/80 = 0.8 → g = 0.8." }],
          woorden: [{ woord: "groeifactor", uitleg: "factor waarmee je elke stap vermenigvuldigt" }],
          theorie: "g < 1 = afname. g > 1 = groei. g = 1 = stilstand.",
          voorbeelden: [{ type: "voorbeeld", tekst: "100·0.8 = 80, 80·0.8 = 64, 64·0.8 = 51.2" }],
          basiskennis: [{ onderwerp: "richting", uitleg: "g < 1 bij dalende rij" }],
          niveaus: {
            basis: "Rij daalt → g < 1. 80÷100 = 0.8.",
            simpeler: "Deel nieuw door oud. 80÷100 = 0.8.",
            nogSimpeler: "100 wordt 80 → keer 0.8.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "g = 1 + p", tekst: "7% = 0.07. g = 1 + 0.07 = 1.07." }],
          woorden: [{ woord: "fractie", uitleg: "percentage als decimaal: 7% = 0.07" }],
          theorie: "Groei: g = 1 + p/100. Afname: g = 1 − p/100.",
          voorbeelden: [{ type: "voorbeeld", tekst: "5% → 1.05, 8% → 1.08, 100% → 2" }],
          basiskennis: [{ onderwerp: "het oude", uitleg: "100% van het oude blijft + 7% groei = 107%" }],
          niveaus: {
            basis: "7% groei → factor 1.07 (100% oud + 7% groei).",
            simpeler: "g = 1 + 0.07 = 1.07.",
            nogSimpeler: "Erbij = 1 plus 0,07.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "g = 1 − p", tekst: "4% af = 0.04. g = 1 − 0.04 = 0.96." }],
          woorden: [{ woord: "afname", uitleg: "g kleiner dan 1, altijd positief" }],
          theorie: "Bij afname: g = 1 − p/100. Nooit min-teken.",
          voorbeelden: [{ type: "voorbeeld", tekst: "5% af → 0.95, 10% af → 0.90, 50% af → 0.5" }],
          basiskennis: [{ onderwerp: "wat blijft", uitleg: "100% − 4% = 96% blijft = factor 0.96" }],
          niveaus: {
            basis: "4% af → er blijft 96% → g = 0.96.",
            simpeler: "Niet 1 + maar 1 − bij dalen. 1 − 0.04 = 0.96.",
            nogSimpeler: "Eraf = 1 min 0,04.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "p = (g − 1)·100", tekst: "(1.15 − 1)·100 = 15%." }],
          woorden: [{ woord: "percentage", uitleg: "(g − 1)·100 bij groei" }],
          theorie: "Verschil tussen g en 1 is procentueel verschil per stap.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1.05 → 5%, 1.20 → 20%, 2 → 100%" }],
          basiskennis: [{ onderwerp: "1 = stilstand", uitleg: "alles boven 1 is groei, eronder afname" }],
          niveaus: {
            basis: "g = 1.15 → 15% groei (verschil met 1).",
            simpeler: "1.15 − 1 = 0.15 = 15%.",
            nogSimpeler: "0,15 = 15 procent.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "macht", uitleg: "2³ = 2·2·2 = 8" }],
          theorie: "Verdubbelen bij t=3 betekent 3 keer met 2 vermenigvuldigen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "200 → 400 → 800 → 1600" }],
          basiskennis: [{ onderwerp: "machtsknop", uitleg: "rekenmachine: 200 × 2 ^ 3 =" }],
          niveaus: {
            basis: "Drie keer ×2: 200·2·2·2 = 1600.",
            simpeler: "200, dan 400, dan 800, dan 1600.",
            nogSimpeler: "200 → ×2 → ×2 → ×2 = 1600.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "samengesteld", uitleg: "rente over de rente erbij" }],
          theorie: "Spaarrekening = exponentieel met g = 1 + rente.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Jaar 1: 1050. Jaar 2: 1102.50. Jaar 3: 1157.63." }],
          basiskennis: [{ onderwerp: "rente", uitleg: "5% per jaar = ×1.05 per jaar" }],
          niveaus: {
            basis: "1000·1.05³ = €1157.63 (rente groeit ook mee).",
            simpeler: "Drie jaar ×1.05: 1000·1.05·1.05·1.05.",
            nogSimpeler: "Rekenmachine: 1000 × 1.05 ^ 3 =.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "kwadraat", uitleg: "1.5² = 1.5·1.5 = 2.25" }],
          theorie: "N(t) = b·g^t — vul t in, reken.",
          voorbeelden: [{ type: "voorbeeld", tekst: "N(0)=100, N(1)=150, N(2)=225" }],
          basiskennis: [{ onderwerp: "macht eerst", uitleg: "eerst 1.5² rekenen, dan ×100" }],
          niveaus: {
            basis: "1.5² = 2.25. 100·2.25 = 225.",
            simpeler: "100·1.5·1.5 = 150·1.5 = 225.",
            nogSimpeler: "Twee keer ×1.5: 100→150→225.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Afname met 0.9", tekst: "10% af → g = 0.9. 800·0.9·0.9·0.9 = 583.2." }],
          woorden: [{ woord: "0.9", uitleg: "g bij 10% afname" }],
          theorie: "Afname is NIET lineair: 800−3·80 = 560 is fout.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Jaar 1: 720. Jaar 2: 648. Jaar 3: 583.2." }],
          basiskennis: [{ onderwerp: "verschil lin/exp", uitleg: "elke 10% van een kleinere hoeveelheid" }],
          niveaus: {
            basis: "800·0.9³ = 800·0.729 = 583.2.",
            simpeler: "Drie keer ×0.9. Niet −80 −80 −80.",
            nogSimpeler: "800, 720, 648, 583.2.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Tel halveringen", tekst: "24÷8 = 3 halveringen: 100→50→25→12.5." }],
          woorden: [{ woord: "halveringstijd", uitleg: "tijd om tot helft te zakken" }],
          theorie: "Aantal halveringen = totale tijd ÷ halveringstijd.",
          voorbeelden: [{ type: "voorbeeld", tekst: "T=8j: na 8j helft, na 16j kwart, na 24j 1/8" }],
          basiskennis: [{ onderwerp: "halveren", uitleg: "delen door 2" }],
          niveaus: {
            basis: "3 halveringen: 100/2/2/2 = 12.5 g.",
            simpeler: "100→50→25→12.5.",
            nogSimpeler: "3 keer halveren = door 2, door 2, door 2.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "g = 1 + p", tekst: "8% = 0.08. g = 1.08." }],
          woorden: [{ woord: "groeifactor", uitleg: "100% + groei = factor" }],
          theorie: "Groei % → g via 1 + p/100.",
          voorbeelden: [{ type: "voorbeeld", tekst: "8% → 1.08" }],
          basiskennis: [{ onderwerp: "1 plus", uitleg: "het oude blijft + procent erbij" }],
          niveaus: {
            basis: "8% groei → g = 1.08.",
            simpeler: "1 + 0.08 = 1.08.",
            nogSimpeler: "Erbij = 1 plus.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "macht", uitleg: "2⁵ = 2·2·2·2·2 = 32" }],
          theorie: "Bij N(t) = b·g^t vul t in op de macht.",
          voorbeelden: [{ type: "voorbeeld", tekst: "2¹=2, 2²=4, 2³=8, 2⁴=16, 2⁵=32" }],
          basiskennis: [{ onderwerp: "macht eerst", uitleg: "eerst 2⁵, dan ×50" }],
          niveaus: {
            basis: "2⁵ = 32. 50·32 = 1600.",
            simpeler: "5 keer ×2: 50→100→200→400→800→1600.",
            nogSimpeler: "Rekenmachine: 50 × 2 ^ 5.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "halveringen tellen", uitleg: "totale tijd ÷ halveringstijd" }],
          theorie: "Halveren = delen door 2.",
          voorbeelden: [{ type: "voorbeeld", tekst: "200·(1/2)⁴ = 200/16 = 12.5" }],
          basiskennis: [{ onderwerp: "exponentieel", uitleg: "niet lineair aftrekken!" }],
          niveaus: {
            basis: "4 halveringen: 200/2/2/2/2 = 12.5 g.",
            simpeler: "200→100→50→25→12.5.",
            nogSimpeler: "Door 2, door 2, door 2, door 2.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Rente op rente", tekst: "5000·1.03¹⁰ ≈ 6720." }],
          woorden: [{ woord: "lening", uitleg: "groeit met rente per jaar" }],
          theorie: "Niet aflossen + rente = exponentieel.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1.03¹⁰ ≈ 1.344" }],
          basiskennis: [{ onderwerp: "machtsknop", uitleg: "5000 × 1.03 ^ 10 =" }],
          niveaus: {
            basis: "5000·1.03¹⁰ = €6720.",
            simpeler: "Tien keer ×1.03 op rij.",
            nogSimpeler: "Rekenmachine: 5000 × 1.03 ^ 10.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Jaar 5 = 4 stappen", tekst: "Jaar 1 → jaar 5 = 4 keer ×1.04. 200·1.04⁴ ≈ 234." }],
          woorden: [{ woord: "stappen tellen", uitleg: "jaar 5 ná jaar 1 = 4 jaar later" }],
          theorie: "Let op: \"jaar 5\" vanaf jaar 1 = exponent 4 niet 5.",
          voorbeelden: [{ type: "voorbeeld", tekst: "1.04⁴ ≈ 1.170 → 200·1.170 ≈ 234" }],
          basiskennis: [{ onderwerp: "stappen", uitleg: "verschil tussen jaartal en aantal stappen" }],
          niveaus: {
            basis: "4 stappen van jaar 1 → jaar 5. 200·1.04⁴ ≈ 234 kWh.",
            simpeler: "Vier keer ×1.04 op 200.",
            nogSimpeler: "200 → 208 → 216.3 → 225 → 234.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Afname → g = 0.88", tekst: "12% af → g = 1 − 0.12 = 0.88. 5000·0.88⁵ ≈ 2640." }],
          woorden: [{ woord: "afname-factor", uitleg: "1 − p, hier 0.88" }],
          theorie: "Bij afname is g < 1.",
          voorbeelden: [{ type: "voorbeeld", tekst: "0.88⁵ ≈ 0.528 → 5000·0.528 ≈ 2640" }],
          basiskennis: [{ onderwerp: "factor afleiden", uitleg: "12% af = 88% blijft = 0.88" }],
          niveaus: {
            basis: "5000·0.88⁵ ≈ 2640 vissen.",
            simpeler: "Vijf keer ×0.88.",
            nogSimpeler: "Rekenmachine: 5000 × 0.88 ^ 5.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "verdubbelingstijd", uitleg: "tijd om te verdubbelen" }],
          theorie: "N = b·2^(t/T) bij verdubbelingstijd T.",
          voorbeelden: [{ type: "voorbeeld", tekst: "25 jaar / 5 = 5 verdubbelingen → 2⁵ = 32" }],
          basiskennis: [{ onderwerp: "tellen", uitleg: "verdubbelingen = totale tijd ÷ T" }],
          niveaus: {
            basis: "5 verdubbelingen op 100: 100·32 = 3200.",
            simpeler: "100→200→400→800→1600→3200.",
            nogSimpeler: "Vijf keer keer 2.",
          },
        },
      },
    ],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "12 jaar ×1.06", tekst: "2000·1.06¹² ≈ €4024." }],
          woorden: [{ woord: "samengestelde rente", uitleg: "rente óver rente" }],
          theorie: "1.06¹² ≈ 2.012 — bedrag verdubbelt na ~12 jaar bij 6%.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Vuistregel: bij 6% verdubbelt geld in ~12 jaar." }],
          basiskennis: [{ onderwerp: "groei %", uitleg: "6% × 12 ≠ 72% — door samengesteld effect meer" }],
          niveaus: {
            basis: "2000·1.06¹² ≈ €4024.",
            simpeler: "12 jaar lang ×1.06.",
            nogSimpeler: "Rekenmachine: 2000 × 1.06 ^ 12.",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "halveren", uitleg: "delen door 2" }],
          theorie: "Halveringstijd 5u, 15 uur = 3 halveringen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "200·(0.5)³ = 200/8 = 25" }],
          basiskennis: [{ onderwerp: "tellen", uitleg: "halveringen = totale tijd ÷ halveringstijd" }],
          niveaus: {
            basis: "3 halveringen: 200→100→50→25 mg.",
            simpeler: "Door 2, door 2, door 2.",
            nogSimpeler: "200, dan 100, dan 50, dan 25.",
          },
        },
      },
      { q: "**Groeifactor** 1,05 betekent?", options: ["+5% per stap","+50% per stap","Halvering","×1,5"], answer: 0, wrongHints: [null, "Dat is 1,50.", "Andersom — afname.", "Niet."] },
      { q: "Bevolking 1000, groei 3% per jaar. Na 1 jaar?", options: ["1030","1003","1300","970"], answer: 0, wrongHints: [null, "Niet — 3% niet 0,3%.", "Te veel.", "Dat is afname."] },
      { q: "**Halveringstijd** is?", options: ["Tijd voordat hoeveelheid halveert","Tijd om te verdubbelen","Helft van een dag","Helft van de groei"], answer: 0, wrongHints: [null, "Andersom.", "Niet relevant.", "Niet."] },
      { q: "Rente 5% over €1000 voor 2 jaar (samengesteld). Saldo?", options: ["€1102,50","€1100","€1050","€1500"], answer: 0, wrongHints: [null, "Niet — samengesteld geeft meer.", "Dat is 1 jaar.", "Te veel."] },
      { q: "**Groeifactor 0,8** betekent?", options: ["−20% per stap (afname)","+20% per stap","Halveren","Verdubbelen"], answer: 0, wrongHints: [null,"Boven 1.","Veel sterker afname.","Veel sterker toename."] },
      { q: "Formule **eindwaarde** bij groei: A = ?", options: ["A₀ × g^t","A₀ + g","A₀ × t","A₀ + t × g"], answer: 0, wrongHints: [null,"Lineair.","Verkeerd.","Lineair."] },
      { q: "**Verdubbelingstijd** is de tijd waarin?", options: ["Hoeveelheid verdubbelt","Hoeveelheid halveert","Niets gebeurt","Verandering 0%"], answer: 0, wrongHints: [null,"Halveringstijd.","Wel iets.","Wel iets."] },
      { q: "**2⁵** = ?", options: ["32","10","16","64"], answer: 0, wrongHints: [null,"Tegenovergesteld.","2⁴.","2⁶."] },
      { q: "Bij **groeifactor 1** verandert er?", options: ["Niets","Verdubbelt","Halveert","Stijgt 100%"], answer: 0, wrongHints: [null,"Dat is 2.","Tegenovergesteld.","Dat is 2."] },
      { q: "**Exponentiële groei** ziet er in grafiek uit als?", options: ["Steeds steiler omhoog","Rechte lijn","Steeds vlakker","Daling"], answer: 0, wrongHints: [null,"Lineair.","Niet groei.","Tegenovergesteld."] },
      { q: "Auto verliest 15% waarde per jaar. Groeifactor?", options: ["0,85","1,15","0,15","1,85"], answer: 0, wrongHints: [null,"Toename.","Niet groeifactor zelf.","Niet."] },
      { q: "**Open vraag**: bevolking 500, groei 10% per jaar. Hoeveel inwoners na 1 jaar? Typ getal.", kind: "open", acceptedAnswers: ["550"], numericTolerance: 0, explanation: "500 × 1,1 = 550." },
      { q: "**Open vraag**: bereken 3⁴. Typ alleen getal.", kind: "open", acceptedAnswers: ["81"], numericTolerance: 0, explanation: "3⁴ = 3×3×3×3 = 81." },
    ],
  },
];
