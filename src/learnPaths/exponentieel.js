...
<text x="150" y="170" text-anchor="middle" fill="${COLORS.muted}" font-size="11" font-family="Arial" font-style="italic">je beheerst het 🎓</text>
    ...
    checks: [
      ...
      { q: "**Groeifactor** 1,05 betekent?", options: ["+5% per stap","+50% per stap","Halvering","×1,5"], answer: 0, wrongHints: [null,"Klopt — 1,05 = 100% + 5%.","Dat is 1,50.","Andersom — afname.","Niet."] },
      { q: "Bevolking 1000, groei 3% per jaar. Na 1 jaar?", options: ["1030","1003","1300","970"], answer: 0, wrongHints: [null,"Klopt — × 1,03.","Niet — 3% niet 0,3%.","Te veel.","Dat is afname."] },
      { q: "**Halveringstijd** is?", options: ["Tijd voordat hoeveelheid halveert","Tijd om te verdubbelen","Helft van een dag","Helft van de groei"], answer: 0, wrongHints: [null,"Klopt — bv. radioactief verval.","Andersom.","Niet relevant.","Niet."] },
      { q: "Rente 5% over €1000 voor 2 jaar (samengesteld). Saldo?", options: ["€1102,50","€1100","€1050","€1500"], answer: 0, wrongHints: [null,"Klopt — × 1,05 × 1,05.","Niet — samengesteld geeft meer.","Dat is 1 jaar.","Te veel."] },
    ],
  },
];
