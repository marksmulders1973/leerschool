...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "Sleutelzin: 'Please ensure that it is not **spread to other sites** by checking your clothing and pets'. Doel = verspreiding stoppen. Plant is NIET native (uit New Zealand) = exotisch.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 2: **'School in the US typically starts even BEFORE 8am, considerably EARLIER than in many other Western countries.'** UK-onderzoek vergelijkt met UK-school (8:30) — VS is dus nog vroeger = nog meer slaaptekort.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Tekst: 'taking **Eddie's ideas** of how to encourage charitable acts to improve well-being. For example, **\"We can buy toys for children that don't have any,\" Eddie wrote.**' De quote is Eddie's suggestie.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 1: 'kept it simple' + 'vintage 1960s Mister Softee truck'. Alinea 2: 'aggressively simple, **old-style** options — chocolate, vanilla or twist'. = traditioneel concept. Andere opties verzinnen kenmerken die NIET in tekst staan.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Joe's quote: '**a $4 cone costs me 30 cents to make — pay me, that's how this works.**' Hij vroeg zich af: waarom willen mensen GRATIS iets dat zo goedkoop te maken is + waarom verwachten ze dat als prominentie-claim genoeg is?",
