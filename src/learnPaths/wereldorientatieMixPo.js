// Leerpad: Wereldoriëntatie Doorstroomtoets-stijl mix — groep 7-8
// Gemengd geschiedenis + aardrijkskunde + natuur in Doorstroomtoets-stijl.
// 5 stappen × ~5 checks.
  ...
  // ─── B. Aardrijkskunde NL + wereld ────────────────────────
  {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Brexit 2020", tekst: "**27 EU-lidstaten** sinds Verenigd Koninkrijk uitgetreden 31 jan 2020 (Brexit). Voor Brexit: 28. **Eurozone**: 21 landen (sinds Bulgarije 2026). Brussel = hoofdstad EU. Andere instellingen in Straatsburg + Luxemburg + Frankfurt (ECB)." }],
...
const wereldorientatieMixPo = {
  ...
  title: "Wereldoriëntatie mix (groep 7-8 Doorstroomtoets-stijl)",
  emoji: "🌍",
  level: "groep7-8",
  ...
  sloThema: "Wereldoriëntatie groep 7-8 — Doorstroomtoets-stijl gemixed eindtoets",
  prerequisites: [
