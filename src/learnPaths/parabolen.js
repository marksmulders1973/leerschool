    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5.", simpeler: "Eerste getal.", nogSimpeler: "5." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Ja.", simpeler: "5 = 5 dus ja.", nogSimpeler: "Ja." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "U-vorm.", simpeler: "Letter U.", nogSimpeler: "U." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "-9.", simpeler: "9 dan negatief.", nogSimpeler: "Min." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Dal.", simpeler: "Plus = dal.", nogSimpeler: "Dal." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "7.", simpeler: "Getal voor x².", nogSimpeler: "7." },
        },
      },
      {
        q: "In y = x², wat is a?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1.", simpeler: "Stiekem 1.", nogSimpeler: "Eén." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "32.", simpeler: "16 × 2.", nogSimpeler: "32." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "y = 4x².", simpeler: "Grootste a.", nogSimpeler: "4." },
        },
      },
      {
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "5.", simpeler: "0 + 5.", nogSimpeler: "5." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "6.", simpeler: "Voor x.", nogSimpeler: "6." },
        },
      },
      {
        q: "In y = x² + 5, wat is b?",
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0.", simpeler: "Geen x-term.", nogSimpeler: "0." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0.", simpeler: "y = 0.", nogSimpeler: "Nul." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "-4 en 4.", simpeler: "Plus en min 4.", nogSimpeler: "±4." },
        },
      },
    ],
  },
