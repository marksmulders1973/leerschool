    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "x + 3 met x = 6", tekst: "Vul de waarde van x in: x wordt 6. Dan staat er 6 + 3 = 9. Vervangen + uitrekenen, in 2 stappen." }],
          woorden: [{ woord: "x", uitleg: "doosje voor een onbekend getal" }],
          theorie: "Eerst: vul de waarde in. Daarna: reken uit.",
          voorbeelden: [{ type: "voorbeeld", tekst: "x = 10: x + 3 = 13. x = 2: x + 3 = 5" }],
          basiskennis: [{ onderwerp: "optellen", uitleg: "+ betekent samenvoegen" }],
          niveaus: { basis: "9.", simpeler: "6 + 3.", nogSimpeler: "Optellen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "kwadraat", uitleg: "ander woord voor 'tot de tweede macht'" }],
          theorie: "Het 2-tje is geen los getal om mee te rekenen — het is een instructie.",
          voorbeelden: [{ type: "voorbeeld", tekst: "3² = 9. 5² = 25. 10² = 100" }],
          basiskennis: [{ onderwerp: "vermenigvuldigen", uitleg: "× met zichzelf" }],
          niveaus: { basis: "16.", simpeler: "4 × 4.", nogSimpeler: "4 keer 4." },
        },
      },
      {
        q: "Stel x = 6. Wat is x²?",
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "x²", uitleg: "x maal x" }],
          theorie: "x² = x · x. Niet x + 2 of x · 2.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Tafel-van-6: 6 × 6 = 36" }],
          basiskennis: [{ onderwerp: "tafels", uitleg: "leer kwadraten 1²-12² uit hoofd" }],
          niveaus: { basis: "36.", simpeler: "6 × 6.", nogSimpeler: "Zes keer zes." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "y = x + 5 met x = 3", tekst: "Vervang x door 3: y = 3 + 5 = 8. Eerst vervangen, dan rekenen." }],
          woorden: [{ woord: "regel", uitleg: "formule die y bepaalt uit x" }],
          theorie: "Een regel = een recept: doe X met de invoer.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x + 5: x=0→y=5. x=1→y=6. x=10→y=15" }],
          basiskennis: [{ onderwerp: "vervangen + rekenen", uitleg: "altijd 2 stappen" }],
          niveaus: { basis: "8.", simpeler: "3 + 5.", nogSimpeler: "Optellen." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "kwadraat", uitleg: "tweede macht" }],
          theorie: "Hoe groter x, hoe veel sneller y groeit. 7² is al 49, terwijl 2² maar 4 is.",
          voorbeelden: [{ type: "voorbeeld", tekst: "7² = 49. 8² = 64. 9² = 81. 10² = 100" }],
          basiskennis: [{ onderwerp: "kwadraat groeit snel", uitleg: "verdubbelen x = 4× y" }],
          niveaus: { basis: "49.", simpeler: "7 × 7.", nogSimpeler: "Tafel van 7." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "coördinaat", uitleg: "locatie als (x, y)" }],
          theorie: "Geheugensteun: x voor y, alfabet-volgorde.",
          voorbeelden: [{ type: "voorbeeld", tekst: "(3, 4): 3 rechts, 4 omhoog. (-1, 2): 1 links, 2 omhoog" }],
          basiskennis: [{ onderwerp: "volgorde belangrijk", uitleg: "(5,2) ≠ (2,5)" }],
          niveaus: { basis: "5.", simpeler: "Eerste getal.", nogSimpeler: "Eerste getal. → 5." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "lijn", uitleg: "verzameling punten die aan een regel voldoen" }],
          theorie: "Een punt (a, b) ligt op de lijn als invullen van x = a → y = b geeft.",
          voorbeelden: [{ type: "voorbeeld", tekst: "(3,3) ligt op y=x. (3,4) niet (want 3≠4)" }],
          basiskennis: [{ onderwerp: "test door invullen", uitleg: "ja als regel klopt" }],
          niveaus: { basis: "Ja.", simpeler: "5 = 5 dus ja.", nogSimpeler: "5 = 5 dus ja. → Ja." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Tel: -3, -2, -1, 0, 1, 2, 3", tekst: "7 getallen — 3 negatieve, de nul, en 3 positieve. Vergeet x = 0 niet en tel ook de negatieve mee." }],
          woorden: [{ woord: "inclusief", uitleg: "beide einden meetellen" }],
          theorie: "Van n tot m inclusief: (m - n + 1) getallen. Hier (3 - (-3) + 1) = 7.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Van -2 tot 2: 5 getallen (-2,-1,0,1,2)" }],
          basiskennis: [{ onderwerp: "+1 voor inclusief", uitleg: "anders mis je er één" }],
          niveaus: { basis: "7.", simpeler: "Tel ze: 7.", nogSimpeler: "Zeven." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "Punten verbinden → U-vorm", tekst: "Als je de punten uit de tabel y = x² vloeiend verbindt, krijg je een U-vorm. Deze vorm heet een PARABOOL." }],
          woorden: [{ woord: "parabool", uitleg: "U-vormige kromme" }],
          theorie: "Vloeiende kromme = geen hoeken, geen scherpe kantelpunten.",
          voorbeelden: [{ type: "voorbeeld", tekst: "Baan van gegooide bal, water in fontein, schotelantenne" }],
          basiskennis: [{ onderwerp: "U-vorm", uitleg: "symmetrisch rond top" }],
          niveaus: { basis: "U-vorm.", simpeler: "Letter U.", nogSimpeler: "Letter U. → U." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "dal", uitleg: "U-vormig laagste punt" }],
          theorie: "Top = uiterste punt. Dal: laagste. Berg: hoogste.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x²: dalparabool, top op (0, 0) — laagste punt" }],
          basiskennis: [{ onderwerp: "dal vs berg", uitleg: "verschillende top-positie" }],
          niveaus: { basis: "Onderaan.", simpeler: "Laagste punt.", nogSimpeler: "Bodem." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "y = -x²: eerst x², dan minteken", tekst: "Twee stappen: 1) 3² = 9. 2) Het minteken voor x² maakt het uiteindelijk -9. -x² betekent: -(x²), niet (-x)²." }],
          woorden: [{ woord: "−x²", uitleg: "min vóór = negatief resultaat" }],
          theorie: "Verschil: -x² is altijd ≤ 0. (-x)² is altijd ≥ 0. Hier hebben we -x² → -9.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = -x² bij x=4: y = -16" }],
          basiskennis: [{ onderwerp: "volgorde", uitleg: "kwadraat eerst, dan minteken" }],
          niveaus: { basis: "-9.", simpeler: "9 dan negatief.", nogSimpeler: "9 dan negatief. → Min." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "−7x²: minteken = berg", tekst: "Bij negatief getal vóór x² (zoals -7) krijg je een bergparabool (∩-vorm). Het minteken keert de U om naar een berg." }],
          woorden: [{ woord: "bergparabool", uitleg: "omgekeerde U, ∩-vorm" }],
          theorie: "Regel: a positief = dal. a negatief = berg.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = -2x²: berg. y = -0,5x²: ook berg" }],
          basiskennis: [{ onderwerp: "minteken keert om", uitleg: "U → ∩" }],
          niveaus: { basis: "Berg.", simpeler: "Min = berg.", nogSimpeler: "Berg." },
        },
      },
      {
        q: "y = 4x². Dal of berg?",
        ...
        uitlegPad: {
          stappen: [{ titel: "4x²: plus = dal", tekst: "Bij positief getal (4) vóór x² krijg je een dalparabool (U-vorm). Geen minteken, dus geen berg." }],
          woorden: [{ woord: "dalparabool", uitleg: "U-vorm, opent naar boven" }],
          theorie: "Onthoud: kijk alleen naar het TEKEN voor x², niet naar de grootte.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = 0,1x²: dal. y = 100x²: dal" }],
          basiskennis: [{ onderwerp: "geen min = plus", uitleg: "ontbreken minteken" }],
          niveaus: { basis: "Dal.", simpeler: "Plus = dal.", nogSimpeler: "Plus = dal. → Dal." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "a = getal voor x²", tekst: "In y = 7x²: de a is het getal dat direct voor x² staat. Hier a = 7." }],
          woorden: [{ woord: "coëfficiënt", uitleg: "vermenigvuldigend getal" }],
          theorie: "Bij y = ax² + bx + c is a het getal vóór x², b vóór x, c los achteraan.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = 3x²: a=3. y = -x²: a=-1. y = ½x²: a=½" }],
          basiskennis: [{ onderwerp: "voor x²", uitleg: "direct ervoor" }],
          niveaus: { basis: "7.", simpeler: "Getal voor x².", nogSimpeler: "Getal voor x². → 7." },
        },
      },
      {
        q: "In y = x², wat is a?",
        ...
        uitlegPad: {
          stappen: [{ titel: "Onzichtbare 1 voor x²", tekst: "y = x² is hetzelfde als y = 1·x². De 1 schrijven we niet op, maar staat er stiekem. Dus a = 1." }],
          woorden: [{ woord: "verborgen 1", uitleg: "wordt weggelaten in notatie" }],
          theorie: "Als er geen getal staat voor x², is a = 1.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = -x² betekent y = -1·x², dus a = -1" }],
          basiskennis: [{ onderwerp: "1 als default", uitleg: "1 × iets = iets" }],
          niveaus: { basis: "1.", simpeler: "Stiekem 1.", nogSimpeler: "Stiekem 1. → Eén." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "volgorde", uitleg: "kwadraat eerst, dan a" }],
          theorie: "Volgorde-bewerkingen: machten eerst, dan vermenigvuldigingen.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = 3x² bij x=2: 2²=4, dan 3·4=12" }],
          basiskennis: [{ onderwerp: "Meneer Van Dale", uitleg: "machten vóór × en /" }],
          niveaus: { basis: "32.", simpeler: "16 × 2.", nogSimpeler: "16 × 2. → 32." },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "breed", uitleg: "flauw oplopend" }],
          theorie: "Bij a tussen 0 en 1: brede flauwe parabool.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = ¼x²: zeer breed. y = 5x²: zeer smal" }],
          basiskennis: [{ onderwerp: "kleinste positieve a", uitleg: "= breedst" }],
          niveaus: { basis: "y = ⅓x².", simpeler: "Kleinste a.", nogSimpeler: "Een derde." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "32.", simpeler: "64 / 2.", nogSimpeler: "Helft van 64." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "x = 0", uitleg: "y = c bij x = 0" }],
          theorie: "Bij x = 0 is x² altijd 0 — y wordt dan precies c.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² + 7 bij x=0: y = 7. y = x² - 3 bij x=0: y = -3" }],
          basiskennis: [{ onderwerp: "c-waarde", uitleg: "y-as-snijpunt" }],
          niveaus: { basis: "5.", simpeler: "0 + 5.", nogSimpeler: "0 + 5. → 5." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "y = x² − 4 met x=0", tekst: "0² = 0. Dan -4 → y = -4. Het minteken hoort bij de 4, niet bij x²." }],
          woorden: [{ woord: "minteken", uitleg: "aftrekken" }],
          theorie: "Bij x = 0: y = c, ook als c negatief is.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² - 9 bij x=0: y = -9" }],
          basiskennis: [{ onderwerp: "negatieve c", uitleg: "y kan onder de x-as" }],
          niveaus: { basis: "-4.", simpeler: "0 − 4.", nogSimpeler: "Min vier." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "c = -6 bij y = x² − 6", tekst: "Het minteken hoort bij de 6. Dus c = -6. Niet +6, want dan zou y = x² + 6 staan." }],
          woorden: [{ woord: "negatieve c", uitleg: "minteken hoort erbij" }],
          theorie: "c is het LOSSE getal achter x², met zijn teken.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² + 3: c=3. y = x² - 8: c=-8" }],
          basiskennis: [{ onderwerp: "teken meenemen", uitleg: "− hoort bij getal" }],
          niveaus: { basis: "-6.", simpeler: "Min zes.", nogSimpeler: "Negatief." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "verticale verschuiving", uitleg: "+c schuift omhoog, −c omlaag" }],
          theorie: "Top van y = x² + c zit altijd op de y-as (x = 0), op hoogte c.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² + 4: top (0, 4). y = x² - 5: top (0, -5)" }],
          basiskennis: [{ onderwerp: "(0, c)", uitleg: "x = 0, y = c" }],
          niveaus: { basis: "(0, 9).", simpeler: "9 omhoog.", nogSimpeler: "(0, 9)." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "uiterste punt", uitleg: "hoogste of laagste" }],
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "verschoven top", uitleg: "verschuiving zorgt voor andere top-locatie" }],
          theorie: "Bij y = x² + c is de top altijd (0, c). Hier c = -8.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² - 3: top (0, -3). y = x² + 7: top (0, 7)" }],
          basiskennis: [{ onderwerp: "c met teken", uitleg: "minteken meenemen" }],
          niveaus: { basis: "(0, -8).", simpeler: "8 omlaag.", nogSimpeler: "(0, -8)." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "b = getal voor x (zonder kwadraat)", tekst: "In y = 2x² + 6x + 1: a=2 (voor x²), b=6 (voor x), c=1 (los). De b is het getal vóór de x zonder kleine 2." }],
          woorden: [{ woord: "drie coëfficiënten", uitleg: "a, b, c — drie verschillende plekken" }],
          theorie: "y = ax² + bx + c — standaardvorm.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = 3x² - 5x + 2: a=3, b=-5, c=2" }],
          basiskennis: [{ onderwerp: "voor x zonder kwadraat", uitleg: "tweede term" }],
          niveaus: { basis: "6.", simpeler: "Voor x.", nogSimpeler: "Voor x. → 6." },
        },
      },
      {
        q: "In y = x² + 5, wat is b?",
        ...
        uitlegPad: {
          stappen: [{ titel: "Geen x-term = b = 0", tekst: "In y = x² + 5 staat geen losse x-term (geen bx). Dat betekent b = 0. De parabool is dan dezelfde als y = x² + 0x + 5." }],
          woorden: [{ woord: "ontbreken x-term", uitleg: "b = 0" }],
          theorie: "Als de bx-term mist, schrijven we 'm gewoon niet — maar b = 0.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² + 7: b=0. y = x²: a=1, b=0, c=0" }],
          basiskennis: [{ onderwerp: "0 × x = 0", uitleg: "0 wordt weggelaten" }],
          niveaus: { basis: "0.", simpeler: "Geen x-term.", nogSimpeler: "Geen x-term. → 0." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "x_top = −b/(2a) = −6/2 = −3", tekst: "Voor y = x² + 6x: a=1, b=6. Vul in: x_top = −6 / (2×1) = −6/2 = −3." }],
          woorden: [{ woord: "topformule", uitleg: "x-coördinaat van top" }],
          theorie: "Vergeet het minteken in −b niet, ook als b positief is.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² + 4x: x_top = -4/2 = -2" }],
          basiskennis: [{ onderwerp: "delen", uitleg: "−b boven, 2a onder" }],
          niveaus: { basis: "-3.", simpeler: "-6/2.", nogSimpeler: "Min drie." },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "dubbele min", uitleg: "−(−x) = +x" }],
          theorie: "Bij negatieve b wordt −b positief. Pas op met de tekens.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² - 8x: x_top = 8/2 = 4. y = 2x² - 4x: x_top = 4/4 = 1" }],
          basiskennis: [{ onderwerp: "min × min = plus", uitleg: "twee minnen op" }],
          niveaus: { basis: "2.", simpeler: "4/2.", nogSimpeler: "Twee." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "nulpunt", uitleg: "punt waar y = 0" }],
          theorie: "Om nulpunten te vinden: stel y = 0 in en los op voor x.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² - 4: nulpunten waar 0 = x² - 4 → x = ±2" }],
          basiskennis: [{ onderwerp: "x-as", uitleg: "y is daar overal 0" }],
          niveaus: { basis: "0.", simpeler: "y = 0.", nogSimpeler: "y = 0. → Nul." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          woorden: [{ woord: "wortel", uitleg: "omgekeerd van kwadraat" }],
          theorie: "x² = positief getal heeft altijd 2 oplossingen: ±√getal.",
          voorbeelden: [{ type: "voorbeeld", tekst: "x² = 25 → x = ±5. x² = 9 → x = ±3" }],
          basiskennis: [{ onderwerp: "twee oplossingen", uitleg: "positief én negatief" }],
          niveaus: { basis: "-4 en 4.", simpeler: "Plus en min 4.", nogSimpeler: "Plus en min 4. → ±4." },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "x² + 1 = 0 onmogelijk", tekst: "Stel y = 0: x² + 1 = 0 → x² = -1. Maar x² is altijd ≥ 0 — kan nooit -1 zijn. Dus geen oplossing. 0 nulpunten." }],
          woorden: [{ woord: "zwevende parabool", uitleg: "raakt x-as niet" }],
          theorie: "Bij y = x² + positief getal: parabool ligt boven x-as, raakt 'm niet.",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² + 4 zweeft 4 boven x-as: geen nulpunten" }],
          basiskennis: [{ onderwerp: "x² ≥ 0", uitleg: "fundamentele regel" }],
          niveaus: { basis: "0.", simpeler: "Geen.", nogSimpeler: "Nul nulpunten." },
        },
      },
      {
        ...
        uitlegPad: {
          stappen: [{ titel: "x² = 36 → x = ±6", tekst: "y = x² − 36: stel y = 0 → x² = 36 → x = ±6. Twee nulpunten." }],
          woorden: [{ woord: "x² − getal", uitleg: "altijd 2 nulpunten als getal > 0" }],
          theorie: "Vuistregel: y = x² − positief getal → 2 nulpunten (snijdt x-as 2×).",
          voorbeelden: [{ type: "voorbeeld", tekst: "y = x² - 1: x = ±1. y = x² - 100: x = ±10" }],
          basiskennis: [{ onderwerp: "snijpunten", uitleg: "links + rechts van top" }],
