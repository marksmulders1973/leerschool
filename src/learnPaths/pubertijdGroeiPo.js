...
// toets-relevant lichaam. 1F. 4 stappen.
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: puberteit komt tegenwoordig **eerder** dan vroeger (1900: rond 14-15, nu: 11). Oorzaak: betere voeding + meer lichaamsgewicht. Genetisch + omgeving samen.",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip: hormonen ≠ vitamines. Vitamines = stoffen die je via voeding binnen krijgt. Hormonen = stoffen die je lichaam zelf maakt om signalen te geven.",
          voorbeelden: [
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: 85% van pubers heeft puistjes. Heel normaal, gaat meestal vanzelf weg rond ~20 jaar. Bij erge acne: huisarts → soms medicijn (Roaccutane bv).",
          voorbeelden: [
      ...
      { q: "Tot welke leeftijd **brein ontwikkelt**?", options: ["~25 jr", "12 jr", "8 jr", "60 jr"], answer: 0, wrongHints: [null, "Te jong.", "Te jong.", "Te oud."] },
      {
        ...
        uitlegPad: {
          stappen: [
            ...
            { titel: "Toets-feit: lengte-eindstand", tekst: "Je **uiteindelijke lengte** wordt voor **80% door genen** bepaald (van je ouders). Voeding + slaap helpen om je 'genetisch potentieel' te bereiken.\n\n**Vuistregel**: tel lengte vader + moeder, deel door 2.\n• Voor jongens: + ~7 cm\n• Voor meisjes: − ~7 cm\nDit geeft een schatting (kan 5-10 cm afwijken)." },
          ],
          woorden: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [
            ...
            { titel: "Toets-feit: 90% van botten gevormd vóór 18", tekst: "Je piek-botmassa wordt bereikt rond **18-25 jaar**. Daarna kun je nog wel onderhouden maar nieuwe bot-mass opbouwen wordt steeds moeilijker. **NU goed eten + bewegen = sterke botten levenslang**.\n\nNL-aanbeveling voor kinderen 9-13 jr: **1100 mg calcium per dag** = ~3 zuivelporties (melk, yoghurt, kaas)." },
          ],
          woorden: [
          ...
          basiskennis: [{ onderwerp: "Botten bouwen = nu", uitleg: "Toets-feit: je hebt 1 kans in je leven om sterke botten op te bouwen — tussen 10-20 jaar. Daarna alleen onderhoud mogelijk." }],
