...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "EU-interne markt heeft 4 vrijheden: goederen, diensten, kapitaal, **personen**. Vrij verkeer van personen = elk EU-burger mag werken, wonen, studeren in ander EU-land zonder visum.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**CPB (Centraal Planbureau)** is het instituut dat alle regeringsplannen + verkiezingsprogramma's doorrekent op economische effecten. CBS = statistiek (cijfers van verleden). SER = sociaal-economisch advies. UWV = uitvoering uitkeringen.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**Modaal** komt van 'modus' = de waarde die het vaakst voorkomt in een verdeling. Modaal inkomen = inkomen dat de meeste Nederlanders verdienen (~€37.000 bruto in 2022). Anders dan **gemiddelde** (alle inkomens opgeteld ÷ aantal).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "**UWV** = Uitvoeringsinstituut **Werknemers**Verzekeringen — voert werknemersverzekeringen uit (WW, WIA, ZW). **SVB** doet volksverzekeringen (AOW, AKW). Wim was werknemer + werkloos = UWV is zijn instantie voor WW.",
