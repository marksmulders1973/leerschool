    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "20+273=293 K.", simpeler: "Celsius + 273 = Kelvin.", nogSimpeler: "293 K" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "−273,15 °C.", simpeler: "Min 273 graden = nulpunt Kelvin.", nogSimpeler: "−273" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Kelvin.", simpeler: "Altijd Kelvin in formules.", nogSimpeler: "K" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Hoog → laag T.", simpeler: "Warmte gaat naar koud, niet andersom.", nogSimpeler: "Hoog→laag" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Beide dezelfde T.", simpeler: "Water wordt warmer tot kamer-T.", nogSimpeler: "Evenwicht" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Q≈1,5·10⁵ J.", simpeler: "Massa × c × ΔT = ~146 kJ.", nogSimpeler: "~1,5·10⁵" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "T blijft 0 °C tijdens smelten.", simpeler: "Energie gaat in smelten, niet opwarmen.", nogSimpeler: "0°C blijft" },
        },
      },
      {
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "0,1·2260=226.", simpeler: "Massa × verdampingswarmte = 226 kJ.", nogSimpeler: "226" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Verdamping kost veel energie.", simpeler: "Zweet verdampt → energie uit huid → koel.", nogSimpeler: "L_v" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "p₂=2·10⁵.", simpeler: "V/2 → p ×2.", nogSimpeler: "2·10⁵" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "T↑ → p↑ → barst.", simpeler: "Warm gas wil meer ruimte; bus barst.", nogSimpeler: "p↑" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "22,4 L.", simpeler: "1 mol = 22,4 L bij standaard.", nogSimpeler: "22,4" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "V neemt toe (lagere p).", simpeler: "Minder buiten-druk → ballon zet uit.", nogSimpeler: "V↑" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "n≈0,40 mol.", simpeler: "pV/(RT) = 0,4 mol.", nogSimpeler: "0,4" },
        },
      },
    ],
  },
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "500−200=300.", simpeler: "Warmte in min arbeid uit = 300 J.", nogSimpeler: "+300" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Straling door vacuüm.", simpeler: "Vacuüm: alleen EM-golven.", nogSimpeler: "Straling" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Adiabatische compressie.", simpeler: "Snel persen → warm zonder warmte-uit.", nogSimpeler: "Compressie" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Glaswol = isolator.", simpeler: "Glaswol heeft lucht in poriën → slecht geleiden.", nogSimpeler: "Glaswol" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "COP=4.", simpeler: "Warmtepomp factor 4 zuiniger.", nogSimpeler: "COP" },
        },
      },
    ],
  },
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "1−300/600=0,5.", simpeler: "Helft van energie wordt arbeid.", nogSimpeler: "50%" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Warm = ijler = opwaarts.", simpeler: "Heet gas weegt minder; ballon stijgt.", nogSimpeler: "Archimedes" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Vacuüm + reflectie.", simpeler: "Alle drie warmte-stroming geblokkeerd.", nogSimpeler: "3 in 1" },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "2⁴=16×.", simpeler: "Vierde macht: 2·2·2·2 = 16.", nogSimpeler: "16×" },
        },
      },
    ],
  },
