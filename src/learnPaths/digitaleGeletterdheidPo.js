...
// Sluit op media-wijsheid. Toets-burgerschap. 1F. 4 stappen.
...
const steps = [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip computer-onderdelen: CPU = brein. RAM = werktafel. SSD = archief. GPU = grafische chip (voor games + AI). Verschillende functies, allemaal nodig.",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip veiligheid: ALTIJD checken of er HTTPS + slotje staat voordat je: wachtwoord intypt, gegevens deelt, of betaalt online. Geen HTTPS = niet veilig.",
          voorbeelden: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit AI: niet 1 ding, maar verschillende modellen. ChatGPT = bekendste. Gebruikt door honderden miljoenen mensen voor school, werk, plezier. Pas op met huiswerk-opdrachten: scholen detecteren AI-tekst steeds beter.",
          voorbeelden: [
          ...
          niveaus: {
            basis: "AI-chatbot die tekst maakt en vragen beantwoordt.",
            simpeler: "Computer-programma waarmee je kan 'chatten' alsof met mens.",
            nogSimpeler: "Slimme AI-chatter",
          },
        },
      },
    ],
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-tip betrouwbaarheid: vraag JE 4 dingen: 1) Wie schreef het? 2) Wanneer? 3) Welke bronnen geven ze? 4) Klopt het met andere bronnen? Antwoord op alle 4 → vertrouwen.",
          voorbeelden: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Heel slecht.", "Top-slecht.", "Niet."],
        uitlegPad: {
          stappen: [
          ...
          theorie: "Toets-feit: '123456' is al jaren **#1 meest-gebruikt wachtwoord ter wereld** (volgens NordPass-rapport). Hackers kraken het direct. Gebruik liever een lange zin + 2FA waar mogelijk.",
          voorbeelden: [
          ...
          niveaus: {
            basis: "Lange zin met mix = sterk.",
            simpeler: "Hoe LANGER en GEMENGDER, hoe sterker. 'Mijn-kat-eet-graag-vis-2024!' = top.",
            nogSimpeler: "Lang + mix",
          },
        },
      },
      {
        ...
        uitlegPad: {
          ...
          theorie: "Toets-feit: phishing is **#1 manier** waarop accounts worden gehackt. NL heeft veel phishing via WhatsApp ('mam, ik heb een nieuw nummer en geld nodig'). Altijd via bekende kanaal controleren bij twijfel.",
          voorbeelden: [
          ...
          niveaus: {
            basis: "Nep-email/sms om gegevens te stelen.",
            simpeler: "Oplichters sturen een vals bericht dat lijkt op je bank — om je wachtwoord/pincode te stelen.",
            nogSimpeler: "Nep-email",
          },
        },
      },
      {
  ...
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        uitlegPad: {
          stappen: [
            ...
            { titel: "Toets-feit: privacy + AVG", tekst: "**Sinds 2018** is in EU de **AVG-wet** (Algemene Verordening Gegevensbescherming): websites MOETEN vragen voor tracking-cookies. Je MAG altijd weigeren. Pers­oonlijke gegevens worden beschermd. Bij overtreding: boetes tot **20 miljoen euro**." },
          ],
          woorden: [
          ...
          niveaus: { basis: "Bestandje van website.", simpeler: "Cookie = bestandje dat website op je computer zet om je te herkennen. Bv. om in te loggen, taal te onthouden, of jou advertenties te tonen.", nogSimpeler: "Bestandje" },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — virus is schadelijk programma.", "Wachtwoord is jouw geheim.", "Kabel is hardware."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: { basis: "Stappenplan computer.", simpeler: "Algoritme = stappenplan dat computer volgt om iets te beslissen of berekenen. Bv. welke TikTok-video je ziet of welke route Google Maps kiest.", nogSimpeler: "Stappenplan" },
        },
      },
      ...
      { q: "Welke kleur slotje in browser betekent **veilig**?", options: ["Groen / dichtgesloten","Rood","Niet relevant","Geel"], answer: 0, wrongHints: [null, "Gevaar.", "Wel.", "Soms waarschuwing."] },
    ],
  },
];
...
const digitaleGeletterdheidPo = {
  ...
  title: "Digitale geletterdheid (Doorstroomtoets groep 6-8)",
  emoji: "💻",
  level: "groep6-8",
  ...
  intro:
    "Digitale geletterdheid voor Doorstroomtoets groep 6-8 — computer + internet basis (CPU/HTTPS/WWW/Tim Berners-Lee) + slim zoeken (Google-trucs + bronnen-controle + AI-hallucinatie) + veiligheid (wachtwoord + 2FA + phishing + cyberpesten + AVG-privacy). Sluit op mediawijsheid. ~15 min.",
  triggerKeywords: [
