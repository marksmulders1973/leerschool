  ...
  },
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "In het ISS wonen astronauten — James Webb is een kijk-instrument. Wat doet het?", "Een raket brengt dingen omhoog — wat werd er in 2021 zélf omhoog gebracht?", "Grapje-optie — waarmee kijk je diep het heelal in?"],
      },
    ],
  },
  {
    ...
    checks: [
      ...
      { q: "**ISS** = ?", options: ["Internationaal ruimtestation in baan", "Raket", "Maan", "Mars-rover"], answer: 0, wrongHints: [null, "Een raket vliegt op en neer — waar verblijven astronauten maandenlang?", "De maan is een natuurlijk hemellichaam — het ISS is door mensen gebouwd.", "Rovers rijden op een planeet — waar draait het ISS omheen?"] },
      ...
      { q: "Welke **planeet** heeft **opvallende ringen**?", options: ["Saturnus", "Aarde", "Mars", "Mercurius"], answer: 0, wrongHints: [null, "De aarde heeft alleen een maan — denk aan een planeet verder weg.", "Mars is beroemd om zijn rode kleur, niet om ringen.", "Mercurius is klein en kaal, vlak bij de zon — zoek juist verder van de zon."] },
...
const ruimtevaartPo = {
  id: "ruimtevaart-po",
  title: "Ruimtevaart (Doorstroomtoets groep 6-8)",
  emoji: "🚀",
  level: "groep6-8",
  subject: "natuur",
  referentieNiveau: "1F",
  ...
  intro:
    "Ruimtevaart voor Doorstroomtoets groep 6-8 — hoe raket werkt (Newton's 3e wet, brandstof, lanceerlocaties) + maanlanding Apollo 11 (Armstrong/Aldrin 1969) + ISS (sinds 1998, André Kuipers) + Mars-rovers + SpaceX/Musk + James Webb telescoop + Artemis (terug naar maan 2026). Sluit op sterren-planeten. ~15 min.",
  triggerKeywords: [
