...
const steps = [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Tweede.", "Eerst in ruimte (niet op maan).", "Bleef in baan."],
      },
      {
        q: "Welke missie was **eerste maanlanding**?",
        options: ["Apollo 11", "Apollo 13", "Sputnik 1", "ISS"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Mislukking-die-overleefden.", "Sovjet eerste satelliet.", "Niet maan."],
      },
      {
        q: "Hoeveel mensen liepen **op maan** totaal?",
        options: ["12 (allemaal Amerikaans)", "1", "100", "0"],
        answer: 0,
        wrongHints: [null, "Klopt — 6 missies, 2 per keer.", "Te weinig.", "Te veel.", "Wel 12."],
      },
      {
        q: "Wat is **Artemis**?",
        options: ["NASA-programma om opnieuw op maan", "Sterrenstelsel", "Raketnaam alleen", "Sovjet-missie"],
        answer: 0,
        wrongHints: [null, "Klopt — tegen 2026.", "Niet primair.", "Wel raket maar programma.", "Niet."],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    checks: [
      { q: "Eerste **mens op maan**?", options: ["Neil Armstrong (1969)", "Aldrin", "Gagarin", "Kuipers"], answer: 0, wrongHints: [null, "Klopt.", "Tweede.", "Niet maan.", "NL — niet maan."] },
      { q: "Eerste **mens in ruimte**?", options: ["Joeri Gagarin (1961)", "Armstrong", "Teresjkova", "Kuipers"], answer: 0, wrongHints: [null, "Klopt.", "Maan, niet eerste in ruimte.", "Eerste vrouw.", "NL."] },
      { q: "Hoeveel mensen **op maan** totaal?", options: ["12", "0", "100", "1"], answer: 0, wrongHints: [null, "Klopt — 6 missies, 2/keer.", "Wel.", "Te veel.", "Te weinig."] },
      { q: "**Apollo 11** wanneer?", options: ["1969", "1957", "1989", "2020"], answer: 0, wrongHints: [null, "Klopt.", "Sputnik.", "Niet.", "Recent."] },
      { q: "**ISS** = ?", options: ["Internationaal ruimtestation in baan", "Raket", "Maan", "Mars-rover"], answer: 0, wrongHints: [null, "Klopt — sinds 1998.", "Niet.", "Niet.", "Niet."] },
      { q: "NL-astronaut **André Kuipers** ging 2x naar?", options: ["ISS", "Maan", "Mars", "Sun"], answer: 0, wrongHints: [null, "Klopt.", "Geen NL'er op maan.", "Onbemand.", "Onmogelijk."] },
    ],
  },
];
