    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Was in 1800.", "Veel te veel.", "Veel te weinig."],
      },
      {
        q: "Welk **continent** heeft de meeste mensen?",
        options: ["Azië", "Afrika", "Europa", "Amerika"],
        answer: 0,
        wrongHints: [null, "Klopt — 59% van wereld.", "Tweede.", "Veel minder.", "Veel minder."],
      },
      {
        q: "Welk **land** heeft sinds 2023 de meeste mensen?",
        options: ["India", "China", "VS", "Indonesië"],
        answer: 0,
        wrongHints: [null, "Klopt — voorbij China.", "Was tot 2023 grootst.", "Veel kleiner.", "4e plaats."],
      },
      {
        q: "Wat is **vergrijzing**?",
        options: ["Bevolking wordt gemiddeld ouder", "Bevolking sterft uit", "Bevolking verhuist", "Bevolking jonger"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet uitsterven.", "Niet verhuizen.", "Tegenovergesteld."],
      },
    ],
  },
  ...
  // STAP 2: Spreiding + dichtheid
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Veel mensen.", "Veel mensen.", "Veel mensen."],
      },
      {
        q: "**10 miljoen inwoners** op **100.000 km²**. Dichtheid?",
        options: ["100 mensen/km²", "10 mensen/km²", "1000 mensen/km²", "1 mensen/km²"],
        answer: 0,
        wrongHints: [null, "Klopt — 10M ÷ 100K = 100.", "Te weinig.", "Te veel.", "Te weinig."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 4 grote steden + omgeving.", "Niet heel NL.", "Slechts deel.", "Geen buurland."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — emigreren = uit-.", "Dat is immigratie.", "Niet emigratie.", "Reizen is geen verhuizen."],
      },
      {
        q: "Wat is een **vluchteling**?",
        options: ["Iemand die vlucht voor oorlog/vervolging", "Toerist", "Werknemer", "Student"],
        answer: 0,
        wrongHints: [null, "Klopt — Vluchtelingenverdrag 1951.", "Geen vluchteling.", "Economische migrant.", "Tijdelijke migrant."],
      },
      {
        q: "Wat is **interne migratie**?",
        options: ["Binnen 1 land verhuizen", "Tussen landen", "Tussen continenten", "Reizen"],
        answer: 0,
        wrongHints: [null, "Klopt — bv. platteland → stad.", "Dat is internationaal.", "Dat is continentaal.", "Reizen = niet verhuizen."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — Joods, Armeens, Iers, etc.", "Geen land.", "Geen kamp.", "Geen programma."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — duwt mensen weg.", "Dat is pull.", "Tegengesteld.", "Niet specifiek migratie."],
      },
      {
        q: "Welke is een **pull-factor**?",
        options: ["Goed werk + veilig land", "Oorlog", "Hongersnood", "Ramp"],
        answer: 0,
        wrongHints: [null, "Klopt — trekt aan.", "Push.", "Push.", "Push."],
      },
      {
        q: "Wat is **brain drain**?",
        options: ["Hoogopgeleiden verlaten arme landen", "Onderwijs in zee", "Vergeetachtigheid", "Te veel werk"],
        answer: 0,
        wrongHints: [null, "Klopt — letterlijk 'breinen-afvoer'.", "Geen geografie-onderwerp.", "Geen migratie-term.", "Geen migratie-term."],
      },
      {
        q: "Welke is een **belangrijkste push-factor** voor Syrische vluchtelingen?",
        options: ["Oorlog (2011-)", "Klimaat", "Werkloosheid", "Onderwijs"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Speelt wel mee maar oorlog primair.", "Speelt mee.", "Niet hoofd-push."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — Italianen + Spanjaarden + Marokkanen + Turken.", "Te vroeg.", "Te vroeg.", "Veel later."],
      },
      {
        q: "Hoeveel % NL'ers heeft **migratie-achtergrond** (2024)?",
        options: ["~25%", "~5%", "~75%", "~50%"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Te weinig.", "Te veel.", "Te veel — eerder helft in grote steden."],
      },
      {
        q: "Wat is een **AZC**?",
        options: ["Asielzoekerscentrum", "Algemeen Ziekenhuis", "Amsterdamse Zorg", "Antwerps Centrum"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet AZC.", "Niet AZC.", "Niet NL."],
      },
      {
        q: "Welke groep kwam na **2022**?",
        options: ["Oekraïners (oorlog Rusland)", "Marokkanen", "Surinamers", "Polen"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Eerder gastarbeiders.", "1975+.", "Sinds 2004 EU."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "1800.", "Onmogelijk.", "Te weinig."],
      },
      {
        q: "Wat is **bevolkingsdichtheid**?",
        options: ["Mensen per km²", "Aantal kinderen", "Aantal landen", "Aantal geboortes"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet dichtheid.", "Niet dichtheid.", "Geboortecijfer."],
      },
      {
        q: "Welke is een **push-factor**?",
        options: ["Oorlog in het land", "Goede school", "Veiligheid", "Werk"],
        answer: 0,
        wrongHints: [null, "Klopt — duwt weg.", "Pull.", "Pull.", "Pull."],
      },
      {
        q: "Welk **land** heeft sinds 2023 de meeste mensen?",
        options: ["India", "China", "VS", "Rusland"],
        answer: 0,
        wrongHints: [null, "Klopt — voorbij China.", "Was nummer 1 tot 2023.", "Veel kleiner.", "Veel kleiner."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Klopt qua omvang grootendeels, maar specifiek deze 4.", "Niet de Randstad.", "Niet de Randstad."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — bv. Tokio, Delhi, Shanghai.", "Niet steden.", "Niet definitie.", "Sommige wel maar niet alle."],
      },
    ],
  },
];
