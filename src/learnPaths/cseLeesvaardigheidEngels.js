...
const steps = [
  // STAP 1: Signaalwoorden
  {
    ...
    checks: [
      ...
      {
        q: "*'First... then... finally...'* — welk soort signaalwoorden?",
        options: ["Volgorde (sequence)", "Tegenstelling", "Reden-gevolg", "Voorbeeld"],
        answer: 0,
        wrongHints: [null, "Geen 'but' / 'however'.", "Geen 'because'.", "Geen 'for instance'."],
      },
      {
        q: "*'For example, ...'* leidt in?",
        options: ["Voorbeeld", "Conclusie", "Tegenstelling", "Reden"],
        answer: 0,
        wrongHints: [null, "Daarvoor 'in conclusion'.", "Daarvoor 'however'.", "Daarvoor 'because'."],
      },
    ],
  },
  ...
  // STAP 2: Tekstsoorten
  {
    ...
    checks: [
      ...
      {
        q: "*'In my opinion, this movie was disappointing.'* Welk soort?",
        options: ["Opinion / mening", "News", "Recipe", "Manual"],
        answer: 0,
        wrongHints: [null, "Geen neutraal feit.", "Geen recept.", "Geen handleiding."],
      },
      {
        q: "*'Step 1: turn on the device. Step 2: press the button.'* Welk soort?",
        options: ["Instruction / manual", "News", "Opinion", "Story"],
        answer: 0,
        wrongHints: [null, "Geen actualiteit.", "Geen mening.", "Geen verhaal."],
      },
    ],
  },
  ...
  // STAP 3: Woordbetekenis uit context
  {
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Dat is 'very-'.", "Dat is 'pre-'.", "Dat is 'inter-'."],
      },
      {
        q: "*'I felt jubilant after passing the test.'* Wat betekent **jubilant** (uit context)?",
        options: ["Heel blij", "Verdrietig", "Boos", "Bang"],
        answer: 0,
        wrongHints: [null, "Tegenovergesteld.", "Geen positieve emotie.", "Geen positieve emotie."],
      },
    ],
  },
  ...
  // STAP 4: Hoofdgedachte + details
  {
    ...
    checks: [
      ...
      {
        q: "Bij **examen-vraag 'What is the main point?'** zoek je naar?",
        options: ["Hoofdgedachte van de tekst", "Eerste zin", "Mooie zin", "Auteur"],
        answer: 0,
        wrongHints: [null, "Soms — vaak ergens anders.", "Niet relevant.", "Geen tekst-inhoud."],
      },
      {
        q: "*'Skimming'* is een leestechniek waarbij je...?",
        options: ["Snel scant op hoofdlijnen", "Elk woord langzaam leest", "Niets leest", "Alleen titel leest"],
        answer: 0,
        wrongHints: [null, "Dat is grondig lezen.", "Geen techniek.", "Onvolledig."],
      },
    ],
  },
  ...
  // STAP 5: Verwijzingen
  {
    ...
    checks: [
      ...
      {
        q: "*'I bought a phone. **It** has a great camera.'* Waar verwijst **'it'** naar?",
        options: ["De telefoon", "De camera", "De winkel", "Ik"],
        answer: 0,
        wrongHints: [null, "'It' staat ervoor (telefoon).", "Niet relevant.", "Persoon, geen 'it'."],
      },
      {
        q: "*'The students who studied passed. **They** worked hard.'* Waar verwijst **'they'** naar?",
        options: ["Studenten die studeerden", "Iedereen", "De docent", "Onbekend"],
        answer: 0,
        wrongHints: [null, "Specifieker.", "Geen relevant.", "Wel bekend."],
      },
    ],
  },
  ...
  // STAP 6: Eind-toets
  {
    ...
    checks: [
      ...
      {
        q: "*'**Open question**: what does 'although' signal in English?'*",
        kind: "open",
        acceptedAnswers: ["contrast", "tegenstelling", "tegenstelling/contrast"],
        explanation: "'Although' is een tegenstelling-signaalwoord, vergelijkbaar met 'though' / 'even though'.",
      },
      {
