    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — verrassing/tegenstelling.", "Dat is toevoegen.", "Dat is gevolg.", "Dat is voorbeeld."],
      },
      {
        q: "Welk woord geeft **'gevolg'** aan?",
        options: ["therefore", "but", "although", "for example"],
        answer: 0,
        wrongHints: [null, "Klopt — 'daarom'.", "Tegenstelling.", "Tegenstelling.", "Voorbeeld."],
      },
      {
        q: "*'Tom studied hard. ___, he failed the exam.'* Welk woord?",
        options: ["However", "Therefore", "Because", "Moreover"],
        answer: 0,
        wrongHints: [null, "Klopt — onverwacht resultaat = tegenstelling.", "Niet gevolg — hard werken zou tot slagen leiden, niet zakken.", "Geen reden.", "Geen toevoeging."],
        uitlegPad: {
          stappen: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — reden 'omdat'.", "Geen tegenstelling.", "Dat zou andersom zijn.", "Geen toevoeging."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — tegenstelling met 'cheerful'.", "Zelfde — geen tegenstelling.", "Kan ook negatief maar 'morose' = stiller, niet boos.", "Anders type negatief gevoel."],
      },
      {
        q: "*'unhappy'** — wat betekent **un-**?",
        options: ["niet", "veel", "zonder", "opnieuw"],
        answer: 0,
        wrongHints: [null, "Klopt — un = niet.", "Geen 'veel'.", "Dat is -less.", "Dat is re-."],
      },
      {
        q: "*'He bought legumes, such as beans and lentils.'* Wat zijn **legumes**?",
        options: ["Peulvruchten (bonen-familie)", "Fruit", "Vlees", "Brood"],
        answer: 0,
        wrongHints: [null, "Klopt — voorbeelden bonen+linzen.", "Geen fruit.", "Niet plantaardig + vlees.", "Niet brood."],
      },
      {
        q: "*'-less'* aan eind van woord betekent ... ?",
        options: ["Zonder", "Met", "Twee", "Opnieuw"],
        answer: 0,
        wrongHints: [null, "Klopt — careless = zonder zorg.", "Tegengesteld.", "Dat is bi-.", "Dat is re-."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Niet typisch.", "Wel maar niet primair.", "Niet typisch."],
      },
      {
        q: "Wat is een **detail-vraag**?",
        options: ["Vraag naar specifiek feit (jaar, aantal)", "Vraag naar mening", "Hoofdpunt vragen", "Niet relevant"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Andere vraagtype.", "Andere vraagtype.", "Wel relevant."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — geen eigen mening.", "Niet — alleen wat in tekst.", "Niet — alleen wat in tekst.", "Niet — alleen tekst."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — algemeen genoeg.", "Detail (specifiek getal).", "Gevolg/detail, geen hoofdpunt.", "Niet in tekst."],
      },
    ],
  },
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — enige persoon genoemd.", "Niet — Tom expliciet.", "Een broodje is 'it'.", "Mary niet genoemd."],
      },
      {
        q: "*'The book was thick. ___ had 500 pages.'* Welk woord?",
        options: ["It", "He", "She", "They"],
        answer: 0,
        wrongHints: [null, "Klopt — book = it.", "Persoon, geen ding.", "Persoon (vrouw).", "Meervoud."],
      },
      {
        q: "*'Sarah loves cats. **They** are her favorite animals.'* Wat is **they**?",
        options: ["Cats", "Sarah", "Animals", "Personen"],
        answer: 0,
        wrongHints: [null, "Klopt — meervoud katten.", "Sarah is 'she'.", "Wel synoniem maar context = cats.", "Geen specifieke personen."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — 'this' vat samen.", "Niet expliciet genoemd.", "Te beperkt.", "Te beperkt."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt.", "Gevolg.", "Voorbeeld.", "Toevoegen."],
      },
      {
        q: "Welk soort tekst probeert **iets te verkopen**?",
        options: ["Advertentie", "News", "Review", "Story"],
        answer: 0,
        wrongHints: [null, "Klopt.", "Informeert.", "Beoordeelt.", "Vermaakt."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — vast majority = grote meerderheid.", "Niet vast = snel.", "Niet hard.", "Engels vast ≠ Nederlands vast."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — combineert beide zinnen.", "Detail.", "Te algemeen.", "Detail."],
      },
      {
        q: "*'Anna and Tim went to the park. **They** played football.'* Wie is **they**?",
        options: ["Anna and Tim", "Sport-team", "Toeschouwers", "Anna alleen"],
        answer: 0,
        wrongHints: [null, "Klopt — 2 personen samen.", "Niet — Anna+Tim genoemd.", "Niet genoemd.", "Te beperkt."],
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Klopt — duur is tegenovergesteld van 'great'.", "Geen gevolg.", "Geen reden.", "Geen voorbeeld."],
      },
    ],
  },
];
