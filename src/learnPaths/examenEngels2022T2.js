...
const steps = [
  {
    ...
    checks: [{
      ...
      explanation: "Tekst: 'asking legitimate boat users to **help us by reporting any suspicious activity**' + 'don't get involved' + 'pass on information'. Doel = informatie doorgeven (anoniem mag).",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Naam 'Empathy Museum' + zinsdeel 'slipping into someone else's shoes helps people understand the lived experience of others' = inleven in anderen. Schoenen zijn middel, empathie is doel.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Schrijver maakt deze point in alinea 2: 'it won't have occurred to her for a millisecond that she shouldn't be racing alongside 50% of her classmates' + 'Most children probably aren't even aware of this resistance to mixed competition.' = kinderen WETEN niet eens van het debat.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Tekst: 'upcycling, a process in which **unwanted pieces of fabric** are transformed' + 'waste fabric collected from a community shop'. = oude/weggegooide materialen omgevormd.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 1: '**introduced the new Youth Criminal Justice Act**' = nieuwe wet ingevoerd. McLellan VERANDERT actief het systeem.",
  ...
  },
  {
    ...
    checks: [{
      ...
      explanation: "Alinea 2 lijst diverse publiek-groepen + REDENEN: 'people gawped' (curiositeit), 'medical professionals studied' (medisch), 'rich patrons dined' (status), 'reformers debated moral implications' (ethiek). = diverse mensen, diverse redenen.",
