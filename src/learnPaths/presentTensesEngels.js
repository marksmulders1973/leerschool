    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Continuous past niet hier.", "He → -s.", "Geen werkwoordvorm."],
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Continuous past niet bij gewoonte.", "You → do, niet does.", "Geen geldige combinatie."],
      },
    ],
  },
  {
...
<text x="150" y="150" text-anchor="middle" fill="${COLORS.good}" font-size="12" font-family="Arial" font-weight="bold">je kunt het — good luck!</text>
    ...
    checks: [
      ...
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Know is state verb, geen continuous.", "We → geen -s.", "-ing past niet."],
      },
      {
        q: "*___ your sister ___ this weekend?* (work, tijdelijk)",
        options: ["Is / working", "Does / work", "Do / works", "Are / working"],
        answer: 0,
        wrongHints: [null, "Tijdelijk past niet bij simple.", "Vorm klopt niet.", "Sister = is, niet are."],
      },
      {
        q: "*Tom usually ___ his homework after dinner.*",
        options: ["does", "is doing", "do", "doing"],
        answer: 0,
        wrongHints: [null, "Continuous past niet bij 'usually'.", "He → does.", "Geen geldige vorm."],
      },
      { q: "Look! She _____ a beautiful song.", options: ["is singing","sings","sing","sang"], answer: 0, wrongHints: [null, "Niet — gebeurt nu, niet altijd.", "Niet — vorm fout.", "Past — niet nu."] },
      { q: "Water _____ at 100°C.", options: ["boils","is boiling","boil","boiled"], answer: 0, wrongHints: [null, "Niet — algemene waarheid, geen tijdelijk feit.", "Niet — water = it → -s.", "Past tense — niet nodig."] },
    ],
  },
];
