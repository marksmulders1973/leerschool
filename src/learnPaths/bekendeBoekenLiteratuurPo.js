...
const steps = [
  ...
  },
  {
    ...
    checks: [
      ...
      { q: "Wie schreef *Harry Potter*?", options: ["J.K. Rowling","Roald Dahl","Annie M.G. Schmidt","Tonke Dragt"], answer: 0, wrongHints: [null,"Klopt — Brits.","Andere kinderboeken.","NL.","NL."] },
      { q: "Wie schreef *Pluk van de Petteflet*?", options: ["Annie M.G. Schmidt","Tonke Dragt","Jacques Vriens","Carry Slee"], answer: 0, wrongHints: [null,"Klopt.","Andere boeken.","Andere.","Andere."] },
      { q: "*De brief voor de koning* is van?", options: ["Tonke Dragt","Annie M.G. Schmidt","Roald Dahl","J.K. Rowling"], answer: 0, wrongHints: [null,"Klopt — 1962.","Niet.","Niet.","Niet."] },
      { q: "Wie schreef *Sjakie en de Chocoladefabriek*?", options: ["Roald Dahl","Annie M.G. Schmidt","Tonke Dragt","Anne Frank"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Niet kinderboek."] },
      { q: "Wat is **proza**?", options: ["Gewone tekst (geen poëzie)","Gedicht","Spel","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt.","Tegengestelde.","Niet.","Wel."] },
      { q: "**Multatuli** schreef beroemd boek over?", options: ["Koloniale uitbuiting (Max Havelaar)","Liefde","Sport","Eten"], answer: 0, wrongHints: [null,"Klopt — 1860.","Niet hoofdthema.","Niet.","Niet."] },
      { q: "Wie tekende **Nijntje**?", options: ["Dick Bruna","Fiep Westendorp","Annie M.G. Schmidt","Roald Dahl"], answer: 0, wrongHints: [null,"Klopt — Utrecht.","Andere.","Schrijver.","Niet."] },
      { q: "Wie schreef *Het Achterhuis*?", options: ["Anne Frank","Multatuli","Tonke Dragt","Annie M.G. Schmidt"], answer: 0, wrongHints: [null,"Klopt — dagboek 1942-44.","Andere periode.","Niet.","Niet."] },
      { q: "**Gouden Griffel** is prijs voor?", options: ["Beste NL-kinderboek","Beste film","Beste spel","Beste recept"], answer: 0, wrongHints: [null,"Klopt — sinds 1971.","Niet.","Niet.","Niet."] },
      { q: "Wie is **Carry Slee**?", options: ["NL-jeugdboek-schrijfster","Tekenaar","Acteur","Componist"], answer: 0, wrongHints: [null,"Klopt — Razend etc.","Niet.","Niet.","Niet."] },
      { q: "Wat is een **strip**?", options: ["Verhaal met tekeningen + tekstballonnen","Lang boek","Gedicht","Niet relevant"], answer: 0, wrongHints: [null,"Klopt — bv. Donald Duck.","Niet specifiek.","Niet.","Wel."] },
      { q: "Wie schreef **fantasy** *De Hobbit*?", options: ["J.R.R. Tolkien","Roald Dahl","C.S. Lewis","Tonke Dragt"], answer: 0, wrongHints: [null,"Klopt — 1937.","Andere boeken.","Narnia.","Niet."] },
      { q: "Wat is een **leescommissie** of **leesclub**?", options: ["Groep mensen die samen lezen + bespreken","Een uitgeverij","Een boekwinkel","Niet bestaand"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Wel."] },
      { q: "Wat doet een **bibliothecaris**?", options: ["Bibliotheek beheren + lezers helpen","Boeken schrijven","Boeken drukken","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Niet.","Niet.","Wel."] },
      { q: "Welke 2 belangrijke NL-jeugdboeken-prijzen zijn er?", options: ["Gouden + Zilveren Griffel","Pulitzer + Booker","Niet bestaand","Niet relevant"], answer: 0, wrongHints: [null,"Klopt.","Andere taal.","Wel.","Niet."] },
    ],
  },
];
