    ...
    checks: [
      {
        ...
        answer: 0,
        wrongHints: [null, "Brits.", "Andere.", "Volwassen."],
        uitlegPad: {
          stappen: [
    ...
    checks: [
      {
        ...
        uitlegPad: {
          ...
          niveaus: {
            basis: "Februari/maart 1945, Bergen-Belsen.",
            simpeler: "Anne stierf eind winter 1945 aan tyfus in concentratiekamp Bergen-Belsen, vlak voor het kamp bevrijd werd.",
            nogSimpeler: "1945",
          },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Veel later.", "Kinderboek.", "Dagboek."],
        uitlegPad: {
          stappen: [
          ...
          niveaus: {
            basis: "Multatuli.",
            simpeler: "Multatuli (schuilnaam Eduard Douwes Dekker) schreef Max Havelaar in 1860 — aanklacht NL-koloniaal beleid in Indonesië.",
            nogSimpeler: "Multatuli",
          },
        },
      },
      {
    ...
    checks: [
      ...
      { q: "**Harry Potter** = aantal delen?", options: ["7", "1", "100", "3"], answer: 0, wrongHints: [null, "Te weinig.", "Te veel.", "Te weinig."] },
      {
        ...
        uitlegPad: {
          ...
          niveaus: { basis: "Tijdreis Middeleeuwen.", simpeler: "Boek door Thea Beckman: jongen reist terug naar 1212 voor de kinderkruistocht. Historische roman.", nogSimpeler: "Tijdreis" },
        },
      },
      {
        ...
        answer: 0,
        wrongHints: [null, "Niet — Schmidt schreef kortere boeken (Jip+Janneke).", "Niet — Beckman schreef Spijkerbroek.", "Niet — Dahl was Brits."],
        uitlegPad: {
          stappen: [
      ...
      { q: "*De brief voor de koning* is van?", options: ["Tonke Dragt","Annie M.G. Schmidt","Roald Dahl","J.K. Rowling"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      ...
      { q: "**Gouden Griffel** is prijs voor?", options: ["Beste NL-kinderboek","Beste film","Beste spel","Beste recept"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
      { q: "Wie is **Carry Slee**?", options: ["NL-jeugdboek-schrijfster","Tekenaar","Acteur","Componist"], answer: 0, wrongHints: [null, "Niet.", "Niet.", "Niet."] },
