...
## Verzend-log
- **18 aug 2026 (middag) — Buurtgezinnen deel 1: 34 coördinatoren ✅ 34/34 (Mark-go "go Buurtgezinnen via gmail")** — via Mark's Gmail (MCP send_message, dus zichtbaar in Gmail-verzonden), persoonlijke aanhef "Beste [voornaam]" + gemeente(n) in de vraag-alinea. Gedekt: **Drenthe (3) · Flevoland (1) · Friesland (8) · Gelderland (18) · Groningen (3) · Limburg-regio (1, Tamara)**. Multi-gemeente-coördinatoren 1× gemaild met beide gemeenten benoemd; wietske@ (Middel-zekerheid, gemeente al gedekt door Susan) overgeslagen. ⚠️ Let op: alle adressen zitten op één domein (@buurtgezinnen.nl = één landelijke organisatie) — daarom gespreid over dagen (Gmail-reputatie-regel ~35/dag) én kans dat HQ het opmerkt; overweging voor Mark: kort vriendelijk berichtje aan info@buurtgezinnen.nl ("ik benader enkele van uw coördinatoren…") kan een centraal "nee" vóór zijn. **Deel 2 (Limburg-rest + Noord-Brabant, ~35) wo 19 aug · deel 3 (Noord-Holland, ~35) do 20 · deel 4 (Utrecht + Zuid-Holland, rest) vr 21 — telkens na Mark-go of doorlopende go.**
