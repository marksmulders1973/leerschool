# 🗓️ Mark-agenda — dingen/datums om aan te denken

> Bron voor het "Denk-aan"-blok in élk dagrapport-PDF. Claude werkt dit bij
> bij elke mail-check en elke afspraak/toezegging; afgehandeld = weghalen.
> Verschil met WACHT-OP.md: dáár staat waar WIJ op wachten; hier staat wat
...
- 📦 **17 sep — Voedselbank Dongen: antwoord VERSTUURD 11:49 ("gaan deze week op de post").** Mark heeft géén posters (les: nooit "van de laser" beloven zonder te vragen). **Twee sporen:** (1) **envelop 50 flyers** uit voorraad → Schubertstraat 30, 5102 BH Dongen, t.a.v. Monique Balemans, uiterlijk za 19 sep, PostNL-bon bewaren; (2) **3 A3-posters via Drukwerkdeal rechtstreeks naar Dongen** — winkelwagen staat klaar in Chrome-voor-Claude (A3, gesatineerd mc 135 g, 4/0, geen afwerking, 3 st., normale levering **di 22 sep**, €19,24 incl., gratis verzending); Mark: inloggen → bezorgadres Dongen → betalen → daarna bestand uploaden: `Desktop\dagrapport\poster-DONGEN2027-a3-drukwerk.pdf` (303×426 mm, 3 mm afloop). Na bestelling: Claude concept-regeltje aan Monique "posters komen dinsdag apart".
...
- ✅ **15 sep — Bedrieger-spel: tikken gerepareerd (v669).** Mark: "als bedrieger lukte het me niet om iemand aan te tikken." Drie reviews + simulatie + live repro: regels te streng en onzichtbaar (2,5 m / 8 m ogen, geen feedback), gast-tik stil afgewezen, rollen door relay gedropt. Nu: 3,5 m / 5 m, bezig-bots geen ogen, vaste ronde 👉-knop rechtsonder mét reden, flits bij tik, tikOk/tikNee, rollen herhaald, één spelleider, laatkomer-tekst, host-weg-overlay, Stop-bevestiging, zweefknop uit. **Test zelf:** park → 🎮 Bedrieger → 🕵️ → loop naar een bot bij een post; onder de knop staat wat je moet doen. **Klas-test (2 telefoons + pc, 10 min):** staat in het klas-review. **Open, Mark beslist:** MAX_SPELERS 10 → 30 voor een klas · host-migratie · klassement per uid (dubbele voornamen) · top-3-ranking i.p.v. laatste plaats zichtbaar (pesten).

- ✅ **15 sep — "Wie is de imposter?" heet nu "Wie is de bedrieger?" (v668).** Els Knaapen op Facebook: "Imposter is geen Nederlands woord." Alle zichtbare teksten omgezet (menu, lobby, rolkaart BEDRIEGER, uitkomsten, WhatsApp-uitnodiging, leerkracht-kaart, landingspagina's, FAQ-JSON, llms.txt, zoekbalk); URL wie-is-de-imposter.html en interne identifiers bewust gelijk gehouden. Landingspagina noemt Among Us ("daar heet de bedrieger een impostor"). Reactie onder haar opmerking geplaatst. Openstaand: de tekst van de FB-post zelf zegt nog imposter — bewerken kan, alleen op Marks 'ja'.

- ✅ **15 sep — Ommeriek: BESLOTEN niets te sturen (Mark: 'voelt creepy alsof we hem volgen').** Rolf Zwart vroeg als persoon het oefenpakket aan en krijgt exact wat iedereen krijgt: de wekelijkse reeks van hallo@. Code OMMERIEK2027 weer verwijderd; geen blok, geen teller, geen zachte check. Regel aangescherpt: alleen als de *organisatie* zelf aanvraagt (functioneel adres) volgt code + concept; een persoon vanaf een werkadres = gewone lezer. De reeks-mail kreeg één neutrale zin voor iedereen: doorgeven aan klas/school/organisatie → doorgeven.html. Een gesprek begint pas als hij zelf antwoordt.
- ⏸️ **16 sep — Mark: "stuur maar niets".** Scholen batch 2 (96 mails, rij 16-111, `scripts/outreach-send-scholen.mjs`) én het bedankje aan Voedselbank Enschede-Haaksbergen gaan NIET uit. Niet meer dagelijks om 'ga' vragen; Mark zegt het zelf als hij het weer wil (dan op een maandagochtend, idee B). LOWAN batch 4 is wél gegaan (Mark 09:00: 'doe maar lowan').
...
- **⚠️ Scholen batch 2 NIET verstuurd vr 11 sep** (geen ochtendsessie) → **ma 14 sep 60, di 15 sep 36** (Claude ~08:00).
- **🆕 VluchtelingenWerk-medewerker vroeg 11 sep 09:58 het oefenpakket aan** → concept warme opvolging ma 14 sep (Claude), jij 'stuur maar'. Intranet-verwijzers gezien: OKT Amsterdam (11 sep), SharePoint BJZ Limburg (10 sep).
...
- **🎉 KINDERHULP-NIEUWSBRIEF IS VERSTUURD do 10 sep ±10:15** (een week eerder dan 'uiterlijk 18 sep'; gezien in de cijfers: utm_source=clang, campagne 'nieuwsbrief intermediairs' A/B). Dag 1: 25 apparaten, 8 accounts, 7× code ingetikt, 2 claims. **Claude dagelijks t/m ~20 sep:** Kinderhulp-blok in het dagrapport. ~~Vr 11 sep: concept bedank-mail Marion + opvolging Leudal/Huizen~~ ✅ alle drie verstuurd 10 sep 17:15-17:20; Marion antwoordde 11 sep (zie boven). ✅ **Idee 1 GEBOUWD v641 (10 sep 16:10, Mark 'ja idee 1' + 'maak maar'):** nieuwsbrief-tag → eigen partner-code (regel-tabel `NIEUWSBRIEF_REGELS` in partnerCode.js: utm_source=clang + campagne 'intermediairs'/'kinderhulp' → KINDERHULP2027); zelfde ere-scherm als een QR-scan, geen overtypen; dag-1-bezoekers krijgen de code bij terugkomst (first-touch-bron). Elke partner houdt zijn EIGEN code (Mark: 'kan er variatie in?') — nieuwe nieuwsbrief-partner = nieuwe regel. Meting: partner_bezoek via:'nieuwsbrief'|'nieuwsbrief-terug'.
- **📬 VoorleesExpress Almere (Frieda van Olphen, De Nieuwe Bibliotheek) warm 10 sep 15:33:** 'mooi initiatief, deel het met 2 collega's, heb je meer informatie?' → **concept-antwoord klaar** (Desktop\dagrapport\concept-mail-frieda-voorleesexpress-almere-2026-09-10.md + in het dagrapport). ✅ **VERSTUURD 10 sep 15:55** (reply-all, Mark-go). Nu wachten; bij ja → code ALMERE2027 + flyer met logo (eerst tonen).
- **☁️ Cloudflare 'verify your email' (hallo@, 9 sep 06:31):** als nog niet aangeklikt → doen (1 min), anders blijft het account onbevestigd.

- **⭐ TWEE-WEKEN-PLAN t/m 24 sep (Mark-akkoord 10 sep):** (1) elke mail <24u beantwoorden; (2) één warme leerkracht die klas-game/schooldictee echt gebruikt; (3) Stripe-testaccount + test-sleutels; (4) LinkedIn 1×/week; (5) game op 2 telefoons · dashboard-login. Claude: outreach-cadans, GEEN nieuwe functies (alleen fixes + meten), Kinderhulp-claims v.a. 15 sep, zachte checks ~15 sep. Wacht op KvK: stadspassen, gemeenten, Leergeld-prijs, pers, Stripe live. Evaluatie in dagrapport do 24 sep. Memory: project_studiebol_plan_2weken_sep2026.
...
- **🏫 Scholen batch 2 loopt (akkoord 10 sep):** 15 verstuurd 10 sep · ~~vr 11 sep 60~~ niet verstuurd → **ma 14 sep 60** (rij 16-75) · **di 15 sep 36** (rij 76-111). Daarna LOWAN batch 4 (139 over) na 'ga'.
...
- **LOWAN: ✅ batch 1 (45) 2 sep · ✅ batch 2 (45) 8 sep · ✅ batch 3 (45) 10 sep · ✅ batch 4 (45) verzonden wo 16 sep ±09:05 (Mark: 'doe maar lowan'; `docs/outreach/LOWAN-BATCH-4.md`). ✅ **Batch 5 (45) GEPLAND: Windows-taak "Leerkwartier LOWAN batch 5" ma 21 sep 08:00** (Mark 16 sep: 'ga, LOWAN batch 5 maandag'; adressen in `LOWAN-BATCH-5.md`, runner `scripts/outreach/run-lowan-batch5.cmd`, log `docs/outreach/lowan-batch-5-run.log`). Claude ma 21 sep: log controleren, verzendlog committen, WACHT-OP bijwerken. Daarna nog 92 over (batch 6 di, batch 7 wo, elk na Mark's woord). Reacties komen op hallo@ → Gmail; stand 8 sep: 0 reacties, 0 bounces.**
- ~~Google-login in Chrome-voor-Claude~~ ✅ 10 sep: ingelogd (gmail); indexering aangevraagd voor dictee-oefenen.html, samen-bouwen.html, park.html.
- ~~Analytics-login verlopen (8 sep)~~ ✅ **hersteld 10 sep 16:20** — account **mark-smulders@hotmail.com**; bij een volgende verlopen sessie: loginpagina openen in Chrome-voor-Claude + dat adres noemen (memory reference_vercel_login_chrome_voor_claude).
...
| Wanneer | Wat | Wie |
|---|---|---|
| **half nov 2026** | 📬 **Kinderhulp januari-editie aanvragen** (Mark 11 sep): Marion vragen om een ÁNDER item in de januari-nieuwsbrief voor intermediairs — "Doorstroomtoets over zes weken: gratis Kwartiercheck" (geen herhaling van het september-item; zij plaatsen niet 2× hetzelfde). **Pas als KvK (28 sep) én Stripe-betaalmogelijkheid klaar zijn.** Concept door Claude, Mark zegt stuur maar. Staat ook in Supabase `opvolgbronnen` (volgende_opvolging 2026-11-15) | Claude concept → Mark |
...
| **di 15 sep** | 💶 **Prinsjesdag — Belastingplan 2027 checken: gaat de startersaftrek-afschaffing per 1-1-2027 door?** (kabinetsplan 20 apr 2026, géén overgangsrecht). Bij doorgaan → reconstructie 2026-uren (mei-aug uit git/verzendlogs) naar voren halen: alleen mét ≥1.225 échte uren in 2026 is de startersaftrek (€2.123 + zelfstandigenaftrek €1.200 ≈ €1.230 netto) ooit nog te pakken | Claude checkt → Mark beslist |
| ✅ 13 aug → ✅ 28 aug | ~~Leergeld-golven~~ **COMPLEET: Noord-16 (13 aug) + Zuid-20 (18 aug) + Midden-20 (28 aug) = alle 115 Leergeld-stichtingen gedekt.** VoorleesExpress deel 2 óók 28 aug (48); deel 3 za 29 aug. Flyer-regel: digitaal; print alléén uit 1.000-voorraad per 50 | Claude |
...
| ~~do 27 aug ~13:00~~ ✅ | 📞 **GEBELD 27 aug — ging super:** Froukje gaat Leerkwartier (1) zélf gebruiken, (2) **voorleggen binnen Buurtgezinnen** (3e interne spoor naast Nicole/Eveline), en (3) haar man is **huiswerkbegeleider** — samen gaan ze door de vragen heen en geven Mark tips (gratis kwaliteitscheck!). Vervolg: "zoals besproken"-mail (concept klaar, Mark-go) + tips opvolgen zodra ze komen | ✅ afgehandeld |
...
| ~~±half sep~~ ❌ | ~~SIDN-antwoord~~ — **AFGEWEZEN 21 aug** (standaardbrief; PDF in Desktop\SIDN-aanvraag); geld-spoor loopt via eenmanszaak/KvK | ✅ afgehandeld |
| ~~≤ begin okt~~ | ⏸️ GEPARKEERD (Mark 3 sep: "zonder de kerstpakketten") — 🎄 Kerstpakket-inlegvellen: voedselbanken/Leergeld benaderen voor december-actie — timing dwingt, uiterlijk oktober! | Claude concept, Mark-go |
...
| ~half dec 2026 | 📈 **Capaciteits-check vóór de Cito-piek** (28 aug-nulmeting: DB 29 MB/500 MB, 501/50.000 actieve users — zeeën van ruimte): Supabase-dashboard egress (5 GB-limiet) + Vercel Hobby bandbreedte (100 GB) + Auth rate-limit anonieme logins verruimen voor klassikaal gebruik (25 kinderen op één school-IP). Pas bij rode meters: Supabase Pro $25/mnd overwegen | Claude checkt → Mark beslist |
