...
- 💬 **15 sep — FB-reactie beantwoorden: spelnaam was niet Nederlands.** Iemand reageerde (vrijwel zeker onder de imposter-post van 10 sep op de FB-pagina, post-ID `122107707794586962`) dat de naam van het spel geen Nederlands is. **Terecht — en er zat nog een fout in: "imposter" is ook de verkeerde Engelse spelling (correct: impostor).** Aangepast in v668: het spel heet nu **"Wie doet alsof?"**, de rol heet **"de nepper"**. Claude kon niet zelf reageren (cloud-sessie zonder jouw Chrome-login). **Klaar om te plakken:**
  > Goeie, en je hebt gelijk. Sterker nog: "imposter" is óók nog de verkeerde Engelse spelling — het is "impostor". Het spel heet vanaf nu **"Wie doet alsof?"** en de rol heet "de nepper". Dank voor het meekijken, dit soort dingen zie ik zelf niet meer. 💛
  Staat de reactie op Threads of Instagram in plaats van Facebook? Zelfde tekst. Daarna: afvinken + regel weg hier.
