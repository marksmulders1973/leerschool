...
| Wanneer | Wat | Wie |
|---|---|---|
| **di 19 aug 10:00-12:00** | 📞 **Laura van der Westerlaken belt** (voorzitter Leergeld Oisterwijk, reactie op Zuid-mail 18 aug) op 06 84 58 1000. Spiekbriefje: basis gratis (gegarandeerd t/m 2031), Familie-extra's 2027 (€4,95/€24,95 Seizoenspas/€39 — per gezin), partner-code = gezinnen via Leergeld gratis Familie, geen account/reclame/doorverkoop (AVG), kleine vraag = alleen noemen in nieuwsbrief/poster (alles klaar, maatwerk gratis). Zij is didactisch onderlegd — concreet zijn over uitleg-op-3-niveaus; geen interne cijfers. Na afloop: uitkomst aan Claude melden voor logging | **Mark** |
...
| **di 25 aug 13:00** | 📞 **FaceTime-rondleiding Voedselbank Alkmaar** (Teresa, 06-5239 5673) — haar voorstel 18 aug i.p.v. fysiek bezoek (privacy klanten). Mark bevestigt per mail (concept klaar). Fysiek VB-bezoek kan evt. apart naar **Rotterdam** (Amber, di+do; 50 flyers meenemen) | Mark bevestigt |
