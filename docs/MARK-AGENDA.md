...
- **📱 Dictee-reclame 2 ("woorden van school") klaar, wacht op 'post maar':** beeld `Desktop\social-dictee\dictee-post-2.png`, teksten `dictee-posts-2.md` (FB/IG/Threads/LinkedIn-bedrijfspagina door Claude; LinkedIn persoonlijk door Mark).

- **🎉 KINDERHULP-NIEUWSBRIEF IS VERSTUURD do 10 sep ±10:15** (een week eerder dan 'uiterlijk 18 sep'; gezien in de cijfers: utm_source=clang, campagne 'nieuwsbrief intermediairs' A/B). Dag 1: 25 apparaten, 8 accounts, 7× code ingetikt, 2 claims. **Claude dagelijks t/m ~20 sep:** Kinderhulp-blok in het dagrapport. **Vr 11 sep:** concept bedank-mail Marion (zachte getallen, vraag: /doorgeven.html in de november-editie + nieuwsbrief doorsturen) · concept warme opvolging Leergeld Leudal + basisschool Huizen (beide vroegen 10 sep zelf het oefenpakket aan). ✅ **Idee 1 GEBOUWD v641 (10 sep 16:10, Mark 'ja idee 1' + 'maak maar'):** nieuwsbrief-tag → eigen partner-code (regel-tabel `NIEUWSBRIEF_REGELS` in partnerCode.js: utm_source=clang + campagne 'intermediairs'/'kinderhulp' → KINDERHULP2027); zelfde ere-scherm als een QR-scan, geen overtypen; dag-1-bezoekers krijgen de code bij terugkomst (first-touch-bron). Elke partner houdt zijn EIGEN code (Mark: 'kan er variatie in?') — nieuwe nieuwsbrief-partner = nieuwe regel. Meting: partner_bezoek via:'nieuwsbrief'|'nieuwsbrief-terug'.
