...
## 📌 Besluit 23 sep 2026 — vroege partners: Familie gratis t/m 2028
Mark: "2027 én 2028 gratis klinkt rijker." Besluit (met Claude's advies): **alle partnercodes aangemaakt vóór 1-1-2027 geven het Familiepakket gratis t/m 31-12-2028** ("omdat jullie er vroeg bij zijn" — eindige groep, urgentie voor partners die nog twijfelen). **Nieuwe codes vanaf 1-1-2027: 12 maanden vanaf de claim** (het "langste-van-de-twee"-idee; te bouwen in de paywall-sprint jan 2027, dan houdt 2028 verkoopbaar voor nieuwe partners). Ooievaarspas blijft blijvend (contract). Gevolg voor het verdienmodel: partneromzet uit de vroege partners schuift naar 2029; omzet 2027-2028 komt uit Familie-verkoop aan gezinnen zónder code en uit nieuwe partners. Kosten: AI ≈ €0,003 per apparaat per maand gemiddeld (sep 2026), Charley-gebruikers 1,6%; bij 2.000 code-kinderen in 2028 ≈ €30-60/maand. DB: `partner_codes.familie_tot = 2028-12-31` voor 39 codes (23 sep). Teksten: app leest de datum (partnerFamilieTotLabel), flyer-sjabloon B1, hook gratis-claim-guard, concepten Bonaire + corporaties. Gedrukte flyers met "heel 2027" blijven waar (het werd meer, niet minder).
