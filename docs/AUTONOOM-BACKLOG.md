...
- [~] **V3 — BEAUTY-QUEUE (3 scouts 31 jul, gerangschikt; werkwijze: improvement-agent + Claude als visuele keurmeester render+screenshot elk resultaat).** Batches, hoogste waarde eerst:
  ...
  - **B4 — Aardrijkskunde/maatschappij (iconisch):** platentektoniek twee schuivende aardplaten (platentektoniekAardrijkskunde) · Tweede Kamer als halve-cirkel-zaal (nederlandseStaatMaatschappijleer) · Trias Politica als iconen (boek/vuist/weegschaal).
