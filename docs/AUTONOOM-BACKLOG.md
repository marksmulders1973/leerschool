...
- 2026-05-26 — **Doorstroomtoets-kern gaten dichten**: 4 nieuwe PO-paden (zinsontledingPo 25q, verwijswoordenPo 22q, inhoudsmatenPo 20q, schaalPlattegrondPo 20q = 87 nieuwe checks). examenLookup herbouwd (cse-leesvaardigheid-nederlands 0→30 refs na 5 Nederlands examen-paden). Manifest 282→286. PR #1 aangemaakt. Commits 613ebed → 19f3591.
