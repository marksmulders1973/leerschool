...
- [ ] **V3 (nu = beauty-scout, doorlopend)** Systematische schoonheids-ronde (Mark 31 jul): laat een scout-agent de sweep-vellen aflopen en de visuals rangschikken die WERKEN maar veel mooier/duidelijker kunnen (NL-kaart-lat) — geen bugs maar "kan strakker". Daarna per batch improvement-agents + Claude als visuele keurmeester (render+screenshot elk resultaat). Kandidaten al genoemd: schematische blok-diagrammen die echte vormen/iconen kunnen krijgen.
