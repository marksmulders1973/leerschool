...
- [~] **V3 — BEAUTY-QUEUE (3 scouts 31 jul, gerangschikt; werkwijze: improvement-agent + Claude als visuele keurmeester render+screenshot elk resultaat).** Batches, hoogste waarde eerst:
  - **B1 — Concrete Cito-kern-contexten (rekenen/natuur groep 6-8, iconische quick-wins):** ✅ thermometer negatieve getallen (v136) · deeltjesmodel vast/vloeibaar/gas (toestandStoffenPo: rooster→los→verspreid + ijs/water/stoom) · tafels als stippen-arrays (tafelsPo, groep 4-6, hoog-frequent) · spelling lettergrepen in gekleurde blokjes (spelling, kort/lang-klinker).
