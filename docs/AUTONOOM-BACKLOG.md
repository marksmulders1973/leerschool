...
- [~] **A8.2 Begrijpend lezen 3 → ~15 paden** — ✓8/7 batch 1 (4 paden, commits 1a589be..5a54942): verwijswoorden / woordbetekenis-context / conclusies-trekken / tekstdoel-schrijversdoel. ✓15/7 **batch 2** (4 paden, commits 4fdb67e..d3c32ce): feiten-details-opzoeken (17 checks) / tekstverbanden-oorzaak-gevolg (16) / alinea-functies-tussenkopjes (17) / nieuwsbericht-lezen-5W+H (17) — 4 parallelle agents, linters schoon, alle ≤15 min. Nu **11 v/d ~15**. **Batch 3 (volgende):** brief/e-mail-lezen, schema+tekst-combi, lange toets-teksten g8 (2 teksten ~350 w), poëzie/verhaal-diepte g7-8. Werkwijze: 4 parallelle schrijf-agents met template begrijpendLezenTekstenPo.js + harde eisen (≤18 checks, eigen teksten, hint-regels), daarna manifest+lint+gate+build+commit-per-pad.
