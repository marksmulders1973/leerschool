...
- [~] **V3 — BEAUTY-QUEUE (3 scouts 31 jul, gerangschikt; werkwijze: improvement-agent + Claude als visuele keurmeester render+screenshot elk resultaat).** Batches, hoogste waarde eerst:
  ...
  - **B3 — Biologie voortplanting/hormonen:** menstruatiecyclus als ronde 28-dagen-klok · organen als herkenbare anatomie · hormonen klier→bloedbaan→doelorgaan (voortplantingHormonenBiologie).
