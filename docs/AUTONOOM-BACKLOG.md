...
- 2026-05-20 — **CONTENT-MEGA-SESSIE** (23 paden + 5 UI-fixes, commits cb160e0 → 46bbb40, manifest 254 → 270). HAVO/VWO-cluster sterk uitgebouwd: 6 nask (trillingen-golven, elektromagnetisme, radioactiviteit, optica, warmte-thermodynamica, quantum-atoommodel), 4 wiskunde (goniometrie, differentialen, log-exp, algebra-vergelijkingen), 2 biologie (ecosystemen, evolutie, immuunsysteem), 1 scheikunde (mol-stoichiometrie-redox), 1 geschiedenis (industriële-revolutie), 1 economie (marktvormen-markfalen), 2 aardrijkskunde (atmosfeer-klimaat, globalisering), 1 nederlands (stijl-literatuur), 1 engels (literatuur), 1 PO Cito (maten-omtrek-oppervlakte). UI-fixes: OBLITERATOR settings/Hall of Fame/8 muziek-stages, mobile-overflow (overflow-x:hidden + min-width:0), examen-mix-bron-label (gele tekst onder vraag), desktop hero-tiles breder ≥1024px + aspect 5:4, mobile tile-aspect 4:5, examens-CTA-routing fix (role=student bij feature examens). Eindcommit `46bbb40`.
