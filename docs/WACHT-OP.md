...
|---|---|---|---|
| **Spark Fest flyers (1.000 goodybags, festival zo 18 okt)** | 🖨️✅ **BESTELD & IN PRODUCTIE (29 jul, order 15653885)** — A5, 1.000 st., dubbelzijdig (voorkant op beide zijden, Mark's keuze), 135 g/m² glans, offset, **€43,56 incl., verwachte levering di 4 aug** rechtstreeks bij Inez: Saskerstraat 227, 1827 AD Alkmaar. Druk-PDF: `flyer-HAARLEMMERMEER2027-DRUK.pdf` (154×216 mm; generator `scripts/maak-drukpdf-haarlemmermeer.mjs` — oude PDF was Letter/thuisprint). NB: 1.050 bestond niet als oplage-stap; 1.000 = precies goed | 29 jul | (1) Bevestigingsmail aan Inez ✅ 29 jul; (2) **toestemming bedankt-pagina gevraagd ✅ 29 jul** (Mark: "vraag maar") — bij "ja" het klaarstaande Spark Fest-blok in `bedankt.html` activeren (uitgecommentarieerd onder Leergeld-sectie, evt. logo erbij); (3) rond 4-5 aug checken of geleverd; (4) LinkedIn-concept `Desktop\linkedin-sparkfest-post.md` POST 1 kan live — Mark plakt zelf; (5) september: Inez maakt tasjes, festival zo 18 okt → daarna scan-teller volgen (≥25 scans = goodybag-model uitrollen) |
