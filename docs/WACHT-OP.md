...
| **🔥 Voedselbank Alkmaar — sept-verspreiding** (Teresa): **18 aug GEANTWOORD: FaceTime-rondleiding di 25 aug 13:00** i.p.v. fysiek bezoek (privacy klanten + reistijd); zij printen de posters zélf ("drukkosten besparen wij je"); deelde hun promo-YouTube (uFIVSiZt_44). Concept-bevestiging klaar → Mark verstuurt | (1) Mark bevestigt FaceTime di 25 aug 13:00 (06-5239 5673); (2) quote-toestemming (gevraagd 10 aug, nog open); (3) evt. Word-aanpassingen | 18 aug | Verspreiding begin sept (digitaal+print, printen ze zelf) → scan-teller ALKMAAR2027 volgen; di 25 aug = FaceTime-dag → fysiek VB-bezoek kan evt. naar Rotterdam (Amber) |
| **🔥 School's cool Twente** (team Hetty/Anne/Esra/Daniëlle, mentorproject brugklassers Enschede/Hengelo/Oldenzaal) — 11 aug enthousiast antwoord "hoe werkt alles precies?"; **uitleg-mail + flyer-op-maat (code SCHOOLSCOOL2027, v246) door Mark verstuurd 11 aug**, incl. aanbod online demo voor begeleiders; ✅ poster A3+A4 mét logo + brugklas-regel nagestuurd 14 aug (geen-antwoord-nodig-toon) | Hun reactie (demo-afspraak? verspreiding onder mentoren?) | 11 aug | Bij "ja" → scan-teller SCHOOLSCOOL2027 volgen in dagrapport + evt. demo plannen; stil t/m ~25 aug → vriendelijke nudge. Memory: `project_studiebol_schoolscool_twente` |
...
| **✅ Amber (VB Rotterdam) succes-update VERSTUURD 13 aug** (Mark-go; Resend, Re:-onderwerp, MarCom@voedselbank.nl): dia draait ~1 mnd, eerste gezinnen via code + QR-ouder; gevraagd: (1) logo-toestemming bedankt.html, (2) bezoekdag di/do + setje 50 flyers uit voorraad | Amber's antwoord (logo-ja + datum) | 13 aug | Bij logo-ja → 2/3 op de 3-partner-teller; bij datum → NIET dubbel plannen met Alkmaar-rondleiding (di 25 aug optie-conflict); stil ~22 aug → vriendelijke nudge |
| **🏝️ Caribische batch 1 (10 mails, Mark verstuurd 9 aug)**: RCN-OCW · RKCS · DOS · VPCO · Colegio Arubano · SKOA · SPCOA · SVOBE+MPC · SKOS · OOB Bonaire | Eerste reacties (scholen daar starten ~half aug) | 9 aug | Warme reactie → warme-leads-lijst + reply + evt. partner-code. **Batch 2 (eilanden-rest + Suriname, ~41 mails) staat los hiervan gepland do 20-21 aug na go** — teksten klaar in `docs/outreach/CARIBISCH-OUTREACH.md` |
