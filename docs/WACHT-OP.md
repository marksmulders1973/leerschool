...
| Wat | Wacht op | Sinds | Daarna |
|---|---|---|---|
| **🔥 Voedselbank Alkmaar — sept-verspreiding** (Teresa, akkoord 10 aug): 1-pagina-flyer + Word-versie ✅ geleverd 12 aug (links live: flyer-ALKMAAR2027.pdf + -bewerkbaar.docx); **reply door Mark VERSTUURD 12 aug ±10:15** mét rondleiding-voorstel **di 25 aug ±11:00**; ✅ poster A3+A4 mét logo nagestuurd 14 aug | (1) Teresa's antwoord op de rondleiding-datum; (2) haar quote-toestemming (gevraagd 10 aug); (3) evt. haar Word-aanpassingen (dan gedrukte versie gelijk houden) | 12 aug | Verspreiding begin sept (digitaal+print) → scan-teller ALKMAAR2027 dagelijks volgen; vangnet #29 vóór 1 sep live |
...
| **14-aug-golf: Humanitas COMPLEET — 74 afdelingen (50 + rest-24), def. tekst mét verdienmodel + voedselbanken-bewijs + poster-links** | Eerste reacties (vrijwilligers; kan snel of pas na weekend) | 14 aug | Warm → warme-leads + concept-reply aan Mark; ma 17 aug = 5 vb-restjes + SUN/fondsen ~40 (SUN-tekst eerst als concept; tempo ~50/dag) |
