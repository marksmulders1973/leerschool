...
| **14-aug-golf: Humanitas #1 — 50 afdelingen (⭐ jeugd/gezin vooraan), def. tekst mét verdienmodel-alinea + voedselbanken-bewijs + poster-links** | Eerste reacties (vrijwilligersorganisatie, kan snel of pas na weekend) | 14 aug | Warm → warme-leads + concept-reply aan Mark; rest-23 + 5 vb + SUN = batch ma 17 aug (tempo ~50/dag) |
