...
| Wat | Wacht op | Sinds | Daarna |
|---|---|---|---|
| **🔥 Voedselbank Alkmaar — sept-verspreiding** (Teresa, akkoord 10 aug): vroeg 12 aug 07:20 om 1-pagina-flyer + Word-versie → ✅ **zelfde ochtend gemaakt** (flyer-Alkmaar-1pagina.pdf + flyer-Alkmaar-bewerkbaar.docx op Mark's bureaublad; live-PDF ververst). | (1) Mark verstuurt reply + 2 bijlagen (concept klaar, mét rondleiding-voorstel di 25 aug); (2) Teresa's quote-toestemming (gevraagd 10 aug) | 12 aug | Verspreiding begin sept (digitaal+print) → scan-teller ALKMAAR2027 dagelijks volgen; vangnet #29 vóór 1 sep live |
