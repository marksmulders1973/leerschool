# 💶 Kosten 2026 — aanloopkosten eenmanszaak Leerkwartier

> Voorbereiding voor de aangifte over 2026 (voorjaar 2027, sámen doornemen — staande afspraak).
> Startdatum eenmanszaak: 1 sep 2026 (KvK-afspraak 28 sep). Kosten van vóór de start zijn
> **aanloopkosten** en in het eerste jaar aftrekbaar. Claude werkt dit bestand bij bij elke
> mail-check waarin een factuur/kostenpost langskomt; Mark vult aan wat alleen hij weet.
>
...
| Overig (kantoorspullen, evt. telefoonkosten zakelijk deel) | bonnen | ? |

## Komt nog in 2026

| Wanneer | Wat | Bedrag |
|---|---|---|
| 28 sep | KvK-inschrijving (pin ter plekke) | ± €80 |
| doorlopend | Anthropic API-tegoed bijkopen | variabel |
...
1. **Facturenmap:** `OneDrive\Leerkwartier-facturen-2026\` — Mark sleept daar alle PDF's/bonnen in
   (hotmail-facturen even doorsturen naar Gmail mag ook; dan kan Claude ze zelf archiveren).
2. **Claude** houdt dit bestand bij (nieuwe kostenpost in mail → rij erbij) en toont de stand
