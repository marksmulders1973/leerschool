...
| do 24 sep 12:00 | **LOWAN batch 7B + 7C** (de allerlaatste 29) | 29 | Resend | ✅ Taak liep pas om 12:00 (pc sliep om 08:30) en werd na 2 mails afgebroken; rij 3-29 om 12:35 handmatig als **7C** verstuurd (`LOWAN-BATCH-7C.md`) → LOWAN compleet (313/325) |
| do 24 sep 14:00 | **Bonaire ronde 2** (13: 9 scholen variant S + 4 organisaties variant O, `BONAIRE-S.md`/`BONAIRE-O.md`, code BONAIRE2027 t/m 2028) | 13 | Resend | ⏰ **Windows-taak "Leerkwartier Bonaire ronde 2"** om 14:00 NL = 08:00 Bonaire (runner `run-bonaire-ronde2.cmd`, log `bonaire-ronde2-run.log`); Mark "stuur maar bonaire" 23 sep; dagtotaal 24 sep = 42 |
...
| ✅ za 26 sep 06:35 (naar voren gehaald, Mark "stuur de mail nu maar"; Windows-taak uitgezet) | **België test**: 7 voedselbanken (`BELGIE-VOEDSELBANKEN.md`, elk een eigen code: VOEDSELBANKBE · ANTWERPEN · LIMBURGBE · OOSTVLAANDEREN · WESTVLAANDEREN · BRUSSEL · KRUIDENIER + 2027, Familie t/m 2028) + eerste 20 scholen met taalheldklas (`BELGIE-SCHOLEN-TAALHELDKLAS.md`) | 27 | Resend via Windows-taak `Leerkwartier Belgie test 2026-10-01` | Mark "stuur maar" 25 sep; Huizen van het Kind (50) pas na eerste reacties; droogloop OK |
