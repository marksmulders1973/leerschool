...
| do 24 sep 08:30 | **LOWAN batch 7B** (`LOWAN-BATCH-7B.md`, de allerlaatste 29) | 29 | Resend | ⏰ **Windows-taak "Leerkwartier LOWAN batch 7B"** (runner `scripts/outreach/run-lowan-batch7b.cmd`, log `lowan-batch-7b-run.log`); pc aan of slapend → daarna LOWAN compleet (313/325) |
